...
require (
	...
	github.com/tencentcloudstack/terraform-provider-tencentcloud v1.81.69
)
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.845 // indirect
