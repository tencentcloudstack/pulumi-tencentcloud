...
require (
	...
	github.com/tencentcloudstack/terraform-provider-tencentcloud v1.81.70
)
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.847 // indirect
