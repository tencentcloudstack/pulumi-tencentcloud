...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/organization v1.0.910 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/postgres v1.0.873 // indirect
