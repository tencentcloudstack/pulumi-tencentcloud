...
export class BucketPicStyle extends pulumi.CustomResource {
     ...
     */
    declare public readonly styleBody: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: BucketPicStyleArgs | BucketPicStyleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["styleBody"] = state?.styleBody;
            ...
            if (args?.styleBody === undefined && !opts.urn) {
            ...
            resourceInputs["styleBody"] = args?.styleBody;
