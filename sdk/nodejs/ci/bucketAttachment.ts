 ...
 *
 * const bucketAttachment = new tencentcloud.ci.BucketAttachment("bucket_attachment", {bucket: "terraform-ci-xxxxxx"});
 * ```
 *
 * ## Import
 *
...
export class BucketAttachment extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly ciStatus: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: BucketAttachmentArgs | BucketAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ciStatus"] = state?.ciStatus;
        } else {
