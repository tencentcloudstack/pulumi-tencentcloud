...
export { GetInstanceUrlsArgs, GetInstanceUrlsResult, GetInstanceUrlsOutputArgs } from "./getInstanceUrls";
export const getInstanceUrls: typeof import("./getInstanceUrls").getInstanceUrls = null as any;
export const getInstanceUrlsOutput: typeof import("./getInstanceUrls").getInstanceUrlsOutput = null as any;
utilities.lazyLoad(exports, ["getInstanceUrls","getInstanceUrlsOutput"], () => require("./getInstanceUrls"));
...
export { InstanceParamsArgs, InstanceParamsState } from "./instanceParams";
export type InstanceParams = import("./instanceParams").InstanceParams;
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Mongodb/readonlyInstance:ReadonlyInstance":
