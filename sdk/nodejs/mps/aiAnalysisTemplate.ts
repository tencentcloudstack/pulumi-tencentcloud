...
export class AiAnalysisTemplate extends pulumi.CustomResource {
     ...
     */
    declare public readonly classificationConfigure: pulumi.Output<outputs.Mps.AiAnalysisTemplateClassificationConfigure | undefined>;
    /**
     ...
     */
    declare public readonly coverConfigure: pulumi.Output<outputs.Mps.AiAnalysisTemplateCoverConfigure | undefined>;
    /**
     * Ai frame tag task control parameters.
     */
    declare public readonly frameTagConfigure: pulumi.Output<outputs.Mps.AiAnalysisTemplateFrameTagConfigure | undefined>;
    /**
     ...
     */
    declare public readonly tagConfigure: pulumi.Output<outputs.Mps.AiAnalysisTemplateTagConfigure | undefined>;
    ...
    constructor(name: string, argsOrState?: AiAnalysisTemplateArgs | AiAnalysisTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["classificationConfigure"] = state?.classificationConfigure;
            resourceInputs["comment"] = state?.comment;
            resourceInputs["coverConfigure"] = state?.coverConfigure;
            resourceInputs["frameTagConfigure"] = state?.frameTagConfigure;
            resourceInputs["name"] = state?.name;
            resourceInputs["tagConfigure"] = state?.tagConfigure;
        } else {
            const args = argsOrState as AiAnalysisTemplateArgs | undefined;
            resourceInputs["classificationConfigure"] = args?.classificationConfigure;
            resourceInputs["comment"] = args?.comment;
            resourceInputs["coverConfigure"] = args?.coverConfigure;
            resourceInputs["frameTagConfigure"] = args?.frameTagConfigure;
            resourceInputs["name"] = args?.name;
            resourceInputs["tagConfigure"] = args?.tagConfigure;
        }
