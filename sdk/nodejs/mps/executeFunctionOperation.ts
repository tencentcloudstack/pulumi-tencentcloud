...
export class ExecuteFunctionOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly functionArg: pulumi.Output<string>;
    /**
