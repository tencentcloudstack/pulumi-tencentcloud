 ...
 * import * as tencentcloud from "@tencentcloud_iac/pulumi";
 *
 * const eventRtp = new tencentcloud.mps.Event("event_rtp", {
 *     eventName: "tf_test_event_rtp_%d",
 *     description: "tf test mps event description",
 * });
 * const flowRtp = new tencentcloud.mps.Flow("flow_rtp", {
...
export class Flow extends pulumi.CustomResource {
     ...
     */
    declare public readonly inputGroups: pulumi.Output<outputs.Mps.FlowInputGroup[]>;
    /**
     * Maximum bandwidth, unit bps, optional [10000000, 20000000, 50000000].
     */
    declare public readonly maxBandwidth: pulumi.Output<number>;
    ...
    constructor(name: string, argsOrState?: FlowArgs | FlowState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["inputGroups"] = state?.inputGroups;
            ...
            if (args?.maxBandwidth === undefined && !opts.urn) {
            ...
            resourceInputs["inputGroups"] = args?.inputGroups;
