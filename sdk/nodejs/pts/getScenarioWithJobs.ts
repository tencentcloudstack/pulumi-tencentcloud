 ...
 * ```
 */
export function getScenarioWithJobsOutput(args: GetScenarioWithJobsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetScenarioWithJobsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Pts/getScenarioWithJobs:getScenarioWithJobs", {
        "ascend": args.ascend,
        "ignoreDataset": args.ignoreDataset,
        "ignoreScript": args.ignoreScript,
        "orderBy": args.orderBy,
