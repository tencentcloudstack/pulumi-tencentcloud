...
export class L4RuleV2 extends pulumi.CustomResource {
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.Dayu.L4RuleV2Rules>;
    /**
     * The virtual port of the layer 4 rule.
     */
    declare public readonly virtualPort: pulumi.Output<number>;
    /**
     * Resource vpn.
     */
    declare public readonly vpn: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: L4RuleV2Args | L4RuleV2State, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["virtualPort"] = state?.virtualPort;
