 ...
 *
 * const example = new tencentcloud.cam.SamlProvider("example", {
 *     name: "tf-example",
...
export class SamlProvider extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly providerArn: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: SamlProviderArgs | SamlProviderState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["providerArn"] = state?.providerArn;
