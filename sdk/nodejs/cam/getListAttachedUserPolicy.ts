...
export function getListAttachedUserPolicyOutput(args: GetListAttachedUserPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetListAttachedUserPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cam/getListAttachedUserPolicy:getListAttachedUserPolicy", {
        "attachType": args.attachType,
        "keyword": args.keyword,
        "resultOutputFile": args.resultOutputFile,
        "strategyType": args.strategyType,
