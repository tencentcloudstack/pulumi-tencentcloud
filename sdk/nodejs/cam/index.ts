...
export { MessageReceiverArgs, MessageReceiverState } from "./messageReceiver";
export type MessageReceiver = import("./messageReceiver").MessageReceiver;
export const MessageReceiver: typeof import("./messageReceiver").MessageReceiver = null as any;
utilities.lazyLoad(exports, ["MessageReceiver"], () => require("./messageReceiver"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Cam/messageReceiver:MessageReceiver":
                return new MessageReceiver(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Cam/messageReceiver", _module)
