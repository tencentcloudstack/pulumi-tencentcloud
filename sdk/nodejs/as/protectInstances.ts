...
export class ProtectInstances extends pulumi.CustomResource {
     ...
     */
    declare public readonly protectedFromScaleIn: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: ProtectInstancesArgs | ProtectInstancesState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["protectedFromScaleIn"] = state?.protectedFromScaleIn;
        } else {
            ...
            if (args?.protectedFromScaleIn === undefined && !opts.urn) {
            ...
            resourceInputs["protectedFromScaleIn"] = args?.protectedFromScaleIn;
        }
...
export interface ProtectInstancesState {
     ...
     * If instances need protect.
     */
    protectedFromScaleIn?: pulumi.Input<boolean | undefined>;
}
