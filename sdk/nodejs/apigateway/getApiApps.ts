 ...
 * Use this data source to query list information of apiGateway api_app
 */
export function getApiAppsOutput(args?: GetApiAppsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiAppsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:ApiGateway/getApiApps:getApiApps", {
        "apiAppId": args.apiAppId,
        "apiAppName": args.apiAppName,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
