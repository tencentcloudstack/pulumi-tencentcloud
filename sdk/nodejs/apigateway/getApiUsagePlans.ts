 ...
 *
 * const exampleUsagePlan = new tencentcloud.apigateway.UsagePlan("example", {
 ...
 * ```
 */
export function getApiUsagePlansOutput(args: GetApiUsagePlansOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetApiUsagePlansResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:ApiGateway/getApiUsagePlans:getApiUsagePlans", {
        "resultOutputFile": args.resultOutputFile,
        "serviceId": args.serviceId,
    }, opts);
}
