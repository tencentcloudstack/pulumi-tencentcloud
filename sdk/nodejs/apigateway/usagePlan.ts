...
export class UsagePlan extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly attachApiKeys: pulumi.Output<string[]>;
    /**
     * Attach service and API list.
     */
    declare public /*out*/ readonly attachLists: pulumi.Output<outputs.ApiGateway.UsagePlanAttachList[]>;
    /**
     ...
     */
    declare public readonly maxRequestNum: pulumi.Output<number | undefined>;
    /**
     * Limit of requests per second. Valid values: -1, [1,2000]. The default value is -1, which indicates no limit.
     */
    declare public readonly maxRequestNumPreSec: pulumi.Output<number | undefined>;
    /**
     ...
     */
    declare public readonly usagePlanDesc: pulumi.Output<string | undefined>;
    /**
     * Custom usage plan name.
     */
    declare public readonly usagePlanName: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: UsagePlanArgs | UsagePlanState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["attachApiKeys"] = state?.attachApiKeys;
            resourceInputs["attachLists"] = state?.attachLists;
            resourceInputs["createTime"] = state?.createTime;
            resourceInputs["maxRequestNum"] = state?.maxRequestNum;
            resourceInputs["maxRequestNumPreSec"] = state?.maxRequestNumPreSec;
            resourceInputs["modifyTime"] = state?.modifyTime;
            resourceInputs["usagePlanDesc"] = state?.usagePlanDesc;
            resourceInputs["usagePlanName"] = state?.usagePlanName;
        } else {
            const args = argsOrState as UsagePlanArgs | undefined;
            if (args?.usagePlanName === undefined && !opts.urn) {
                throw new Error("Missing required property 'usagePlanName'");
            }
            resourceInputs["maxRequestNum"] = args?.maxRequestNum;
            resourceInputs["maxRequestNumPreSec"] = args?.maxRequestNumPreSec;
            resourceInputs["usagePlanDesc"] = args?.usagePlanDesc;
