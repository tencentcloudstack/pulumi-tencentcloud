 ...
 *     ipVersion: "IPv4",
 * });
 * const attachService = new tencentcloud.apigateway.UsagePlanAttachment("attach_service", {
 *     usagePlanId: plan.id,
 ...
 * ```
 */
export function getUsagePlanEnvironmentsOutput(args: GetUsagePlanEnvironmentsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUsagePlanEnvironmentsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:ApiGateway/getUsagePlanEnvironments:getUsagePlanEnvironments", {
        "bindType": args.bindType,
        "resultOutputFile": args.resultOutputFile,
        "usagePlanId": args.usagePlanId,
    }, opts);
