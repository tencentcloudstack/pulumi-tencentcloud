 ...
 * Use this data source to query detailed information of tcmq subscribe
 */
export function getSubscribeOutput(args: GetSubscribeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSubscribeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tcmq/getSubscribe:getSubscribe", {
        "limit": args.limit,
        "offset": args.offset,
        "resultOutputFile": args.resultOutputFile,
        "subscriptionName": args.subscriptionName,
