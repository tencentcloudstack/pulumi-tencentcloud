...
export class EmailAddress extends pulumi.CustomResource {
     ...
     * Sender name.
     */
    declare public readonly emailSenderName: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: EmailAddressArgs | EmailAddressState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["emailSenderName"] = state?.emailSenderName;
            ...
            resourceInputs["emailSenderName"] = args?.emailSenderName;
