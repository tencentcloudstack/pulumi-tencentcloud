 ...
 * Use this data source to query table groups of the TcaplusDB cluster.
 */
export function getTablegroupsOutput(args: GetTablegroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTablegroupsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tcaplus/getTablegroups:getTablegroups", {
        "clusterId": args.clusterId,
        "resultOutputFile": args.resultOutputFile,
        "tablegroupId": args.tablegroupId,
        "tablegroupName": args.tablegroupName,
