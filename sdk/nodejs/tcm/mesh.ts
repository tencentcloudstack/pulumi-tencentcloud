...
export class Mesh extends pulumi.CustomResource {
     ...
     * Mesh configuration.
     */
    declare public readonly config: pulumi.Output<outputs.Tcm.MeshConfig>;
    /**
     * Mesh name.
     */
     ...
     * Mesh version.
     */
    declare public readonly meshVersion: pulumi.Output<string>;
    /**
     * A list of associated tags.
     */
    declare public readonly tagLists: pulumi.Output<outputs.Tcm.MeshTagList[] | undefined>;
    /**
     * Mesh type.
     */
    ...
    constructor(name: string, argsOrState?: MeshArgs | MeshState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["meshVersion"] = state?.meshVersion;
            ...
            if (args?.meshVersion === undefined && !opts.urn) {
            ...
            resourceInputs["meshVersion"] = args?.meshVersion;
