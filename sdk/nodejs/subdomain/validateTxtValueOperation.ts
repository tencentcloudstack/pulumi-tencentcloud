 ...
 *
 * const subdomainValidateTxtValueOperation = new tencentcloud.subdomain.ValidateTxtValueOperation("subdomain_validate_txt_value_operation", {domainZone: "www.iac-tf.cloud"});
 * ```
 */
export class ValidateTxtValueOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly domainZone: pulumi.Output<string>;
    /**
     * Record types need to be added.
     */
    declare public /*out*/ readonly recordType: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ValidateTxtValueOperationArgs | ValidateTxtValueOperationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["domainZone"] = state?.domainZone;
            ...
            if (args?.domainZone === undefined && !opts.urn) {
                throw new Error("Missing required property 'domainZone'");
            }
            resourceInputs["domainZone"] = args?.domainZone;
