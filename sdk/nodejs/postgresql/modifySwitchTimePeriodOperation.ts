 ...
 *
 * const modifySwitchTimePeriodOperation = new tencentcloud.postgresql.ModifySwitchTimePeriodOperation("modify_switch_time_period_operation", {
...
export class ModifySwitchTimePeriodOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly switchTag: pulumi.Output<number>;
