...
export { InstanceNetworkAccessArgs, InstanceNetworkAccessState } from "./instanceNetworkAccess";
export type InstanceNetworkAccess = import("./instanceNetworkAccess").InstanceNetworkAccess;
export const InstanceNetworkAccess: typeof import("./instanceNetworkAccess").InstanceNetworkAccess = null as any;
utilities.lazyLoad(exports, ["InstanceNetworkAccess"], () => require("./instanceNetworkAccess"));

export { InstanceSslConfigArgs, InstanceSslConfigState } from "./instanceSslConfig";
export type InstanceSslConfig = import("./instanceSslConfig").InstanceSslConfig;
export const InstanceSslConfig: typeof import("./instanceSslConfig").InstanceSslConfig = null as any;
utilities.lazyLoad(exports, ["InstanceSslConfig"], () => require("./instanceSslConfig"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Postgresql/instanceNetworkAccess:InstanceNetworkAccess":
                return new InstanceNetworkAccess(name, <any>undefined, { urn })
            case "tencentcloud:Postgresql/instanceSslConfig:InstanceSslConfig":
                return new InstanceSslConfig(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Postgresql/instanceNetworkAccess", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Postgresql/instanceSslConfig", _module)
