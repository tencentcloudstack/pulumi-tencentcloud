 ...
 * ```
 */
export function getAccountPrivilegesOutput(args: GetAccountPrivilegesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAccountPrivilegesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Postgresql/getAccountPrivileges:getAccountPrivileges", {
        "databaseObjectSets": args.databaseObjectSets,
        "dbInstanceId": args.dbInstanceId,
        "resultOutputFile": args.resultOutputFile,
        "userName": args.userName,
