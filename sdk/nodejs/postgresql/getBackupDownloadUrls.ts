 ...
 * ```
 */
export function getBackupDownloadUrlsOutput(args: GetBackupDownloadUrlsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupDownloadUrlsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Postgresql/getBackupDownloadUrls:getBackupDownloadUrls", {
        "backupDownloadRestriction": args.backupDownloadRestriction,
        "backupId": args.backupId,
        "backupType": args.backupType,
        "dbInstanceId": args.dbInstanceId,
