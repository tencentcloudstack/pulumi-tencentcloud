 ...
 * ```
 */
export function getCrossBorderComplianceOutput(args?: GetCrossBorderComplianceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCrossBorderComplianceResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Ccn/getCrossBorderCompliance:getCrossBorderCompliance", {
        "businessAddress": args.businessAddress,
        "company": args.company,
        "complianceId": args.complianceId,
        "email": args.email,
