...
export class InstancesRejectAttach extends pulumi.CustomResource {
     ...
     */
    declare public readonly instances: pulumi.Output<outputs.Ccn.InstancesRejectAttachInstance[]>;
...
export interface InstancesRejectAttachState {
     ...
     * Reject List Of Attachment Instances.
     */
    instances?: pulumi.Input<pulumi.Input<inputs.Ccn.InstancesRejectAttachInstance>[] | undefined>;
}
