 ...
 * const exampleRouteTableBroadcastPolicies = new tencentcloud.ccn.RouteTableBroadcastPolicies("example", {
 *     ccnId: example.id,
 *     routeTableId: exampleRouteTable.id,
 *     policies: [{
 *         action: "accept",
...
export class RouteTableBroadcastPolicies extends pulumi.CustomResource {
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.Ccn.RouteTableBroadcastPoliciesPolicy[]>;
    /**
     * CCN Route table ID.
     */
