 ...
 * const exampleRouteTableInputPolicies = new tencentcloud.ccn.RouteTableInputPolicies("example", {
 *     ccnId: example.id,
 *     routeTableId: exampleRouteTable.id,
 *     policies: [{
 *         action: "accept",
...
export class RouteTableInputPolicies extends pulumi.CustomResource {
     ...
     */
    declare public readonly policies: pulumi.Output<outputs.Ccn.RouteTableInputPoliciesPolicy[] | undefined>;
    /**
     * CCN Route table ID.
     */
