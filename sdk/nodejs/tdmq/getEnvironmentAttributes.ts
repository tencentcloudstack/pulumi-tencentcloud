 ...
 *
 * const exampleInstance = new tencentcloud.tdmq.Instance("example", {
 ...
 * ```
 */
export function getEnvironmentAttributesOutput(args: GetEnvironmentAttributesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnvironmentAttributesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tdmq/getEnvironmentAttributes:getEnvironmentAttributes", {
        "clusterId": args.clusterId,
        "environmentId": args.environmentId,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
