 ...
 * ```
 */
export function getRocketmqClusterOutput(args?: GetRocketmqClusterOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRocketmqClusterResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tdmq/getRocketmqCluster:getRocketmqCluster", {
        "clusterIdLists": args.clusterIdLists,
        "idKeyword": args.idKeyword,
        "nameKeyword": args.nameKeyword,
        "resultOutputFile": args.resultOutputFile,
