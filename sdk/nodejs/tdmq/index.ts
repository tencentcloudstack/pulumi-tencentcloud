...
export { RabbitmqUserPermissionArgs, RabbitmqUserPermissionState } from "./rabbitmqUserPermission";
export type RabbitmqUserPermission = import("./rabbitmqUserPermission").RabbitmqUserPermission;
export const RabbitmqUserPermission: typeof import("./rabbitmqUserPermission").RabbitmqUserPermission = null as any;
utilities.lazyLoad(exports, ["RabbitmqUserPermission"], () => require("./rabbitmqUserPermission"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Tdmq/rabbitmqUserPermission:RabbitmqUserPermission":
                return new RabbitmqUserPermission(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Tdmq/rabbitmqUserPermission", _module)
