...
export function getVipInstanceOutput(args: GetVipInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVipInstanceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tdmq/getVipInstance:getVipInstance", {
        "clusterId": args.clusterId,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
}
