 ...
 *
 * const fooSnapshotByTimeOffsetTemplate = new tencentcloud.vod.SnapshotByTimeOffsetTemplate("foo", {
 *     name: "tf-snapshot",
 *     width: 130,
 *     height: 128,
 ...
 * ```
 */
export function getSnapshotByTimeOffsetTemplatesOutput(args?: GetSnapshotByTimeOffsetTemplatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSnapshotByTimeOffsetTemplatesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Vod/getSnapshotByTimeOffsetTemplates:getSnapshotByTimeOffsetTemplates", {
        "definition": args.definition,
        "resultOutputFile": args.resultOutputFile,
        "subAppId": args.subAppId,
        "type": args.type,
