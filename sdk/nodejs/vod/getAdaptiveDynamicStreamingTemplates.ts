 ...
 *
 * const fooAdaptiveDynamicStreamingTemplate = new tencentcloud.vod.AdaptiveDynamicStreamingTemplate("foo", {
 *     format: "HLS",
 *     name: "tf-adaptive",
 *     drmType: "SimpleAES",
 ...
 *     ],
 * });
 * const foo = tencentcloud.Vod.getAdaptiveDynamicStreamingTemplatesOutput({
 *     type: "Custom",
 ...
 * ```
 */
export function getAdaptiveDynamicStreamingTemplatesOutput(args?: GetAdaptiveDynamicStreamingTemplatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAdaptiveDynamicStreamingTemplatesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Vod/getAdaptiveDynamicStreamingTemplates:getAdaptiveDynamicStreamingTemplates", {
        "definition": args.definition,
        "resultOutputFile": args.resultOutputFile,
        "subAppId": args.subAppId,
        "type": args.type,
