...
export class Template extends pulumi.CustomResource {
     ...
     */
    declare public readonly smsType: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: TemplateArgs | TemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["smsType"] = state?.smsType;
            ...
            if (args?.smsType === undefined && !opts.urn) {
            ...
            resourceInputs["smsType"] = args?.smsType;
