 ...
 * Use this data source to query detailed information of tsf publicConfigSummary
 */
export function getPublicConfigSummaryOutput(args?: GetPublicConfigSummaryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPublicConfigSummaryResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tsf/getPublicConfigSummary:getPublicConfigSummary", {
        "configIdLists": args.configIdLists,
        "configTagLists": args.configTagLists,
        "disableProgramAuthCheck": args.disableProgramAuthCheck,
        "orderBy": args.orderBy,
