 ...
 * ```
 */
export function getMicroserviceOutput(args: GetMicroserviceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMicroserviceResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tsf/getMicroservice:getMicroservice", {
        "microserviceIdLists": args.microserviceIdLists,
        "microserviceNameLists": args.microserviceNameLists,
        "namespaceId": args.namespaceId,
        "resultOutputFile": args.resultOutputFile,
