...
export class ConfigTemplate extends pulumi.CustomResource {
     ...
     */
    declare public readonly configTemplateDesc: pulumi.Output<string | undefined>;
    /**
     * Template Id.
     */
    declare public /*out*/ readonly configTemplateId: pulumi.Output<string>;
    /**
     * Configuration template name.
     */
    declare public readonly configTemplateName: pulumi.Output<string>;
    /**
     * Configure the microservice framework corresponding to the template.
     */
    declare public readonly configTemplateType: pulumi.Output<string>;
    /**
     * Configure template data.
     */
    declare public readonly configTemplateValue: pulumi.Output<string>;
    /**
     * creation time.
     */
    ...
    constructor(name: string, argsOrState?: ConfigTemplateArgs | ConfigTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["configTemplateDesc"] = state?.configTemplateDesc;
            resourceInputs["configTemplateId"] = state?.configTemplateId;
            resourceInputs["configTemplateName"] = state?.configTemplateName;
            resourceInputs["configTemplateType"] = state?.configTemplateType;
            resourceInputs["configTemplateValue"] = state?.configTemplateValue;
            ...
            if (args?.configTemplateType === undefined && !opts.urn) {
                throw new Error("Missing required property 'configTemplateType'");
            }
            if (args?.configTemplateValue === undefined && !opts.urn) {
                throw new Error("Missing required property 'configTemplateValue'");
            }
            resourceInputs["configTemplateDesc"] = args?.configTemplateDesc;
            resourceInputs["configTemplateName"] = args?.configTemplateName;
            resourceInputs["configTemplateType"] = args?.configTemplateType;
            resourceInputs["configTemplateValue"] = args?.configTemplateValue;
