...
export class UnitRule extends pulumi.CustomResource {
     ...
     * list of rule items.
     */
    declare public readonly unitRuleItemLists: pulumi.Output<outputs.Tsf.UnitRuleUnitRuleItemList[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UnitRuleArgs | UnitRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["unitRuleItemLists"] = state?.unitRuleItemLists;
        } else {
            ...
            resourceInputs["unitRuleItemLists"] = args?.unitRuleItemLists;
