...
export class CngwGateway extends pulumi.CustomResource {
     ...
     */
    declare public readonly enableCls: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly gatewayVersion: pulumi.Output<string>;
    /**
     * ingress class name.
     */
    declare public readonly ingressClassName: pulumi.Output<string>;
    /**
     * Port information that the instance listens to.
     */
    declare public /*out*/ readonly instancePorts: pulumi.Output<outputs.Tse.CngwGatewayInstancePort[]>;
    /**
     * internet configration.
     */
    declare public readonly internetConfig: pulumi.Output<outputs.Tse.CngwGatewayInternetConfig | undefined>;
    /**
     ...
     */
    declare public readonly nodeConfig: pulumi.Output<outputs.Tse.CngwGatewayNodeConfig>;
    /**
     ...
     */
    declare public readonly tradeType: pulumi.Output<number | undefined>;
    /**
     ...
     * vpc information.
     */
    declare public readonly vpcConfig: pulumi.Output<outputs.Tse.CngwGatewayVpcConfig>;
    ...
    constructor(name: string, argsOrState?: CngwGatewayArgs | CngwGatewayState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["enableCls"] = state?.enableCls;
            resourceInputs["engineRegion"] = state?.engineRegion;
            resourceInputs["featureVersion"] = state?.featureVersion;
            resourceInputs["gatewayVersion"] = state?.gatewayVersion;
            resourceInputs["ingressClassName"] = state?.ingressClassName;
            ...
            if (args?.gatewayVersion === undefined && !opts.urn) {
            ...
            resourceInputs["enableCls"] = args?.enableCls;
            ...
            resourceInputs["ingressClassName"] = args?.ingressClassName;
