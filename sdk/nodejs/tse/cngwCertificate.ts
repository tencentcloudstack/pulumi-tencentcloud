...
export class CngwCertificate extends pulumi.CustomResource {
     ...
     */
    declare public readonly bindDomains: pulumi.Output<string[]>;
    /**
     ...
     */
    declare public /*out*/ readonly crt: pulumi.Output<string>;
    /**
     * Gateway ID.
     */
    ...
    constructor(name: string, argsOrState?: CngwCertificateArgs | CngwCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["bindDomains"] = args?.bindDomains;
