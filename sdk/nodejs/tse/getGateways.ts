...
export function getGatewaysOutput(args?: GetGatewaysOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewaysResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tse/getGateways:getGateways", {
        "filters": args.filters,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
}
...
export interface GetGatewaysOutputArgs {
     ...
     * filter conditions, valid value:Type,Name,GatewayId,Tag,TradeType,InternetPaymode,Region.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.Tse.GetGatewaysFilterArgs>[] | undefined>;
    /**
     * Used to save results.
     */
