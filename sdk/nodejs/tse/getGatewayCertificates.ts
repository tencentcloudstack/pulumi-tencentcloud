 ...
 * ```
 */
export function getGatewayCertificatesOutput(args: GetGatewayCertificatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayCertificatesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tse/getGatewayCertificates:getGatewayCertificates", {
        "filters": args.filters,
        "gatewayId": args.gatewayId,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
...
export interface GetGatewayCertificatesOutputArgs {
     ...
     * Filter conditions, valid value: `BindDomain`, `Name`.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.Tse.GetGatewayCertificatesFilterArgs>[] | undefined>;
    /**
     * Gateway ID.
     */
