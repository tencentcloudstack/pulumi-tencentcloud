...
export class CngwService extends pulumi.CustomResource {
     ...
     */
    declare public readonly upstreamInfo: pulumi.Output<outputs.Tse.CngwServiceUpstreamInfo>;
    /**
     * service type. Reference value:`Kubernetes`, `Registry`, `IPList`, `HostIP`, `Scf`.
     */
    declare public readonly upstreamType: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: CngwServiceArgs | CngwServiceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["upstreamInfo"] = state?.upstreamInfo;
            ...
            if (args?.upstreamInfo === undefined && !opts.urn) {
                throw new Error("Missing required property 'upstreamInfo'");
            }
            if (args?.upstreamType === undefined && !opts.urn) {
            ...
            resourceInputs["upstreamInfo"] = args?.upstreamInfo;
