 ...
 *
 * const cngwStrategy = new tencentcloud.tse.CngwStrategy("cngw_strategy", {
 *     description: "aaaaa",
...
export class CngwStrategy extends pulumi.CustomResource {
     ...
     */
    declare public readonly config: pulumi.Output<outputs.Tse.CngwStrategyConfig | undefined>;
    /**
     * configuration of timed scaling.
     */
    declare public readonly cronConfig: pulumi.Output<outputs.Tse.CngwStrategyCronConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: CngwStrategyArgs | CngwStrategyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["cronConfig"] = state?.cronConfig;
            ...
            resourceInputs["cronConfig"] = args?.cronConfig;
