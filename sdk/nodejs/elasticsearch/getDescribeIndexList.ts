 ...
 * ```
 */
export function getDescribeIndexListOutput(args: GetDescribeIndexListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDescribeIndexListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Elasticsearch/getDescribeIndexList:getDescribeIndexList", {
        "indexName": args.indexName,
        "indexStatusLists": args.indexStatusLists,
        "indexType": args.indexType,
        "instanceId": args.instanceId,
