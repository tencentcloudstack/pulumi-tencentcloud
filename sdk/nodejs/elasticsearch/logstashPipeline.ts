...
export class LogstashPipeline extends pulumi.CustomResource {
     ...
     */
    declare public readonly opType: pulumi.Output<number>;
    /**
     * Pipeline information.
     */
    declare public readonly pipeline: pulumi.Output<outputs.Elasticsearch.LogstashPipelinePipeline>;
    ...
    constructor(name: string, argsOrState?: LogstashPipelineArgs | LogstashPipelineState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["opType"] = state?.opType;
            ...
            if (args?.opType === undefined && !opts.urn) {
            ...
            resourceInputs["opType"] = args?.opType;
