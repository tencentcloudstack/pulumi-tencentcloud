 ...
 * ```
 */
export function getProbeDataOutput(args: GetProbeDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProbeDataResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cat/getProbeData:getProbeData", {
        "ascending": args.ascending,
        "beginTime": args.beginTime,
        "cities": args.cities,
        "codes": args.codes,
