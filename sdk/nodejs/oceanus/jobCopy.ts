...
export class JobCopy extends pulumi.CustomResource {
     ...
     */
    declare public readonly jobType: pulumi.Output<number | undefined>;
    /**
     ...
     */
    declare public readonly targetClusterId: pulumi.Output<string>;
    /**
     * The directory ID of the new job.
     */
    declare public readonly targetFolderId: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: JobCopyArgs | JobCopyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["targetClusterId"] = state?.targetClusterId;
            resourceInputs["targetFolderId"] = state?.targetFolderId;
            ...
            if (args?.targetClusterId === undefined && !opts.urn) {
            ...
            resourceInputs["targetClusterId"] = args?.targetClusterId;
            resourceInputs["targetFolderId"] = args?.targetFolderId;
