 ...
 * ```
 */
export function getGatewayFlowMonitorDetailOutput(args: GetGatewayFlowMonitorDetailOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGatewayFlowMonitorDetailResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Vpc/getGatewayFlowMonitorDetail:getGatewayFlowMonitorDetail", {
        "directConnectGatewayId": args.directConnectGatewayId,
        "natId": args.natId,
        "orderDirection": args.orderDirection,
        "orderField": args.orderField,
