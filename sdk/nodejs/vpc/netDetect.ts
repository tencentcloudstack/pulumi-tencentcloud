...
export class NetDetect extends pulumi.CustomResource {
     ...
     */
    declare public readonly detectDestinationIps: pulumi.Output<string[]>;
    /**
     * Network probe description.
     */
    declare public readonly netDetectDescription: pulumi.Output<string | undefined>;
    /**
     * Network probe name, the maximum length cannot exceed 60 bytes.
     */
    declare public readonly netDetectName: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly nextHopDestination: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NetDetectArgs | NetDetectState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["detectDestinationIps"] = state?.detectDestinationIps;
            resourceInputs["netDetectDescription"] = state?.netDetectDescription;
            resourceInputs["netDetectName"] = state?.netDetectName;
            resourceInputs["nextHopDestination"] = state?.nextHopDestination;
            resourceInputs["nextHopType"] = state?.nextHopType;
            resourceInputs["subnetId"] = state?.subnetId;
            resourceInputs["vpcId"] = state?.vpcId;
        } else {
            const args = argsOrState as NetDetectArgs | undefined;
            if (args?.detectDestinationIps === undefined && !opts.urn) {
                throw new Error("Missing required property 'detectDestinationIps'");
            }
            if (args?.netDetectName === undefined && !opts.urn) {
            ...
            resourceInputs["detectDestinationIps"] = args?.detectDestinationIps;
            resourceInputs["netDetectDescription"] = args?.netDetectDescription;
            resourceInputs["netDetectName"] = args?.netDetectName;
            resourceInputs["nextHopDestination"] = args?.nextHopDestination;
