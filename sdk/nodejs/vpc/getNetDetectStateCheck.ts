 ...
 * ```
 */
export function getNetDetectStateCheckOutput(args: GetNetDetectStateCheckOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetNetDetectStateCheckResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Vpc/getNetDetectStateCheck:getNetDetectStateCheck", {
        "detectDestinationIps": args.detectDestinationIps,
        "netDetectId": args.netDetectId,
        "netDetectName": args.netDetectName,
        "nextHopDestination": args.nextHopDestination,
