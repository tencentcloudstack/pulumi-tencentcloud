 ...
 * ```
 */
export function getSgSnapshotFileContentOutput(args: GetSgSnapshotFileContentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSgSnapshotFileContentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Vpc/getSgSnapshotFileContent:getSgSnapshotFileContent", {
        "resultOutputFile": args.resultOutputFile,
        "securityGroupId": args.securityGroupId,
        "snapshotFileId": args.snapshotFileId,
        "snapshotPolicyId": args.snapshotPolicyId,
