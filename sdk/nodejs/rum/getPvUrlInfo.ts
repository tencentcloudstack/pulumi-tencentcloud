 ...
 */
export interface GetPvUrlInfoArgs {
    /**
 ...
 */
export interface GetPvUrlInfoResult {
 ...
 * ```
 */
export function getPvUrlInfoOutput(args: GetPvUrlInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPvUrlInfoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getPvUrlInfo:getPvUrlInfo", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "device": args.device,
 ...
 * A collection of arguments for invoking getPvUrlInfo.
 */
export interface GetPvUrlInfoOutputArgs {
    /**
     * The region where the data reporting takes place.
     */
