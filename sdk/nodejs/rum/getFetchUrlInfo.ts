 ...
 */
export interface GetFetchUrlInfoArgs {
    /**
 ...
 */
export interface GetFetchUrlInfoResult {
 ...
 * ```
 */
export function getFetchUrlInfoOutput(args: GetFetchUrlInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFetchUrlInfoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getFetchUrlInfo:getFetchUrlInfo", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "costType": args.costType,
 ...
 * A collection of arguments for invoking getFetchUrlInfo.
 */
export interface GetFetchUrlInfoOutputArgs {
    /**
     * The region where the data reporting takes place.
     */
