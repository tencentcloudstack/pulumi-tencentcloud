 ...
 */
export interface GetStaticUrlArgs {
    /**
 ...
 */
export interface GetStaticUrlResult {
 ...
 * ```
 */
export function getStaticUrlOutput(args: GetStaticUrlOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStaticUrlResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getStaticUrl:getStaticUrl", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "costType": args.costType,
 ...
 * A collection of arguments for invoking getStaticUrl.
 */
export interface GetStaticUrlOutputArgs {
    /**
     * The region where the data reporting takes place.
     */
