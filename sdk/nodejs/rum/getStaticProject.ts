 ...
 *
 * const staticProject = tencentcloud.rum.getStaticProject({
 ...
 * ```
 */
export function getStaticProject(args: GetStaticProjectArgs, opts?: pulumi.InvokeOptions): Promise<GetStaticProjectResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("tencentcloud:Rum/getStaticProject:getStaticProject", {
        "area": args.area,
        "brand": args.brand,
 ...
 */
export interface GetStaticProjectArgs {
    /**
 ...
 */
export interface GetStaticProjectResult {
 ...
 * ```
 */
export function getStaticProjectOutput(args: GetStaticProjectOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStaticProjectResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getStaticProject:getStaticProject", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "costType": args.costType,
 ...
 * A collection of arguments for invoking getStaticProject.
 */
export interface GetStaticProjectOutputArgs {
    /**
     * The region where the data reporting takes place.
     */
