...
export class TawInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly areaId: pulumi.Output<number>;
    /**
     * Billing status (`1` = in use, `2` = expired, `3` = destroyed, `4` = assigning, `5` = failed).
     */
    declare public /*out*/ readonly chargeStatus: pulumi.Output<number>;
    /**
     * Billing type (1: Pay-as-you-go).
     */
    declare public readonly chargeType: pulumi.Output<number>;
    /**
     * Cluster ID.
     */
     ...
     */
    declare public readonly dataRetentionDays: pulumi.Output<number>;
    /**
     * Instance description (up to 1,024 bytes).
     */
    declare public readonly instanceDesc: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TawInstanceArgs | TawInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dataRetentionDays"] = state?.dataRetentionDays;
            ...
            if (args?.areaId === undefined && !opts.urn) {
            ...
            if (args?.dataRetentionDays === undefined && !opts.urn) {
            ...
            resourceInputs["dataRetentionDays"] = args?.dataRetentionDays;
            resourceInputs["instanceDesc"] = args?.instanceDesc;
