...
export function getTawAreaOutput(args?: GetTawAreaOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTawAreaResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getTawArea:getTawArea", {
        "areaIds": args.areaIds,
        "areaKeys": args.areaKeys,
        "areaStatuses": args.areaStatuses,
        "resultOutputFile": args.resultOutputFile,
