 ...
 * ```
 */
export function getPvUrlStatisticsOutput(args: GetPvUrlStatisticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetPvUrlStatisticsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getPvUrlStatistics:getPvUrlStatistics", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "device": args.device,
...
export interface GetPvUrlStatisticsOutputArgs {
     ...
     * Query groupby type `1`: 1m, `2`: 5m, `3`: 30m, `4`: 1h, `5`: 1d.
     */
    groupByType?: pulumi.Input<number | undefined>;
    /**
     * Whether it is non-China region.`1`: yes; `0`: no.
     */
