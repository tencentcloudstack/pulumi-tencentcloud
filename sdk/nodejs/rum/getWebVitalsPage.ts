 ...
 */
export interface GetWebVitalsPageArgs {
    /**
 ...
 */
export interface GetWebVitalsPageResult {
 ...
 * ```
 */
export function getWebVitalsPageOutput(args: GetWebVitalsPageOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWebVitalsPageResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getWebVitalsPage:getWebVitalsPage", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "costType": args.costType,
 ...
 * A collection of arguments for invoking getWebVitalsPage.
 */
export interface GetWebVitalsPageOutputArgs {
    /**
     * The region where the data reporting takes place.
     */
