 ...
 * ```
 */
export function getTawInstanceOutput(args?: GetTawInstanceOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTawInstanceResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getTawInstance:getTawInstance", {
        "areaIds": args.areaIds,
        "chargeStatuses": args.chargeStatuses,
        "chargeTypes": args.chargeTypes,
        "instanceIds": args.instanceIds,
