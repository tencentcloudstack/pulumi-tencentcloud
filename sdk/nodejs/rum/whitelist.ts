...
export class Whitelist extends pulumi.CustomResource {
     ...
     * Business identifier.
     */
    declare public readonly aid: pulumi.Output<string | undefined>;
    /**
     * Creation time.
     */
     ...
     * End time.
     */
    declare public /*out*/ readonly ttl: pulumi.Output<string>;
    /**
     * uin: business identifier.
     */
    declare public readonly whitelistUin: pulumi.Output<string>;
    /**
     * Auto-Increment allowlist ID.
     */
    declare public /*out*/ readonly wid: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: WhitelistArgs | WhitelistState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["aid"] = state?.aid;
            resourceInputs["createTime"] = state?.createTime;
            resourceInputs["createUser"] = state?.createUser;
            resourceInputs["instanceId"] = state?.instanceId;
            resourceInputs["remark"] = state?.remark;
            resourceInputs["ttl"] = state?.ttl;
            resourceInputs["whitelistUin"] = state?.whitelistUin;
            resourceInputs["wid"] = state?.wid;
        } else {
            ...
            if (args?.whitelistUin === undefined && !opts.urn) {
                throw new Error("Missing required property 'whitelistUin'");
            }
            resourceInputs["aid"] = args?.aid;
            resourceInputs["instanceId"] = args?.instanceId;
            resourceInputs["remark"] = args?.remark;
            resourceInputs["whitelistUin"] = args?.whitelistUin;
