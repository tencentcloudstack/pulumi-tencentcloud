 ...
 * ```
 */
export function getCustomUrlOutput(args: GetCustomUrlOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCustomUrlResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getCustomUrl:getCustomUrl", {
        "area": args.area,
        "brand": args.brand,
        "browser": args.browser,
        "costType": args.costType,
