...
export function getLogListOutput(args: GetLogListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetLogListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Rum/getLogList:getLogList", {
        "endTime": args.endTime,
        "orderBy": args.orderBy,
        "projectId": args.projectId,
        "query": args.query,
