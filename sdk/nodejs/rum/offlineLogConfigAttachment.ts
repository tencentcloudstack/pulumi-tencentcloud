...
export class OfflineLogConfigAttachment extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly msg: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly uniqueId: pulumi.Output<string>;
