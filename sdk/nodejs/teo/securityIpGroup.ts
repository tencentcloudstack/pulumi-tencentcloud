 ...
 *
 * const teoSecurityIpGroup = new tencentcloud.teo.SecurityIpGroup("teo_security_ip_group", {
...
export class SecurityIpGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly ipGroup: pulumi.Output<outputs.Teo.SecurityIpGroupIpGroup>;
    /**
     * Site ID.
     */
    ...
    constructor(name: string, argsOrState?: SecurityIpGroupArgs | SecurityIpGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.ipGroup === undefined && !opts.urn) {
