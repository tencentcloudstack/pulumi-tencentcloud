...
export class AsScalingGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Kubernetes/asScalingGroup:AsScalingGroup';
     ...
     */
    public readonly autoScalingConfig!: pulumi.Output<outputs.Kubernetes.AsScalingGroupAutoScalingConfig>;
    /**
     * Auto scaling group parameters.
     */
    public readonly autoScalingGroup!: pulumi.Output<outputs.Kubernetes.AsScalingGroupAutoScalingGroup>;
    /**
     * ID of the cluster.
     */
...
export interface AsScalingGroupState {
     ...
     * Auto scaling config parameters.
     */
    autoScalingConfig?: pulumi.Input<inputs.Kubernetes.AsScalingGroupAutoScalingConfig>;
    /**
     * Auto scaling group parameters.
     */
    autoScalingGroup?: pulumi.Input<inputs.Kubernetes.AsScalingGroupAutoScalingGroup>;
    /**
     * ID of the cluster.
     */
