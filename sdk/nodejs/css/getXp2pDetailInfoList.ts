 ...
 * ```
 */
export function getXp2pDetailInfoListOutput(args?: GetXp2pDetailInfoListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetXp2pDetailInfoListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Css/getXp2pDetailInfoList:getXp2pDetailInfoList", {
        "dimensions": args.dimensions,
        "queryTime": args.queryTime,
        "resultOutputFile": args.resultOutputFile,
        "streamNames": args.streamNames,
