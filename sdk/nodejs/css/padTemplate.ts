...
export class PadTemplate extends pulumi.CustomResource {
     ...
     */
    declare public readonly waitDuration: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: PadTemplateArgs | PadTemplateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["waitDuration"] = state?.waitDuration;
        } else {
            ...
            resourceInputs["waitDuration"] = args?.waitDuration;
        }
