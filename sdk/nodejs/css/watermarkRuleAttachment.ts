 ...
 *
 * const example = new tencentcloud.css.PullStreamTask("example", {
 ...
 * });
 * const exampleWatermark = new tencentcloud.css.Watermark("example", {
 ...
 *     height: 0,
 * });
 * const watermarkRuleAttachment = new tencentcloud.css.WatermarkRuleAttachment("watermark_rule_attachment", {
