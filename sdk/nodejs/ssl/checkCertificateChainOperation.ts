 ...
 *
 * const checkCertificateChain = new tencentcloud.ssl.CheckCertificateChainOperation("check_certificate_chain", {certificateChain: "-----BEGIN CERTIFICATE--·····---END CERTIFICATE-----"});
 * ```
 *
 * ## Import
 *
