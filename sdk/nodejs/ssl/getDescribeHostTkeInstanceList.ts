 ...
 * ```
 */
export function getDescribeHostTkeInstanceListOutput(args: GetDescribeHostTkeInstanceListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDescribeHostTkeInstanceListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Ssl/getDescribeHostTkeInstanceList:getDescribeHostTkeInstanceList", {
        "asyncCache": args.asyncCache,
        "certificateId": args.certificateId,
        "filters": args.filters,
        "isCache": args.isCache,
...
export interface GetDescribeHostTkeInstanceListOutputArgs {
     ...
     * List of filtering parameters; Filterkey: domainmatch.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.Ssl.GetDescribeHostTkeInstanceListFilterArgs>[] | undefined>;
    /**
     * Whether to query the cache, 1: Yes; 0: No, the default is the query cache, the cache is half an hour.
     */
