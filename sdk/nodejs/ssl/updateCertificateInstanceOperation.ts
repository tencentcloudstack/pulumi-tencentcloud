...
export class UpdateCertificateInstanceOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowDownload: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly certificatePublicKey: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly expiringNotificationSwitch: pulumi.Output<number | undefined>;
    /**
     ...
     */
    declare public readonly repeatable: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly resourceTypesRegions: pulumi.Output<outputs.Ssl.UpdateCertificateInstanceOperationResourceTypesRegion[] | undefined>;
    ...
    constructor(name: string, argsOrState?: UpdateCertificateInstanceOperationArgs | UpdateCertificateInstanceOperationState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["allowDownload"] = state?.allowDownload;
            ...
            resourceInputs["expiringNotificationSwitch"] = state?.expiringNotificationSwitch;
            ...
            resourceInputs["resourceTypesRegions"] = state?.resourceTypesRegions;
        } else {
            const args = argsOrState as UpdateCertificateInstanceOperationArgs | undefined;
            if (args?.oldCertificateId === undefined && !opts.urn) {
            ...
            resourceInputs["allowDownload"] = args?.allowDownload;
            ...
            resourceInputs["expiringNotificationSwitch"] = args?.expiringNotificationSwitch;
            ...
            resourceInputs["resourceTypesRegions"] = args?.resourceTypesRegions;
        }
...
export interface UpdateCertificateInstanceOperationState {
     ...
     * Whether to allow downloading, if you choose to upload the certificate, you can configure this parameter.
     */
    allowDownload?: pulumi.Input<boolean | undefined>;
    /**
     * Update new certificate ID.
     */
     ...
     * Whether to ignore expiration reminders for old certificates 0: Do not ignore notifications. 1: Ignore the notification and ignore the OldCertificateId expiration reminder.
     */
    expiringNotificationSwitch?: pulumi.Input<number | undefined>;
    /**
     * Update the original certificate ID.
     */
     ...
     * List of regions where cloud resources need to be deploye.
     */
    resourceTypesRegions?: pulumi.Input<pulumi.Input<inputs.Ssl.UpdateCertificateInstanceOperationResourceTypesRegion>[] | undefined>;
}
