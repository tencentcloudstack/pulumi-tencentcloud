 ...
 * ```
 */
export function getDescribeHostTeoInstanceListOutput(args: GetDescribeHostTeoInstanceListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDescribeHostTeoInstanceListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Ssl/getDescribeHostTeoInstanceList:getDescribeHostTeoInstanceList", {
        "certificateId": args.certificateId,
        "filters": args.filters,
        "isCache": args.isCache,
        "oldCertificateId": args.oldCertificateId,
...
export interface GetDescribeHostTeoInstanceListOutputArgs {
     ...
     * List of filtering parameters; Filterkey: domainmatch.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.Ssl.GetDescribeHostTeoInstanceListFilterArgs>[] | undefined>;
    /**
     * Whether to query the cache, 1: Yes; 0: No, the default is the query cache, the cache is half an hour.
     */
