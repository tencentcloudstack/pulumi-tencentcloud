 ...
 *
 * const updateCertificateRecordRollback = new tencentcloud.ssl.UpdateCertificateRecordRollbackOperation("update_certificate_record_rollback", {deployRecordId: "1603"});
 * ```
 *
 * ## Import
 *
...
export class UpdateCertificateRecordRollbackOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly deployRecordId: pulumi.Output<string | undefined>;
