 ...
 * ```
 */
export function getDescribeHostClbInstanceListOutput(args: GetDescribeHostClbInstanceListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDescribeHostClbInstanceListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Ssl/getDescribeHostClbInstanceList:getDescribeHostClbInstanceList", {
        "asyncCache": args.asyncCache,
        "certificateId": args.certificateId,
        "filters": args.filters,
        "isCache": args.isCache,
...
export interface GetDescribeHostClbInstanceListOutputArgs {
     ...
     * List of filtering parameters; Filterkey: domainmatch.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.Ssl.GetDescribeHostClbInstanceListFilterArgs>[] | undefined>;
    /**
     * Whether to query the cache, 1: Yes; 0: No, the default is the query cache, the cache is half an hour.
     */
