...
export { ClusterTransparentEncryptArgs, ClusterTransparentEncryptState } from "./clusterTransparentEncrypt";
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Cynosdb/auditService:AuditService":
                return new AuditService(name, <any>undefined, { urn })
            case "tencentcloud:Cynosdb/backupConfig:BackupConfig":
            ...
            case "tencentcloud:Cynosdb/ssl:Ssl":
...
pulumi.runtime.registerResourceModule("tencentcloud", "Cynosdb/ssl", _module)
