...
export class InstanceParam extends pulumi.CustomResource {
     ...
     */
    declare public readonly instanceParamLists: pulumi.Output<outputs.Cynosdb.InstanceParamInstanceParamList[] | undefined>;
    /**
     * Yes: modify within the operation and maintenance time window, no: execute immediately (default value).
     */
    declare public readonly isInMaintainPeriod: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: InstanceParamArgs | InstanceParamState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["instanceParamLists"] = state?.instanceParamLists;
            resourceInputs["isInMaintainPeriod"] = state?.isInMaintainPeriod;
        } else {
            ...
            resourceInputs["instanceParamLists"] = args?.instanceParamLists;
            resourceInputs["isInMaintainPeriod"] = args?.isInMaintainPeriod;
        }
