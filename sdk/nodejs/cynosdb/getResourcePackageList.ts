 ...
 * ```
 */
export function getResourcePackageListOutput(args?: GetResourcePackageListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetResourcePackageListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cynosdb/getResourcePackageList:getResourcePackageList", {
        "orderBies": args.orderBies,
        "orderDirection": args.orderDirection,
        "packageIds": args.packageIds,
        "packageNames": args.packageNames,
