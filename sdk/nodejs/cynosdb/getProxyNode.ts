 ...
 * Use this data source to query detailed information of cynosdb proxyNode
 */
export function getProxyNodeOutput(args?: GetProxyNodeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProxyNodeResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cynosdb/getProxyNode:getProxyNode", {
        "filters": args.filters,
        "orderBy": args.orderBy,
        "orderByType": args.orderByType,
        "resultOutputFile": args.resultOutputFile,
