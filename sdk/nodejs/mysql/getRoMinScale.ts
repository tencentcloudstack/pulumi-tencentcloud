 ...
 * ```
 */
export function getRoMinScaleOutput(args?: GetRoMinScaleOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRoMinScaleResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Mysql/getRoMinScale:getRoMinScale", {
        "masterInstanceId": args.masterInstanceId,
        "resultOutputFile": args.resultOutputFile,
        "roInstanceId": args.roInstanceId,
    }, opts);
