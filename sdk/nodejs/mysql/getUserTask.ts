 ...
 * ```
 */
export function getUserTaskOutput(args?: GetUserTaskOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetUserTaskResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Mysql/getUserTask:getUserTask", {
        "asyncRequestId": args.asyncRequestId,
        "instanceId": args.instanceId,
        "resultOutputFile": args.resultOutputFile,
        "startTimeBegin": args.startTimeBegin,
