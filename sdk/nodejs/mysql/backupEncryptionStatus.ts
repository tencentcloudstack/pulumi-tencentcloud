 ...
 *     },
 * });
 * const exampleBackupEncryptionStatus = new tencentcloud.mysql.BackupEncryptionStatus("example", {
...
export class BackupEncryptionStatus extends pulumi.CustomResource {
     ...
     */
    declare public readonly encryptionStatus: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: BackupEncryptionStatusArgs | BackupEncryptionStatusState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["encryptionStatus"] = state?.encryptionStatus;
            resourceInputs["instanceId"] = state?.instanceId;
        } else {
            const args = argsOrState as BackupEncryptionStatusArgs | undefined;
            if (args?.encryptionStatus === undefined && !opts.urn) {
                throw new Error("Missing required property 'encryptionStatus'");
            }
            if (args?.instanceId === undefined && !opts.urn) {
                throw new Error("Missing required property 'instanceId'");
            }
            resourceInputs["encryptionStatus"] = args?.encryptionStatus;
