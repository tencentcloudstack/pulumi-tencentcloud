...
export class DeployGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly deployGroupName: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly devClasses: pulumi.Output<string[] | undefined>;
    /**
     * The limit on the number of instances on the same physical machine in deploy group affinity policy 1.
     */
    declare public readonly limitNum: pulumi.Output<number | undefined>;
    ...
    constructor(name: string, argsOrState?: DeployGroupArgs | DeployGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["deployGroupName"] = state?.deployGroupName;
            resourceInputs["description"] = state?.description;
            resourceInputs["devClasses"] = state?.devClasses;
            resourceInputs["limitNum"] = state?.limitNum;
        } else {
            const args = argsOrState as DeployGroupArgs | undefined;
            if (args?.deployGroupName === undefined && !opts.urn) {
                throw new Error("Missing required property 'deployGroupName'");
            }
            resourceInputs["deployGroupName"] = args?.deployGroupName;
            resourceInputs["description"] = args?.description;
            resourceInputs["devClasses"] = args?.devClasses;
            resourceInputs["limitNum"] = args?.limitNum;
        }
