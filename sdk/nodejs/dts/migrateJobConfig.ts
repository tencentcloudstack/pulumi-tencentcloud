...
export class MigrateJobConfig extends pulumi.CustomResource {
     ...
     */
    declare public readonly completeMode: pulumi.Output<string | undefined>;
    /**
     * job id.
     */
    ...
    constructor(name: string, argsOrState?: MigrateJobConfigArgs | MigrateJobConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["completeMode"] = state?.completeMode;
            ...
            resourceInputs["completeMode"] = args?.completeMode;
