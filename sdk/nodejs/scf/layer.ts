...
export class Layer extends pulumi.CustomResource {
     ...
     */
    declare public readonly content: pulumi.Output<outputs.Scf.LayerContent>;
    /**
     ...
     */
    declare public /*out*/ readonly layerVersion: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: LayerArgs | LayerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["layerVersion"] = state?.layerVersion;
