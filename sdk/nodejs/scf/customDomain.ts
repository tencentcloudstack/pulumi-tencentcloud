 ...
 *
 * const scfCustomDomain = new tencentcloud.scf.CustomDomain("scf_custom_domain", {
 *     domain: "xxxxxx",
 *     protocol: "HTTP",
 *     endpointsConfigs: [{
 *         namespace: "default",
...
export class CustomDomain extends pulumi.CustomResource {
     ...
     */
    declare public readonly certConfig: pulumi.Output<outputs.Scf.CustomDomainCertConfig>;
    /**
     ...
     */
    declare public readonly endpointsConfigs: pulumi.Output<outputs.Scf.CustomDomainEndpointsConfig[]>;
    /**
     ...
     */
    declare public readonly wafConfig: pulumi.Output<outputs.Scf.CustomDomainWafConfig>;
    ...
    constructor(name: string, argsOrState?: CustomDomainArgs | CustomDomainState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["endpointsConfigs"] = state?.endpointsConfigs;
            ...
            if (args?.endpointsConfigs === undefined && !opts.urn) {
            ...
            resourceInputs["endpointsConfigs"] = args?.endpointsConfigs;
