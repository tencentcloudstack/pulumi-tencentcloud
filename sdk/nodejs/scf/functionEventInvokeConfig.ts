 ...
 *
 * const functionEventInvokeConfig = new tencentcloud.scf.FunctionEventInvokeConfig("functionEventInvokeConfig", {
 *     asyncTriggerConfig: {
 *         msgTtl: 24,
 *         retryConfigs: [{
 *             retryNum: 2,
...
export class FunctionEventInvokeConfig extends pulumi.CustomResource {
     ...
     */
    public readonly asyncTriggerConfig!: pulumi.Output<outputs.Scf.FunctionEventInvokeConfigAsyncTriggerConfig>;
    /**
     * Function name.
     */
