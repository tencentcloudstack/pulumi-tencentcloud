 ...
 * ```
 */
export function getInstanceNodesOutput(args: GetInstanceNodesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInstanceNodesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Clickhouse/getInstanceNodes:getInstanceNodes", {
        "displayPolicy": args.displayPolicy,
        "forceAll": args.forceAll,
        "instanceId": args.instanceId,
        "nodeRole": args.nodeRole,
