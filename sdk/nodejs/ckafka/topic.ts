...
export class Topic extends pulumi.CustomResource {
     ...
     */
    declare public readonly cleanUpPolicy: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly forwardCosBucket: pulumi.Output<string>;
    /**
     * Periodic frequency of data backup to cos.
     */
    declare public /*out*/ readonly forwardInterval: pulumi.Output<number>;
    /**
     * Data backup cos status. Valid values: `0`, `1`. `1`: do not open data backup, `0`: open data backup.
     */
    declare public /*out*/ readonly forwardStatus: pulumi.Output<number>;
    /**
     * Ckafka instance ID.
     */
     ...
     */
    declare public readonly maxMessageBytes: pulumi.Output<number>;
    /**
     * Message storage location.
     */
    declare public /*out*/ readonly messageStorageLocation: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly segment: pulumi.Output<number | undefined>;
    /**
     * Number of bytes rolled by shard.
     */
    declare public /*out*/ readonly segmentBytes: pulumi.Output<number>;
    /**
     * Min number of sync replicas, Default is `1`.
     */
    declare public readonly syncReplicaMinNum: pulumi.Output<number | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: TopicArgs | TopicState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["cleanUpPolicy"] = state?.cleanUpPolicy;
            resourceInputs["createTime"] = state?.createTime;
            resourceInputs["enableWhiteList"] = state?.enableWhiteList;
            resourceInputs["forwardCosBucket"] = state?.forwardCosBucket;
            resourceInputs["forwardInterval"] = state?.forwardInterval;
            resourceInputs["forwardStatus"] = state?.forwardStatus;
            resourceInputs["instanceId"] = state?.instanceId;
            resourceInputs["ipWhiteLists"] = state?.ipWhiteLists;
            resourceInputs["maxMessageBytes"] = state?.maxMessageBytes;
            resourceInputs["messageStorageLocation"] = state?.messageStorageLocation;
            resourceInputs["note"] = state?.note;
            resourceInputs["partitionNum"] = state?.partitionNum;
            resourceInputs["replicaNum"] = state?.replicaNum;
            ...
            resourceInputs["syncReplicaMinNum"] = state?.syncReplicaMinNum;
            resourceInputs["topicName"] = state?.topicName;
            resourceInputs["uncleanLeaderElectionEnable"] = state?.uncleanLeaderElectionEnable;
        } else {
