 ...
 *
 * const example = tencentcloud.ckafka.getVersion({
...
export function getVersion(args: GetVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetVersionResult> {
    ...
    return pulumi.runtime.invoke("tencentcloud:Ckafka/getVersion:getVersion", {
...
export interface GetVersionResult {
     ...
     */
    readonly curBrokerVersion: string;
    /**
     ...
     */
    readonly latestBrokerVersions: outputs.Ckafka.GetVersionLatestBrokerVersion[];
...
export function getVersionOutput(args: GetVersionOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVersionResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Ckafka/getVersion:getVersion", {
        "instanceId": args.instanceId,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
}
