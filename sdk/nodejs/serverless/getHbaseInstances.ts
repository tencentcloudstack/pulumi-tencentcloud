...
export function getHbaseInstances(args: GetHbaseInstancesArgs, opts?: pulumi.InvokeOptions): Promise<GetHbaseInstancesResult> {
    ...
    return pulumi.runtime.invoke("tencentcloud:Serverless/getHbaseInstances:getHbaseInstances", {
        "asc": args.asc,
...
export interface GetHbaseInstancesArgs {
     ...
     * Custom query.
     */
    filters?: inputs.Serverless.GetHbaseInstancesFilter[];
    /**
...
export interface GetHbaseInstancesResult {
    ...
    readonly filters?: outputs.Serverless.GetHbaseInstancesFilter[];
    /**
     ...
     */
    readonly instanceLists: outputs.Serverless.GetHbaseInstancesInstanceList[];
 ...
 * ```
 */
export function getHbaseInstancesOutput(args: GetHbaseInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHbaseInstancesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Serverless/getHbaseInstances:getHbaseInstances", {
        "asc": args.asc,
        "displayStrategy": args.displayStrategy,
        "filters": args.filters,
        "orderField": args.orderField,
