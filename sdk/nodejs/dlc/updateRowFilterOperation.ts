 ...
 *
 * const example = new tencentcloud.dlc.UpdateRowFilterOperation("example", {
 *     policyId: 103704,
 *     policy: {
...
export class UpdateRowFilterOperation extends pulumi.CustomResource {
     ...
     */
    declare public readonly policy: pulumi.Output<outputs.Dlc.UpdateRowFilterOperationPolicy>;
    /**
