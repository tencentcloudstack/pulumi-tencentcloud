...
export { AttachDataMaskPolicyArgs, AttachDataMaskPolicyState } from "./attachDataMaskPolicy";
export type AttachDataMaskPolicy = import("./attachDataMaskPolicy").AttachDataMaskPolicy;
...
export { DataMaskStrategyArgs, DataMaskStrategyState } from "./dataMaskStrategy";
export type DataMaskStrategy = import("./dataMaskStrategy").DataMaskStrategy;
export const DataMaskStrategy: typeof import("./dataMaskStrategy").DataMaskStrategy = null as any;
utilities.lazyLoad(exports, ["DataMaskStrategy"], () => require("./dataMaskStrategy"));

export { DatasourceHouseAttachmentArgs, DatasourceHouseAttachmentState } from "./datasourceHouseAttachment";
export type DatasourceHouseAttachment = import("./datasourceHouseAttachment").DatasourceHouseAttachment;
export const DatasourceHouseAttachment: typeof import("./datasourceHouseAttachment").DatasourceHouseAttachment = null as any;
utilities.lazyLoad(exports, ["DatasourceHouseAttachment"], () => require("./datasourceHouseAttachment"));
...
export { GetDataEngineNetworkArgs, GetDataEngineNetworkResult, GetDataEngineNetworkOutputArgs } from "./getDataEngineNetwork";
export const getDataEngineNetwork: typeof import("./getDataEngineNetwork").getDataEngineNetwork = null as any;
export const getDataEngineNetworkOutput: typeof import("./getDataEngineNetwork").getDataEngineNetworkOutput = null as any;
utilities.lazyLoad(exports, ["getDataEngineNetwork","getDataEngineNetworkOutput"], () => require("./getDataEngineNetwork"));

export { GetDataEngineSessionParametersArgs, GetDataEngineSessionParametersResult, GetDataEngineSessionParametersOutputArgs } from "./getDataEngineSessionParameters";
export const getDataEngineSessionParameters: typeof import("./getDataEngineSessionParameters").getDataEngineSessionParameters = null as any;
export const getDataEngineSessionParametersOutput: typeof import("./getDataEngineSessionParameters").getDataEngineSessionParametersOutput = null as any;
utilities.lazyLoad(exports, ["getDataEngineSessionParameters","getDataEngineSessionParametersOutput"], () => require("./getDataEngineSessionParameters"));
...
export { GetEngineNodeSpecificationsArgs, GetEngineNodeSpecificationsResult, GetEngineNodeSpecificationsOutputArgs } from "./getEngineNodeSpecifications";
export const getEngineNodeSpecifications: typeof import("./getEngineNodeSpecifications").getEngineNodeSpecifications = null as any;
export const getEngineNodeSpecificationsOutput: typeof import("./getEngineNodeSpecifications").getEngineNodeSpecificationsOutput = null as any;
utilities.lazyLoad(exports, ["getEngineNodeSpecifications","getEngineNodeSpecificationsOutput"], () => require("./getEngineNodeSpecifications"));

export { GetNativeSparkSessionsArgs, GetNativeSparkSessionsResult, GetNativeSparkSessionsOutputArgs } from "./getNativeSparkSessions";
export const getNativeSparkSessions: typeof import("./getNativeSparkSessions").getNativeSparkSessions = null as any;
export const getNativeSparkSessionsOutput: typeof import("./getNativeSparkSessions").getNativeSparkSessionsOutput = null as any;
utilities.lazyLoad(exports, ["getNativeSparkSessions","getNativeSparkSessionsOutput"], () => require("./getNativeSparkSessions"));

export { GetSessionImageVersionArgs, GetSessionImageVersionResult, GetSessionImageVersionOutputArgs } from "./getSessionImageVersion";
export const getSessionImageVersion: typeof import("./getSessionImageVersion").getSessionImageVersion = null as any;
export const getSessionImageVersionOutput: typeof import("./getSessionImageVersion").getSessionImageVersionOutput = null as any;
utilities.lazyLoad(exports, ["getSessionImageVersion","getSessionImageVersionOutput"], () => require("./getSessionImageVersion"));

export { GetStandardEngineResourceGroupConfigInformationArgs, GetStandardEngineResourceGroupConfigInformationResult, GetStandardEngineResourceGroupConfigInformationOutputArgs } from "./getStandardEngineResourceGroupConfigInformation";
export const getStandardEngineResourceGroupConfigInformation: typeof import("./getStandardEngineResourceGroupConfigInformation").getStandardEngineResourceGroupConfigInformation = null as any;
export const getStandardEngineResourceGroupConfigInformationOutput: typeof import("./getStandardEngineResourceGroupConfigInformation").getStandardEngineResourceGroupConfigInformationOutput = null as any;
utilities.lazyLoad(exports, ["getStandardEngineResourceGroupConfigInformation","getStandardEngineResourceGroupConfigInformationOutput"], () => require("./getStandardEngineResourceGroupConfigInformation"));

export { GetTaskResultArgs, GetTaskResultResult, GetTaskResultOutputArgs } from "./getTaskResult";
export const getTaskResult: typeof import("./getTaskResult").getTaskResult = null as any;
export const getTaskResultOutput: typeof import("./getTaskResult").getTaskResultOutput = null as any;
utilities.lazyLoad(exports, ["getTaskResult","getTaskResultOutput"], () => require("./getTaskResult"));
...
export { StandardEngineResourceGroupArgs, StandardEngineResourceGroupState } from "./standardEngineResourceGroup";
export type StandardEngineResourceGroup = import("./standardEngineResourceGroup").StandardEngineResourceGroup;
export const StandardEngineResourceGroup: typeof import("./standardEngineResourceGroup").StandardEngineResourceGroup = null as any;
utilities.lazyLoad(exports, ["StandardEngineResourceGroup"], () => require("./standardEngineResourceGroup"));

export { StandardEngineResourceGroupConfigInfoArgs, StandardEngineResourceGroupConfigInfoState } from "./standardEngineResourceGroupConfigInfo";
export type StandardEngineResourceGroupConfigInfo = import("./standardEngineResourceGroupConfigInfo").StandardEngineResourceGroupConfigInfo;
export const StandardEngineResourceGroupConfigInfo: typeof import("./standardEngineResourceGroupConfigInfo").StandardEngineResourceGroupConfigInfo = null as any;
utilities.lazyLoad(exports, ["StandardEngineResourceGroupConfigInfo"], () => require("./standardEngineResourceGroupConfigInfo"));
...
export { UserVpcConnectionArgs, UserVpcConnectionState } from "./userVpcConnection";
export type UserVpcConnection = import("./userVpcConnection").UserVpcConnection;
export const UserVpcConnection: typeof import("./userVpcConnection").UserVpcConnection = null as any;
utilities.lazyLoad(exports, ["UserVpcConnection"], () => require("./userVpcConnection"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Dlc/dataMaskStrategy:DataMaskStrategy":
                return new DataMaskStrategy(name, <any>undefined, { urn })
            case "tencentcloud:Dlc/datasourceHouseAttachment:DatasourceHouseAttachment":
                return new DatasourceHouseAttachment(name, <any>undefined, { urn })
            ...
            case "tencentcloud:Dlc/standardEngineResourceGroup:StandardEngineResourceGroup":
                return new StandardEngineResourceGroup(name, <any>undefined, { urn })
            case "tencentcloud:Dlc/standardEngineResourceGroupConfigInfo:StandardEngineResourceGroupConfigInfo":
                return new StandardEngineResourceGroupConfigInfo(name, <any>undefined, { urn })
            ...
            case "tencentcloud:Dlc/userVpcConnection:UserVpcConnection":
                return new UserVpcConnection(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Dlc/dataMaskStrategy", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Dlc/datasourceHouseAttachment", _module)
...
pulumi.runtime.registerResourceModule("tencentcloud", "Dlc/standardEngineResourceGroup", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Dlc/standardEngineResourceGroupConfigInfo", _module)
...
pulumi.runtime.registerResourceModule("tencentcloud", "Dlc/userVpcConnection", _module)
