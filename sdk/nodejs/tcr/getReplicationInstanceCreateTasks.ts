 ...
 * Use this data source to query detailed information of tcr replicationInstanceCreateTasks
 */
export function getReplicationInstanceCreateTasksOutput(args: GetReplicationInstanceCreateTasksOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetReplicationInstanceCreateTasksResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Tcr/getReplicationInstanceCreateTasks:getReplicationInstanceCreateTasks", {
        "replicationRegionId": args.replicationRegionId,
        "replicationRegistryId": args.replicationRegistryId,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
