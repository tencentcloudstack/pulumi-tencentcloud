...
export class Namespace extends pulumi.CustomResource {
     ...
     */
    declare public readonly cveWhitelistItems: pulumi.Output<outputs.Tcr.NamespaceCveWhitelistItem[] | undefined>;
    /**
     ...
     */
    declare public readonly isAutoScan: pulumi.Output<boolean | undefined>;
    /**
     * Blocking switch, `True` is open, `False` is closed. Default is `false`.
     */
    declare public readonly isPreventVul: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: NamespaceArgs | NamespaceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["cveWhitelistItems"] = state?.cveWhitelistItems;
            resourceInputs["instanceId"] = state?.instanceId;
            resourceInputs["isAutoScan"] = state?.isAutoScan;
            resourceInputs["isPreventVul"] = state?.isPreventVul;
            ...
            resourceInputs["cveWhitelistItems"] = args?.cveWhitelistItems;
            resourceInputs["instanceId"] = args?.instanceId;
            resourceInputs["isAutoScan"] = args?.isAutoScan;
            resourceInputs["isPreventVul"] = args?.isPreventVul;
...
export interface NamespaceState {
     ...
     * Vulnerability Whitelist.
     */
    cveWhitelistItems?: pulumi.Input<pulumi.Input<inputs.Tcr.NamespaceCveWhitelistItem>[] | undefined>;
    /**
     * ID of the TCR instance.
     */
     ...
     * Scanning level, `True` is automatic, `False` is manual. Default is `false`.
     */
    isAutoScan?: pulumi.Input<boolean | undefined>;
    /**
     * Blocking switch, `True` is open, `False` is closed. Default is `false`.
     */
    isPreventVul?: pulumi.Input<boolean | undefined>;
    /**
     * Indicate that the namespace is public or not. Default is `false`.
     */
