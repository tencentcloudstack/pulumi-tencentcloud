 ...
 * ```
 */
export function getStoragesSetOutput(args?: GetStoragesSetOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStoragesSetResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cbs/getStoragesSet:getStoragesSet", {
        "availabilityZone": args.availabilityZone,
        "chargeTypes": args.chargeTypes,
        "dedicatedClusterId": args.dedicatedClusterId,
        "instanceIps": args.instanceIps,
