...
export class SnapshotPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly repeatHours!: pulumi.Output<number[]>;
    /**
     * Periodic snapshot is enabled. Valid values: [0, 1, 2, 3, 4, 5, 6]. 0 means Sunday, 1-6 means Monday to Saturday.
     */
    public readonly repeatWeekdays!: pulumi.Output<number[]>;
    /**
    ...
    constructor(name: string, argsOrState?: SnapshotPolicyArgs | SnapshotPolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["repeatHours"] = state ? state.repeatHours : undefined;
            ...
            if ((!args || args.repeatHours === undefined) && !opts.urn) {
            ...
            resourceInputs["repeatHours"] = args ? args.repeatHours : undefined;
