 ...
 * });
 * const eipExample1 = new tencentcloud.eip.Instance("eip_example1", {name: "eip_example1"});
 * const eipExample2 = new tencentcloud.eip.Instance("eip_example2", {name: "eip_example2"});
 * // Create NAT Gateway
 * const myNat = new tencentcloud.nat.Gateway("my_nat", {
 *     vpcId: vpc.id,
 ...
 *     ],
 * });
 * const routeEntry = new tencentcloud.route.TableEntry("route_entry", {
 *     routeTableId: routeTable.id,
 ...
 * const subnetSnat = new tencentcloud.nat.GatewaySnat("subnet_snat", {
 ...
 * const myInstanceSnat = new tencentcloud.nat.GatewaySnat("my_instance_snat", {
 *     natGatewayId: myNat.id,
...
export class GatewaySnat extends pulumi.CustomResource {
     ...
     */
    declare public readonly instancePrivateIpAddr: pulumi.Output<string | undefined>;
    /**
     * NAT gateway ID.
     */
     ...
     */
    declare public readonly publicIpAddrs: pulumi.Output<string[]>;
    /**
     ...
     * SNAT rule ID.
     */
    declare public /*out*/ readonly snatId: pulumi.Output<string>;
    /**
     * The IPv4 CIDR of the subnet, required when `resourceType` is SUBNET.
     */
    declare public readonly subnetCidrBlock: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: GatewaySnatArgs | GatewaySnatState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["instancePrivateIpAddr"] = state?.instancePrivateIpAddr;
            resourceInputs["natGatewayId"] = state?.natGatewayId;
            resourceInputs["publicIpAddrs"] = state?.publicIpAddrs;
            resourceInputs["resourceType"] = state?.resourceType;
            resourceInputs["snatId"] = state?.snatId;
            resourceInputs["subnetCidrBlock"] = state?.subnetCidrBlock;
            ...
            if (args?.publicIpAddrs === undefined && !opts.urn) {
            ...
            resourceInputs["instancePrivateIpAddr"] = args?.instancePrivateIpAddr;
            resourceInputs["natGatewayId"] = args?.natGatewayId;
            resourceInputs["publicIpAddrs"] = args?.publicIpAddrs;
            resourceInputs["resourceType"] = args?.resourceType;
            resourceInputs["subnetCidrBlock"] = args?.subnetCidrBlock;
