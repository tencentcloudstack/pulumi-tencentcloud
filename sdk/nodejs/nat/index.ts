...
export { GatewayFlowMonitorArgs, GatewayFlowMonitorState } from "./gatewayFlowMonitor";
export type GatewayFlowMonitor = import("./gatewayFlowMonitor").GatewayFlowMonitor;
export const GatewayFlowMonitor: typeof import("./gatewayFlowMonitor").GatewayFlowMonitor = null as any;
utilities.lazyLoad(exports, ["GatewayFlowMonitor"], () => require("./gatewayFlowMonitor"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Nat/gatewayFlowMonitor:GatewayFlowMonitor":
                return new GatewayFlowMonitor(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Nat/gatewayFlowMonitor", _module)
