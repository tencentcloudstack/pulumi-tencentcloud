...
export class UserGroupMembers extends pulumi.CustomResource {
     ...
     */
    declare public readonly memberIdSets: pulumi.Output<number[]>;
    /**
     * User Group ID.
     */
    declare public readonly userGroupId: pulumi.Output<number>;
    ...
    constructor(name: string, argsOrState?: UserGroupMembersArgs | UserGroupMembersState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["memberIdSets"] = args?.memberIdSets;
