...
export class GatewaySslClientCert extends pulumi.CustomResource {
     ...
     */
    declare public readonly sslVpnClientId: pulumi.Output<string>;
    /**
     * `on`: Enable, `off`: Disable.
     */
    declare public readonly switch: pulumi.Output<string | undefined>;
