...
export interface GetRecordListResult {
     ...
     * List of records.
     */
    readonly instanceLists: outputs.Dnspod.GetRecordListInstanceList[];
 ...
 * ```
 */
export function getRecordListOutput(args: GetRecordListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRecordListResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Dnspod/getRecordList:getRecordList", {
        "domain": args.domain,
        "domainId": args.domainId,
        "filterAtNs": args.filterAtNs,
        "groupIds": args.groupIds,
