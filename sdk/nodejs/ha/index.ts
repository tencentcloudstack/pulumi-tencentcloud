...
export { VipInstanceAttachmentArgs, VipInstanceAttachmentState } from "./vipInstanceAttachment";
export type VipInstanceAttachment = import("./vipInstanceAttachment").VipInstanceAttachment;
export const VipInstanceAttachment: typeof import("./vipInstanceAttachment").VipInstanceAttachment = null as any;
utilities.lazyLoad(exports, ["VipInstanceAttachment"], () => require("./vipInstanceAttachment"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Ha/vipInstanceAttachment:VipInstanceAttachment":
                return new VipInstanceAttachment(name, <any>undefined, { urn })
            default:
...
pulumi.runtime.registerResourceModule("tencentcloud", "Ha/vipInstanceAttachment", _module)
