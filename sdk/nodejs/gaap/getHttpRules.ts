 ...
 * ```
 */
export function getHttpRulesOutput(args: GetHttpRulesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetHttpRulesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Gaap/getHttpRules:getHttpRules", {
        "domain": args.domain,
        "forwardHost": args.forwardHost,
        "listenerId": args.listenerId,
        "path": args.path,
