 ...
 * ```
 */
export function getProxiesOutput(args?: GetProxiesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetProxiesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Gaap/getProxies:getProxies", {
        "accessRegion": args.accessRegion,
        "ids": args.ids,
        "projectId": args.projectId,
        "realserverRegion": args.realserverRegion,
