...
export class OrgIdentity extends pulumi.CustomResource {
     ...
     */
    declare public readonly identityAliasName: pulumi.Output<string>;
    /**
     * Identity policy list.
     */
    declare public readonly identityPolicies: pulumi.Output<outputs.Organization.OrgIdentityIdentityPolicy[]>;
    ...
    constructor(name: string, argsOrState?: OrgIdentityArgs | OrgIdentityState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["identityAliasName"] = state?.identityAliasName;
            resourceInputs["identityPolicies"] = state?.identityPolicies;
        } else {
            const args = argsOrState as OrgIdentityArgs | undefined;
            if (args?.identityAliasName === undefined && !opts.urn) {
                throw new Error("Missing required property 'identityAliasName'");
            }
            if (args?.identityPolicies === undefined && !opts.urn) {
                throw new Error("Missing required property 'identityPolicies'");
            }
            resourceInputs["description"] = args?.description;
            resourceInputs["identityAliasName"] = args?.identityAliasName;
            resourceInputs["identityPolicies"] = args?.identityPolicies;
        }
