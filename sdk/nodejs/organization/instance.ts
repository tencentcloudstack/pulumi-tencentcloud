...
export class Instance extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly hostUin: pulumi.Output<number>;
    /**
     ...
     */
    declare public /*out*/ readonly isAssignManager: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public /*out*/ readonly isAuthManager: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public /*out*/ readonly isManager: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public /*out*/ readonly orgPermissions: pulumi.Output<outputs.Organization.InstanceOrgPermission[]>;
    /**
     ...
     */
    declare public /*out*/ readonly orgPolicyType: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly payUin: pulumi.Output<string>;
    /**
     * Organize the root node ID.Note: This field may return NULL, indicating that the valid value cannot be obtained.
     */
    declare public /*out*/ readonly rootNodeId: pulumi.Output<number>;
    /**
     * Root node name.
     */
    declare public readonly rootNodeName: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: InstanceArgs | InstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["hostUin"] = state?.hostUin;
            resourceInputs["isAllowQuit"] = state?.isAllowQuit;
            resourceInputs["isAssignManager"] = state?.isAssignManager;
            resourceInputs["isAuthManager"] = state?.isAuthManager;
            resourceInputs["isManager"] = state?.isManager;
            ...
            resourceInputs["orgPolicyType"] = state?.orgPolicyType;
            resourceInputs["orgType"] = state?.orgType;
            resourceInputs["payName"] = state?.payName;
            resourceInputs["payUin"] = state?.payUin;
            resourceInputs["rootNodeId"] = state?.rootNodeId;
            resourceInputs["rootNodeName"] = state?.rootNodeName;
        } else {
            const args = argsOrState as InstanceArgs | undefined;
            resourceInputs["rootNodeName"] = args?.rootNodeName;
