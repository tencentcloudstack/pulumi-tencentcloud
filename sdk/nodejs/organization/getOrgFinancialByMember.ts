 ...
 * ```
 */
export function getOrgFinancialByMemberOutput(args: GetOrgFinancialByMemberOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetOrgFinancialByMemberResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Organization/getOrgFinancialByMember:getOrgFinancialByMember", {
        "endMonth": args.endMonth,
        "memberUins": args.memberUins,
        "month": args.month,
        "productCodes": args.productCodes,
