...
export class ProgramFpgaImage extends pulumi.CustomResource {
     ...
     */
    declare public readonly dbdFs: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    declare public readonly fpgaUrl: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ProgramFpgaImageArgs | ProgramFpgaImageState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dbdFs"] = state?.dbdFs;
            resourceInputs["dryRun"] = state?.dryRun;
            resourceInputs["fpgaUrl"] = state?.fpgaUrl;
            resourceInputs["instanceId"] = state?.instanceId;
        } else {
            const args = argsOrState as ProgramFpgaImageArgs | undefined;
            if (args?.fpgaUrl === undefined && !opts.urn) {
                throw new Error("Missing required property 'fpgaUrl'");
            }
            if (args?.instanceId === undefined && !opts.urn) {
                throw new Error("Missing required property 'instanceId'");
            }
            resourceInputs["dbdFs"] = args?.dbdFs;
            resourceInputs["dryRun"] = args?.dryRun;
            resourceInputs["fpgaUrl"] = args?.fpgaUrl;
