...
export class RebootInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly forceReboot: pulumi.Output<boolean | undefined>;
    /**
     * Instance ID.
     */
    ...
    constructor(name: string, argsOrState?: RebootInstanceArgs | RebootInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["forceReboot"] = state?.forceReboot;
            ...
            resourceInputs["forceReboot"] = args?.forceReboot;
