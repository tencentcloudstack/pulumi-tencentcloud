...
export class UrlPurge extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly purgeHistories: pulumi.Output<outputs.Cdn.UrlPurgePurgeHistory[]>;
    /**
     ...
     */
    declare public readonly urlEncode: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: UrlPurgeArgs | UrlPurgeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["purgeHistories"] = state?.purgeHistories;
            resourceInputs["redo"] = state?.redo;
            resourceInputs["taskId"] = state?.taskId;
            resourceInputs["urlEncode"] = state?.urlEncode;
            ...
            resourceInputs["urlEncode"] = args?.urlEncode;
