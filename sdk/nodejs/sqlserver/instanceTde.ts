 ...
 *     },
 * });
 * const exampleInstanceTde = new tencentcloud.sqlserver.InstanceTde("example", {
...
export class InstanceTde extends pulumi.CustomResource {
     ...
     */
    declare public readonly certificateAttribution: pulumi.Output<string>;
    /**
     * Instance ID.
     */
     ...
     */
    declare public readonly quoteUin: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: InstanceTdeArgs | InstanceTdeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["certificateAttribution"] = state?.certificateAttribution;
            resourceInputs["instanceId"] = state?.instanceId;
            resourceInputs["quoteUin"] = state?.quoteUin;
        } else {
            const args = argsOrState as InstanceTdeArgs | undefined;
            if (args?.certificateAttribution === undefined && !opts.urn) {
                throw new Error("Missing required property 'certificateAttribution'");
            }
            if (args?.instanceId === undefined && !opts.urn) {
                throw new Error("Missing required property 'instanceId'");
            }
            resourceInputs["certificateAttribution"] = args?.certificateAttribution;
            resourceInputs["instanceId"] = args?.instanceId;
            resourceInputs["quoteUin"] = args?.quoteUin;
        }
