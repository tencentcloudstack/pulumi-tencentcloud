 ...
 * ```
 */
export function getBasicInstancesOutput(args?: GetBasicInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBasicInstancesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Sqlserver/getBasicInstances:getBasicInstances", {
        "id": args.id,
        "name": args.name,
        "projectId": args.projectId,
        "resultOutputFile": args.resultOutputFile,
