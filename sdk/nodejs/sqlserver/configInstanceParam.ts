 ...
 *     },
 * });
 * const exampleConfigInstanceParam = new tencentcloud.sqlserver.ConfigInstanceParam("example", {
...
export class ConfigInstanceParam extends pulumi.CustomResource {
     ...
     */
    declare public readonly paramLists: pulumi.Output<outputs.Sqlserver.ConfigInstanceParamParamList[]>;
