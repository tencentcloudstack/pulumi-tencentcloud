 ...
 * ```
 */
export function getBackupCommandsOutput(args: GetBackupCommandsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupCommandsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Sqlserver/getBackupCommands:getBackupCommands", {
        "backupFileType": args.backupFileType,
        "dataBaseName": args.dataBaseName,
        "isRecovery": args.isRecovery,
        "localPath": args.localPath,
