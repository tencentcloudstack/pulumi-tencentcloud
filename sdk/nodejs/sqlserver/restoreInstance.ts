...
export class RestoreInstance extends pulumi.CustomResource {
     ...
     */
    declare public readonly backupId: pulumi.Output<number>;
    /**
     * TDE encryption, `enable` encrypted, `disable` unencrypted.
     */
    declare public /*out*/ readonly encryptions: pulumi.Output<outputs.Sqlserver.RestoreInstanceEncryption[]>;
    /**
     * Instance ID.
     */
     ...
     */
    declare public readonly renameRestores: pulumi.Output<outputs.Sqlserver.RestoreInstanceRenameRestore[]>;
