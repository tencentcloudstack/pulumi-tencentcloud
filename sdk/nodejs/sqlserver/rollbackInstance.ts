...
export class RollbackInstance extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly encryptions: pulumi.Output<outputs.Sqlserver.RollbackInstanceEncryption[]>;
    /**
     * Instance ID.
     */
     ...
     */
    declare public readonly renameRestores: pulumi.Output<outputs.Sqlserver.RollbackInstanceRenameRestore[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RollbackInstanceArgs | RollbackInstanceState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.renameRestores === undefined && !opts.urn) {
