 ...
 * });
 * const exampleBusinessIntelligenceFile = new tencentcloud.sqlserver.BusinessIntelligenceFile("example", {
...
export class BusinessIntelligenceFile extends pulumi.CustomResource {
     ...
     * Cos Url.
     */
    declare public readonly fileUrl: pulumi.Output<string>;
    /**
     * instance id.
     */
    ...
    constructor(name: string, argsOrState?: BusinessIntelligenceFileArgs | BusinessIntelligenceFileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.fileUrl === undefined && !opts.urn) {
