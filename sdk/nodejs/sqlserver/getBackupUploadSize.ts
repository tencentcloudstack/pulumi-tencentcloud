 ...
 * ```
 */
export function getBackupUploadSizeOutput(args: GetBackupUploadSizeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupUploadSizeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Sqlserver/getBackupUploadSize:getBackupUploadSize", {
        "backupMigrationId": args.backupMigrationId,
        "incrementalMigrationId": args.incrementalMigrationId,
        "instanceId": args.instanceId,
        "resultOutputFile": args.resultOutputFile,
