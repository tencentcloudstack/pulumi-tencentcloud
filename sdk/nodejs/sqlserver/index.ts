...
export { GetCollationTimeZoneArgs, GetCollationTimeZoneResult, GetCollationTimeZoneOutputArgs } from "./getCollationTimeZone";
export const getCollationTimeZone: typeof import("./getCollationTimeZone").getCollationTimeZone = null as any;
export const getCollationTimeZoneOutput: typeof import("./getCollationTimeZone").getCollationTimeZoneOutput = null as any;
utilities.lazyLoad(exports, ["getCollationTimeZone","getCollationTimeZoneOutput"], () => require("./getCollationTimeZone"));
...
export { WanIpConfigArgs, WanIpConfigState } from "./wanIpConfig";
export type WanIpConfig = import("./wanIpConfig").WanIpConfig;
export const WanIpConfig: typeof import("./wanIpConfig").WanIpConfig = null as any;
utilities.lazyLoad(exports, ["WanIpConfig"], () => require("./wanIpConfig"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Sqlserver/wanIpConfig:WanIpConfig":
                return new WanIpConfig(name, <any>undefined, { urn })
            default:
...
pulumi.runtime.registerResourceModule("tencentcloud", "Sqlserver/wanIpConfig", _module)
