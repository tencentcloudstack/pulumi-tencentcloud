...
export class DdosGeoIpBlockConfig extends pulumi.CustomResource {
     ...
     */
    declare public readonly ddosGeoIpBlockConfig: pulumi.Output<outputs.Antiddos.DdosGeoIpBlockConfigDdosGeoIpBlockConfig>;
    /**
     * InstanceId.
     */
    ...
    constructor(name: string, argsOrState?: DdosGeoIpBlockConfigArgs | DdosGeoIpBlockConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ddosGeoIpBlockConfig"] = state?.ddosGeoIpBlockConfig;
            resourceInputs["instanceId"] = state?.instanceId;
        } else {
            const args = argsOrState as DdosGeoIpBlockConfigArgs | undefined;
            if (args?.ddosGeoIpBlockConfig === undefined && !opts.urn) {
                throw new Error("Missing required property 'ddosGeoIpBlockConfig'");
            }
            if (args?.instanceId === undefined && !opts.urn) {
                throw new Error("Missing required property 'instanceId'");
            }
            resourceInputs["ddosGeoIpBlockConfig"] = args?.ddosGeoIpBlockConfig;
