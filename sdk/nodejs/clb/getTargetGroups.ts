 ...
 * });
 * const ruleBasic = new tencentcloud.clb.ListenerRule("rule_basic", {
 *     clbId: clbBasic.id,
 ...
 * ```
 */
export function getTargetGroupsOutput(args?: GetTargetGroupsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetGroupsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Clb/getTargetGroups:getTargetGroups", {
        "resultOutputFile": args.resultOutputFile,
        "targetGroupId": args.targetGroupId,
        "targetGroupName": args.targetGroupName,
        "vpcId": args.vpcId,
