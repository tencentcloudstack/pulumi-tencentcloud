...
export class FunctionTargetsAttachment extends pulumi.CustomResource {
     ...
     */
    declare public readonly functionTargets: pulumi.Output<outputs.Clb.FunctionTargetsAttachmentFunctionTargets>;
    /**
    ...
    constructor(name: string, argsOrState?: FunctionTargetsAttachmentArgs | FunctionTargetsAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["functionTargets"] = state?.functionTargets;
            ...
            if (args?.functionTargets === undefined && !opts.urn) {
            ...
            resourceInputs["functionTargets"] = args?.functionTargets;
