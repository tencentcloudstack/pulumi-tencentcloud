...
export { CustomizedConfigAttachmentArgs, CustomizedConfigAttachmentState } from "./customizedConfigAttachment";
export type CustomizedConfigAttachment = import("./customizedConfigAttachment").CustomizedConfigAttachment;
export const CustomizedConfigAttachment: typeof import("./customizedConfigAttachment").CustomizedConfigAttachment = null as any;
utilities.lazyLoad(exports, ["CustomizedConfigAttachment"], () => require("./customizedConfigAttachment"));

export { CustomizedConfigV2Args, CustomizedConfigV2State } from "./customizedConfigV2";
export type CustomizedConfigV2 = import("./customizedConfigV2").CustomizedConfigV2;
export const CustomizedConfigV2: typeof import("./customizedConfigV2").CustomizedConfigV2 = null as any;
utilities.lazyLoad(exports, ["CustomizedConfigV2"], () => require("./customizedConfigV2"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Clb/clsLogAttachment:ClsLogAttachment":
            ...
            case "tencentcloud:Clb/customizedConfigAttachment:CustomizedConfigAttachment":
                return new CustomizedConfigAttachment(name, <any>undefined, { urn })
            case "tencentcloud:Clb/customizedConfigV2:CustomizedConfigV2":
                return new CustomizedConfigV2(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Clb/clsLogAttachment", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Clb/customizedConfig", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Clb/customizedConfigAttachment", _module)
pulumi.runtime.registerResourceModule("tencentcloud", "Clb/customizedConfigV2", _module)
