 ...
 * ```
 */
export function getIdleInstancesOutput(args?: GetIdleInstancesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIdleInstancesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Clb/getIdleInstances:getIdleInstances", {
        "loadBalancerRegion": args.loadBalancerRegion,
        "resultOutputFile": args.resultOutputFile,
    }, opts);
}
