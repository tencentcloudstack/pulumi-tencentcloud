 ...
 *
 * const instanceConfig = new tencentcloud.dcdb.InstanceConfig("instance_config", {
 *     instanceId: dcdbId,
 *     rsAccessStrategy: 0,
 * });
 * ```
...
export class InstanceConfig extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tencentcloud:Dcdb/instanceConfig:InstanceConfig';
    ...
    constructor(name: string, argsOrState?: InstanceConfigArgs | InstanceConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.rsAccessStrategy === undefined && !opts.urn) {
