 ...
 * Use this data source to query detailed information of dcdb databaseTables
 */
export function getDatabaseTablesOutput(args: GetDatabaseTablesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDatabaseTablesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Dcdb/getDatabaseTables:getDatabaseTables", {
        "dbName": args.dbName,
        "instanceId": args.instanceId,
        "resultOutputFile": args.resultOutputFile,
        "table": args.table,
