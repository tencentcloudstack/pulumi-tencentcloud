 ...
 * ```
 */
export function getBucketMultipartUploadsOutput(args: GetBucketMultipartUploadsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBucketMultipartUploadsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Cos/getBucketMultipartUploads:getBucketMultipartUploads", {
        "bucket": args.bucket,
        "delimiter": args.delimiter,
        "encodingType": args.encodingType,
        "prefix": args.prefix,
