...
export class Batch extends pulumi.CustomResource {
     ...
     */
    declare public readonly confirmationRequired: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly manifest: pulumi.Output<outputs.Cos.BatchManifest>;
    /**
     * Select the action to be performed on the objects in the manifest file.
     */
    declare public readonly operation: pulumi.Output<outputs.Cos.BatchOperation>;
    /**
     ...
     */
    declare public readonly report: pulumi.Output<outputs.Cos.BatchReport>;
    /**
     ...
     * Uin.
     */
    declare public readonly uin: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: BatchArgs | BatchState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["confirmationRequired"] = state?.confirmationRequired;
            ...
            resourceInputs["report"] = state?.report;
