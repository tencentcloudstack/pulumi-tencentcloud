...
export class RenewDisk extends pulumi.CustomResource {
     ...
     */
    declare public readonly renewDiskChargePrepaid: pulumi.Output<outputs.Lighthouse.RenewDiskRenewDiskChargePrepaid>;
    ...
    constructor(name: string, argsOrState?: RenewDiskArgs | RenewDiskState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["renewDiskChargePrepaid"] = state?.renewDiskChargePrepaid;
        } else {
            const args = argsOrState as RenewDiskArgs | undefined;
            if (args?.diskId === undefined && !opts.urn) {
                throw new Error("Missing required property 'diskId'");
            }
            if (args?.renewDiskChargePrepaid === undefined && !opts.urn) {
            ...
            resourceInputs["renewDiskChargePrepaid"] = args?.renewDiskChargePrepaid;
        }
