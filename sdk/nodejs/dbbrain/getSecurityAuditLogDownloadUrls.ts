 ...
 * ```
 */
export function getSecurityAuditLogDownloadUrlsOutput(args: GetSecurityAuditLogDownloadUrlsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSecurityAuditLogDownloadUrlsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Dbbrain/getSecurityAuditLogDownloadUrls:getSecurityAuditLogDownloadUrls", {
        "asyncRequestId": args.asyncRequestId,
        "product": args.product,
        "resultOutputFile": args.resultOutputFile,
        "secAuditGroupId": args.secAuditGroupId,
