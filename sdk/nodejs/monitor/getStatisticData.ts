...
export function getStatisticDataOutput(args: GetStatisticDataOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetStatisticDataResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Monitor/getStatisticData:getStatisticData", {
        "conditions": args.conditions,
        "groupBys": args.groupBys,
        "metricNames": args.metricNames,
        "module": args.module,
