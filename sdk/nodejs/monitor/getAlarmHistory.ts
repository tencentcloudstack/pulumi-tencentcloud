 ...
 * ```
 */
export function getAlarmHistoryOutput(args: GetAlarmHistoryOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmHistoryResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Monitor/getAlarmHistory:getAlarmHistory", {
        "alarmLevels": args.alarmLevels,
        "alarmObject": args.alarmObject,
        "alarmStatuses": args.alarmStatuses,
        "content": args.content,
