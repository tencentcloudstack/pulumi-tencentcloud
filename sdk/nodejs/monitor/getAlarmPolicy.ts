 ...
 * ```
 */
export function getAlarmPolicyOutput(args: GetAlarmPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAlarmPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Monitor/getAlarmPolicy:getAlarmPolicy", {
        "dimensions": args.dimensions,
        "enables": args.enables,
        "field": args.field,
        "instanceGroupId": args.instanceGroupId,
