 ...
 * const fooTmpTkeTemplate = new tencentcloud.monitor.TmpTkeTemplate("foo", {template: {
 *     name: "tf-template",
 *     level: "cluster",
 *     describe: "template",
 *     serviceMonitors: [{
...
export class TmpTkeTemplateAttachment extends pulumi.CustomResource {
     ...
     * Sync target details.
     */
    declare public readonly targets: pulumi.Output<outputs.Monitor.TmpTkeTemplateAttachmentTargets>;
    /**
