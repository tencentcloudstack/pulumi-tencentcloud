...
export { TmpExporterIntegrationV2Args, TmpExporterIntegrationV2State } from "./tmpExporterIntegrationV2";
export type TmpExporterIntegrationV2 = import("./tmpExporterIntegrationV2").TmpExporterIntegrationV2;
export const TmpExporterIntegrationV2: typeof import("./tmpExporterIntegrationV2").TmpExporterIntegrationV2 = null as any;
utilities.lazyLoad(exports, ["TmpExporterIntegrationV2"], () => require("./tmpExporterIntegrationV2"));
...
export { TmpMultipleWritesListArgs, TmpMultipleWritesListState } from "./tmpMultipleWritesList";
export type TmpMultipleWritesList = import("./tmpMultipleWritesList").TmpMultipleWritesList;
export const TmpMultipleWritesList: typeof import("./tmpMultipleWritesList").TmpMultipleWritesList = null as any;
utilities.lazyLoad(exports, ["TmpMultipleWritesList"], () => require("./tmpMultipleWritesList"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "tencentcloud:Monitor/tmpExporterIntegrationV2:TmpExporterIntegrationV2":
                return new TmpExporterIntegrationV2(name, <any>undefined, { urn })
            ...
            case "tencentcloud:Monitor/tmpMultipleWritesList:TmpMultipleWritesList":
                return new TmpMultipleWritesList(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Monitor/tmpExporterIntegrationV2", _module)
...
pulumi.runtime.registerResourceModule("tencentcloud", "Monitor/tmpMultipleWritesList", _module)
