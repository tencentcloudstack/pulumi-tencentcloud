...
export class Export extends pulumi.CustomResource {
     ...
     * export start time.
     */
    declare public readonly from: pulumi.Output<number>;
    /**
     * export amount of log.
     */
    declare public readonly logCount: pulumi.Output<number>;
    /**
     ...
     * export end time.
     */
    declare public readonly to: pulumi.Output<number>;
    /**
     * topic id.
     */
    ...
    constructor(name: string, argsOrState?: ExportArgs | ExportState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.logCount === undefined && !opts.urn) {
            ...
            resourceInputs["logCount"] = args?.logCount;
