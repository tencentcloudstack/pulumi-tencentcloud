 ...
 * import * as tencentcloud from "@tencentcloud_iac/pulumi";
 *
 * const groupOstype = new tencentcloud.cls.MachineGroup("group_ostype", {
 *     groupName: "group",
 *     serviceLogging: true,
 *     ostype: 1,
 *     tags: {
...
export class MachineGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly metaTags: pulumi.Output<{[key: string]: string}>;
    /**
     * Operating system type. Valid values: 0 (Linux), 1 (Windows).
     */
    declare public readonly ostype: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: MachineGroupArgs | MachineGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["metaTags"] = state?.metaTags;
            ...
            resourceInputs["metaTags"] = args?.metaTags;
...
export interface MachineGroupState {
     ...
     * Type of the machine group to be created.
     */
    machineGroupType?: pulumi.Input<inputs.Cls.MachineGroupMachineGroupType | undefined>;
    /**
     * Machine group metadata information list, stored as key-value pairs.
     */
    metaTags?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
    /**
     * Operating system type. Valid values: 0 (Linux), 1 (Windows).
     */
    ostype?: pulumi.Input<number | undefined>;
    /**
     * Whether to enable the service log to record the logs generated by the LogListener service itself. After it is enabled, the internal logset clsServiceLogging and the loglistener_status, loglistener_alarm, and loglistenerBusiness log topics will be created, which will not incur fees.
     */
