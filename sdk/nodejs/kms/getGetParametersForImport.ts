 ...
 * ```
 */
export function getGetParametersForImportOutput(args: GetGetParametersForImportOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetGetParametersForImportResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Kms/getGetParametersForImport:getGetParametersForImport", {
        "keyId": args.keyId,
        "resultOutputFile": args.resultOutputFile,
        "wrappingAlgorithm": args.wrappingAlgorithm,
        "wrappingKeySpec": args.wrappingKeySpec,
