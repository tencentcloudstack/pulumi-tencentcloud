...
// Export members:
export { ExtraTemplateArgs, ExtraTemplateState } from "./extraTemplate";
export type ExtraTemplate = import("./extraTemplate").ExtraTemplate;
export const ExtraTemplate: typeof import("./extraTemplate").ExtraTemplate = null as any;
utilities.lazyLoad(exports, ["ExtraTemplate"], () => require("./extraTemplate"));
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "tencentcloud:Address/extraTemplate:ExtraTemplate":
                return new ExtraTemplate(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("tencentcloud", "Address/extraTemplate", _module)
