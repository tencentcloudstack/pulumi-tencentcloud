 ...
 *
 * const identityCenterRoleConfigurationPermissionCustomPoliciesAttachment = new tencentcloud.identity.CenterRoleConfigurationPermissionCustomPoliciesAttachment("identity_center_role_configuration_permission_custom_policies_attachment", {
 *     zoneId: "z-xxxxxx",
...
export class CenterRoleConfigurationPermissionCustomPoliciesAttachment extends pulumi.CustomResource {
     ...
     * Policies.
     */
    declare public readonly policies: pulumi.Output<outputs.Identity.CenterRoleConfigurationPermissionCustomPoliciesAttachmentPolicy[]>;
    /**
...
export interface CenterRoleConfigurationPermissionCustomPoliciesAttachmentState {
     ...
     * Policies.
     */
    policies?: pulumi.Input<pulumi.Input<inputs.Identity.CenterRoleConfigurationPermissionCustomPoliciesAttachmentPolicy>[] | undefined>;
    /**
     * Permission configuration ID.
     */
