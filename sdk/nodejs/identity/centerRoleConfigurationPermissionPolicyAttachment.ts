...
export class CenterRoleConfigurationPermissionPolicyAttachment extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly rolePolicyDocument: pulumi.Output<string>;
    /**
     * Role policy id.
     */
    declare public readonly rolePolicyId: pulumi.Output<number>;
    /**
     * Role policy name.
     */
    ...
    constructor(name: string, argsOrState?: CenterRoleConfigurationPermissionPolicyAttachmentArgs | CenterRoleConfigurationPermissionPolicyAttachmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["rolePolicyId"] = state?.rolePolicyId;
            ...
            if (args?.rolePolicyId === undefined && !opts.urn) {
            ...
            resourceInputs["rolePolicyId"] = args?.rolePolicyId;
