 ...
 * ```
 */
export function getBackupDownloadInfoOutput(args: GetBackupDownloadInfoOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupDownloadInfoResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("tencentcloud:Redis/getBackupDownloadInfo:getBackupDownloadInfo", {
        "backupId": args.backupId,
        "instanceId": args.instanceId,
        "ipComparisonSymbol": args.ipComparisonSymbol,
        "limitIps": args.limitIps,
