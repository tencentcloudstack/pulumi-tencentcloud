...
__all__ = [
    'SnapshotByTimeOffsetTemplatesResult',
    'AwaitableSnapshotByTimeOffsetTemplatesResult',
    'snapshot_by_time_offset_templates',
    'snapshot_by_time_offset_templates_output',
]

@pulumi.output_type
class SnapshotByTimeOffsetTemplatesResult:
    """
    ...
    def template_lists(self) -> Sequence['outputs.SnapshotByTimeOffsetTemplatesTemplateListResult']:
...
class AwaitableSnapshotByTimeOffsetTemplatesResult(SnapshotByTimeOffsetTemplatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return SnapshotByTimeOffsetTemplatesResult(
...
def snapshot_by_time_offset_templates(definition: Optional[str] = None,
                                      result_output_file: Optional[str] = None,
                                      sub_app_id: Optional[int] = None,
                                      type: Optional[str] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableSnapshotByTimeOffsetTemplatesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Vod/snapshotByTimeOffsetTemplates:SnapshotByTimeOffsetTemplates', __args__, opts=opts, typ=SnapshotByTimeOffsetTemplatesResult).value

    return AwaitableSnapshotByTimeOffsetTemplatesResult(
...
@_utilities.lift_output_func(snapshot_by_time_offset_templates)
def snapshot_by_time_offset_templates_output(definition: Optional[pulumi.Input[Optional[str]]] = None,
                                             result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                             sub_app_id: Optional[pulumi.Input[Optional[int]]] = None,
                                             type: Optional[pulumi.Input[Optional[str]]] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[SnapshotByTimeOffsetTemplatesResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
