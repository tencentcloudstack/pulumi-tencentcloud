...
__all__ = [
    'ImageSpriteTemplatesResult',
    'AwaitableImageSpriteTemplatesResult',
    'image_sprite_templates',
    'image_sprite_templates_output',
]

@pulumi.output_type
class ImageSpriteTemplatesResult:
    """
    ...
    def template_lists(self) -> Sequence['outputs.ImageSpriteTemplatesTemplateListResult']:
...
class AwaitableImageSpriteTemplatesResult(ImageSpriteTemplatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return ImageSpriteTemplatesResult(
...
def image_sprite_templates(definition: Optional[str] = None,
                           result_output_file: Optional[str] = None,
                           sub_app_id: Optional[int] = None,
                           type: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableImageSpriteTemplatesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Vod/imageSpriteTemplates:ImageSpriteTemplates', __args__, opts=opts, typ=ImageSpriteTemplatesResult).value

    return AwaitableImageSpriteTemplatesResult(
...
@_utilities.lift_output_func(image_sprite_templates)
def image_sprite_templates_output(definition: Optional[pulumi.Input[Optional[str]]] = None,
                                  result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                  sub_app_id: Optional[pulumi.Input[Optional[int]]] = None,
                                  type: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[ImageSpriteTemplatesResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
