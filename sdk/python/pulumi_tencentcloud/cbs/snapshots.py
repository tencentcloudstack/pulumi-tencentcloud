...
class SnapshotsResult:
    ...
    def snapshot_lists(self) -> Sequence['outputs.SnapshotsSnapshotListResult']:
...
def snapshots(availability_zone: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cbs/snapshots:Snapshots', __args__, opts=opts, typ=SnapshotsResult).value
...
def snapshots_output(availability_zone: Optional[pulumi.Input[Optional[str]]] = None,
