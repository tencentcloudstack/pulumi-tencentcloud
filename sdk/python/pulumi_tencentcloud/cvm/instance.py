...
class InstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] bandwidth_package_id: bandwidth package id. if user is standard user, then the bandwidth_package_id is needed, or default has
        ...
        :param pulumi.Input[bool] disable_security_service: Disable enhance service for security, it is enabled by default. When this options is set, security agent won't be
               installed. Modifying will cause the instance reset.
        :param pulumi.Input[bool] force_delete: Indicate whether to force delete the instance. Default is `false`. If set true, the instance will be permanently deleted
               instead of being moved into the recycle bin. Note: only works for `PREPAID` instance.
        :param pulumi.Input[str] hostname: The hostname of the instance. Windows instance: The name should be a combination of 2 to 15 characters comprised of
        ...
        :param pulumi.Input[str] internet_charge_type: Internet charge type of the instance, Valid values are `BANDWIDTH_PREPAID`, `TRAFFIC_POSTPAID_BY_HOUR`,
               `BANDWIDTH_POSTPAID_BY_HOUR` and `BANDWIDTH_PACKAGE`. This value does not need to be set when `allocate_public_ip` is
               false.
        :param pulumi.Input[int] internet_max_bandwidth_out: Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bits per second). This value does not need to
               be set when `allocate_public_ip` is false.
        :param pulumi.Input[bool] keep_image_login: Whether to keep image login or not, default is `false`. When the image type is private or shared or imported, this
        ...
        :param pulumi.Input[str] stopped_mode: Billing method of a pay-as-you-go instance after shutdown. Available values: `KEEP_CHARGING`,`STOP_CHARGING`. Default
               `KEEP_CHARGING`.
        ...
        :param pulumi.Input[str] system_disk_id: System disk snapshot ID used to initialize the system disk. When system disk type is `LOCAL_BASIC` and `LOCAL_SSD`, disk
               id is not supported.
        :param pulumi.Input[int] system_disk_size: Size of the system disk. Valid value ranges: (50~1000). and unit is GB. Default is 50GB. If modified, the instance may
               force stop.
        ...
        :param pulumi.Input[Mapping[str, Any]] tags: A mapping of tags to assign to the resource. For tag limits, please refer to [Use
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Instance, __self__).__init__(
            'tencentcloud:Cvm/instance:Instance',
            resource_name,
            __props__,
            opts)
