...
def images(image_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cvm/images:Images', __args__, opts=opts, typ=ImagesResult).value
...
def images_output(image_id: Optional[pulumi.Input[Optional[str]]] = None,
