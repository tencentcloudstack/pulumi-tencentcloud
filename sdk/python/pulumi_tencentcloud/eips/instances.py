...
class InstancesResult:
    ...
    def eip_lists(self) -> Sequence['outputs.InstancesEipListResult']:
...
def instances(eip_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Eips/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
...
def instances_output(eip_id: Optional[pulumi.Input[Optional[str]]] = None,
