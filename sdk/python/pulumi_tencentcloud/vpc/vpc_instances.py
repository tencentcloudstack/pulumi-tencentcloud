...
__all__ = [
    'VpcInstancesResult',
    'AwaitableVpcInstancesResult',
    'vpc_instances',
    'vpc_instances_output',
]

@pulumi.output_type
class VpcInstancesResult:
    """
    ...
    def instance_lists(self) -> Sequence['outputs.VpcInstancesInstanceListResult']:
...
class AwaitableVpcInstancesResult(VpcInstancesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return VpcInstancesResult(
...
def vpc_instances(cidr_block: Optional[str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableVpcInstancesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Vpc/vpcInstances:VpcInstances', __args__, opts=opts, typ=VpcInstancesResult).value

    return AwaitableVpcInstancesResult(
...
@_utilities.lift_output_func(vpc_instances)
def vpc_instances_output(cidr_block: Optional[pulumi.Input[Optional[str]]] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[VpcInstancesResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
