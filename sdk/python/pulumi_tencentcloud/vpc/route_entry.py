...
class RouteEntryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] next_type: Type of next-hop. Valid values: `CVM`, `VPN`, `DIRECTCONNECT`, `PEERCONNECTION`, `SSLVPN`, `NAT`, `NORMAL_CVM`, `EIP`
               and `CCN`.
...
class RouteEntry(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(RouteEntry, __self__).__init__(
            'tencentcloud:Vpc/routeEntry:RouteEntry',
            resource_name,
            __props__,
            opts)
