...
def instances(ccn_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Ccn/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
...
def instances_output(ccn_id: Optional[pulumi.Input[Optional[str]]] = None,
