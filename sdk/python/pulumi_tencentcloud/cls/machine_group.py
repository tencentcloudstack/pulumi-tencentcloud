...
class MachineGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] service_logging: Whether to enable the service log to record the logs generated by the LogListener service itself. After it is enabled,
