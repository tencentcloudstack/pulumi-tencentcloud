...
class InstancesResult:
    ...
    def cdh_instance_lists(self) -> Sequence['outputs.InstancesCdhInstanceListResult']:
...
def instances(availability_zone: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cdh/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
