...
__all__ = ['GatewayCcnRouteInstanceArgs', 'GatewayCcnRouteInstance']

@pulumi.input_type
class GatewayCcnRouteInstanceArgs:
...
@pulumi.input_type
class _GatewayCcnRouteInstanceState:
    def __init__(__self__, *,
...
class GatewayCcnRouteInstance(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a GatewayCcnRouteInstance resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: GatewayCcnRouteInstanceArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a GatewayCcnRouteInstance resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param GatewayCcnRouteInstanceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GatewayCcnRouteInstanceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GatewayCcnRouteInstanceArgs.__new__(GatewayCcnRouteInstanceArgs)
        ...
        super(GatewayCcnRouteInstance, __self__).__init__(
            'tencentcloud:Dc/gatewayCcnRouteInstance:GatewayCcnRouteInstance',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            as_paths: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            cidr_block: Optional[pulumi.Input[str]] = None,
            dcg_id: Optional[pulumi.Input[str]] = None) -> 'GatewayCcnRouteInstance':
        """
        ...
        __props__ = _GatewayCcnRouteInstanceState.__new__(_GatewayCcnRouteInstanceState)

        __props__.__dict__["as_paths"] = as_paths
        __props__.__dict__["cidr_block"] = cidr_block
        __props__.__dict__["dcg_id"] = dcg_id
        return GatewayCcnRouteInstance(resource_name, opts=opts, __props__=__props__)
