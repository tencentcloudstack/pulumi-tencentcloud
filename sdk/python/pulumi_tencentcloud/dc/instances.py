...
def instances(dc_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Dc/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
...
def instances_output(dc_id: Optional[pulumi.Input[Optional[str]]] = None,
