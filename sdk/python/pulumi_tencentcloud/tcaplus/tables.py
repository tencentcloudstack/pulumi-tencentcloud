...
class TablesResult:
    ...
    @property
    @pulumi.getter
    def lists(self) -> Sequence['outputs.TablesListResult']:
...
class AwaitableTablesResult(TablesResult):
...
def tables(cluster_id: Optional[str] = None,
           result_output_file: Optional[str] = None,
           table_id: Optional[str] = None,
           table_name: Optional[str] = None,
           tablegroup_id: Optional[str] = None,
           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableTablesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Tcaplus/tables:Tables', __args__, opts=opts, typ=TablesResult).value

    return AwaitableTablesResult(
...
@_utilities.lift_output_func(tables)
def tables_output(cluster_id: Optional[pulumi.Input[str]] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[TablesResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
