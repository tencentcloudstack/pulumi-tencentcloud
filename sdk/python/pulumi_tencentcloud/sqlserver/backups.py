...
class BackupsResult:
    ...
    @property
    @pulumi.getter
    def lists(self) -> Sequence['outputs.BackupsListResult']:
...
def backups(end_time: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Sqlserver/backups:Backups', __args__, opts=opts, typ=BackupsResult).value
...
def backups_output(end_time: Optional[pulumi.Input[str]] = None,
