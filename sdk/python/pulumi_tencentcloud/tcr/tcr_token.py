...
class TcrToken(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a TcrToken resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
        ...
        Create a TcrToken resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param TcrTokenArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TcrTokenArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TcrTokenArgs.__new__(TcrTokenArgs)
        ...
        super(TcrToken, __self__).__init__(
            'tencentcloud:Tcr/tcrToken:TcrToken',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            token: Optional[pulumi.Input[str]] = None,
            token_id: Optional[pulumi.Input[str]] = None,
            user_name: Optional[pulumi.Input[str]] = None) -> 'TcrToken':
        """
        ...
        __props__ = _TcrTokenState.__new__(_TcrTokenState)
        ...
        return TcrToken(resource_name, opts=opts, __props__=__props__)
