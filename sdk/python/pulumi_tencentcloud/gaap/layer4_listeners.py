...
__all__ = [
    'Layer4ListenersResult',
    'AwaitableLayer4ListenersResult',
    'layer4_listeners',
    'layer4_listeners_output',
]

@pulumi.output_type
class Layer4ListenersResult:
    """
    ...
    @property
    @pulumi.getter
    def listeners(self) -> Sequence['outputs.Layer4ListenersListenerResult']:
...
class AwaitableLayer4ListenersResult(Layer4ListenersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return Layer4ListenersResult(
            id=self.id,
...
def layer4_listeners(listener_id: Optional[str] = None,
                     listener_name: Optional[str] = None,
                     port: Optional[int] = None,
                     protocol: Optional[str] = None,
                     proxy_id: Optional[str] = None,
                     result_output_file: Optional[str] = None,
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableLayer4ListenersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Gaap/layer4Listeners:Layer4Listeners', __args__, opts=opts, typ=Layer4ListenersResult).value

    return AwaitableLayer4ListenersResult(
        id=__ret__.id,
...
@_utilities.lift_output_func(layer4_listeners)
def layer4_listeners_output(listener_id: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[Layer4ListenersResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
