...
class GroupsResult:
    ...
    def group_lists(self) -> Sequence['outputs.GroupsGroupListResult']:
...
def groups(group_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cam/groups:Groups', __args__, opts=opts, typ=GroupsResult).value
