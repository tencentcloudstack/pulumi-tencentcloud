...
class RolesResult:
    ...
    def role_lists(self) -> Sequence['outputs.RolesRoleListResult']:
...
def roles(description: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cam/roles:Roles', __args__, opts=opts, typ=RolesResult).value
...
def roles_output(description: Optional[pulumi.Input[Optional[str]]] = None,
