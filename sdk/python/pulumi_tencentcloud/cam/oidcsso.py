...
class OIDCSSOArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] authorization_endpoint: Authorization request Endpoint, OpenID Connect identity provider authorization address. Corresponds to the value of the
        ...
        :param pulumi.Input[str] identity_key: The signature public key requires base64_encode. Verify the public key signed by the OpenID Connect identity provider ID
               Token. For the security of your account, we recommend that you rotate the signed public key regularly.
        :param pulumi.Input[str] identity_url: Identity provider URL. OpenID Connect identity provider identity.Corresponds to the value of the `issuer` field in the
        ...
        :param pulumi.Input[str] response_mode: Authorize the request Forsonse mode. Authorization request return mode, form_post and frogment two optional modes,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] scopes: Authorize the request Scope. openid; email; profile; Authorization request information scope. The default is required
               openid.
        """
...
class OIDCSSO(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a OIDCSSO resource with the given unique name, props, and options.
