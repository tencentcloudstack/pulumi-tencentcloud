...
__all__ = [
    'GroupPolicyAttachmentsResult',
    'AwaitableGroupPolicyAttachmentsResult',
    'group_policy_attachments',
    'group_policy_attachments_output',
]

@pulumi.output_type
class GroupPolicyAttachmentsResult:
    """
    ...
    def group_policy_attachment_lists(self) -> Sequence['outputs.GroupPolicyAttachmentsGroupPolicyAttachmentListResult']:
...
class AwaitableGroupPolicyAttachmentsResult(GroupPolicyAttachmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GroupPolicyAttachmentsResult(
...
def group_policy_attachments(create_mode: Optional[int] = None,
                             group_id: Optional[str] = None,
                             policy_id: Optional[str] = None,
                             policy_type: Optional[str] = None,
                             result_output_file: Optional[str] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGroupPolicyAttachmentsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cam/groupPolicyAttachments:GroupPolicyAttachments', __args__, opts=opts, typ=GroupPolicyAttachmentsResult).value

    return AwaitableGroupPolicyAttachmentsResult(
...
@_utilities.lift_output_func(group_policy_attachments)
def group_policy_attachments_output(create_mode: Optional[pulumi.Input[Optional[int]]] = None,
                                    group_id: Optional[pulumi.Input[str]] = None,
                                    policy_id: Optional[pulumi.Input[Optional[str]]] = None,
                                    policy_type: Optional[pulumi.Input[Optional[str]]] = None,
                                    result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GroupPolicyAttachmentsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
