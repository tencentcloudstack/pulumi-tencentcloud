...
class UserPolicyAttachmentsResult:
    ...
    def user_policy_attachment_lists(self) -> Sequence['outputs.UserPolicyAttachmentsUserPolicyAttachmentListResult']:
...
def user_policy_attachments(create_mode: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Cam/userPolicyAttachments:UserPolicyAttachments', __args__, opts=opts, typ=UserPolicyAttachmentsResult).value
...
def user_policy_attachments_output(create_mode: Optional[pulumi.Input[Optional[int]]] = None,
