...
__all__ = [
    'L4RulesV2Result',
    'AwaitableL4RulesV2Result',
    'l4_rules_v2',
    'l4_rules_v2_output',
]

@pulumi.output_type
class L4RulesV2Result:
    """
    ...
    @property
    @pulumi.getter
    def lists(self) -> Sequence['outputs.L4RulesV2ListResult']:
...
class AwaitableL4RulesV2Result(L4RulesV2Result):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return L4RulesV2Result(
...
def l4_rules_v2(business: Optional[str] = None,
                ip: Optional[str] = None,
                result_output_file: Optional[str] = None,
                virtual_port: Optional[int] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableL4RulesV2Result:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Dayu/l4RulesV2:L4RulesV2', __args__, opts=opts, typ=L4RulesV2Result).value

    return AwaitableL4RulesV2Result(
...
@_utilities.lift_output_func(l4_rules_v2)
def l4_rules_v2_output(business: Optional[pulumi.Input[str]] = None,
                       ip: Optional[pulumi.Input[Optional[str]]] = None,
                       result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                       virtual_port: Optional[pulumi.Input[Optional[int]]] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[L4RulesV2Result]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
