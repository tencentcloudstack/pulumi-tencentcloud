...
class NodePoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: Name of the node pool. The name does not exceed 25 characters, and only supports Chinese, English, numbers, underscores,
               separators (`-`) and decimal points.
        :param pulumi.Input['NodePoolNodeConfigArgs'] node_config: Node config.
        :param pulumi.Input[str] node_os: Operating system of the cluster, the available values include: `tlinux2.4x86_64`, `ubuntu18.04.1x86_64`, `ubuntu16.04.1
...
class NodePool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(NodePool, __self__).__init__(
            'tencentcloud:Tke/nodePool:NodePool',
            resource_name,
            __props__,
            opts)
