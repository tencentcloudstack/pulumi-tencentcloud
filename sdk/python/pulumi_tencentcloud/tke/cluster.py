...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] claim_expired_seconds: Claim expired seconds to recycle ENI. This field can only set when field `network_type` is 'VPC-CNI'.
               `claim_expired_seconds` must greater or equal than 300 and less than 15768000.
        :param pulumi.Input[bool] cluster_as_enabled: Indicates whether to enable cluster node auto scaling. Default is false.
        ...
        :param pulumi.Input[str] cluster_cidr: A network address block of the cluster. Different from vpc cidr and cidr of other clusters within this vpc. Must be in
               10./192.168/172.[16-31] segments.
        :param pulumi.Input[str] cluster_deploy_type: Deployment type of the cluster, the available values include: 'MANAGED_CLUSTER' and 'INDEPENDENT_CLUSTER'. Default is
               'MANAGED_CLUSTER'.
        ...
        :param pulumi.Input[bool] cluster_internet: Open internet access or not. If this field is set 'true', the field below `worker_config` must be set. Because only
        ...
        :param pulumi.Input[bool] cluster_intranet: Open intranet access or not. If this field is set 'true', the field below `worker_config` must be set. Because only
               cluster with node is allowed enable access endpoint.
        :param pulumi.Input[str] cluster_intranet_subnet_id: Subnet id who can access this independent cluster, this field must and can only set when `cluster_intranet` is true.
        ...
        :param pulumi.Input[str] cluster_level: Specify cluster level, valid for managed cluster, use data source `tencentcloud_kubernetes_cluster_levels` to query
               available levels. Available value examples `L5`, `L20`, `L50`, `L100`, etc.
        :param pulumi.Input[int] cluster_max_pod_num: The maximum number of Pods per node in the cluster. Default is 256. The minimum value is 4. When its power unequal to 2,
               it will round upward to the closest power of 2.
        :param pulumi.Input[int] cluster_max_service_num: The maximum number of services in the cluster. Default is 256. The range is from 32 to 32768. When its power unequal to
               2, it will round upward to the closest power of 2.
        :param pulumi.Input[str] cluster_name: Name of the cluster.
        :param pulumi.Input[str] cluster_os: Operating system of the cluster, the available values include:
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] eni_subnet_ids: Subnet Ids for cluster with VPC-CNI network mode. This field can only set when field `network_type` is 'VPC-CNI'.
        ...
        :param pulumi.Input[int] globe_desired_pod_num: Indicate to set desired pod number in node. valid when enable_customized_pod_cidr=true, and it takes effect for all
               nodes.
        ...
        :param pulumi.Input[str] kube_proxy_mode: Cluster kube-proxy mode, the available values include: 'kube-proxy-bpf'. Default is not set.When set to kube-proxy-bpf,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] managed_cluster_internet_security_policies: Security policies for managed cluster internet, like:'192.168.1.0/24' or '113.116.51.27', '0.0.0.0/0' means all. This
        ...
        :param pulumi.Input[str] service_cidr: A network address block of the service. Different from vpc cidr and cidr of other clusters within this vpc. Must be in
               10./192.168/172.[16-31] segments.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ClusterWorkerConfigArgs']]] worker_configs: Deploy the machine configuration information of the 'WORKER' service, and create <=20 units for common users. The other
...
class Cluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[bool] upgrade_instances_follow_cluster: Indicates whether upgrade all instances when cluster_version change. Default is false.
        :param pulumi.Input[str] vpc_id: Vpc Id of the cluster.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['ClusterWorkerConfigArgs']]]] worker_configs: Deploy the machine configuration information of the 'WORKER' service, and create <=20 units for common users. The other
               'WORK' service are added by 'tencentcloud_kubernetes_worker'.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        super(Cluster, __self__).__init__(
            'tencentcloud:Tke/cluster:Cluster',
            resource_name,
            __props__,
            opts)
