...
class InstancesResult:
    ...
    def dnat_lists(self) -> Sequence['outputs.InstancesDnatListResult']:
...
def instances(description: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Dnats/instances:Instances', __args__, opts=opts, typ=InstancesResult).value
