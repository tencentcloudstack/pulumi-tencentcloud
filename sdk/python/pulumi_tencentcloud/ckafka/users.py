...
def users(account_name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Ckafka/users:Users', __args__, opts=opts, typ=UsersResult).value
...
def users_output(account_name: Optional[pulumi.Input[Optional[str]]] = None,
