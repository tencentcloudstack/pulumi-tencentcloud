...
class GatewaysResult:
    ...
    @property
    @pulumi.getter
    def nats(self) -> Sequence['outputs.GatewaysNatResult']:
...
def gateways(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Nat/gateways:Gateways', __args__, opts=opts, typ=GatewaysResult).value
...
def gateways_output(id: Optional[pulumi.Input[Optional[str]]] = None,
