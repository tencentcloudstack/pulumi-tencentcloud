...
__all__ = [
    'GatewaySnatsResult',
    'AwaitableGatewaySnatsResult',
    'gateway_snats',
    'gateway_snats_output',
]

@pulumi.output_type
class GatewaySnatsResult:
    """
    ...
    def snat_lists(self) -> Sequence['outputs.GatewaySnatsSnatListResult']:
...
class AwaitableGatewaySnatsResult(GatewaySnatsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GatewaySnatsResult(
...
def gateway_snats(description: Optional[str] = None,
                  instance_id: Optional[str] = None,
                  nat_gateway_id: Optional[str] = None,
                  public_ip_addrs: Optional[Sequence[str]] = None,
                  result_output_file: Optional[str] = None,
                  subnet_id: Optional[str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGatewaySnatsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Nat/gatewaySnats:GatewaySnats', __args__, opts=opts, typ=GatewaySnatsResult).value

    return AwaitableGatewaySnatsResult(
...
@_utilities.lift_output_func(gateway_snats)
def gateway_snats_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                         instance_id: Optional[pulumi.Input[Optional[str]]] = None,
                         nat_gateway_id: Optional[pulumi.Input[str]] = None,
                         public_ip_addrs: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                         result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                         subnet_id: Optional[pulumi.Input[Optional[str]]] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GatewaySnatsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
