...
class AwaitableInfoResult(InfoResult):
...
def info(result_output_file: Optional[str] = None,
         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableInfoResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:User/info:Info', __args__, opts=opts, typ=InfoResult).value

    return AwaitableInfoResult(
...
@_utilities.lift_output_func(info)
def info_output(result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[InfoResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
