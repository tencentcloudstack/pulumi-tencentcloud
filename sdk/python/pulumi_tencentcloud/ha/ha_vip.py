...
class HaVipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vip: Virtual IP address, it must not be occupied and in this VPC network segment. If not set, it will be assigned after
