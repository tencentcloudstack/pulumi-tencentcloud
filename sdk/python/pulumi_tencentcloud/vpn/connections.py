...
class ConnectionsResult:
    ...
    def connection_lists(self) -> Sequence['outputs.ConnectionsConnectionListResult']:
...
def connections(customer_gateway_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Vpn/connections:Connections', __args__, opts=opts, typ=ConnectionsResult).value
