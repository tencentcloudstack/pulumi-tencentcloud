...
class GatewaysResult:
    ...
    def gateway_lists(self) -> Sequence['outputs.GatewaysGatewayListResult']:
...
def gateways(id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Vpn/gateways:Gateways', __args__, opts=opts, typ=GatewaysResult).value
