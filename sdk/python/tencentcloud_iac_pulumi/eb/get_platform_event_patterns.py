...
class GetPlatformEventPatternsResult:
    ...
    def event_patterns(
        self,
    ) -> Sequence["outputs.GetPlatformEventPatternsEventPatternResult"]:
        """
...
def get_platform_event_patterns(
    product_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eb/getPlatformEventPatterns:getPlatformEventPatterns",
        __args__,
        opts=opts,
        typ=GetPlatformEventPatternsResult,
    ).value
...
def get_platform_event_patterns_output(
    product_type: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetPlatformEventPatternsResult]:
    """
    Use this data source to query detailed information of eb platform_event_patterns
    ...
    return __ret__.apply(
        lambda __response__: GetPlatformEventPatternsResult(
