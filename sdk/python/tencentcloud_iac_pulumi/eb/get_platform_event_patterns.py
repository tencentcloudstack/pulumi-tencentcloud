...
def get_platform_event_patterns(product_type: Optional[_builtins.str] = None,
...
def get_platform_event_patterns_output(product_type: Optional[pulumi.Input[_builtins.str]] = None,
                                       result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPlatformEventPatternsResult]:
    """
    Use this data source to query detailed information of eb platform_event_patterns
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Eb/getPlatformEventPatterns:getPlatformEventPatterns', __args__, opts=opts, typ=GetPlatformEventPatternsResult)
    return __ret__.apply(lambda __response__: GetPlatformEventPatternsResult(
        event_patterns=pulumi.get(__response__, 'event_patterns'),
