...
def get_event_rules(event_bus_id: Optional[_builtins.str] = None,
...
def get_event_rules_output(event_bus_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Eb/getEventRules:getEventRules', __args__, opts=opts, typ=GetEventRulesResult)
