...
class EventConnectorConnectionDescriptionArgsDict(TypedDict):
    ...
    """
    api_gw_params: NotRequired[
        pulumi.Input[Optional["EventConnectorConnectionDescriptionApiGwParamsArgsDict"]]
    ]
    """
    apigw parameter,Note: This field may return null, indicating that no valid value can be obtained.
    """
    ckafka_params: NotRequired[
        pulumi.Input[
            Optional["EventConnectorConnectionDescriptionCkafkaParamsArgsDict"]
        ]
    ]
    """
...
class EventConnectorConnectionDescriptionArgs:
    def __init__(
        ...
        *,
        resource_description: pulumi.Input[_builtins.str],
        api_gw_params: pulumi.Input[
            Optional["EventConnectorConnectionDescriptionApiGwParamsArgs"]
        ] = None,
        ckafka_params: pulumi.Input[
            Optional["EventConnectorConnectionDescriptionCkafkaParamsArgs"]
        ] = None
    ):
        """
    ...
    def api_gw_params(
        self,
    ) -> pulumi.Input[Optional["EventConnectorConnectionDescriptionApiGwParamsArgs"]]:
        """
        apigw parameter,Note: This field may return null, indicating that no valid value can be obtained.
        """
    ...
    def ckafka_params(
        self,
    ) -> pulumi.Input[Optional["EventConnectorConnectionDescriptionCkafkaParamsArgs"]]:
        """
        ckafka parameter, note: this field may return null, indicating that no valid value can be obtained.
        """
...
class EventTargetTargetDescriptionArgsDict(TypedDict):
    ...
    """
    ckafka_target_params: NotRequired[
        pulumi.Input[Optional["EventTargetTargetDescriptionCkafkaTargetParamsArgsDict"]]
    ]
    """
    Ckafka parameters.
    """
    es_target_params: NotRequired[
        pulumi.Input[Optional["EventTargetTargetDescriptionEsTargetParamsArgsDict"]]
    ]
    """
    ElasticSearch parameters.
    """
    scf_params: NotRequired[
        pulumi.Input[Optional["EventTargetTargetDescriptionScfParamsArgsDict"]]
    ]
    """
...
class EventTargetTargetDescriptionArgs:
    def __init__(
        ...
        *,
        resource_description: pulumi.Input[_builtins.str],
        ckafka_target_params: pulumi.Input[
            Optional["EventTargetTargetDescriptionCkafkaTargetParamsArgs"]
        ] = None,
        es_target_params: pulumi.Input[
            Optional["EventTargetTargetDescriptionEsTargetParamsArgs"]
        ] = None,
        scf_params: pulumi.Input[
            Optional["EventTargetTargetDescriptionScfParamsArgs"]
        ] = None
    ):
        """
    ...
    def ckafka_target_params(
        self,
    ) -> pulumi.Input[Optional["EventTargetTargetDescriptionCkafkaTargetParamsArgs"]]:
        """
        Ckafka parameters.
        """
    ...
    def es_target_params(
        self,
    ) -> pulumi.Input[Optional["EventTargetTargetDescriptionEsTargetParamsArgs"]]:
        """
        ElasticSearch parameters.
        """
    ...
    def es_target_params(
        self,
        value: pulumi.Input[Optional["EventTargetTargetDescriptionEsTargetParamsArgs"]],
    ):
    ...
    def scf_params(
        self,
    ) -> pulumi.Input[Optional["EventTargetTargetDescriptionScfParamsArgs"]]:
        """
        cloud function parameters.
        """
...
class EventTargetTargetDescriptionCkafkaTargetParamsArgs:
    ...
    def retry_policy(
        self,
    ) -> pulumi.Input["EventTargetTargetDescriptionCkafkaTargetParamsRetryPolicyArgs"]:
        """
        retry strategy.
        """
...
class EventTargetTargetDescriptionEsTargetParamsArgsDict(TypedDict):
    ...
    """
    index_template_type: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    es template type.
    """
...
class EventTargetTargetDescriptionEsTargetParamsArgs:
    def __init__(
        ...
        *,
        ...
        output_mode: pulumi.Input[_builtins.str],
        rotation_interval: pulumi.Input[_builtins.str],
        index_template_type: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def index_template_type(self) -> pulumi.Input[_builtins.str | None]:
        """
        es template type.
        """
    ...
    def index_template_type(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "index_template_type", value)


class EventTargetTargetDescriptionScfParamsArgsDict(TypedDict):
    batch_event_count: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    ...
    """
    batch_timeout: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    ...
    """
    enable_batch_delivery: NotRequired[pulumi.Input[_builtins.bool | None]]
    """
...
class EventTargetTargetDescriptionScfParamsArgs:
    def __init__(
        __self__,
        *,
        batch_event_count: pulumi.Input[_builtins.int | None] = None,
        batch_timeout: pulumi.Input[_builtins.int | None] = None,
        enable_batch_delivery: pulumi.Input[_builtins.bool | None] = None
    ):
        """
    ...
    def batch_event_count(self) -> pulumi.Input[_builtins.int | None]:
        """
        Maximum number of events for batch delivery. This parameter is no longer effective, please use the batch_event_count parameter at the outer level.
        """
    ...
    def batch_event_count(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "batch_event_count", value)

    @_builtins.property
    @pulumi.getter(name="batchTimeout")
    def batch_timeout(self) -> pulumi.Input[_builtins.int | None]:
        """
        Maximum waiting time for batch delivery. This parameter is no longer effective, please use the batch_timeout parameter at the outer level.
        """
    ...
    def batch_timeout(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "batch_timeout", value)

    @_builtins.property
    @pulumi.getter(name="enableBatchDelivery")
    def enable_batch_delivery(self) -> pulumi.Input[_builtins.bool | None]:
        """
        Enable batch delivery. This parameter is no longer effective, please use the enable_batch_delivery parameter at the outer level.
        """
    ...
    def enable_batch_delivery(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "enable_batch_delivery", value)


class EventTransformTransformationArgsDict(TypedDict):
    etl_filter: NotRequired[
        pulumi.Input[Optional["EventTransformTransformationEtlFilterArgsDict"]]
    ]
    """
    Describe how to filter data.
    """
    extraction: NotRequired[
        pulumi.Input[Optional["EventTransformTransformationExtractionArgsDict"]]
    ]
    """
    Describe how to extract data.
    """
    transform: NotRequired[
        pulumi.Input[Optional["EventTransformTransformationTransformArgsDict"]]
    ]
    """
...
class EventTransformTransformationArgs:
    def __init__(
        __self__,
        *,
        etl_filter: pulumi.Input[
            Optional["EventTransformTransformationEtlFilterArgs"]
        ] = None,
        extraction: pulumi.Input[
            Optional["EventTransformTransformationExtractionArgs"]
        ] = None,
        transform: pulumi.Input[
            Optional["EventTransformTransformationTransformArgs"]
        ] = None
    ):
        """
    ...
    def etl_filter(
        self,
    ) -> pulumi.Input[Optional["EventTransformTransformationEtlFilterArgs"]]:
        """
        Describe how to filter data.
        """
    ...
    @etl_filter.setter
    def etl_filter(
        self, value: pulumi.Input[Optional["EventTransformTransformationEtlFilterArgs"]]
    ):
    ...
    def extraction(
        self,
    ) -> pulumi.Input[Optional["EventTransformTransformationExtractionArgs"]]:
        """
        Describe how to extract data.
        """
    ...
    def extraction(
        self,
        value: pulumi.Input[Optional["EventTransformTransformationExtractionArgs"]],
    ):
    ...
    def transform(
        self,
    ) -> pulumi.Input[Optional["EventTransformTransformationTransformArgs"]]:
        """
        Describe how to convert data.
        """
    ...
    @transform.setter
    def transform(
        self, value: pulumi.Input[Optional["EventTransformTransformationTransformArgs"]]
    ):
...
class EventTransformTransformationEtlFilterArgs:
    def __init__(__self__, *, filter: pulumi.Input[_builtins.str]):
        """
...
class EventTransformTransformationExtractionArgsDict(TypedDict):
    ...
    Value: `TEXT`, `JSON`.
    """
    text_params: NotRequired[
        pulumi.Input[
            Optional["EventTransformTransformationExtractionTextParamsArgsDict"]
        ]
    ]
    """
...
class EventTransformTransformationExtractionArgs:
    def __init__(
        ...
        *,
        extraction_input_path: pulumi.Input[_builtins.str],
        format: pulumi.Input[_builtins.str],
        text_params: pulumi.Input[
            Optional["EventTransformTransformationExtractionTextParamsArgs"]
        ] = None
    ):
        """
    ...
    def text_params(
        self,
    ) -> pulumi.Input[Optional["EventTransformTransformationExtractionTextParamsArgs"]]:
        """
        Only Text needs to be passed.
        """
...
class EventTransformTransformationExtractionTextParamsArgsDict(TypedDict):
    ...
    """
    separator: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class EventTransformTransformationExtractionTextParamsArgs:
    def __init__(
        ...
        *,
        ...
        separator: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def separator(self) -> pulumi.Input[_builtins.str | None]:
        """
        `Comma`, `|`, `tab`, `space`, `newline`, `%`, `#`, the limit length is 1.
        """
    ...
    @separator.setter
    def separator(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "separator", value)


class EventTransformTransformationTransformArgsDict(TypedDict):
    output_structs: pulumi.Input[
        Sequence[
            pulumi.Input["EventTransformTransformationTransformOutputStructArgsDict"]
        ]
    ]
    """
...
class EventTransformTransformationTransformArgs:
    def __init__(
        ...
        *,
        output_structs: pulumi.Input[
            Sequence[
                pulumi.Input["EventTransformTransformationTransformOutputStructArgs"]
            ]
        ]
    ):
        """
    ...
    def output_structs(
        ...
        Sequence[pulumi.Input["EventTransformTransformationTransformOutputStructArgs"]]
    ]:
        """
        Describe how the data is transformed.
        """
...
class PutEventsEventListArgsDict(TypedDict):
    ...
    """
    time: NotRequired[pulumi.Input[_builtins.int | None]]
    """
...
class PutEventsEventListArgs:
    def __init__(
        ...
        *,
        ...
        subject: pulumi.Input[_builtins.str],
        type: pulumi.Input[_builtins.str],
        time: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def time(self) -> pulumi.Input[_builtins.int | None]:
        """
        The timestamp in milliseconds when the event occurred,time.Now().UnixNano()/1e6.
        """
    ...
    @time.setter
    def time(self, value: pulumi.Input[_builtins.int | None]):
...
class GetSearchFilterArgs:
    def __init__(
        __self__,
        *,
        filters: Sequence["GetSearchFilterFilterArgs"] | None = None,
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["GetSearchFilterFilterArgs"] | None:
        """
        LogFilters array.
        """
    ...
    @filters.setter
    def filters(self, value: Sequence["GetSearchFilterFilterArgs"] | None):
...
class GetSearchFilterFilterArgs:
    def __init__(
        __self__, *, key: _builtins.str, operator: _builtins.str, value: _builtins.str
    ):
        """
        :param _builtins.str key: filter field name.
