...
class GetPlatformProductsResult:
    ...
    def platform_products(
        self,
    ) -> Sequence["outputs.GetPlatformProductsPlatformProductResult"]:
        """
...
def get_platform_products(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eb/getPlatformProducts:getPlatformProducts",
        __args__,
        opts=opts,
        typ=GetPlatformProductsResult,
    ).value
...
def get_platform_products_output(
    ...
    return __ret__.apply(
        lambda __response__: GetPlatformProductsResult(
