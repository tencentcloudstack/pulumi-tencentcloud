...
class GetPlatformEventNamesResult:
    ...
    def __init__(
        __self__, event_names=None, id=None, product_type=None, result_output_file=None
    ):
...
def get_platform_event_names(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eb/getPlatformEventNames:getPlatformEventNames",
        __args__,
        opts=opts,
        typ=GetPlatformEventNamesResult,
    ).value
...
def get_platform_event_names_output(
...
) -> pulumi.Output[GetPlatformEventNamesResult]:
    """
    Use this data source to query detailed information of eb platform_event_names
    ...
    return __ret__.apply(
        lambda __response__: GetPlatformEventNamesResult(
