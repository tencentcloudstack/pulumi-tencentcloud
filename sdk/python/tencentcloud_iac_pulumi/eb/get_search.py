...
class GetSearchResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetSearchFilterResult"] | None:
        return pulumi.get(self, "filters")

    @_builtins.property
    @pulumi.getter(name="groupField")
    def group_field(self) -> _builtins.str | None:
    ...
    def order_fields(self) -> Sequence[_builtins.str] | None:
...
def get_search(
    ...
    event_bus_id: _builtins.str | None = None,
    filters: (
        Sequence[Union["GetSearchFilterArgs", "GetSearchFilterArgsDict"]] | None
    ) = None,
    group_field: _builtins.str | None = None,
    order_by: _builtins.str | None = None,
    order_fields: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eb/getSearch:getSearch", __args__, opts=opts, typ=GetSearchResult
    ).value
...
def get_search_output(
    ...
    order_fields: pulumi.Input[Sequence[_builtins.str] | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetSearchResult(
