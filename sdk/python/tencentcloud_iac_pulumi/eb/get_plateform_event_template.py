...
class GetPlateformEventTemplateResult:
    ...
    def __init__(
        __self__, event_template=None, event_type=None, id=None, result_output_file=None
    ):
...
def get_plateform_event_template(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eb/getPlateformEventTemplate:getPlateformEventTemplate",
        __args__,
        opts=opts,
        typ=GetPlateformEventTemplateResult,
    ).value
...
def get_plateform_event_template_output(
...
) -> pulumi.Output[GetPlateformEventTemplateResult]:
    """
    Use this data source to query detailed information of eb plateform_event_template
    ...
    return __ret__.apply(
        lambda __response__: GetPlateformEventTemplateResult(
