...
class GetInstanceNodesResult:
    ...
    def display_policy(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "display_policy")

    @_builtins.property
    @pulumi.getter(name="forceAll")
    def force_all(self) -> Optional[_builtins.bool]:
...
def get_instance_nodes(display_policy: Optional[_builtins.str] = None,
                       force_all: Optional[_builtins.bool] = None,
...
def get_instance_nodes_output(display_policy: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              force_all: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                              instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                              node_role: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstanceNodesResult]:
    """
    Use this data source to query detailed information of clickhouse instance_nodes
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clickhouse/getInstanceNodes:getInstanceNodes', __args__, opts=opts, typ=GetInstanceNodesResult)
