...
class BackupArgs:
    def __init__(
        __self__,
        *,
        cos_bucket_name: pulumi.Input[_builtins.str],
    ...
    def cos_bucket_name(self) -> pulumi.Input[_builtins.str]:
        """
        COS bucket name.
        """
    ...
    def cos_bucket_name(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("tencentcloud:Clickhouse/backup:Backup")
class Backup(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Clickhouse/backup:Backup", resource_name, __props__, opts
        )
