...
class GetSpecResult:
    ...
    def is_elastic(self) -> _builtins.bool | None:
...
def get_spec(
    is_elastic: _builtins.bool | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clickhouse/getSpec:getSpec",
        __args__,
        opts=opts,
        typ=GetSpecResult,
    ).value
...
def get_spec_output(
    is_elastic: pulumi.Input[_builtins.bool | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetSpecResult(
