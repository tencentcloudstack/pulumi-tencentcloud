...
def get_backup_jobs(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clickhouse/getBackupJobs:getBackupJobs",
        __args__,
        opts=opts,
        typ=GetBackupJobsResult,
    ).value
...
def get_backup_jobs_output(
...
) -> pulumi.Output[GetBackupJobsResult]:
    """
    Use this data source to query detailed information of clickhouse backup jobs
    ...
    return __ret__.apply(
        lambda __response__: GetBackupJobsResult(
