...
class AccountArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] describe: Description.
        """
...
@pulumi.type_token("tencentcloud:Clickhouse/account:Account")
class Account(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Clickhouse/account:Account", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter
    def describe(self) -> pulumi.Output[_builtins.str | None]:
        """
        Description.
        """
        return pulumi.get(self, "describe")
