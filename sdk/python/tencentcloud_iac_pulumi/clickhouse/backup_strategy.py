...
__all__ = ['BackupStrategy', 'BackupStrategyArgs']
...
class BackupStrategyArgs:
    def __init__(__self__, *,
                 ...
                 meta_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyMetaBackupStrategyArgs']]]] = None):
        """
    ...
    def meta_backup_strategies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyMetaBackupStrategyArgs']]]]:
        """
    ...
    def meta_backup_strategies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyMetaBackupStrategyArgs']]]]):
...
class _BackupStrategyState:
    def __init__(__self__, *,
                 data_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyDataBackupStrategyArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dataBackupStrategies")
    def data_backup_strategies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyDataBackupStrategyArgs']]]]:
        """
        Data backup strategy.
        """
        return pulumi.get(self, "data_backup_strategies")
    ...
    @data_backup_strategies.setter
    def data_backup_strategies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BackupStrategyDataBackupStrategyArgs']]]]):
        pulumi.set(self, "data_backup_strategies", value)
...
@pulumi.type_token("tencentcloud:Clickhouse/backupStrategy:BackupStrategy")
class BackupStrategy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BackupStrategyDataBackupStrategyArgs', 'BackupStrategyDataBackupStrategyArgsDict']]]]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 meta_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BackupStrategyMetaBackupStrategyArgs', 'BackupStrategyMetaBackupStrategyArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        backup_strategy = tencentcloud.clickhouse.BackupStrategy("backup_strategy",
            instance_id="cdwch-xxxxxx",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['BackupStrategyDataBackupStrategyArgs', 'BackupStrategyDataBackupStrategyArgsDict']]]] data_backup_strategies: Data backup strategy.
        :param pulumi.Input[_builtins.str] instance_id: Instance id.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BackupStrategyMetaBackupStrategyArgs', 'BackupStrategyMetaBackupStrategyArgsDict']]]] meta_backup_strategies: Metadata backup strategy.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            data_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BackupStrategyDataBackupStrategyArgs', 'BackupStrategyDataBackupStrategyArgsDict']]]]] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            meta_backup_strategies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BackupStrategyMetaBackupStrategyArgs', 'BackupStrategyMetaBackupStrategyArgsDict']]]]] = None) -> 'BackupStrategy':
        """
