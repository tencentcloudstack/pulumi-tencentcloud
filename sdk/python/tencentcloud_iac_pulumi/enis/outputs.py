...
class GetInstanceEniResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cdc_id: CDC instance ID.
        :param _builtins.str create_time: Creation time of the ENI.
        :param _builtins.str description: Description of the ENI. Conflict with `ids`.
        :param _builtins.str id: ID of the ENI.
        ...
        :param Sequence[_builtins.str] security_groups: A set of security group IDs which bind the ENI.
        :param _builtins.str state: States of the ENI.
...
class GetInstanceEniIpv6Result(dict):
    def __init__(__self__, *,
                 ...
                 description: _builtins.str,
                 is_wan_ip_blocked: _builtins.bool,
                 primary: _builtins.bool):
        """
        :param _builtins.str address: `IPv6` address, such as `3402:4e00:20:100:0:8cd9:2a67:71f3`.
        :param _builtins.str address_id: The `ID` of the `EIP` instance, such as `eip-hxlqja90`.
        :param _builtins.str description: Description of the ENI. Conflict with `ids`.
    ...
    def is_wan_ip_blocked(self) -> _builtins.bool:
        """
