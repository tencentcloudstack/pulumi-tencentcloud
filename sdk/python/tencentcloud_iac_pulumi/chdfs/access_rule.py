...
class _AccessRuleState:
    def __init__(
        ...
        *,
        ...
        access_rule: pulumi.Input[Optional["AccessRuleAccessRuleArgs"]] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="accessRule")
    def access_rule(self) -> pulumi.Input[Optional["AccessRuleAccessRuleArgs"]]:
        """
        rule detail.
        """
        return pulumi.get(self, "access_rule")
    ...
    @access_rule.setter
    def access_rule(self, value: pulumi.Input[Optional["AccessRuleAccessRuleArgs"]]):
        pulumi.set(self, "access_rule", value)
...
class AccessRule(pulumi.CustomResource):
    ...
    def __init__(
        ...
        access_group_id: pulumi.Input[_builtins.str | None] = None,
        access_rule: pulumi.Input[
            Union["AccessRuleAccessRuleArgs", "AccessRuleAccessRuleArgsDict"] | None
        ] = None,
        __props__=None,
    ):
        """
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Chdfs/accessRule:AccessRule", resource_name, __props__, opts
        )
