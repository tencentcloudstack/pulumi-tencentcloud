...
__all__ = ['LifeCycleRule', 'LifeCycleRuleArgs']
...
class _LifeCycleRuleState:
    def __init__(__self__, *,
                 ...
                 life_cycle_rule: pulumi.Input[Optional['LifeCycleRuleLifeCycleRuleArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="lifeCycleRule")
    def life_cycle_rule(self) -> pulumi.Input[Optional['LifeCycleRuleLifeCycleRuleArgs']]:
        """
        life cycle rule.
        """
        return pulumi.get(self, "life_cycle_rule")
    ...
    @life_cycle_rule.setter
    def life_cycle_rule(self, value: pulumi.Input[Optional['LifeCycleRuleLifeCycleRuleArgs']]):
        pulumi.set(self, "life_cycle_rule", value)


@pulumi.type_token("tencentcloud:Chdfs/lifeCycleRule:LifeCycleRule")
class LifeCycleRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 file_system_id: pulumi.Input[Optional[_builtins.str]] = None,
                 life_cycle_rule: pulumi.Input[Optional[Union['LifeCycleRuleLifeCycleRuleArgs', 'LifeCycleRuleLifeCycleRuleArgsDict']]] = None,
                 __props__=None):
        """
        ...
        life_cycle_rule = tencentcloud.chdfs.LifeCycleRule("life_cycle_rule",
        ...
        :param pulumi.Input[_builtins.str] file_system_id: file system id.
        :param pulumi.Input[Union['LifeCycleRuleLifeCycleRuleArgs', 'LifeCycleRuleLifeCycleRuleArgsDict']] life_cycle_rule: life cycle rule.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            file_system_id: pulumi.Input[Optional[_builtins.str]] = None,
            life_cycle_rule: pulumi.Input[Optional[Union['LifeCycleRuleLifeCycleRuleArgs', 'LifeCycleRuleLifeCycleRuleArgsDict']]] = None) -> 'LifeCycleRule':
        """
