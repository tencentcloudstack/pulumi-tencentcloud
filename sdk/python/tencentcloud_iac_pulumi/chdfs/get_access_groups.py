...
def get_access_groups(owner_uin: Optional[_builtins.int] = None,
...
def get_access_groups_output(owner_uin: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Chdfs/getAccessGroups:getAccessGroups', __args__, opts=opts, typ=GetAccessGroupsResult)
