...
def get_access_groups(
    ...
    :param _builtins.int owner_uin: get groups belongs to the owner uin, must set but only can use one of VpcId and OwnerUin to get the groups.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Chdfs/getAccessGroups:getAccessGroups",
        __args__,
        opts=opts,
        typ=GetAccessGroupsResult,
    ).value
...
def get_access_groups_output(
...
) -> pulumi.Output[GetAccessGroupsResult]:
    """
    Use this data source to query detailed information of chdfs access_groups
    ...
    return __ret__.apply(
        lambda __response__: GetAccessGroupsResult(
