...
class _MountPointState:
    def __init__(__self__, *,
                 ...
                 mount_point_status: Optional[pulumi.Input[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mountPointStatus")
    def mount_point_status(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        mount status 1:open, 2:close.
        """
        return pulumi.get(self, "mount_point_status")
    ...
    @mount_point_status.setter
    def mount_point_status(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "mount_point_status", value)
...
class MountPoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            file_system_id: Optional[pulumi.Input[_builtins.str]] = None,
            mount_point_name: Optional[pulumi.Input[_builtins.str]] = None,
            mount_point_status: Optional[pulumi.Input[_builtins.int]] = None) -> 'MountPoint':
        """
