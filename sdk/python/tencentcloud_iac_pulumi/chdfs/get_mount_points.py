...
class GetMountPointsResult:
    ...
    def access_group_id(self) -> _builtins.str | None:
    ...
    def owner_uin(self) -> _builtins.int | None:
...
def get_mount_points(
    access_group_id: _builtins.str | None = None,
    file_system_id: _builtins.str | None = None,
    owner_uin: _builtins.int | None = None,
    ...
    :param _builtins.str access_group_id: get mount points belongs to access group id, only can use one of the AccessGroupId,FileSystemId,OwnerUin parameters.
    ...
    :param _builtins.int owner_uin: get mount points belongs to owner uin, only can use one of the AccessGroupId,FileSystemId,OwnerUin parameters.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Chdfs/getMountPoints:getMountPoints",
        __args__,
        opts=opts,
        typ=GetMountPointsResult,
    ).value
...
def get_mount_points_output(
    ...
    return __ret__.apply(
        lambda __response__: GetMountPointsResult(
