...
class GetMountPointsResult:
    ...
    def owner_uin(self) -> Optional[_builtins.int]:
...
def get_mount_points(access_group_id: Optional[_builtins.str] = None,
                     file_system_id: Optional[_builtins.str] = None,
                     owner_uin: Optional[_builtins.int] = None,
...
def get_mount_points_output(access_group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            file_system_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            owner_uin: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Chdfs/getMountPoints:getMountPoints', __args__, opts=opts, typ=GetMountPointsResult)
