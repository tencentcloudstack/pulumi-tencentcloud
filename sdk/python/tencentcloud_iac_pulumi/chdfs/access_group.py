...
class _AccessGroupState:
    def __init__(__self__, *,
                 ...
                 vpc_type: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="vpcType")
    def vpc_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        vpc network type(1:CVM, 2:BM 1.0).
        """
        return pulumi.get(self, "vpc_type")
    ...
    @vpc_type.setter
    def vpc_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "vpc_type", value)
...
class AccessGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_type: pulumi.Input[Optional[_builtins.int]] = None) -> 'AccessGroup':
        """
