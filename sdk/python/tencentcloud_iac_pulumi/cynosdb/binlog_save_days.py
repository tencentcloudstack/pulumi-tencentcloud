...
class _BinlogSaveDaysState:
    def __init__(__self__, *,
                 binlog_save_days: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="binlogSaveDays")
    def binlog_save_days(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Binlog retention days.
        """
        return pulumi.get(self, "binlog_save_days")
    ...
    @binlog_save_days.setter
    def binlog_save_days(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "binlog_save_days", value)
...
class BinlogSaveDays(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            binlog_save_days: Optional[pulumi.Input[_builtins.int]] = None,
            cluster_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'BinlogSaveDays':
        """
