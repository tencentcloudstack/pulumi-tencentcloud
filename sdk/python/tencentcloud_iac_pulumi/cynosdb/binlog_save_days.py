...
__all__ = ["BinlogSaveDays", "BinlogSaveDaysArgs"]
...
class BinlogSaveDaysArgs:
    def __init__(
        __self__,
        *,
        binlog_save_days: pulumi.Input[_builtins.int],
        cluster_id: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a BinlogSaveDays resource.

        :param pulumi.Input[_builtins.int] binlog_save_days: Binlog retention days.
    ...
    def binlog_save_days(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def binlog_save_days(self, value: pulumi.Input[_builtins.int]):
...
class _BinlogSaveDaysState:
    def __init__(
        __self__,
        *,
        binlog_save_days: pulumi.Input[_builtins.int | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="binlogSaveDays")
    def binlog_save_days(self) -> pulumi.Input[_builtins.int | None]:
        """
        Binlog retention days.
        """
        return pulumi.get(self, "binlog_save_days")
    ...
    @binlog_save_days.setter
    def binlog_save_days(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "binlog_save_days", value)
...
@pulumi.type_token("tencentcloud:Cynosdb/binlogSaveDays:BinlogSaveDays")
class BinlogSaveDays(pulumi.CustomResource):
    ...
    def __init__(
        ...
        binlog_save_days = tencentcloud.cynosdb.BinlogSaveDays("binlog_save_days",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BinlogSaveDaysArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="binlogSaveDays")
    def binlog_save_days(self) -> pulumi.Output[_builtins.int]:
        """
        Binlog retention days.
        """
        return pulumi.get(self, "binlog_save_days")
