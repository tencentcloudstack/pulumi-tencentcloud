...
class _BinlogSaveDaysState:
    def __init__(__self__, *,
                 binlog_save_days: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="binlogSaveDays")
    def binlog_save_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Binlog retention days.
        """
        return pulumi.get(self, "binlog_save_days")
    ...
    @binlog_save_days.setter
    def binlog_save_days(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "binlog_save_days", value)
...
class BinlogSaveDays(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            binlog_save_days: pulumi.Input[Optional[_builtins.int]] = None,
            cluster_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'BinlogSaveDays':
        """
