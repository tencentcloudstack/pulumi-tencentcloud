...
class ParamTemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] engine_version: MySQL version number.
        :param pulumi.Input[_builtins.str] template_name: Template Name.
        :param pulumi.Input[_builtins.str] db_mode: Database type, optional values: NORMAL (default), SERVERLESS.
        :param pulumi.Input[Sequence[pulumi.Input['ParamTemplateParamListArgs']]] param_lists: parameter list.
        :param pulumi.Input[_builtins.str] template_description: Template Description.
        :param pulumi.Input[_builtins.int] template_id: Optional parameter, template ID to be copied.
        """
...
@pulumi.type_token("tencentcloud:Cynosdb/paramTemplate:ParamTemplate")
class ParamTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        param_template = tencentcloud.cynosdb.ParamTemplate("param_template",
            db_mode="SERVERLESS",
            engine_version="5.7",
    ...
    @_builtins.property
    @pulumi.getter(name="dbMode")
    def db_mode(self) -> pulumi.Output[_builtins.str | None]:
        """
        Database type, optional values: NORMAL (default), SERVERLESS.
        """
        return pulumi.get(self, "db_mode")
