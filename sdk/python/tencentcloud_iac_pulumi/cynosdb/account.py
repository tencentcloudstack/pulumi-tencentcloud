...
class AccountArgs:
    def __init__(
        ...
        *,
        ...
        max_user_connections: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def max_user_connections(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def max_user_connections(self, value: pulumi.Input[_builtins.int | None]):
...
class Account(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.cynosdb.Account("example",
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cynosdb/account:Account", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="maxUserConnections")
    def max_user_connections(self) -> pulumi.Output[_builtins.int | None]:
        """
        The maximum number of user connections cannot be greater than 10240.
        """
        return pulumi.get(self, "max_user_connections")
