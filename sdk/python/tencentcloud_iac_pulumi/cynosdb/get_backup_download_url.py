...
def get_backup_download_url(
    backup_id: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getBackupDownloadUrl:getBackupDownloadUrl",
        __args__,
        opts=opts,
        typ=GetBackupDownloadUrlResult,
    ).value
...
def get_backup_download_url_output(
...
) -> pulumi.Output[GetBackupDownloadUrlResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetBackupDownloadUrlResult(
