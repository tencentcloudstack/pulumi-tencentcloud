...
class GetClusterParamLogsResult:
    ...
    def cluster_param_logs(
        self,
    ) -> Sequence["outputs.GetClusterParamLogsClusterParamLogResult"]:
        """
...
def get_cluster_param_logs(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getClusterParamLogs:getClusterParamLogs",
        __args__,
        opts=opts,
        typ=GetClusterParamLogsResult,
    ).value
...
def get_cluster_param_logs_output(
...
) -> pulumi.Output[GetClusterParamLogsResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_param_logs
    ...
    return __ret__.apply(
        lambda __response__: GetClusterParamLogsResult(
