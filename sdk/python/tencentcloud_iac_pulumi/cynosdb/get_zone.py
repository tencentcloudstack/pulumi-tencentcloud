...
class GetZoneResult:
    ...
    def __init__(
        __self__,
        id=None,
        include_virtual_zones=None,
        region_sets=None,
        result_output_file=None,
        show_permission=None,
    ):
    ...
    def include_virtual_zones(self) -> _builtins.bool | None:
    ...
    def show_permission(self) -> _builtins.bool | None:
...
def get_zone(
    include_virtual_zones: _builtins.bool | None = None,
    result_output_file: _builtins.str | None = None,
    show_permission: _builtins.bool | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getZone:getZone", __args__, opts=opts, typ=GetZoneResult
    ).value
...
def get_zone_output(
    include_virtual_zones: pulumi.Input[_builtins.bool | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    show_permission: pulumi.Input[_builtins.bool | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetZoneResult(
