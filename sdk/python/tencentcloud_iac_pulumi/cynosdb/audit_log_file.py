...
class AuditLogFileArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] order: Sort by. Supported values are: `ASC` - ascending, `DESC` - descending.
        :param pulumi.Input[_builtins.str] order_by: Sort field. supported values are:
               `timestamp` - timestamp
...
class _AuditLogFileState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] create_time: Audit log file creation time. The format is 2019-03-20 17:09:13.
        :param pulumi.Input[_builtins.str] download_url: The download address of the audit logs.
        :param pulumi.Input[_builtins.str] end_time: End time.
        :param pulumi.Input[_builtins.str] err_msg: Error message.
        :param pulumi.Input[_builtins.str] file_name: Audit log file name.
        :param pulumi.Input[_builtins.int] file_size: File size, The unit is KB.
        :param pulumi.Input['AuditLogFileFilterArgs'] filter: Filter condition. Logs can be filtered according to the filter conditions set.
        :param pulumi.Input[_builtins.str] instance_id: The ID of instance.
        :param pulumi.Input[_builtins.str] order: Sort by. Supported values are: `ASC` - ascending, `DESC` - descending.
        :param pulumi.Input[_builtins.str] order_by: Sort field. supported values are:
...
@pulumi.type_token("tencentcloud:Cynosdb/auditLogFile:AuditLogFile")
class AuditLogFile(pulumi.CustomResource):
    ...
    def __init__(
        ...
        audit_log_file = tencentcloud.cynosdb.AuditLogFile("audit_log_file",
    ...
    @_builtins.property
    @pulumi.getter(name="errMsg")
    def err_msg(self) -> pulumi.Output[_builtins.str]:
        """
        Error message.
        """
        return pulumi.get(self, "err_msg")
