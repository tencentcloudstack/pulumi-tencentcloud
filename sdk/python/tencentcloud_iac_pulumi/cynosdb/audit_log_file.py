...
class _AuditLogFileState:
    def __init__(__self__, *,
                 ...
                 err_msg: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def err_msg(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Error message.
        """
    ...
    @err_msg.setter
    def err_msg(self, value: Optional[pulumi.Input[_builtins.str]]):
