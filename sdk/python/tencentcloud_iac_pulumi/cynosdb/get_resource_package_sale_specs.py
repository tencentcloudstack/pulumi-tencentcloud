...
def get_resource_package_sale_specs(
    instance_type: _builtins.str | None = None,
    package_region: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getResourcePackageSaleSpecs:getResourcePackageSaleSpecs",
        __args__,
        opts=opts,
        typ=GetResourcePackageSaleSpecsResult,
    ).value
...
def get_resource_package_sale_specs_output(
...
) -> pulumi.Output[GetResourcePackageSaleSpecsResult]:
    """
    Use this data source to query detailed information of cynosdb resource_package_sale_specs
    ...
    return __ret__.apply(
        lambda __response__: GetResourcePackageSaleSpecsResult(
