...
class GetProxyVersionResult:
    ...
    def __init__(
        __self__,
        cluster_id=None,
        current_proxy_version=None,
        id=None,
        proxy_group_id=None,
        result_output_file=None,
        support_proxy_versions=None,
    ):
    ...
    def proxy_group_id(self) -> _builtins.str | None:
...
def get_proxy_version(
    ...
    proxy_group_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getProxyVersion:getProxyVersion",
        __args__,
        opts=opts,
        typ=GetProxyVersionResult,
    ).value
...
def get_proxy_version_output(
...
) -> pulumi.Output[GetProxyVersionResult]:
    """
    Use this data source to query detailed information of cynosdb proxy_version
    ...
    return __ret__.apply(
        lambda __response__: GetProxyVersionResult(
