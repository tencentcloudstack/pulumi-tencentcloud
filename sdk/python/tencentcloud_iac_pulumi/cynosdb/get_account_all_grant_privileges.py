...
class GetAccountAllGrantPrivilegesResult:
    ...
    def database_privileges(
        self,
    ) -> Sequence["outputs.GetAccountAllGrantPrivilegesDatabasePrivilegeResult"]:
        """
    ...
    def table_privileges(
        self,
    ) -> Sequence["outputs.GetAccountAllGrantPrivilegesTablePrivilegeResult"]:
        """
...
def get_account_all_grant_privileges(
    account: (
        Union[
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getAccountAllGrantPrivileges:getAccountAllGrantPrivileges",
        __args__,
        opts=opts,
        typ=GetAccountAllGrantPrivilegesResult,
    ).value
...
def get_account_all_grant_privileges_output(
...
) -> pulumi.Output[GetAccountAllGrantPrivilegesResult]:
    """
    Use this data source to query detailed information of cynosdb account_all_grant_privileges
    ...
    return __ret__.apply(
        lambda __response__: GetAccountAllGrantPrivilegesResult(
