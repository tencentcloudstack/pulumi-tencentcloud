...
def get_account_all_grant_privileges_output(account: pulumi.Input[Optional[Union['GetAccountAllGrantPrivilegesAccountArgs', 'GetAccountAllGrantPrivilegesAccountArgsDict']]] = None,
