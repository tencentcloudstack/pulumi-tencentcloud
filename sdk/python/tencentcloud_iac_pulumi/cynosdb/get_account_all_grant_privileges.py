...
class GetAccountAllGrantPrivilegesResult:
    ...
    def global_privileges(self) -> Sequence[_builtins.str]:
        """
    ...
    def privilege_statements(self) -> Sequence[_builtins.str]:
        """
...
def get_account_all_grant_privileges(account: Optional[Union['GetAccountAllGrantPrivilegesAccountArgs', 'GetAccountAllGrantPrivilegesAccountArgsDict']] = None,
    ...
    account_all_grant_privileges = tencentcloud.Cynosdb.get_account_all_grant_privileges(cluster_id="cynosdbmysql-bws8h88b",
        account={
    ...
    :param Union['GetAccountAllGrantPrivilegesAccountArgs', 'GetAccountAllGrantPrivilegesAccountArgsDict'] account: account information.
...
def get_account_all_grant_privileges_output(account: Optional[pulumi.Input[Union['GetAccountAllGrantPrivilegesAccountArgs', 'GetAccountAllGrantPrivilegesAccountArgsDict']]] = None,
                                            cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccountAllGrantPrivilegesResult]:
    """
    Use this data source to query detailed information of cynosdb account_all_grant_privileges
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cynosdb/getAccountAllGrantPrivileges:getAccountAllGrantPrivileges', __args__, opts=opts, typ=GetAccountAllGrantPrivilegesResult)
    return __ret__.apply(lambda __response__: GetAccountAllGrantPrivilegesResult(
        account=pulumi.get(__response__, 'account'),
        cluster_id=pulumi.get(__response__, 'cluster_id'),
        database_privileges=pulumi.get(__response__, 'database_privileges'),
        global_privileges=pulumi.get(__response__, 'global_privileges'),
        id=pulumi.get(__response__, 'id'),
        privilege_statements=pulumi.get(__response__, 'privilege_statements'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        table_privileges=pulumi.get(__response__, 'table_privileges')))
