...
class GetClusterInstanceGroupsResult:
    ...
    def instance_grp_info_lists(
        self,
    ) -> Sequence["outputs.GetClusterInstanceGroupsInstanceGrpInfoListResult"]:
        """
...
def get_cluster_instance_groups(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getClusterInstanceGroups:getClusterInstanceGroups",
        __args__,
        opts=opts,
        typ=GetClusterInstanceGroupsResult,
    ).value
...
def get_cluster_instance_groups_output(
...
) -> pulumi.Output[GetClusterInstanceGroupsResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_instance_groups
    ...
    return __ret__.apply(
        lambda __response__: GetClusterInstanceGroupsResult(
            cluster_id=pulumi.get(__response__, "cluster_id"),
            id=pulumi.get(__response__, "id"),
            instance_grp_info_lists=pulumi.get(__response__, "instance_grp_info_lists"),
