...
def get_cluster_instance_groups(cluster_id: Optional[_builtins.str] = None,
...
def get_cluster_instance_groups_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClusterInstanceGroupsResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_instance_groups
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cynosdb/getClusterInstanceGroups:getClusterInstanceGroups', __args__, opts=opts, typ=GetClusterInstanceGroupsResult)
    return __ret__.apply(lambda __response__: GetClusterInstanceGroupsResult(
