...
def get_binlog_download_url(
    binlog_id: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getBinlogDownloadUrl:getBinlogDownloadUrl",
        __args__,
        opts=opts,
        typ=GetBinlogDownloadUrlResult,
    ).value
...
def get_binlog_download_url_output(
    binlog_id: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetBinlogDownloadUrlResult]:
    """
    Use this data source to query detailed information of cynosdb binlog_download_url
    ...
    return __ret__.apply(
        lambda __response__: GetBinlogDownloadUrlResult(
