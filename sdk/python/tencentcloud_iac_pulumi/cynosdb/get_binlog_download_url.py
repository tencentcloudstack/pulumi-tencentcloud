...
def get_binlog_download_url(binlog_id: Optional[_builtins.int] = None,
    ...
    binlog_download_url = tencentcloud.Cynosdb.get_binlog_download_url(cluster_id="cynosdbmysql-bws8h88b",
        binlog_id=6202249)
    ```
...
def get_binlog_download_url_output(binlog_id: Optional[pulumi.Input[_builtins.int]] = None,
                                   cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBinlogDownloadUrlResult]:
    """
    Use this data source to query detailed information of cynosdb binlog_download_url
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cynosdb/getBinlogDownloadUrl:getBinlogDownloadUrl', __args__, opts=opts, typ=GetBinlogDownloadUrlResult)
    return __ret__.apply(lambda __response__: GetBinlogDownloadUrlResult(
        binlog_id=pulumi.get(__response__, 'binlog_id'),
