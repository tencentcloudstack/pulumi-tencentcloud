...
class _RestartInstanceState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] status: instance state.
        """
...
@pulumi.type_token("tencentcloud:Cynosdb/restartInstance:RestartInstance")
class RestartInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        restart_instance = tencentcloud.cynosdb.RestartInstance("restart_instance", instance_id="cynosdbmysql-ins-afqx1hy0")
        ```
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cynosdb/restartInstance:RestartInstance",
            resource_name,
            __props__,
            opts,
        )
