...
def get_cluster_params(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getClusterParams:getClusterParams",
        __args__,
        opts=opts,
        typ=GetClusterParamsResult,
    ).value
...
def get_cluster_params_output(
...
) -> pulumi.Output[GetClusterParamsResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_params
    ...
    return __ret__.apply(
        lambda __response__: GetClusterParamsResult(
