...
def get_cluster_params(cluster_id: Optional[_builtins.str] = None,
...
def get_cluster_params_output(cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
                              param_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClusterParamsResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_params
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cynosdb/getClusterParams:getClusterParams', __args__, opts=opts, typ=GetClusterParamsResult)
    return __ret__.apply(lambda __response__: GetClusterParamsResult(
