...
def get_project_security_groups(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getProjectSecurityGroups:getProjectSecurityGroups",
        __args__,
        opts=opts,
        typ=GetProjectSecurityGroupsResult,
    ).value
...
def get_project_security_groups_output(
...
) -> pulumi.Output[GetProjectSecurityGroupsResult]:
    """
    Use this data source to query detailed information of cynosdb project_security_groups
    ...
    return __ret__.apply(
        lambda __response__: GetProjectSecurityGroupsResult(
