...
def get_cluster_detail_databases(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cynosdb/getClusterDetailDatabases:getClusterDetailDatabases",
        __args__,
        opts=opts,
        typ=GetClusterDetailDatabasesResult,
    ).value
...
def get_cluster_detail_databases_output(
...
) -> pulumi.Output[GetClusterDetailDatabasesResult]:
    """
    Use this data source to query detailed information of cynosdb cluster_detail_databases
    ...
    return __ret__.apply(
        lambda __response__: GetClusterDetailDatabasesResult(
