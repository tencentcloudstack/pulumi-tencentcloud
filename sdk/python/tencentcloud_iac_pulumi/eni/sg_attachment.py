...
class _SgAttachmentState:
    def __init__(__self__, *,
                 network_interface_ids: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="networkInterfaceIds")
    def network_interface_ids(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ENI instance ID. Such as:eni-pxir56ns. It Only support set one eni instance now.
        """
        return pulumi.get(self, "network_interface_ids")
    ...
    @network_interface_ids.setter
    def network_interface_ids(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "network_interface_ids", value)
...
class SgAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            network_interface_ids: pulumi.Input[Optional[_builtins.str]] = None,
            security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'SgAttachment':
        """
