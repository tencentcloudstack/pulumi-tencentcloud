...
class RouteArgs:
    def __init__(
        ...
        *,
        ...
        access_type: pulumi.Input[_builtins.int | None] = None,
        auth_flag: pulumi.Input[_builtins.int | None] = None,
        caller_appid: pulumi.Input[_builtins.int | None] = None,
        ...
        :param pulumi.Input[_builtins.int] vip_type: Routing network type (3:vpc routing; 4: standard support routing; 7: professional support routing).
        :param pulumi.Input[_builtins.int] access_type: Access type. Valid values:
        ...
        :param pulumi.Input[_builtins.int] auth_flag: Auth flag.
        :param pulumi.Input[_builtins.int] caller_appid: Caller appid.
        :param pulumi.Input[_builtins.str] ip: Ip.
        :param pulumi.Input[_builtins.int] public_network: Public network.
    ...
    def access_type(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    @access_type.setter
    def access_type(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "access_type", value)

    @_builtins.property
    @pulumi.getter(name="authFlag")
    def auth_flag(self) -> pulumi.Input[_builtins.int | None]:
        """
        Auth flag.
        """
    ...
    @auth_flag.setter
    def auth_flag(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "auth_flag", value)

    @_builtins.property
    @pulumi.getter(name="callerAppid")
    def caller_appid(self) -> pulumi.Input[_builtins.int | None]:
        """
        Caller appid.
        """
    ...
    @caller_appid.setter
    def caller_appid(self, value: pulumi.Input[_builtins.int | None]):
...
class _RouteState:
    def __init__(
        ...
        *,
        access_type: pulumi.Input[_builtins.int | None] = None,
        auth_flag: pulumi.Input[_builtins.int | None] = None,
        broker_vip_lists: pulumi.Input[
            Sequence[pulumi.Input["RouteBrokerVipListArgs"]] | None
        ] = None,
        caller_appid: pulumi.Input[_builtins.int | None] = None,
        ...
        public_network: pulumi.Input[_builtins.int | None] = None,
        subnet_id: pulumi.Input[_builtins.str | None] = None,
        vip_lists: pulumi.Input[
            Sequence[pulumi.Input["RouteVipListArgs"]] | None
        ] = None,
    ...
    def broker_vip_lists(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["RouteBrokerVipListArgs"]] | None]:
        """
    ...
    def broker_vip_lists(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["RouteBrokerVipListArgs"]] | None],
    ):
    ...
    def vip_lists(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["RouteVipListArgs"]] | None]:
        """
        Virtual IP list.
        """
    ...
    @vip_lists.setter
    def vip_lists(
        self, value: pulumi.Input[Sequence[pulumi.Input["RouteVipListArgs"]] | None]
    ):
...
@pulumi.type_token("tencentcloud:Ckafka/route:Route")
class Route(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RouteArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Ckafka/route:Route", resource_name, __props__, opts
        )
    ...
    def get(
        ...
        broker_vip_lists: pulumi.Input[
            Sequence[
                pulumi.Input[
                    Union["RouteBrokerVipListArgs", "RouteBrokerVipListArgsDict"]
                ]
            ]
            | None
        ] = None,
        ...
        subnet_id: pulumi.Input[_builtins.str | None] = None,
        vip_lists: pulumi.Input[
            Sequence[pulumi.Input[Union["RouteVipListArgs", "RouteVipListArgsDict"]]]
            | None
        ] = None,
        vip_type: pulumi.Input[_builtins.int | None] = None,
        vpc_id: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.int] access_type: Access type. Valid values:
               ...
               - 3: SASL_SSL (SSL encrypted communication. When the data starts, authentication will be logged in through SASL. Only the community version supports it).
        :param pulumi.Input[_builtins.int] auth_flag: Auth flag.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RouteBrokerVipListArgs', 'RouteBrokerVipListArgsDict']]]] broker_vip_lists: Virtual IP list (1 to 1 broker nodes).
        :param pulumi.Input[_builtins.int] caller_appid: Caller appid.
        :param pulumi.Input[_builtins.str] instance_id: Instance id.
        :param pulumi.Input[_builtins.str] ip: Ip.
        :param pulumi.Input[_builtins.int] public_network: Public network.
        :param pulumi.Input[_builtins.str] subnet_id: Subnet id.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RouteVipListArgs', 'RouteVipListArgsDict']]]] vip_lists: Virtual IP list.
        :param pulumi.Input[_builtins.int] vip_type: Routing network type (3:vpc routing; 4: standard support routing; 7: professional support routing).
        :param pulumi.Input[_builtins.str] vpc_id: Vpc id.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="accessType")
    def access_type(self) -> pulumi.Output[_builtins.int]:
        """
        Access type. Valid values:
        - 0: PLAINTEXT (in clear text, supported by both the old version and the community version without user information)
        - 1: SASL_PLAINTEXT (in clear text, but at the beginning of the data, authentication will be logged in through SASL, which is only supported by the community version)
    ...
    @_builtins.property
    @pulumi.getter(name="authFlag")
    def auth_flag(self) -> pulumi.Output[_builtins.int | None]:
        """
        Auth flag.
        """
        return pulumi.get(self, "auth_flag")
    ...
    @_builtins.property
    @pulumi.getter(name="callerAppid")
    def caller_appid(self) -> pulumi.Output[_builtins.int | None]:
        """
        Caller appid.
        """
        return pulumi.get(self, "caller_appid")
    ...
    @_builtins.property
    @pulumi.getter(name="publicNetwork")
    def public_network(self) -> pulumi.Output[_builtins.int | None]:
        """
        Public network.
        """
        return pulumi.get(self, "public_network")
