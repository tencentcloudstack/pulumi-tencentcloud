...
class GetTaskStatusResult:
    ...
    def __init__(
        __self__, flow_id=None, id=None, result_output_file=None, results=None
    ):
...
def get_task_status(
    flow_id: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ckafka/getTaskStatus:getTaskStatus",
        __args__,
        opts=opts,
        typ=GetTaskStatusResult,
    ).value
...
def get_task_status_output(
...
) -> pulumi.Output[GetTaskStatusResult]:
    """
    Use this data source to query detailed information of ckafka task_status
    ...
    return __ret__.apply(
        lambda __response__: GetTaskStatusResult(
