...
def get_datahub_group_offsets(group: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: topic name that the task subscribe.
...
def get_datahub_group_offsets_output(group: Optional[pulumi.Input[_builtins.str]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDatahubGroupOffsetsResult]:
    """
    Use this data source to query detailed information of ckafka datahub_group_offsets
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ckafka/getDatahubGroupOffsets:getDatahubGroupOffsets', __args__, opts=opts, typ=GetDatahubGroupOffsetsResult)
    return __ret__.apply(lambda __response__: GetDatahubGroupOffsetsResult(
