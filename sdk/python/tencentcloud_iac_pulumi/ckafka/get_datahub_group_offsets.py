...
def get_datahub_group_offsets(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ckafka/getDatahubGroupOffsets:getDatahubGroupOffsets",
        __args__,
        opts=opts,
        typ=GetDatahubGroupOffsetsResult,
    ).value
...
def get_datahub_group_offsets_output(
...
) -> pulumi.Output[GetDatahubGroupOffsetsResult]:
    """
    Use this data source to query detailed information of ckafka datahub_group_offsets
    ...
    return __ret__.apply(
        lambda __response__: GetDatahubGroupOffsetsResult(
