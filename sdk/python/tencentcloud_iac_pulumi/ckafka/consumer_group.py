...
__all__ = ["ConsumerGroup", "ConsumerGroupArgs"]
...
class ConsumerGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ConsumerGroupArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="topicNameLists")
    def topic_name_lists(self) -> pulumi.Output[Sequence[_builtins.str] | None]:
        """
        array of topic names.
        """
        return pulumi.get(self, "topic_name_lists")
