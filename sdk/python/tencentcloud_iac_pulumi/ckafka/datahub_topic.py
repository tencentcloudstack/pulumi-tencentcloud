...
class _DatahubTopicState:
    def __init__(__self__, *,
                 ...
                 retention_ms: pulumi.Input[Optional[_builtins.int]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="retentionMs")
    def retention_ms(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Message retention time, in ms, the current minimum value is 60000 ms.
        """
        return pulumi.get(self, "retention_ms")
    ...
    @retention_ms.setter
    def retention_ms(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "retention_ms", value)
...
class DatahubTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            partition_num: pulumi.Input[Optional[_builtins.int]] = None,
            retention_ms: pulumi.Input[Optional[_builtins.int]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'DatahubTopic':
        """
