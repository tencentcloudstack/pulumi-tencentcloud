...
class RenewInstanceArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] time_span: Renewal duration, the default is 1, and the unit is month.
        """
...
@pulumi.type_token("tencentcloud:Ckafka/renewInstance:RenewInstance")
class RenewInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        renew_ckafka_instance = tencentcloud.ckafka.RenewInstance("renew_ckafka_instance",
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Ckafka/renewInstance:RenewInstance",
            resource_name,
            __props__,
            opts,
        )
