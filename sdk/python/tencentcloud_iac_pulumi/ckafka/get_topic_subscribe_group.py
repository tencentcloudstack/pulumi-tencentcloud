...
class GetTopicSubscribeGroupResult:
    ...
    def groups_infos(
        self,
    ) -> Sequence["outputs.GetTopicSubscribeGroupGroupsInfoResult"]:
        """
...
def get_topic_subscribe_group(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ckafka/getTopicSubscribeGroup:getTopicSubscribeGroup",
        __args__,
        opts=opts,
        typ=GetTopicSubscribeGroupResult,
    ).value
...
def get_topic_subscribe_group_output(
...
) -> pulumi.Output[GetTopicSubscribeGroupResult]:
    """
    Use this data source to query detailed information of ckafka topic_subscribe_group
    ...
    return __ret__.apply(
        lambda __response__: GetTopicSubscribeGroupResult(
