...
class GetDatahubTaskResult:
    ...
    def task_type(self) -> _builtins.str | None:
        """
...
def get_datahub_task(
    ...
    :param _builtins.str search_word: search key.
    :param _builtins.str source_type: The source type.
    :param _builtins.str target_type: Destination type of dump.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ckafka/getDatahubTask:getDatahubTask",
        __args__,
        opts=opts,
        typ=GetDatahubTaskResult,
    ).value
...
def get_datahub_task_output(
...
) -> pulumi.Output[GetDatahubTaskResult]:
    """
    Use this data source to query detailed information of ckafka datahub_task
    ...
    return __ret__.apply(
        lambda __response__: GetDatahubTaskResult(
            ...
            task_lists=pulumi.get(__response__, "task_lists"),
