...
def get_datahub_task(resource: Optional[_builtins.str] = None,
...
def get_datahub_task_output(resource: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDatahubTaskResult]:
    """
    Use this data source to query detailed information of ckafka datahub_task
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ckafka/getDatahubTask:getDatahubTask', __args__, opts=opts, typ=GetDatahubTaskResult)
    return __ret__.apply(lambda __response__: GetDatahubTaskResult(
