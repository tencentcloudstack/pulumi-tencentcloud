...
class GetTopicSyncReplicaResult:
    ...
    def out_of_sync_replica_only(self) -> Optional[_builtins.bool]:
...
def get_topic_sync_replica(instance_id: Optional[_builtins.str] = None,
                           out_of_sync_replica_only: Optional[_builtins.bool] = None,
...
def get_topic_sync_replica_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  out_of_sync_replica_only: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                                  result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  topic_name: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTopicSyncReplicaResult]:
    """
    Use this data source to query detailed information of ckafka topic_sync_replica
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ckafka/getTopicSyncReplica:getTopicSyncReplica', __args__, opts=opts, typ=GetTopicSyncReplicaResult)
    return __ret__.apply(lambda __response__: GetTopicSyncReplicaResult(
        id=pulumi.get(__response__, 'id'),
        instance_id=pulumi.get(__response__, 'instance_id'),
        out_of_sync_replica_only=pulumi.get(__response__, 'out_of_sync_replica_only'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        topic_in_sync_replica_lists=pulumi.get(__response__, 'topic_in_sync_replica_lists'),
