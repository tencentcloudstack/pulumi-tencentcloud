...
def get_topic_sync_replica_output(instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                                  out_of_sync_replica_only: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
