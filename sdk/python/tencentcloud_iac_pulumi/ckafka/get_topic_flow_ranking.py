...
class GetTopicFlowRankingResult:
    ...
    def begin_date(self) -> _builtins.str | None:
...
def get_topic_flow_ranking(
    begin_date: _builtins.str | None = None,
    end_date: _builtins.str | None = None,
    instance_id: _builtins.str | None = None,
    ranking_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ckafka/getTopicFlowRanking:getTopicFlowRanking",
        __args__,
        opts=opts,
        typ=GetTopicFlowRankingResult,
    ).value
...
def get_topic_flow_ranking_output(
    ...
    return __ret__.apply(
        lambda __response__: GetTopicFlowRankingResult(
