...
class GetTmpRegionsResult:
    ...
    def __init__(
        __self__, id=None, pay_mode=None, region_sets=None, result_output_file=None
    ):
...
def get_tmp_regions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getTmpRegions:getTmpRegions",
        __args__,
        opts=opts,
        typ=GetTmpRegionsResult,
    ).value
...
def get_tmp_regions_output(
...
) -> pulumi.Output[GetTmpRegionsResult]:
    """
    Use this data source to query detailed information of monitor tmp_regions
    ...
    return __ret__.apply(
        lambda __response__: GetTmpRegionsResult(
