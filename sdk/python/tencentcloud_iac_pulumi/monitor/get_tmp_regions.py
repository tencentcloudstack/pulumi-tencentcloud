...
def get_tmp_regions(pay_mode: Optional[_builtins.int] = None,
    ...
    :param _builtins.int pay_mode: Pay mode. `1`-Prepaid, `2`-Postpaid, `3`-All regions (default is all regions if not filled in).
...
def get_tmp_regions_output(pay_mode: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                           result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTmpRegionsResult]:
    """
    Use this data source to query detailed information of monitor tmp_regions
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Monitor/getTmpRegions:getTmpRegions', __args__, opts=opts, typ=GetTmpRegionsResult)
    return __ret__.apply(lambda __response__: GetTmpRegionsResult(
