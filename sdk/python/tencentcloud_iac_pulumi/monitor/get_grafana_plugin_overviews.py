...
class GetGrafanaPluginOverviewsResult:
    ...
    def plugin_sets(
        self,
    ) -> Sequence["outputs.GetGrafanaPluginOverviewsPluginSetResult"]:
        """
        Plugin set.
        """
...
def get_grafana_plugin_overviews(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getGrafanaPluginOverviews:getGrafanaPluginOverviews",
        __args__,
        opts=opts,
        typ=GetGrafanaPluginOverviewsResult,
    ).value
...
def get_grafana_plugin_overviews_output(
    ...
    return __ret__.apply(
        lambda __response__: GetGrafanaPluginOverviewsResult(
