...
class GetAlarmBasicAlarmsResult:
    ...
    def alarm_statuses(self) -> Sequence[_builtins.int] | None:
        """
    ...
    def obj_like(self) -> _builtins.str | None:
        return pulumi.get(self, "obj_like")

    @_builtins.property
    @pulumi.getter(name="occurTimeOrder")
    def occur_time_order(self) -> _builtins.str | None:
    ...
    def view_names(self) -> Sequence[_builtins.str] | None:
...
def get_alarm_basic_alarms(
    alarm_statuses: Sequence[_builtins.int] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmBasicAlarms:getAlarmBasicAlarms",
        __args__,
        opts=opts,
        typ=GetAlarmBasicAlarmsResult,
    ).value
...
def get_alarm_basic_alarms_output(
    alarm_statuses: pulumi.Input[Sequence[_builtins.int] | None] = None,
    ...
    obj_like: pulumi.Input[_builtins.str | None] = None,
    occur_time_order: pulumi.Input[_builtins.str | None] = None,
    ...
    view_names: pulumi.Input[Sequence[_builtins.str] | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetAlarmBasicAlarmsResult]:
    """
    Use this data source to query detailed information of monitor basic_alarms
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmBasicAlarmsResult(
