...
def get_policy_conditions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getPolicyConditions:getPolicyConditions",
        __args__,
        opts=opts,
        typ=GetPolicyConditionsResult,
    ).value
...
def get_policy_conditions_output(
...
) -> pulumi.Output[GetPolicyConditionsResult]:
    """
    Use this data source to query monitor policy conditions(There is a lot of data and it is recommended to output to a file)
    ...
    return __ret__.apply(
        lambda __response__: GetPolicyConditionsResult(
