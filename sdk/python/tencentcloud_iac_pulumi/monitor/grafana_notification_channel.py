...
__all__ = ["GrafanaNotificationChannel", "GrafanaNotificationChannelArgs"]
...
class GrafanaNotificationChannelArgs:
    def __init__(
        ...
        *,
        ...
        channel_name: pulumi.Input[_builtins.str | None] = None,
        extra_org_ids: pulumi.Input[
    ...
    def channel_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        channel name.
        """
...
class GrafanaNotificationChannel(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            GrafanaNotificationChannelArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = GrafanaNotificationChannelArgs.__new__(
                GrafanaNotificationChannelArgs
            )
    ...
    def get(
        ...
        __props__ = _GrafanaNotificationChannelState.__new__(
            _GrafanaNotificationChannelState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="extraOrgIds")
    def extra_org_ids(self) -> pulumi.Output[Sequence[_builtins.str] | None]:
        """
        extra grafana organization id list, default to 1 representing Main Org.
        """
        return pulumi.get(self, "extra_org_ids")
