...
class GetAlarmNoticesResult:
    ...
    def owner_uid(self) -> _builtins.int | None:
        return pulumi.get(self, "owner_uid")

    @_builtins.property
    @pulumi.getter(name="receiverType")
    def receiver_type(self) -> _builtins.str | None:
        """
...
def get_alarm_notices(
    ...
    owner_uid: _builtins.int | None = None,
    receiver_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmNotices:getAlarmNotices",
        __args__,
        opts=opts,
...
def get_alarm_notices_output(
    ...
    owner_uid: pulumi.Input[_builtins.int | None] = None,
    receiver_type: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    user_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
