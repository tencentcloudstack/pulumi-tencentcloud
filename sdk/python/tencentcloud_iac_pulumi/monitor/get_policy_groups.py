...
def get_policy_groups_output(name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             policy_view_names: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
