...
class GetAlarmAllNamespacesResult:
    ...
    def __init__(
        ...
        custom_namespaces_news=None,
        id=None,
        ids=None,
        module=None,
        monitor_types=None,
        qce_namespaces_news=None,
    ...
    def common_namespaces(
        self,
    ) -> Sequence["outputs.GetAlarmAllNamespacesCommonNamespaceResult"]:
        """
    ...
    def custom_namespaces_news(
        self,
    ) -> Sequence["outputs.GetAlarmAllNamespacesCustomNamespacesNewsResult"]:
        """
    ...
    def qce_namespaces_news(
        self,
    ) -> Sequence["outputs.GetAlarmAllNamespacesQceNamespacesNewsResult"]:
        """
...
def get_alarm_all_namespaces(
    ...
    scene_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmAllNamespaces:getAlarmAllNamespaces",
        __args__,
        opts=opts,
        typ=GetAlarmAllNamespacesResult,
    ).value
...
def get_alarm_all_namespaces_output(
    ...
    scene_type: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetAlarmAllNamespacesResult]:
    """
    Use this data source to query detailed information of monitor alarm_all_namespaces
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmAllNamespacesResult(
