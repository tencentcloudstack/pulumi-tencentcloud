...
class GetAlarmMonitorTypeResult:
    ...
    def monitor_type_infos(
        self,
    ) -> Sequence["outputs.GetAlarmMonitorTypeMonitorTypeInfoResult"]:
        """
...
def get_alarm_monitor_type(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmMonitorType:getAlarmMonitorType",
        __args__,
        opts=opts,
        typ=GetAlarmMonitorTypeResult,
    ).value
...
def get_alarm_monitor_type_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmMonitorTypeResult(
