...
__all__ = ["TmpExporterIntegrationV2", "TmpExporterIntegrationV2Args"]
...
class TmpExporterIntegrationV2Args:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.bool] disable: Integration is disabled when the value is true. Default is false.
    ...
    def kube_type(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    @kube_type.setter
    def kube_type(self, value: pulumi.Input[_builtins.int | None]):
...
class TmpExporterIntegrationV2(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TmpExporterIntegrationV2Args, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = TmpExporterIntegrationV2Args.__new__(
                TmpExporterIntegrationV2Args
            )
    ...
    def get(
        ...
        __props__ = _TmpExporterIntegrationV2State.__new__(
            _TmpExporterIntegrationV2State
        )
    ...
    @_builtins.property
    @pulumi.getter(name="kubeType")
    def kube_type(self) -> pulumi.Output[_builtins.int | None]:
        """
        Integration config. 1 - TKE; 2 - EKS; 3 - MEKS.
        """
        return pulumi.get(self, "kube_type")
