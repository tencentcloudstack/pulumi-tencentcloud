...
def get_binding_objects(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getBindingObjects:getBindingObjects",
        __args__,
        opts=opts,
        typ=GetBindingObjectsResult,
    ).value
...
def get_binding_objects_output(
...
) -> pulumi.Output[GetBindingObjectsResult]:
    """
    Use this data source to query policy group binding objects.
    ...
    return __ret__.apply(
        lambda __response__: GetBindingObjectsResult(
