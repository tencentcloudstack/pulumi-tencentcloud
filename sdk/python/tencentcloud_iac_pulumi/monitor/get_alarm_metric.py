...
def get_alarm_metric(
    ...
    :param _builtins.str monitor_type: Monitoring Type Filter MT_QCE=Cloud Product Monitoring.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmMetric:getAlarmMetric",
        __args__,
        opts=opts,
        typ=GetAlarmMetricResult,
    ).value
...
def get_alarm_metric_output(
...
) -> pulumi.Output[GetAlarmMetricResult]:
    """
    Use this data source to query detailed information of monitor alarm_metric
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmMetricResult(
