...
def get_alarm_metric(module: Optional[_builtins.str] = None,
...
def get_alarm_metric_output(module: Optional[pulumi.Input[_builtins.str]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAlarmMetricResult]:
    """
    Use this data source to query detailed information of monitor alarm_metric
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Monitor/getAlarmMetric:getAlarmMetric', __args__, opts=opts, typ=GetAlarmMetricResult)
    return __ret__.apply(lambda __response__: GetAlarmMetricResult(
