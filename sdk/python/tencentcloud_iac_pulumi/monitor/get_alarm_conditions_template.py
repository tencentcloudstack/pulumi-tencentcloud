...
class GetAlarmConditionsTemplateResult:
    ...
    def __init__(
        ...
        id=None,
        module=None,
        policy_count_order=None,
        result_output_file=None,
        template_group_lists=None,
        update_time_order=None,
        view_name=None,
    ):
    ...
    def policy_count_order(self) -> _builtins.str | None:
    ...
    def template_group_lists(
        self,
    ) -> Sequence["outputs.GetAlarmConditionsTemplateTemplateGroupListResult"]:
        """
        Template List.
        """
    ...
    def update_time_order(self) -> _builtins.str | None:
...
def get_alarm_conditions_template(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmConditionsTemplate:getAlarmConditionsTemplate",
        __args__,
        opts=opts,
        typ=GetAlarmConditionsTemplateResult,
    ).value
...
def get_alarm_conditions_template_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmConditionsTemplateResult(
