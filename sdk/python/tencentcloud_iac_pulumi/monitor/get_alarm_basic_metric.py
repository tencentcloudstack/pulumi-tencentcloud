...
def get_alarm_basic_metric(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmBasicMetric:getAlarmBasicMetric",
        __args__,
        opts=opts,
        typ=GetAlarmBasicMetricResult,
    ).value
...
def get_alarm_basic_metric_output(
...
) -> pulumi.Output[GetAlarmBasicMetricResult]:
    """
    Use this data source to query detailed information of monitor basic_metric
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmBasicMetricResult(
