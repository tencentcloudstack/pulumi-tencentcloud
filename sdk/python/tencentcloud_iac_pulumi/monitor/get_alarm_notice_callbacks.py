...
class GetAlarmNoticeCallbacksResult:
    ...
    def __init__(
        __self__, id=None, result_output_file=None, tags=None, url_notices=None
    ):
...
def get_alarm_notice_callbacks(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmNoticeCallbacks:getAlarmNoticeCallbacks",
        __args__,
        opts=opts,
        typ=GetAlarmNoticeCallbacksResult,
    ).value
...
def get_alarm_notice_callbacks_output(
...
) -> pulumi.Output[GetAlarmNoticeCallbacksResult]:
    """
    Use this data source to query detailed information of monitor alarm_notice_callbacks
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmNoticeCallbacksResult(
