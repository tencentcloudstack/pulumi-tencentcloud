...
class GetAlarmPolicyResult:
    ...
    def __init__(
        ...
        monitor_types=None,
        namespaces=None,
        need_correspondence=None,
        not_bind_all=None,
        not_binding_notice_rule=None,
        not_instance_group=None,
        notice_ids=None,
        one_click_policy_types=None,
        order=None,
        policies=None,
        policy_name=None,
        policy_types=None,
        ...
        receiver_on_call_form_ids=None,
        receiver_uids=None,
        ...
        if receiver_on_call_form_ids and not isinstance(
            receiver_on_call_form_ids, list
        ):
            raise TypeError(
                "Expected argument 'receiver_on_call_form_ids' to be a list"
            )
    ...
    @_builtins.property
    @pulumi.getter
    def enables(self) -> Sequence[_builtins.int] | None:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def field(self) -> _builtins.str | None:
    ...
    def instance_group_id(self) -> _builtins.int | None:
        """
    ...
    def one_click_policy_types(self) -> Sequence[_builtins.str] | None:
    ...
    def policy_types(self) -> Sequence[_builtins.str] | None:
    ...
    def rule_types(self) -> Sequence[_builtins.str] | None:
    ...
    def trigger_tasks(
        self,
    ) -> Sequence["outputs.GetAlarmPolicyTriggerTaskResult"] | None:
        """
...
def get_alarm_policy(
    ...
    enables: Sequence[_builtins.int] | None = None,
    field: _builtins.str | None = None,
    instance_group_id: _builtins.int | None = None,
    module: _builtins.str | None = None,
    monitor_types: Sequence[_builtins.str] | None = None,
    namespaces: Sequence[_builtins.str] | None = None,
    need_correspondence: _builtins.int | None = None,
    not_bind_all: _builtins.int | None = None,
    not_binding_notice_rule: _builtins.int | None = None,
    not_instance_group: _builtins.int | None = None,
    notice_ids: Sequence[_builtins.str] | None = None,
    one_click_policy_types: Sequence[_builtins.str] | None = None,
    order: _builtins.str | None = None,
    policy_name: _builtins.str | None = None,
    policy_types: Sequence[_builtins.str] | None = None,
    project_ids: Sequence[_builtins.int] | None = None,
    prom_ins_id: _builtins.str | None = None,
    receiver_groups: Sequence[_builtins.int] | None = None,
    receiver_on_call_form_ids: Sequence[_builtins.str] | None = None,
    receiver_uids: Sequence[_builtins.int] | None = None,
    result_output_file: _builtins.str | None = None,
    rule_types: Sequence[_builtins.str] | None = None,
    trigger_tasks: (
        Sequence[
            Union["GetAlarmPolicyTriggerTaskArgs", "GetAlarmPolicyTriggerTaskArgsDict"]
        ]
        | None
    ) = None,
    ...
    alarm_policy = tencentcloud.monitor.get_alarm_policy(module="monitor",
    ...
    :param Sequence[_builtins.int] enables: Filter by alarm status. Valid values: [1]: enabled; [0]: disabled; [0, 1]: all.
    :param _builtins.str field: Sort by field. For example, to sort by the last modification time, use Field: UpdateTime.
    :param _builtins.int instance_group_id: Instance group ID.
    :param _builtins.str module: Value fixed at monitor.
    :param Sequence[_builtins.str] monitor_types: Filter by monitor type. Valid values: MT_QCE (Tencent Cloud service monitoring). If this parameter is left empty, all will be queried by default.
    :param Sequence[_builtins.str] namespaces: Filter by namespace. For the values of different policy types, please see:[Poicy Type List](https://www.tencentcloud.com/document/product/248/39565?has_map=1).
    :param _builtins.int need_correspondence: Whether the relationship between a policy and the input parameter filter dimension is required. 1: Yes. 0: No. Default value: 0.
    :param _builtins.int not_bind_all: Whether the returned result needs to filter policies associated with all objects. Valid values: 1 (Yes), 0 (No).
    :param _builtins.int not_binding_notice_rule: If 1 is passed in, alarm policies with no notification rules configured are queried. If it is left empty or other values are passed in, all alarm policies are queried.
    :param _builtins.int not_instance_group: Whether the returned result needs to filter policies associated with instance groups. Valid values: 1 (Yes), 0 (No).
    ...
    :param Sequence[_builtins.str] one_click_policy_types: Filter by quick alarm policy. If this parameter is left empty, all policies are displayed. ONECLICK: Display quick alarm policies; NOT_ONECLICK: Display non-quick alarm policies.
    :param _builtins.str order: Sort order. Valid values: ASC (ascending), DESC (descending).
    :param _builtins.str policy_name: Fuzzy search by policy name.
    :param Sequence[_builtins.str] policy_types: Filter by default policy. Valid values: DEFAULT (display default policy), NOT_DEFAULT (display non-default policies). If this parameter is left empty, all policies will be displayed.
    :param Sequence[_builtins.int] project_ids: ID array of the policy project, which can be viewed on the following page: [Project Management](https://console.tencentcloud.com/project).
    :param _builtins.str prom_ins_id: ID of the TencentCloud Managed Service for Prometheus instance, which is used for customizing a metric policy.
    :param Sequence[_builtins.int] receiver_groups: Search by recipient group. You can get the user group list with the API [ListGroups](https://www.tencentcloud.com/document/product/598/34589?from_cn_redirect=1) in 'Cloud Access Management' or query the user group list where a sub-user is in with the API [ListGroupsForUser](https://www.tencentcloud.com/document/product/598/34588?from_cn_redirect=1). The GroupId field in the returned result should be entered here.
    :param Sequence[_builtins.str] receiver_on_call_form_ids: Search by schedule.
    :param Sequence[_builtins.int] receiver_uids: Search by recipient. You can get the user list with the API [ListUsers](https://www.tencentcloud.com/document/product/598/34587?from_cn_redirect=1) in 'Cloud Access Management' or query the sub-user information with the API [GetUser](https://www.tencentcloud.com/document/product/598/34590?from_cn_redirect=1). The Uid field in the returned result should be entered here.
    :param _builtins.str result_output_file: Used to save results.
    :param Sequence[_builtins.str] rule_types: Filter by trigger condition. Valid values: STATIC (display policies with static threshold), DYNAMIC (display policies with dynamic threshold). If this parameter is left empty, all policies will be displayed.
    :param Sequence[Union['GetAlarmPolicyTriggerTaskArgs', 'GetAlarmPolicyTriggerTaskArgsDict']] trigger_tasks: Filter alarm policy by triggered task (such as auto scaling task). Up to 10 tasks can be specified.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Monitor/getAlarmPolicy:getAlarmPolicy",
        __args__,
        opts=opts,
        typ=GetAlarmPolicyResult,
    ).value
...
def get_alarm_policy_output(
    dimensions: pulumi.Input[_builtins.str | None] = None,
    enables: pulumi.Input[Sequence[_builtins.int] | None] = None,
    field: pulumi.Input[_builtins.str | None] = None,
    instance_group_id: pulumi.Input[_builtins.int | None] = None,
    module: pulumi.Input[_builtins.str | None] = None,
    monitor_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    namespaces: pulumi.Input[Sequence[_builtins.str] | None] = None,
    need_correspondence: pulumi.Input[_builtins.int | None] = None,
    not_bind_all: pulumi.Input[_builtins.int | None] = None,
    not_binding_notice_rule: pulumi.Input[_builtins.int | None] = None,
    not_instance_group: pulumi.Input[_builtins.int | None] = None,
    notice_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    one_click_policy_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    order: pulumi.Input[_builtins.str | None] = None,
    policy_name: pulumi.Input[_builtins.str | None] = None,
    policy_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    project_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
    prom_ins_id: pulumi.Input[_builtins.str | None] = None,
    receiver_groups: pulumi.Input[Sequence[_builtins.int] | None] = None,
    receiver_on_call_form_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    receiver_uids: pulumi.Input[Sequence[_builtins.int] | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    rule_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    trigger_tasks: pulumi.Input[
        Sequence[
            Union["GetAlarmPolicyTriggerTaskArgs", "GetAlarmPolicyTriggerTaskArgsDict"]
        ]
        | None
...
) -> pulumi.Output[GetAlarmPolicyResult]:
    """
    Use this data source to query detailed information of monitor alarm_policy
    ...
    return __ret__.apply(
        lambda __response__: GetAlarmPolicyResult(
            dimensions=pulumi.get(__response__, "dimensions"),
            enables=pulumi.get(__response__, "enables"),
            ...
            need_correspondence=pulumi.get(__response__, "need_correspondence"),
            not_bind_all=pulumi.get(__response__, "not_bind_all"),
            not_binding_notice_rule=pulumi.get(__response__, "not_binding_notice_rule"),
            not_instance_group=pulumi.get(__response__, "not_instance_group"),
            notice_ids=pulumi.get(__response__, "notice_ids"),
            one_click_policy_types=pulumi.get(__response__, "one_click_policy_types"),
            ...
            prom_ins_id=pulumi.get(__response__, "prom_ins_id"),
            receiver_groups=pulumi.get(__response__, "receiver_groups"),
            receiver_on_call_form_ids=pulumi.get(
                __response__, "receiver_on_call_form_ids"
            ),
            receiver_uids=pulumi.get(__response__, "receiver_uids"),
            result_output_file=pulumi.get(__response__, "result_output_file"),
            rule_types=pulumi.get(__response__, "rule_types"),
            trigger_tasks=pulumi.get(__response__, "trigger_tasks"),
        )
    )
