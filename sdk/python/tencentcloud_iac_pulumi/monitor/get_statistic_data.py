...
class GetStatisticDataResult:
    ...
    def group_bys(self) -> Optional[Sequence[_builtins.str]]:
...
def get_statistic_data(conditions: Optional[Sequence[Union['GetStatisticDataConditionArgs', 'GetStatisticDataConditionArgsDict']]] = None,
                       group_bys: Optional[Sequence[_builtins.str]] = None,
...
def get_statistic_data_output(conditions: Optional[pulumi.Input[Optional[Sequence[Union['GetStatisticDataConditionArgs', 'GetStatisticDataConditionArgsDict']]]]] = None,
                              group_bys: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStatisticDataResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Monitor/getStatisticData:getStatisticData', __args__, opts=opts, typ=GetStatisticDataResult)
    return __ret__.apply(lambda __response__: GetStatisticDataResult(
