...
__all__ = ["TmpGrafanaConfig", "TmpGrafanaConfigArgs"]
...
class TmpGrafanaConfigArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] config: JSON encoded string.
...
@pulumi.type_token("tencentcloud:Monitor/tmpGrafanaConfig:TmpGrafanaConfig")
class TmpGrafanaConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        foo_tmp_grafana_config = tencentcloud.monitor.TmpGrafanaConfig("foo",
            config=json.dumps({
                "server": {
                    "http_port": 8080,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TmpGrafanaConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
