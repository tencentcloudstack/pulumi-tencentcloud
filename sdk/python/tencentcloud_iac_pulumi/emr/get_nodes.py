...
class GetNodesResult:
    ...
    def hardware_resource_type(self) -> _builtins.str | None:
        """
...
def get_nodes(
    hardware_resource_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Emr/getNodes:getNodes", __args__, opts=opts, typ=GetNodesResult
    ).value
...
def get_nodes_output(
    hardware_resource_type: pulumi.Input[_builtins.str | None] = None,
