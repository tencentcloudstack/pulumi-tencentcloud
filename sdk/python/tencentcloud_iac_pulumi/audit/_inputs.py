...
class TrackStorageArgsDict(TypedDict):
    ...
    """
    compress: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class TrackStorageArgs:
    def __init__(__self__, *,
                 ...
                 storage_region: pulumi.Input[_builtins.str],
                 storage_type: pulumi.Input[_builtins.str],
                 compress: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def compress(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Whether to compress. `1`: compress, `2`: do not compress.
        """
    ...
    @compress.setter
    def compress(self, value: pulumi.Input[Optional[_builtins.int]]):
