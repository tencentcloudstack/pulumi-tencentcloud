...
class GetKeyAliasResult:
    ...
    def audit_key_alias_lists(
        self,
    ) -> Sequence["outputs.GetKeyAliasAuditKeyAliasListResult"]:
        """
...
def get_key_alias(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Audit/getKeyAlias:getKeyAlias",
        __args__,
        opts=opts,
        typ=GetKeyAliasResult,
    ).value
...
def get_key_alias_output(
...
) -> pulumi.Output[GetKeyAliasResult]:
    """
    Use this data source to query the key alias list specified with region supported by the audit.
    ...
    return __ret__.apply(
        lambda __response__: GetKeyAliasResult(
