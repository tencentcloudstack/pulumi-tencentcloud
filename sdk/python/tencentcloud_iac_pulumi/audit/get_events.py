...
def get_events_output(end_time: pulumi.Input[Optional[_builtins.int]] = None,
                      is_return_location: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                      lookup_attributes: pulumi.Input[Optional[Optional[Sequence[Union['GetEventsLookupAttributeArgs', 'GetEventsLookupAttributeArgsDict']]]]] = None,
