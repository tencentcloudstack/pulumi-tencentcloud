...
class GetEventsResult:
    ...
    def is_return_location(self) -> Optional[_builtins.int]:
...
def get_events(end_time: Optional[_builtins.int] = None,
               is_return_location: Optional[_builtins.int] = None,
               lookup_attributes: Optional[Sequence[Union['GetEventsLookupAttributeArgs', 'GetEventsLookupAttributeArgsDict']]] = None,
...
def get_events_output(end_time: Optional[pulumi.Input[_builtins.int]] = None,
                      is_return_location: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                      lookup_attributes: Optional[pulumi.Input[Optional[Sequence[Union['GetEventsLookupAttributeArgs', 'GetEventsLookupAttributeArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Audit/getEvents:getEvents', __args__, opts=opts, typ=GetEventsResult)
