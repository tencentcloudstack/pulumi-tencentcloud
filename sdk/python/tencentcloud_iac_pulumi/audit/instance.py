...
class InstanceArgs:
    def __init__(
        ...
        *,
        ...
        enable_kms_encry: pulumi.Input[bool] | None = None,
        key_id: pulumi.Input[str] | None = None,
        log_file_prefix: pulumi.Input[str] | None = None,
    ...
    def enable_kms_encry(self) -> pulumi.Input[bool] | None:
        """
    ...
    def enable_kms_encry(self, value: pulumi.Input[bool] | None):
        pulumi.set(self, "enable_kms_encry", value)

    @property
    @pulumi.getter(name="keyId")
    def key_id(self) -> pulumi.Input[str] | None:
        """
    ...
    @key_id.setter
    def key_id(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "key_id", value)

    @property
    @pulumi.getter(name="logFilePrefix")
    def log_file_prefix(self) -> pulumi.Input[str] | None:
        """
    ...
    def log_file_prefix(self, value: pulumi.Input[str] | None):
...
class _InstanceState:
    def __init__(
        __self__,
        *,
        audit_switch: pulumi.Input[bool] | None = None,
        cos_bucket: pulumi.Input[str] | None = None,
        cos_region: pulumi.Input[str] | None = None,
        enable_kms_encry: pulumi.Input[bool] | None = None,
        key_id: pulumi.Input[str] | None = None,
        log_file_prefix: pulumi.Input[str] | None = None,
        name: pulumi.Input[str] | None = None,
        read_write_attribute: pulumi.Input[int] | None = None
    ):
        """
    ...
    @property
    @pulumi.getter(name="auditSwitch")
    def audit_switch(self) -> pulumi.Input[bool] | None:
        """
        Indicate whether to turn on audit logging or not.
        """
        return pulumi.get(self, "audit_switch")
    ...
    @audit_switch.setter
    def audit_switch(self, value: pulumi.Input[bool] | None):
        pulumi.set(self, "audit_switch", value)

    @property
    @pulumi.getter(name="cosBucket")
    def cos_bucket(self) -> pulumi.Input[str] | None:
        """
        Name of the cos bucket to save audit log. Caution: the validation of existing cos bucket will not be checked by
        terraform.
        """
    ...
    @cos_bucket.setter
    def cos_bucket(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "cos_bucket", value)

    @property
    @pulumi.getter(name="cosRegion")
    def cos_region(self) -> pulumi.Input[str] | None:
        """
        Region of the cos bucket.
        """
        return pulumi.get(self, "cos_region")
    ...
    @cos_region.setter
    def cos_region(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "cos_region", value)
    ...
    @property
    @pulumi.getter(name="readWriteAttribute")
    def read_write_attribute(self) -> pulumi.Input[int] | None:
        """
        Event attribute filter. Valid values: `1`, `2`, `3`. `1` for readonly, `2` for write-only, `3` for all.
        """
        return pulumi.get(self, "read_write_attribute")
    ...
    @read_write_attribute.setter
    def read_write_attribute(self, value: pulumi.Input[int] | None):
        pulumi.set(self, "read_write_attribute", value)
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Audit/instance:Instance", resource_name, __props__, opts
        )
    ...
    @property
    @pulumi.getter(name="enableKmsEncry")
    def enable_kms_encry(self) -> pulumi.Output[bool | None]:
        """
        Indicate whether the log is encrypt with KMS algorithm or not.
        """
        return pulumi.get(self, "enable_kms_encry")
    ...
    @property
    @pulumi.getter(name="keyId")
    def key_id(self) -> pulumi.Output[str | None]:
        """
        Existing CMK unique key. This field can be get by data source `_audit.get_key_alias`. Caution: the region of the KMS must be as same as the `cos_region`.
        """
        return pulumi.get(self, "key_id")
