...
class GetValidateStatusResult:
    ...
    def __init__(
        __self__, domain_zone=None, id=None, result_output_file=None, status=None
    ):
...
def get_validate_status(
    domain_zone: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Subdomain/getValidateStatus:getValidateStatus",
        __args__,
        opts=opts,
        typ=GetValidateStatusResult,
    ).value
...
def get_validate_status_output(
...
) -> pulumi.Output[GetValidateStatusResult]:
    """
    Use this data source to query detailed information of dnspod subdomain_validate_status
    ...
    return __ret__.apply(
        lambda __response__: GetValidateStatusResult(
