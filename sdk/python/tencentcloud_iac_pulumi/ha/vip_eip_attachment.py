...
__all__ = ["VipEipAttachment", "VipEipAttachmentArgs"]
...
class _VipEipAttachmentState:
    ...
    @_builtins.property
    @pulumi.getter(name="havipId")
    def havip_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        ID of the attached HA VIP.
        """
        return pulumi.get(self, "havip_id")
    ...
    @havip_id.setter
    def havip_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "havip_id", value)
...
class VipEipAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            VipEipAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
