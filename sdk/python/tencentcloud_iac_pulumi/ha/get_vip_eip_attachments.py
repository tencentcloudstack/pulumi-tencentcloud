...
class GetVipEipAttachmentsResult:
    ...
    def __init__(
        __self__,
        address_ip=None,
        ha_vip_eip_attachment_lists=None,
        havip_id=None,
        id=None,
        ...
        if ha_vip_eip_attachment_lists and not isinstance(
            ha_vip_eip_attachment_lists, list
        ):
            raise TypeError(
                "Expected argument 'ha_vip_eip_attachment_lists' to be a list"
            )
    ...
    def address_ip(self) -> _builtins.str | None:
        """
    ...
    def ha_vip_eip_attachment_lists(
        self,
    ) -> Sequence["outputs.GetVipEipAttachmentsHaVipEipAttachmentListResult"]:
        """
...
def get_vip_eip_attachments(
    address_ip: _builtins.str | None = None,
    havip_id: _builtins.str | None = None,
    ...
    foo = tencentcloud.ha.get_vip_eip_attachments(havip_id="havip-kjqwe4ba",
        address_ip="1.1.1.1")
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ha/getVipEipAttachments:getVipEipAttachments",
        __args__,
        opts=opts,
        typ=GetVipEipAttachmentsResult,
    ).value
...
def get_vip_eip_attachments_output(
    ...
    return __ret__.apply(
        lambda __response__: GetVipEipAttachmentsResult(
            address_ip=pulumi.get(__response__, "address_ip"),
            ha_vip_eip_attachment_lists=pulumi.get(
                __response__, "ha_vip_eip_attachment_lists"
            ),
            havip_id=pulumi.get(__response__, "havip_id"),
