...
def get_vip_eip_attachments(address_ip: Optional[_builtins.str] = None,
                            havip_id: Optional[_builtins.str] = None,
...
def get_vip_eip_attachments_output(address_ip: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   havip_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVipEipAttachmentsResult]:
    """
    Use this data source to query detailed information of HA VIP EIP attachments
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ha/getVipEipAttachments:getVipEipAttachments', __args__, opts=opts, typ=GetVipEipAttachmentsResult)
    return __ret__.apply(lambda __response__: GetVipEipAttachmentsResult(
        address_ip=pulumi.get(__response__, 'address_ip'),
        ha_vip_eip_attachment_lists=pulumi.get(__response__, 'ha_vip_eip_attachment_lists'),
