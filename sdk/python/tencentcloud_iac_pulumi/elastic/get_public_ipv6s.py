...
class GetPublicIpv6sResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetPublicIpv6sFilterResult"] | None:
    ...
    def ipv6_address_ids(self) -> Sequence[_builtins.str] | None:
    ...
    @_builtins.property
    @pulumi.getter
    def traditional(self) -> _builtins.bool | None:
...
def get_public_ipv6s(
    filters: (
        Sequence[Union["GetPublicIpv6sFilterArgs", "GetPublicIpv6sFilterArgsDict"]]
        | None
    ) = None,
    ipv6_address_ids: Sequence[_builtins.str] | None = None,
    result_output_file: _builtins.str | None = None,
    traditional: _builtins.bool | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Elastic/getPublicIpv6s:getPublicIpv6s",
        __args__,
        opts=opts,
        typ=GetPublicIpv6sResult,
    ).value
...
def get_public_ipv6s_output(
    filters: pulumi.Input[
        Sequence[Union["GetPublicIpv6sFilterArgs", "GetPublicIpv6sFilterArgsDict"]]
        | None
    ] = None,
    ipv6_address_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    traditional: pulumi.Input[_builtins.bool | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetPublicIpv6sResult]:
    """
    Use this data source to query detailed information of vpc elastic_public_ipv6s
    ...
    return __ret__.apply(
        lambda __response__: GetPublicIpv6sResult(
