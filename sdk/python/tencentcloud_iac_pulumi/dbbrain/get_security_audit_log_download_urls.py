...
def get_security_audit_log_download_urls(async_request_id: Optional[_builtins.int] = None,
...
def get_security_audit_log_download_urls_output(async_request_id: Optional[pulumi.Input[_builtins.int]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSecurityAuditLogDownloadUrlsResult]:
    """
    Use this data source to query detailed information of dbbrain security_audit_log_download_urls
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getSecurityAuditLogDownloadUrls:getSecurityAuditLogDownloadUrls', __args__, opts=opts, typ=GetSecurityAuditLogDownloadUrlsResult)
    return __ret__.apply(lambda __response__: GetSecurityAuditLogDownloadUrlsResult(
