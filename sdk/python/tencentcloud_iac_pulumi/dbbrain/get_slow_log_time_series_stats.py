...
class GetSlowLogTimeSeriesStatsResult:
    ...
    def series_datas(
        self,
    ) -> Sequence["outputs.GetSlowLogTimeSeriesStatsSeriesDataResult"]:
        """
    ...
    def time_series(
        self,
    ) -> Sequence["outputs.GetSlowLogTimeSeriesStatsTimeSeriesResult"]:
        """
...
def get_slow_log_time_series_stats(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getSlowLogTimeSeriesStats:getSlowLogTimeSeriesStats",
        __args__,
        opts=opts,
        typ=GetSlowLogTimeSeriesStatsResult,
    ).value
...
def get_slow_log_time_series_stats_output(
...
) -> pulumi.Output[GetSlowLogTimeSeriesStatsResult]:
    """
    Use this data source to query detailed information of dbbrain slow_log_time_series_stats
    ...
    return __ret__.apply(
        lambda __response__: GetSlowLogTimeSeriesStatsResult(
