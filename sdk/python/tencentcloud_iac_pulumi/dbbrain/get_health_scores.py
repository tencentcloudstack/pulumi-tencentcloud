...
def get_health_scores(instance_id: Optional[_builtins.str] = None,
...
def get_health_scores_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetHealthScoresResult]:
    """
    Use this data source to query detailed information of dbbrain health_scores
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getHealthScores:getHealthScores', __args__, opts=opts, typ=GetHealthScoresResult)
    return __ret__.apply(lambda __response__: GetHealthScoresResult(
