...
__all__ = ["TdsqlAuditLog", "TdsqlAuditLogArgs"]
...
class TdsqlAuditLogArgs:
    def __init__(
        ...
        *,
        ...
        node_request_type: pulumi.Input[_builtins.str],
        product: pulumi.Input[_builtins.str],
        start_time: pulumi.Input[_builtins.str],
        filter: pulumi.Input[Optional["TdsqlAuditLogFilterArgs"]] = None
    ):
        """
        The set of arguments for constructing a TdsqlAuditLog resource.

        :param pulumi.Input[_builtins.str] end_time: Deadline time, such as `2019-09-11 10:13:14`.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] node_request_type: Consistent with Product. For example: dcdb, mariadb.
        :param pulumi.Input[_builtins.str] product: Service product type, supported values include: dcdb - cloud database Tdsql, mariadb - cloud database MariaDB for MariaDB..
        :param pulumi.Input[_builtins.str] start_time: Start time, such as `2019-09-10 12:13:14`.
    ...
    def node_request_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def node_request_type(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def filter(self) -> pulumi.Input[Optional["TdsqlAuditLogFilterArgs"]]:
        """
    ...
    @filter.setter
    def filter(self, value: pulumi.Input[Optional["TdsqlAuditLogFilterArgs"]]):
...
class _TdsqlAuditLogState:
    def __init__(
        ...
        *,
        ...
        node_request_type: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="nodeRequestType")
    def node_request_type(self) -> pulumi.Input[_builtins.str | None]:
        """
        Consistent with Product. For example: dcdb, mariadb.
        """
        return pulumi.get(self, "node_request_type")
    ...
    @node_request_type.setter
    def node_request_type(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "node_request_type", value)
...
@pulumi.type_token("tencentcloud:Dbbrain/tdsqlAuditLog:TdsqlAuditLog")
class TdsqlAuditLog(pulumi.CustomResource):
    ...
    def __init__(
        ...
        end_time: pulumi.Input[_builtins.str | None] = None,
        filter: pulumi.Input[
            Union["TdsqlAuditLogFilterArgs", "TdsqlAuditLogFilterArgsDict"] | None
        ] = None,
        instance_id: pulumi.Input[_builtins.str | None] = None,
        node_request_type: pulumi.Input[_builtins.str | None] = None,
        product: pulumi.Input[_builtins.str | None] = None,
        ...
        my_log = tencentcloud.dbbrain.TdsqlAuditLog("my_log",
            product="dcdb",
        ...
        :param pulumi.Input[_builtins.str] end_time: Deadline time, such as `2019-09-11 10:13:14`.
        :param pulumi.Input[Union['TdsqlAuditLogFilterArgs', 'TdsqlAuditLogFilterArgsDict']] filter: Filter conditions. Logs can be filtered according to the filter conditions set.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] node_request_type: Consistent with Product. For example: dcdb, mariadb.
        :param pulumi.Input[_builtins.str] product: Service product type, supported values include: dcdb - cloud database Tdsql, mariadb - cloud database MariaDB for MariaDB..
        :param pulumi.Input[_builtins.str] start_time: Start time, such as `2019-09-10 12:13:14`.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TdsqlAuditLogArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="nodeRequestType")
    def node_request_type(self) -> pulumi.Output[_builtins.str]:
        """
        Consistent with Product. For example: dcdb, mariadb.
        """
        return pulumi.get(self, "node_request_type")
