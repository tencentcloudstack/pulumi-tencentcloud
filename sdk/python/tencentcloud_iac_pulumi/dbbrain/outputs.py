...
class ModifyDiagDbInstanceOperationInstanceConfs(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ModifyDiagDbInstanceOperationInstanceConfs. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        __self__,
        *,
        daily_inspection: _builtins.str | None = None,
        overview_display: _builtins.str | None = None,
    ):
        """
    ...
    def daily_inspection(self) -> _builtins.str | None:
        """
    ...
    def overview_display(self) -> _builtins.str | None:
        """
...
class SqlFilterSessionToken(dict):
    def __init__(__self__, *, password: _builtins.str, user: _builtins.str):
        """
...
class TdsqlAuditLogFilter(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in TdsqlAuditLogFilter. Access the value via the '{suggest}' property getter instead."
            )
...
class GetDiagDbInstancesItemResult(dict):
    ...
    def instance_confs(
        self,
    ) -> Sequence["outputs.GetDiagDbInstancesItemInstanceConfResult"]:
        """
...
class GetSlowLogTimeSeriesStatsSeriesDataResult(dict):
    ...
    def series(
        self,
    ) -> Sequence["outputs.GetSlowLogTimeSeriesStatsSeriesDataSeriesResult"]:
        """
        Monitor metrics.
        """
...
class GetSlowLogTimeSeriesStatsTimeSeriesResult(dict):
    def __init__(__self__, *, count: _builtins.int, timestamp: _builtins.int):
        """
...
class GetTopSpaceSchemaTimeSeriesTopSpaceSchemaTimeSeriesResult(dict):
    def __init__(
        __self__,
        *,
        series_datas: Sequence[
            "outputs.GetTopSpaceSchemaTimeSeriesTopSpaceSchemaTimeSeriesSeriesDataResult"
        ],
        table_schema: _builtins.str,
    ):
        """
...
class GetTopSpaceSchemaTimeSeriesTopSpaceSchemaTimeSeriesSeriesDataResult(dict):
    def __init__(
        ...
        *,
        series: Sequence[
            "outputs.GetTopSpaceSchemaTimeSeriesTopSpaceSchemaTimeSeriesSeriesDataSeriesResult"
        ],
        timestamps: Sequence[_builtins.int],
    ):
        """
...
class GetTopSpaceTableTimeSeriesTopSpaceTableTimeSeriesResult(dict):
    def __init__(
        ...
        *,
        engine: _builtins.str,
        series_datas: Sequence[
            "outputs.GetTopSpaceTableTimeSeriesTopSpaceTableTimeSeriesSeriesDataResult"
        ],
        table_name: _builtins.str,
        table_schema: _builtins.str,
    ):
...
class GetTopSpaceTableTimeSeriesTopSpaceTableTimeSeriesSeriesDataResult(dict):
    def __init__(
        ...
        *,
        series: Sequence[
            "outputs.GetTopSpaceTableTimeSeriesTopSpaceTableTimeSeriesSeriesDataSeriesResult"
        ],
        timestamps: Sequence[_builtins.int],
    ):
        """
