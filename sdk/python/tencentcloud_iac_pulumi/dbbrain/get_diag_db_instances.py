...
def get_diag_db_instances(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getDiagDbInstances:getDiagDbInstances",
        __args__,
        opts=opts,
        typ=GetDiagDbInstancesResult,
    ).value
...
def get_diag_db_instances_output(
...
) -> pulumi.Output[GetDiagDbInstancesResult]:
    """
    Use this data source to query detailed information of dbbrain diag_db_instances
    ...
    return __ret__.apply(
        lambda __response__: GetDiagDbInstancesResult(
