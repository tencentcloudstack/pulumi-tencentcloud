...
def get_slow_log_user_host_stats(end_time: Optional[_builtins.str] = None,
...
def get_slow_log_user_host_stats_output(end_time: Optional[pulumi.Input[_builtins.str]] = None,
                                        instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                        md5: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSlowLogUserHostStatsResult]:
    """
    Use this data source to query detailed information of dbbrain slow_log_user_host_stats
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getSlowLogUserHostStats:getSlowLogUserHostStats', __args__, opts=opts, typ=GetSlowLogUserHostStatsResult)
    return __ret__.apply(lambda __response__: GetSlowLogUserHostStatsResult(
