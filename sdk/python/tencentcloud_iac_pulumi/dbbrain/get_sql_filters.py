...
class GetSqlFiltersResult:
    ...
    def filter_ids(self) -> Sequence[_builtins.int] | None:
...
def get_sql_filters(
    filter_ids: Sequence[_builtins.int] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getSqlFilters:getSqlFilters",
        __args__,
        opts=opts,
        typ=GetSqlFiltersResult,
    ).value
...
def get_sql_filters_output(
    filter_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
...
) -> pulumi.Output[GetSqlFiltersResult]:
    """
    Use this data source to query detailed information of dbbrain sqlFilters
    ...
    return __ret__.apply(
        lambda __response__: GetSqlFiltersResult(
