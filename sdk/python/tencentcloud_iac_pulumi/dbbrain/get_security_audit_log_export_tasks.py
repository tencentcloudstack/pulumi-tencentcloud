...
class GetSecurityAuditLogExportTasksResult:
    ...
    def __init__(
        __self__,
        async_request_ids=None,
        id=None,
        lists=None,
        product=None,
        result_output_file=None,
        sec_audit_group_id=None,
    ):
    ...
    def async_request_ids(self) -> Sequence[_builtins.int] | None:
...
class AwaitableGetSecurityAuditLogExportTasksResult(
    GetSecurityAuditLogExportTasksResult
):
...
def get_security_audit_log_export_tasks(
    async_request_ids: Sequence[_builtins.int] | None = None,
    product: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    sec_audit_group_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getSecurityAuditLogExportTasks:getSecurityAuditLogExportTasks",
        __args__,
        opts=opts,
        typ=GetSecurityAuditLogExportTasksResult,
    ).value
...
def get_security_audit_log_export_tasks_output(
    async_request_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
...
) -> pulumi.Output[GetSecurityAuditLogExportTasksResult]:
    """
    Use this data source to query detailed information of dbbrain securityAuditLogExportTasks
    ...
    return __ret__.apply(
        lambda __response__: GetSecurityAuditLogExportTasksResult(
