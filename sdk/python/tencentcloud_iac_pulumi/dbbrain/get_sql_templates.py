...
def get_sql_templates(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getSqlTemplates:getSqlTemplates",
        __args__,
        opts=opts,
        typ=GetSqlTemplatesResult,
    ).value
...
def get_sql_templates_output(
...
) -> pulumi.Output[GetSqlTemplatesResult]:
    """
    Use this data source to query detailed information of dbbrain sql_templates
    ...
    return __ret__.apply(
        lambda __response__: GetSqlTemplatesResult(
            ...
            sql_id=pulumi.get(__response__, "sql_id"),
            sql_template=pulumi.get(__response__, "sql_template"),
            sql_text=pulumi.get(__response__, "sql_text"),
            sql_type=pulumi.get(__response__, "sql_type"),
        )
    )
