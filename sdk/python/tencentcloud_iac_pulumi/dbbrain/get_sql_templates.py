...
def get_sql_templates(instance_id: Optional[_builtins.str] = None,
...
def get_sql_templates_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getSqlTemplates:getSqlTemplates', __args__, opts=opts, typ=GetSqlTemplatesResult)
