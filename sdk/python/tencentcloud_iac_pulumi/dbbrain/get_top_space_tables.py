...
def get_top_space_tables(instance_id: Optional[_builtins.str] = None,
...
def get_top_space_tables_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTopSpaceTablesResult]:
    """
    Use this data source to query detailed information of dbbrain top_space_tables
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getTopSpaceTables:getTopSpaceTables', __args__, opts=opts, typ=GetTopSpaceTablesResult)
    return __ret__.apply(lambda __response__: GetTopSpaceTablesResult(
