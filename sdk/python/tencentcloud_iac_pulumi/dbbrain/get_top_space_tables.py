...
class GetTopSpaceTablesResult:
    ...
    def top_space_tables(
        self,
    ) -> Sequence["outputs.GetTopSpaceTablesTopSpaceTableResult"]:
        """
...
def get_top_space_tables(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getTopSpaceTables:getTopSpaceTables",
        __args__,
        opts=opts,
        typ=GetTopSpaceTablesResult,
    ).value
...
def get_top_space_tables_output(
...
) -> pulumi.Output[GetTopSpaceTablesResult]:
    """
    Use this data source to query detailed information of dbbrain top_space_tables
    ...
    return __ret__.apply(
        lambda __response__: GetTopSpaceTablesResult(
            ...
            top_space_tables=pulumi.get(__response__, "top_space_tables"),
        )
    )
