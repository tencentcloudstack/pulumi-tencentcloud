...
__all__ = ["SecurityAuditLogExportTask", "SecurityAuditLogExportTaskArgs"]
...
class SecurityAuditLogExportTaskArgs:
    def __init__(
        ...
        *,
        ...
        sec_audit_group_id: pulumi.Input[_builtins.str],
        start_time: pulumi.Input[_builtins.str],
        danger_levels: pulumi.Input[Sequence[pulumi.Input[_builtins.int]] | None] = None
    ):
        """
        ...
        :param pulumi.Input[_builtins.str] product: product, optional value is mysql.
        :param pulumi.Input[_builtins.str] sec_audit_group_id: security audit group id.
        :param pulumi.Input[_builtins.str] start_time: start time.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] danger_levels: List of log risk levels, supported values include: 0 no risk; 1 low risk; 2 medium risk; 3 high risk.
        """
    ...
    def sec_audit_group_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def sec_audit_group_id(self, value: pulumi.Input[_builtins.str]):
...
class _SecurityAuditLogExportTaskState:
    def __init__(
        __self__,
        *,
        async_request_id: pulumi.Input[_builtins.int | None] = None,
        danger_levels: pulumi.Input[
        ...
        sec_audit_group_id: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.int] async_request_id: request of async id.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] danger_levels: List of log risk levels, supported values include: 0 no risk; 1 low risk; 2 medium risk; 3 high risk.
        :param pulumi.Input[_builtins.str] end_time: end time.
        :param pulumi.Input[_builtins.str] product: product, optional value is mysql.
        :param pulumi.Input[_builtins.str] sec_audit_group_id: security audit group id.
    ...
    def async_request_id(self) -> pulumi.Input[_builtins.int | None]:
        """
        request of async id.
        """
    ...
    def async_request_id(self, value: pulumi.Input[_builtins.int | None]):
    ...
    @_builtins.property
    @pulumi.getter(name="secAuditGroupId")
    def sec_audit_group_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        security audit group id.
        """
        return pulumi.get(self, "sec_audit_group_id")
    ...
    @sec_audit_group_id.setter
    def sec_audit_group_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "sec_audit_group_id", value)
...
class SecurityAuditLogExportTask(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SecurityAuditLogExportTaskArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = SecurityAuditLogExportTaskArgs.__new__(
                SecurityAuditLogExportTaskArgs
            )
    ...
    def get(
        ...
        __props__ = _SecurityAuditLogExportTaskState.__new__(
            _SecurityAuditLogExportTaskState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="asyncRequestId")
    def async_request_id(self) -> pulumi.Output[_builtins.int]:
        """
        request of async id.
        """
        return pulumi.get(self, "async_request_id")
    ...
    @_builtins.property
    @pulumi.getter(name="dangerLevels")
    def danger_levels(self) -> pulumi.Output[Sequence[_builtins.int] | None]:
        """
        List of log risk levels, supported values include: 0 no risk; 1 low risk; 2 medium risk; 3 high risk.
        """
        return pulumi.get(self, "danger_levels")
    ...
    @_builtins.property
    @pulumi.getter(name="secAuditGroupId")
    def sec_audit_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        security audit group id.
        """
        return pulumi.get(self, "sec_audit_group_id")
