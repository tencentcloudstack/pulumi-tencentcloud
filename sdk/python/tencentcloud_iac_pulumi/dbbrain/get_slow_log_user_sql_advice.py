...
def get_slow_log_user_sql_advice(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getSlowLogUserSqlAdvice:getSlowLogUserSqlAdvice",
        __args__,
        opts=opts,
        typ=GetSlowLogUserSqlAdviceResult,
    ).value
...
def get_slow_log_user_sql_advice_output(
    ...
    schema: pulumi.Input[_builtins.str | None] = None,
    sql_text: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetSlowLogUserSqlAdviceResult]:
    """
    Use this data source to query detailed information of dbbrain slow_log_user_sql_advice
    ...
    return __ret__.apply(
        lambda __response__: GetSlowLogUserSqlAdviceResult(
