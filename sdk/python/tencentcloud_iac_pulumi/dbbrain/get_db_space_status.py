...
class GetDbSpaceStatusResult:
    ...
    def range_days(self) -> _builtins.int | None:
...
def get_db_space_status(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getDbSpaceStatus:getDbSpaceStatus",
        __args__,
        opts=opts,
        typ=GetDbSpaceStatusResult,
    ).value
...
def get_db_space_status_output(
    ...
    return __ret__.apply(
        lambda __response__: GetDbSpaceStatusResult(
