...
class GetDiagEventResult:
    ...
    @_builtins.property
    @pulumi.getter
    def explanation(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def suggestions(self) -> _builtins.str:
        """
...
def get_diag_event(
    event_id: _builtins.int | None = None,
    ...
    :param _builtins.int event_id: Event ID. Obtain it through `Get Instance Diagnosis History DescribeDBDiagHistory`.
    :param _builtins.str instance_id: isntance id.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dbbrain/getDiagEvent:getDiagEvent",
        __args__,
        opts=opts,
        typ=GetDiagEventResult,
    ).value
...
def get_diag_event_output(
    event_id: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetDiagEventResult]:
    """
    Use this data source to query detailed information of dbbrain diag_event
    ...
    return __ret__.apply(
        lambda __response__: GetDiagEventResult(
            diag_item=pulumi.get(__response__, "diag_item"),
            diag_type=pulumi.get(__response__, "diag_type"),
            end_time=pulumi.get(__response__, "end_time"),
            event_id=pulumi.get(__response__, "event_id"),
            explanation=pulumi.get(__response__, "explanation"),
            id=pulumi.get(__response__, "id"),
            instance_id=pulumi.get(__response__, "instance_id"),
            metric=pulumi.get(__response__, "metric"),
            outline=pulumi.get(__response__, "outline"),
            problem=pulumi.get(__response__, "problem"),
            ...
            suggestions=pulumi.get(__response__, "suggestions"),
        )
    )
