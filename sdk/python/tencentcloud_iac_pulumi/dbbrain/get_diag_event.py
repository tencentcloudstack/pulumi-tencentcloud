...
def get_diag_event(event_id: Optional[_builtins.int] = None,
...
def get_diag_event_output(event_id: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDiagEventResult]:
    """
    Use this data source to query detailed information of dbbrain diag_event
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dbbrain/getDiagEvent:getDiagEvent', __args__, opts=opts, typ=GetDiagEventResult)
    return __ret__.apply(lambda __response__: GetDiagEventResult(
