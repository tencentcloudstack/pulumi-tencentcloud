...
class AccessRuleArgs:
    def __init__(__self__, *,
                 ...
                 rw_permission: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def rw_permission(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def rw_permission(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _AccessRuleState:
    def __init__(__self__, *,
                 ...
                 auth_client_ip: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="authClientIp")
    def auth_client_ip(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        A single IP or a single IP address range such as 10.1.10.11 or 10.10.1.0/24 indicates that all IPs are allowed. Please note that the IP entered should be CVM's private IP.
        """
        return pulumi.get(self, "auth_client_ip")
    ...
    @auth_client_ip.setter
    def auth_client_ip(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "auth_client_ip", value)
...
class AccessRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[_builtins.int]] = None,
            rw_permission: Optional[pulumi.Input[_builtins.str]] = None,
            user_permission: Optional[pulumi.Input[_builtins.str]] = None) -> 'AccessRule':
        """
