...
def get_mount_targets(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cfs/getMountTargets:getMountTargets",
        __args__,
        opts=opts,
        typ=GetMountTargetsResult,
    ).value
...
def get_mount_targets_output(
...
) -> pulumi.Output[GetMountTargetsResult]:
    """
    Use this data source to query detailed information of cfs mount_targets
    ...
    return __ret__.apply(
        lambda __response__: GetMountTargetsResult(
