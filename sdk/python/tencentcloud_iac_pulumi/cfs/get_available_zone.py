...
def get_available_zone(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cfs/getAvailableZone:getAvailableZone",
        __args__,
        opts=opts,
        typ=GetAvailableZoneResult,
    ).value
...
def get_available_zone_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAvailableZoneResult(
