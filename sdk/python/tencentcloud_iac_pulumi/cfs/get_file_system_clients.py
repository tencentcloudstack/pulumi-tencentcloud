...
def get_file_system_clients(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cfs/getFileSystemClients:getFileSystemClients",
        __args__,
        opts=opts,
        typ=GetFileSystemClientsResult,
    ).value
...
def get_file_system_clients_output(
...
) -> pulumi.Output[GetFileSystemClientsResult]:
    """
    Use this data source to query detailed information of cfs file_system_clients
    ...
    return __ret__.apply(
        lambda __response__: GetFileSystemClientsResult(
