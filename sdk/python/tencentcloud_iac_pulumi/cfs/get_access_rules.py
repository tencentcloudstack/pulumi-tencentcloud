...
class GetAccessRulesResult:
    ...
    def access_rule_id(self) -> _builtins.str | None:
        """
    ...
    def access_rule_lists(
        self,
    ) -> Sequence["outputs.GetAccessRulesAccessRuleListResult"]:
        """
...
def get_access_rules(
    ...
    access_rule_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cfs/getAccessRules:getAccessRules",
        __args__,
        opts=opts,
        typ=GetAccessRulesResult,
    ).value
...
def get_access_rules_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAccessRulesResult(
            access_group_id=pulumi.get(__response__, "access_group_id"),
            access_rule_id=pulumi.get(__response__, "access_rule_id"),
            access_rule_lists=pulumi.get(__response__, "access_rule_lists"),
