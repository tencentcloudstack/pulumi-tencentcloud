...
def get_access_rules(access_group_id: Optional[_builtins.str] = None,
...
def get_access_rules_output(access_group_id: Optional[pulumi.Input[_builtins.str]] = None,
                            access_rule_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cfs/getAccessRules:getAccessRules', __args__, opts=opts, typ=GetAccessRulesResult)
