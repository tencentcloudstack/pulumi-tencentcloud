...
__all__ = ["AutoSnapshotPolicyAttachment", "AutoSnapshotPolicyAttachmentArgs"]
...
class AutoSnapshotPolicyAttachmentArgs:
    def __init__(
        ...
        *,
        ...
        file_system_ids: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a AutoSnapshotPolicyAttachment resource.

        :param pulumi.Input[_builtins.str] auto_snapshot_policy_id: ID of the snapshot to be unbound.
        :param pulumi.Input[_builtins.str] file_system_ids: List of IDs of the file systems to be unbound, separated by comma.
        """
    ...
    def file_system_ids(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def file_system_ids(self, value: pulumi.Input[_builtins.str]):
...
class _AutoSnapshotPolicyAttachmentState:
    def __init__(
        __self__,
        *,
        auto_snapshot_policy_id: pulumi.Input[_builtins.str | None] = None,
        file_system_ids: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="autoSnapshotPolicyId")
    def auto_snapshot_policy_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        ID of the snapshot to be unbound.
        """
        return pulumi.get(self, "auto_snapshot_policy_id")
    ...
    @auto_snapshot_policy_id.setter
    def auto_snapshot_policy_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "auto_snapshot_policy_id", value)

    @_builtins.property
    @pulumi.getter(name="fileSystemIds")
    def file_system_ids(self) -> pulumi.Input[_builtins.str | None]:
        """
        List of IDs of the file systems to be unbound, separated by comma.
        """
        return pulumi.get(self, "file_system_ids")
    ...
    @file_system_ids.setter
    def file_system_ids(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "file_system_ids", value)
...
class AutoSnapshotPolicyAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        auto_snapshot_policy_attachment = tencentcloud.cfs.AutoSnapshotPolicyAttachment("auto_snapshot_policy_attachment",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            AutoSnapshotPolicyAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = AutoSnapshotPolicyAttachmentArgs.__new__(
                AutoSnapshotPolicyAttachmentArgs
            )
    ...
    def get(
        ...
        __props__ = _AutoSnapshotPolicyAttachmentState.__new__(
            _AutoSnapshotPolicyAttachmentState
        )

        __props__.__dict__["auto_snapshot_policy_id"] = auto_snapshot_policy_id
        __props__.__dict__["file_system_ids"] = file_system_ids
        return AutoSnapshotPolicyAttachment(
    ...
    @_builtins.property
    @pulumi.getter(name="fileSystemIds")
    def file_system_ids(self) -> pulumi.Output[_builtins.str]:
        """
        List of IDs of the file systems to be unbound, separated by comma.
        """
        return pulumi.get(self, "file_system_ids")
