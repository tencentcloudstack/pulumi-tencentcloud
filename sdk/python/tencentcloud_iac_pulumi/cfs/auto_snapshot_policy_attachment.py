...
class _AutoSnapshotPolicyAttachmentState:
    def __init__(__self__, *,
                 ...
                 file_system_ids: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="fileSystemIds")
    def file_system_ids(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        List of IDs of the file systems to be unbound, separated by comma.
        """
        return pulumi.get(self, "file_system_ids")
    ...
    @file_system_ids.setter
    def file_system_ids(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "file_system_ids", value)


@pulumi.type_token("tencentcloud:Cfs/autoSnapshotPolicyAttachment:AutoSnapshotPolicyAttachment")
class AutoSnapshotPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            auto_snapshot_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            file_system_ids: pulumi.Input[Optional[_builtins.str]] = None) -> 'AutoSnapshotPolicyAttachment':
        """
