...
__all__ = ["SignUpCfsService", "SignUpCfsServiceArgs"]
...
class _SignUpCfsServiceState:
    def __init__(
        __self__, *, cfs_service_status: pulumi.Input[_builtins.str | None] = None
    ):
        """
        Input properties used for looking up and filtering SignUpCfsService resources.

        :param pulumi.Input[_builtins.str] cfs_service_status: Current status of the CFS service for this user. Valid values: creating (activating); created (activated).
        """
    ...
    def cfs_service_status(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def cfs_service_status(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "cfs_service_status", value)


@pulumi.type_token("tencentcloud:Cfs/signUpCfsService:SignUpCfsService")
class SignUpCfsService(pulumi.CustomResource):
    ...
    def __init__(
        ...
        sign_up_cfs_service = tencentcloud.cfs.SignUpCfsService("sign_up_cfs_service")
        ```
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: SignUpCfsServiceArgs | None = None,
        opts: pulumi.ResourceOptions | None = None,
    ):
        """
        Provides a resource to create a cfs sign_up_cfs_service
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SignUpCfsServiceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def get(
        ...
        id: pulumi.Input[str],
        opts: pulumi.ResourceOptions | None = None,
        cfs_service_status: pulumi.Input[_builtins.str | None] = None,
    ) -> "SignUpCfsService":
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cfsServiceStatus")
    def cfs_service_status(self) -> pulumi.Output[_builtins.str]:
        """
        Current status of the CFS service for this user. Valid values: creating (activating); created (activated).
        """
        return pulumi.get(self, "cfs_service_status")
