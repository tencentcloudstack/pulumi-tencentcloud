...
class AccessGroupArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] description: Description of the access group, and max length is 255.
        :param pulumi.Input[_builtins.str] name: Name of the access group, and max length is 64.
        """
...
class _AccessGroupState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] create_time: Create time of the access group.
        :param pulumi.Input[_builtins.str] description: Description of the access group, and max length is 255.
        :param pulumi.Input[_builtins.str] name: Name of the access group, and max length is 64.
        """
...
@pulumi.type_token("tencentcloud:Cfs/accessGroup:AccessGroup")
class AccessGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.cfs.AccessGroup("example",
            name="tx_example",
            description="desc.")
        ```
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: AccessGroupArgs | None = None,
        opts: pulumi.ResourceOptions | None = None,
    ):
        """
        Provides a resource to create a CFS access group.
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cfs/accessGroup:AccessGroup", resource_name, __props__, opts
        )
