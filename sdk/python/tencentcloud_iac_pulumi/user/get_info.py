...
def get_info(result_output_file: Optional[_builtins.str] = None,
...
def get_info_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInfoResult]:
    """
    Use this data source to query user appid, uin and ownerUin.
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:User/getInfo:getInfo', __args__, opts=opts, typ=GetInfoResult)
