...
class GetSignResult:
    ...
    def file_type(self) -> _builtins.int | None:
...
def get_sign(
    file_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getSign:getSign", __args__, opts=opts, typ=GetSignResult
    ).value
...
def get_sign_output(
    file_type: pulumi.Input[_builtins.int | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetSignResult(
