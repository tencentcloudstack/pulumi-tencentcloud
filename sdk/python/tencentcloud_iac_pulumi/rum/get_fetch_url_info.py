...
def get_fetch_url_info(area: Optional[_builtins.str] = None,
...
def get_fetch_url_info_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFetchUrlInfoResult]:
    """
    Use this data source to query detailed information of rum fetch_url_info
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getFetchUrlInfo:getFetchUrlInfo', __args__, opts=opts, typ=GetFetchUrlInfoResult)
    return __ret__.apply(lambda __response__: GetFetchUrlInfoResult(
