...
def get_custom_url(area: Optional[_builtins.str] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCustomUrlResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getCustomUrl:getCustomUrl', __args__, opts=opts, typ=GetCustomUrlResult).value
...
def get_custom_url_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCustomUrlResult]:
    """
    Use this data source to query detailed information of rum custom_url
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getCustomUrl:getCustomUrl', __args__, opts=opts, typ=GetCustomUrlResult)
    return __ret__.apply(lambda __response__: GetCustomUrlResult(
