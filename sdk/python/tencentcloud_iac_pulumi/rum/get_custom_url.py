...
def get_custom_url(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_custom_url)
def get_custom_url_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetCustomUrlResult]:
    """
    Use this data source to query detailed information of rum custom_url
