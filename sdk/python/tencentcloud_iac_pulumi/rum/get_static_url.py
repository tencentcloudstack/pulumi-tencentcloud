...
def get_static_url(area: Optional[_builtins.str] = None,
                   ...
                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStaticUrlResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getStaticUrl:getStaticUrl', __args__, opts=opts, typ=GetStaticUrlResult).value
...
def get_static_url_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                          ...
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStaticUrlResult]:
    """
    Use this data source to query detailed information of rum static_url
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getStaticUrl:getStaticUrl', __args__, opts=opts, typ=GetStaticUrlResult)
    return __ret__.apply(lambda __response__: GetStaticUrlResult(
