...
def get_static_url(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_static_url)
def get_static_url_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStaticUrlResult]:
    """
    Use this data source to query detailed information of rum static_url
