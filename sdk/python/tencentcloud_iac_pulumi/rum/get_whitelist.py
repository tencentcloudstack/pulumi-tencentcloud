...
def get_whitelist(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getWhitelist:getWhitelist",
        __args__,
        opts=opts,
        typ=GetWhitelistResult,
    ).value
...
def get_whitelist_output(
...
) -> pulumi.Output[GetWhitelistResult]:
    """
    Use this data source to query detailed information of rum whitelist
    ...
    return __ret__.apply(
        lambda __response__: GetWhitelistResult(
