...
def get_offline_log_config(
    project_key: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getOfflineLogConfig:getOfflineLogConfig",
        __args__,
        opts=opts,
        typ=GetOfflineLogConfigResult,
    ).value
...
def get_offline_log_config_output(
...
) -> pulumi.Output[GetOfflineLogConfigResult]:
    """
    Use this data source to query detailed information of rum offlineLogConfig
    ...
    return __ret__.apply(
        lambda __response__: GetOfflineLogConfigResult(
