...
class GetReportCountResult:
    ...
    def report_type(self) -> _builtins.str | None:
...
def get_report_count(
    ...
    report_type: _builtins.str | None = None,
    ...
    report_count = tencentcloud.rum.get_report_count(start_time=1625444040,
        end_time=1625454840,
        project_id=1,
        report_type="log")
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getReportCount:getReportCount",
        __args__,
        opts=opts,
        typ=GetReportCountResult,
    ).value
...
def get_report_count_output(
    ...
    report_type: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetReportCountResult]:
    """
    Use this data source to query detailed information of rum report_count
    ...
    return __ret__.apply(
        lambda __response__: GetReportCountResult(
            end_time=pulumi.get(__response__, "end_time"),
            id=pulumi.get(__response__, "id"),
            instance_id=pulumi.get(__response__, "instance_id"),
            project_id=pulumi.get(__response__, "project_id"),
            report_type=pulumi.get(__response__, "report_type"),
