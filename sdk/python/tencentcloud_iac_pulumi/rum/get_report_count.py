...
def get_report_count(end_time: Optional[_builtins.int] = None,
...
def get_report_count_output(end_time: Optional[pulumi.Input[_builtins.int]] = None,
                            instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            project_id: Optional[pulumi.Input[_builtins.int]] = None,
                            report_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            start_time: Optional[pulumi.Input[_builtins.int]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetReportCountResult]:
    """
    Use this data source to query detailed information of rum report_count
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getReportCount:getReportCount', __args__, opts=opts, typ=GetReportCountResult)
    return __ret__.apply(lambda __response__: GetReportCountResult(
