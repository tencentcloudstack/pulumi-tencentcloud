...
def get_static_resource(area: Optional[_builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStaticResourceResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getStaticResource:getStaticResource', __args__, opts=opts, typ=GetStaticResourceResult).value
...
def get_static_resource_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStaticResourceResult]:
    """
    Use this data source to query detailed information of rum static_resource
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getStaticResource:getStaticResource', __args__, opts=opts, typ=GetStaticResourceResult)
    return __ret__.apply(lambda __response__: GetStaticResourceResult(
