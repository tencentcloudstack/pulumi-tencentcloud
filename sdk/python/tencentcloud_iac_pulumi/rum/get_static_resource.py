...
def get_static_resource(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_static_resource)
def get_static_resource_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStaticResourceResult]:
    """
    Use this data source to query detailed information of rum static_resource
