...
class GetPvUrlStatisticsResult:
    ...
    def group_by_type(self) -> Optional[int]:
...
def get_pv_url_statistics(area: Optional[str] = None,
                          ...
                          group_by_type: Optional[int] = None,
    ...
    :param int group_by_type: Query groupby type `1`: 1m, `2`: 5m, `3`: 30m, `4`: 1h, `5`: 1d.
    ...
    return AwaitableGetPvUrlStatisticsResult(
        ...
        from_=__ret__.from_,
        group_by_type=__ret__.group_by_type,
        id=__ret__.id,
...
@_utilities.lift_output_func(get_pv_url_statistics)
def get_pv_url_statistics_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 group_by_type: Optional[pulumi.Input[Optional[int]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPvUrlStatisticsResult]:
    """
    Use this data source to query detailed information of rum pv_url_statistics
