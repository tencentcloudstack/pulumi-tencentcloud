...
class GetPvUrlStatisticsResult:
    ...
    """
    def __init__(__self__, area=None, brand=None, browser=None, device=None, end_time=None, engine=None, env=None, ext_first=None, ext_second=None, ext_third=None, from_=None, group_by_type=None, id=None, is_abroad=None, isp=None, level=None, net_type=None, os=None, platform=None, project_id=None, result=None, result_output_file=None, start_time=None, type=None, version_num=None):
    ...
    def group_by_type(self) -> Optional[_builtins.int]:
...
def get_pv_url_statistics(area: Optional[_builtins.str] = None,
                          ...
                          group_by_type: Optional[_builtins.int] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPvUrlStatisticsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getPvUrlStatistics:getPvUrlStatistics', __args__, opts=opts, typ=GetPvUrlStatisticsResult).value
...
def get_pv_url_statistics_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 group_by_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPvUrlStatisticsResult]:
    """
    Use this data source to query detailed information of rum pv_url_statistics
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getPvUrlStatistics:getPvUrlStatistics', __args__, opts=opts, typ=GetPvUrlStatisticsResult)
    return __ret__.apply(lambda __response__: GetPvUrlStatisticsResult(
