...
class GetFetchUrlResult:
    ...
    def net_status(self) -> Optional[str]:
...
def get_fetch_url(area: Optional[str] = None,
    ...
    :param str net_status: The network status where the data reporting takes place.`0`: noraml, `1`: week, `2`: disconnection, `3`: unknown.
...
@_utilities.lift_output_func(get_fetch_url)
def get_fetch_url_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                         ...
                         net_status: Optional[pulumi.Input[Optional[str]]] = None,
