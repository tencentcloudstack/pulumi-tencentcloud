...
def get_static_project(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_static_project)
def get_static_project_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStaticProjectResult]:
    """
    Use this data source to query detailed information of rum static_project
