...
def get_static_project(area: Optional[_builtins.str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStaticProjectResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getStaticProject:getStaticProject', __args__, opts=opts, typ=GetStaticProjectResult).value
...
def get_static_project_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStaticProjectResult]:
    """
    Use this data source to query detailed information of rum static_project
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getStaticProject:getStaticProject', __args__, opts=opts, typ=GetStaticProjectResult)
    return __ret__.apply(lambda __response__: GetStaticProjectResult(
