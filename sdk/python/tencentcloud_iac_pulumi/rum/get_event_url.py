...
def get_event_url(area: Optional[str] = None,
    ...
    :param str name: Event name for data reporting.
...
@_utilities.lift_output_func(get_event_url)
def get_event_url_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetEventUrlResult]:
    """
    Use this data source to query detailed information of rum event_url
