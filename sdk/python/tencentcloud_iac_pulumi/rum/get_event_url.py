...
def get_event_url(area: Optional[_builtins.str] = None,
                  ...
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetEventUrlResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getEventUrl:getEventUrl', __args__, opts=opts, typ=GetEventUrlResult).value
...
def get_event_url_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetEventUrlResult]:
    """
    Use this data source to query detailed information of rum event_url
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getEventUrl:getEventUrl', __args__, opts=opts, typ=GetEventUrlResult)
    return __ret__.apply(lambda __response__: GetEventUrlResult(
