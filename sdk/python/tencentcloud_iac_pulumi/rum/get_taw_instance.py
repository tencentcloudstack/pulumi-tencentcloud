...
class GetTawInstanceResult:
    ...
    def charge_statuses(self) -> Sequence[_builtins.int] | None:
        return pulumi.get(self, "charge_statuses")

    @_builtins.property
    @pulumi.getter(name="chargeTypes")
    def charge_types(self) -> Sequence[_builtins.int] | None:
...
def get_taw_instance(
    area_ids: Sequence[_builtins.int] | None = None,
    charge_statuses: Sequence[_builtins.int] | None = None,
    charge_types: Sequence[_builtins.int] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getTawInstance:getTawInstance",
        __args__,
        opts=opts,
        typ=GetTawInstanceResult,
    ).value
...
def get_taw_instance_output(
    area_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
    charge_statuses: pulumi.Input[Sequence[_builtins.int] | None] = None,
    charge_types: pulumi.Input[Sequence[_builtins.int] | None] = None,
...
) -> pulumi.Output[GetTawInstanceResult]:
    """
    Use this data source to query detailed information of rum tawInstance
    ...
    return __ret__.apply(
        lambda __response__: GetTawInstanceResult(
