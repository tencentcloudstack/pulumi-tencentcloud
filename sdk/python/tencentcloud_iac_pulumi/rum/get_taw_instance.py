...
class GetTawInstanceResult:
    ...
    def charge_statuses(self) -> Optional[Sequence[_builtins.int]]:
        return pulumi.get(self, "charge_statuses")

    @_builtins.property
    @pulumi.getter(name="chargeTypes")
    def charge_types(self) -> Optional[Sequence[_builtins.int]]:
...
def get_taw_instance(area_ids: Optional[Sequence[_builtins.int]] = None,
                     charge_statuses: Optional[Sequence[_builtins.int]] = None,
                     charge_types: Optional[Sequence[_builtins.int]] = None,
    ...
    taw_instance = tencentcloud.Rum.get_taw_instance(charge_statuses=[1],
        charge_types=[1],
        area_ids=[1],
        instance_statuses=[2],
    ...
    :param Sequence[_builtins.int] area_ids: Region ID.
    :param Sequence[_builtins.int] charge_statuses: Billing status.
    :param Sequence[_builtins.int] charge_types: Billing type.
    :param Sequence[_builtins.str] instance_ids: Instance ID.
    :param Sequence[_builtins.int] instance_statuses: Instance status (`1`: creating; `2`: running; `3`: exceptional; `4`: restarting; `5`: stopping; `6`: stopped; `7`: terminating; `8`: terminated).
...
def get_taw_instance_output(area_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.int]]]] = None,
                            charge_statuses: Optional[pulumi.Input[Optional[Sequence[_builtins.int]]]] = None,
                            charge_types: Optional[pulumi.Input[Optional[Sequence[_builtins.int]]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTawInstanceResult]:
    """
    Use this data source to query detailed information of rum tawInstance
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getTawInstance:getTawInstance', __args__, opts=opts, typ=GetTawInstanceResult)
    return __ret__.apply(lambda __response__: GetTawInstanceResult(
        area_ids=pulumi.get(__response__, 'area_ids'),
        charge_statuses=pulumi.get(__response__, 'charge_statuses'),
