...
def get_pv_url_info(area: Optional[_builtins.str] = None,
                    ...
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPvUrlInfoResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getPvUrlInfo:getPvUrlInfo', __args__, opts=opts, typ=GetPvUrlInfoResult).value
...
def get_pv_url_info_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           ...
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPvUrlInfoResult]:
    """
    Use this data source to query detailed information of rum pv_url_info
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getPvUrlInfo:getPvUrlInfo', __args__, opts=opts, typ=GetPvUrlInfoResult)
    return __ret__.apply(lambda __response__: GetPvUrlInfoResult(
