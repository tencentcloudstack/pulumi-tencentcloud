...
def get_pv_url_info(area: Optional[str] = None,
    ...
    :param str type: Type value is fixed, please always pass `pagepv`.
...
@_utilities.lift_output_func(get_pv_url_info)
def get_pv_url_info_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPvUrlInfoResult]:
    """
    Use this data source to query detailed information of rum pv_url_info
