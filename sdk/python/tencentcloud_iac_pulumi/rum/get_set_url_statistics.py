...
def get_set_url_statistics(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_set_url_statistics)
def get_set_url_statistics_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSetUrlStatisticsResult]:
    """
    Use this data source to query detailed information of rum set_url_statistics
