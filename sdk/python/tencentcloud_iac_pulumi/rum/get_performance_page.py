...
def get_performance_page(area: Optional[str] = None,
...
@_utilities.lift_output_func(get_performance_page)
def get_performance_page_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetPerformancePageResult]:
    """
    Use this data source to query detailed information of rum performance_page
