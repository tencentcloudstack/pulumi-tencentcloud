...
def get_performance_page(area: Optional[_builtins.str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPerformancePageResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getPerformancePage:getPerformancePage', __args__, opts=opts, typ=GetPerformancePageResult).value
...
def get_performance_page_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPerformancePageResult]:
    """
    Use this data source to query detailed information of rum performance_page
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getPerformancePage:getPerformancePage', __args__, opts=opts, typ=GetPerformancePageResult)
    return __ret__.apply(lambda __response__: GetPerformancePageResult(
