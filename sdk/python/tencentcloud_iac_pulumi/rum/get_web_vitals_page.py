...
def get_web_vitals_page(area: Optional[_builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWebVitalsPageResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Rum/getWebVitalsPage:getWebVitalsPage', __args__, opts=opts, typ=GetWebVitalsPageResult).value
...
def get_web_vitals_page_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWebVitalsPageResult]:
    """
    Use this data source to query detailed information of rum web_vitals_page
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getWebVitalsPage:getWebVitalsPage', __args__, opts=opts, typ=GetWebVitalsPageResult)
    return __ret__.apply(lambda __response__: GetWebVitalsPageResult(
