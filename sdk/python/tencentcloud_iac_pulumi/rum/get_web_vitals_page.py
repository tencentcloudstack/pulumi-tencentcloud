...
def get_web_vitals_page(area: Optional[str] = None,
    ...
    :param str type: Query Data Type(from or empty). `from`: CostType query by from.
...
@_utilities.lift_output_func(get_web_vitals_page)
def get_web_vitals_page_output(area: Optional[pulumi.Input[Optional[str]]] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetWebVitalsPageResult]:
    """
    Use this data source to query detailed information of rum web_vitals_page
