...
class GetScoresResult:
    ...
    def is_demo(self) -> _builtins.int | None:
...
def get_scores(
    ...
    is_demo: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getScores:getScores", __args__, opts=opts, typ=GetScoresResult
    ).value
...
def get_scores_output(
    end_time: pulumi.Input[_builtins.str | None] = None,
    is_demo: pulumi.Input[_builtins.int | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetScoresResult(
