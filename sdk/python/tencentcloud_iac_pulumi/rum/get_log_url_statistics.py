...
def get_log_url_statistics(area: Optional[_builtins.str] = None,
...
def get_log_url_statistics_output(area: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLogUrlStatisticsResult]:
    """
    Use this data source to query detailed information of rum log_url_statistics
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Rum/getLogUrlStatistics:getLogUrlStatistics', __args__, opts=opts, typ=GetLogUrlStatisticsResult)
    return __ret__.apply(lambda __response__: GetLogUrlStatisticsResult(
