...
def get_log_url_statistics(
    ...
    log_url_statistics = tencentcloud.rum.get_log_url_statistics(start_time=1625444040,
        type="analysis",
        end_time=1625454840,
        project_id=1)
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Rum/getLogUrlStatistics:getLogUrlStatistics",
        __args__,
        opts=opts,
        typ=GetLogUrlStatisticsResult,
    ).value
...
def get_log_url_statistics_output(
...
) -> pulumi.Output[GetLogUrlStatisticsResult]:
    """
    Use this data source to query detailed information of rum log_url_statistics
    ...
    return __ret__.apply(
        lambda __response__: GetLogUrlStatisticsResult(
