...
def get_pairs(key_id: Optional[_builtins.str] = None,
...
def get_pairs_output(key_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                     ...
                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPairsResult]:
    """
    Use this data source to query key pairs.
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Key/getPairs:getPairs', __args__, opts=opts, typ=GetPairsResult)
    return __ret__.apply(lambda __response__: GetPairsResult(
