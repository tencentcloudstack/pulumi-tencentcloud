...
def get_gateway_canary_rules(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tse/getGatewayCanaryRules:getGatewayCanaryRules",
        __args__,
        opts=opts,
        typ=GetGatewayCanaryRulesResult,
    ).value
...
def get_gateway_canary_rules_output(
...
) -> pulumi.Output[GetGatewayCanaryRulesResult]:
    """
    Use this data source to query detailed information of tse gateway_canary_rules
    ...
    return __ret__.apply(
        lambda __response__: GetGatewayCanaryRulesResult(
