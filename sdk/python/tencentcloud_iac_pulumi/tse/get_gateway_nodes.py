...
def get_gateway_nodes(gateway_id: Optional[_builtins.str] = None,
...
def get_gateway_nodes_output(gateway_id: Optional[pulumi.Input[_builtins.str]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGatewayNodesResult]:
    """
    Use this data source to query detailed information of tse gateway_nodes
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tse/getGatewayNodes:getGatewayNodes', __args__, opts=opts, typ=GetGatewayNodesResult)
    return __ret__.apply(lambda __response__: GetGatewayNodesResult(
