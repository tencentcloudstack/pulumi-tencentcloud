...
class GetBucketsResult:
    ...
    def bucket_prefix(self) -> _builtins.str | None:
...
def get_buckets(
    bucket_prefix: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cos/getBuckets:getBuckets",
        __args__,
        opts=opts,
        typ=GetBucketsResult,
    ).value
...
def get_buckets_output(
    bucket_prefix: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetBucketsResult(
