...
class _ObjectDownloadOperationState:
    def __init__(__self__, *,
                 ...
                 download_path: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="downloadPath")
    def download_path(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Download path.
        """
        return pulumi.get(self, "download_path")
    ...
    @download_path.setter
    def download_path(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "download_path", value)
...
class ObjectDownloadOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bucket: Optional[pulumi.Input[_builtins.str]] = None,
            download_path: Optional[pulumi.Input[_builtins.str]] = None,
            key: Optional[pulumi.Input[_builtins.str]] = None) -> 'ObjectDownloadOperation':
        """
