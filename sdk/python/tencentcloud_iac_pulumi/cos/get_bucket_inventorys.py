...
class GetBucketInventorysResult:
    ...
    def __init__(
        __self__, bucket=None, id=None, inventorys=None, result_output_file=None
    ):
...
def get_bucket_inventorys(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cos/getBucketInventorys:getBucketInventorys",
        __args__,
        opts=opts,
        typ=GetBucketInventorysResult,
    ).value
...
def get_bucket_inventorys_output(
...
) -> pulumi.Output[GetBucketInventorysResult]:
    """
    Use this data source to query the COS bucket inventorys.
    ...
    return __ret__.apply(
        lambda __response__: GetBucketInventorysResult(
