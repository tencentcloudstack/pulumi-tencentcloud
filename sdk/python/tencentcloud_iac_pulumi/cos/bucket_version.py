...
__all__ = ["BucketVersion", "BucketVersionArgs"]
...
class BucketVersionArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] status: Whether to enable versioning. Valid values: `Suspended`, `Enabled`.
        """
...
@pulumi.type_token("tencentcloud:Cos/bucketVersion:BucketVersion")
class BucketVersion(pulumi.CustomResource):
    ...
    def __init__(
        ...
        bucket_version = tencentcloud.cos.BucketVersion("bucket_version",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BucketVersionArgs, pulumi.ResourceOptions, *args, **kwargs
        )
