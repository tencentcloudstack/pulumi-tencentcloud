...
def get_bucket_object(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cos/getBucketObject:getBucketObject",
        __args__,
        opts=opts,
        typ=GetBucketObjectResult,
    ).value
...
def get_bucket_object_output(
...
) -> pulumi.Output[GetBucketObjectResult]:
    """
    Use this data source to query the metadata of an object stored inside a bucket.
    ...
    return __ret__.apply(
        lambda __response__: GetBucketObjectResult(
