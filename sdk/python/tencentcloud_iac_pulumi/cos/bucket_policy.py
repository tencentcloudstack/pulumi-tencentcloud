...
__all__ = ["BucketPolicy", "BucketPolicyArgs"]
...
class BucketPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BucketPolicyArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cos/bucketPolicy:BucketPolicy", resource_name, __props__, opts
        )
