...
class GetBatchsResult:
    ...
    def job_statuses(self) -> _builtins.str | None:
...
def get_batchs(
    ...
    job_statuses: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    uin: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cos/getBatchs:getBatchs", __args__, opts=opts, typ=GetBatchsResult
    ).value
...
def get_batchs_output(
    appid: pulumi.Input[_builtins.int | None] = None,
    job_statuses: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetBatchsResult(
