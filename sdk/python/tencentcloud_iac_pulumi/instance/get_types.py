...
class GetTypesResult:
    ...
    """
    def __init__(__self__, availability_zone=None, cbs_filter=None, cpu_core_count=None, exclude_sold_out=None, filters=None, gpu_core_count=None, id=None, instance_types=None, memory_size=None, result_output_file=None):
        if availability_zone and not isinstance(availability_zone, str):
            raise TypeError("Expected argument 'availability_zone' to be a str")
        pulumi.set(__self__, "availability_zone", availability_zone)
        if cbs_filter and not isinstance(cbs_filter, dict):
            raise TypeError("Expected argument 'cbs_filter' to be a dict")
        pulumi.set(__self__, "cbs_filter", cbs_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="cbsFilter")
    def cbs_filter(self) -> Optional['outputs.GetTypesCbsFilterResult']:
        return pulumi.get(self, "cbs_filter")
    ...
    def exclude_sold_out(self) -> Optional[_builtins.bool]:
    ...
    def gpu_core_count(self) -> Optional[_builtins.int]:
        """
...
def get_types(availability_zone: Optional[_builtins.str] = None,
              cbs_filter: Optional[Union['GetTypesCbsFilterArgs', 'GetTypesCbsFilterArgsDict']] = None,
              cpu_core_count: Optional[_builtins.int] = None,
              exclude_sold_out: Optional[_builtins.bool] = None,
              filters: Optional[Sequence[Union['GetTypesFilterArgs', 'GetTypesFilterArgsDict']]] = None,
              gpu_core_count: Optional[_builtins.int] = None,
    ...
    high_network = tencentcloud.instance.get_types(availability_zone="ap-guangzhou-6",
        cpu_core_count=8,
        memory_size=16)
    ...
    gpu_instances = tencentcloud.instance.get_types(gpu_core_count=1,
        filters=[{
            "name": "zone",
            "values": ["ap-guangzhou-6"],
        }])
    ...
    local_disk = tencentcloud.instance.get_types(availability_zone="ap-guangzhou-6",
        cpu_core_count=4)
    pulumi.export("localDiskTypes", [instance.local_disk_type_list for instance in local_disk.instance_types if len(instance.local_disk_type_list) > 0])
    ```
    ...
    with_pricing = tencentcloud.instance.get_types(availability_zone="ap-guangzhou-6",
        cpu_core_count=2,
        memory_size=4)
    pulumi.export("pricingInfo", [{
        "type": instance.instance_type,
        "price": instance.price[0] if len(instance.price) > 0 else None,
    } for instance in with_pricing.instance_types])
    ```
    ...
    :param Union['GetTypesCbsFilterArgs', 'GetTypesCbsFilterArgsDict'] cbs_filter: Cbs filter.
    :param _builtins.int cpu_core_count: The number of CPU cores of the instance.
    :param _builtins.bool exclude_sold_out: Indicate to filter instances types that is sold out or not, default is false.
    :param Sequence[Union['GetTypesFilterArgs', 'GetTypesFilterArgsDict']] filters: One or more name/value pairs to filter. This field is conflict with `availability_zone`.
    ...
    return AwaitableGetTypesResult(
        ...
        cbs_filter=pulumi.get(__ret__, 'cbs_filter'),
...
def get_types_output(availability_zone: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                     cbs_filter: pulumi.Input[Optional[Optional[Union['GetTypesCbsFilterArgs', 'GetTypesCbsFilterArgsDict']]]] = None,
                     cpu_core_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                     exclude_sold_out: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                     filters: pulumi.Input[Optional[Optional[Sequence[Union['GetTypesFilterArgs', 'GetTypesFilterArgsDict']]]]] = None,
                     gpu_core_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Instance/getTypes:getTypes', __args__, opts=opts, typ=GetTypesResult)
    return __ret__.apply(lambda __response__: GetTypesResult(
        availability_zone=pulumi.get(__response__, 'availability_zone'),
        cbs_filter=pulumi.get(__response__, 'cbs_filter'),
        cpu_core_count=pulumi.get(__response__, 'cpu_core_count'),
        exclude_sold_out=pulumi.get(__response__, 'exclude_sold_out'),
        filters=pulumi.get(__response__, 'filters'),
        gpu_core_count=pulumi.get(__response__, 'gpu_core_count'),
