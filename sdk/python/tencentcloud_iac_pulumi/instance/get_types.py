...
def get_types_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                     cbs_filter: Optional[pulumi.Input[Optional[Union['GetTypesCbsFilterArgs', 'GetTypesCbsFilterArgsDict']]]] = None,
                     cpu_core_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                     exclude_sold_out: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                     filters: Optional[pulumi.Input[Optional[Sequence[Union['GetTypesFilterArgs', 'GetTypesFilterArgsDict']]]]] = None,
                     gpu_core_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
