...
class GetHbaseInstancesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def asc(self) -> _builtins.int | None:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetHbaseInstancesFilterResult"] | None:
...
def get_hbase_instances(
    asc: _builtins.int | None = None,
    display_strategy: _builtins.str | None = None,
    filters: (
        Sequence[
            Union["GetHbaseInstancesFilterArgs", "GetHbaseInstancesFilterArgsDict"]
        ]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Serverless/getHbaseInstances:getHbaseInstances",
        __args__,
        opts=opts,
        typ=GetHbaseInstancesResult,
    ).value
...
def get_hbase_instances_output(
    asc: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetHbaseInstancesResult]:
    """
    Use this data source to query detailed information of emr serverless_hbase_instances
    ...
    return __ret__.apply(
        lambda __response__: GetHbaseInstancesResult(
