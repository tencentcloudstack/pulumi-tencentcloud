...
__all__ = ["HbaseInstance", "HbaseInstanceArgs"]
...
class HbaseInstanceArgs:
    def __init__(
        ...
        *,
        ...
        zone_settings: pulumi.Input[
            Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]]
        ],
        auto_renew_flag: pulumi.Input[_builtins.int | None] = None,
        node_type: pulumi.Input[_builtins.str | None] = None,
        tags: pulumi.Input[
            Sequence[pulumi.Input["HbaseInstanceTagArgs"]] | None
        ] = None,
    ...
    def zone_settings(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]]]:
        """
    ...
    def zone_settings(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]]],
    ):
    ...
    def tags(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["HbaseInstanceTagArgs"]] | None]:
        """
    ...
    def tags(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceTagArgs"]] | None],
    ):
...
class _HbaseInstanceState:
    def __init__(
        ...
        *,
        ...
        time_unit: pulumi.Input[_builtins.str | None] = None,
        zone_settings: pulumi.Input[
            Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]] | None
        ] = None
    ):
        """
    ...
    def zone_settings(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]] | None]:
        """
        Detailed configuration of the instance availability zone, currently supports multiple availability zones, the number of availability zones can only be 1 or 3, including zone name, VPC information, and number of nodes. The total number of nodes across all zones must be greater than or equal to 3 and less than or equal to 50.
        """
        return pulumi.get(self, "zone_settings")
...
class HbaseInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        tags: pulumi.Input[
            Sequence[
                pulumi.Input[Union["HbaseInstanceTagArgs", "HbaseInstanceTagArgsDict"]]
            ]
            | None
        ] = None,
        time_span: pulumi.Input[_builtins.int | None] = None,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            HbaseInstanceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence["outputs.HbaseInstanceTag"] | None]:
        """
        List of tags to bind to the instance.
        """
        return pulumi.get(self, "tags")
    ...
    def zone_settings(
        self,
    ) -> pulumi.Output[Sequence["outputs.HbaseInstanceZoneSetting"]]:
        """
        Detailed configuration of the instance availability zone, currently supports multiple availability zones, the number of availability zones can only be 1 or 3, including zone name, VPC information, and number of nodes. The total number of nodes across all zones must be greater than or equal to 3 and less than or equal to 50.
        """
        return pulumi.get(self, "zone_settings")
