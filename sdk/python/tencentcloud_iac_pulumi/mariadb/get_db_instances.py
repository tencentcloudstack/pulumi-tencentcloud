...
def get_db_instances(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mariadb/getDbInstances:getDbInstances",
        __args__,
        opts=opts,
        typ=GetDbInstancesResult,
    ).value
...
def get_db_instances_output(
...
) -> pulumi.Output[GetDbInstancesResult]:
    """
    Use this data source to query detailed information of mariadb dbInstances
    ...
    return __ret__.apply(
        lambda __response__: GetDbInstancesResult(
