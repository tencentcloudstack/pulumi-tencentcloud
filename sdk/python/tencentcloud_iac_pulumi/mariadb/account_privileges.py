...
class AccountPrivilegesArgs:
    def __init__(__self__, *,
                 ...
                 column_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesColumnPrivilegeArgs']]]] = None,
                 database_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesDatabasePrivilegeArgs']]]] = None,
                 function_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesFunctionPrivilegeArgs']]]] = None,
                 global_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 procedure_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesProcedurePrivilegeArgs']]]] = None,
                 table_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesTablePrivilegeArgs']]]] = None,
                 view_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesViewPrivilegeArgs']]]] = None):
        """
    ...
    def column_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesColumnPrivilegeArgs']]]]:
        """
    ...
    def column_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesColumnPrivilegeArgs']]]]):
        pulumi.set(self, "column_privileges", value)

    @_builtins.property
    @pulumi.getter(name="databasePrivileges")
    def database_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesDatabasePrivilegeArgs']]]]:
        """
    ...
    def database_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesDatabasePrivilegeArgs']]]]):
        pulumi.set(self, "database_privileges", value)

    @_builtins.property
    @pulumi.getter(name="functionPrivileges")
    def function_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesFunctionPrivilegeArgs']]]]:
        """
    ...
    def function_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesFunctionPrivilegeArgs']]]]):
        pulumi.set(self, "function_privileges", value)

    @_builtins.property
    @pulumi.getter(name="globalPrivileges")
    def global_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def global_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "global_privileges", value)

    @_builtins.property
    @pulumi.getter(name="procedurePrivileges")
    def procedure_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesProcedurePrivilegeArgs']]]]:
        """
    ...
    def procedure_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesProcedurePrivilegeArgs']]]]):
        pulumi.set(self, "procedure_privileges", value)

    @_builtins.property
    @pulumi.getter(name="tablePrivileges")
    def table_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesTablePrivilegeArgs']]]]:
        """
    ...
    def table_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesTablePrivilegeArgs']]]]):
        pulumi.set(self, "table_privileges", value)

    @_builtins.property
    @pulumi.getter(name="viewPrivileges")
    def view_privileges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesViewPrivilegeArgs']]]]:
        """
    ...
    def view_privileges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesViewPrivilegeArgs']]]]):
...
class _AccountPrivilegesState:
    def __init__(__self__, *,
                 accounts: pulumi.Input[Optional['AccountPrivilegesAccountsArgs']] = None,
                 column_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesColumnPrivilegeArgs']]]] = None,
                 database_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesDatabasePrivilegeArgs']]]] = None,
                 function_privileges: pulumi.Input[Optional[Sequence[pulumi.Input['AccountPrivilegesFunctionPrivilegeArgs']]]] = None,
                 global_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def accounts(self) -> pulumi.Input[Optional['AccountPrivilegesAccountsArgs']]:
        """
        account information.
        """
        return pulumi.get(self, "accounts")
    ...
    @accounts.setter
    def accounts(self, value: pulumi.Input[Optional['AccountPrivilegesAccountsArgs']]):
        pulumi.set(self, "accounts", value)
...
@pulumi.type_token("tencentcloud:Mariadb/accountPrivileges:AccountPrivileges")
class AccountPrivileges(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 accounts: pulumi.Input[Optional[Union['AccountPrivilegesAccountsArgs', 'AccountPrivilegesAccountsArgsDict']]] = None,
                 column_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesColumnPrivilegeArgs', 'AccountPrivilegesColumnPrivilegeArgsDict']]]]] = None,
                 database_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesDatabasePrivilegeArgs', 'AccountPrivilegesDatabasePrivilegeArgsDict']]]]] = None,
                 function_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesFunctionPrivilegeArgs', 'AccountPrivilegesFunctionPrivilegeArgsDict']]]]] = None,
                 global_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 procedure_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesProcedurePrivilegeArgs', 'AccountPrivilegesProcedurePrivilegeArgsDict']]]]] = None,
                 table_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesTablePrivilegeArgs', 'AccountPrivilegesTablePrivilegeArgsDict']]]]] = None,
                 view_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesViewPrivilegeArgs', 'AccountPrivilegesViewPrivilegeArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        account_privileges = tencentcloud.mariadb.AccountPrivileges("account_privileges",
        ...
        :param pulumi.Input[Union['AccountPrivilegesAccountsArgs', 'AccountPrivilegesAccountsArgsDict']] accounts: account information.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesColumnPrivilegeArgs', 'AccountPrivilegesColumnPrivilegeArgsDict']]]] column_privileges: Column permission. Valid values of `Privileges`: `SELECT`, `INSERT`, `UPDATE`, `REFERENCES`.Note: if the parameter is left empty, no change will be made to the granted column permissions. To clear the granted column permissions, set `Privileges` to an empty array.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesDatabasePrivilegeArgs', 'AccountPrivilegesDatabasePrivilegeArgsDict']]]] database_privileges: Database permission. Valid values of `Privileges`: `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `CREATE`, `DROP`, `REFERENCES`, `INDEX`, `ALTER`, `CREATE TEMPORARY TABLES`, `LOCK TABLES`, `EXECUTE`, `CREATE VIEW`, `SHOW VIEW`, `CREATE ROUTINE`, `ALTER ROUTINE`, `EVENT`, `TRIGGER`.Note: if the parameter is left empty, no change will be made to the granted database permissions. To clear the granted database permissions, set `Privileges` to an empty array.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesFunctionPrivilegeArgs', 'AccountPrivilegesFunctionPrivilegeArgsDict']]]] function_privileges: Database function permissions. Valid values of `Privileges`: `ALTER ROUTINE`, `EXECUTE`.Note: if the parameter is not passed in, no change will be made to the granted function permissions. To clear the granted function permissions, set `Privileges` to an empty array.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] global_privileges: Global permission. Valid values of `GlobalPrivileges`: `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `CREATE`, `PROCESS`, `DROP`, `REFERENCES`, `INDEX`, `ALTER`, `SHOW DATABASES`, `CREATE TEMPORARY TABLES`, `LOCK TABLES`, `EXECUTE`, `CREATE VIEW`, `SHOW VIEW`, `CREATE ROUTINE`, `ALTER ROUTINE`, `EVENT`, `TRIGGER`.Note: if the parameter is left empty, no change will be made to the granted global permissions. To clear the granted global permissions, set the parameter to an empty array.
        :param pulumi.Input[_builtins.str] instance_id: instance id.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesProcedurePrivilegeArgs', 'AccountPrivilegesProcedurePrivilegeArgsDict']]]] procedure_privileges: Database stored procedure permission. Valid values of `Privileges`: `ALTER ROUTINE`, `EXECUTE`.Note: if the parameter is not passed in, no change will be made to the granted stored procedure permissions. To clear the granted stored procedure permissions, set `Privileges` to an empty array.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesTablePrivilegeArgs', 'AccountPrivilegesTablePrivilegeArgsDict']]]] table_privileges: `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `CREATE`, `DROP`, `REFERENCES`, `INDEX`, `ALTER`, `CREATE VIEW`, `SHOW VIEW`, `TRIGGER`.Note: if the parameter is not passed in, no change will be made to the granted table permissions. To clear the granted table permissions, set `Privileges` to an empty array.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AccountPrivilegesViewPrivilegeArgs', 'AccountPrivilegesViewPrivilegeArgsDict']]]] view_privileges: Database view permission. Valid values of `Privileges`: `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `CREATE`, `DROP`, `REFERENCES`, `INDEX`, `ALTER`, `CREATE VIEW`, `SHOW VIEW`, `TRIGGER`.Note: if the parameter is not passed in, no change will be made to the granted view permissions. To clear the granted view permissions, set `Privileges` to an empty array.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            procedure_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesProcedurePrivilegeArgs', 'AccountPrivilegesProcedurePrivilegeArgsDict']]]]] = None,
            table_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesTablePrivilegeArgs', 'AccountPrivilegesTablePrivilegeArgsDict']]]]] = None,
            view_privileges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AccountPrivilegesViewPrivilegeArgs', 'AccountPrivilegesViewPrivilegeArgsDict']]]]] = None) -> 'AccountPrivileges':
        """
