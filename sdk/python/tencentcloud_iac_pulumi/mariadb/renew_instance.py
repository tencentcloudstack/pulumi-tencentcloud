...
class RenewInstanceArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] period: Renewal duration, unit: month.
        """
...
@pulumi.type_token("tencentcloud:Mariadb/renewInstance:RenewInstance")
class RenewInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        renew_instance = tencentcloud.mariadb.RenewInstance("renew_instance",
