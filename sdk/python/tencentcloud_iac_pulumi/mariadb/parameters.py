...
class ParametersArgs:
    ...
    @params.setter
    def params(
        self, value: pulumi.Input[Sequence[pulumi.Input["ParametersParamArgs"]]]
    ):
...
class _ParametersState:
    def __init__(
        ...
        *,
        ...
        params: pulumi.Input[
            Sequence[pulumi.Input["ParametersParamArgs"]] | None
        ] = None
    ):
        """
    ...
    def params(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ParametersParamArgs"]] | None]:
        """
        Number of days to keep, no more than 30.
        """
        return pulumi.get(self, "params")
    ...
    def params(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["ParametersParamArgs"]] | None],
    ):
        pulumi.set(self, "params", value)
...
class Parameters(pulumi.CustomResource):
    ...
    def __init__(
        ...
        params: pulumi.Input[
            Sequence[
                pulumi.Input[Union["ParametersParamArgs", "ParametersParamArgsDict"]]
            ]
            | None
        ] = None,
        __props__=None,
        ...
        example = tencentcloud.mariadb.Parameters("example",
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Mariadb/parameters:Parameters", resource_name, __props__, opts
        )
