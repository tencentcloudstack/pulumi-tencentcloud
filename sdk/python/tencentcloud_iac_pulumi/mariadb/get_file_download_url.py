...
def get_file_download_url(file_path: Optional[_builtins.str] = None,
    ...
    file_download_url = tencentcloud.Mariadb.get_file_download_url(instance_id="tdsql-9vqvls95",
...
def get_file_download_url_output(file_path: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mariadb/getFileDownloadUrl:getFileDownloadUrl', __args__, opts=opts, typ=GetFileDownloadUrlResult)
