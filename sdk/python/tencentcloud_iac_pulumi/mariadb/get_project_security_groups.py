...
def get_project_security_groups(product: Optional[_builtins.str] = None,
    ...
    :param _builtins.str product: Database engine name. Valid value: `mariadb`.
...
def get_project_security_groups_output(product: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mariadb/getProjectSecurityGroups:getProjectSecurityGroups', __args__, opts=opts, typ=GetProjectSecurityGroupsResult)
