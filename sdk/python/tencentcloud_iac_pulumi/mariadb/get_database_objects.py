...
def get_database_objects(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mariadb/getDatabaseObjects:getDatabaseObjects",
        __args__,
        opts=opts,
        typ=GetDatabaseObjectsResult,
    ).value
...
def get_database_objects_output(
...
) -> pulumi.Output[GetDatabaseObjectsResult]:
    """
    Use this data source to query detailed information of mariadb database_objects
    ...
    return __ret__.apply(
        lambda __response__: GetDatabaseObjectsResult(
