...
class RestartInstanceArgs:
    ...
    def restart_time(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @restart_time.setter
    def restart_time(self, value: pulumi.Input[_builtins.str | None]):
...
@pulumi.type_token("tencentcloud:Mariadb/restartInstance:RestartInstance")
class RestartInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        restart_instance = tencentcloud.mariadb.RestartInstance("restart_instance", instance_id="tdsql-9vqvls95")
        ```
    ...
    @_builtins.property
    @pulumi.getter(name="restartTime")
    def restart_time(self) -> pulumi.Output[_builtins.str | None]:
        """
        expected restart time.
        """
        return pulumi.get(self, "restart_time")
