...
def get_database_table(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mariadb/getDatabaseTable:getDatabaseTable",
        __args__,
        opts=opts,
        typ=GetDatabaseTableResult,
    ).value
...
def get_database_table_output(
...
) -> pulumi.Output[GetDatabaseTableResult]:
    """
    Use this data source to query detailed information of mariadb database_table
    ...
    return __ret__.apply(
        lambda __response__: GetDatabaseTableResult(
