...
def get_sale_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mariadb/getSaleInfo:getSaleInfo",
        __args__,
        opts=opts,
        typ=GetSaleInfoResult,
    ).value
...
def get_sale_info_output(
    ...
    return __ret__.apply(
        lambda __response__: GetSaleInfoResult(
