...
def get_registration_code(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mqtt/getRegistrationCode:getRegistrationCode",
        __args__,
        opts=opts,
        typ=GetRegistrationCodeResult,
    ).value
...
def get_registration_code_output(
...
) -> pulumi.Output[GetRegistrationCodeResult]:
    """
    Use this data source to query detailed information of MQTT registration code
    ...
    return __ret__.apply(
        lambda __response__: GetRegistrationCodeResult(
