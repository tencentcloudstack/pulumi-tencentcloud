...
class GetDomainsResult:
    ...
    def full_url_cache(self) -> _builtins.bool | None:
        """
    ...
    def https_switch(self) -> _builtins.str | None:
        """
...
def get_domains(
    ...
    full_url_cache: _builtins.bool | None = None,
    https_switch: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cdn/getDomains:getDomains",
        __args__,
        opts=opts,
...
def get_domains_output(
    ...
    https_switch: pulumi.Input[_builtins.str | None] = None,
