...
class GetDomainVerifierResult:
    ...
    def __init__(
        ...
        domain=None,
        failed_reason=None,
        file_verify_domains=None,
        file_verify_name=None,
        file_verify_url=None,
        freeze_record=None,
        id=None,
        record=None,
        record_type=None,
    ...
    def auto_verify(self) -> _builtins.bool | None:
    ...
    def freeze_record(self) -> _builtins.bool | None:
...
def get_domain_verifier(
    auto_verify: _builtins.bool | None = None,
    domain: _builtins.str | None = None,
    failed_reason: _builtins.str | None = None,
    freeze_record: _builtins.bool | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cdn/getDomainVerifier:getDomainVerifier",
        __args__,
        opts=opts,
        typ=GetDomainVerifierResult,
    ).value
...
def get_domain_verifier_output(
    auto_verify: pulumi.Input[_builtins.bool | None] = None,
    domain: pulumi.Input[_builtins.str | None] = None,
    failed_reason: pulumi.Input[_builtins.str | None] = None,
    freeze_record: pulumi.Input[_builtins.bool | None] = None,
...
) -> pulumi.Output[GetDomainVerifierResult]:
    """
    Provides a resource to check or create a cdn Domain Verify Record
    ...
    return __ret__.apply(
        lambda __response__: GetDomainVerifierResult(
