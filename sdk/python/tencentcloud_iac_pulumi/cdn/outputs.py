...
class DomainAutoGuard(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainAutoGuard. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 ...
                 filter_rules: Optional[Sequence['outputs.DomainAutoGuardFilterRule']] = None):
        """
    ...
    def filter_rules(self) -> Optional[Sequence['outputs.DomainAutoGuardFilterRule']]:
        """
...
class DomainAutoGuardFilterRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainAutoGuardFilterRule. Access the value via the '{suggest}' property getter instead.")
...
class DomainGeoBlocker(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainGeoBlocker. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 switch: _builtins.str,
                 block_rules: Optional[Sequence['outputs.DomainGeoBlockerBlockRule']] = None):
        """
    ...
    def block_rules(self) -> Optional[Sequence['outputs.DomainGeoBlockerBlockRule']]:
        """
...
class DomainGeoBlockerBlockRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainGeoBlockerBlockRule. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 block_type: Optional[_builtins.str] = None,
    ...
    def block_type(self) -> Optional[_builtins.str]:
        """
...
class DomainHttpsConfigHsts(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainHttpsConfigHsts. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 switch: _builtins.str,
                 include_sub_domains: Optional[_builtins.str] = None,
    ...
    def include_sub_domains(self) -> Optional[_builtins.str]:
        """
...
class DomainRangeOriginPull(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainRangeOriginPull. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 switch: _builtins.str,
                 range_rules: Optional[Sequence['outputs.DomainRangeOriginPullRangeRule']] = None):
        """
    ...
    def range_rules(self) -> Optional[Sequence['outputs.DomainRangeOriginPullRangeRule']]:
        """
...
class DomainRangeOriginPullRangeRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainRangeOriginPullRangeRule. Access the value via the '{suggest}' property getter instead.")
...
class DomainUrlRedirect(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainUrlRedirect. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 switch: _builtins.str,
                 path_rules: Optional[Sequence['outputs.DomainUrlRedirectPathRule']] = None):
        """
        :param _builtins.str switch: Configuration switch, valid values are `on` and `off`.
    ...
    def path_rules(self) -> Optional[Sequence['outputs.DomainUrlRedirectPathRule']]:
        """
...
class DomainUrlRedirectPathRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainUrlRedirectPathRule. Access the value via the '{suggest}' property getter instead.")
...
class DomainUserAgentFilter(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainUserAgentFilter. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 switch: _builtins.str,
                 filter_rules: Optional[Sequence['outputs.DomainUserAgentFilterFilterRule']] = None):
        """
        :param _builtins.str switch: Configuration switch, valid values are `on` and `off`.
    ...
    @_builtins.property
    @pulumi.getter(name="filterRules")
    def filter_rules(self) -> Optional[Sequence['outputs.DomainUserAgentFilterFilterRule']]:
        """
...
class DomainUserAgentFilterFilterRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in DomainUserAgentFilterFilterRule. Access the value via the '{suggest}' property getter instead.")
