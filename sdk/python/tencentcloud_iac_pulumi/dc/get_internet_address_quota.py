...
def get_internet_address_quota(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dc/getInternetAddressQuota:getInternetAddressQuota",
        __args__,
        opts=opts,
        typ=GetInternetAddressQuotaResult,
    ).value
...
def get_internet_address_quota_output(
    ...
    return __ret__.apply(
        lambda __response__: GetInternetAddressQuotaResult(
