...
class _InternetAddressState:
    def __init__(__self__, *,
                 addr_proto: Optional[pulumi.Input[_builtins.int]] = None,
                 addr_type: Optional[pulumi.Input[_builtins.int]] = None,
                 mask_len: Optional[pulumi.Input[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="addrProto")
    def addr_proto(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        0: IPv4, 1: IPv6.
        """
        return pulumi.get(self, "addr_proto")
    ...
    @addr_proto.setter
    def addr_proto(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "addr_proto", value)

    @_builtins.property
    @pulumi.getter(name="addrType")
    def addr_type(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        0: BGP, 1: china telecom, 2: china mobile, 3: china unicom.
        """
        return pulumi.get(self, "addr_type")
    ...
    @addr_type.setter
    def addr_type(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "addr_type", value)

    @_builtins.property
    @pulumi.getter(name="maskLen")
    def mask_len(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        CIDR address mask.
        """
        return pulumi.get(self, "mask_len")
    ...
    @mask_len.setter
    def mask_len(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "mask_len", value)
...
class InternetAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            addr_proto: Optional[pulumi.Input[_builtins.int]] = None,
            addr_type: Optional[pulumi.Input[_builtins.int]] = None,
            mask_len: Optional[pulumi.Input[_builtins.int]] = None) -> 'InternetAddress':
        """
