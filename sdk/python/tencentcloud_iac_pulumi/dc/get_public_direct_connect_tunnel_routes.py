...
def get_public_direct_connect_tunnel_routes_output(direct_connect_tunnel_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                   filters: pulumi.Input[Optional[Optional[Sequence[Union['GetPublicDirectConnectTunnelRoutesFilterArgs', 'GetPublicDirectConnectTunnelRoutesFilterArgsDict']]]]] = None,
