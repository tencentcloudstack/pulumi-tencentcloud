...
class GetAccessPointsResult:
    ...
    def access_point_sets(
        self,
    ) -> Sequence["outputs.GetAccessPointsAccessPointSetResult"]:
        """
    ...
    def region_id(self) -> _builtins.str | None:
        """
...
def get_access_points(
    region_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dc/getAccessPoints:getAccessPoints",
        __args__,
        opts=opts,
        typ=GetAccessPointsResult,
    ).value
...
def get_access_points_output(
...
) -> pulumi.Output[GetAccessPointsResult]:
    """
    Use this data source to query detailed information of dc access_points
    ...
    return __ret__.apply(
        lambda __response__: GetAccessPointsResult(
