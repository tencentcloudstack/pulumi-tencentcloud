...
class ApplicationConfigArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] config_value: configuration item value.
        :param pulumi.Input[_builtins.str] config_version: configuration item version.
        :param pulumi.Input[_builtins.str] config_type: configuration item value type.
        :param pulumi.Input[_builtins.str] config_version_desc: configuration item version description.
        :param pulumi.Input[_builtins.bool] encode_with_base64: Base64 encoded configuration items.
...
@pulumi.type_token("tencentcloud:Tsf/applicationConfig:ApplicationConfig")
class ApplicationConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        application_config = tencentcloud.tsf.ApplicationConfig("application_config",
            config_name="test-2",
            config_version="1.0",
