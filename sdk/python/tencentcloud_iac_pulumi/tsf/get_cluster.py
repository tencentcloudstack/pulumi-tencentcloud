...
def get_cluster_output(cluster_id_lists: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                       cluster_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
