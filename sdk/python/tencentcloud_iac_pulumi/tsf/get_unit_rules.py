...
def get_unit_rules(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getUnitRules:getUnitRules",
        __args__,
        opts=opts,
        typ=GetUnitRulesResult,
    ).value
...
def get_unit_rules_output(
...
) -> pulumi.Output[GetUnitRulesResult]:
    """
    Use this data source to query detailed information of tsf unit_rules
    ...
    return __ret__.apply(
        lambda __response__: GetUnitRulesResult(
