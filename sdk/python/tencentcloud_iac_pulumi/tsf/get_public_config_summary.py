...
def get_public_config_summary(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getPublicConfigSummary:getPublicConfigSummary",
        __args__,
        opts=opts,
        typ=GetPublicConfigSummaryResult,
    ).value
...
def get_public_config_summary_output(
...
) -> pulumi.Output[GetPublicConfigSummaryResult]:
    """
    Use this data source to query detailed information of tsf public_config_summary
    ...
    return __ret__.apply(
        lambda __response__: GetPublicConfigSummaryResult(
