...
class GetMicroserviceResult:
    ...
    def __init__(
        __self__,
        id=None,
        microservice_id_lists=None,
        microservice_name_lists=None,
        namespace_id=None,
    ...
    def microservice_id_lists(self) -> Sequence[_builtins.str] | None:
        return pulumi.get(self, "microservice_id_lists")

    @_builtins.property
    @pulumi.getter(name="microserviceNameLists")
    def microservice_name_lists(self) -> Sequence[_builtins.str] | None:
...
def get_microservice(
    microservice_id_lists: Sequence[_builtins.str] | None = None,
    microservice_name_lists: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getMicroservice:getMicroservice",
        __args__,
        opts=opts,
        typ=GetMicroserviceResult,
    ).value
...
def get_microservice_output(
    microservice_id_lists: pulumi.Input[Sequence[_builtins.str] | None] = None,
    microservice_name_lists: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetMicroserviceResult]:
    """
    Use this data source to query detailed information of tsf microservice
    ...
    return __ret__.apply(
        lambda __response__: GetMicroserviceResult(
