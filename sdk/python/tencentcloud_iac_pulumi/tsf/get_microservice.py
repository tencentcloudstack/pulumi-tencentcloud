...
def get_microservice_output(microservice_id_lists: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                            microservice_name_lists: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
