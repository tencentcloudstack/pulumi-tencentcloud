...
class GetApplicationResult:
    ...
    def application_id_lists(self) -> Optional[Sequence[_builtins.str]]:
        return pulumi.get(self, "application_id_lists")

    @_builtins.property
    @pulumi.getter(name="applicationResourceTypeLists")
    def application_resource_type_lists(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def microservice_type(self) -> Optional[_builtins.str]:
        """
...
def get_application(application_id_lists: Optional[Sequence[_builtins.str]] = None,
                    application_resource_type_lists: Optional[Sequence[_builtins.str]] = None,
                    application_type: Optional[_builtins.str] = None,
                    microservice_type: Optional[_builtins.str] = None,
...
def get_application_output(application_id_lists: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           application_resource_type_lists: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                           application_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           microservice_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tsf/getApplication:getApplication', __args__, opts=opts, typ=GetApplicationResult)
    return __ret__.apply(lambda __response__: GetApplicationResult(
        application_id_lists=pulumi.get(__response__, 'application_id_lists'),
        application_resource_type_lists=pulumi.get(__response__, 'application_resource_type_lists'),
