...
def get_container_group(application_id: Optional[_builtins.str] = None,
...
def get_container_group_output(application_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tsf/getContainerGroup:getContainerGroup', __args__, opts=opts, typ=GetContainerGroupResult)
