...
def get_api_detail(
    ...
    pkg_version: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getApiDetail:getApiDetail",
        __args__,
        opts=opts,
        typ=GetApiDetailResult,
    ).value
...
def get_api_detail_output(
    ...
    return __ret__.apply(
        lambda __response__: GetApiDetailResult(
