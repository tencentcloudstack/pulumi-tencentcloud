...
__all__ = ["EnableUnitRule", "EnableUnitRuleArgs"]
...
class EnableUnitRuleArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] rule_id: api ID.
        :param pulumi.Input[_builtins.str] switch: switch, on: `enabled`, off: `disabled`.
        """
...
@pulumi.type_token("tencentcloud:Tsf/enableUnitRule:EnableUnitRule")
class EnableUnitRule(pulumi.CustomResource):
    ...
    def __init__(
        ...
        enable_unit_rule = tencentcloud.tsf.EnableUnitRule("enable_unit_rule",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            EnableUnitRuleArgs, pulumi.ResourceOptions, *args, **kwargs
        )
