...
def get_usable_unit_namespaces(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getUsableUnitNamespaces:getUsableUnitNamespaces",
        __args__,
        opts=opts,
        typ=GetUsableUnitNamespacesResult,
    ).value
...
def get_usable_unit_namespaces_output(
...
) -> pulumi.Output[GetUsableUnitNamespacesResult]:
    """
    Use this data source to query detailed information of tsf usable_unit_namespaces
    ...
    return __ret__.apply(
        lambda __response__: GetUsableUnitNamespacesResult(
