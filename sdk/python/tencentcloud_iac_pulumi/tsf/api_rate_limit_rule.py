...
__all__ = ["ApiRateLimitRule", "ApiRateLimitRuleArgs"]
...
class ApiRateLimitRuleArgs:
    def __init__(
        ...
        *,
        ...
        max_qps: pulumi.Input[_builtins.int],
        usable_status: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a ApiRateLimitRule resource.

        :param pulumi.Input[_builtins.str] api_id: Api Id.
        :param pulumi.Input[_builtins.int] max_qps: qps value.
        :param pulumi.Input[_builtins.str] usable_status: Enabled/disabled, enabled/disabled, if not passed, it is enabled by default.
        """
    ...
    def max_qps(self) -> pulumi.Input[_builtins.int]:
        """
        qps value.
        """
    ...
    @max_qps.setter
    def max_qps(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "max_qps", value)

    @_builtins.property
    @pulumi.getter(name="usableStatus")
    def usable_status(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def usable_status(self, value: pulumi.Input[_builtins.str | None]):
...
class _ApiRateLimitRuleState:
    def __init__(
        ...
        *,
        ...
        max_qps: pulumi.Input[_builtins.int | None] = None,
        rule_content: pulumi.Input[_builtins.str | None] = None,
        rule_id: pulumi.Input[_builtins.str | None] = None,
        rule_name: pulumi.Input[_builtins.str | None] = None,
        tsf_rule_id: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.int] max_qps: qps value.
        :param pulumi.Input[_builtins.str] rule_content: Rule content.
        :param pulumi.Input[_builtins.str] rule_id: rule Id.
        :param pulumi.Input[_builtins.str] rule_name: Current limit name.
        :param pulumi.Input[_builtins.str] tsf_rule_id: Tsf Rule ID.
    ...
    @_builtins.property
    @pulumi.getter(name="maxQps")
    def max_qps(self) -> pulumi.Input[_builtins.int | None]:
        """
        qps value.
        """
        return pulumi.get(self, "max_qps")
    ...
    @max_qps.setter
    def max_qps(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "max_qps", value)

    @_builtins.property
    @pulumi.getter(name="ruleContent")
    def rule_content(self) -> pulumi.Input[_builtins.str | None]:
        """
        Rule content.
        """
    ...
    @rule_content.setter
    def rule_content(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def tsf_rule_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        Tsf Rule ID.
        """
    ...
    @tsf_rule_id.setter
    def tsf_rule_id(self, value: pulumi.Input[_builtins.str | None]):
...
@pulumi.type_token("tencentcloud:Tsf/apiRateLimitRule:ApiRateLimitRule")
class ApiRateLimitRule(pulumi.CustomResource):
    ...
    def __init__(
        ...
        api_rate_limit_rule = tencentcloud.tsf.ApiRateLimitRule("api_rate_limit_rule",
            api_id="api-xxxxxx",
            max_qps=10,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ApiRateLimitRuleArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="maxQps")
    def max_qps(self) -> pulumi.Output[_builtins.int]:
        """
        qps value.
        """
        return pulumi.get(self, "max_qps")
    ...
    @_builtins.property
    @pulumi.getter(name="tsfRuleId")
    def tsf_rule_id(self) -> pulumi.Output[_builtins.str]:
        """
        Tsf Rule ID.
        """
        return pulumi.get(self, "tsf_rule_id")
    ...
    @_builtins.property
    @pulumi.getter(name="usableStatus")
    def usable_status(self) -> pulumi.Output[_builtins.str]:
        """
        Enabled/disabled, enabled/disabled, if not passed, it is enabled by default.
        """
        return pulumi.get(self, "usable_status")
