...
@pulumi.type_token("tencentcloud:Tsf/applicationPublicConfigRelease:ApplicationPublicConfigRelease")
class ApplicationPublicConfigRelease(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_id: pulumi.Input[Optional[_builtins.str]] = None,
            namespace_id: pulumi.Input[Optional[_builtins.str]] = None,
            release_desc: pulumi.Input[Optional[_builtins.str]] = None) -> 'ApplicationPublicConfigRelease':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="releaseDesc")
    def release_desc(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Release description.
        """
        return pulumi.get(self, "release_desc")
