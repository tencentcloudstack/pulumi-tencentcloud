...
__all__ = ["BindApiGroup", "BindApiGroupArgs"]
...
class BindApiGroupArgs:
    def __init__(
        __self__,
        *,
        gateway_deploy_group_id: pulumi.Input[_builtins.str],
        group_id: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a BindApiGroup resource.

        :param pulumi.Input[_builtins.str] gateway_deploy_group_id: gateway group id.
    ...
    def gateway_deploy_group_id(self) -> pulumi.Input[_builtins.str]:
        """
        gateway group id.
        """
    ...
    def gateway_deploy_group_id(self, value: pulumi.Input[_builtins.str]):
...
class _BindApiGroupState:
    ...
    @_builtins.property
    @pulumi.getter(name="gatewayDeployGroupId")
    def gateway_deploy_group_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        gateway group id.
        """
        return pulumi.get(self, "gateway_deploy_group_id")
    ...
    @gateway_deploy_group_id.setter
    def gateway_deploy_group_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "gateway_deploy_group_id", value)
...
@pulumi.type_token("tencentcloud:Tsf/bindApiGroup:BindApiGroup")
class BindApiGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        bind_api_group = tencentcloud.tsf.BindApiGroup("bind_api_group",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BindApiGroupArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Tsf/bindApiGroup:BindApiGroup", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="gatewayDeployGroupId")
    def gateway_deploy_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        gateway group id.
        """
        return pulumi.get(self, "gateway_deploy_group_id")
