...
class _BindApiGroupState:
    def __init__(__self__, *,
                 gateway_deploy_group_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="gatewayDeployGroupId")
    def gateway_deploy_group_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        gateway group id.
        """
        return pulumi.get(self, "gateway_deploy_group_id")
    ...
    @gateway_deploy_group_id.setter
    def gateway_deploy_group_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "gateway_deploy_group_id", value)
...
class BindApiGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            gateway_deploy_group_id: Optional[pulumi.Input[_builtins.str]] = None,
            group_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'BindApiGroup':
        """
