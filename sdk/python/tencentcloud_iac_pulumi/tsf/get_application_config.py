...
class GetApplicationConfigResult:
    ...
    def config_id(self) -> _builtins.str | None:
        """
    ...
    def config_name(self) -> _builtins.str | None:
        """
    ...
    def config_version(self) -> _builtins.str | None:
        """
...
def get_application_config(
    ...
    config_id: _builtins.str | None = None,
    config_id_lists: Sequence[_builtins.str] | None = None,
    config_name: _builtins.str | None = None,
    config_version: _builtins.str | None = None,
    ...
    :param Sequence[_builtins.str] config_id_lists: Configuration ID list, query all with lower priority when not provided.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getApplicationConfig:getApplicationConfig",
        __args__,
        opts=opts,
        typ=GetApplicationConfigResult,
    ).value
...
def get_application_config_output(
...
) -> pulumi.Output[GetApplicationConfigResult]:
    """
    Use this data source to query detailed information of tsf application_config
    ...
    return __ret__.apply(
        lambda __response__: GetApplicationConfigResult(
