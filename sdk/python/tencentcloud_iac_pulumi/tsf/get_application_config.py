...
def get_application_config(application_id: Optional[_builtins.str] = None,
...
def get_application_config_output(application_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  config_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplicationConfigResult]:
    """
    Use this data source to query detailed information of tsf application_config
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tsf/getApplicationConfig:getApplicationConfig', __args__, opts=opts, typ=GetApplicationConfigResult)
    return __ret__.apply(lambda __response__: GetApplicationConfigResult(
