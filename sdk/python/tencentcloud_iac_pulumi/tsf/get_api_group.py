...
class GetApiGroupResult:
    ...
    def gateway_instance_id(self) -> Optional[_builtins.str]:
        """
...
def get_api_group(auth_type: Optional[_builtins.str] = None,
                  gateway_instance_id: Optional[_builtins.str] = None,
...
def get_api_group_output(auth_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         gateway_instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApiGroupResult]:
    """
    Use this data source to query detailed information of tsf api_group
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tsf/getApiGroup:getApiGroup', __args__, opts=opts, typ=GetApiGroupResult)
    return __ret__.apply(lambda __response__: GetApiGroupResult(
