...
def get_api_group_output(auth_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                         gateway_instance_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
