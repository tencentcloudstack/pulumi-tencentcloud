...
def get_ms_api_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getMsApiList:getMsApiList",
        __args__,
        opts=opts,
        typ=GetMsApiListResult,
    ).value
...
def get_ms_api_list_output(
...
) -> pulumi.Output[GetMsApiListResult]:
    """
    Use this data source to query detailed information of tsf ms_api_list
    ...
    return __ret__.apply(
        lambda __response__: GetMsApiListResult(
