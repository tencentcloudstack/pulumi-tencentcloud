...
def get_application_file_config(
    ...
    application_file_config = tencentcloud.tsf.get_application_file_config(config_id="dcfg-f-4y4ekzqv",
    ...
    :param Sequence[_builtins.str] config_id_lists: List of configuration item ID.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getApplicationFileConfig:getApplicationFileConfig",
        __args__,
        opts=opts,
        typ=GetApplicationFileConfigResult,
    ).value
...
def get_application_file_config_output(
...
) -> pulumi.Output[GetApplicationFileConfigResult]:
    """
    Use this data source to query detailed information of tsf application_file_config
    ...
    return __ret__.apply(
        lambda __response__: GetApplicationFileConfigResult(
