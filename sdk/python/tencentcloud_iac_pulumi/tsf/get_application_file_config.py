...
def get_application_file_config(application_id: Optional[_builtins.str] = None,
...
def get_application_file_config_output(application_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplicationFileConfigResult]:
    """
    Use this data source to query detailed information of tsf application_file_config
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tsf/getApplicationFileConfig:getApplicationFileConfig', __args__, opts=opts, typ=GetApplicationFileConfigResult)
    return __ret__.apply(lambda __response__: GetApplicationFileConfigResult(
