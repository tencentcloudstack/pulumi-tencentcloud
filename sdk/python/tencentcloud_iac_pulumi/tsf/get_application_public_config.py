...
def get_application_public_config(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getApplicationPublicConfig:getApplicationPublicConfig",
        __args__,
        opts=opts,
        typ=GetApplicationPublicConfigResult,
    ).value
...
def get_application_public_config_output(
...
) -> pulumi.Output[GetApplicationPublicConfigResult]:
    """
    Use this data source to query detailed information of tsf application_public_config
    ...
    return __ret__.apply(
        lambda __response__: GetApplicationPublicConfigResult(
