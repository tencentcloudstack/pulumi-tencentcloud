...
class TaskArgs:
    def __init__(
        ...
        *,
        ...
        task_content: pulumi.Input[_builtins.str],
        task_name: pulumi.Input[_builtins.str],
        task_type: pulumi.Input[_builtins.str],
        time_out: pulumi.Input[_builtins.int],
        advance_settings: pulumi.Input[Optional["TaskAdvanceSettingsArgs"]] = None,
        program_id_lists: pulumi.Input[
            Sequence[pulumi.Input[_builtins.str]] | None
        ] = None,
        retry_count: pulumi.Input[_builtins.int | None] = None,
        retry_interval: pulumi.Input[_builtins.int | None] = None,
        shard_arguments: pulumi.Input[
            Sequence[pulumi.Input["TaskShardArgumentArgs"]] | None
        ] = None,
        shard_count: pulumi.Input[_builtins.int | None] = None,
        success_operator: pulumi.Input[_builtins.str | None] = None,
        success_ratio: pulumi.Input[_builtins.str | None] = None,
        task_argument: pulumi.Input[_builtins.str | None] = None,
        task_rule: pulumi.Input[Optional["TaskTaskRuleArgs"]] = None
    ):
        """
        The set of arguments for constructing a Task resource.

        :param pulumi.Input[_builtins.str] execute_type: execution type, unicast/broadcast.
        :param pulumi.Input[_builtins.str] group_id: deployment group ID.
        :param pulumi.Input[_builtins.str] task_content: task content, length limit 65536 bytes.
        :param pulumi.Input[_builtins.str] task_name: task name, task length 64 characters.
        :param pulumi.Input[_builtins.str] task_type: task type, java.
        :param pulumi.Input[_builtins.int] time_out: task timeout, time unit ms.
        ...
        :param pulumi.Input[_builtins.int] retry_count: number of retries, 0 &amp;lt;= RetryCount&amp;lt;= 10.
        :param pulumi.Input[_builtins.int] retry_interval: retry interval, 0 &amp;lt;= RetryInterval &amp;lt;= 600000, time unit ms.
        :param pulumi.Input[Sequence[pulumi.Input['TaskShardArgumentArgs']]] shard_arguments: Fragmentation parameters.
        :param pulumi.Input[_builtins.int] shard_count: number of shards.
        :param pulumi.Input[_builtins.str] success_operator: the operator to judge the success of the task.
        :param pulumi.Input[_builtins.str] success_ratio: The threshold for judging the success rate of the task, such as 100.
        :param pulumi.Input[_builtins.str] task_argument: task parameters, the length limit is 10000 characters.
    ...
    def task_content(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @task_content.setter
    def task_content(self, value: pulumi.Input[_builtins.str]):
    ...
    def time_out(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @time_out.setter
    def time_out(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "time_out", value)

    @_builtins.property
    @pulumi.getter(name="advanceSettings")
    def advance_settings(self) -> pulumi.Input[Optional["TaskAdvanceSettingsArgs"]]:
        """
        advanced settings.
        """
    ...
    def advance_settings(
        self, value: pulumi.Input[Optional["TaskAdvanceSettingsArgs"]]
    ):
    ...
    def retry_count(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def shard_arguments(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["TaskShardArgumentArgs"]] | None]:
        """
    ...
    def shard_arguments(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["TaskShardArgumentArgs"]] | None],
    ):
    ...
    def success_operator(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def success_operator(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "success_operator", value)

    @_builtins.property
    @pulumi.getter(name="successRatio")
    def success_ratio(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def success_ratio(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "success_ratio", value)

    @_builtins.property
    @pulumi.getter(name="taskArgument")
    def task_argument(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def task_argument(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "task_argument", value)

    @_builtins.property
    @pulumi.getter(name="taskRule")
    def task_rule(self) -> pulumi.Input[Optional["TaskTaskRuleArgs"]]:
        """
        trigger rule.
        """
    ...
    @task_rule.setter
    def task_rule(self, value: pulumi.Input[Optional["TaskTaskRuleArgs"]]):
...
class _TaskState:
    def __init__(
        ...
        *,
        advance_settings: pulumi.Input[Optional["TaskAdvanceSettingsArgs"]] = None,
        belong_flow_ids: pulumi.Input[
            Sequence[pulumi.Input[_builtins.str]] | None
        ] = None,
        execute_type: pulumi.Input[_builtins.str | None] = None,
        ...
        success_ratio: pulumi.Input[_builtins.str | None] = None,
        task_argument: pulumi.Input[_builtins.str | None] = None,
        task_content: pulumi.Input[_builtins.str | None] = None,
        task_id: pulumi.Input[_builtins.str | None] = None,
        task_log_id: pulumi.Input[_builtins.str | None] = None,
        task_name: pulumi.Input[_builtins.str | None] = None,
        task_rule: pulumi.Input[Optional["TaskTaskRuleArgs"]] = None,
        task_state: pulumi.Input[_builtins.str | None] = None,
        task_type: pulumi.Input[_builtins.str | None] = None,
        time_out: pulumi.Input[_builtins.int | None] = None,
        trigger_type: pulumi.Input[_builtins.str | None] = None
    ):
        """
        Input properties used for looking up and filtering Task resources.

        :param pulumi.Input['TaskAdvanceSettingsArgs'] advance_settings: advanced settings.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] belong_flow_ids: ID of the workflow to which it belongs.
        :param pulumi.Input[_builtins.str] execute_type: execution type, unicast/broadcast.
        :param pulumi.Input[_builtins.str] group_id: deployment group ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] program_id_lists: Program id list.
        :param pulumi.Input[_builtins.int] retry_count: number of retries, 0 &amp;lt;= RetryCount&amp;lt;= 10.
        ...
        :param pulumi.Input[_builtins.str] task_log_id: task history ID.
        :param pulumi.Input[_builtins.str] task_name: task name, task length 64 characters.
        :param pulumi.Input['TaskTaskRuleArgs'] task_rule: trigger rule.
        :param pulumi.Input[_builtins.str] task_state: Whether to enable the task, ENABLED/DISABLED.
        :param pulumi.Input[_builtins.str] task_type: task type, java.
        :param pulumi.Input[_builtins.int] time_out: task timeout, time unit ms.
    ...
    @_builtins.property
    @pulumi.getter(name="executeType")
    def execute_type(self) -> pulumi.Input[_builtins.str | None]:
        """
        execution type, unicast/broadcast.
        """
        return pulumi.get(self, "execute_type")
    ...
    @execute_type.setter
    def execute_type(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "execute_type", value)
    ...
    @_builtins.property
    @pulumi.getter(name="taskContent")
    def task_content(self) -> pulumi.Input[_builtins.str | None]:
        """
        task content, length limit 65536 bytes.
        """
        return pulumi.get(self, "task_content")
    ...
    @task_content.setter
    def task_content(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "task_content", value)
    ...
    def task_log_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        task history ID.
        """
    ...
    @task_log_id.setter
    def task_log_id(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def task_state(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @task_state.setter
    def task_state(self, value: pulumi.Input[_builtins.str | None]):
    ...
    @_builtins.property
    @pulumi.getter(name="timeOut")
    def time_out(self) -> pulumi.Input[_builtins.int | None]:
        """
        task timeout, time unit ms.
        """
        return pulumi.get(self, "time_out")
    ...
    @time_out.setter
    def time_out(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "time_out", value)

    @_builtins.property
    @pulumi.getter(name="triggerType")
    def trigger_type(self) -> pulumi.Input[_builtins.str | None]:
        """
        trigger type.
        """
...
@pulumi.type_token("tencentcloud:Tsf/task:Task")
class Task(pulumi.CustomResource):
    ...
    def __init__(
        ...
        advance_settings: pulumi.Input[
            Union["TaskAdvanceSettingsArgs", "TaskAdvanceSettingsArgsDict"] | None
        ] = None,
        execute_type: pulumi.Input[_builtins.str | None] = None,
        group_id: pulumi.Input[_builtins.str | None] = None,
        program_id_lists: pulumi.Input[
        ...
        shard_arguments: pulumi.Input[
            Sequence[
                pulumi.Input[
                    Union["TaskShardArgumentArgs", "TaskShardArgumentArgsDict"]
                ]
            ]
            | None
        ] = None,
        ...
        task_content: pulumi.Input[_builtins.str | None] = None,
        task_name: pulumi.Input[_builtins.str | None] = None,
        task_rule: pulumi.Input[
            Union["TaskTaskRuleArgs", "TaskTaskRuleArgsDict"] | None
        ] = None,
        task_type: pulumi.Input[_builtins.str | None] = None,
        time_out: pulumi.Input[_builtins.int | None] = None,
        __props__=None,
        ...
        :param pulumi.Input[Union['TaskAdvanceSettingsArgs', 'TaskAdvanceSettingsArgsDict']] advance_settings: advanced settings.
        :param pulumi.Input[_builtins.str] execute_type: execution type, unicast/broadcast.
        :param pulumi.Input[_builtins.str] group_id: deployment group ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] program_id_lists: Program id list.
        :param pulumi.Input[_builtins.int] retry_count: number of retries, 0 &amp;lt;= RetryCount&amp;lt;= 10.
        :param pulumi.Input[_builtins.int] retry_interval: retry interval, 0 &amp;lt;= RetryInterval &amp;lt;= 600000, time unit ms.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TaskShardArgumentArgs', 'TaskShardArgumentArgsDict']]]] shard_arguments: Fragmentation parameters.
        :param pulumi.Input[_builtins.int] shard_count: number of shards.
        :param pulumi.Input[_builtins.str] success_operator: the operator to judge the success of the task.
        :param pulumi.Input[_builtins.str] success_ratio: The threshold for judging the success rate of the task, such as 100.
        :param pulumi.Input[_builtins.str] task_argument: task parameters, the length limit is 10000 characters.
        :param pulumi.Input[_builtins.str] task_content: task content, length limit 65536 bytes.
        :param pulumi.Input[_builtins.str] task_name: task name, task length 64 characters.
        :param pulumi.Input[Union['TaskTaskRuleArgs', 'TaskTaskRuleArgsDict']] task_rule: trigger rule.
        :param pulumi.Input[_builtins.str] task_type: task type, java.
        :param pulumi.Input[_builtins.int] time_out: task timeout, time unit ms.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TaskArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__("tencentcloud:Tsf/task:Task", resource_name, __props__, opts)
    ...
    @_builtins.property
    @pulumi.getter(name="belongFlowIds")
    def belong_flow_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        ID of the workflow to which it belongs.
        """
        return pulumi.get(self, "belong_flow_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="retryInterval")
    def retry_interval(self) -> pulumi.Output[_builtins.int]:
        """
        retry interval, 0 &amp;lt;= RetryInterval &amp;lt;= 600000, time unit ms.
        """
        return pulumi.get(self, "retry_interval")
    ...
    @_builtins.property
    @pulumi.getter(name="successOperator")
    def success_operator(self) -> pulumi.Output[_builtins.str]:
        """
        the operator to judge the success of the task.
        """
        return pulumi.get(self, "success_operator")
    ...
    @_builtins.property
    @pulumi.getter(name="successRatio")
    def success_ratio(self) -> pulumi.Output[_builtins.str]:
        """
        The threshold for judging the success rate of the task, such as 100.
        """
        return pulumi.get(self, "success_ratio")
    ...
    @_builtins.property
    @pulumi.getter(name="taskArgument")
    def task_argument(self) -> pulumi.Output[_builtins.str]:
        """
        task parameters, the length limit is 10000 characters.
        """
        return pulumi.get(self, "task_argument")
    ...
    @_builtins.property
    @pulumi.getter(name="taskContent")
    def task_content(self) -> pulumi.Output[_builtins.str]:
        """
        task content, length limit 65536 bytes.
        """
        return pulumi.get(self, "task_content")
    ...
    @_builtins.property
    @pulumi.getter(name="taskLogId")
    def task_log_id(self) -> pulumi.Output[_builtins.str]:
        """
        task history ID.
        """
        return pulumi.get(self, "task_log_id")
    ...
    @_builtins.property
    @pulumi.getter(name="timeOut")
    def time_out(self) -> pulumi.Output[_builtins.int]:
        """
        task timeout, time unit ms.
        """
        return pulumi.get(self, "time_out")
