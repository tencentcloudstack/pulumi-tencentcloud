...
def get_business_log_configs(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tsf/getBusinessLogConfigs:getBusinessLogConfigs",
        __args__,
        opts=opts,
        typ=GetBusinessLogConfigsResult,
    ).value
...
def get_business_log_configs_output(
...
) -> pulumi.Output[GetBusinessLogConfigsResult]:
    """
    Use this data source to query detailed information of tsf business_log_configs
    ...
    return __ret__.apply(
        lambda __response__: GetBusinessLogConfigsResult(
