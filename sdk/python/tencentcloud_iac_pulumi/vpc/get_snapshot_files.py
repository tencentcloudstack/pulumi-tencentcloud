...
class GetSnapshotFilesResult:
    ...
    def snapshot_file_sets(
        self,
    ) -> Sequence["outputs.GetSnapshotFilesSnapshotFileSetResult"]:
        """
        snap shot file set.
        """
...
def get_snapshot_files(
    business_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getSnapshotFiles:getSnapshotFiles",
        __args__,
        opts=opts,
        typ=GetSnapshotFilesResult,
    ).value
...
def get_snapshot_files_output(
    business_type: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetSnapshotFilesResult]:
    """
    Use this data source to query detailed information of vpc snapshot_files
    ...
    return __ret__.apply(
        lambda __response__: GetSnapshotFilesResult(
