...
__all__ = ["DhcpAssociateAddress", "DhcpAssociateAddressArgs"]
...
class DhcpAssociateAddressArgs:
    def __init__(
        ...
        *,
        ...
        dhcp_ip_id: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a DhcpAssociateAddress resource.

        :param pulumi.Input[_builtins.str] address_ip: Elastic public network `IP`. Must be `EIP` not bound to `DhcpIp`.
        :param pulumi.Input[_builtins.str] dhcp_ip_id: `DhcpIp` unique `ID`, like: `dhcpip-9o233uri`. Must be a `DhcpIp` that is not bound to `EIP`.
        """
    ...
    def dhcp_ip_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @dhcp_ip_id.setter
    def dhcp_ip_id(self, value: pulumi.Input[_builtins.str]):
...
class _DhcpAssociateAddressState:
    def __init__(
        ...
        *,
        ...
        dhcp_ip_id: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dhcpIpId")
    def dhcp_ip_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        `DhcpIp` unique `ID`, like: `dhcpip-9o233uri`. Must be a `DhcpIp` that is not bound to `EIP`.
        """
        return pulumi.get(self, "dhcp_ip_id")
    ...
    @dhcp_ip_id.setter
    def dhcp_ip_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "dhcp_ip_id", value)


@pulumi.type_token("tencentcloud:Vpc/dhcpAssociateAddress:DhcpAssociateAddress")
class DhcpAssociateAddress(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DhcpAssociateAddressArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="dhcpIpId")
    def dhcp_ip_id(self) -> pulumi.Output[_builtins.str]:
        """
        `DhcpIp` unique `ID`, like: `dhcpip-9o233uri`. Must be a `DhcpIp` that is not bound to `EIP`.
        """
        return pulumi.get(self, "dhcp_ip_id")
