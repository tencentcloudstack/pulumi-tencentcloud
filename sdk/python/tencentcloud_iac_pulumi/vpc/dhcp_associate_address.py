...
class _DhcpAssociateAddressState:
    def __init__(__self__, *,
                 ...
                 dhcp_ip_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dhcpIpId")
    def dhcp_ip_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        `DhcpIp` unique `ID`, like: `dhcpip-9o233uri`. Must be a `DhcpIp` that is not bound to `EIP`.
        """
        return pulumi.get(self, "dhcp_ip_id")
    ...
    @dhcp_ip_id.setter
    def dhcp_ip_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "dhcp_ip_id", value)
...
class DhcpAssociateAddress(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            address_ip: Optional[pulumi.Input[_builtins.str]] = None,
            dhcp_ip_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DhcpAssociateAddress':
        """
