...
class GetCvmInstancesResult:
    ...
    def __init__(
        __self__, filters=None, id=None, instance_sets=None, result_output_file=None
    ):
...
def get_cvm_instances(
    filters: (
        Sequence[Union["GetCvmInstancesFilterArgs", "GetCvmInstancesFilterArgsDict"]]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getCvmInstances:getCvmInstances",
        __args__,
        opts=opts,
        typ=GetCvmInstancesResult,
    ).value
...
def get_cvm_instances_output(
...
) -> pulumi.Output[GetCvmInstancesResult]:
    """
    Use this data source to query detailed information of vpc cvm_instances
    ...
    return __ret__.apply(
        lambda __response__: GetCvmInstancesResult(
