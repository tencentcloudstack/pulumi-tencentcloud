...
class SnapshotPolicyAttachmentArgs:
    def __init__(
        ...
        *,
        instances: pulumi.Input[
            Sequence[pulumi.Input["SnapshotPolicyAttachmentInstanceArgs"]]
        ],
    ...
    def instances(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["SnapshotPolicyAttachmentInstanceArgs"]]]:
        """
...
class _SnapshotPolicyAttachmentState:
    def __init__(
        ...
        *,
        instances: pulumi.Input[
            Sequence[pulumi.Input["SnapshotPolicyAttachmentInstanceArgs"]] | None
        ] = None,
...
class SnapshotPolicyAttachment(pulumi.CustomResource):
    ...
    def instances(
        self,
    ) -> pulumi.Output[Sequence["outputs.SnapshotPolicyAttachmentInstance"]]:
        """
        Associated instance information.
        """
        return pulumi.get(self, "instances")
