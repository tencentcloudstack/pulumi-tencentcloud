...
def get_bandwidth_package_bill_usage(bandwidth_package_id: Optional[_builtins.str] = None,
...
def get_bandwidth_package_bill_usage_output(bandwidth_package_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBandwidthPackageBillUsageResult]:
    """
    Use this data source to query detailed information of vpc bandwidth_package_bill_usage
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Vpc/getBandwidthPackageBillUsage:getBandwidthPackageBillUsage', __args__, opts=opts, typ=GetBandwidthPackageBillUsageResult)
    return __ret__.apply(lambda __response__: GetBandwidthPackageBillUsageResult(
        bandwidth_package_bill_bandwidth_sets=pulumi.get(__response__, 'bandwidth_package_bill_bandwidth_sets'),
