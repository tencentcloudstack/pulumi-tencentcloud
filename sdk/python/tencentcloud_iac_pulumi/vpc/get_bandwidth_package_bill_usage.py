...
class GetBandwidthPackageBillUsageResult:
    ...
    def __init__(
        __self__,
        bandwidth_package_bill_bandwidth_sets=None,
        bandwidth_package_id=None,
        id=None,
        result_output_file=None,
    ):
        if bandwidth_package_bill_bandwidth_sets and not isinstance(
            bandwidth_package_bill_bandwidth_sets, list
        ):
            raise TypeError(
                "Expected argument 'bandwidth_package_bill_bandwidth_sets' to be a list"
            )
        pulumi.set(
            __self__,
            "bandwidth_package_bill_bandwidth_sets",
            bandwidth_package_bill_bandwidth_sets,
        )
    ...
    def bandwidth_package_bill_bandwidth_sets(
        self,
    ) -> Sequence[
        "outputs.GetBandwidthPackageBillUsageBandwidthPackageBillBandwidthSetResult"
    ]:
        """
...
def get_bandwidth_package_bill_usage(
    ...
    :param _builtins.str bandwidth_package_id: The unique ID of the postpaid bandwidth package.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getBandwidthPackageBillUsage:getBandwidthPackageBillUsage",
        __args__,
        opts=opts,
        typ=GetBandwidthPackageBillUsageResult,
    ).value

    return AwaitableGetBandwidthPackageBillUsageResult(
        bandwidth_package_bill_bandwidth_sets=pulumi.get(
            __ret__, "bandwidth_package_bill_bandwidth_sets"
        ),
...
def get_bandwidth_package_bill_usage_output(
...
) -> pulumi.Output[GetBandwidthPackageBillUsageResult]:
    """
    Use this data source to query detailed information of vpc bandwidth_package_bill_usage
    ...
    return __ret__.apply(
        lambda __response__: GetBandwidthPackageBillUsageResult(
            bandwidth_package_bill_bandwidth_sets=pulumi.get(
                __response__, "bandwidth_package_bill_bandwidth_sets"
            ),
