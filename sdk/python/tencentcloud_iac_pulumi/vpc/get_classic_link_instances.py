...
def get_classic_link_instances_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetClassicLinkInstancesFilterArgs', 'GetClassicLinkInstancesFilterArgsDict']]]]] = None,
