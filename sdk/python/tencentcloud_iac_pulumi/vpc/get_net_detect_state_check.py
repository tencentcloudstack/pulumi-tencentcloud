...
class GetNetDetectStateCheckResult:
    ...
    def net_detect_id(self) -> Optional[_builtins.str]:
    ...
    def net_detect_name(self) -> Optional[_builtins.str]:
...
def get_net_detect_state_check(detect_destination_ips: Optional[Sequence[_builtins.str]] = None,
                               net_detect_id: Optional[_builtins.str] = None,
                               net_detect_name: Optional[_builtins.str] = None,
                               next_hop_destination: Optional[_builtins.str] = None,
...
def get_net_detect_state_check_output(detect_destination_ips: Optional[pulumi.Input[Sequence[_builtins.str]]] = None,
                                      net_detect_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      net_detect_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      next_hop_destination: Optional[pulumi.Input[_builtins.str]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetDetectStateCheckResult]:
    """
    Use this data source to query detailed information of vpc net_detect_state_check
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Vpc/getNetDetectStateCheck:getNetDetectStateCheck', __args__, opts=opts, typ=GetNetDetectStateCheckResult)
    return __ret__.apply(lambda __response__: GetNetDetectStateCheckResult(
        ...
        net_detect_ip_state_sets=pulumi.get(__response__, 'net_detect_ip_state_sets'),
