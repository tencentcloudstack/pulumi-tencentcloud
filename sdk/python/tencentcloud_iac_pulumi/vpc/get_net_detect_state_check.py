...
class GetNetDetectStateCheckResult:
    ...
    def __init__(
        __self__,
        detect_destination_ips=None,
        id=None,
        net_detect_id=None,
        net_detect_ip_state_sets=None,
        net_detect_name=None,
        next_hop_destination=None,
        next_hop_type=None,
    ...
    def detect_destination_ips(self) -> Sequence[_builtins.str]:
        """
    ...
    def net_detect_id(self) -> _builtins.str | None:
    ...
    def net_detect_ip_state_sets(
        self,
    ) -> Sequence["outputs.GetNetDetectStateCheckNetDetectIpStateSetResult"]:
        """
    ...
    def net_detect_name(self) -> _builtins.str | None:
        return pulumi.get(self, "net_detect_name")

    @_builtins.property
    @pulumi.getter(name="nextHopDestination")
    def next_hop_destination(self) -> _builtins.str:
...
def get_net_detect_state_check(
    detect_destination_ips: Sequence[_builtins.str] | None = None,
    net_detect_id: _builtins.str | None = None,
    net_detect_name: _builtins.str | None = None,
    next_hop_destination: _builtins.str | None = None,
    next_hop_type: _builtins.str | None = None,
    ...
    net_detect_state_check = tencentcloud.vpc.get_net_detect_state_check(net_detect_id="netd-12345678",
    ...
    :param Sequence[_builtins.str] detect_destination_ips: The array of detection destination IPv4 addresses, which contains at most two IP addresses.
    :param _builtins.str net_detect_id: ID of a network inspector instance, e.g. netd-12345678. Enter at least one of this parameter, VpcId, SubnetId, and NetDetectName. Use NetDetectId if it is present.
    :param _builtins.str net_detect_name: The name of a network inspector, up to 60 bytes in length. It is used together with VpcId and NetDetectName. You should enter either this parameter or NetDetectId, or both. Use NetDetectId if it is present.
    :param _builtins.str next_hop_destination: The next-hop destination gateway. The value is related to NextHopType.If NextHopType is set to VPN, the value of this parameter is the VPN gateway ID, such as vpngw-12345678.If NextHopType is set to DIRECTCONNECT, the value of this parameter is the direct connect gateway ID, such as dcg-12345678.If NextHopType is set to PEERCONNECTION, the value of this parameter is the peering connection ID, such as pcx-12345678.If NextHopType is set to NAT, the value of this parameter is the NAT gateway ID, such as nat-12345678.If NextHopType is set to NORMAL_CVM, the value of this parameter is the IPv4 address of the CVM, such as 10.0.0.12.
    :param _builtins.str next_hop_type: The type of the next hop. Currently supported types are:VPN: VPN gateway;DIRECTCONNECT: direct connect gateway;PEERCONNECTION: peering connection;NAT: NAT gateway;NORMAL_CVM: normal CVM.
    :param _builtins.str result_output_file: Used to save results.
    :param _builtins.str subnet_id: ID of a subnet instance, e.g. `subnet-12345678`, which is used together with VpcId and NetDetectName. You should enter either this parameter or NetDetectId, or both. Use NetDetectId if it is present.
    :param _builtins.str vpc_id: ID of a `VPC` instance, e.g. `vpc-12345678`, which is used together with SubnetId and NetDetectName. You should enter either this parameter or NetDetectId, or both. Use NetDetectId if it is present.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getNetDetectStateCheck:getNetDetectStateCheck",
        __args__,
        opts=opts,
        typ=GetNetDetectStateCheckResult,
    ).value
...
def get_net_detect_state_check_output(
    detect_destination_ips: pulumi.Input[Sequence[_builtins.str] | None] = None,
    net_detect_id: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetNetDetectStateCheckResult]:
    """
    Use this data source to query detailed information of vpc net_detect_state_check
    ...
    return __ret__.apply(
        lambda __response__: GetNetDetectStateCheckResult(
            detect_destination_ips=pulumi.get(__response__, "detect_destination_ips"),
            id=pulumi.get(__response__, "id"),
            net_detect_id=pulumi.get(__response__, "net_detect_id"),
            net_detect_ip_state_sets=pulumi.get(
                __response__, "net_detect_ip_state_sets"
            ),
            net_detect_name=pulumi.get(__response__, "net_detect_name"),
            next_hop_destination=pulumi.get(__response__, "next_hop_destination"),
