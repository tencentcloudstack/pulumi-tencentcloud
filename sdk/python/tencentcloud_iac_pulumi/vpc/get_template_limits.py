...
def get_template_limits(result_output_file: Optional[_builtins.str] = None,
...
def get_template_limits_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTemplateLimitsResult]:
    """
    Use this data source to query detailed information of vpc template_limits
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Vpc/getTemplateLimits:getTemplateLimits', __args__, opts=opts, typ=GetTemplateLimitsResult)
    return __ret__.apply(lambda __response__: GetTemplateLimitsResult(
        id=pulumi.get(__response__, 'id'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        template_limits=pulumi.get(__response__, 'template_limits')))
