...
class GetTemplateLimitsResult:
    ...
    def template_limits(
        self,
    ) -> Sequence["outputs.GetTemplateLimitsTemplateLimitResult"]:
        """
        template limit.
        """
...
def get_template_limits(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getTemplateLimits:getTemplateLimits",
        __args__,
        opts=opts,
        typ=GetTemplateLimitsResult,
    ).value
...
def get_template_limits_output(
    ...
    return __ret__.apply(
        lambda __response__: GetTemplateLimitsResult(
