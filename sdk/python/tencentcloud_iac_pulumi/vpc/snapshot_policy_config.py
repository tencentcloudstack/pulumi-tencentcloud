...
__all__ = ["SnapshotPolicyConfig", "SnapshotPolicyConfigArgs"]
...
@pulumi.type_token("tencentcloud:Vpc/snapshotPolicyConfig:SnapshotPolicyConfig")
class SnapshotPolicyConfig(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SnapshotPolicyConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
