...
class GetResourceDashboardResult:
    ...
    def resource_dashboard_sets(
        self,
    ) -> Sequence["outputs.GetResourceDashboardResourceDashboardSetResult"]:
        """
...
def get_resource_dashboard(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getResourceDashboard:getResourceDashboard",
        __args__,
        opts=opts,
        typ=GetResourceDashboardResult,
    ).value
...
def get_resource_dashboard_output(
...
) -> pulumi.Output[GetResourceDashboardResult]:
    """
    Use this data source to query detailed information of vpc resource_dashboard
    ...
    return __ret__.apply(
        lambda __response__: GetResourceDashboardResult(
