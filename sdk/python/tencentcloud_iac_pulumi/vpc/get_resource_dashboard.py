...
def get_resource_dashboard_output(result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                  vpc_ids: pulumi.Input[Optional[Sequence[_builtins.str]]] = None,
