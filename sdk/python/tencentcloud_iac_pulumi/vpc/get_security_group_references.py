...
def get_security_group_references(result_output_file: Optional[_builtins.str] = None,
...
def get_security_group_references_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         security_group_ids: Optional[pulumi.Input[Sequence[_builtins.str]]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSecurityGroupReferencesResult]:
    """
    Use this data source to query detailed information of vpc security_group_references
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Vpc/getSecurityGroupReferences:getSecurityGroupReferences', __args__, opts=opts, typ=GetSecurityGroupReferencesResult)
    return __ret__.apply(lambda __response__: GetSecurityGroupReferencesResult(
        id=pulumi.get(__response__, 'id'),
        referred_security_group_sets=pulumi.get(__response__, 'referred_security_group_sets'),
