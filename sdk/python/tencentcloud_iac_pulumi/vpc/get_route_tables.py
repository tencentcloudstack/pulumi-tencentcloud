...
class GetRouteTablesResult:
    ...
    def association_main(self) -> _builtins.bool | None:
    ...
    def route_table_id(self) -> _builtins.str | None:
        """
...
def get_route_tables(
    association_main: _builtins.bool | None = None,
    name: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    route_table_id: _builtins.str | None = None,
    ...
    tags_instances = tencentcloud.vpc.get_route_tables_output(tags=route_table.tags)
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getRouteTables:getRouteTables",
        __args__,
        opts=opts,
        typ=GetRouteTablesResult,
    ).value
...
def get_route_tables_output(
    association_main: pulumi.Input[_builtins.bool | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetRouteTablesResult(
