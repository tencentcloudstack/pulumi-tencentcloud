...
class GetSgSnapshotFileContentResult:
    ...
    def backup_datas(
        self,
    ) -> Sequence["outputs.GetSgSnapshotFileContentBackupDataResult"]:
        """
        Backup data.
        """
    ...
    def original_datas(
        self,
    ) -> Sequence["outputs.GetSgSnapshotFileContentOriginalDataResult"]:
        """
        Original data.
        """
...
def get_sg_snapshot_file_content(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getSgSnapshotFileContent:getSgSnapshotFileContent",
        __args__,
        opts=opts,
        typ=GetSgSnapshotFileContentResult,
    ).value
...
def get_sg_snapshot_file_content_output(
    ...
    return __ret__.apply(
        lambda __response__: GetSgSnapshotFileContentResult(
