...
def get_account_attributes(result_output_file: Optional[_builtins.str] = None,
...
def get_account_attributes_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAccountAttributesResult]:
    """
    Use this data source to query detailed information of vpc account_attributes
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Vpc/getAccountAttributes:getAccountAttributes', __args__, opts=opts, typ=GetAccountAttributesResult)
    return __ret__.apply(lambda __response__: GetAccountAttributesResult(
