...
def get_limits(
    limit_types: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getLimits:getLimits", __args__, opts=opts, typ=GetLimitsResult
    ).value
...
def get_limits_output(
    limit_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
