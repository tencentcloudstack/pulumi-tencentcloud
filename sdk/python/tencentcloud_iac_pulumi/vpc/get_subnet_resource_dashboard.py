...
class GetSubnetResourceDashboardResult:
    ...
    def resource_statistics_sets(
        self,
    ) -> Sequence["outputs.GetSubnetResourceDashboardResourceStatisticsSetResult"]:
        """
...
def get_subnet_resource_dashboard(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getSubnetResourceDashboard:getSubnetResourceDashboard",
        __args__,
        opts=opts,
        typ=GetSubnetResourceDashboardResult,
    ).value
...
def get_subnet_resource_dashboard_output(
...
) -> pulumi.Output[GetSubnetResourceDashboardResult]:
    """
    Use this data source to query detailed information of vpc subnet_resource_dashboard
    ...
    return __ret__.apply(
        lambda __response__: GetSubnetResourceDashboardResult(
            id=pulumi.get(__response__, "id"),
            resource_statistics_sets=pulumi.get(
                __response__, "resource_statistics_sets"
            ),
