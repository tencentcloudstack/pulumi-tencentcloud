...
class GetGatewayFlowMonitorDetailResult:
    ...
    def __init__(
        ...
        gateway_flow_monitor_detail_sets=None,
        id=None,
        nat_id=None,
        ...
        if gateway_flow_monitor_detail_sets and not isinstance(
            gateway_flow_monitor_detail_sets, list
        ):
            raise TypeError(
                "Expected argument 'gateway_flow_monitor_detail_sets' to be a list"
            )
        pulumi.set(
            __self__,
            "gateway_flow_monitor_detail_sets",
            gateway_flow_monitor_detail_sets,
        )
    ...
    def direct_connect_gateway_id(self) -> _builtins.str | None:
        return pulumi.get(self, "direct_connect_gateway_id")

    @_builtins.property
    @pulumi.getter(name="gatewayFlowMonitorDetailSets")
    def gateway_flow_monitor_detail_sets(
        self,
    ) -> Sequence[
        "outputs.GetGatewayFlowMonitorDetailGatewayFlowMonitorDetailSetResult"
    ]:
        """
    ...
    def nat_id(self) -> _builtins.str | None:
    ...
    def peering_connection_id(self) -> _builtins.str | None:
    ...
    def vpn_id(self) -> _builtins.str | None:
...
def get_gateway_flow_monitor_detail(
    direct_connect_gateway_id: _builtins.str | None = None,
    nat_id: _builtins.str | None = None,
    order_direction: _builtins.str | None = None,
    order_field: _builtins.str | None = None,
    peering_connection_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    time_point: _builtins.str | None = None,
    vpn_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpc/getGatewayFlowMonitorDetail:getGatewayFlowMonitorDetail",
        __args__,
        opts=opts,
        typ=GetGatewayFlowMonitorDetailResult,
    ).value

    return AwaitableGetGatewayFlowMonitorDetailResult(
        direct_connect_gateway_id=pulumi.get(__ret__, "direct_connect_gateway_id"),
        gateway_flow_monitor_detail_sets=pulumi.get(
            __ret__, "gateway_flow_monitor_detail_sets"
        ),
...
def get_gateway_flow_monitor_detail_output(
    direct_connect_gateway_id: pulumi.Input[_builtins.str | None] = None,
    nat_id: pulumi.Input[_builtins.str | None] = None,
    order_direction: pulumi.Input[_builtins.str | None] = None,
    order_field: pulumi.Input[_builtins.str | None] = None,
    peering_connection_id: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    time_point: pulumi.Input[_builtins.str | None] = None,
    vpn_id: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetGatewayFlowMonitorDetailResult]:
    """
    Use this data source to query detailed information of vpc gateway_flow_monitor_detail
    ...
    return __ret__.apply(
        lambda __response__: GetGatewayFlowMonitorDetailResult(
            direct_connect_gateway_id=pulumi.get(
                __response__, "direct_connect_gateway_id"
            ),
            gateway_flow_monitor_detail_sets=pulumi.get(
                __response__, "gateway_flow_monitor_detail_sets"
            ),
