...
@pulumi.type_token("tencentcloud:Vpc/peerConnectAcceptOperation:PeerConnectAcceptOperation")
class PeerConnectAcceptOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            peering_connection_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'PeerConnectAcceptOperation':
        """
