...
class _TrafficPackageState:
    def __init__(__self__, *,
                 ...
                 remaining_amount: pulumi.Input[Optional[_builtins.float]] = None,
                 traffic_amount: pulumi.Input[Optional[_builtins.int]] = None,
                 used_amount: pulumi.Input[Optional[_builtins.float]] = None):
        """
    ...
    def remaining_amount(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        Remaining amount.
        """
    ...
    def remaining_amount(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "remaining_amount", value)

    @_builtins.property
    @pulumi.getter(name="trafficAmount")
    def traffic_amount(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Traffic Package Amount, eg: 10,20,50,512,1024,5120,51200,60,300,600,3072,6144,30720,61440,307200.
        """
        return pulumi.get(self, "traffic_amount")
    ...
    @traffic_amount.setter
    def traffic_amount(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "traffic_amount", value)

    @_builtins.property
    @pulumi.getter(name="usedAmount")
    def used_amount(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
        Used amount.
        """
    ...
    @used_amount.setter
    def used_amount(self, value: pulumi.Input[Optional[_builtins.float]]):
...
class TrafficPackage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            remaining_amount: pulumi.Input[Optional[_builtins.float]] = None,
            traffic_amount: pulumi.Input[Optional[_builtins.int]] = None,
            used_amount: pulumi.Input[Optional[_builtins.float]] = None) -> 'TrafficPackage':
        """
