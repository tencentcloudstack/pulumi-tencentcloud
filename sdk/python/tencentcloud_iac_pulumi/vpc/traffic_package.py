...
__all__ = ["TrafficPackage", "TrafficPackageArgs"]


@pulumi.input_type
class TrafficPackageArgs:
    def __init__(__self__, *, traffic_amount: pulumi.Input[_builtins.int]):
        """
...
class _TrafficPackageState:
    def __init__(
        ...
        *,
        ...
        remaining_amount: pulumi.Input[_builtins.float | None] = None,
        traffic_amount: pulumi.Input[_builtins.int | None] = None,
        used_amount: pulumi.Input[_builtins.float | None] = None
    ):
        """
    ...
    def remaining_amount(self) -> pulumi.Input[_builtins.float | None]:
        """
        Remaining amount.
        """
    ...
    def remaining_amount(self, value: pulumi.Input[_builtins.float | None]):
        pulumi.set(self, "remaining_amount", value)

    @_builtins.property
    @pulumi.getter(name="trafficAmount")
    def traffic_amount(self) -> pulumi.Input[_builtins.int | None]:
        """
        Traffic Package Amount, eg: 10,20,50,512,1024,5120,51200,60,300,600,3072,6144,30720,61440,307200.
        """
        return pulumi.get(self, "traffic_amount")
    ...
    @traffic_amount.setter
    def traffic_amount(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "traffic_amount", value)

    @_builtins.property
    @pulumi.getter(name="usedAmount")
    def used_amount(self) -> pulumi.Input[_builtins.float | None]:
        """
        Used amount.
        """
    ...
    @used_amount.setter
    def used_amount(self, value: pulumi.Input[_builtins.float | None]):
...
class TrafficPackage(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TrafficPackageArgs, pulumi.ResourceOptions, *args, **kwargs
        )
