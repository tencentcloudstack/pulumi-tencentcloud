...
def get_parameter_templates_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetParameterTemplatesFilterArgs', 'GetParameterTemplatesFilterArgsDict']]]]] = None,
