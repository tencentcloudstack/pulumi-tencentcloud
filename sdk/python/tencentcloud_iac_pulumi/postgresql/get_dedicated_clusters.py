...
def get_dedicated_clusters_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDedicatedClustersFilterArgs', 'GetDedicatedClustersFilterArgsDict']]]]] = None,
