...
class _ReadonlyGroupState:
    def __init__(__self__, *,
                 ...
                 max_replay_lag: pulumi.Input[Optional[_builtins.int]] = None,
                 max_replay_latency: pulumi.Input[Optional[_builtins.int]] = None,
                 min_delay_eliminate_reserve: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 net_info_lists: pulumi.Input[Optional[Sequence[pulumi.Input['ReadonlyGroupNetInfoListArgs']]]] = None,
                 project_id: pulumi.Input[Optional[_builtins.int]] = None,
                 replay_lag_eliminate: pulumi.Input[Optional[_builtins.int]] = None,
                 replay_latency_eliminate: pulumi.Input[Optional[_builtins.int]] = None,
                 security_groups_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="maxReplayLag")
    def max_replay_lag(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Delay threshold in ms.
        """
        return pulumi.get(self, "max_replay_lag")
    ...
    @max_replay_lag.setter
    def max_replay_lag(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "max_replay_lag", value)

    @_builtins.property
    @pulumi.getter(name="maxReplayLatency")
    def max_replay_latency(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Delayed log size threshold in MB.
        """
        return pulumi.get(self, "max_replay_latency")
    ...
    @max_replay_latency.setter
    def max_replay_latency(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "max_replay_latency", value)

    @_builtins.property
    @pulumi.getter(name="minDelayEliminateReserve")
    def min_delay_eliminate_reserve(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The minimum number of read-only replicas that must be retained in an RO group.
        """
        return pulumi.get(self, "min_delay_eliminate_reserve")
    ...
    @min_delay_eliminate_reserve.setter
    def min_delay_eliminate_reserve(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "min_delay_eliminate_reserve", value)
    ...
    def net_info_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReadonlyGroupNetInfoListArgs']]]]:
        """
    ...
    def net_info_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReadonlyGroupNetInfoListArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="replayLagEliminate")
    def replay_lag_eliminate(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Whether to remove a read-only replica from an RO group if the delay between the read-only replica and the primary instance exceeds the threshold. Valid values: 0 (no), 1 (yes).
        """
        return pulumi.get(self, "replay_lag_eliminate")
    ...
    @replay_lag_eliminate.setter
    def replay_lag_eliminate(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "replay_lag_eliminate", value)

    @_builtins.property
    @pulumi.getter(name="replayLatencyEliminate")
    def replay_latency_eliminate(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Whether to remove a read-only replica from an RO group if the sync log size difference between the read-only replica and the primary instance exceeds the threshold. Valid values: 0 (no), 1 (yes).
        """
        return pulumi.get(self, "replay_latency_eliminate")
    ...
    @replay_latency_eliminate.setter
    def replay_latency_eliminate(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "replay_latency_eliminate", value)
...
class ReadonlyGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            min_delay_eliminate_reserve: pulumi.Input[Optional[_builtins.int]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            net_info_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReadonlyGroupNetInfoListArgs', 'ReadonlyGroupNetInfoListArgsDict']]]]] = None,
            project_id: pulumi.Input[Optional[_builtins.int]] = None,
            replay_lag_eliminate: pulumi.Input[Optional[_builtins.int]] = None,
            replay_latency_eliminate: pulumi.Input[Optional[_builtins.int]] = None,
            security_groups_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            subnet_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ReadonlyGroup':
        """
