...
class RenewDbInstanceOperationArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] db_instance_id: Instance ID in the format of postgres-6fego161.
        :param pulumi.Input[_builtins.int] period: Renewal duration in months.
        :param pulumi.Input[_builtins.int] auto_voucher: Whether to automatically use vouchers. 1:yes, 0:no. Default value:0.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] voucher_ids: Voucher ID list (only one voucher can be specified currently).
        """
...
class RenewDbInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        renew_db_instance_operation = tencentcloud.postgresql.RenewDbInstanceOperation("renew_db_instance_operation",
