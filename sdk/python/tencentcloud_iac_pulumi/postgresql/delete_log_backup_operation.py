...
class _DeleteLogBackupOperationState:
    def __init__(__self__, *,
                 ...
                 log_backup_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="logBackupId")
    def log_backup_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Log backup ID.
        """
        return pulumi.get(self, "log_backup_id")
    ...
    @log_backup_id.setter
    def log_backup_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "log_backup_id", value)
...
class DeleteLogBackupOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            db_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            log_backup_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DeleteLogBackupOperation':
        """
