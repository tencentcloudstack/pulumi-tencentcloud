...
class _DeleteLogBackupOperationState:
    def __init__(__self__, *,
                 ...
                 log_backup_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="logBackupId")
    def log_backup_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Log backup ID.
        """
        return pulumi.get(self, "log_backup_id")
    ...
    @log_backup_id.setter
    def log_backup_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "log_backup_id", value)


@pulumi.type_token("tencentcloud:Postgresql/deleteLogBackupOperation:DeleteLogBackupOperation")
class DeleteLogBackupOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            db_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            log_backup_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'DeleteLogBackupOperation':
        """
