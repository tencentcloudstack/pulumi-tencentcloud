...
class GetDbInstanceClassesResult:
    ...
    """
    def __init__(__self__, class_info_sets=None, db_engine=None, db_major_version=None, id=None, result_output_file=None, storage_type=None, zone=None):
...
def get_db_instance_classes_output(db_engine: pulumi.Input[Optional[_builtins.str]] = None,
