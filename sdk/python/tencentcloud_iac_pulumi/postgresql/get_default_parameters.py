...
class GetDefaultParametersResult:
    ...
    def param_info_sets(
        self,
    ) -> Sequence["outputs.GetDefaultParametersParamInfoSetResult"]:
        """
...
def get_default_parameters(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Postgresql/getDefaultParameters:getDefaultParameters",
        __args__,
        opts=opts,
        typ=GetDefaultParametersResult,
    ).value
...
def get_default_parameters_output(
...
) -> pulumi.Output[GetDefaultParametersResult]:
    """
    Use this data source to query detailed information of postgresql default_parameters
    ...
    return __ret__.apply(
        lambda __response__: GetDefaultParametersResult(
