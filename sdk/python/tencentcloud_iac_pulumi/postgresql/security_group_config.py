...
class _SecurityGroupConfigState:
    def __init__(
        ...
        *,
        db_instance_id: pulumi.Input[_builtins.str | None] = None,
        read_only_group_id: pulumi.Input[_builtins.str | None] = None,
        security_group_id_sets: pulumi.Input[
...
class SecurityGroupConfig(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SecurityGroupConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="dbInstanceId")
    def db_instance_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        Instance ID. Either this parameter or ReadOnlyGroupId must be passed in. If both parameters are passed in, ReadOnlyGroupId will be ignored.
        """
        return pulumi.get(self, "db_instance_id")
