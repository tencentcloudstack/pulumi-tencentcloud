...
def get_readonly_groups(filters: Optional[Sequence[Union['GetReadonlyGroupsFilterArgs', 'GetReadonlyGroupsFilterArgsDict']]] = None,
...
def get_readonly_groups_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetReadonlyGroupsFilterArgs', 'GetReadonlyGroupsFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Postgresql/getReadonlyGroups:getReadonlyGroups', __args__, opts=opts, typ=GetReadonlyGroupsResult)
