...
class GetAccountPrivilegesResult:
    ...
    def database_object_sets(
        self,
    ) -> Sequence["outputs.GetAccountPrivilegesDatabaseObjectSetResult"]:
    ...
    def privilege_sets(
        self,
    ) -> Sequence["outputs.GetAccountPrivilegesPrivilegeSetResult"]:
        """
...
def get_account_privileges(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Postgresql/getAccountPrivileges:getAccountPrivileges",
        __args__,
        opts=opts,
        typ=GetAccountPrivilegesResult,
    ).value
...
def get_account_privileges_output(
    database_object_sets: pulumi.Input[
        Sequence[
            Union[
                "GetAccountPrivilegesDatabaseObjectSetArgs",
                "GetAccountPrivilegesDatabaseObjectSetArgsDict",
...
) -> pulumi.Output[GetAccountPrivilegesResult]:
    """
    Use this data source to query detailed information of postgresql account privileges
    ...
    return __ret__.apply(
        lambda __response__: GetAccountPrivilegesResult(
