...
def get_account_privileges_output(database_object_sets: pulumi.Input[Optional[Sequence[Union['GetAccountPrivilegesDatabaseObjectSetArgs', 'GetAccountPrivilegesDatabaseObjectSetArgsDict']]]] = None,
