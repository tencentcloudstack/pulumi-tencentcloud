...
class BackupPlanConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        backup_plan_config = tencentcloud.postgresql.BackupPlanConfig("backup_plan_config",
    ...
    def get(resource_name: str,
            ...
            db_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            max_backup_start_time: Optional[pulumi.Input[_builtins.str]] = None,
            min_backup_start_time: Optional[pulumi.Input[_builtins.str]] = None) -> 'BackupPlanConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="backupPeriods")
    def backup_periods(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Backup cycle, which means on which days each week the instance will be backed up. The parameter value should be the lowercase names of the days of the week.
        """
        return pulumi.get(self, "backup_periods")
