...
class GetLogBackupsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetLogBackupsFilterResult"] | None:
...
def get_log_backups(
    filters: (
        Sequence[Union["GetLogBackupsFilterArgs", "GetLogBackupsFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Postgresql/getLogBackups:getLogBackups",
        __args__,
        opts=opts,
        typ=GetLogBackupsResult,
    ).value
...
def get_log_backups_output(
...
) -> pulumi.Output[GetLogBackupsResult]:
    """
    Use this data source to query detailed information of postgresql log_backups
    ...
    return __ret__.apply(
        lambda __response__: GetLogBackupsResult(
            filters=pulumi.get(__response__, "filters"),
            id=pulumi.get(__response__, "id"),
            log_backup_sets=pulumi.get(__response__, "log_backup_sets"),
