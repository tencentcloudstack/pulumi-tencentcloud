...
def get_log_backups(filters: Optional[Sequence[Union['GetLogBackupsFilterArgs', 'GetLogBackupsFilterArgsDict']]] = None,
...
def get_log_backups_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetLogBackupsFilterArgs', 'GetLogBackupsFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Postgresql/getLogBackups:getLogBackups', __args__, opts=opts, typ=GetLogBackupsResult)
