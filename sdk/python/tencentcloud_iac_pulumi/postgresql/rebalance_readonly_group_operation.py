...
@pulumi.type_token("tencentcloud:Postgresql/rebalanceReadonlyGroupOperation:RebalanceReadonlyGroupOperation")
class RebalanceReadonlyGroupOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            read_only_group_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RebalanceReadonlyGroupOperation':
        """
