...
__all__ = ["RebalanceReadonlyGroupOperation", "RebalanceReadonlyGroupOperationArgs"]


@pulumi.input_type
class RebalanceReadonlyGroupOperationArgs:
    def __init__(__self__, *, read_only_group_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a RebalanceReadonlyGroupOperation resource.

        :param pulumi.Input[_builtins.str] read_only_group_id: readonly Group ID.
        """
...
class _RebalanceReadonlyGroupOperationState:
    def __init__(
        __self__, *, read_only_group_id: pulumi.Input[_builtins.str | None] = None
    ):
        """
...
class RebalanceReadonlyGroupOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        group_rebalance = tencentcloud.postgresql.ReadonlyGroup("group_rebalance",
        ...
        rebalance_readonly_group_operation = tencentcloud.postgresql.RebalanceReadonlyGroupOperation("rebalance_readonly_group_operation", read_only_group_id=group_rebalance.id)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RebalanceReadonlyGroupOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = RebalanceReadonlyGroupOperationArgs.__new__(
                RebalanceReadonlyGroupOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _RebalanceReadonlyGroupOperationState.__new__(
            _RebalanceReadonlyGroupOperationState
        )

        __props__.__dict__["read_only_group_id"] = read_only_group_id
        return RebalanceReadonlyGroupOperation(
