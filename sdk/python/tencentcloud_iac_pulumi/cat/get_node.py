...
class GetNodeResult:
    ...
    def is_ipv6(self) -> _builtins.bool | None:
        return pulumi.get(self, "is_ipv6")

    @_builtins.property
    @pulumi.getter
    def location(self) -> _builtins.int | None:
        """
    ...
    def node_name(self) -> _builtins.str | None:
        return pulumi.get(self, "node_name")

    @_builtins.property
    @pulumi.getter(name="nodeType")
    def node_type(self) -> _builtins.int | None:
...
def get_node(
    is_ipv6: _builtins.bool | None = None,
    location: _builtins.int | None = None,
    node_name: _builtins.str | None = None,
    node_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cat/getNode:getNode", __args__, opts=opts, typ=GetNodeResult
    ).value
...
def get_node_output(
    is_ipv6: pulumi.Input[_builtins.bool | None] = None,
    location: pulumi.Input[_builtins.int | None] = None,
    node_name: pulumi.Input[_builtins.str | None] = None,
    node_type: pulumi.Input[_builtins.int | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetNodeResult(
