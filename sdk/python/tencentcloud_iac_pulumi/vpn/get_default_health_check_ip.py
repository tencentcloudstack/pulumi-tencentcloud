...
class GetDefaultHealthCheckIpResult:
    ...
    def __init__(
        __self__,
        health_check_local_ip=None,
        health_check_remote_ip=None,
        id=None,
...
def get_default_health_check_ip(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpn/getDefaultHealthCheckIp:getDefaultHealthCheckIp",
        __args__,
        opts=opts,
        typ=GetDefaultHealthCheckIpResult,
    ).value
...
def get_default_health_check_ip_output(
...
) -> pulumi.Output[GetDefaultHealthCheckIpResult]:
    """
    Use this data source to query detailed information of vpn default_health_check_ip
    ...
    return __ret__.apply(
        lambda __response__: GetDefaultHealthCheckIpResult(
