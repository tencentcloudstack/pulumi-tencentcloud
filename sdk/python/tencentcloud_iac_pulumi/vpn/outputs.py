...
class ConnectionBgpConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ConnectionBgpConfig. Access the value via the '{suggest}' property getter instead."
            )
...
class ConnectionHealthCheckConfig(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ConnectionHealthCheckConfig. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        __self__,
        *,
        probe_interval: _builtins.int | None = None,
        probe_threshold: _builtins.int | None = None,
        probe_timeout: _builtins.int | None = None,
        probe_type: _builtins.str | None = None,
    ):
        """
    ...
    def probe_interval(self) -> _builtins.int | None:
        """
    ...
    def probe_threshold(self) -> _builtins.int | None:
        """
    ...
    def probe_timeout(self) -> _builtins.int | None:
        """
    ...
    def probe_type(self) -> _builtins.str | None:
        """
...
class ConnectionSecurityGroupPolicy(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ConnectionSecurityGroupPolicy. Access the value via the '{suggest}' property getter instead."
            )
...
class CustomerGatewayConfigurationDownloadCustomerGatewayVendor(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in CustomerGatewayConfigurationDownloadCustomerGatewayVendor. Access the value via the '{suggest}' property getter instead."
            )
...
@pulumi.output_type
class SslServerDnsServers(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "primaryDns":
            suggest = "primary_dns"
        elif key == "secondaryDns":
            suggest = "secondary_dns"

        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in SslServerDnsServers. Access the value via the '{suggest}' property getter instead."
            )

    def __getitem__(self, key: str) -> Any:
        SslServerDnsServers.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(
        __self__,
        *,
        primary_dns: _builtins.str | None = None,
        secondary_dns: _builtins.str | None = None,
    ):
        """
        :param _builtins.str primary_dns: Primary DNS server address.
        :param _builtins.str secondary_dns: Secondary DNS server address.
        """
    ...
    def primary_dns(self) -> _builtins.str | None:
        """
    ...
    def secondary_dns(self) -> _builtins.str | None:
        """
...
class GetConnectionsConnectionListResult(dict):
    def __init__(
        ...
        *,
        ...
        security_group_policies: Sequence[
            "outputs.GetConnectionsConnectionListSecurityGroupPolicyResult"
        ],
        state: _builtins.str,
    ...
    def security_group_policies(
        self,
    ) -> Sequence["outputs.GetConnectionsConnectionListSecurityGroupPolicyResult"]:
        """
