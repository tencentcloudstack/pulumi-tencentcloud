...
class ConnectionHealthCheckConfigArgsDict(TypedDict):
    ...
    """
    probe_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Detection timeout, range [10-5000], Unit: ms.
    """
    probe_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class SslServerDnsServersArgsDict(TypedDict):
    primary_dns: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Primary DNS server address.
    """
    secondary_dns: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
