...
def get_customer_gateways(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Vpn/getCustomerGateways:getCustomerGateways",
        __args__,
        opts=opts,
        typ=GetCustomerGatewaysResult,
    ).value
...
def get_customer_gateways_output(
...
) -> pulumi.Output[GetCustomerGatewaysResult]:
    """
    Use this data source to query detailed information of VPN customer gateways.
    ...
    return __ret__.apply(
        lambda __response__: GetCustomerGatewaysResult(
