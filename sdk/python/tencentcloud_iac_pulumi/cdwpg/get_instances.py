...
class GetInstancesResult:
    ...
    def search_tags(self) -> Sequence[_builtins.str] | None:
...
def get_instances(
    ...
    search_tags: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cdwpg/getInstances:getInstances",
        __args__,
        opts=opts,
...
def get_instances_output(
    ...
    search_tags: pulumi.Input[Sequence[_builtins.str] | None] = None,
