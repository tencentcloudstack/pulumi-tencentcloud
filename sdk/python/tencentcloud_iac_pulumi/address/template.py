...
class TemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] addresses: Address list. IP(`10.0.0.1`), CIDR(`10.0.1.0/24`), IP range(`10.0.0.1-10.0.0.100`) format are supported.
        :param pulumi.Input[_builtins.str] name: Name of the address template.
        """
...
class _TemplateState:
    def __init__(
        __self__,
        *,
        addresses: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        name: pulumi.Input[_builtins.str | None] = None
    ):
        """
...
@pulumi.type_token("tencentcloud:Address/template:Template")
class Template(pulumi.CustomResource):
    ...
    def __init__(
        ...
        > **NOTE:** It can be replaced by `Address.ExtraTemplate`.
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Address/template:Template", resource_name, __props__, opts
        )
