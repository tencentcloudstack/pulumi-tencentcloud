...
__all__ = ["TemplateGroup", "TemplateGroupArgs"]
...
class TemplateGroupArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] template_ids: Template ID list.
        :param pulumi.Input[_builtins.str] name: Name of the address template group.
        """
...
class _TemplateGroupState:
    def __init__(
        ...
        *,
        name: pulumi.Input[_builtins.str | None] = None,
        template_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None
    ):
        """
...
@pulumi.type_token("tencentcloud:Address/templateGroup:TemplateGroup")
class TemplateGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        foo = tencentcloud.address.TemplateGroup("foo",
            name="group-test",
            template_ids=[
                "ipl-axaf24151",
                "ipl-axaf24152",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TemplateGroupArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Address/templateGroup:TemplateGroup",
            resource_name,
            __props__,
            opts,
        )
