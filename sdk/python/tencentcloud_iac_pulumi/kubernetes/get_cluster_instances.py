...
class GetClusterInstancesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetClusterInstancesFilterResult"] | None:
...
def get_cluster_instances(
    ...
    filters: (
        Sequence[
            Union["GetClusterInstancesFilterArgs", "GetClusterInstancesFilterArgsDict"]
        ]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kubernetes/getClusterInstances:getClusterInstances",
        __args__,
        opts=opts,
        typ=GetClusterInstancesResult,
    ).value
...
def get_cluster_instances_output(
...
) -> pulumi.Output[GetClusterInstancesResult]:
    """
    Use this data source to query detailed information of kubernetes cluster_instances
    ...
    return __ret__.apply(
        lambda __response__: GetClusterInstancesResult(
