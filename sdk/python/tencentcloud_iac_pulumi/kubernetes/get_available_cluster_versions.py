...
def get_available_cluster_versions_output(cluster_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          cluster_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
