...
def get_available_cluster_versions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kubernetes/getAvailableClusterVersions:getAvailableClusterVersions",
        __args__,
        opts=opts,
        typ=GetAvailableClusterVersionsResult,
    ).value
...
def get_available_cluster_versions_output(
...
) -> pulumi.Output[GetAvailableClusterVersionsResult]:
    """
    Use this data source to query detailed information of kubernetes available_cluster_versions
    ...
    return __ret__.apply(
        lambda __response__: GetAvailableClusterVersionsResult(
