...
class GetClustersResult:
    ...
    def kube_config_file_prefix(self) -> _builtins.str | None:
...
def get_clusters(
    ...
    kube_config_file_prefix: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kubernetes/getClusters:getClusters",
        __args__,
        opts=opts,
...
def get_clusters_output(
    ...
    kube_config_file_prefix: pulumi.Input[_builtins.str | None] = None,
