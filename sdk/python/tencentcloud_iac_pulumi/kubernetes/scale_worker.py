...
__all__ = ["ScaleWorker", "ScaleWorkerArgs"]
...
class ScaleWorkerArgs:
    def __init__(
        ...
        *,
        ...
        create_result_output_file: pulumi.Input[_builtins.str | None] = None,
        data_disks: pulumi.Input[
            Sequence[pulumi.Input["ScaleWorkerDataDiskArgs"]] | None
        ] = None,
        ...
        gpu_args: pulumi.Input[Optional["ScaleWorkerGpuArgsArgs"]] = None,
        ...
        taints: pulumi.Input[
            Sequence[pulumi.Input["ScaleWorkerTaintArgs"]] | None
        ] = None,
    ...
    def create_result_output_file(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def create_result_output_file(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def data_disks(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ScaleWorkerDataDiskArgs"]] | None]:
        """
    ...
    def data_disks(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["ScaleWorkerDataDiskArgs"]] | None],
    ):
    ...
    def gpu_args(self) -> pulumi.Input[Optional["ScaleWorkerGpuArgsArgs"]]:
        """
    ...
    @gpu_args.setter
    def gpu_args(self, value: pulumi.Input[Optional["ScaleWorkerGpuArgsArgs"]]):
    ...
    def taints(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ScaleWorkerTaintArgs"]] | None]:
        """
        Node taint.
        """
    ...
    def taints(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["ScaleWorkerTaintArgs"]] | None],
    ):
...
class _ScaleWorkerState:
    def __init__(
        ...
        *,
        ...
        unschedulable: pulumi.Input[_builtins.int | None] = None,
        user_script: pulumi.Input[_builtins.str | None] = None,
        worker_config: pulumi.Input[Optional["ScaleWorkerWorkerConfigArgs"]] = None,
        worker_instances_lists: pulumi.Input[
            Sequence[pulumi.Input["ScaleWorkerWorkerInstancesListArgs"]] | None
        ] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="workerConfig")
    def worker_config(self) -> pulumi.Input[Optional["ScaleWorkerWorkerConfigArgs"]]:
        """
        Deploy the machine configuration information of the 'WORK' service, and create <=20 units for common users.
        """
        return pulumi.get(self, "worker_config")
    ...
    @worker_config.setter
    def worker_config(
        self, value: pulumi.Input[Optional["ScaleWorkerWorkerConfigArgs"]]
    ):
        pulumi.set(self, "worker_config", value)
...
class ScaleWorker(pulumi.CustomResource):
    ...
    def __init__(
        ...
        data_disks: pulumi.Input[
            Sequence[
                pulumi.Input[
                    Union["ScaleWorkerDataDiskArgs", "ScaleWorkerDataDiskArgsDict"]
                ]
            ]
            | None
        ] = None,
        ...
        gpu_args: pulumi.Input[
            Union["ScaleWorkerGpuArgsArgs", "ScaleWorkerGpuArgsArgsDict"] | None
        ] = None,
        labels: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]] | None] = None,
        mount_target: pulumi.Input[_builtins.str | None] = None,
        pre_start_user_script: pulumi.Input[_builtins.str | None] = None,
        taints: pulumi.Input[
            Sequence[
                pulumi.Input[Union["ScaleWorkerTaintArgs", "ScaleWorkerTaintArgsDict"]]
            ]
            | None
        ] = None,
        unschedulable: pulumi.Input[_builtins.int | None] = None,
        user_script: pulumi.Input[_builtins.str | None] = None,
        worker_config: pulumi.Input[
            Union["ScaleWorkerWorkerConfigArgs", "ScaleWorkerWorkerConfigArgsDict"]
            | None
        ] = None,
        __props__=None,
    ):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ScaleWorkerArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="createResultOutputFile")
    def create_result_output_file(self) -> pulumi.Output[_builtins.str | None]:
        """
        Used to save results of CVMs creation error messages.
        """
        return pulumi.get(self, "create_result_output_file")
    ...
    def data_disks(
        self,
    ) -> pulumi.Output[Sequence["outputs.ScaleWorkerDataDisk"] | None]:
        """
        Configurations of tke data disk.
        """
        return pulumi.get(self, "data_disks")
    ...
    @_builtins.property
    @pulumi.getter(name="desiredPodNum")
    def desired_pod_num(self) -> pulumi.Output[_builtins.int | None]:
        """
        Indicate to set desired pod number in current node. Valid when the cluster enable customized pod cidr.
        """
        return pulumi.get(self, "desired_pod_num")
    ...
    @_builtins.property
    @pulumi.getter
    def taints(self) -> pulumi.Output[Sequence["outputs.ScaleWorkerTaint"] | None]:
        """
        Node taint.
        """
        return pulumi.get(self, "taints")
    ...
    @_builtins.property
    @pulumi.getter(name="userScript")
    def user_script(self) -> pulumi.Output[_builtins.str | None]:
        """
        Base64 encoded user script, this script will be executed after the k8s component is run. The user needs to ensure that the script is reentrant and retry logic. The script and its generated log files can be viewed in the /data/ccs_userscript/ path of the node, if required. The node needs to be initialized before it can be added to the schedule. It can be used with the unschedulable parameter. After the final initialization of userScript is completed, add the kubectl uncordon nodename --kubeconfig=/root/.kube/config command to add the node to the schedule.
        """
        return pulumi.get(self, "user_script")
    ...
    def worker_instances_lists(
        self,
    ) -> pulumi.Output[Sequence["outputs.ScaleWorkerWorkerInstancesList"]]:
        """
        An information list of kubernetes cluster 'WORKER'. Each element contains the following attributes:
        """
        return pulumi.get(self, "worker_instances_lists")
