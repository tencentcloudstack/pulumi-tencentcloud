...
class GetAddonsResult:
    ...
    def addon_name(self) -> _builtins.str | None:
        """
        Add-on name.
        """
...
def get_addons(
    addon_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kubernetes/getAddons:getAddons",
        __args__,
        opts=opts,
        typ=GetAddonsResult,
    ).value
...
def get_addons_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAddonsResult(
