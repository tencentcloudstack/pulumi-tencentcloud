...
class LogConfigArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] log_config: JSON expression of log collection configuration. For more details, please refer to the guide: https://www.tencentcloud.com/zh/document/product/457/64846.
        :param pulumi.Input[_builtins.str] log_config_name: Log config name. Must be identical to Value `metadata.name` in Field `log_config`.
    ...
    def log_config_name(self) -> pulumi.Input[_builtins.str]:
        """
        Log config name. Must be identical to Value `metadata.name` in Field `log_config`.
        """
...
class _LogConfigState:
    def __init__(
        ...
        *,
        ...
        cluster_type: pulumi.Input[_builtins.str | None] = None,
        log_config: pulumi.Input[_builtins.str | None] = None,
        log_config_name: pulumi.Input[_builtins.str | None] = None,
        logset_id: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="logConfig")
    def log_config(self) -> pulumi.Input[_builtins.str | None]:
        """
        JSON expression of log collection configuration. For more details, please refer to the guide: https://www.tencentcloud.com/zh/document/product/457/64846.
        """
        return pulumi.get(self, "log_config")
    ...
    @log_config.setter
    def log_config(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "log_config", value)

    @_builtins.property
    @pulumi.getter(name="logConfigName")
    def log_config_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        Log config name. Must be identical to Value `metadata.name` in Field `log_config`.
        """
        return pulumi.get(self, "log_config_name")
    ...
    @log_config_name.setter
    def log_config_name(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "log_config_name", value)
...
class LogConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="logsetId")
    def logset_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        CLS log set ID.
        """
        return pulumi.get(self, "logset_id")
