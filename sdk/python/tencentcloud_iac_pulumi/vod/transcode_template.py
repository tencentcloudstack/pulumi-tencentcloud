...
class TranscodeTemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] container: The container format. Valid values: `mp4`, `flv`, `hls`, `mp3`, `flac`, `ogg`, `m4a`, `wav` ( `mp3`, `flac`, `ogg`, `m4a`, and `wav` are audio file formats).
        ...
        :param pulumi.Input[_builtins.int] remove_audio: Whether to remove audio data. Valid values:0: retain 1: remove Default value: 0.
        :param pulumi.Input[_builtins.int] remove_video: Whether to remove video data. Valid values:
               - 0: retain
               - 1: remove
                 Default value: 0.
        :param pulumi.Input[_builtins.str] segment_type: The segment type. This parameter is valid only if `Container` is `hls`. Valid values: `ts`: TS segment; `fmp4`: fMP4 segment Default: `ts`.
...
@pulumi.type_token("tencentcloud:Vod/transcodeTemplate:TranscodeTemplate")
class TranscodeTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        :param pulumi.Input[Union['TranscodeTemplateAudioTemplateArgs', 'TranscodeTemplateAudioTemplateArgsDict']] audio_template: Audio stream configuration parameter. This field is required when `RemoveAudio` is 0.
        :param pulumi.Input[_builtins.str] comment: Template description. Length limit: 256 characters.
        :param pulumi.Input[_builtins.str] container: The container format. Valid values: `mp4`, `flv`, `hls`, `mp3`, `flac`, `ogg`, `m4a`, `wav` ( `mp3`, `flac`, `ogg`, `m4a`, and `wav` are audio file formats).
        :param pulumi.Input[_builtins.str] name: Transcoding template name. Length limit: 64 characters.
        :param pulumi.Input[_builtins.int] remove_audio: Whether to remove audio data. Valid values:0: retain 1: remove Default value: 0.
        ...
        :param pulumi.Input[_builtins.str] segment_type: The segment type. This parameter is valid only if `Container` is `hls`. Valid values: `ts`: TS segment; `fmp4`: fMP4 segment Default: `ts`.
        :param pulumi.Input[_builtins.int] sub_app_id: The VOD [application](https://intl.cloud.tencent.com/document/product/266/14574) ID. For customers who activate VOD service from December 25, 2023, if they want to access resources in a VOD application (whether it's the default application or a newly created one), they must fill in this field with the application ID.
        :param pulumi.Input[Union['TranscodeTemplateTehdConfigArgs', 'TranscodeTemplateTehdConfigArgsDict']] tehd_config: TESHD transcoding parameter.
        :param pulumi.Input[Union['TranscodeTemplateVideoTemplateArgs', 'TranscodeTemplateVideoTemplateArgsDict']] video_template: Video stream configuration parameter. This field is required when `RemoveVideo` is 0.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="segmentType")
    def segment_type(self) -> pulumi.Output[_builtins.str | None]:
        """
        The segment type. This parameter is valid only if `Container` is `hls`. Valid values: `ts`: TS segment; `fmp4`: fMP4 segment Default: `ts`.
        """
        return pulumi.get(self, "segment_type")
