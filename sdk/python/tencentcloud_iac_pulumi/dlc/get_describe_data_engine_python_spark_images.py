...
class GetDescribeDataEnginePythonSparkImagesResult:
    ...
    def python_spark_images(
        self,
    ) -> Sequence[
        "outputs.GetDescribeDataEnginePythonSparkImagesPythonSparkImageResult"
    ]:
        """
...
class AwaitableGetDescribeDataEnginePythonSparkImagesResult(
    GetDescribeDataEnginePythonSparkImagesResult
):
...
def get_describe_data_engine_python_spark_images(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getDescribeDataEnginePythonSparkImages:getDescribeDataEnginePythonSparkImages",
        __args__,
        opts=opts,
        typ=GetDescribeDataEnginePythonSparkImagesResult,
    ).value
...
def get_describe_data_engine_python_spark_images_output(
...
) -> pulumi.Output[GetDescribeDataEnginePythonSparkImagesResult]:
    """
    Use this data source to query detailed information of DLC describe data engine python spark images
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeDataEnginePythonSparkImagesResult(
