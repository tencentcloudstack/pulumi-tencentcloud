...
class _StoreLocationConfigState:
    def __init__(__self__, *,
                 ...
                 store_location: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="storeLocation")
    def store_location(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The calculation results are stored in the cos path, such as: cosn://bucketname/.
        """
        return pulumi.get(self, "store_location")
    ...
    @store_location.setter
    def store_location(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "store_location", value)
...
class StoreLocationConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            enable: pulumi.Input[Optional[_builtins.int]] = None,
            store_location: pulumi.Input[Optional[_builtins.str]] = None) -> 'StoreLocationConfig':
        """
