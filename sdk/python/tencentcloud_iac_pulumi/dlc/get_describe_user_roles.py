...
class GetDescribeUserRolesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def fuzzy(self) -> _builtins.str | None:
...
def get_describe_user_roles(
    fuzzy: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getDescribeUserRoles:getDescribeUserRoles",
        __args__,
        opts=opts,
        typ=GetDescribeUserRolesResult,
    ).value
...
def get_describe_user_roles_output(
    fuzzy: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetDescribeUserRolesResult]:
    """
    Use this data source to query detailed information of DLC describe user roles
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeUserRolesResult(
