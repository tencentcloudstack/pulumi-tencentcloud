...
class GetCheckDataEngineConfigPairsValidityResult:
    ...
    def child_image_version_id(self) -> Optional[_builtins.str]:
    ...
    def image_version_id(self) -> Optional[_builtins.str]:
    ...
    def unavailable_configs(self) -> Sequence[_builtins.str]:
        """
...
def get_check_data_engine_config_pairs_validity(child_image_version_id: Optional[_builtins.str] = None,
                                                data_engine_config_pairs: Optional[Sequence[Union['GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgs', 'GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgsDict']]] = None,
                                                image_version_id: Optional[_builtins.str] = None,
    ...
    example = tencentcloud.Dlc.get_check_data_engine_config_pairs_validity(child_image_version_id="d3ftghd4-9a7e-4f64-a3f4-f38507c69742")
    ```


    :param _builtins.str child_image_version_id: ID of the minor version of the engine.
    :param Sequence[Union['GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgs', 'GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgsDict']] data_engine_config_pairs: User-defined parameters.
    :param _builtins.str image_version_id: ID of the major version of the engine. If there is the ID of the minor version, only the ID of the minor version needs to be input. If not, the latest ID of the minor version under the major version will be acquired.
...
def get_check_data_engine_config_pairs_validity_output(child_image_version_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       data_engine_config_pairs: Optional[pulumi.Input[Optional[Sequence[Union['GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgs', 'GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgsDict']]]]] = None,
                                                       image_version_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCheckDataEngineConfigPairsValidityResult]:
    """
    Use this data source to query detailed information of DLC check data engine config pairs validity
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dlc/getCheckDataEngineConfigPairsValidity:getCheckDataEngineConfigPairsValidity', __args__, opts=opts, typ=GetCheckDataEngineConfigPairsValidityResult)
    return __ret__.apply(lambda __response__: GetCheckDataEngineConfigPairsValidityResult(
        child_image_version_id=pulumi.get(__response__, 'child_image_version_id'),
        data_engine_config_pairs=pulumi.get(__response__, 'data_engine_config_pairs'),
        id=pulumi.get(__response__, 'id'),
        image_version_id=pulumi.get(__response__, 'image_version_id'),
        is_available=pulumi.get(__response__, 'is_available'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        unavailable_configs=pulumi.get(__response__, 'unavailable_configs')))
