...
class GetCheckDataEngineConfigPairsValidityResult:
    ...
    def __init__(
        __self__,
        child_image_version_id=None,
        data_engine_config_pairs=None,
        id=None,
        image_version_id=None,
        is_available=None,
        result_output_file=None,
        unavailable_configs=None,
    ):
    ...
    def child_image_version_id(self) -> _builtins.str | None:
    ...
    def data_engine_config_pairs(
        ...
        Sequence[
            "outputs.GetCheckDataEngineConfigPairsValidityDataEngineConfigPairResult"
        ]
        | None
    ):
    ...
    def image_version_id(self) -> _builtins.str | None:
...
class AwaitableGetCheckDataEngineConfigPairsValidityResult(
    GetCheckDataEngineConfigPairsValidityResult
):
...
def get_check_data_engine_config_pairs_validity(
    child_image_version_id: _builtins.str | None = None,
    ...
    image_version_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getCheckDataEngineConfigPairsValidity:getCheckDataEngineConfigPairsValidity",
        __args__,
        opts=opts,
        typ=GetCheckDataEngineConfigPairsValidityResult,
    ).value
...
def get_check_data_engine_config_pairs_validity_output(
    child_image_version_id: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetCheckDataEngineConfigPairsValidityResult(
            child_image_version_id=pulumi.get(__response__, "child_image_version_id"),
            data_engine_config_pairs=pulumi.get(
                __response__, "data_engine_config_pairs"
            ),
