...
def get_check_data_engine_config_pairs_validity_output(child_image_version_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                       data_engine_config_pairs: pulumi.Input[Optional[Optional[Sequence[Union['GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgs', 'GetCheckDataEngineConfigPairsValidityDataEngineConfigPairArgsDict']]]]] = None,
                                                       image_version_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
