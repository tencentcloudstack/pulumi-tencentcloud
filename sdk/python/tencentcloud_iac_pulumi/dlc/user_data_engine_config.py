...
__all__ = ['UserDataEngineConfig', 'UserDataEngineConfigArgs']

@pulumi.input_type
class UserDataEngineConfigArgs:
    def __init__(__self__, *,
                 data_engine_id: pulumi.Input[_builtins.str],
                 data_engine_config_pairs: pulumi.Input[Optional[Sequence[pulumi.Input['UserDataEngineConfigDataEngineConfigPairArgs']]]] = None,
                 session_resource_template: pulumi.Input[Optional['UserDataEngineConfigSessionResourceTemplateArgs']] = None):
        """
    ...
    def data_engine_config_pairs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['UserDataEngineConfigDataEngineConfigPairArgs']]]]:
        """
    ...
    def data_engine_config_pairs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['UserDataEngineConfigDataEngineConfigPairArgs']]]]):
        pulumi.set(self, "data_engine_config_pairs", value)

    @_builtins.property
    @pulumi.getter(name="sessionResourceTemplate")
    def session_resource_template(self) -> pulumi.Input[Optional['UserDataEngineConfigSessionResourceTemplateArgs']]:
        """
    ...
    def session_resource_template(self, value: pulumi.Input[Optional['UserDataEngineConfigSessionResourceTemplateArgs']]):
...
@pulumi.type_token("tencentcloud:Dlc/userDataEngineConfig:UserDataEngineConfig")
class UserDataEngineConfig(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_engine_config_pairs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['UserDataEngineConfigDataEngineConfigPairArgs', 'UserDataEngineConfigDataEngineConfigPairArgsDict']]]]] = None,
                 data_engine_id: pulumi.Input[Optional[_builtins.str]] = None,
                 session_resource_template: pulumi.Input[Optional[Union['UserDataEngineConfigSessionResourceTemplateArgs', 'UserDataEngineConfigSessionResourceTemplateArgsDict']]] = None,
                 __props__=None):
        """
        ...
        user_data_engine_config = tencentcloud.dlc.UserDataEngineConfig("user_data_engine_config",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['UserDataEngineConfigDataEngineConfigPairArgs', 'UserDataEngineConfigDataEngineConfigPairArgsDict']]]] data_engine_config_pairs: Engine configuration items.
        :param pulumi.Input[_builtins.str] data_engine_id: Engine unique id.
        :param pulumi.Input[Union['UserDataEngineConfigSessionResourceTemplateArgs', 'UserDataEngineConfigSessionResourceTemplateArgsDict']] session_resource_template: Job engine resource configuration template.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            data_engine_config_pairs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['UserDataEngineConfigDataEngineConfigPairArgs', 'UserDataEngineConfigDataEngineConfigPairArgsDict']]]]] = None,
            data_engine_id: pulumi.Input[Optional[_builtins.str]] = None,
            session_resource_template: pulumi.Input[Optional[Union['UserDataEngineConfigSessionResourceTemplateArgs', 'UserDataEngineConfigSessionResourceTemplateArgsDict']]] = None) -> 'UserDataEngineConfig':
        """
