...
__all__ = [
    ...
    "ModifyDataEngineDescriptionOperationArgs",
]
...
class ModifyDataEngineDescriptionOperation(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ModifyDataEngineDescriptionOperationArgs.__new__(
                ModifyDataEngineDescriptionOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _ModifyDataEngineDescriptionOperationState.__new__(
            _ModifyDataEngineDescriptionOperationState
        )

        __props__.__dict__["data_engine_name"] = data_engine_name
        __props__.__dict__["message"] = message
        return ModifyDataEngineDescriptionOperation(
