...
class GetDescribeDataEngineImageVersionsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def asc(self) -> _builtins.bool | None:
    ...
    def image_parent_versions(
        self,
    ) -> Sequence["outputs.GetDescribeDataEngineImageVersionsImageParentVersionResult"]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sort(self) -> _builtins.str | None:
        return pulumi.get(self, "sort")


class AwaitableGetDescribeDataEngineImageVersionsResult(
    GetDescribeDataEngineImageVersionsResult
):
...
def get_describe_data_engine_image_versions(
    asc: _builtins.bool | None = None,
    engine_type: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    sort: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getDescribeDataEngineImageVersions:getDescribeDataEngineImageVersions",
        __args__,
        opts=opts,
        typ=GetDescribeDataEngineImageVersionsResult,
    ).value
...
def get_describe_data_engine_image_versions_output(
    asc: pulumi.Input[_builtins.bool | None] = None,
    engine_type: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    sort: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetDescribeDataEngineImageVersionsResult]:
    """
    Use this data source to query detailed information of DLC describe data engine image versions
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeDataEngineImageVersionsResult(
