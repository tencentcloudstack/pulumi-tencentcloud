...
__all__ = ["BindWorkGroupsToUserAttachment", "BindWorkGroupsToUserAttachmentArgs"]


@pulumi.input_type
class BindWorkGroupsToUserAttachmentArgs:
    def __init__(
        __self__, *, add_info: pulumi.Input["BindWorkGroupsToUserAttachmentAddInfoArgs"]
    ):
        """
    ...
    @add_info.setter
    def add_info(
        self, value: pulumi.Input["BindWorkGroupsToUserAttachmentAddInfoArgs"]
    ):
...
class _BindWorkGroupsToUserAttachmentState:
    def __init__(
        __self__,
        *,
        add_info: pulumi.Input[
            Optional["BindWorkGroupsToUserAttachmentAddInfoArgs"]
        ] = None
    ):
        """
    ...
    def add_info(
        self,
    ) -> pulumi.Input[Optional["BindWorkGroupsToUserAttachmentAddInfoArgs"]]:
        """
        Information about bound working groups and users.
        """
        return pulumi.get(self, "add_info")
    ...
    @add_info.setter
    def add_info(
        self, value: pulumi.Input[Optional["BindWorkGroupsToUserAttachmentAddInfoArgs"]]
    ):
        pulumi.set(self, "add_info", value)
...
class BindWorkGroupsToUserAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BindWorkGroupsToUserAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = BindWorkGroupsToUserAttachmentArgs.__new__(
                BindWorkGroupsToUserAttachmentArgs
            )
    ...
    def get(
    ...
    ) -> "BindWorkGroupsToUserAttachment":
        """
        ...
        __props__ = _BindWorkGroupsToUserAttachmentState.__new__(
            _BindWorkGroupsToUserAttachmentState
        )

        __props__.__dict__["add_info"] = add_info
        return BindWorkGroupsToUserAttachment(
    ...
    def add_info(
        self,
    ) -> pulumi.Output["outputs.BindWorkGroupsToUserAttachmentAddInfo"]:
        """
        Information about bound working groups and users.
        """
        return pulumi.get(self, "add_info")
