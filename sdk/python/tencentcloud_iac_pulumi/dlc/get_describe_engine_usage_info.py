...
def get_describe_engine_usage_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getDescribeEngineUsageInfo:getDescribeEngineUsageInfo",
        __args__,
        opts=opts,
        typ=GetDescribeEngineUsageInfoResult,
    ).value
...
def get_describe_engine_usage_info_output(
...
) -> pulumi.Output[GetDescribeEngineUsageInfoResult]:
    """
    Use this data source to query detailed information of DLC describe engine usage info
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeEngineUsageInfoResult(
