...
def get_describe_data_engine(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dlc/getDescribeDataEngine:getDescribeDataEngine",
        __args__,
        opts=opts,
        typ=GetDescribeDataEngineResult,
    ).value
...
def get_describe_data_engine_output(
...
) -> pulumi.Output[GetDescribeDataEngineResult]:
    """
    Use this data source to query detailed information of DLC describe data engine
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeDataEngineResult(
