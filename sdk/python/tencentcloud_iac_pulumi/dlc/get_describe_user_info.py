...
def get_describe_user_info_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDescribeUserInfoFilterArgs', 'GetDescribeUserInfoFilterArgsDict']]]]] = None,
