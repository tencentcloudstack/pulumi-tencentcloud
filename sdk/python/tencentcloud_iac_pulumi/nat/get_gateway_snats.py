...
class GetGatewaySnatsResult:
    ...
    def public_ip_addrs(self) -> Sequence[_builtins.str] | None:
...
def get_gateway_snats(
    description: _builtins.str | None = None,
    instance_id: _builtins.str | None = None,
    nat_gateway_id: _builtins.str | None = None,
    public_ip_addrs: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Nat/getGatewaySnats:getGatewaySnats",
        __args__,
        opts=opts,
        typ=GetGatewaySnatsResult,
    ).value
...
def get_gateway_snats_output(
    ...
    public_ip_addrs: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetGatewaySnatsResult]:
    """
    Use this data source to query detailed information of VPN gateways.
    ...
    return __ret__.apply(
        lambda __response__: GetGatewaySnatsResult(
