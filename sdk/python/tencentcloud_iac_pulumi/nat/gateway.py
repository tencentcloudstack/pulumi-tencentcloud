...
class GatewayArgs:
    def __init__(
        ...
        *,
        ...
        max_concurrent: pulumi.Input[_builtins.int | None] = None,
        name: pulumi.Input[_builtins.str | None] = None,
        nat_product_version: pulumi.Input[_builtins.int | None] = None,
        stock_public_ip_addresses_bandwidth_out: pulumi.Input[
            _builtins.int | None
        ] = None,
    ...
    def max_concurrent(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def max_concurrent(self, value: pulumi.Input[_builtins.int | None]):
    ...
    def nat_product_version(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def nat_product_version(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "nat_product_version", value)

    @_builtins.property
    @pulumi.getter(name="stockPublicIpAddressesBandwidthOut")
    def stock_public_ip_addresses_bandwidth_out(
        self,
...
class _GatewayState:
    def __init__(
        __self__,
        *,
        assigned_eip_sets: pulumi.Input[
...
class Gateway(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__.__dict__["stock_public_ip_addresses_bandwidth_out"] = (
                stock_public_ip_addresses_bandwidth_out
            )
        ...
        super().__init__(
            "tencentcloud:Nat/gateway:Gateway", resource_name, __props__, opts
        )
