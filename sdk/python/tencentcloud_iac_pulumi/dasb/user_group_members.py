...
__all__ = ['UserGroupMembers', 'UserGroupMembersArgs']

@pulumi.input_type
class UserGroupMembersArgs:
    def __init__(__self__, *,
                 member_id_sets: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]],
                 user_group_id: pulumi.Input[_builtins.int]):
        """
        The set of arguments for constructing a UserGroupMembers resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] member_id_sets: Collection of member user IDs.
    ...
    def user_group_id(self) -> pulumi.Input[_builtins.int]:
        """
        User Group ID.
        """
    ...
    def user_group_id(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("tencentcloud:Dasb/userGroupMembers:UserGroupMembers")
class UserGroupMembers(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_user_group_members = tencentcloud.dasb.UserGroupMembers("example",
            user_group_id=example_user_group.id.apply(lambda x: int(x)),
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            member_id_sets: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
            user_group_id: pulumi.Input[Optional[_builtins.int]] = None) -> 'UserGroupMembers':
        """
