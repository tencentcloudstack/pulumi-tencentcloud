...
__all__ = ["ResetUser", "ResetUserArgs"]


@pulumi.input_type
class ResetUserArgs:
    def __init__(__self__, *, user_id: pulumi.Input[_builtins.int]):
        """
...
class _ResetUserState:
    def __init__(__self__, *, user_id: pulumi.Input[_builtins.int | None] = None):
        """
...
@pulumi.type_token("tencentcloud:Dasb/resetUser:ResetUser")
class ResetUser(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ResetUserArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dasb/resetUser:ResetUser", resource_name, __props__, opts
        )
