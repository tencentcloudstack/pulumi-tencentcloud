...
__all__ = ["CmdTemplate", "CmdTemplateArgs"]
...
class CmdTemplateArgs:
    def __init__(
        __self__,
        *,
        cmd_list: pulumi.Input[_builtins.str],
        name: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a CmdTemplate resource.

        :param pulumi.Input[_builtins.str] cmd_list: Command list, n separated, maximum length 32768 bytes.
        :param pulumi.Input[_builtins.str] name: Template name, maximum length 32 characters, cannot contain blank characters.
        """
    ...
    def cmd_list(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @cmd_list.setter
    def cmd_list(self, value: pulumi.Input[_builtins.str]):
...
class _CmdTemplateState:
    def __init__(
        __self__,
        *,
        cmd_list: pulumi.Input[_builtins.str | None] = None,
        name: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cmdList")
    def cmd_list(self) -> pulumi.Input[_builtins.str | None]:
        """
        Command list, n separated, maximum length 32768 bytes.
        """
        return pulumi.get(self, "cmd_list")
    ...
    @cmd_list.setter
    def cmd_list(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "cmd_list", value)
...
@pulumi.type_token("tencentcloud:Dasb/cmdTemplate:CmdTemplate")
class CmdTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.dasb.CmdTemplate("example",
            name="tf_example",
            cmd_list="rm -rf*")
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CmdTemplateArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dasb/cmdTemplate:CmdTemplate", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="cmdList")
    def cmd_list(self) -> pulumi.Output[_builtins.str]:
        """
        Command list, n separated, maximum length 32768 bytes.
        """
        return pulumi.get(self, "cmd_list")
