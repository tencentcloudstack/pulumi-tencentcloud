...
class _CmdTemplateState:
    def __init__(__self__, *,
                 cmd_list: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cmdList")
    def cmd_list(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Command list, n separated, maximum length 32768 bytes.
        """
        return pulumi.get(self, "cmd_list")
    ...
    @cmd_list.setter
    def cmd_list(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "cmd_list", value)
...
class CmdTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cmd_list: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None) -> 'CmdTemplate':
        """
