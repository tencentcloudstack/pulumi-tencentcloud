...
__all__ = ["DeviceGroup", "DeviceGroupArgs"]
...
class DeviceGroupArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] department_id: The ID of the department to which the asset group belongs, such as: 1.2.3 name, with a maximum length of 32 characters.
        :param pulumi.Input[_builtins.str] name: Device group name, the maximum length is 32 characters.
        """
...
@pulumi.type_token("tencentcloud:Dasb/deviceGroup:DeviceGroup")
class DeviceGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.dasb.DeviceGroup("example",
            name="tf_example",
            department_id="1.2")
        ```
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: DeviceGroupArgs | None = None,
        opts: pulumi.ResourceOptions | None = None,
    ):
        """
        Provides a resource to create a dasb device_group
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DeviceGroupArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dasb/deviceGroup:DeviceGroup", resource_name, __props__, opts
        )
