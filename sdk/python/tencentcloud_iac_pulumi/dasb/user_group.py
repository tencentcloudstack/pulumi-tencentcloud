...
class UserGroupArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] department_id: ID of the department to which the user group belongs, such as: 1.2.3.
...
@pulumi.type_token("tencentcloud:Dasb/userGroup:UserGroup")
class UserGroup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.dasb.UserGroup("example", name="tf_example")
        ```
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dasb/userGroup:UserGroup", resource_name, __props__, opts
        )
