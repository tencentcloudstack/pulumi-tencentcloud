...
class _TableEntryState:
    def __init__(__self__, *,
                 ...
                 disabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 next_hub: pulumi.Input[Optional[_builtins.str]] = None,
                 next_type: pulumi.Input[Optional[_builtins.str]] = None,
                 route_entry_id: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="nextHub")
    def next_hub(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ID of next-hop gateway. Note: when `next_type` is EIP, `next_hub` should be `0`.
        """
        return pulumi.get(self, "next_hub")
    ...
    @next_hub.setter
    def next_hub(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "next_hub", value)

    @_builtins.property
    @pulumi.getter(name="nextType")
    def next_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Type of next-hop. Valid values: `CVM`, `VPN`, `DIRECTCONNECT`, `PEERCONNECTION`, `HAVIP`, `NAT`, `NORMAL_CVM`, `EIP`, `LOCAL_GATEWAY`, `INTRANAT`, `USER_CCN` and `GWLB_ENDPOINT`.
        """
        return pulumi.get(self, "next_type")
    ...
    @next_type.setter
    def next_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "next_type", value)

    @_builtins.property
    @pulumi.getter(name="routeEntryId")
    def route_entry_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ID of route entry.
        """
    ...
    def route_entry_id(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class TableEntry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_entry_id: pulumi.Input[Optional[_builtins.int]] = None,
            route_item_id: pulumi.Input[Optional[_builtins.str]] = None,
            route_table_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'TableEntry':
        """
