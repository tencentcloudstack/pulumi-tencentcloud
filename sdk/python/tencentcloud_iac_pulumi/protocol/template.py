...
class TemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] protocols: Protocol list. Valid protocols are  `tcp`, `udp`, `icmp`, `gre`. Single port(tcp:80), multi-port(tcp:80,443), port range(tcp:3306-20000), all(tcp:all) format are support. Protocol `icmp` and `gre` cannot specify port.
        :param pulumi.Input[_builtins.str] name: Name of the protocol template.
        """
...
@pulumi.type_token("tencentcloud:Protocol/template:Template")
class Template(pulumi.CustomResource):
    ...
    def __init__(
        ...
        foo = tencentcloud.protocol.Template("foo",
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Protocol/template:Template", resource_name, __props__, opts
        )
