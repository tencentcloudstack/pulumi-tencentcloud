...
class GetTemplateGroupsResult:
    ...
    def __init__(
        __self__, group_lists=None, id=None, name=None, result_output_file=None
    ):
...
def get_template_groups(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Protocol/getTemplateGroups:getTemplateGroups",
        __args__,
        opts=opts,
        typ=GetTemplateGroupsResult,
    ).value
...
def get_template_groups_output(
...
) -> pulumi.Output[GetTemplateGroupsResult]:
    """
    Use this data source to query detailed information of protocol template groups.
    ...
    return __ret__.apply(
        lambda __response__: GetTemplateGroupsResult(
