...
class ClusterProxyList(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ClusterProxyList. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 machine_num: Optional[_builtins.int] = None,
    ...
    def machine_num(self) -> Optional[_builtins.int]:
        """
        Machine quantity.
        """
...
class ClusterResourceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ClusterResourceTag. Access the value via the '{suggest}' property getter instead.")
...
class ClusterServerList(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ClusterServerList. Access the value via the '{suggest}' property getter instead.")
...
class TablegroupResourceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TablegroupResourceTag. Access the value via the '{suggest}' property getter instead.")
