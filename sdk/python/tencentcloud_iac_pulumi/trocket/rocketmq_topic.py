...
class _RocketmqTopicState:
    def __init__(
        ...
        *,
        ...
        queue_num: pulumi.Input[_builtins.int | None] = None,
        remark: pulumi.Input[_builtins.str | None] = None,
        tags: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]] | None] = None,
        topic: pulumi.Input[_builtins.str | None] = None,
        topic_type: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="queueNum")
    def queue_num(self) -> pulumi.Input[_builtins.int | None]:
        """
        Number of queue. Must be greater than or equal to 3.
        """
        return pulumi.get(self, "queue_num")
    ...
    @queue_num.setter
    def queue_num(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "queue_num", value)
    ...
    @_builtins.property
    @pulumi.getter(name="topicType")
    def topic_type(self) -> pulumi.Input[_builtins.str | None]:
        """
        Topic type. `UNSPECIFIED`: not specified, `NORMAL`: normal message, `FIFO`: sequential message, `DELAY`: delayed message.
        """
        return pulumi.get(self, "topic_type")
    ...
    @topic_type.setter
    def topic_type(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "topic_type", value)
