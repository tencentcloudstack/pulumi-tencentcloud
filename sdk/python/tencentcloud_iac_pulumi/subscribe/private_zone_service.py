...
__all__ = ["PrivateZoneService", "PrivateZoneServiceArgs"]
...
class _PrivateZoneServiceState:
    def __init__(
        __self__, *, service_status: pulumi.Input[_builtins.str | None] = None
    ):
        """
        Input properties used for looking up and filtering PrivateZoneService resources.

        :param pulumi.Input[_builtins.str] service_status: Private domain resolution service activation status.
        """
    ...
    def service_status(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def service_status(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "service_status", value)


@pulumi.type_token("tencentcloud:Subscribe/privateZoneService:PrivateZoneService")
class PrivateZoneService(pulumi.CustomResource):
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: PrivateZoneServiceArgs | None = None,
        opts: pulumi.ResourceOptions | None = None,
    ):
        """
        Provides a resource to create a privatedns subscribe private zone service
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            PrivateZoneServiceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def get(
        ...
        id: pulumi.Input[str],
        opts: pulumi.ResourceOptions | None = None,
        service_status: pulumi.Input[_builtins.str | None] = None,
    ) -> "PrivateZoneService":
        """
