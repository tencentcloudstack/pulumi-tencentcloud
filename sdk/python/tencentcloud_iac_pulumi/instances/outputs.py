...
__all__ = [
    ...
    'GetInstanceInstanceListGpuInfoResult',
...
class GetInstanceInstanceListResult(dict):
    def __init__(__self__, *,
                 ...
                 gpu_infos: Sequence['outputs.GetInstanceInstanceListGpuInfoResult'],
        ...
        :param Sequence['GetInstanceInstanceListGpuInfoArgs'] gpu_infos: Instance GPU info.
        ...
        :param _builtins.str rack_id: The rack ID of the instance resource pool to which the instance belongs.
    ...
    def gpu_infos(self) -> Sequence['outputs.GetInstanceInstanceListGpuInfoResult']:
        """
        Instance GPU info.
        """
...
@pulumi.output_type
class GetInstanceInstanceListGpuInfoResult(dict):
    def __init__(__self__, *,
                 gpu_count: _builtins.float,
                 gpu_ids: Sequence[_builtins.str],
                 gpu_type: _builtins.str):
        """
        :param _builtins.float gpu_count: Number of instance GPUs. A value less than 1 indicates a VGPU type, and a value greater than 1 indicates a GPU passthrough type.
        :param Sequence[_builtins.str] gpu_ids: Instance GPU address.
        :param _builtins.str gpu_type: Instance GPU type.
        """
    ...
    def gpu_ids(self) -> Sequence[_builtins.str]:
        """
