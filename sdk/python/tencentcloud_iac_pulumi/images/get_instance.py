...
class GetInstanceResult:
    ...
    def image_name_regex(self) -> _builtins.str | None:
        return pulumi.get(self, "image_name_regex")

    @_builtins.property
    @pulumi.getter(name="imageTypes")
    def image_types(self) -> Sequence[_builtins.str] | None:
        """
        Type of the image.
        """
    ...
    def os_name(self) -> _builtins.str | None:
        """
...
def get_instance(
    ...
    image_name_regex: _builtins.str | None = None,
    image_types: Sequence[_builtins.str] | None = None,
    instance_type: _builtins.str | None = None,
    os_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Images/getInstance:getInstance",
        __args__,
        opts=opts,
...
def get_instance_output(
    ...
    image_name_regex: pulumi.Input[_builtins.str | None] = None,
    image_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
