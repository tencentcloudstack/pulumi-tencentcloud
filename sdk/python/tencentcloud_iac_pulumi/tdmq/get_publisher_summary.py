...
def get_publisher_summary(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getPublisherSummary:getPublisherSummary",
        __args__,
        opts=opts,
        typ=GetPublisherSummaryResult,
    ).value
...
def get_publisher_summary_output(
...
) -> pulumi.Output[GetPublisherSummaryResult]:
    """
    Use this data source to query detailed information of tdmq publisher_summary
    ...
    return __ret__.apply(
        lambda __response__: GetPublisherSummaryResult(
