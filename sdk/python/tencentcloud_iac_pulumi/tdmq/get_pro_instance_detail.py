...
def get_pro_instance_detail(cluster_id: Optional[_builtins.str] = None,
...
def get_pro_instance_detail_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetProInstanceDetailResult]:
    """
    Use this data source to query detailed information of tdmq pro_instance_detail
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tdmq/getProInstanceDetail:getProInstanceDetail', __args__, opts=opts, typ=GetProInstanceDetailResult)
    return __ret__.apply(lambda __response__: GetProInstanceDetailResult(
        ...
        network_access_point_infos=pulumi.get(__response__, 'network_access_point_infos'),
