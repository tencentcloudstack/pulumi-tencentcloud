...
class GetProInstanceDetailResult:
    ...
    def __init__(
        ...
        cluster_id=None,
        cluster_infos=None,
        cluster_spec_infos=None,
        id=None,
        network_access_point_infos=None,
        ...
        if network_access_point_infos and not isinstance(
            network_access_point_infos, list
        ):
            raise TypeError(
                "Expected argument 'network_access_point_infos' to be a list"
            )
    ...
    def cluster_infos(
        self,
    ) -> Sequence["outputs.GetProInstanceDetailClusterInfoResult"]:
        """
        Cluster information.
        """
    ...
    def cluster_spec_infos(
        self,
    ) -> Sequence["outputs.GetProInstanceDetailClusterSpecInfoResult"]:
        """
    ...
    def network_access_point_infos(
        self,
    ) -> Sequence["outputs.GetProInstanceDetailNetworkAccessPointInfoResult"]:
        """
...
def get_pro_instance_detail(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getProInstanceDetail:getProInstanceDetail",
        __args__,
        opts=opts,
        typ=GetProInstanceDetailResult,
    ).value
...
def get_pro_instance_detail_output(
...
) -> pulumi.Output[GetProInstanceDetailResult]:
    """
    Use this data source to query detailed information of tdmq pro_instance_detail
    ...
    return __ret__.apply(
        lambda __response__: GetProInstanceDetailResult(
            cluster_id=pulumi.get(__response__, "cluster_id"),
            cluster_infos=pulumi.get(__response__, "cluster_infos"),
            cluster_spec_infos=pulumi.get(__response__, "cluster_spec_infos"),
            id=pulumi.get(__response__, "id"),
            network_access_point_infos=pulumi.get(
                __response__, "network_access_point_infos"
            ),
