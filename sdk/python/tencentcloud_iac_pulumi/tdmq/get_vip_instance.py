...
class GetVipInstanceResult:
    ...
    def instance_configs(
        self,
    ) -> Sequence["outputs.GetVipInstanceInstanceConfigResult"]:
...
def get_vip_instance(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getVipInstance:getVipInstance",
        __args__,
        opts=opts,
        typ=GetVipInstanceResult,
    ).value
...
def get_vip_instance_output(
...
) -> pulumi.Output[GetVipInstanceResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetVipInstanceResult(
