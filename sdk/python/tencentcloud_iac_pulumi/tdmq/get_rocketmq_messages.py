...
class GetRocketmqMessagesResult:
    ...
    def message_tracks(
        self,
    ) -> Sequence["outputs.GetRocketmqMessagesMessageTrackResult"]:
        """
    ...
    def query_dlq_msg(self) -> _builtins.bool | None:
...
def get_rocketmq_messages(
    cluster_id: _builtins.str | None = None,
    environment_id: _builtins.str | None = None,
    msg_id: _builtins.str | None = None,
    query_dlq_msg: _builtins.bool | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getRocketmqMessages:getRocketmqMessages",
        __args__,
        opts=opts,
        typ=GetRocketmqMessagesResult,
    ).value
...
def get_rocketmq_messages_output(
    cluster_id: pulumi.Input[_builtins.str | None] = None,
    environment_id: pulumi.Input[_builtins.str | None] = None,
    msg_id: pulumi.Input[_builtins.str | None] = None,
    query_dlq_msg: pulumi.Input[_builtins.bool | None] = None,
...
) -> pulumi.Output[GetRocketmqMessagesResult]:
    """
    Use this data source to query detailed information of tdmq message
    ...
    return __ret__.apply(
        lambda __response__: GetRocketmqMessagesResult(
