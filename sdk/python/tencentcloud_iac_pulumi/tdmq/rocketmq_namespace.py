...
class RocketmqNamespaceArgs:
    ...
    @_utilities.deprecated("""It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored.""")
...
class RocketmqNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_time: pulumi.Input[Optional[_builtins.int]] = None,
            ttl: pulumi.Input[Optional[_builtins.int]] = None,
            vpc_endpoint: pulumi.Input[Optional[_builtins.str]] = None) -> 'RocketmqNamespace':
        """
    ...
    @pulumi.getter(name="retentionTime")
    @_utilities.deprecated("""It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored.""")
    def retention_time(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of persisted messages in milliseconds.
        """
        return pulumi.get(self, "retention_time")
