...
__all__ = ["RocketmqNamespace", "RocketmqNamespaceArgs"]
...
class RocketmqNamespaceArgs:
    def __init__(
        ...
        *,
        ...
        retention_time: pulumi.Input[_builtins.int | None] = None,
        ...
        :param pulumi.Input[_builtins.str] namespace_name: Namespace name, which can contain 3-64 letters, digits, hyphens, and underscores.
        :param pulumi.Input[_builtins.str] remark: Remarks (up to 128 characters).
        :param pulumi.Input[_builtins.int] retention_time: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of persisted messages in milliseconds.
        :param pulumi.Input[_builtins.int] ttl: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of unconsumed messages in milliseconds. Value range: 60 seconds-15 days.
        """
        ...
        if retention_time is not None:
            warnings.warn(
                """It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored.""",
                DeprecationWarning,
            )
            pulumi.log.warn(
                """retention_time is deprecated: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored."""
            )
        if retention_time is not None:
        ...
        if ttl is not None:
            ...
            pulumi.log.warn(
                """ttl is deprecated: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored."""
            )
        if ttl is not None:
    ...
    def retention_time(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def retention_time(self, value: pulumi.Input[_builtins.int | None]):
...
class _RocketmqNamespaceState:
    def __init__(
        ...
        *,
        ...
        public_endpoint: pulumi.Input[_builtins.str | None] = None,
        remark: pulumi.Input[_builtins.str | None] = None,
        retention_time: pulumi.Input[_builtins.int | None] = None,
        ttl: pulumi.Input[_builtins.int | None] = None,
        ...
        :param pulumi.Input[_builtins.str] cluster_id: Cluster ID.
        :param pulumi.Input[_builtins.str] namespace_name: Namespace name, which can contain 3-64 letters, digits, hyphens, and underscores.
        :param pulumi.Input[_builtins.str] public_endpoint: Public network access point address.
        :param pulumi.Input[_builtins.str] remark: Remarks (up to 128 characters).
        :param pulumi.Input[_builtins.int] retention_time: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of persisted messages in milliseconds.
        :param pulumi.Input[_builtins.int] ttl: It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of unconsumed messages in milliseconds. Value range: 60 seconds-15 days.
        :param pulumi.Input[_builtins.str] vpc_endpoint: VPC access point address.
        """
    ...
    def public_endpoint(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def public_endpoint(self, value: pulumi.Input[_builtins.str | None]):
...
@pulumi.type_token("tencentcloud:Tdmq/rocketmqNamespace:RocketmqNamespace")
class RocketmqNamespace(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RocketmqNamespaceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def retention_time(self) -> pulumi.Output[_builtins.int | None]:
        """
        It has been deprecated from version 1.81.20. Due to the adjustment of RocketMQ, the creation or modification of this parameter will be ignored. Retention time of persisted messages in milliseconds.
        """
        return pulumi.get(self, "retention_time")
