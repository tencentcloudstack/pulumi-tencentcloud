...
class GetPublishersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetPublishersFilterResult"] | None:
...
def get_publishers(
    ...
    filters: (
        Sequence[Union["GetPublishersFilterArgs", "GetPublishersFilterArgsDict"]] | None
    ) = None,
    namespace: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    sort: Union["GetPublishersSortArgs", "GetPublishersSortArgsDict"] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getPublishers:getPublishers",
        __args__,
        opts=opts,
        typ=GetPublishersResult,
    ).value
...
def get_publishers_output(
    ...
    return __ret__.apply(
        lambda __response__: GetPublishersResult(
