...
def get_environment_attributes(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getEnvironmentAttributes:getEnvironmentAttributes",
        __args__,
        opts=opts,
        typ=GetEnvironmentAttributesResult,
    ).value
...
def get_environment_attributes_output(
...
) -> pulumi.Output[GetEnvironmentAttributesResult]:
    """
    Use this data source to query detailed information of tdmq environment_attributes
    ...
    return __ret__.apply(
        lambda __response__: GetEnvironmentAttributesResult(
