...
def get_rocketmq_namespace(cluster_id: Optional[_builtins.str] = None,
    ...
    example_rocketmq_namespace = tencentcloud.tdmq.RocketmqNamespace("example",
        ...
        remark="remark.")
    example = tencentcloud.Tdmq.get_rocketmq_namespace_output(cluster_id=example_rocketmq_cluster.cluster_id,
        name_keyword=example_rocketmq_namespace.namespace_name)
    ```


    :param _builtins.str cluster_id: Cluster ID.
    :param _builtins.str name_keyword: Search by name.
...
def get_rocketmq_namespace_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRocketmqNamespaceResult]:
    """
    Use this data source to query detailed information of tdmqRocketmq namespace
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tdmq/getRocketmqNamespace:getRocketmqNamespace', __args__, opts=opts, typ=GetRocketmqNamespaceResult)
    return __ret__.apply(lambda __response__: GetRocketmqNamespaceResult(
