...
def get_rocketmq_namespace(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getRocketmqNamespace:getRocketmqNamespace",
        __args__,
        opts=opts,
        typ=GetRocketmqNamespaceResult,
    ).value
...
def get_rocketmq_namespace_output(
...
) -> pulumi.Output[GetRocketmqNamespaceResult]:
    """
    Use this data source to query detailed information of tdmqRocketmq namespace
    ...
    return __ret__.apply(
        lambda __response__: GetRocketmqNamespaceResult(
