...
__all__ = [
    ...
    "RabbitmqVipInstanceResourceTag",
...
class NamespaceRetentionPolicy(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in NamespaceRetentionPolicy. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        __self__,
        *,
        size_in_mb: _builtins.int | None = None,
        time_in_minutes: _builtins.int | None = None,
    ):
        """
    ...
    def size_in_mb(self) -> _builtins.int | None:
        """
    ...
    def time_in_minutes(self) -> _builtins.int | None:
        """
...
class NamespaceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in NamespaceTag. Access the value via the '{suggest}' property getter instead."
            )

    def __getitem__(self, key: str) -> Any:
        NamespaceTag.__key_warning(key)
        return super().__getitem__(key)
...
class ProfessionalClusterVpc(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in ProfessionalClusterVpc. Access the value via the '{suggest}' property getter instead."
            )
...
@pulumi.output_type
class RabbitmqVipInstanceResourceTag(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "tagKey":
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in RabbitmqVipInstanceResourceTag. Access the value via the '{suggest}' property getter instead."
            )

    def __getitem__(self, key: str) -> Any:
        RabbitmqVipInstanceResourceTag.__key_warning(key)
        return super().__getitem__(key)
...
class RabbitmqVipInstanceVpc(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in RabbitmqVipInstanceVpc. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        ...
        *,
        ...
        vpc_data_stream_endpoint_status: _builtins.str | None = None,
        vpc_endpoint: _builtins.str | None = None,
    ...
    def vpc_data_stream_endpoint_status(self) -> _builtins.str | None:
        """
    ...
    def vpc_endpoint(self) -> _builtins.str | None:
        """
        VPC Endpoint.
        """
...
class RocketmqClusterVpc(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in RocketmqClusterVpc. Access the value via the '{suggest}' property getter instead."
            )
...
class RocketmqVipInstanceIpRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in RocketmqVipInstanceIpRule. Access the value via the '{suggest}' property getter instead."
            )
...
class RocketmqVipInstanceVpcInfo(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in RocketmqVipInstanceVpcInfo. Access the value via the '{suggest}' property getter instead."
            )
...
class TopicTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in TopicTag. Access the value via the '{suggest}' property getter instead."
            )

    def __getitem__(self, key: str) -> Any:
        TopicTag.__key_warning(key)
        return super().__getitem__(key)
...
class GetProInstanceDetailClusterInfoResult(dict):
    def __init__(
        ...
        *,
        ...
        node_distributions: Sequence[
            "outputs.GetProInstanceDetailClusterInfoNodeDistributionResult"
        ],
        remark: _builtins.str,
    ...
    def node_distributions(
        self,
    ) -> Sequence["outputs.GetProInstanceDetailClusterInfoNodeDistributionResult"]:
        """
...
class GetPublishersSortResult(dict):
    def __init__(__self__, *, name: _builtins.str, order: _builtins.str):
        """
...
class GetVipInstanceInstanceConfigResult(dict):
    def __init__(
        ...
        *,
        ...
        node_count: _builtins.int,
        node_distributions: Sequence[
            "outputs.GetVipInstanceInstanceConfigNodeDistributionResult"
        ],
        topic_distributions: Sequence[
            "outputs.GetVipInstanceInstanceConfigTopicDistributionResult"
        ],
        used_group_num: _builtins.int,
        used_namespace_num: _builtins.int,
        used_topic_num: _builtins.int,
    ...
    def node_distributions(
        self,
    ) -> Sequence["outputs.GetVipInstanceInstanceConfigNodeDistributionResult"]:
        """
        Node distribution.
        """
        return pulumi.get(self, "node_distributions")
    ...
    def topic_distributions(
        self,
    ) -> Sequence["outputs.GetVipInstanceInstanceConfigTopicDistributionResult"]:
        """
        Topic distribution.
        """
...
class GetVipInstanceInstanceConfigTopicDistributionResult(dict):
    def __init__(__self__, *, count: _builtins.int, topic_type: _builtins.str):
        """
