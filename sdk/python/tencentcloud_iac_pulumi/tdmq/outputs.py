...
class NamespaceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in NamespaceTag. Access the value via the '{suggest}' property getter instead.")
...
class RabbitmqVipInstanceResourceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RabbitmqVipInstanceResourceTag. Access the value via the '{suggest}' property getter instead.")
...
class TopicTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TopicTag. Access the value via the '{suggest}' property getter instead.")
