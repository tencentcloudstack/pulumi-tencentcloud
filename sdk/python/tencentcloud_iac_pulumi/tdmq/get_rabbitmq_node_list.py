...
class GetRabbitmqNodeListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetRabbitmqNodeListFilterResult"] | None:
    ...
    def sort_element(self) -> _builtins.str | None:
        return pulumi.get(self, "sort_element")

    @_builtins.property
    @pulumi.getter(name="sortOrder")
    def sort_order(self) -> _builtins.str | None:
...
def get_rabbitmq_node_list(
    filters: (
        Sequence[
            Union["GetRabbitmqNodeListFilterArgs", "GetRabbitmqNodeListFilterArgsDict"]
        ]
        | None
    ) = None,
    ...
    sort_element: _builtins.str | None = None,
    sort_order: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tdmq/getRabbitmqNodeList:getRabbitmqNodeList",
        __args__,
        opts=opts,
        typ=GetRabbitmqNodeListResult,
    ).value
...
def get_rabbitmq_node_list_output(
    ...
    sort_element: pulumi.Input[_builtins.str | None] = None,
    sort_order: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetRabbitmqNodeListResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetRabbitmqNodeListResult(
