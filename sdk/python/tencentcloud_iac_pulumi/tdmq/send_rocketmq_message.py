...
__all__ = ["SendRocketmqMessage", "SendRocketmqMessageArgs"]
...
class SendRocketmqMessageArgs:
    def __init__(
        ...
        *,
        ...
        msg_body: pulumi.Input[_builtins.str],
        namespace_id: pulumi.Input[_builtins.str],
        topic_name: pulumi.Input[_builtins.str],
        msg_key: pulumi.Input[_builtins.str | None] = None,
        msg_tag: pulumi.Input[_builtins.str | None] = None
    ):
        """
        ...
        :param pulumi.Input[_builtins.str] msg_body: Information.
        :param pulumi.Input[_builtins.str] namespace_id: Namespaces.
        :param pulumi.Input[_builtins.str] topic_name: topic name.
        :param pulumi.Input[_builtins.str] msg_key: Message key information.
        :param pulumi.Input[_builtins.str] msg_tag: Message tag information.
        """
    ...
    def msg_body(self) -> pulumi.Input[_builtins.str]:
        """
        Information.
        """
    ...
    @msg_body.setter
    def msg_body(self, value: pulumi.Input[_builtins.str]):
    ...
    def msg_key(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @msg_key.setter
    def msg_key(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "msg_key", value)

    @_builtins.property
    @pulumi.getter(name="msgTag")
    def msg_tag(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @msg_tag.setter
    def msg_tag(self, value: pulumi.Input[_builtins.str | None]):
...
class _SendRocketmqMessageState:
    def __init__(
        ...
        *,
        ...
        msg_body: pulumi.Input[_builtins.str | None] = None,
        msg_key: pulumi.Input[_builtins.str | None] = None,
        msg_tag: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="msgBody")
    def msg_body(self) -> pulumi.Input[_builtins.str | None]:
        """
        Information.
        """
        return pulumi.get(self, "msg_body")
    ...
    @msg_body.setter
    def msg_body(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "msg_body", value)
...
@pulumi.type_token("tencentcloud:Tdmq/sendRocketmqMessage:SendRocketmqMessage")
class SendRocketmqMessage(pulumi.CustomResource):
    ...
    def __init__(
        ...
        send_rocketmq_message = tencentcloud.tdmq.SendRocketmqMessage("send_rocketmq_message",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SendRocketmqMessageArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="msgBody")
    def msg_body(self) -> pulumi.Output[_builtins.str]:
        """
        Information.
        """
        return pulumi.get(self, "msg_body")
    ...
    @_builtins.property
    @pulumi.getter(name="msgKey")
    def msg_key(self) -> pulumi.Output[_builtins.str | None]:
        """
        Message key information.
        """
        return pulumi.get(self, "msg_key")
    ...
    @_builtins.property
    @pulumi.getter(name="msgTag")
    def msg_tag(self) -> pulumi.Output[_builtins.str | None]:
        """
        Message tag information.
        """
        return pulumi.get(self, "msg_tag")
