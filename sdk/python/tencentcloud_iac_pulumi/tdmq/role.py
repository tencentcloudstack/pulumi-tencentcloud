...
class _RoleState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] remark: The description of tdmq role.
        :param pulumi.Input[_builtins.str] role_name: The name of tdmq role.
        :param pulumi.Input[_builtins.str] token: Role token. This field is returned by the API and used for authentication.
        """
...
class Role(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__("tencentcloud:Tdmq/role:Role", resource_name, __props__, opts)
