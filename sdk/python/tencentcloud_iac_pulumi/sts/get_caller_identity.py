...
def get_caller_identity(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sts/getCallerIdentity:getCallerIdentity",
        __args__,
        opts=opts,
        typ=GetCallerIdentityResult,
    ).value
...
def get_caller_identity_output(
    ...
    return __ret__.apply(
        lambda __response__: GetCallerIdentityResult(
