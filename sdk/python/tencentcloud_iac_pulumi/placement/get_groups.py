...
class GetGroupsResult:
    ...
    def placement_group_id(self) -> _builtins.str | None:
        """
    ...
    def placement_group_lists(
        self,
    ) -> Sequence["outputs.GetGroupsPlacementGroupListResult"]:
        """
...
def get_groups(
    ...
    placement_group_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Placement/getGroups:getGroups",
        __args__,
        opts=opts,
        typ=GetGroupsResult,
    ).value
