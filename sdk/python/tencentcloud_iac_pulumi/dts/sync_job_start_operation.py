...
__all__ = ["SyncJobStartOperation", "SyncJobStartOperationArgs"]
...
@pulumi.type_token("tencentcloud:Dts/syncJobStartOperation:SyncJobStartOperation")
class SyncJobStartOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        sync_job_start_operation = tencentcloud.dts.SyncJobStartOperation("sync_job_start_operation", job_id="sync-werwfs23")
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SyncJobStartOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
