...
class GetSyncJobsResult:
    ...
    def tag_filters(self) -> Sequence["outputs.GetSyncJobsTagFilterResult"] | None:
...
def get_sync_jobs(
    ...
    tag_filters: (
        Sequence[Union["GetSyncJobsTagFilterArgs", "GetSyncJobsTagFilterArgsDict"]]
        | None
    ) = None,
    ...
    :param _builtins.str order: order field.
    :param _builtins.str order_seq: order way, optional value is DESC or ASC.
    ...
    :param Sequence[_builtins.str] statuses: status.
    :param Sequence[Union['GetSyncJobsTagFilterArgs', 'GetSyncJobsTagFilterArgsDict']] tag_filters: tag filters.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dts/getSyncJobs:getSyncJobs",
        __args__,
        opts=opts,
        typ=GetSyncJobsResult,
    ).value
...
def get_sync_jobs_output(
...
) -> pulumi.Output[GetSyncJobsResult]:
    """
    Use this data source to query detailed information of dts syncJobs
    ...
    return __ret__.apply(
        lambda __response__: GetSyncJobsResult(
