...
def get_sync_jobs(job_id: Optional[_builtins.str] = None,
                  ...
                  tag_filters: Optional[Sequence[Union['GetSyncJobsTagFilterArgs', 'GetSyncJobsTagFilterArgsDict']]] = None,
...
def get_sync_jobs_output(job_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         tag_filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSyncJobsTagFilterArgs', 'GetSyncJobsTagFilterArgsDict']]]]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSyncJobsResult]:
    """
    Use this data source to query detailed information of dts syncJobs
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dts/getSyncJobs:getSyncJobs', __args__, opts=opts, typ=GetSyncJobsResult)
    return __ret__.apply(lambda __response__: GetSyncJobsResult(
