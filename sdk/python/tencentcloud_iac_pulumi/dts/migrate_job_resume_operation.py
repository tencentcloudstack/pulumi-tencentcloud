...
__all__ = ["MigrateJobResumeOperation", "MigrateJobResumeOperationArgs"]
...
class MigrateJobResumeOperationArgs:
    def __init__(
        ...
        *,
        ...
        resume_option: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a MigrateJobResumeOperation resource.

        :param pulumi.Input[_builtins.str] job_id: job id.
        :param pulumi.Input[_builtins.str] resume_option: resume mode: 1.clearData-Clear target data; 2.overwrite-The task is executed in overwrite mode; 3.normal-No extra action. Note that clearData and overwrite are valid only for redis links, normal is valid only for non-Redis links.
        """
    ...
    def resume_option(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def resume_option(self, value: pulumi.Input[_builtins.str]):
...
class _MigrateJobResumeOperationState:
    def __init__(
        ...
        *,
        ...
        resume_option: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="resumeOption")
    def resume_option(self) -> pulumi.Input[_builtins.str | None]:
        """
        resume mode: 1.clearData-Clear target data; 2.overwrite-The task is executed in overwrite mode; 3.normal-No extra action. Note that clearData and overwrite are valid only for redis links, normal is valid only for non-Redis links.
        """
        return pulumi.get(self, "resume_option")
    ...
    @resume_option.setter
    def resume_option(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "resume_option", value)
...
class MigrateJobResumeOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.dts.MigrateJobResumeOperation("example",
            job_id="dts-puwyj5uy",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            MigrateJobResumeOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = MigrateJobResumeOperationArgs.__new__(
                MigrateJobResumeOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _MigrateJobResumeOperationState.__new__(
            _MigrateJobResumeOperationState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="resumeOption")
    def resume_option(self) -> pulumi.Output[_builtins.str]:
        """
        resume mode: 1.clearData-Clear target data; 2.overwrite-The task is executed in overwrite mode; 3.normal-No extra action. Note that clearData and overwrite are valid only for redis links, normal is valid only for non-Redis links.
        """
        return pulumi.get(self, "resume_option")
