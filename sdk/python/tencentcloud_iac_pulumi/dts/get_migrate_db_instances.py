...
class GetMigrateDbInstancesResult:
    ...
    def migrate_role(self) -> _builtins.str | None:
...
def get_migrate_db_instances(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dts/getMigrateDbInstances:getMigrateDbInstances",
        __args__,
        opts=opts,
        typ=GetMigrateDbInstancesResult,
    ).value
...
def get_migrate_db_instances_output(
    account_mode: pulumi.Input[_builtins.str | None] = None,
    database_type: pulumi.Input[_builtins.str | None] = None,
    ...
    migrate_role: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetMigrateDbInstancesResult]:
    """
    Use this data source to query detailed information of dts migrate_db_instances
    ...
    return __ret__.apply(
        lambda __response__: GetMigrateDbInstancesResult(
