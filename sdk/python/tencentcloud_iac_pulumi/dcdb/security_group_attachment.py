...
class SecurityGroupAttachmentArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: attached instance id.
...
@pulumi.type_token("tencentcloud:Dcdb/securityGroupAttachment:SecurityGroupAttachment")
class SecurityGroupAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        security_group_attachment = tencentcloud.dcdb.SecurityGroupAttachment("security_group_attachment",
            security_group_id="",
            instance_id="")
        ```
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dcdb/securityGroupAttachment:SecurityGroupAttachment",
            resource_name,
            __props__,
            opts,
        )
