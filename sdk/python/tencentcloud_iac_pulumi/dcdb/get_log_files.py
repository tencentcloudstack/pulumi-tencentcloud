...
def get_log_files(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getLogFiles:getLogFiles",
        __args__,
        opts=opts,
        typ=GetLogFilesResult,
    ).value
...
def get_log_files_output(
...
) -> pulumi.Output[GetLogFilesResult]:
    """
    Use this data source to query detailed information of dcdb log_files
    ...
    return __ret__.apply(
        lambda __response__: GetLogFilesResult(
