...
class GetUpgradePriceResult:
    ...
    def __init__(
        __self__,
        add_shard_config=None,
        amount_unit=None,
        expand_shard_config=None,
        formula=None,
        id=None,
        instance_id=None,
        original_price=None,
    ...
    def add_shard_config(
        self,
    ) -> Optional["outputs.GetUpgradePriceAddShardConfigResult"]:
    ...
    def expand_shard_config(
        self,
    ) -> Optional["outputs.GetUpgradePriceExpandShardConfigResult"]:
    ...
    def split_shard_config(
        self,
    ) -> Optional["outputs.GetUpgradePriceSplitShardConfigResult"]:
...
def get_upgrade_price(
    add_shard_config: (
        Union[
            "GetUpgradePriceAddShardConfigArgs", "GetUpgradePriceAddShardConfigArgsDict"
        ]
        | None
    ) = None,
    ...
    upgrade_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getUpgradePrice:getUpgradePrice",
        __args__,
        opts=opts,
        typ=GetUpgradePriceResult,
    ).value
...
def get_upgrade_price_output(
    add_shard_config: pulumi.Input[
        Union[
            "GetUpgradePriceAddShardConfigArgs", "GetUpgradePriceAddShardConfigArgsDict"
        ]
        | None
    ...
    expand_shard_config: pulumi.Input[
        Union[
            "GetUpgradePriceExpandShardConfigArgs",
            "GetUpgradePriceExpandShardConfigArgsDict",
        ]
    ...
    split_shard_config: pulumi.Input[
        Union[
            "GetUpgradePriceSplitShardConfigArgs",
            "GetUpgradePriceSplitShardConfigArgsDict",
        ]
    ...
    upgrade_type: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetUpgradePriceResult]:
    """
    Use this data source to query detailed information of dcdb upgrade_price
    ...
    return __ret__.apply(
        lambda __response__: GetUpgradePriceResult(
