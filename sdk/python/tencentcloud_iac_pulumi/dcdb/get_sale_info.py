...
def get_sale_info(result_output_file: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tencentcloud:Dcdb/getSaleInfo:getSaleInfo', __args__, opts=opts, typ=GetSaleInfoResult).value

    return AwaitableGetSaleInfoResult(
        id=pulumi.get(__ret__, 'id'),
        region_lists=pulumi.get(__ret__, 'region_lists'),
        result_output_file=pulumi.get(__ret__, 'result_output_file'))
def get_sale_info_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSaleInfoResult]:
    """
    Use this data source to query detailed information of dcdb sale_info
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dcdb/getSaleInfo:getSaleInfo', __args__, opts=opts, typ=GetSaleInfoResult)
    return __ret__.apply(lambda __response__: GetSaleInfoResult(
