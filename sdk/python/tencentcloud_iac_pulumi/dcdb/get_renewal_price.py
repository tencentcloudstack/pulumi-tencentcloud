...
def get_renewal_price(amount_unit: Optional[_builtins.str] = None,
    ...
    renewal_price = tencentcloud.Dcdb.get_renewal_price(instance_id=dcdb_id,
        period=1,
        amount_unit="pent")
    ```
...
def get_renewal_price_output(amount_unit: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dcdb/getRenewalPrice:getRenewalPrice', __args__, opts=opts, typ=GetRenewalPriceResult)
