...
def get_renewal_price(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getRenewalPrice:getRenewalPrice",
        __args__,
        opts=opts,
        typ=GetRenewalPriceResult,
    ).value
...
def get_renewal_price_output(
...
) -> pulumi.Output[GetRenewalPriceResult]:
    """
    Use this data source to query detailed information of dcdb renewal_price
    ...
    return __ret__.apply(
        lambda __response__: GetRenewalPriceResult(
