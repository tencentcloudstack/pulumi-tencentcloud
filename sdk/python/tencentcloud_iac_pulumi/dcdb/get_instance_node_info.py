...
def get_instance_node_info(instance_id: Optional[_builtins.str] = None,
    ...
    instance_node_info = tencentcloud.Dcdb.get_instance_node_info(instance_id=dcdb_id)
    ```


    :param _builtins.str instance_id: Instance ID, such as tdsqlshard-6ltok4u9.
...
def get_instance_node_info_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dcdb/getInstanceNodeInfo:getInstanceNodeInfo', __args__, opts=opts, typ=GetInstanceNodeInfoResult)
