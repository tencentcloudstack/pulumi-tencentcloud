...
class GetPriceResult:
    ...
    def shard_node_count(self) -> _builtins.int:
...
def get_price(
    ...
    shard_count: _builtins.int | None = None,
    shard_memory: _builtins.int | None = None,
    shard_node_count: _builtins.int | None = None,
    shard_storage: _builtins.int | None = None,
    ...
    :param _builtins.int instance_count: The count of instances wants to buy.
    ...
    :param _builtins.int shard_count: Number of instance shards.
    :param _builtins.int shard_memory: Shard memory size in GB.
    :param _builtins.int shard_node_count: Number of instance shard nodes.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getPrice:getPrice", __args__, opts=opts, typ=GetPriceResult
    ).value
...
def get_price_output(
    ...
    return __ret__.apply(
        lambda __response__: GetPriceResult(
            ...
            shard_memory=pulumi.get(__response__, "shard_memory"),
            shard_node_count=pulumi.get(__response__, "shard_node_count"),
            shard_storage=pulumi.get(__response__, "shard_storage"),
