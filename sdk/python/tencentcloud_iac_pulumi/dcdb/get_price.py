...
def get_price(amount_unit: Optional[_builtins.str] = None,
              ...
              shard_memory: Optional[_builtins.int] = None,
              shard_node_count: Optional[_builtins.int] = None,
              shard_storage: Optional[_builtins.int] = None,
...
def get_price_output(amount_unit: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dcdb/getPrice:getPrice', __args__, opts=opts, typ=GetPriceResult)
