...
class InstanceConfigArgs:
    def __init__(
        ...
        *,
        ...
        rs_access_strategy: pulumi.Input[_builtins.int]
    ):
        """
        The set of arguments for constructing a InstanceConfig resource.

        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.int] rs_access_strategy: RS nearest access mode, 0-no policy, 1-nearest access.
        """
    ...
    def rs_access_strategy(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def rs_access_strategy(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("tencentcloud:Dcdb/instanceConfig:InstanceConfig")
class InstanceConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        instance_config = tencentcloud.dcdb.InstanceConfig("instance_config",
            instance_id=dcdb_id,
