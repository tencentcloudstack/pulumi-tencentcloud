...
def get_file_download_url(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getFileDownloadUrl:getFileDownloadUrl",
        __args__,
        opts=opts,
        typ=GetFileDownloadUrlResult,
    ).value
...
def get_file_download_url_output(
...
) -> pulumi.Output[GetFileDownloadUrlResult]:
    """
    Use this data source to query detailed information of dcdb file_download_url
    ...
    return __ret__.apply(
        lambda __response__: GetFileDownloadUrlResult(
