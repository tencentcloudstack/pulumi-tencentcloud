...
class GetSlowLogsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def slave(self) -> _builtins.int | None:
...
def get_slow_logs(
    ...
    shard_id: _builtins.str | None = None,
    slave: _builtins.int | None = None,
    ...
    slow_logs = tencentcloud.dcdb.get_slow_logs(instance_id=dcdb_id,
        start_time="%s",
        end_time="%s",
    ...
    :param _builtins.str instance_id: Instance ID in the format of `tdsqlshard-ow728lmc`.
    ...
    :param _builtins.str shard_id: Instance shard ID in the format of `shard-rc754ljk`.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getSlowLogs:getSlowLogs",
        __args__,
        opts=opts,
...
def get_slow_logs_output(
    ...
    shard_id: pulumi.Input[_builtins.str | None] = None,
    slave: pulumi.Input[_builtins.int | None] = None,
