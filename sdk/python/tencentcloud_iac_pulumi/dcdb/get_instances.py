...
class GetInstancesResult:
    ...
    def excluster_type(self) -> _builtins.int | None:
    ...
    def is_filter_excluster(self) -> _builtins.bool | None:
        return pulumi.get(self, "is_filter_excluster")

    @_builtins.property
    @pulumi.getter(name="isFilterVpc")
    def is_filter_vpc(self) -> _builtins.bool | None:
    ...
    def search_name(self) -> _builtins.str | None:
...
def get_instances(
    ...
    :param _builtins.int excluster_type: cluster excluster type.
    :param Sequence[_builtins.str] instance_ids: instance ids.
    :param _builtins.bool is_filter_excluster: search according to the cluster excluter type.
    :param _builtins.bool is_filter_vpc: search according to the vpc.
    :param Sequence[_builtins.int] project_ids: project ids.
    :param _builtins.str result_output_file: Used to save results.
    :param _builtins.str search_key: search key, support fuzzy query.
    :param _builtins.str search_name: search name, support instancename, vip, all.
    :param _builtins.str subnet_id: subnet id, valid when IsFilterVpc is true.
    :param _builtins.str vpc_id: vpc id, valid when IsFilterVpc is true.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getInstances:getInstances",
        __args__,
        opts=opts,
...
def get_instances_output(
    excluster_type: pulumi.Input[_builtins.int | None] = None,
    instance_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    is_filter_excluster: pulumi.Input[_builtins.bool | None] = None,
    is_filter_vpc: pulumi.Input[_builtins.bool | None] = None,
    ...
    search_name: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetInstancesResult(
            excluster_type=pulumi.get(__response__, "excluster_type"),
            id=pulumi.get(__response__, "id"),
            instance_ids=pulumi.get(__response__, "instance_ids"),
            is_filter_excluster=pulumi.get(__response__, "is_filter_excluster"),
            is_filter_vpc=pulumi.get(__response__, "is_filter_vpc"),
