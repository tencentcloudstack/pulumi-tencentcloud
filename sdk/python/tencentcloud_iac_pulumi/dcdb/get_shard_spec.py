...
def get_shard_spec(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dcdb/getShardSpec:getShardSpec",
        __args__,
        opts=opts,
        typ=GetShardSpecResult,
    ).value
...
def get_shard_spec_output(
    ...
    return __ret__.apply(
        lambda __response__: GetShardSpecResult(
