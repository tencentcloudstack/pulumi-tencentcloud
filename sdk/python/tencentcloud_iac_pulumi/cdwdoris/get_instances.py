...
def get_instances(result_output_file: Optional[_builtins.str] = None,
                  ...
                  search_tags: Optional[Sequence[Union['GetInstancesSearchTagArgs', 'GetInstancesSearchTagArgsDict']]] = None,
    ...
    :param _builtins.str search_instance_id: The name of the cluster ID for the search.
    :param _builtins.str search_instance_name: The cluster name for the search.
    :param Sequence[Union['GetInstancesSearchTagArgs', 'GetInstancesSearchTagArgsDict']] search_tags: Search tag list.
    """
    __args__ = dict()
...
def get_instances_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         search_tags: Optional[pulumi.Input[Optional[Sequence[Union['GetInstancesSearchTagArgs', 'GetInstancesSearchTagArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cdwdoris/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
