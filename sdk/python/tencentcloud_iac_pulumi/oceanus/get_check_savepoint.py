...
def get_check_savepoint(
    job_id: _builtins.str | None = None,
    record_type: _builtins.int | None = None,
    result_output_file: _builtins.str | None = None,
    savepoint_path: _builtins.str | None = None,
    serial_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getCheckSavepoint:getCheckSavepoint",
        __args__,
        opts=opts,
        typ=GetCheckSavepointResult,
    ).value
...
def get_check_savepoint_output(
    job_id: pulumi.Input[_builtins.str | None] = None,
    record_type: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetCheckSavepointResult]:
    """
    Use this data source to query detailed information of oceanus check_savepoint
    ...
    return __ret__.apply(
        lambda __response__: GetCheckSavepointResult(
