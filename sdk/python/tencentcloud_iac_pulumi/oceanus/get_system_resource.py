...
class GetSystemResourceResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetSystemResourceFilterResult"] | None:
        return pulumi.get(self, "filters")

    @_builtins.property
    @pulumi.getter(name="flinkVersion")
    def flink_version(self) -> _builtins.str | None:
    ...
    def resource_ids(self) -> Sequence[_builtins.str] | None:
...
def get_system_resource(
    ...
    filters: (
        Sequence[
            Union["GetSystemResourceFilterArgs", "GetSystemResourceFilterArgsDict"]
        ]
        | None
    ) = None,
    flink_version: _builtins.str | None = None,
    resource_ids: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getSystemResource:getSystemResource",
        __args__,
        opts=opts,
        typ=GetSystemResourceResult,
    ).value
...
def get_system_resource_output(
    ...
    return __ret__.apply(
        lambda __response__: GetSystemResourceResult(
