...
class GetTreeResourcesResult:
    ...
    def __init__(
        __self__, id=None, result_output_file=None, tree_infos=None, work_space_id=None
    ):
...
def get_tree_resources(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getTreeResources:getTreeResources",
        __args__,
        opts=opts,
        typ=GetTreeResourcesResult,
    ).value
...
def get_tree_resources_output(
...
) -> pulumi.Output[GetTreeResourcesResult]:
    """
    Use this data source to query detailed information of oceanus tree_resources
    ...
    return __ret__.apply(
        lambda __response__: GetTreeResourcesResult(
