...
class GetTreeJobsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetTreeJobsFilterResult"] | None:
...
def get_tree_jobs(
    filters: (
        Sequence[Union["GetTreeJobsFilterArgs", "GetTreeJobsFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getTreeJobs:getTreeJobs",
        __args__,
        opts=opts,
        typ=GetTreeJobsResult,
    ).value
...
def get_tree_jobs_output(
...
) -> pulumi.Output[GetTreeJobsResult]:
    """
    Use this data source to query detailed information of oceanus tree_jobs
    ...
    return __ret__.apply(
        lambda __response__: GetTreeJobsResult(
