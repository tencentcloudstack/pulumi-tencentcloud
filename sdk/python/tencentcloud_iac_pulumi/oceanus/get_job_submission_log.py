...
class GetJobSubmissionLogResult:
    ...
    def __init__(
        ...
        id=None,
        job_id=None,
        job_instance_lists=None,
        job_request_id=None,
        keyword=None,
        list_over=None,
        log_content_lists=None,
        log_lists=None,
        order_type=None,
    ...
    def job_instance_lists(
        self,
    ) -> Sequence["outputs.GetJobSubmissionLogJobInstanceListResult"]:
        """
    ...
    def log_content_lists(
        self,
    ) -> Sequence["outputs.GetJobSubmissionLogLogContentListResult"]:
        """
    ...
    def running_order_id(self) -> _builtins.int | None:
        """
...
def get_job_submission_log(
    cursor: _builtins.str | None = None,
    ...
    running_order_id: _builtins.int | None = None,
    ...
    example = tencentcloud.oceanus.get_job_submission_log(job_id="cql-314rw6w0",
        start_time=int(1696130964345),
        end_time=int(1698118169241),
        running_order_id=0,
        order_type="desc")
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getJobSubmissionLog:getJobSubmissionLog",
        __args__,
        opts=opts,
        typ=GetJobSubmissionLogResult,
    ).value
...
def get_job_submission_log_output(
    cursor: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetJobSubmissionLogResult(
