...
def get_job_submission_log_output(cursor: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                  ...
                                  running_order_id: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
