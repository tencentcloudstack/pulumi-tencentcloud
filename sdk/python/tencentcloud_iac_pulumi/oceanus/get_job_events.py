...
def get_job_events(
    end_timestamp: _builtins.int | None = None,
    job_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    start_timestamp: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getJobEvents:getJobEvents",
        __args__,
        opts=opts,
        typ=GetJobEventsResult,
    ).value
...
def get_job_events_output(
    end_timestamp: pulumi.Input[_builtins.int | None] = None,
    job_id: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    start_timestamp: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetJobEventsResult]:
    """
    Use this data source to query detailed information of oceanus job_events
    ...
    return __ret__.apply(
        lambda __response__: GetJobEventsResult(
