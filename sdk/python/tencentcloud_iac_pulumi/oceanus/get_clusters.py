...
class GetClustersResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetClustersFilterResult"] | None:
...
def get_clusters(
    ...
    filters: (
        Sequence[Union["GetClustersFilterArgs", "GetClustersFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getClusters:getClusters",
        __args__,
        opts=opts,
