...
class GetWorkSpacesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetWorkSpacesFilterResult"] | None:
    ...
    def work_space_set_items(
        self,
    ) -> Sequence["outputs.GetWorkSpacesWorkSpaceSetItemResult"]:
        """
...
def get_work_spaces(
    filters: (
        Sequence[Union["GetWorkSpacesFilterArgs", "GetWorkSpacesFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Oceanus/getWorkSpaces:getWorkSpaces",
        __args__,
        opts=opts,
        typ=GetWorkSpacesResult,
    ).value
...
def get_work_spaces_output(
    ...
    return __ret__.apply(
        lambda __response__: GetWorkSpacesResult(
