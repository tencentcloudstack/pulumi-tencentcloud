...
class GetResourceRelatedJobResult:
    ...
    def desc_by_job_config_create_time(self) -> Optional[_builtins.int]:
    ...
    def resource_config_version(self) -> Optional[_builtins.int]:
...
def get_resource_related_job(desc_by_job_config_create_time: Optional[_builtins.int] = None,
                             resource_config_version: Optional[_builtins.int] = None,
    ...
    return AwaitableGetResourceRelatedJobResult(
        desc_by_job_config_create_time=pulumi.get(__ret__, 'desc_by_job_config_create_time'),
...
def get_resource_related_job_output(desc_by_job_config_create_time: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                    resource_config_version: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                    ...
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetResourceRelatedJobResult]:
    """
    Use this data source to query detailed information of oceanus resource_related_job
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Oceanus/getResourceRelatedJob:getResourceRelatedJob', __args__, opts=opts, typ=GetResourceRelatedJobResult)
    return __ret__.apply(lambda __response__: GetResourceRelatedJobResult(
        desc_by_job_config_create_time=pulumi.get(__response__, 'desc_by_job_config_create_time'),
