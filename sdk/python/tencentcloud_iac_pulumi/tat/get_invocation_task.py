...
class GetInvocationTaskResult:
    ...
    def hide_output(self) -> Optional[_builtins.bool]:
    ...
    def invocation_task_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_invocation_task(filters: Optional[Sequence[Union['GetInvocationTaskFilterArgs', 'GetInvocationTaskFilterArgsDict']]] = None,
                        hide_output: Optional[_builtins.bool] = None,
                        invocation_task_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    invocation_task = tencentcloud.Tat.get_invocation_task(filters=[{
            "name": "instance-id",
            "values": ["ins-p4pq4gaq"],
        }],
        hide_output=True)
...
def get_invocation_task_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetInvocationTaskFilterArgs', 'GetInvocationTaskFilterArgsDict']]]]] = None,
                               hide_output: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                               invocation_task_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                               result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInvocationTaskResult]:
    """
    Use this data source to query detailed information of tat invocation_task
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tat/getInvocationTask:getInvocationTask', __args__, opts=opts, typ=GetInvocationTaskResult)
    return __ret__.apply(lambda __response__: GetInvocationTaskResult(
        filters=pulumi.get(__response__, 'filters'),
        hide_output=pulumi.get(__response__, 'hide_output'),
        id=pulumi.get(__response__, 'id'),
        invocation_task_ids=pulumi.get(__response__, 'invocation_task_ids'),
        invocation_task_sets=pulumi.get(__response__, 'invocation_task_sets'),
