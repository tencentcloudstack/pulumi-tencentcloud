...
class InvokerScheduleSettingsArgsDict(TypedDict):
    ...
    """
    invoke_time: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class InvokerScheduleSettingsArgs:
    def __init__(__self__, *,
                 policy: pulumi.Input[_builtins.str],
                 invoke_time: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def invoke_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The next execution time of the invoker. This field is required if Policy is ONCE.
        """
    ...
    @invoke_time.setter
    def invoke_time(self, value: pulumi.Input[Optional[_builtins.str]]):
