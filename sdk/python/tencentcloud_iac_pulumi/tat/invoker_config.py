...
__all__ = ['InvokerConfig', 'InvokerConfigArgs']

@pulumi.input_type
class InvokerConfigArgs:
    def __init__(__self__, *,
                 invoker_id: pulumi.Input[_builtins.str],
                 invoker_status: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a InvokerConfig resource.

        :param pulumi.Input[_builtins.str] invoker_id: ID of the invoker to be enabled.
        :param pulumi.Input[_builtins.str] invoker_status: Invoker on and off state, Values: `on`, `off`.
        """
    ...
    def invoker_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @invoker_id.setter
    def invoker_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "invoker_id", value)

    @_builtins.property
    @pulumi.getter(name="invokerStatus")
    def invoker_status(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def invoker_status(self, value: pulumi.Input[_builtins.str]):
...
class _InvokerConfigState:
    def __init__(__self__, *,
                 ...
                 invoker_status: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="invokerStatus")
    def invoker_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Invoker on and off state, Values: `on`, `off`.
        """
        return pulumi.get(self, "invoker_status")
    ...
    @invoker_status.setter
    def invoker_status(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "invoker_status", value)


@pulumi.type_token("tencentcloud:Tat/invokerConfig:InvokerConfig")
class InvokerConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        invoker_config = tencentcloud.tat.InvokerConfig("invoker_config",
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            invoker_id: pulumi.Input[Optional[_builtins.str]] = None,
            invoker_status: pulumi.Input[Optional[_builtins.str]] = None) -> 'InvokerConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="invokerStatus")
    def invoker_status(self) -> pulumi.Output[_builtins.str]:
        """
        Invoker on and off state, Values: `on`, `off`.
        """
        return pulumi.get(self, "invoker_status")
