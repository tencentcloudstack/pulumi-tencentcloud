...
class GetInvokerResult:
    ...
    def invoker_id(self) -> _builtins.str | None:
        """
        Invoker ID.
        """
...
def get_invoker(
    ...
    invoker_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tat/getInvoker:getInvoker",
        __args__,
        opts=opts,
        typ=GetInvokerResult,
    ).value
...
def get_invoker_output(
...
) -> pulumi.Output[GetInvokerResult]:
    """
    Use this data source to query detailed information of tat invoker
    ...
    return __ret__.apply(
        lambda __response__: GetInvokerResult(
