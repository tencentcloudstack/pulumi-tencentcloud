...
class GetCommandResult:
    ...
    def command_id(self) -> _builtins.str | None:
        """
        Command ID.
        """
    ...
    def command_name(self) -> _builtins.str | None:
        """
        Command name.
        """
    ...
    def command_type(self) -> _builtins.str | None:
        """
        Command type.
        """
    ...
    def created_by(self) -> _builtins.str | None:
        """
...
def get_command(
    command_id: _builtins.str | None = None,
    command_name: _builtins.str | None = None,
    command_type: _builtins.str | None = None,
    created_by: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tat/getCommand:getCommand",
        __args__,
        opts=opts,
        typ=GetCommandResult,
    ).value
...
def get_command_output(
...
) -> pulumi.Output[GetCommandResult]:
    """
    Use this data source to query detailed information of tat command
    ...
    return __ret__.apply(
        lambda __response__: GetCommandResult(
