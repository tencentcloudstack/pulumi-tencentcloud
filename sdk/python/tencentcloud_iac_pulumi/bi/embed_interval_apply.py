...
__all__ = ["EmbedIntervalApply", "EmbedIntervalApplyArgs"]
...
class EmbedIntervalApplyArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] bi_token: Token that needs to be applied for extension.
        :param pulumi.Input[_builtins.int] page_id: Sharing page id, this is empty value 0 when embedding the board.
        :param pulumi.Input[_builtins.int] project_id: Sharing project id, required.
        :param pulumi.Input[_builtins.str] scope: Choose panel or page.
        """
...
@pulumi.type_token("tencentcloud:Bi/embedIntervalApply:EmbedIntervalApply")
class EmbedIntervalApply(pulumi.CustomResource):
    ...
    def __init__(
        ...
        embed_interval = tencentcloud.bi.EmbedIntervalApply("embed_interval",
            project_id=11015030,
            page_id=10520483,
    ...
    def __init__(
        __self__,
        resource_name: str,
        args: EmbedIntervalApplyArgs | None = None,
        opts: pulumi.ResourceOptions | None = None,
    ):
        """
        Provides a resource to create a bi embed_interval
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            EmbedIntervalApplyArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="biToken")
    def bi_token(self) -> pulumi.Output[_builtins.str | None]:
        """
        Token that needs to be applied for extension.
        """
        return pulumi.get(self, "bi_token")
