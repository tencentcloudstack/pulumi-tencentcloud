...
def get_user_project(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Bi/getUserProject:getUserProject",
        __args__,
        opts=opts,
        typ=GetUserProjectResult,
    ).value
...
def get_user_project_output(
...
) -> pulumi.Output[GetUserProjectResult]:
    """
    Use this data source to query detailed information of bi user_project
    ...
    return __ret__.apply(
        lambda __response__: GetUserProjectResult(
