...
class GetProjectResult:
    ...
    def all_page(self) -> _builtins.bool | None:
    ...
    def module_collection(self) -> _builtins.str | None:
    ...
    def page_no(self) -> _builtins.int | None:
...
def get_project(
    all_page: _builtins.bool | None = None,
    keyword: _builtins.str | None = None,
    module_collection: _builtins.str | None = None,
    page_no: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Bi/getProject:getProject",
        __args__,
        opts=opts,
        typ=GetProjectResult,
    ).value
...
def get_project_output(
    all_page: pulumi.Input[_builtins.bool | None] = None,
    keyword: pulumi.Input[_builtins.str | None] = None,
    module_collection: pulumi.Input[_builtins.str | None] = None,
    page_no: pulumi.Input[_builtins.int | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetProjectResult(
