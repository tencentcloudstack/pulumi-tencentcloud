...
def get_security_policies(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getSecurityPolicies:getSecurityPolicies",
        __args__,
        opts=opts,
        typ=GetSecurityPoliciesResult,
    ).value
...
def get_security_policies_output(
...
) -> pulumi.Output[GetSecurityPoliciesResult]:
    """
    Use this data source to query security policies of GAAP proxy.
    ...
    return __ret__.apply(
        lambda __response__: GetSecurityPoliciesResult(
