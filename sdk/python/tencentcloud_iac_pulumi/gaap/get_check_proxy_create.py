...
class GetCheckProxyCreateResult:
    ...
    def ip_address_version(self) -> _builtins.str | None:
        return pulumi.get(self, "ip_address_version")

    @_builtins.property
    @pulumi.getter(name="networkType")
    def network_type(self) -> _builtins.str | None:
...
def get_check_proxy_create(
    access_region: _builtins.str | None = None,
    bandwidth: _builtins.int | None = None,
    concurrent: _builtins.int | None = None,
    group_id: _builtins.str | None = None,
    ip_address_version: _builtins.str | None = None,
    network_type: _builtins.str | None = None,
    package_type: _builtins.str | None = None,
    real_server_region: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getCheckProxyCreate:getCheckProxyCreate",
        __args__,
        opts=opts,
        typ=GetCheckProxyCreateResult,
    ).value
...
def get_check_proxy_create_output(
    ...
    return __ret__.apply(
        lambda __response__: GetCheckProxyCreateResult(
