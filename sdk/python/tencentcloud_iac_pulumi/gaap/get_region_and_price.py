...
class GetRegionAndPriceResult:
    ...
    def __init__(
        __self__,
        bandwidth_unit_prices=None,
        currency=None,
        dest_region_sets=None,
        id=None,
    ...
    def bandwidth_unit_prices(
        self,
    ) -> Sequence["outputs.GetRegionAndPriceBandwidthUnitPriceResult"]:
        """
    ...
    def dest_region_sets(
        self,
    ) -> Sequence["outputs.GetRegionAndPriceDestRegionSetResult"]:
        """
...
def get_region_and_price(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getRegionAndPrice:getRegionAndPrice",
        __args__,
        opts=opts,
        typ=GetRegionAndPriceResult,
    ).value
...
def get_region_and_price_output(
...
) -> pulumi.Output[GetRegionAndPriceResult]:
    """
    Use this data source to query detailed information of gaap region and price
    ...
    return __ret__.apply(
        lambda __response__: GetRegionAndPriceResult(
