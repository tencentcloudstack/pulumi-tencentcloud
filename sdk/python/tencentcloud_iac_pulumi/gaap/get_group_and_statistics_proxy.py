...
def get_group_and_statistics_proxy(project_id: Optional[_builtins.int] = None,
...
def get_group_and_statistics_proxy_output(project_id: Optional[pulumi.Input[_builtins.int]] = None,
                                          result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGroupAndStatisticsProxyResult]:
    """
    Use this data source to query detailed information of gaap and statistics proxy
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Gaap/getGroupAndStatisticsProxy:getGroupAndStatisticsProxy', __args__, opts=opts, typ=GetGroupAndStatisticsProxyResult)
    return __ret__.apply(lambda __response__: GetGroupAndStatisticsProxyResult(
