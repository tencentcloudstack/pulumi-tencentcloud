...
class GetProxiesStatusResult:
    ...
    def instance_status_sets(
        self,
    ) -> Sequence["outputs.GetProxiesStatusInstanceStatusSetResult"]:
        """
        Proxy status list.
        """
    ...
    def proxy_ids(self) -> Sequence[_builtins.str] | None:
...
def get_proxies_status(
    proxy_ids: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getProxiesStatus:getProxiesStatus",
        __args__,
        opts=opts,
        typ=GetProxiesStatusResult,
    ).value
...
def get_proxies_status_output(
    proxy_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetProxiesStatusResult]:
    """
    Use this data source to query detailed information of gaap proxies status
    ...
    return __ret__.apply(
        lambda __response__: GetProxiesStatusResult(
