...
class GetRealServersStatusResult:
    ...
    def __init__(
        __self__,
        id=None,
        real_server_ids=None,
        real_server_status_sets=None,
    ...
    def real_server_status_sets(
        self,
    ) -> Sequence["outputs.GetRealServersStatusRealServerStatusSetResult"]:
        """
...
def get_real_servers_status(
    real_server_ids: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getRealServersStatus:getRealServersStatus",
        __args__,
        opts=opts,
        typ=GetRealServersStatusResult,
    ).value
...
def get_real_servers_status_output(
    real_server_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetRealServersStatusResult]:
    """
    Use this data source to query detailed information of gaap real servers status
    ...
    return __ret__.apply(
        lambda __response__: GetRealServersStatusResult(
