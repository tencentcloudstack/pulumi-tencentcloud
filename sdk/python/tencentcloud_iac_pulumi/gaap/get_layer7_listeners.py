...
def get_layer7_listeners(group_id: Optional[_builtins.str] = None,
...
def get_layer7_listeners_output(group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLayer7ListenersResult]:
    """
    Use this data source to query gaap layer7 listeners.
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Gaap/getLayer7Listeners:getLayer7Listeners', __args__, opts=opts, typ=GetLayer7ListenersResult)
    return __ret__.apply(lambda __response__: GetLayer7ListenersResult(
