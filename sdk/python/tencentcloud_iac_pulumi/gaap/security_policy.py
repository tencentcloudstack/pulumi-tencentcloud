...
__all__ = ["SecurityPolicy", "SecurityPolicyArgs"]
...
class SecurityPolicyArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] action: Default policy. Valid value: `ACCEPT` and `DROP`.
        :param pulumi.Input[_builtins.str] proxy_id: ID of the GAAP proxy.
        :param pulumi.Input[_builtins.bool] enable: Indicates whether policy is enable, default value is `true`.
        """
...
@pulumi.type_token("tencentcloud:Gaap/securityPolicy:SecurityPolicy")
class SecurityPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SecurityPolicyArgs, pulumi.ResourceOptions, *args, **kwargs
        )
