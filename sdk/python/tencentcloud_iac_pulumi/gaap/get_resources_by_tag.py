...
def get_resources_by_tag(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getResourcesByTag:getResourcesByTag",
        __args__,
        opts=opts,
        typ=GetResourcesByTagResult,
    ).value
...
def get_resources_by_tag_output(
...
) -> pulumi.Output[GetResourcesByTagResult]:
    """
    Use this data source to query detailed information of gaap resources by tag
    ...
    return __ret__.apply(
        lambda __response__: GetResourcesByTagResult(
