...
class GetRuleRealServersResult:
    ...
    def bind_real_server_sets(
        self,
    ) -> Sequence["outputs.GetRuleRealServersBindRealServerSetResult"]:
        """
    ...
    def real_server_sets(
        self,
    ) -> Sequence["outputs.GetRuleRealServersRealServerSetResult"]:
        """
        Real Server Set.
        """
...
def get_rule_real_servers(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Gaap/getRuleRealServers:getRuleRealServers",
        __args__,
        opts=opts,
        typ=GetRuleRealServersResult,
    ).value
...
def get_rule_real_servers_output(
...
) -> pulumi.Output[GetRuleRealServersResult]:
    """
    Use this data source to query detailed information of gaap rule real servers
    ...
    return __ret__.apply(
        lambda __response__: GetRuleRealServersResult(
