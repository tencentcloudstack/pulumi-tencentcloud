...
class GetRecordsResult:
    ...
    def record_line(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "record_line")

    @_builtins.property
    @pulumi.getter(name="recordLineId")
    def record_line_id(self) -> Optional[_builtins.str]:
...
def get_records(domain: Optional[_builtins.str] = None,
                ...
                record_line: Optional[_builtins.str] = None,
                record_line_id: Optional[_builtins.str] = None,
...
def get_records_output(domain: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       ...
                       record_line: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       record_line_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dnspod/getRecords:getRecords', __args__, opts=opts, typ=GetRecordsResult)
