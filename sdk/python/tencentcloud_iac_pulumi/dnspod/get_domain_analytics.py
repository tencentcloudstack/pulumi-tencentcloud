...
def get_domain_analytics(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dnspod/getDomainAnalytics:getDomainAnalytics",
        __args__,
        opts=opts,
        typ=GetDomainAnalyticsResult,
    ).value
...
def get_domain_analytics_output(
...
) -> pulumi.Output[GetDomainAnalyticsResult]:
    """
    Use this data source to query detailed information of dnspod domain_analytics
    ...
    return __ret__.apply(
        lambda __response__: GetDomainAnalyticsResult(
