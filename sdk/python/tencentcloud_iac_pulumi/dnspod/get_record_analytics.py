...
class GetRecordAnalyticsResult:
    ...
    def dns_format(self) -> _builtins.str | None:
        """
...
def get_record_analytics(
    dns_format: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dnspod/getRecordAnalytics:getRecordAnalytics",
        __args__,
        opts=opts,
        typ=GetRecordAnalyticsResult,
    ).value
...
def get_record_analytics_output(
    dns_format: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetRecordAnalyticsResult]:
    """
    Use this data source to query detailed information of dnspod record_analytics
    ...
    return __ret__.apply(
        lambda __response__: GetRecordAnalyticsResult(
