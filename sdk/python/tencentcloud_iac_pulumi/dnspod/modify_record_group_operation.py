...
__all__ = ["ModifyRecordGroupOperation", "ModifyRecordGroupOperationArgs"]
...
class ModifyRecordGroupOperationArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] group_id: Record Group ID.
        :param pulumi.Input[_builtins.str] record_id: Record ID, multiple IDs are separated by a vertical line |.
...
class ModifyRecordGroupOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        modify_record_group = tencentcloud.dnspod.ModifyRecordGroupOperation("modify_record_group",
            domain="dnspod.cn",
            group_id=1,
            record_id="234|345",
            domain_id=123)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ModifyRecordGroupOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ModifyRecordGroupOperationArgs.__new__(
                ModifyRecordGroupOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _ModifyRecordGroupOperationState.__new__(
            _ModifyRecordGroupOperationState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="domainId")
    def domain_id(self) -> pulumi.Output[_builtins.int | None]:
        """
        Domain ID. The parameter DomainId has a higher priority than the parameter Domain. If the parameter DomainId is passed, the parameter Domain will be ignored. You can find all Domains and DomainIds through the DescribeDomainList interface.
        """
        return pulumi.get(self, "domain_id")
