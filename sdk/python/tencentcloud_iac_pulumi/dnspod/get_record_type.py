...
class GetRecordTypeResult:
    ...
    def type_lists(self) -> Sequence[_builtins.str]:
        """
        Record type list.
        """
...
def get_record_type(domain_grade: Optional[_builtins.str] = None,
...
def get_record_type_output(domain_grade: Optional[pulumi.Input[_builtins.str]] = None,
                           result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRecordTypeResult]:
    """
    Use this data source to query detailed information of dnspod record_type
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dnspod/getRecordType:getRecordType', __args__, opts=opts, typ=GetRecordTypeResult)
    return __ret__.apply(lambda __response__: GetRecordTypeResult(
        domain_grade=pulumi.get(__response__, 'domain_grade'),
        id=pulumi.get(__response__, 'id'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        type_lists=pulumi.get(__response__, 'type_lists')))
