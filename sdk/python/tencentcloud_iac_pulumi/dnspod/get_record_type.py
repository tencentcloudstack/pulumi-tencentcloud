...
class GetRecordTypeResult:
    ...
    def __init__(
        __self__, domain_grade=None, id=None, result_output_file=None, type_lists=None
    ):
...
def get_record_type(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dnspod/getRecordType:getRecordType",
        __args__,
        opts=opts,
        typ=GetRecordTypeResult,
    ).value
...
def get_record_type_output(
...
) -> pulumi.Output[GetRecordTypeResult]:
    """
    Use this data source to query detailed information of dnspod record_type
    ...
    return __ret__.apply(
        lambda __response__: GetRecordTypeResult(
