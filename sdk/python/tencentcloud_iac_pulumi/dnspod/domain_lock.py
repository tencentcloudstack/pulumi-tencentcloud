...
__all__ = ["DomainLock", "DomainLockArgs"]
...
class DomainLockArgs:
    def __init__(
        ...
        *,
        ...
        lock_days: pulumi.Input[_builtins.int]
    ):
        """
        The set of arguments for constructing a DomainLock resource.

        :param pulumi.Input[_builtins.str] domain: Domain name.
        :param pulumi.Input[_builtins.int] lock_days: The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60 days, D_ULTRA 365 days+ New packages: DP_FREE 365 days, DP_PLUS 365 days, DP_EXTRA 365 days, DP_EXPERT 365 days, DP_ULTRA 365 days.
        """
    ...
    def lock_days(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @lock_days.setter
    def lock_days(self, value: pulumi.Input[_builtins.int]):
...
class _DomainLockState:
    def __init__(
        ...
        *,
        ...
        lock_code: pulumi.Input[_builtins.str | None] = None,
        lock_days: pulumi.Input[_builtins.int | None] = None
    ):
        """
        Input properties used for looking up and filtering DomainLock resources.

        :param pulumi.Input[_builtins.str] domain: Domain name.
        :param pulumi.Input[_builtins.str] lock_code: Domain unlock code, can be obtained through the ModifyDomainLock interface.
        :param pulumi.Input[_builtins.int] lock_days: The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60 days, D_ULTRA 365 days+ New packages: DP_FREE 365 days, DP_PLUS 365 days, DP_EXTRA 365 days, DP_EXPERT 365 days, DP_ULTRA 365 days.
        """
    ...
    def lock_code(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @lock_code.setter
    def lock_code(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "lock_code", value)

    @_builtins.property
    @pulumi.getter(name="lockDays")
    def lock_days(self) -> pulumi.Input[_builtins.int | None]:
        """
        The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60 days, D_ULTRA 365 days+ New packages: DP_FREE 365 days, DP_PLUS 365 days, DP_EXTRA 365 days, DP_EXPERT 365 days, DP_ULTRA 365 days.
        """
        return pulumi.get(self, "lock_days")
    ...
    @lock_days.setter
    def lock_days(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "lock_days", value)


@pulumi.type_token("tencentcloud:Dnspod/domainLock:DomainLock")
class DomainLock(pulumi.CustomResource):
    ...
    def __init__(
        ...
        domain_lock = tencentcloud.dnspod.DomainLock("domain_lock",
            domain="dnspod.cn",
            lock_days=30)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DomainLockArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dnspod/domainLock:DomainLock", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="lockCode")
    def lock_code(self) -> pulumi.Output[_builtins.str]:
        """
        Domain unlock code, can be obtained through the ModifyDomainLock interface.
        """
        return pulumi.get(self, "lock_code")
    ...
    @_builtins.property
    @pulumi.getter(name="lockDays")
    def lock_days(self) -> pulumi.Output[_builtins.int]:
        """
        The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60 days, D_ULTRA 365 days+ New packages: DP_FREE 365 days, DP_PLUS 365 days, DP_EXTRA 365 days, DP_EXPERT 365 days, DP_ULTRA 365 days.
        """
        return pulumi.get(self, "lock_days")
