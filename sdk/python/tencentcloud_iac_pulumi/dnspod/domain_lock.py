...
class _DomainLockState:
    def __init__(__self__, *,
                 ...
                 lock_code: pulumi.Input[Optional[_builtins.str]] = None,
                 lock_days: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def lock_code(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @lock_code.setter
    def lock_code(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "lock_code", value)

    @_builtins.property
    @pulumi.getter(name="lockDays")
    def lock_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of max days to lock the domain+ Old packages: D_FREE 30 days, D_PLUS 90 days, D_EXTRA 30 days, D_EXPERT 60 days, D_ULTRA 365 days+ New packages: DP_FREE 365 days, DP_PLUS 365 days, DP_EXTRA 365 days, DP_EXPERT 365 days, DP_ULTRA 365 days.
        """
        return pulumi.get(self, "lock_days")
    ...
    @lock_days.setter
    def lock_days(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "lock_days", value)
...
class DomainLock(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            domain: pulumi.Input[Optional[_builtins.str]] = None,
            lock_code: pulumi.Input[Optional[_builtins.str]] = None,
            lock_days: pulumi.Input[Optional[_builtins.int]] = None) -> 'DomainLock':
        """
