...
class GetRecordLineListResult:
    ...
    def line_group_lists(
        self,
    ) -> Sequence["outputs.GetRecordLineListLineGroupListResult"]:
        """
        Line group list.
        """
...
def get_record_line_list(
    domain: _builtins.str | None = None,
    domain_grade: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dnspod/getRecordLineList:getRecordLineList",
        __args__,
        opts=opts,
        typ=GetRecordLineListResult,
    ).value
...
def get_record_line_list_output(
    domain: pulumi.Input[_builtins.str | None] = None,
    domain_grade: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetRecordLineListResult]:
    """
    Use this data source to query detailed information of dnspod record_line_list
    ...
    return __ret__.apply(
        lambda __response__: GetRecordLineListResult(
