...
def get_domain_log_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dnspod/getDomainLogList:getDomainLogList",
        __args__,
        opts=opts,
        typ=GetDomainLogListResult,
    ).value
...
def get_domain_log_list_output(
...
) -> pulumi.Output[GetDomainLogListResult]:
    """
    Use this data source to query detailed information of dnspod domain_log_list
    ...
    return __ret__.apply(
        lambda __response__: GetDomainLogListResult(
