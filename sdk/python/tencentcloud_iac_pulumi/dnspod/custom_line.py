...
__all__ = ["CustomLine", "CustomLineArgs"]
...
class CustomLine(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CustomLineArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Dnspod/customLine:CustomLine", resource_name, __props__, opts
        )
