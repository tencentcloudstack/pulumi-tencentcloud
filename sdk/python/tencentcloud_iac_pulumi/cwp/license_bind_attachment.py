...
__all__ = ["LicenseBindAttachment", "LicenseBindAttachmentArgs"]
...
class LicenseBindAttachmentArgs:
    def __init__(
        __self__,
        *,
        license_id: pulumi.Input[_builtins.int],
        license_type: pulumi.Input[_builtins.int],
        quuid: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] quuid: Machine quota that needs to be bound.
    ...
    def license_type(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @license_type.setter
    def license_type(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "license_type", value)

    @_builtins.property
    @pulumi.getter
    def quuid(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @quuid.setter
    def quuid(self, value: pulumi.Input[_builtins.str]):
...
class _LicenseBindAttachmentState:
    def __init__(
        __self__,
        *,
        agent_status: pulumi.Input[_builtins.str | None] = None,
        is_switch_bind: pulumi.Input[_builtins.bool | None] = None,
        is_unbind: pulumi.Input[_builtins.bool | None] = None,
        license_id: pulumi.Input[_builtins.int | None] = None,
        license_type: pulumi.Input[_builtins.int | None] = None,
        machine_ip: pulumi.Input[_builtins.str | None] = None,
        machine_name: pulumi.Input[_builtins.str | None] = None,
        machine_wan_ip: pulumi.Input[_builtins.str | None] = None,
        quuid: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.str] agent_status: agent status.
        :param pulumi.Input[_builtins.bool] is_switch_bind: Is it allowed to change the binding, false is not allowed to change the binding.
        :param pulumi.Input[_builtins.bool] is_unbind: Allow unbinding, false does not allow unbinding.
        :param pulumi.Input[_builtins.int] license_id: License ID.
        :param pulumi.Input[_builtins.int] license_type: LicenseType, 0 CWP Pro - Pay as you go, 1 CWP Pro - Monthly subscription, 2 CWP Ultimate - Monthly subscription. Default is 0.
        :param pulumi.Input[_builtins.str] machine_ip: machine ip.
        :param pulumi.Input[_builtins.str] machine_name: machine name.
        :param pulumi.Input[_builtins.str] machine_wan_ip: machine wan ip.
        :param pulumi.Input[_builtins.str] quuid: Machine quota that needs to be bound.
        :param pulumi.Input[_builtins.str] resource_id: Resource ID.
        :param pulumi.Input[_builtins.str] uuid: uuid.
        """
    ...
    def agent_status(self) -> pulumi.Input[_builtins.str | None]:
        """
        agent status.
        """
    ...
    @agent_status.setter
    def agent_status(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "agent_status", value)

    @_builtins.property
    @pulumi.getter(name="isSwitchBind")
    def is_switch_bind(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    def is_switch_bind(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "is_switch_bind", value)

    @_builtins.property
    @pulumi.getter(name="isUnbind")
    def is_unbind(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    @is_unbind.setter
    def is_unbind(self, value: pulumi.Input[_builtins.bool | None]):
    ...
    def machine_ip(self) -> pulumi.Input[_builtins.str | None]:
        """
        machine ip.
        """
    ...
    @machine_ip.setter
    def machine_ip(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "machine_ip", value)

    @_builtins.property
    @pulumi.getter(name="machineName")
    def machine_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        machine name.
        """
    ...
    def machine_wan_ip(self) -> pulumi.Input[_builtins.str | None]:
        """
        machine wan ip.
        """
    ...
    def machine_wan_ip(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "machine_wan_ip", value)

    @_builtins.property
    @pulumi.getter
    def quuid(self) -> pulumi.Input[_builtins.str | None]:
        """
        Machine quota that needs to be bound.
        """
        return pulumi.get(self, "quuid")
    ...
    @quuid.setter
    def quuid(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "quuid", value)
...
@pulumi.type_token("tencentcloud:Cwp/licenseBindAttachment:LicenseBindAttachment")
class LicenseBindAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_license_order = tencentcloud.cwp.LicenseOrder("example",
            alias="tf_example",
            license_type=0,
            license_num=1,
            region_id=1,
        ...
        example_license_bind_attachment = tencentcloud.cwp.LicenseBindAttachment("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            LicenseBindAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="isSwitchBind")
    def is_switch_bind(self) -> pulumi.Output[_builtins.bool]:
        """
        Is it allowed to change the binding, false is not allowed to change the binding.
        """
        return pulumi.get(self, "is_switch_bind")
    ...
    @_builtins.property
    @pulumi.getter(name="isUnbind")
    def is_unbind(self) -> pulumi.Output[_builtins.bool]:
        """
        Allow unbinding, false does not allow unbinding.
        """
        return pulumi.get(self, "is_unbind")
    ...
    @_builtins.property
    @pulumi.getter(name="licenseType")
    def license_type(self) -> pulumi.Output[_builtins.int]:
        """
        LicenseType, 0 CWP Pro - Pay as you go, 1 CWP Pro - Monthly subscription, 2 CWP Ultimate - Monthly subscription. Default is 0.
        """
        return pulumi.get(self, "license_type")
    ...
    @_builtins.property
    @pulumi.getter(name="machineIp")
    def machine_ip(self) -> pulumi.Output[_builtins.str]:
        """
        machine ip.
        """
        return pulumi.get(self, "machine_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="machineWanIp")
    def machine_wan_ip(self) -> pulumi.Output[_builtins.str]:
        """
        machine wan ip.
        """
        return pulumi.get(self, "machine_wan_ip")
    ...
    @_builtins.property
    @pulumi.getter
    def quuid(self) -> pulumi.Output[_builtins.str]:
        """
        Machine quota that needs to be bound.
        """
        return pulumi.get(self, "quuid")
