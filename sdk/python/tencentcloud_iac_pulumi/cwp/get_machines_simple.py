...
class GetMachinesSimpleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetMachinesSimpleFilterResult"] | None:
...
def get_machines_simple(
    filters: (
        Sequence[
            Union["GetMachinesSimpleFilterArgs", "GetMachinesSimpleFilterArgsDict"]
        ]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cwp/getMachinesSimple:getMachinesSimple",
        __args__,
        opts=opts,
        typ=GetMachinesSimpleResult,
    ).value
...
def get_machines_simple_output(
...
) -> pulumi.Output[GetMachinesSimpleResult]:
    """
    Use this data source to query detailed information of CWP machines simple
    ...
    return __ret__.apply(
        lambda __response__: GetMachinesSimpleResult(
