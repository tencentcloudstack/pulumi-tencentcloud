...
class KafkaRechargeArgs:
    def __init__(__self__, *,
                 ...
                 is_encryption_addr: pulumi.Input[Optional[_builtins.bool]] = None,
                 kafka_instance: pulumi.Input[Optional[_builtins.str]] = None,
                 log_recharge_rule: pulumi.Input[Optional['KafkaRechargeLogRechargeRuleArgs']] = None,
    ...
    def is_encryption_addr(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_encryption_addr(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_encryption_addr", value)

    @_builtins.property
    @pulumi.getter(name="kafkaInstance")
    def kafka_instance(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        CKafka Instance id.
        """
    ...
    def kafka_instance(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "kafka_instance", value)

    @_builtins.property
    @pulumi.getter(name="logRechargeRule")
    def log_recharge_rule(self) -> pulumi.Input[Optional['KafkaRechargeLogRechargeRuleArgs']]:
        """
        log recharge rule.
        """
    ...
    def log_recharge_rule(self, value: pulumi.Input[Optional['KafkaRechargeLogRechargeRuleArgs']]):
...
class _KafkaRechargeState:
    def __init__(__self__, *,
                 ...
                 is_encryption_addr: pulumi.Input[Optional[_builtins.bool]] = None,
                 kafka_instance: pulumi.Input[Optional[_builtins.str]] = None,
                 kafka_type: pulumi.Input[Optional[_builtins.int]] = None,
                 log_recharge_rule: pulumi.Input[Optional['KafkaRechargeLogRechargeRuleArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 user_kafka_topics: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="kafkaType")
    def kafka_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        kafka recharge type, 0 for CKafka, 1 fro user define Kafka.
        """
        return pulumi.get(self, "kafka_type")
    ...
    @kafka_type.setter
    def kafka_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "kafka_type", value)
    ...
    @_builtins.property
    @pulumi.getter(name="userKafkaTopics")
    def user_kafka_topics(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        user need recharge kafka topic list.
        """
        return pulumi.get(self, "user_kafka_topics")
    ...
    @user_kafka_topics.setter
    def user_kafka_topics(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "user_kafka_topics", value)
...
class KafkaRecharge(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kafka_instance: pulumi.Input[Optional[_builtins.str]] = None,
                 kafka_type: pulumi.Input[Optional[_builtins.int]] = None,
                 log_recharge_rule: pulumi.Input[Optional[Union['KafkaRechargeLogRechargeRuleArgs', 'KafkaRechargeLogRechargeRuleArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 offset: pulumi.Input[Optional[_builtins.int]] = None,
                 protocol: pulumi.Input[Optional[Union['KafkaRechargeProtocolArgs', 'KafkaRechargeProtocolArgsDict']]] = None,
                 server_addr: pulumi.Input[Optional[_builtins.str]] = None,
                 topic_id: pulumi.Input[Optional[_builtins.str]] = None,
                 user_kafka_topics: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
    ...
    def get(resource_name: str,
            ...
            server_addr: pulumi.Input[Optional[_builtins.str]] = None,
            topic_id: pulumi.Input[Optional[_builtins.str]] = None,
            user_kafka_topics: pulumi.Input[Optional[_builtins.str]] = None) -> 'KafkaRecharge':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="consumerGroupName")
    def consumer_group_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        user consumer group name.
        """
        return pulumi.get(self, "consumer_group_name")
    ...
    @_builtins.property
    @pulumi.getter(name="kafkaInstance")
    def kafka_instance(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        CKafka Instance id.
        """
        return pulumi.get(self, "kafka_instance")
