...
__all__ = ["CloudProductLogTask", "CloudProductLogTaskArgs"]
...
class CloudProductLogTaskArgs:
    def __init__(
        ...
        *,
        ...
        extend: pulumi.Input[str] | None = None,
        logset_name: pulumi.Input[str] | None = None,
        topic_name: pulumi.Input[str] | None = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def extend(self) -> pulumi.Input[str] | None:
        """
    ...
    @extend.setter
    def extend(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "extend", value)

    @property
    @pulumi.getter(name="logsetName")
    def logset_name(self) -> pulumi.Input[str] | None:
        """
    ...
    @logset_name.setter
    def logset_name(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "logset_name", value)

    @property
    @pulumi.getter(name="topicName")
    def topic_name(self) -> pulumi.Input[str] | None:
        """
    ...
    @topic_name.setter
    def topic_name(self, value: pulumi.Input[str] | None):
...
class _CloudProductLogTaskState:
    def __init__(
        __self__,
        *,
        assumer_name: pulumi.Input[str] | None = None,
        cloud_product_region: pulumi.Input[str] | None = None,
        cls_region: pulumi.Input[str] | None = None,
        extend: pulumi.Input[str] | None = None,
        instance_id: pulumi.Input[str] | None = None,
        log_type: pulumi.Input[str] | None = None,
        logset_id: pulumi.Input[str] | None = None,
        logset_name: pulumi.Input[str] | None = None,
        topic_id: pulumi.Input[str] | None = None,
        topic_name: pulumi.Input[str] | None = None
    ):
        """
    ...
    @property
    @pulumi.getter(name="assumerName")
    def assumer_name(self) -> pulumi.Input[str] | None:
        """
        Cloud product identification, Values: CDS, CWP, CDB, TDSQL-C, MongoDB, TDStore, DCDB, MariaDB, PostgreSQL, BH, APIS.
        """
        return pulumi.get(self, "assumer_name")
    ...
    @assumer_name.setter
    def assumer_name(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "assumer_name", value)

    @property
    @pulumi.getter(name="cloudProductRegion")
    def cloud_product_region(self) -> pulumi.Input[str] | None:
        """
        Cloud product region. There are differences in the input format of different log types in different regions. Please refer to the following example:
        - CDS(all log type): ap-guangzhou
        - CDB-AUDIT: gz
    ...
    @cloud_product_region.setter
    def cloud_product_region(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "cloud_product_region", value)

    @property
    @pulumi.getter(name="clsRegion")
    def cls_region(self) -> pulumi.Input[str] | None:
        """
        CLS target region.
        """
        return pulumi.get(self, "cls_region")
    ...
    @cls_region.setter
    def cls_region(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "cls_region", value)
    ...
    @property
    @pulumi.getter(name="logType")
    def log_type(self) -> pulumi.Input[str] | None:
        """
        Log type, Values: CDS-AUDIT, CDS-RISK, CDB-AUDIT, TDSQL-C-AUDIT, MongoDB-AUDIT, MongoDB-SlowLog, MongoDB-ErrorLog, TDMYSQL-SLOW, DCDB-AUDIT, DCDB-SLOW, DCDB-ERROR, MariaDB-AUDIT, MariaDB-SLOW, MariaDB-ERROR, PostgreSQL-SLOW, PostgreSQL-ERROR, PostgreSQL-AUDIT, BH-FILELOG, BH-COMMANDLOG, APIS-ACCESS.
        """
        return pulumi.get(self, "log_type")
    ...
    @log_type.setter
    def log_type(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "log_type", value)

    @property
    @pulumi.getter(name="logsetId")
    def logset_id(self) -> pulumi.Input[str] | None:
        """
        Log set ID.
        """
    ...
    @logset_id.setter
    def logset_id(self, value: pulumi.Input[str] | None):
    ...
    def topic_id(self) -> pulumi.Input[str] | None:
        """
        Log theme ID.
        """
    ...
    @topic_id.setter
    def topic_id(self, value: pulumi.Input[str] | None):
...
class CloudProductLogTask(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CloudProductLogTaskArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @property
    @pulumi.getter
    def extend(self) -> pulumi.Output[str | None]:
        """
        Log configuration extension information, generally used to store additional log delivery configurations.
        """
        return pulumi.get(self, "extend")
    ...
    @property
    @pulumi.getter(name="logsetName")
    def logset_name(self) -> pulumi.Output[str | None]:
        """
        Log set name, it will be automatically created.
        """
        return pulumi.get(self, "logset_name")
    ...
    @property
    @pulumi.getter(name="topicName")
    def topic_name(self) -> pulumi.Output[str | None]:
        """
        The name of the log topic, it will be automatically created.
        """
        return pulumi.get(self, "topic_name")
