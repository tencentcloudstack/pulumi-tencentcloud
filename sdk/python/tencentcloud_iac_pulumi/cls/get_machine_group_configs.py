...
class GetMachineGroupConfigsResult:
    ...
    def __init__(
        __self__, configs=None, group_id=None, id=None, result_output_file=None
    ):
...
def get_machine_group_configs(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cls/getMachineGroupConfigs:getMachineGroupConfigs",
        __args__,
        opts=opts,
        typ=GetMachineGroupConfigsResult,
    ).value
...
def get_machine_group_configs_output(
...
) -> pulumi.Output[GetMachineGroupConfigsResult]:
    """
    Use this data source to query detailed information of cls machine_group_configs
    ...
    return __ret__.apply(
        lambda __response__: GetMachineGroupConfigsResult(
