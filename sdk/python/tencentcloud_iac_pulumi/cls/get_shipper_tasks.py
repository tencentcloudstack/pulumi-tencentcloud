...
def get_shipper_tasks(
    ...
    shipper_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cls/getShipperTasks:getShipperTasks",
        __args__,
        opts=opts,
        typ=GetShipperTasksResult,
    ).value
...
def get_shipper_tasks_output(
    ...
    return __ret__.apply(
        lambda __response__: GetShipperTasksResult(
