...
class TopicArgs:
    def __init__(__self__, *,
                 ...
                 describes: Optional[pulumi.Input[_builtins.str]] = None,
                 extends: Optional[pulumi.Input['TopicExtendsArgs']] = None,
                 hot_period: Optional[pulumi.Input[_builtins.int]] = None,
                 is_web_tracking: Optional[pulumi.Input[_builtins.bool]] = None,
                 max_split_partitions: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.int] hot_period: 0: Turn off log sinking. Non 0: The number of days of standard storage after enabling log settling. HotPeriod needs to be greater than or equal to 7 and less than Period. Only effective when StorageType is hot.
        :param pulumi.Input[_builtins.bool] is_web_tracking: No authentication switch. False: closed; True: Enable. The default is false. After activation, anonymous access to the log topic will be supported for specified operations.
        :param pulumi.Input[_builtins.int] max_split_partitions: Maximum number of partitions to split into for this topic if automatic split is enabled. Default value: 50.
        :param pulumi.Input[_builtins.int] partition_count: Number of log topic partitions. Default value: 1. Maximum value: 10.
        :param pulumi.Input[_builtins.int] period: lifetime. Unit: days. Standard storage value range: 1 to 3600. Infrequent storage value range: 7 to 3600 days. A value of 3640 indicates permanent retention.If this value is not input, it defaults to the Period value of the log set corresponding to the accessed log topic (defaults to 30 days in case of access failure).
        :param pulumi.Input[_builtins.str] storage_type: Log topic storage class. Valid values: hot: real-time storage; cold: offline storage. Default value: hot. If cold is passed in, please contact the customer service to add the log topic to the allowlist first.
    ...
    @_builtins.property
    @pulumi.getter
    def describes(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @describes.setter
    def describes(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def hot_period(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    @hot_period.setter
    def hot_period(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "hot_period", value)

    @_builtins.property
    @pulumi.getter(name="isWebTracking")
    def is_web_tracking(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def is_web_tracking(self, value: Optional[pulumi.Input[_builtins.bool]]):
        pulumi.set(self, "is_web_tracking", value)

    @_builtins.property
    @pulumi.getter(name="maxSplitPartitions")
    def max_split_partitions(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
    ...
    def max_split_partitions(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class Topic(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_split: Optional[pulumi.Input[_builtins.bool]] = None,
                 describes: Optional[pulumi.Input[_builtins.str]] = None,
                 extends: Optional[pulumi.Input[Union['TopicExtendsArgs', 'TopicExtendsArgsDict']]] = None,
                 hot_period: Optional[pulumi.Input[_builtins.int]] = None,
                 is_web_tracking: Optional[pulumi.Input[_builtins.bool]] = None,
                 logset_id: Optional[pulumi.Input[_builtins.str]] = None,
                 max_split_partitions: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.bool] auto_split: Whether to enable automatic split. Default value: true.
        :param pulumi.Input[_builtins.str] describes: Log Topic Description.
        :param pulumi.Input[Union['TopicExtendsArgs', 'TopicExtendsArgsDict']] extends: Log Subject Extension Information.
        :param pulumi.Input[_builtins.int] hot_period: 0: Turn off log sinking. Non 0: The number of days of standard storage after enabling log settling. HotPeriod needs to be greater than or equal to 7 and less than Period. Only effective when StorageType is hot.
        :param pulumi.Input[_builtins.bool] is_web_tracking: No authentication switch. False: closed; True: Enable. The default is false. After activation, anonymous access to the log topic will be supported for specified operations.
        :param pulumi.Input[_builtins.str] logset_id: Logset ID.
        :param pulumi.Input[_builtins.int] max_split_partitions: Maximum number of partitions to split into for this topic if automatic split is enabled. Default value: 50.
