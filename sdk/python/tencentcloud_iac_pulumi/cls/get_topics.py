...
class GetTopicsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetTopicsFilterResult"] | None:
    ...
    def precise_search(self) -> _builtins.int | None:
...
def get_topics(
    ...
    filters: (
        Sequence[Union["GetTopicsFilterArgs", "GetTopicsFilterArgsDict"]] | None
    ) = None,
    precise_search: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cls/getTopics:getTopics", __args__, opts=opts, typ=GetTopicsResult
    ).value
...
def get_topics_output(
    ...
    return __ret__.apply(
        lambda __response__: GetTopicsResult(
