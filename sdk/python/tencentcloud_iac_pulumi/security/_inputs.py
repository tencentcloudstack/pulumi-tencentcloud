...
class GroupRuleSetEgressArgsDict(TypedDict):
    ...
    """
    address_template_group: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    address_template_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    policy_index: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    service_template_group: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Specify Group ID of Protocol template ID like `ppmg-xxxxxxxx`, conflict with `protocol` and `port`.
    """
    service_template_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Specify Protocol template ID like `ppm-xxxxxxxx`, conflict with `protocol` and `port`.
    """
    source_security_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class GroupRuleSetEgressArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[_builtins.str],
                 address_template_group: pulumi.Input[Optional[_builtins.str]] = None,
                 address_template_id: pulumi.Input[Optional[_builtins.str]] = None,
                 cidr_block: pulumi.Input[Optional[_builtins.str]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 ipv6_cidr_block: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_index: pulumi.Input[Optional[_builtins.int]] = None,
                 port: pulumi.Input[Optional[_builtins.str]] = None,
                 protocol: pulumi.Input[Optional[_builtins.str]] = None,
                 service_template_group: pulumi.Input[Optional[_builtins.str]] = None,
                 service_template_id: pulumi.Input[Optional[_builtins.str]] = None,
                 source_security_id: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def address_template_group(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specify Group ID of Address template like `ipmg-xxxxxxxx`, conflict with `source_security_id` and `cidr_block`. NOTE: One of `cidr_block`, `ipv6_cidr_block`, `source_security_id` and `address_template_*` must be set.
        """
    ...
    def address_template_group(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "address_template_group", value)

    @_builtins.property
    @pulumi.getter(name="addressTemplateId")
    def address_template_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specify Address template ID like `ipm-xxxxxxxx`, conflict with `source_security_id` and `cidr_block`. NOTE: One of `cidr_block`, `ipv6_cidr_block`, `source_security_id` and `address_template_*` must be set.
        """
    ...
    def address_template_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def policy_index(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The security group rule index number, whose value dynamically changes with changes in security group rules.
        """
    ...
    @policy_index.setter
    def policy_index(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def service_template_group(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specify Group ID of Protocol template ID like `ppmg-xxxxxxxx`, conflict with `protocol` and `port`.
        """
    ...
    def service_template_group(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "service_template_group", value)

    @_builtins.property
    @pulumi.getter(name="serviceTemplateId")
    def service_template_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specify Protocol template ID like `ppm-xxxxxxxx`, conflict with `protocol` and `port`.
        """
    ...
    def service_template_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "service_template_id", value)

    @_builtins.property
    @pulumi.getter(name="sourceSecurityId")
    def source_security_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ID of the nested security group, and conflicts with `cidr_block` and `address_template_*`. NOTE: One of `cidr_block`, `ipv6_cidr_block`, `source_security_id` and `address_template_*` must be set.
        """
    ...
    def source_security_id(self, value: pulumi.Input[Optional[_builtins.str]]):
