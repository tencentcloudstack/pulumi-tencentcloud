...
class ImmutableTagRuleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str ns_name: namespace name.
        """
...
class InstanceReplication(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str region_name: Replication region name.
...
class InstanceSecurityPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int index: Index of policy.
        :param str version: Version of policy.
        """
...
class ServiceAccountPermission(dict):
    def __init__(__self__, *,
                 ...
                 resource: str):
        """
        :param Sequence[str] actions: Actions, currently support: `tcr:PushRepository`, `tcr:PullRepository`, `tcr:CreateRepository`, `tcr:CreateHelmChart`, `tcr:DescribeHelmCharts`. Note: This field may return null, indicating that no valid value can be obtained.
