...
def get_tag_retention_execution_tasks(execution_id: Optional[_builtins.int] = None,
...
def get_tag_retention_execution_tasks_output(execution_id: Optional[pulumi.Input[_builtins.int]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTagRetentionExecutionTasksResult]:
    """
    Use this data source to query detailed information of tcr tag_retention_execution_tasks
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tcr/getTagRetentionExecutionTasks:getTagRetentionExecutionTasks', __args__, opts=opts, typ=GetTagRetentionExecutionTasksResult)
    return __ret__.apply(lambda __response__: GetTagRetentionExecutionTasksResult(
