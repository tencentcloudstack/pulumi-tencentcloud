...
class GetTagRetentionExecutionsResult:
    ...
    def __init__(
        ...
        retention_execution_lists=None,
        retention_id=None,
    ):
        ...
        if retention_execution_lists and not isinstance(
            retention_execution_lists, list
        ):
            raise TypeError(
                "Expected argument 'retention_execution_lists' to be a list"
            )
    ...
    def retention_execution_lists(
        self,
    ) -> Sequence["outputs.GetTagRetentionExecutionsRetentionExecutionListResult"]:
        """
...
def get_tag_retention_executions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tcr/getTagRetentionExecutions:getTagRetentionExecutions",
        __args__,
        opts=opts,
        typ=GetTagRetentionExecutionsResult,
    ).value
...
def get_tag_retention_executions_output(
...
) -> pulumi.Output[GetTagRetentionExecutionsResult]:
    """
    Use this data source to query detailed information of tcr tag_retention_executions
    ...
    return __ret__.apply(
        lambda __response__: GetTagRetentionExecutionsResult(
            id=pulumi.get(__response__, "id"),
            registry_id=pulumi.get(__response__, "registry_id"),
            result_output_file=pulumi.get(__response__, "result_output_file"),
            retention_execution_lists=pulumi.get(
                __response__, "retention_execution_lists"
            ),
