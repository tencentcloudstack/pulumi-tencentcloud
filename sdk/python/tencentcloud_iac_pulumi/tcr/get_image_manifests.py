...
def get_image_manifests(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tcr/getImageManifests:getImageManifests",
        __args__,
        opts=opts,
        typ=GetImageManifestsResult,
    ).value
...
def get_image_manifests_output(
...
) -> pulumi.Output[GetImageManifestsResult]:
    """
    Use this data source to query detailed information of tcr image_manifests
    ...
    return __ret__.apply(
        lambda __response__: GetImageManifestsResult(
