...
class GetReplicationInstanceSyncStatusResult:
    ...
    def __init__(
        ...
        id=None,
        registry_id=None,
        replication_logs=None,
        replication_region_id=None,
        replication_registry_id=None,
        replication_status=None,
        replication_time=None,
        result_output_file=None,
        show_replication_log=None,
    ):
    ...
    def replication_logs(
        self,
    ) -> Sequence["outputs.GetReplicationInstanceSyncStatusReplicationLogResult"]:
        """
    ...
    def replication_region_id(self) -> _builtins.int | None:
    ...
    def show_replication_log(self) -> _builtins.bool | None:
        return pulumi.get(self, "show_replication_log")


class AwaitableGetReplicationInstanceSyncStatusResult(
    GetReplicationInstanceSyncStatusResult
):
...
def get_replication_instance_sync_status(
    registry_id: _builtins.str | None = None,
    replication_region_id: _builtins.int | None = None,
    replication_registry_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    show_replication_log: _builtins.bool | None = None,
    ...
    sync_status = tencentcloud.tcr.get_replication_instance_sync_status(registry_id=src_registry_id,
        ...
        replication_region_id=int(dst_region_id),
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Tcr/getReplicationInstanceSyncStatus:getReplicationInstanceSyncStatus",
        __args__,
        opts=opts,
        typ=GetReplicationInstanceSyncStatusResult,
    ).value
...
def get_replication_instance_sync_status_output(
    registry_id: pulumi.Input[_builtins.str | None] = None,
    replication_region_id: pulumi.Input[_builtins.int | None] = None,
    replication_registry_id: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    show_replication_log: pulumi.Input[_builtins.bool | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetReplicationInstanceSyncStatusResult]:
    """
    Use this data source to query detailed information of tcr replication_instance_sync_status
    ...
    return __ret__.apply(
        lambda __response__: GetReplicationInstanceSyncStatusResult(
