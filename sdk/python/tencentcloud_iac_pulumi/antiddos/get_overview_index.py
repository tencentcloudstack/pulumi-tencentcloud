...
class GetOverviewIndexResult:
    ...
    def __init__(
        __self__,
        all_ip_count=None,
        antiddos_domain_count=None,
        antiddos_ip_count=None,
        attack_domain_count=None,
        attack_ip_count=None,
        block_ip_count=None,
        end_time=None,
        id=None,
        max_attack_flow=None,
        new_attack_ip=None,
        new_attack_time=None,
    ...
    def all_ip_count(self) -> _builtins.int:
        """
        ip count.
        """
    ...
    def antiddos_domain_count(self) -> _builtins.int:
        """
        AntiddosDomainCount.
        """
    ...
    def antiddos_ip_count(self) -> _builtins.int:
        """
    ...
    def attack_domain_count(self) -> _builtins.int:
        """
        AttackDomainCount.
        """
    ...
    def attack_ip_count(self) -> _builtins.int:
        """
        AttackIpCount.
        """
    ...
    def block_ip_count(self) -> _builtins.int:
        """
        BlockIpCount.
        """
    ...
    def max_attack_flow(self) -> _builtins.int:
        """
        MaxAttackFlow.
        """
    ...
    def new_attack_ip(self) -> _builtins.str:
        """
    ...
    def new_attack_time(self) -> _builtins.str:
        """
    ...
    def new_attack_type(self) -> _builtins.str:
        """
...
def get_overview_index(
    ...
    overview_index = tencentcloud.antiddos.get_overview_index(start_time="2023-11-20 12:32:12",
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Antiddos/getOverviewIndex:getOverviewIndex",
        __args__,
        opts=opts,
        typ=GetOverviewIndexResult,
    ).value
...
def get_overview_index_output(
...
) -> pulumi.Output[GetOverviewIndexResult]:
    """
    Use this data source to query detailed information of antiddos overview index
    ...
    return __ret__.apply(
        lambda __response__: GetOverviewIndexResult(
            all_ip_count=pulumi.get(__response__, "all_ip_count"),
            antiddos_domain_count=pulumi.get(__response__, "antiddos_domain_count"),
            antiddos_ip_count=pulumi.get(__response__, "antiddos_ip_count"),
            attack_domain_count=pulumi.get(__response__, "attack_domain_count"),
            attack_ip_count=pulumi.get(__response__, "attack_ip_count"),
            block_ip_count=pulumi.get(__response__, "block_ip_count"),
            end_time=pulumi.get(__response__, "end_time"),
            id=pulumi.get(__response__, "id"),
            max_attack_flow=pulumi.get(__response__, "max_attack_flow"),
            new_attack_ip=pulumi.get(__response__, "new_attack_ip"),
            new_attack_time=pulumi.get(__response__, "new_attack_time"),
            new_attack_type=pulumi.get(__response__, "new_attack_type"),
