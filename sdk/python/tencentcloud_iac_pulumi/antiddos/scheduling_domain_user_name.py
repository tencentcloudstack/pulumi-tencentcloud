...
__all__ = ["SchedulingDomainUserName", "SchedulingDomainUserNameArgs"]
...
class SchedulingDomainUserNameArgs:
    def __init__(
        ...
        *,
        ...
        domain_user_name: pulumi.Input[_builtins.str]
    ):
        """
        The set of arguments for constructing a SchedulingDomainUserName resource.

        :param pulumi.Input[_builtins.str] domain_name: user cname.
        :param pulumi.Input[_builtins.str] domain_user_name: domain name.
        """
    ...
    def domain_user_name(self) -> pulumi.Input[_builtins.str]:
        """
        domain name.
        """
    ...
    def domain_user_name(self, value: pulumi.Input[_builtins.str]):
...
class _SchedulingDomainUserNameState:
    def __init__(
        ...
        *,
        ...
        domain_user_name: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        domain name.
        """
        return pulumi.get(self, "domain_user_name")
    ...
    @domain_user_name.setter
    def domain_user_name(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "domain_user_name", value)
...
class SchedulingDomainUserName(pulumi.CustomResource):
    ...
    def __init__(
        ...
        scheduling_domain_user_name = tencentcloud.antiddos.SchedulingDomainUserName("scheduling_domain_user_name",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SchedulingDomainUserNameArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = SchedulingDomainUserNameArgs.__new__(
                SchedulingDomainUserNameArgs
            )
    ...
    def get(
        ...
        __props__ = _SchedulingDomainUserNameState.__new__(
            _SchedulingDomainUserNameState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="domainUserName")
    def domain_user_name(self) -> pulumi.Output[_builtins.str]:
        """
        domain name.
        """
        return pulumi.get(self, "domain_user_name")
