...
def get_pending_risk_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Antiddos/getPendingRiskInfo:getPendingRiskInfo",
        __args__,
        opts=opts,
        typ=GetPendingRiskInfoResult,
    ).value
...
def get_pending_risk_info_output(
    ...
    return __ret__.apply(
        lambda __response__: GetPendingRiskInfoResult(
