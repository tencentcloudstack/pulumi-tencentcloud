...
class BgpInstanceEnterprisePackageConfigArgsDict(TypedDict):
    ...
    """
    elastic_bandwidth_flag: NotRequired[pulumi.Input[_builtins.bool | None]]
    """
    Whether to enable elastic service bandwidth. The default value is false.
    """
    elastic_protect_bandwidth: NotRequired[pulumi.Input[_builtins.int | None]]
    """
...
class BgpInstanceEnterprisePackageConfigArgs:
    def __init__(
        ...
        *,
        ...
        protect_ip_count: pulumi.Input[_builtins.int],
        region: pulumi.Input[_builtins.str],
        elastic_bandwidth_flag: pulumi.Input[_builtins.bool | None] = None,
        elastic_protect_bandwidth: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def elastic_bandwidth_flag(self) -> pulumi.Input[_builtins.bool | None]:
        """
        Whether to enable elastic service bandwidth. The default value is false.
        """
    ...
    def elastic_bandwidth_flag(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "elastic_bandwidth_flag", value)

    @_builtins.property
    @pulumi.getter(name="elasticProtectBandwidth")
    def elastic_protect_bandwidth(self) -> pulumi.Input[_builtins.int | None]:
        """
        Elastic bandwidth (Gbps), selectable elastic bandwidth [0, 400, 500, 600, 800, 1000], default is 0.
        """
    ...
    def elastic_protect_bandwidth(self, value: pulumi.Input[_builtins.int | None]):
...
class CcBlackWhiteIpBlackWhiteIpArgs:
    def __init__(
        __self__, *, ip: pulumi.Input[_builtins.str], mask: pulumi.Input[_builtins.int]
    ):
        """
...
class DdosSpeedLimitConfigDdosSpeedLimitConfigArgsDict(TypedDict):
    ...
    """
    speed_values: pulumi.Input[
        Sequence[
            pulumi.Input["DdosSpeedLimitConfigDdosSpeedLimitConfigSpeedValueArgsDict"]
        ]
    ]
    """
    ...
    """
    dst_port_list: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    protocol_list: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class DdosSpeedLimitConfigDdosSpeedLimitConfigArgs:
    def __init__(
        ...
        *,
        ...
        speed_values: pulumi.Input[
            Sequence[
                pulumi.Input["DdosSpeedLimitConfigDdosSpeedLimitConfigSpeedValueArgs"]
            ]
        ],
        dst_port_list: pulumi.Input[_builtins.str | None] = None,
        dst_port_scopes: pulumi.Input[
            Sequence[
                pulumi.Input["DdosSpeedLimitConfigDdosSpeedLimitConfigDstPortScopeArgs"]
            ]
            | None
        ] = None,
        protocol_list: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def speed_values(
        ...
        Sequence[pulumi.Input["DdosSpeedLimitConfigDdosSpeedLimitConfigSpeedValueArgs"]]
    ]:
        """
        Speed limit values, each type of speed limit value can support up to 1; This field array has at least one speed limit value.
        """
    ...
    def dst_port_list(self) -> pulumi.Input[_builtins.str | None]:
        """
        List of port ranges, up to 8, multiple; Separate and indicate the range with -; This port range must be filled in; Fill in style 1:0-65535, style 2: 80; 443; 1000-2000.
        """
    ...
    def dst_port_list(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def protocol_list(self) -> pulumi.Input[_builtins.str | None]:
        """
        IP protocol numbers, values [ALL (all protocols) TCP (tcp protocol) UDP (udp protocol) SMP (smp protocol) 1; 2-100 (custom protocol number range, up to 8)] Note: When customizing the protocol number range, only the protocol number can be filled in, multiple ranges; Separation; When filling in ALL, no other agreements or agreements can be filled inNumber.
        """
    ...
    def protocol_list(self, value: pulumi.Input[_builtins.str | None]):
...
class DefaultAlarmThresholdDefaultAlarmConfigArgsDict(TypedDict):
    alarm_threshold: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    ...
    """
    alarm_type: NotRequired[pulumi.Input[_builtins.int | None]]
    """
...
class DefaultAlarmThresholdDefaultAlarmConfigArgs:
    def __init__(
        __self__,
        *,
        alarm_threshold: pulumi.Input[_builtins.int | None] = None,
        alarm_type: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def alarm_threshold(self) -> pulumi.Input[_builtins.int | None]:
        """
        Alarm threshold, in Mbps, with a value of&gt;=0; When used as an input parameter, setting 0 will delete the alarm threshold configuration;.
        """
    ...
    def alarm_threshold(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "alarm_threshold", value)

    @_builtins.property
    @pulumi.getter(name="alarmType")
    def alarm_type(self) -> pulumi.Input[_builtins.int | None]:
        """
        Alarm threshold type, value [1 (incoming traffic alarm threshold) 2 (attack cleaning traffic alarm threshold)].
        """
    ...
    @alarm_type.setter
    def alarm_type(self, value: pulumi.Input[_builtins.int | None]):
...
class PacketFilterConfigPacketFilterConfigArgsDict(TypedDict):
    ...
    """
    match_begin2: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Second detection position, value [begin_l5 (load) no_match (mismatch)].
    """
    match_logic: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    match_type2: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    offset2: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    The offset from the second detection position, with a value range of [0, Depth2].
    """
    pkt_len_gt: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    Greater than message length, value 1+.
    """
    str: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    str2: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class PacketFilterConfigPacketFilterConfigArgs:
    def __init__(
        ...
        *,
        ...
        depth2: pulumi.Input[_builtins.int | None] = None,
        is_not: pulumi.Input[_builtins.int | None] = None,
        is_not2: pulumi.Input[_builtins.int | None] = None,
        match_begin: pulumi.Input[_builtins.str | None] = None,
        match_begin2: pulumi.Input[_builtins.str | None] = None,
        match_logic: pulumi.Input[_builtins.str | None] = None,
        match_type: pulumi.Input[_builtins.str | None] = None,
        match_type2: pulumi.Input[_builtins.str | None] = None,
        offset: pulumi.Input[_builtins.int | None] = None,
        offset2: pulumi.Input[_builtins.int | None] = None,
        pkt_len_gt: pulumi.Input[_builtins.int | None] = None,
        str: pulumi.Input[_builtins.str | None] = None,
        str2: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def depth2(self) -> pulumi.Input[_builtins.int | None]:
        """
        The second detection depth starting from the second detection position, with a value of [01500].
        """
    ...
    @depth2.setter
    def depth2(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "depth2", value)

    @_builtins.property
    @pulumi.getter(name="isNot")
    def is_not(self) -> pulumi.Input[_builtins.int | None]:
        """
        Whether to include detection values, with a value of [0 (inclusive) and 1 (exclusive)].
        """
    ...
    @is_not.setter
    def is_not(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "is_not", value)

    @_builtins.property
    @pulumi.getter(name="isNot2")
    def is_not2(self) -> pulumi.Input[_builtins.int | None]:
        """
        Whether the second detection includes detection values, with a value of [0 (inclusive) and 1 (exclusive)].
        """
    ...
    @is_not2.setter
    def is_not2(self, value: pulumi.Input[_builtins.int | None]):
    ...
    def match_begin2(self) -> pulumi.Input[_builtins.str | None]:
        """
        Second detection position, value [begin_l5 (load) no_match (mismatch)].
        """
    ...
    @match_begin2.setter
    def match_begin2(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "match_begin2", value)

    @_builtins.property
    @pulumi.getter(name="matchLogic")
    def match_logic(self) -> pulumi.Input[_builtins.str | None]:
        """
        When there is a second detection condition, the AND or relationship with the first detection condition, with the value [and (and relationship) none (fill in this value when there is no second detection condition)].
        """
    ...
    @match_logic.setter
    def match_logic(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def match_type2(self) -> pulumi.Input[_builtins.str | None]:
        """
        The second detection type, with a value of [Sunday (keyword) pcre (regular expression)].
        """
    ...
    @match_type2.setter
    def match_type2(self, value: pulumi.Input[_builtins.str | None]):
    ...
    @_builtins.property
    @pulumi.getter
    def offset2(self) -> pulumi.Input[_builtins.int | None]:
        """
        The offset from the second detection position, with a value range of [0, Depth2].
        """
    ...
    @offset2.setter
    def offset2(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "offset2", value)

    @_builtins.property
    @pulumi.getter(name="pktLenGt")
    def pkt_len_gt(self) -> pulumi.Input[_builtins.int | None]:
        """
        Greater than message length, value 1+.
        """
    ...
    @pkt_len_gt.setter
    def pkt_len_gt(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "pkt_len_gt", value)

    @_builtins.property
    @pulumi.getter
    def str(self) -> pulumi.Input[_builtins.str | None]:
        """
        Detection value, key string or regular expression, value [When the detection type is Sunday, please fill in the string or hexadecimal bytecode, for example, x313233 corresponds to the hexadecimal word&gt;section code of the string &#39;123&#39;; when the detection type is pcre, please fill in the regular expression character string;].
        """
    ...
    @str.setter
    def str(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "str", value)

    @_builtins.property
    @pulumi.getter
    def str2(self) -> pulumi.Input[_builtins.str | None]:
        """
        key string or regular expression, value [When the detection type is Sunday, please fill in the string or hexadecimal bytecode, for example, x313233 corresponds to the hexadecimal word&gt;section code of the string &#39;123&#39;; when the detection type is pcre, please fill in the regular expression character string;].
        """
    ...
    @str2.setter
    def str2(self, value: pulumi.Input[_builtins.str | None]):
