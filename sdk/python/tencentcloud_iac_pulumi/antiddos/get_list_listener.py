...
class GetListListenerResult:
    ...
    def __init__(
        __self__,
        id=None,
        layer4_listeners=None,
        layer7_listeners=None,
    ...
    def layer4_listeners(
        self,
    ) -> Sequence["outputs.GetListListenerLayer4ListenerResult"]:
        """
        L4 listener list.
        """
    ...
    def layer7_listeners(
        self,
    ) -> Sequence["outputs.GetListListenerLayer7ListenerResult"]:
        """
...
def get_list_listener(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Antiddos/getListListener:getListListener",
        __args__,
        opts=opts,
        typ=GetListListenerResult,
    ).value
...
def get_list_listener_output(
    ...
    return __ret__.apply(
        lambda __response__: GetListListenerResult(
