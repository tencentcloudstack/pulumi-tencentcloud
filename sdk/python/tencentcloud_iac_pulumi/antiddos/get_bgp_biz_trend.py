...
def get_bgp_biz_trend(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Antiddos/getBgpBizTrend:getBgpBizTrend",
        __args__,
        opts=opts,
        typ=GetBgpBizTrendResult,
    ).value
...
def get_bgp_biz_trend_output(
...
) -> pulumi.Output[GetBgpBizTrendResult]:
    """
    Use this data source to query detailed information of antiddos bgp_biz_trend
    ...
    return __ret__.apply(
        lambda __response__: GetBgpBizTrendResult(
