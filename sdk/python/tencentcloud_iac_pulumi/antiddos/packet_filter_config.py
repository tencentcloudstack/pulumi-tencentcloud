...
__all__ = ['PacketFilterConfig', 'PacketFilterConfigArgs']
...
class PacketFilterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: resource id.
...
class _PacketFilterConfigState:
    def __init__(__self__, *,
                 ...
                 packet_filter_config: pulumi.Input[Optional['PacketFilterConfigPacketFilterConfigArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="packetFilterConfig")
    def packet_filter_config(self) -> pulumi.Input[Optional['PacketFilterConfigPacketFilterConfigArgs']]:
        """
        Feature filtering configuration.
        """
        return pulumi.get(self, "packet_filter_config")
    ...
    @packet_filter_config.setter
    def packet_filter_config(self, value: pulumi.Input[Optional['PacketFilterConfigPacketFilterConfigArgs']]):
        pulumi.set(self, "packet_filter_config", value)


@pulumi.type_token("tencentcloud:Antiddos/packetFilterConfig:PacketFilterConfig")
class PacketFilterConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 packet_filter_config: pulumi.Input[Optional[Union['PacketFilterConfigPacketFilterConfigArgs', 'PacketFilterConfigPacketFilterConfigArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] instance_id: resource id.
        :param pulumi.Input[Union['PacketFilterConfigPacketFilterConfigArgs', 'PacketFilterConfigPacketFilterConfigArgsDict']] packet_filter_config: Feature filtering configuration.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            packet_filter_config: pulumi.Input[Optional[Union['PacketFilterConfigPacketFilterConfigArgs', 'PacketFilterConfigPacketFilterConfigArgsDict']]] = None) -> 'PacketFilterConfig':
        """
