...
class GetBasicDeviceStatusResult:
    ...
    def filter_region(self) -> Optional[_builtins.int]:
...
def get_basic_device_status(filter_region: Optional[_builtins.int] = None,
...
def get_basic_device_status_output(filter_region: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                   id_lists: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBasicDeviceStatusResult]:
    """
    Use this data source to query detailed information of antiddos basic_device_status
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Antiddos/getBasicDeviceStatus:getBasicDeviceStatus', __args__, opts=opts, typ=GetBasicDeviceStatusResult)
    return __ret__.apply(lambda __response__: GetBasicDeviceStatusResult(
