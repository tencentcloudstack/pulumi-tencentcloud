...
class GetBasicDeviceStatusResult:
    ...
    def filter_region(self) -> _builtins.int | None:
    ...
    def id_lists(self) -> Sequence[_builtins.str] | None:
...
def get_basic_device_status(
    filter_region: _builtins.int | None = None,
    id_lists: Sequence[_builtins.str] | None = None,
    ...
    basic_device_status = tencentcloud.antiddos.get_basic_device_status(ip_lists=["127.0.0.1"],
        filter_region=1)
    ```


    :param _builtins.int filter_region: Region Id.
    :param Sequence[_builtins.str] id_lists: Named resource transfer ID.
    :param Sequence[_builtins.str] ip_lists: Ip resource list.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Antiddos/getBasicDeviceStatus:getBasicDeviceStatus",
        __args__,
        opts=opts,
        typ=GetBasicDeviceStatusResult,
    ).value
...
def get_basic_device_status_output(
    filter_region: pulumi.Input[_builtins.int | None] = None,
    id_lists: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetBasicDeviceStatusResult]:
    """
    Use this data source to query detailed information of antiddos basic_device_status
    ...
    return __ret__.apply(
        lambda __response__: GetBasicDeviceStatusResult(
            clb_datas=pulumi.get(__response__, "clb_datas"),
