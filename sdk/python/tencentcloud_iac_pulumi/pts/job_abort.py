...
class JobAbortArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] abort_reason: The reason for aborting the job.
        """
...
@pulumi.type_token("tencentcloud:Pts/jobAbort:JobAbort")
class JobAbort(pulumi.CustomResource):
    ...
    def __init__(
        ...
        job_abort = tencentcloud.pts.JobAbort("job_abort",
            job_id="job-my644ozi",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            JobAbortArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Pts/jobAbort:JobAbort", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="abortReason")
    def abort_reason(self) -> pulumi.Output[_builtins.int | None]:
        """
        The reason for aborting the job.
        """
        return pulumi.get(self, "abort_reason")
