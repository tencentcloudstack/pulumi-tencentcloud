...
def get_end_points(filters: Optional[Sequence[Union['GetEndPointsFilterArgs', 'GetEndPointsFilterArgsDict']]] = None,
...
def get_end_points_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetEndPointsFilterArgs', 'GetEndPointsFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:PrivateDns/getEndPoints:getEndPoints', __args__, opts=opts, typ=GetEndPointsResult)
