...
class GetPrivateZoneListResult:
    ...
    def __init__(
        __self__, filters=None, id=None, private_zone_sets=None, result_output_file=None
    ):
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetPrivateZoneListFilterResult"] | None:
    ...
    def private_zone_sets(
        self,
    ) -> Sequence["outputs.GetPrivateZoneListPrivateZoneSetResult"]:
        """
        Private Zone Set.
        """
...
def get_private_zone_list(
    filters: (
        Sequence[
            Union["GetPrivateZoneListFilterArgs", "GetPrivateZoneListFilterArgsDict"]
        ]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:PrivateDns/getPrivateZoneList:getPrivateZoneList",
        __args__,
        opts=opts,
        typ=GetPrivateZoneListResult,
    ).value
...
def get_private_zone_list_output(
...
) -> pulumi.Output[GetPrivateZoneListResult]:
    """
    Use this data source to query detailed information of Private Dns private zone list
    ...
    return __ret__.apply(
        lambda __response__: GetPrivateZoneListResult(
