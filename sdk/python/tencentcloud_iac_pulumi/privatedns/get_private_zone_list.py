...
def get_private_zone_list_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetPrivateZoneListFilterArgs', 'GetPrivateZoneListFilterArgsDict']]]]] = None,
