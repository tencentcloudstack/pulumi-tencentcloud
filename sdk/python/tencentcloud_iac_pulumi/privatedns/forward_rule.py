...
class _ForwardRuleState:
    def __init__(__self__, *,
                 end_point_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="endPointId")
    def end_point_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Endpoint ID.
        """
        return pulumi.get(self, "end_point_id")
    ...
    @end_point_id.setter
    def end_point_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "end_point_id", value)
...
class ForwardRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_name: pulumi.Input[Optional[_builtins.str]] = None,
            rule_type: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ForwardRule':
        """
