...
class GetSecretVersionsResult:
    ...
    def secret_version_lists(
        self,
    ) -> Sequence["outputs.GetSecretVersionsSecretVersionListResult"]:
        """
...
def get_secret_versions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssm/getSecretVersions:getSecretVersions",
        __args__,
        opts=opts,
        typ=GetSecretVersionsResult,
    ).value
...
def get_secret_versions_output(
...
) -> pulumi.Output[GetSecretVersionsResult]:
    """
    Use this data source to query detailed information of SSM secret version
    ...
    return __ret__.apply(
        lambda __response__: GetSecretVersionsResult(
