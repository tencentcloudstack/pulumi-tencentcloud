...
def get_ssh_key_pair_value(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssm/getSshKeyPairValue:getSshKeyPairValue",
        __args__,
        opts=opts,
        typ=GetSshKeyPairValueResult,
    ).value
...
def get_ssh_key_pair_value_output(
...
) -> pulumi.Output[GetSshKeyPairValueResult]:
    """
    Use this data source to query detailed information of ssm ssh_key_pair_value
    ...
    return __ret__.apply(
        lambda __response__: GetSshKeyPairValueResult(
