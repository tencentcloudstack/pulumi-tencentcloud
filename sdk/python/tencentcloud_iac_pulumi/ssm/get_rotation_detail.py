...
class GetRotationDetailResult:
    ...
    def __init__(
        ...
        frequency=None,
        id=None,
        latest_rotate_time=None,
        next_rotate_begin_time=None,
...
def get_rotation_detail(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssm/getRotationDetail:getRotationDetail",
        __args__,
        opts=opts,
        typ=GetRotationDetailResult,
    ).value
...
def get_rotation_detail_output(
...
) -> pulumi.Output[GetRotationDetailResult]:
    """
    Use this data source to query detailed information of ssm rotation_detail
    ...
    return __ret__.apply(
        lambda __response__: GetRotationDetailResult(
