...
def get_secrets(order_type: Optional[_builtins.int] = None,
    ...
    example = example_secret.secret_name.apply(lambda secret_name: tencentcloud.Ssm.get_secrets_output(secret_name=secret_name,
        state=1))
    ```
...
def get_secrets_output(order_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                       ...
                       secret_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                       state: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ssm/getSecrets:getSecrets', __args__, opts=opts, typ=GetSecretsResult)
