...
class GetServiceStatusResult:
    ...
    def __init__(
        __self__,
        access_key_escrow_enabled=None,
        id=None,
        invalid_type=None,
        result_output_file=None,
        service_enabled=None,
    ):
        if access_key_escrow_enabled and not isinstance(
            access_key_escrow_enabled, bool
        ):
            raise TypeError(
                "Expected argument 'access_key_escrow_enabled' to be a bool"
            )
...
def get_service_status(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssm/getServiceStatus:getServiceStatus",
        __args__,
        opts=opts,
...
def get_service_status_output(
    ...
    return __ret__.apply(
        lambda __response__: GetServiceStatusResult(
            access_key_escrow_enabled=pulumi.get(
                __response__, "access_key_escrow_enabled"
            ),
