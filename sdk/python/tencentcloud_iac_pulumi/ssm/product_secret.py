...
class ProductSecretArgs:
    def __init__(__self__, *,
                 ...
                 enable_rotation: pulumi.Input[Optional[_builtins.bool]] = None,
                 kms_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 rotation_begin_time: pulumi.Input[Optional[_builtins.str]] = None,
                 rotation_frequency: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def enable_rotation(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def enable_rotation(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def rotation_begin_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def rotation_begin_time(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "rotation_begin_time", value)

    @_builtins.property
    @pulumi.getter(name="rotationFrequency")
    def rotation_frequency(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def rotation_frequency(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _ProductSecretState:
    def __init__(__self__, *,
                 ...
                 kms_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 privileges_lists: pulumi.Input[Optional[Sequence[pulumi.Input['ProductSecretPrivilegesListArgs']]]] = None,
                 ...
                 status: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 user_name_prefix: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="privilegesLists")
    def privileges_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ProductSecretPrivilegesListArgs']]]]:
        """
        List of permissions that need to be granted when the credential is bound to a Tencent Cloud service.
        """
        return pulumi.get(self, "privileges_lists")
    ...
    @privileges_lists.setter
    def privileges_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ProductSecretPrivilegesListArgs']]]]):
        pulumi.set(self, "privileges_lists", value)
    ...
    @_builtins.property
    @pulumi.getter(name="userNamePrefix")
    def user_name_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Prefix of the user account name, which is specified by you and can contain up to 8 characters.Supported character sets include:Digits: [0, 9].Lowercase letters: [a, z].Uppercase letters: [A, Z].Special symbols: underscore.The prefix must begin with a letter.
        """
        return pulumi.get(self, "user_name_prefix")
    ...
    @user_name_prefix.setter
    def user_name_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "user_name_prefix", value)
...
class ProductSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 kms_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 privileges_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ProductSecretPrivilegesListArgs', 'ProductSecretPrivilegesListArgsDict']]]]] = None,
                 product_name: pulumi.Input[Optional[_builtins.str]] = None,
                 rotation_begin_time: pulumi.Input[Optional[_builtins.str]] = None,
                 rotation_frequency: pulumi.Input[Optional[_builtins.int]] = None,
                 secret_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            user_name_prefix: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProductSecret':
        """
