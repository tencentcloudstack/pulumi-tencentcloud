...
__all__ = ["ProductSecret", "ProductSecretArgs"]
...
class ProductSecretArgs:
    def __init__(
        ...
        *,
        ...
        privileges_lists: pulumi.Input[
            Sequence[pulumi.Input["ProductSecretPrivilegesListArgs"]]
        ],
        ...
        enable_rotation: pulumi.Input[_builtins.bool | None] = None,
        kms_key_id: pulumi.Input[_builtins.str | None] = None,
        rotation_begin_time: pulumi.Input[_builtins.str | None] = None,
        rotation_frequency: pulumi.Input[_builtins.int | None] = None,
    ...
    def privileges_lists(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ProductSecretPrivilegesListArgs"]]]:
        """
    ...
    def privileges_lists(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["ProductSecretPrivilegesListArgs"]]],
    ):
    ...
    def enable_rotation(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    def enable_rotation(self, value: pulumi.Input[_builtins.bool | None]):
    ...
    def rotation_begin_time(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def rotation_begin_time(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "rotation_begin_time", value)

    @_builtins.property
    @pulumi.getter(name="rotationFrequency")
    def rotation_frequency(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def rotation_frequency(self, value: pulumi.Input[_builtins.int | None]):
...
class _ProductSecretState:
    def __init__(
        ...
        *,
        ...
        kms_key_id: pulumi.Input[_builtins.str | None] = None,
        privileges_lists: pulumi.Input[
            Sequence[pulumi.Input["ProductSecretPrivilegesListArgs"]] | None
        ] = None,
        ...
        status: pulumi.Input[_builtins.str | None] = None,
        tags: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]] | None] = None,
        user_name_prefix: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def privileges_lists(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ProductSecretPrivilegesListArgs"]] | None]:
        """
        List of permissions that need to be granted when the credential is bound to a Tencent Cloud service.
        """
        return pulumi.get(self, "privileges_lists")
    ...
    @_builtins.property
    @pulumi.getter(name="productName")
    def product_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        Name of the Tencent Cloud service bound to the credential, such as `Mysql`, `Tdsql-mysql`, `Tdsql_C_Mysql`. you can use dataSource `ssm_get_products` to query supported products.
        """
        return pulumi.get(self, "product_name")
    ...
    def secret_type(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    @secret_type.setter
    def secret_type(self, value: pulumi.Input[_builtins.int | None]):
    ...
    @_builtins.property
    @pulumi.getter(name="userNamePrefix")
    def user_name_prefix(self) -> pulumi.Input[_builtins.str | None]:
        """
        Prefix of the user account name, which is specified by you and can contain up to 8 characters.Supported character sets include:Digits: [0, 9].Lowercase letters: [a, z].Uppercase letters: [A, Z].Special symbols: underscore.The prefix must begin with a letter.
        """
        return pulumi.get(self, "user_name_prefix")
    ...
    @user_name_prefix.setter
    def user_name_prefix(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "user_name_prefix", value)
...
class ProductSecret(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ProductSecretArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="kmsKeyId")
    def kms_key_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        Specifies the KMS CMK that encrypts the credential. If this parameter is left empty, the CMK created by Secrets Manager by default will be used for encryption.You can also specify a custom KMS CMK created in the same region for encryption.
        """
        return pulumi.get(self, "kms_key_id")
    ...
    def privileges_lists(
        self,
    ) -> pulumi.Output[Sequence["outputs.ProductSecretPrivilegesList"]]:
        """
        List of permissions that need to be granted when the credential is bound to a Tencent Cloud service.
        """
        return pulumi.get(self, "privileges_lists")
