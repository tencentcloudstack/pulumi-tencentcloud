...
class SecretVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] version_id: Version of secret. The maximum length is 64 bytes. The version_id can only contain English letters, numbers, underscore and hyphen '-'. The first character must be a letter or number.
        :param pulumi.Input[_builtins.str] secret_binary: The base64-encoded binary secret. secret_binary and secret_string must be set only one, and the maximum support is 4096 bytes. When secret status is `Disabled`, this field will not update anymore.
        :param pulumi.Input[_builtins.str] secret_string: The string text of secret. secret_binary and secret_string must be set only one, and the maximum support is 4096 bytes. When secret status is `Disabled`, this field will not update anymore.
        """
...
class SecretVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_name: Optional[pulumi.Input[_builtins.str]] = None,
            secret_string: Optional[pulumi.Input[_builtins.str]] = None,
            version_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SecretVersion':
        """
