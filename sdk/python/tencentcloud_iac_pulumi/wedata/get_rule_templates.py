...
class GetRuleTemplatesResult:
    ...
    def source_engine_types(self) -> Sequence[_builtins.int] | None:
        """
    ...
    def source_object_type(self) -> _builtins.int | None:
        """
...
def get_rule_templates(
    ...
    source_engine_types: Sequence[_builtins.int] | None = None,
    source_object_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Wedata/getRuleTemplates:getRuleTemplates",
        __args__,
        opts=opts,
        typ=GetRuleTemplatesResult,
    ).value
...
def get_rule_templates_output(
...
) -> pulumi.Output[GetRuleTemplatesResult]:
    """
    Use this data source to query detailed information of wedata rule templates
    ...
    return __ret__.apply(
        lambda __response__: GetRuleTemplatesResult(
