...
class _IntegrationOfflineTaskState:
    def __init__(__self__, *,
                 ...
                 task_action: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="taskAction")
    def task_action(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Scheduling configuration: flexible period configuration, only available for hourly/weekly/monthly/yearly scheduling. If the hourly task is specified to run at 0:00, 3:00 and 4:00 every day, it is 0,3,4.
        """
        return pulumi.get(self, "task_action")
    ...
    @task_action.setter
    def task_action(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "task_action", value)
...
class IntegrationOfflineTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 start_time: Optional[pulumi.Input[_builtins.str]] = None,
                 task_action: Optional[pulumi.Input[_builtins.str]] = None,
                 task_info: Optional[pulumi.Input[Union['IntegrationOfflineTaskTaskInfoArgs', 'IntegrationOfflineTaskTaskInfoArgsDict']]] = None,
                 task_mode: Optional[pulumi.Input[_builtins.str]] = None,
                 task_name: Optional[pulumi.Input[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            task_info: Optional[pulumi.Input[Union['IntegrationOfflineTaskTaskInfoArgs', 'IntegrationOfflineTaskTaskInfoArgsDict']]] = None,
            task_mode: Optional[pulumi.Input[_builtins.str]] = None,
            task_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'IntegrationOfflineTask':
        """
