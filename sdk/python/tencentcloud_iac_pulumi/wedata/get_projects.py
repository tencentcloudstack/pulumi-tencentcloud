...
def get_projects_output(project_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                        project_model: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
