...
class GetStatisticsReportResult:
    ...
    def __init__(
        ...
        end_date=None,
        id=None,
        overall_volumes=None,
        receiving_mailbox_type=None,
    ...
    def overall_volumes(
        self,
    ) -> Sequence["outputs.GetStatisticsReportOverallVolumeResult"]:
        """
    ...
    def receiving_mailbox_type(self) -> _builtins.str | None:
...
def get_statistics_report(
    ...
    receiving_mailbox_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ses/getStatisticsReport:getStatisticsReport",
        __args__,
        opts=opts,
        typ=GetStatisticsReportResult,
    ).value
...
def get_statistics_report_output(
    domain: pulumi.Input[_builtins.str | None] = None,
    end_date: pulumi.Input[_builtins.str | None] = None,
    receiving_mailbox_type: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetStatisticsReportResult]:
    """
    Use this data source to query detailed information of ses statistics_report
    ...
    return __ret__.apply(
        lambda __response__: GetStatisticsReportResult(
