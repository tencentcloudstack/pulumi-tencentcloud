...
class BatchSendEmailCycleParamArgsDict(TypedDict):
    ...
    """
    term_cycle: NotRequired[pulumi.Input[_builtins.int | None]]
    """
...
class BatchSendEmailCycleParamArgs:
    def __init__(
        ...
        *,
        begin_time: pulumi.Input[_builtins.str],
        interval_time: pulumi.Input[_builtins.int],
        term_cycle: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def term_cycle(self) -> pulumi.Input[_builtins.int | None]:
        """
        Specifies whether to end the cycle. This parameter is used to update the task. Valid values: 0: No; 1: Yes.
        """
    ...
    @term_cycle.setter
    def term_cycle(self, value: pulumi.Input[_builtins.int | None]):
...
class BatchSendEmailTimedParamArgs:
    def __init__(__self__, *, begin_time: pulumi.Input[_builtins.str]):
        """
...
class DomainAttributeArgsDict(TypedDict):
    expected_value: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Values that need to be configured.
    """
    send_domain: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Domain name.
    """
...
class DomainAttributeArgs:
    def __init__(
        __self__,
        *,
        expected_value: pulumi.Input[_builtins.str | None] = None,
        send_domain: pulumi.Input[_builtins.str | None] = None,
    ...
    def expected_value(self) -> pulumi.Input[_builtins.str | None]:
        """
        Values that need to be configured.
        """
    ...
    def expected_value(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "expected_value", value)

    @_builtins.property
    @pulumi.getter(name="sendDomain")
    def send_domain(self) -> pulumi.Input[_builtins.str | None]:
        """
        Domain name.
        """
    ...
    @send_domain.setter
    def send_domain(self, value: pulumi.Input[_builtins.str | None]):
...
class ReceiverDataArgsDict(TypedDict):
    ...
    """
    template_data: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class ReceiverDataArgs:
    def __init__(
        ...
        *,
        email: pulumi.Input[_builtins.str],
        template_data: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="templateData")
    def template_data(self) -> pulumi.Input[_builtins.str | None]:
        """
        Variable parameters in the template, please use json.dump to format the JSON object as a string type. The object is a set of key-value pairs, where each key represents a variable in the template, and the variables in the template are represented by {{key}}, and the corresponding values will be replaced with {{value}} when sent.Note: Parameter values cannot be complex data such as HTML. The total length of TemplateData (the entire JSON structure) should be less than 800 bytes.
        """
        return pulumi.get(self, "template_data")
    ...
    @template_data.setter
    def template_data(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "template_data", value)
...
class TemplateTemplateContentArgsDict(TypedDict):
    html: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class TemplateTemplateContentArgs:
    def __init__(
        __self__,
        *,
        html: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def html(self) -> pulumi.Input[_builtins.str | None]:
        """
        Html code after base64.
        """
    ...
    @html.setter
    def html(self, value: pulumi.Input[_builtins.str | None]):
