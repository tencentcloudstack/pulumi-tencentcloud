...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            attributes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainAttributeArgs', 'DomainAttributeArgsDict']]]]] = None,
            email_identity: Optional[pulumi.Input[_builtins.str]] = None) -> 'Domain':
        """
