...
class GetEmailIdentitiesResult:
    ...
    def __init__(
        __self__,
        email_identities=None,
        id=None,
        max_daily_quota=None,
        max_reputation_level=None,
    ...
    def email_identities(
        self,
    ) -> Sequence["outputs.GetEmailIdentitiesEmailIdentityResult"]:
        """
...
def get_email_identities(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ses/getEmailIdentities:getEmailIdentities",
        __args__,
        opts=opts,
        typ=GetEmailIdentitiesResult,
    ).value
...
def get_email_identities_output(
    ...
    return __ret__.apply(
        lambda __response__: GetEmailIdentitiesResult(
