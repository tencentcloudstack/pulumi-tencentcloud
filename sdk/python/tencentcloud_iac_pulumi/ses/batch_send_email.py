...
class BatchSendEmailArgs:
    def __init__(__self__, *,
                 ...
                 ad_location: pulumi.Input[Optional[_builtins.int]] = None,
                 attachments: pulumi.Input[Optional[Sequence[pulumi.Input['BatchSendEmailAttachmentArgs']]]] = None,
                 cycle_param: pulumi.Input[Optional['BatchSendEmailCycleParamArgs']] = None,
                 reply_to_addresses: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 unsubscribe: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def ad_location(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @ad_location.setter
    def ad_location(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "ad_location", value)

    @_builtins.property
    @pulumi.getter
    def attachments(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BatchSendEmailAttachmentArgs']]]]:
        """
    ...
    @attachments.setter
    def attachments(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BatchSendEmailAttachmentArgs']]]]):
    ...
    @cycle_param.setter
    def cycle_param(self, value: pulumi.Input[Optional['BatchSendEmailCycleParamArgs']]):
        pulumi.set(self, "cycle_param", value)

    @_builtins.property
    @pulumi.getter(name="replyToAddresses")
    def reply_to_addresses(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def reply_to_addresses(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @timed_param.setter
    def timed_param(self, value: pulumi.Input[Optional['BatchSendEmailTimedParamArgs']]):
        pulumi.set(self, "timed_param", value)

    @_builtins.property
    @pulumi.getter
    def unsubscribe(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @unsubscribe.setter
    def unsubscribe(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _BatchSendEmailState:
    def __init__(__self__, *,
                 ...
                 receiver_id: pulumi.Input[Optional[_builtins.int]] = None,
                 reply_to_addresses: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="fromEmailAddress")
    def from_email_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Sender address. Enter a sender address such as noreply@mail.qcloud.com. To display the sender name, enter the address in the following format:sender &amp;amp;lt;email address&amp;amp;gt;. For example:Tencent Cloud team &amp;amp;lt;noreply@mail.qcloud.com&amp;amp;gt;.
        """
        return pulumi.get(self, "from_email_address")
    ...
    @from_email_address.setter
    def from_email_address(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "from_email_address", value)

    @_builtins.property
    @pulumi.getter(name="receiverId")
    def receiver_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Recipient group ID.
        """
        return pulumi.get(self, "receiver_id")
    ...
    @receiver_id.setter
    def receiver_id(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "receiver_id", value)
...
class BatchSendEmail(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ad_location: pulumi.Input[Optional[_builtins.int]] = None,
                 attachments: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BatchSendEmailAttachmentArgs', 'BatchSendEmailAttachmentArgsDict']]]]] = None,
                 cycle_param: pulumi.Input[Optional[Union['BatchSendEmailCycleParamArgs', 'BatchSendEmailCycleParamArgsDict']]] = None,
                 from_email_address: pulumi.Input[Optional[_builtins.str]] = None,
                 receiver_id: pulumi.Input[Optional[_builtins.int]] = None,
                 reply_to_addresses: pulumi.Input[Optional[_builtins.str]] = None,
                 subject: pulumi.Input[Optional[_builtins.str]] = None,
                 task_type: pulumi.Input[Optional[_builtins.int]] = None,
                 template: pulumi.Input[Optional[Union['BatchSendEmailTemplateArgs', 'BatchSendEmailTemplateArgsDict']]] = None,
                 timed_param: pulumi.Input[Optional[Union['BatchSendEmailTimedParamArgs', 'BatchSendEmailTimedParamArgsDict']]] = None,
                 unsubscribe: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            template: pulumi.Input[Optional[Union['BatchSendEmailTemplateArgs', 'BatchSendEmailTemplateArgsDict']]] = None,
            timed_param: pulumi.Input[Optional[Union['BatchSendEmailTimedParamArgs', 'BatchSendEmailTimedParamArgsDict']]] = None,
            unsubscribe: pulumi.Input[Optional[_builtins.str]] = None) -> 'BatchSendEmail':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="adLocation")
    def ad_location(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Whether to add an ad tag. 0: Add no tag; 1: Add before the subject; 2: Add after the subject.
        """
        return pulumi.get(self, "ad_location")
    ...
    @_builtins.property
    @pulumi.getter(name="replyToAddresses")
    def reply_to_addresses(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Reply-to address. You can enter a valid personal email address that can receive emails. If this parameter is left empty, reply emails will fail to be sent.
        """
        return pulumi.get(self, "reply_to_addresses")
    ...
    @_builtins.property
    @pulumi.getter
    def unsubscribe(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Unsubscribe link option.  0: Do not add unsubscribe link; 1: English 2: Simplified Chinese;  3: Traditional Chinese; 4: Spanish; 5: French;  6: German; 7: Japanese; 8: Korean;  9: Arabic; 10: Thai.
        """
        return pulumi.get(self, "unsubscribe")
