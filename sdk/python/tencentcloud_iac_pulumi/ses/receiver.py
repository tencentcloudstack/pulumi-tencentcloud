...
class ReceiverArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] receivers_name: Recipient group name.
        :param pulumi.Input[_builtins.str] desc: Recipient group description.
        """
...
class _ReceiverState:
    def __init__(
        __self__,
        *,
        datas: pulumi.Input[Sequence[pulumi.Input["ReceiverDataArgs"]] | None] = None,
        desc: pulumi.Input[_builtins.str | None] = None,
        receivers_name: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def datas(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["ReceiverDataArgs"]] | None]:
        """
        Recipient email and template parameters in array format. The number of recipients is limited to within 20,000. If there is an object in the `data` list that inputs `template_data`, then other objects are also required.
        """
        return pulumi.get(self, "datas")
    ...
    @datas.setter
    def datas(
        self, value: pulumi.Input[Sequence[pulumi.Input["ReceiverDataArgs"]] | None]
    ):
        pulumi.set(self, "datas", value)
    ...
    @_builtins.property
    @pulumi.getter(name="receiversName")
    def receivers_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        Recipient group name.
        """
        return pulumi.get(self, "receivers_name")
    ...
    @receivers_name.setter
    def receivers_name(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "receivers_name", value)


@pulumi.type_token("tencentcloud:Ses/receiver:Receiver")
class Receiver(pulumi.CustomResource):
    ...
    def __init__(
        ...
        datas: pulumi.Input[
            Sequence[pulumi.Input[Union["ReceiverDataArgs", "ReceiverDataArgsDict"]]]
            | None
        ] = None,
        desc: pulumi.Input[_builtins.str | None] = None,
        receivers_name: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReceiverDataArgs', 'ReceiverDataArgsDict']]]] datas: Recipient email and template parameters in array format. The number of recipients is limited to within 20,000. If there is an object in the `data` list that inputs `template_data`, then other objects are also required.
        :param pulumi.Input[_builtins.str] desc: Recipient group description.
        :param pulumi.Input[_builtins.str] receivers_name: Recipient group name.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ReceiverArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Ses/receiver:Receiver", resource_name, __props__, opts
        )
