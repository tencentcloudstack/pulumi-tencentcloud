...
class GetBlackEmailAddressResult:
    ...
    def email_address(self) -> _builtins.str | None:
        """
...
def get_black_email_address(
    email_address: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ses/getBlackEmailAddress:getBlackEmailAddress",
        __args__,
        opts=opts,
        typ=GetBlackEmailAddressResult,
    ).value
...
def get_black_email_address_output(
    email_address: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetBlackEmailAddressResult]:
    """
    Use this data source to query detailed information of ses black_email_address
    ...
    return __ret__.apply(
        lambda __response__: GetBlackEmailAddressResult(
