...
def get_regions(result_output_file: Optional[_builtins.str] = None,
...
def get_regions_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getRegions:getRegions', __args__, opts=opts, typ=GetRegionsResult)
