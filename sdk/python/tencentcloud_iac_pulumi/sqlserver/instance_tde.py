...
__all__ = ["InstanceTde", "InstanceTdeArgs"]
...
class InstanceTdeArgs:
    def __init__(
        __self__,
        *,
        certificate_attribution: pulumi.Input[_builtins.str],
        instance_id: pulumi.Input[_builtins.str],
        quote_uin: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a InstanceTde resource.

        :param pulumi.Input[_builtins.str] certificate_attribution: Certificate attribution. self- means to use the account's own certificate, others- means to refer to the certificate of other accounts, and the default is self.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        :param pulumi.Input[_builtins.str] quote_uin: Other referenced main account IDs, required when CertificateAttribute is others.
        """
    ...
    def certificate_attribution(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def certificate_attribution(self, value: pulumi.Input[_builtins.str]):
    ...
    def quote_uin(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @quote_uin.setter
    def quote_uin(self, value: pulumi.Input[_builtins.str | None]):
...
class _InstanceTdeState:
    def __init__(
        __self__,
        *,
        certificate_attribution: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="certificateAttribution")
    def certificate_attribution(self) -> pulumi.Input[_builtins.str | None]:
        """
        Certificate attribution. self- means to use the account's own certificate, others- means to refer to the certificate of other accounts, and the default is self.
        """
        return pulumi.get(self, "certificate_attribution")
    ...
    @certificate_attribution.setter
    def certificate_attribution(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "certificate_attribution", value)
...
@pulumi.type_token("tencentcloud:Sqlserver/instanceTde:InstanceTde")
class InstanceTde(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_instance_tde = tencentcloud.sqlserver.InstanceTde("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            InstanceTdeArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="certificateAttribution")
    def certificate_attribution(self) -> pulumi.Output[_builtins.str]:
        """
        Certificate attribution. self- means to use the account's own certificate, others- means to refer to the certificate of other accounts, and the default is self.
        """
        return pulumi.get(self, "certificate_attribution")
    ...
    @_builtins.property
    @pulumi.getter(name="quoteUin")
    def quote_uin(self) -> pulumi.Output[_builtins.str | None]:
        """
        Other referenced main account IDs, required when CertificateAttribute is others.
        """
        return pulumi.get(self, "quote_uin")
