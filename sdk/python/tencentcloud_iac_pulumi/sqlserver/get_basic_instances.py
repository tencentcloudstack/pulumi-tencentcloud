...
def get_basic_instances(id: Optional[_builtins.str] = None,
...
def get_basic_instances_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               ...
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBasicInstancesResult]:
    """
    Use this data source to query SQL Server basic instances
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getBasicInstances:getBasicInstances', __args__, opts=opts, typ=GetBasicInstancesResult)
    return __ret__.apply(lambda __response__: GetBasicInstancesResult(
