...
class GetDescHaLogSwitchLogResult(dict):
    def __init__(__self__, *,
                 ...
                 switch_type: int):
        """
        :param str end_time: Switch end time Note: This field may return null, indicating that no valid value can be obtained.
        :param str event_id: Switch event ID Note: This field may return null, indicating that no valid value can be obtained.
        :param str reason: Machine failure causes automatic switching Note: This field may return null, indicating that no valid value can be obtained.
        :param str start_time: Switch start time Note: This field may return null, indicating that no valid value can be obtained.
        :param int switch_type: Switching mode 0-system automatic switching, 1-manual switching Note: This field may return null, indicating that no valid value can be obtained.
        """
        pulumi.set(__self__, "end_time", end_time)
