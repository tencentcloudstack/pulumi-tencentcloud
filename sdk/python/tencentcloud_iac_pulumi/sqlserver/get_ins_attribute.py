...
class GetInsAttributeResult:
    ...
    def __init__(
        ...
        event_save_days=None,
        id=None,
        instance_id=None,
        regular_backup_counts=None,
        regular_backup_enable=None,
        regular_backup_save_days=None,
        regular_backup_start_time=None,
        regular_backup_strategy=None,
...
def get_ins_attribute(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getInsAttribute:getInsAttribute",
        __args__,
        opts=opts,
        typ=GetInsAttributeResult,
    ).value
...
def get_ins_attribute_output(
...
) -> pulumi.Output[GetInsAttributeResult]:
    """
    Use this data source to query detailed information of sqlserver_ins_attribute
    ...
    return __ret__.apply(
        lambda __response__: GetInsAttributeResult(
            ...
            regular_backup_save_days=pulumi.get(
                __response__, "regular_backup_save_days"
            ),
            regular_backup_start_time=pulumi.get(
                __response__, "regular_backup_start_time"
            ),
