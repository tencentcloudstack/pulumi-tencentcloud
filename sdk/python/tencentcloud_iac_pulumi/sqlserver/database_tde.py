...
__all__ = ["DatabaseTde", "DatabaseTdeArgs"]


@pulumi.input_type
class DatabaseTdeArgs:
    def __init__(
        __self__,
        *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] db_names: Database name list.
        :param pulumi.Input[_builtins.str] encryption: `enable` - enable encryption, `disable` - disable encryption.
...
@pulumi.type_token("tencentcloud:Sqlserver/databaseTde:DatabaseTde")
class DatabaseTde(pulumi.CustomResource):
    @overload
    def __init__(
        __self__,
        resource_name: str,
        ...
        example_db = tencentcloud.sqlserver.Db("example",
            ...
            remark="test-remark")
        example_database_tde = tencentcloud.sqlserver.DatabaseTde("example",
            instance_id=example.id,
    ...
    def __init__(
        ...
        :param str resource_name: The name of the resource.
        :param DatabaseTdeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """

    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DatabaseTdeArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = DatabaseTdeArgs.__new__(DatabaseTdeArgs)
        ...
        super().__init__(
            "tencentcloud:Sqlserver/databaseTde:DatabaseTde",
            resource_name,
            __props__,
            opts,
        )
    ...
    def get(
        ...
        __props__ = _DatabaseTdeState.__new__(_DatabaseTdeState)

        __props__.__dict__["db_names"] = db_names
        __props__.__dict__["encryption"] = encryption
        __props__.__dict__["instance_id"] = instance_id
        return DatabaseTde(resource_name, opts=opts, __props__=__props__)
