...
class DatabaseTdeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] db_names: Database name list.
        :param pulumi.Input[str] encryption: `enable` - enable encryption, `disable` - disable encryption.
...
class DatabaseTde(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            db_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            encryption: Optional[pulumi.Input[str]] = None,
            instance_id: Optional[pulumi.Input[str]] = None) -> 'DatabaseTde':
        """
