...
def get_backups(backup_name: Optional[_builtins.str] = None,
    ...
    foo = tencentcloud.Sqlserver.get_backups(instance_id="mssql-3cdq7kx5",
...
def get_backups_output(backup_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getBackups:getBackups', __args__, opts=opts, typ=GetBackupsResult)
