...
def get_cross_region_zone(instance_id: Optional[_builtins.str] = None,
...
def get_cross_region_zone_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCrossRegionZoneResult]:
    """
    Use this data source to query detailed information of sqlserver datasource_cross_region_zone
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getCrossRegionZone:getCrossRegionZone', __args__, opts=opts, typ=GetCrossRegionZoneResult)
    return __ret__.apply(lambda __response__: GetCrossRegionZoneResult(
