...
__all__ = ["RenewDbInstance", "RenewDbInstanceArgs"]
...
class RenewDbInstanceArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] period: How many months to renew, the value range is 1-48, the default is 1.
        """
...
@pulumi.type_token("tencentcloud:Sqlserver/renewDbInstance:RenewDbInstance")
class RenewDbInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_renew_db_instance = tencentcloud.sqlserver.RenewDbInstance("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RenewDbInstanceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
