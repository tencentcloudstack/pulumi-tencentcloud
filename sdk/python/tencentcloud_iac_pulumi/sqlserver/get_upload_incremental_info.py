...
class GetUploadIncrementalInfoResult:
    ...
    def incremental_migration_id(self) -> _builtins.str:
...
def get_upload_incremental_info(
    ...
    example = tencentcloud.sqlserver.get_upload_incremental_info(instance_id="mssql-4tgeyeeh",
    ...
    :param _builtins.str incremental_migration_id: ID of the incremental import task.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getUploadIncrementalInfo:getUploadIncrementalInfo",
        __args__,
        opts=opts,
        typ=GetUploadIncrementalInfoResult,
    ).value
...
def get_upload_incremental_info_output(
...
) -> pulumi.Output[GetUploadIncrementalInfoResult]:
    """
    Use this data source to query detailed information of sqlserver upload_incremental_info
    ...
    return __ret__.apply(
        lambda __response__: GetUploadIncrementalInfoResult(
