...
def get_upload_incremental_info(backup_migration_id: Optional[_builtins.str] = None,
...
def get_upload_incremental_info_output(backup_migration_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUploadIncrementalInfoResult]:
    """
    Use this data source to query detailed information of sqlserver upload_incremental_info
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getUploadIncrementalInfo:getUploadIncrementalInfo', __args__, opts=opts, typ=GetUploadIncrementalInfoResult)
    return __ret__.apply(lambda __response__: GetUploadIncrementalInfoResult(
