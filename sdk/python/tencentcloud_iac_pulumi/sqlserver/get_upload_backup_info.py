...
def get_upload_backup_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getUploadBackupInfo:getUploadBackupInfo",
        __args__,
        opts=opts,
        typ=GetUploadBackupInfoResult,
    ).value
...
def get_upload_backup_info_output(
...
) -> pulumi.Output[GetUploadBackupInfoResult]:
    """
    Use this data source to query detailed information of sqlserver upload_backup_info
    ...
    return __ret__.apply(
        lambda __response__: GetUploadBackupInfoResult(
