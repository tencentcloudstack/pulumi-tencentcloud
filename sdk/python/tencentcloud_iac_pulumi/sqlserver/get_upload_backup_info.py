...
def get_upload_backup_info(backup_migration_id: Optional[str] = None,
    ...
    upload_backup_info = tencentcloud.Sqlserver.get_upload_backup_info(backup_migration_id="mssql-backup-migration-8a0f3eht",
...
@_utilities.lift_output_func(get_upload_backup_info)
def get_upload_backup_info_output(backup_migration_id: Optional[pulumi.Input[str]] = None,
                                  instance_id: Optional[pulumi.Input[str]] = None,
                                  result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetUploadBackupInfoResult]:
    """
    Use this data source to query detailed information of sqlserver upload_backup_info
