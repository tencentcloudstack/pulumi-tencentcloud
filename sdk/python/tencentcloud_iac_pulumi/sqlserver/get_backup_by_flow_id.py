...
def get_backup_by_flow_id(
    flow_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getBackupByFlowId:getBackupByFlowId",
        __args__,
        opts=opts,
        typ=GetBackupByFlowIdResult,
    ).value
...
def get_backup_by_flow_id_output(
...
) -> pulumi.Output[GetBackupByFlowIdResult]:
    """
    Use this data source to query detailed information of sqlserver datasource_backup_by_flow_id
    ...
    return __ret__.apply(
        lambda __response__: GetBackupByFlowIdResult(
