...
def get_rollback_time(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getRollbackTime:getRollbackTime",
        __args__,
        opts=opts,
        typ=GetRollbackTimeResult,
    ).value
...
def get_rollback_time_output(
...
) -> pulumi.Output[GetRollbackTimeResult]:
    """
    Use this data source to query detailed information of sqlserver rollback_time
    ...
    return __ret__.apply(
        lambda __response__: GetRollbackTimeResult(
