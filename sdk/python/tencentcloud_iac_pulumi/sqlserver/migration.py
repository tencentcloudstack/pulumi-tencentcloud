...
__all__ = ['Migration', 'MigrationArgs']

@pulumi.input_type
class MigrationArgs:
    def __init__(__self__, *,
                 migrate_name: pulumi.Input[_builtins.str],
                 migrate_type: pulumi.Input[_builtins.int],
                 source: pulumi.Input['MigrationSourceArgs'],
                 source_type: pulumi.Input[_builtins.int],
                 target: pulumi.Input['MigrationTargetArgs'],
                 migrate_db_sets: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationMigrateDbSetArgs']]]] = None,
                 rename_restores: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationRenameRestoreArgs']]]] = None):
        """
        The set of arguments for constructing a Migration resource.

        :param pulumi.Input[_builtins.str] migrate_name: Name of the migration task.
        :param pulumi.Input[_builtins.int] migrate_type: Migration type (1 structure migration 2 data migration 3 incremental synchronization).
        :param pulumi.Input['MigrationSourceArgs'] source: Migration source.
        :param pulumi.Input[_builtins.int] source_type: Type of migration source 1 TencentDB for SQLServer 2 Cloud server self-built SQLServer database 4 SQLServer backup and restore 5 SQLServer backup and restore (COS mode).
    ...
    def migrate_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @migrate_name.setter
    def migrate_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "migrate_name", value)

    @_builtins.property
    @pulumi.getter(name="migrateType")
    def migrate_type(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @migrate_type.setter
    def migrate_type(self, value: pulumi.Input[_builtins.int]):
    ...
    def migrate_db_sets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MigrationMigrateDbSetArgs']]]]:
        """
    ...
    def migrate_db_sets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationMigrateDbSetArgs']]]]):
        pulumi.set(self, "migrate_db_sets", value)

    @_builtins.property
    @pulumi.getter(name="renameRestores")
    def rename_restores(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MigrationRenameRestoreArgs']]]]:
        """
    ...
    def rename_restores(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationRenameRestoreArgs']]]]):
...
class _MigrationState:
    def __init__(__self__, *,
                 migrate_db_sets: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationMigrateDbSetArgs']]]] = None,
                 migrate_name: pulumi.Input[Optional[_builtins.str]] = None,
                 migrate_type: pulumi.Input[Optional[_builtins.int]] = None,
                 rename_restores: pulumi.Input[Optional[Sequence[pulumi.Input['MigrationRenameRestoreArgs']]]] = None,
                 source: pulumi.Input[Optional['MigrationSourceArgs']] = None,
                 source_type: pulumi.Input[Optional[_builtins.int]] = None,
                 target: pulumi.Input[Optional['MigrationTargetArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="migrateName")
    def migrate_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Name of the migration task.
        """
        return pulumi.get(self, "migrate_name")
    ...
    @migrate_name.setter
    def migrate_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "migrate_name", value)

    @_builtins.property
    @pulumi.getter(name="migrateType")
    def migrate_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Migration type (1 structure migration 2 data migration 3 incremental synchronization).
        """
        return pulumi.get(self, "migrate_type")
    ...
    @migrate_type.setter
    def migrate_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "migrate_type", value)
    ...
    @_builtins.property
    @pulumi.getter
    def source(self) -> pulumi.Input[Optional['MigrationSourceArgs']]:
        """
        Migration source.
        """
        return pulumi.get(self, "source")
    ...
    @source.setter
    def source(self, value: pulumi.Input[Optional['MigrationSourceArgs']]):
        pulumi.set(self, "source", value)
    ...
    @_builtins.property
    @pulumi.getter
    def target(self) -> pulumi.Input[Optional['MigrationTargetArgs']]:
        """
        Migration target.
        """
        return pulumi.get(self, "target")
    ...
    @target.setter
    def target(self, value: pulumi.Input[Optional['MigrationTargetArgs']]):
        pulumi.set(self, "target", value)


@pulumi.type_token("tencentcloud:Sqlserver/migration:Migration")
class Migration(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 migrate_db_sets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MigrationMigrateDbSetArgs', 'MigrationMigrateDbSetArgsDict']]]]] = None,
                 migrate_name: pulumi.Input[Optional[_builtins.str]] = None,
                 migrate_type: pulumi.Input[Optional[_builtins.int]] = None,
                 rename_restores: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MigrationRenameRestoreArgs', 'MigrationRenameRestoreArgsDict']]]]] = None,
                 source: pulumi.Input[Optional[Union['MigrationSourceArgs', 'MigrationSourceArgsDict']]] = None,
                 source_type: pulumi.Input[Optional[_builtins.int]] = None,
                 target: pulumi.Input[Optional[Union['MigrationTargetArgs', 'MigrationTargetArgsDict']]] = None,
                 __props__=None):
        """
        ...
        security_group = tencentcloud.security.Group("security_group",
            name="sg-example",
            description="desc.")
        src_example = tencentcloud.sqlserver.BasicInstance("src_example",
            name="tf-example",
            availability_zone=zones.zones[4].name,
        ...
        dst_example = tencentcloud.sqlserver.BasicInstance("dst_example",
            name="tf-example",
            availability_zone=zones.zones[4].name,
            charge_type="POSTPAID_BY_HOUR",
            vpc_id=vpc.id,
        ...
        src = tencentcloud.sqlserver.Db("src",
            instance_id=src_example.id,
            name="tf_example_db_src",
            charset="Chinese_PRC_BIN",
            remark="testACC-remark")
        dst = tencentcloud.sqlserver.Db("dst",
            instance_id=dst_example.id,
            name="tf_example_db_dst",
            charset="Chinese_PRC_BIN",
            remark="testACC-remark")
        src_account = tencentcloud.sqlserver.Account("src",
            instance_id=src_example.id,
            name="tf_example_src_account",
            password="Qwer@234",
            is_admin=True)
        dst_account = tencentcloud.sqlserver.Account("dst",
            instance_id=dst_example.id,
            name="tf_example_dst_account",
            password="Qwer@234",
            is_admin=True)
        src_account_db_attachment = tencentcloud.sqlserver.AccountDbAttachment("src",
            instance_id=src_example.id,
            account_name=src_account.name,
            db_name=src.name,
            privilege="ReadWrite")
        dst_account_db_attachment = tencentcloud.sqlserver.AccountDbAttachment("dst",
            instance_id=dst_example.id,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['MigrationMigrateDbSetArgs', 'MigrationMigrateDbSetArgsDict']]]] migrate_db_sets: Migrate DB objects. Offline migration is not used (SourceType=4 or SourceType=5).
        :param pulumi.Input[_builtins.str] migrate_name: Name of the migration task.
        :param pulumi.Input[_builtins.int] migrate_type: Migration type (1 structure migration 2 data migration 3 incremental synchronization).
        :param pulumi.Input[Sequence[pulumi.Input[Union['MigrationRenameRestoreArgs', 'MigrationRenameRestoreArgsDict']]]] rename_restores: Restore and rename the database in ReNameRestoreDatabase. If it is not filled in, the restored database will be named by default and all databases will be restored. Valid if SourceType=5.
        :param pulumi.Input[Union['MigrationSourceArgs', 'MigrationSourceArgsDict']] source: Migration source.
        :param pulumi.Input[_builtins.int] source_type: Type of migration source 1 TencentDB for SQLServer 2 Cloud server self-built SQLServer database 4 SQLServer backup and restore 5 SQLServer backup and restore (COS mode).
        :param pulumi.Input[Union['MigrationTargetArgs', 'MigrationTargetArgsDict']] target: Migration target.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            source: pulumi.Input[Optional[Union['MigrationSourceArgs', 'MigrationSourceArgsDict']]] = None,
            source_type: pulumi.Input[Optional[_builtins.int]] = None,
            target: pulumi.Input[Optional[Union['MigrationTargetArgs', 'MigrationTargetArgsDict']]] = None) -> 'Migration':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="migrateName")
    def migrate_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the migration task.
        """
        return pulumi.get(self, "migrate_name")
    ...
    @_builtins.property
    @pulumi.getter(name="migrateType")
    def migrate_type(self) -> pulumi.Output[_builtins.int]:
        """
        Migration type (1 structure migration 2 data migration 3 incremental synchronization).
        """
        return pulumi.get(self, "migrate_type")
