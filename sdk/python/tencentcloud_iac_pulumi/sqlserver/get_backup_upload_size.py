...
def get_backup_upload_size_output(backup_migration_id: pulumi.Input[Optional[_builtins.str]] = None,
                                  incremental_migration_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
