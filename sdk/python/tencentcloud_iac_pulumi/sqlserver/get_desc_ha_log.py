...
class GetDescHaLogResult:
    ...
    def switch_type(self) -> _builtins.int | None:
...
def get_desc_ha_log(
    ...
    switch_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Sqlserver/getDescHaLog:getDescHaLog",
        __args__,
        opts=opts,
        typ=GetDescHaLogResult,
    ).value
...
def get_desc_ha_log_output(
    ...
    switch_type: pulumi.Input[_builtins.int | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetDescHaLogResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetDescHaLogResult(
            end_time=pulumi.get(__response__, "end_time"),
            id=pulumi.get(__response__, "id"),
            instance_id=pulumi.get(__response__, "instance_id"),
            result_output_file=pulumi.get(__response__, "result_output_file"),
            start_time=pulumi.get(__response__, "start_time"),
            switch_logs=pulumi.get(__response__, "switch_logs"),
            switch_type=pulumi.get(__response__, "switch_type"),
        )
    )
