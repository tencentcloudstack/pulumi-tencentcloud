...
class GetDescHaLogResult:
    ...
    def switch_type(self) -> Optional[_builtins.int]:
...
def get_desc_ha_log(end_time: Optional[_builtins.str] = None,
                    instance_id: Optional[_builtins.str] = None,
                    result_output_file: Optional[_builtins.str] = None,
                    start_time: Optional[_builtins.str] = None,
                    switch_type: Optional[_builtins.int] = None,
...
def get_desc_ha_log_output(end_time: Optional[pulumi.Input[_builtins.str]] = None,
                           instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                           result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           start_time: Optional[pulumi.Input[_builtins.str]] = None,
                           switch_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDescHaLogResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Sqlserver/getDescHaLog:getDescHaLog', __args__, opts=opts, typ=GetDescHaLogResult)
    return __ret__.apply(lambda __response__: GetDescHaLogResult(
