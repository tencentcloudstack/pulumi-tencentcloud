...
__all__ = ["AccountDbAttachment", "AccountDbAttachmentArgs"]
...
class AccountDbAttachmentArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] account_name: SQL Server account name.
        :param pulumi.Input[_builtins.str] db_name: SQL Server DB name.
        :param pulumi.Input[_builtins.str] instance_id: SQL Server instance ID that the account belongs to.
        :param pulumi.Input[_builtins.str] privilege: Privilege of the account on DB. Valid values: `ReadOnly`, `ReadWrite`.
        """
...
@pulumi.type_token("tencentcloud:Sqlserver/accountDbAttachment:AccountDbAttachment")
class AccountDbAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_account = tencentcloud.sqlserver.Account("example",
            ...
            password="Qwer@234",
            remark="test-remark")
        example_account_db_attachment = tencentcloud.sqlserver.AccountDbAttachment("example",
            instance_id=example.id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            AccountDbAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
