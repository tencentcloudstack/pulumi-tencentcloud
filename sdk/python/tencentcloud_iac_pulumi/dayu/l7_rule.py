...
class L7RuleArgs:
    def __init__(__self__, *,
                 ...
                 health_check_code: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def health_check_code(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def health_check_code(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _L7RuleState:
    def __init__(__self__, *,
                 ...
                 source_lists: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="sourceLists")
    def source_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Source list of the rule, it can be a set of ip sources or a set of domain sources. The number of items ranges from 1 to 16.
        """
        return pulumi.get(self, "source_lists")
    ...
    @source_lists.setter
    def source_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "source_lists", value)
...
class L7Rule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_id: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.int]] = None,
            switch: pulumi.Input[Optional[_builtins.bool]] = None) -> 'L7Rule':
        """
