...
class GetL4RulesV2Result:
    ...
    def virtual_port(self) -> _builtins.int | None:
        """
...
def get_l4_rules_v2(
    ...
    virtual_port: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Dayu/getL4RulesV2:getL4RulesV2",
        __args__,
        opts=opts,
        typ=GetL4RulesV2Result,
    ).value
...
def get_l4_rules_v2_output(
...
) -> pulumi.Output[GetL4RulesV2Result]:
    """
    Use this data source to query dayu new layer 4 rules
    ...
    return __ret__.apply(
        lambda __response__: GetL4RulesV2Result(
