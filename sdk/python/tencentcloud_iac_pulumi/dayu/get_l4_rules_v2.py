...
class GetL4RulesV2Result:
    ...
    def virtual_port(self) -> Optional[_builtins.int]:
        """
...
def get_l4_rules_v2(business: Optional[_builtins.str] = None,
                    ip: Optional[_builtins.str] = None,
                    result_output_file: Optional[_builtins.str] = None,
                    virtual_port: Optional[_builtins.int] = None,
...
def get_l4_rules_v2_output(business: Optional[pulumi.Input[_builtins.str]] = None,
                           ip: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           virtual_port: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetL4RulesV2Result]:
    """
    Use this data source to query dayu new layer 4 rules
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dayu/getL4RulesV2:getL4RulesV2', __args__, opts=opts, typ=GetL4RulesV2Result)
    return __ret__.apply(lambda __response__: GetL4RulesV2Result(
        ...
        virtual_port=pulumi.get(__response__, 'virtual_port')))
