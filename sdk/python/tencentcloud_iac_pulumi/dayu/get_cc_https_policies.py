...
def get_cc_https_policies(name: Optional[_builtins.str] = None,
...
def get_cc_https_policies_output(name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCcHttpsPoliciesResult]:
    """
    Use this data source to query dayu CC https policies
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Dayu/getCcHttpsPolicies:getCcHttpsPolicies', __args__, opts=opts, typ=GetCcHttpsPoliciesResult)
    return __ret__.apply(lambda __response__: GetCcHttpsPoliciesResult(
