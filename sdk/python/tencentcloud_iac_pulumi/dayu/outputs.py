...
class CcHttpPolicyRuleList(dict):
    def __init__(__self__, *,
                 ...
                 skey: Optional[_builtins.str] = None,
                 value: Optional[_builtins.str] = None):
        """
        :param _builtins.str operator: Operator of the rule. Valid values: `include`, `not_include`, `equal`.
        :param _builtins.str skey: Key of the rule. Valid values: `host`, `cgi`, `ua`, `referer`.
        :param _builtins.str value: Rule value, then length should be less than 31 bytes.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def skey(self) -> Optional[_builtins.str]:
        """
...
class CcHttpsPolicyRuleList(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str operator: Operator of the rule. Valid values are `include` and `equal`.
        :param _builtins.str skey: Key of the rule. Valid values are `cgi`, `ua` and `referer`.
        :param _builtins.str value: Rule value, then length should be less than 31 bytes.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "skey", skey)
...
class CcPolicyV2CcBlackWhiteIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str black_white_ip: Blacklist and whitelist IP addresses.
        :param _builtins.str domain: Domain.
        :param _builtins.str protocol: Protocol.
        :param _builtins.str type: IP type, value [black(blacklist IP), white (whitelist IP)].
    ...
    def black_white_ip(self) -> _builtins.str:
        """
...
class CcPolicyV2CcGeoIpPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 modify_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str action: User action, drop or arg.
        :param _builtins.str domain: domain.
        :param _builtins.str protocol: Protocol, preferably HTTP, HTTPS.
        :param _builtins.str region_type: Regional types, divided into china, oversea and customized.
        :param Sequence[_builtins.int] area_lists: The list of region IDs that the user selects to block.
        :param _builtins.str create_time: Create time.
        :param _builtins.str modify_time: Modify time.
        """
...
class CcPolicyV2CcPrecisionPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str policy_action: Policy mode (discard or captcha).
    ...
    def policy_action(self) -> _builtins.str:
        """
...
class CcPolicyV2CcPrecisionPolicyPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str field_name: Configuration item types, currently only support value.
        :param _builtins.str field_type: Configuration fields with the desirable values cgi, ua, cookie, referer, accept, srcip.
        :param _builtins.str value: Configure the value.
        :param _builtins.str value_operator: Configure the item-value comparison mode, which can be taken as the value of evaluate, not_equal, include.
        """
...
class CcPolicyV2CcPrecisionReqLimit(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str domain: Domain.
        :param _builtins.str level: Protection rating, the optional value of default means default policy, loose means loose, and strict means strict.
...
class CcPolicyV2CcPrecisionReqLimitPolicy(dict):
    ...
    def __init__(__self__, *,
                 action: _builtins.str,
                 execute_duration: _builtins.int,
                 mode: _builtins.str,
                 period: _builtins.int,
                 request_num: _builtins.int,
                 cookie: Optional[_builtins.str] = None,
                 uri: Optional[_builtins.str] = None,
                 user_agent: Optional[_builtins.str] = None):
        """
        :param _builtins.str action: The frequency limit policy mode, the optional value of arg indicates the verification code, and drop indicates the discard.
        :param _builtins.int execute_duration: The duration of the frequency limit policy can be taken from 1 to 86400 per second.
        :param _builtins.str mode: The policy item is compared, and the optional value include indicates inclusion, and equal means equal.
        :param _builtins.int period: Statistical period, take values 1, 10, 30, 60, in seconds.
        :param _builtins.int request_num: The number of requests, the value is 1 to 20000.
        :param _builtins.str cookie: Cookies, one of the three policy entries can only be filled in.
        :param _builtins.str uri: Uri, one of the three policy entries can only be filled in.
        :param _builtins.str user_agent: User-Agent, only one of the three policy entries can be filled in.
        """
        pulumi.set(__self__, "action", action)
    ...
    def execute_duration(self) -> _builtins.int:
        """
    ...
    def request_num(self) -> _builtins.int:
        """
...
class CcPolicyV2Threshold(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str domain: domain.
        :param _builtins.int threshold: Cleaning threshold, -1 indicates that the `default` mode is turned on.
        """
        pulumi.set(__self__, "domain", domain)
...
class DdosIpAttachmentV2BoundIpList(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip: IP address.
        :param _builtins.str biz_type: Category of product that can be bound. Valid values: public (CVM and CLB), bm (BM), eni (ENI), vpngw (VPN gateway), natgw (NAT gateway), waf (WAF), fpc (financial products), gaap (GAAP), and other (hosted IP). This field is required when you perform binding.
        :param _builtins.str device_type: Sub-product category. Valid values: cvm (CVM), lb (Load balancer), eni (ENI), vpngw (VPN gateway), natgw (NAT gateway), waf (WAF), fpc (financial products), gaap (GAAP), eip (BM EIP) and other (managed IP). This field is required when you perform binding.
        :param _builtins.str instance_id: Anti-DDoS instance ID of the IP. This field is required only when the instance is bound to an IP. For example, this field InstanceId will be eni-* if the instance ID is bound to an ENI IP; none if there is no instance to bind to a managed IP.
        """
        pulumi.set(__self__, "ip", ip)
...
class DdosPolicyDropOption(dict):
    ...
    def __init__(__self__, *,
                 bad_conn_threshold: _builtins.int,
                 check_sync_conn: _builtins.bool,
                 conn_timeout: _builtins.int,
                 d_conn_limit: _builtins.int,
                 d_new_limit: _builtins.int,
                 drop_abroad: _builtins.bool,
                 drop_icmp: _builtins.bool,
                 drop_other: _builtins.bool,
                 drop_tcp: _builtins.bool,
                 drop_udp: _builtins.bool,
                 icmp_mbps_limit: _builtins.int,
                 null_conn_enable: _builtins.bool,
                 other_mbps_limit: _builtins.int,
                 s_conn_limit: _builtins.int,
                 s_new_limit: _builtins.int,
                 syn_limit: _builtins.int,
                 tcp_mbps_limit: _builtins.int,
                 udp_mbps_limit: _builtins.int,
                 syn_rate: Optional[_builtins.int] = None):
        """
        :param _builtins.int bad_conn_threshold: The number of new connections based on destination IP that trigger suppression of connections. Valid value ranges: (0~4294967295).
        :param _builtins.bool check_sync_conn: Indicate whether to check null connection or not.
        :param _builtins.int conn_timeout: Connection timeout of abnormal connection check. Valid value ranges: (0~65535).
        :param _builtins.int d_conn_limit: The limit of concurrent connections based on destination IP. Valid value ranges: (0~4294967295).
        :param _builtins.int d_new_limit: The limit of new connections based on destination IP. Valid value ranges: (0~4294967295).
        :param _builtins.bool drop_abroad: Indicate whether to drop abroad traffic or not.
        :param _builtins.bool drop_icmp: Indicate whether to drop ICMP protocol or not.
        :param _builtins.bool drop_other: Indicate whether to drop other protocols(exclude TCP/UDP/ICMP) or not.
        :param _builtins.bool drop_tcp: Indicate whether to drop TCP protocol or not.
        :param _builtins.bool drop_udp: Indicate to drop UDP protocol or not.
        :param _builtins.int icmp_mbps_limit: The limit of ICMP traffic rate. Valid value ranges: (0~4294967295)(Mbps).
        :param _builtins.bool null_conn_enable: Indicate to enable null connection or not.
        :param _builtins.int other_mbps_limit: The limit of other protocols(exclude TCP/UDP/ICMP) traffic rate. Valid value ranges: (0~4294967295)(Mbps).
        :param _builtins.int s_conn_limit: The limit of concurrent connections based on source IP. Valid value ranges: (0~4294967295).
        :param _builtins.int s_new_limit: The limit of new connections based on source IP. Valid value ranges: (0~4294967295).
        :param _builtins.int syn_limit: The limit of syn of abnormal connection check. Valid value ranges: (0~100).
        :param _builtins.int tcp_mbps_limit: The limit of TCP traffic. Valid value ranges: (0~4294967295)(Mbps).
        :param _builtins.int udp_mbps_limit: The limit of UDP traffic rate. Valid value ranges: (0~4294967295)(Mbps).
        :param _builtins.int syn_rate: The percentage of syn in ack of abnormal connection check. Valid value ranges: (0~100).
        """
    ...
    def bad_conn_threshold(self) -> _builtins.int:
        """
    ...
    def check_sync_conn(self) -> _builtins.bool:
        """
    ...
    def conn_timeout(self) -> _builtins.int:
        """
    ...
    def d_conn_limit(self) -> _builtins.int:
        """
    ...
    def d_new_limit(self) -> _builtins.int:
        """
    ...
    def drop_abroad(self) -> _builtins.bool:
        """
    ...
    def drop_icmp(self) -> _builtins.bool:
        """
    ...
    def drop_other(self) -> _builtins.bool:
        """
    ...
    def drop_tcp(self) -> _builtins.bool:
        """
    ...
    def drop_udp(self) -> _builtins.bool:
        """
    ...
    def icmp_mbps_limit(self) -> _builtins.int:
        """
    ...
    def null_conn_enable(self) -> _builtins.bool:
        """
    ...
    def other_mbps_limit(self) -> _builtins.int:
        """
    ...
    def s_conn_limit(self) -> _builtins.int:
        """
    ...
    def s_new_limit(self) -> _builtins.int:
        """
    ...
    def syn_limit(self) -> _builtins.int:
        """
    ...
    def tcp_mbps_limit(self) -> _builtins.int:
        """
    ...
    def udp_mbps_limit(self) -> _builtins.int:
        """
    ...
    def syn_rate(self) -> Optional[_builtins.int]:
        """
...
class DdosPolicyPacketFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 d_end_port: Optional[_builtins.int] = None,
                 d_start_port: Optional[_builtins.int] = None,
                 depth: Optional[_builtins.int] = None,
                 is_include: Optional[_builtins.bool] = None,
                 match_begin: Optional[_builtins.str] = None,
                 match_str: Optional[_builtins.str] = None,
                 match_type: Optional[_builtins.str] = None,
                 offset: Optional[_builtins.int] = None,
                 pkt_length_max: Optional[_builtins.int] = None,
                 pkt_length_min: Optional[_builtins.int] = None,
                 protocol: Optional[_builtins.str] = None,
                 s_end_port: Optional[_builtins.int] = None,
                 s_start_port: Optional[_builtins.int] = None):
        """
        :param _builtins.str action: Action of port to take. Valid values: `drop`, `drop_black`,`drop_rst`,`drop_black_rst`,`transmit`.`drop`(drop the packet), `drop_black`(drop the packet and black the ip),`drop_rst`(drop the packet and disconnect),`drop_black_rst`(drop the packet, black the ip and disconnect),`transmit`(transmit the packet).
        :param _builtins.int d_end_port: End port of the destination. Valid value ranges: (0~65535). It must be greater than `d_start_port`.
        :param _builtins.int d_start_port: Start port of the destination. Valid value ranges: (0~65535).
        :param _builtins.int depth: The depth of match. Valid value ranges: (0~1500).
        :param _builtins.bool is_include: Indicate whether to include the key word/regular expression or not.
        :param _builtins.str match_begin: Indicate whether to check load or not, `begin_l5` means to match and `no_match` means not.
        :param _builtins.str match_str: The key word or regular expression.
        :param _builtins.str match_type: Match type. Valid values: `sunday` and `pcre`. `sunday` means key word match while `pcre` means regular match.
        :param _builtins.int offset: The offset of match. Valid value ranges: (0~1500).
        :param _builtins.int pkt_length_max: The max length of the packet. Valid value ranges: (0~1500)(Mbps). It must be greater than `pkt_length_min`.
        :param _builtins.int pkt_length_min: The minimum length of the packet. Valid value ranges: (0~1500)(Mbps).
        :param _builtins.str protocol: Protocol. Valid values: `tcp`, `udp`, `icmp`, `all`.
        :param _builtins.int s_end_port: End port of the source. Valid value ranges: (0~65535). It must be greater than `s_start_port`.
        :param _builtins.int s_start_port: Start port of the source. Valid value ranges: (0~65535).
        """
    ...
    def d_end_port(self) -> Optional[_builtins.int]:
        """
    ...
    def d_start_port(self) -> Optional[_builtins.int]:
        """
    ...
    def is_include(self) -> Optional[_builtins.bool]:
        """
    ...
    def match_str(self) -> Optional[_builtins.str]:
        """
    ...
    def pkt_length_max(self) -> Optional[_builtins.int]:
        """
    ...
    def pkt_length_min(self) -> Optional[_builtins.int]:
        """
    ...
    def s_end_port(self) -> Optional[_builtins.int]:
        """
    ...
    def s_start_port(self) -> Optional[_builtins.int]:
        """
...
class DdosPolicyPortFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kind: Optional[_builtins.int] = None,
                 protocol: Optional[_builtins.str] = None,
                 start_port: Optional[_builtins.int] = None):
        """
        :param _builtins.str action: Action of port to take. Valid values: `drop`, `transmit`.
        :param _builtins.int end_port: End port. Valid value ranges: (0~65535). It must be greater than `start_port`.
        :param _builtins.int kind: The type of forbidden port. Valid values: `0`, `1`, `2`. `0` for destination ports make effect, `1` for source ports make effect. `2` for both destination and source ports.
        :param _builtins.str protocol: Protocol. Valid values are `tcp`, `udp`, `icmp`, `all`.
        :param _builtins.int start_port: Start port. Valid value ranges: (0~65535).
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    @_builtins.property
    @pulumi.getter
    def kind(self) -> Optional[_builtins.int]:
        """
...
class DdosPolicyV2Acl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Action, optional values: drop, transmit, forward.
        :param _builtins.int d_port_end: The destination port ends, and the value range is 0~65535.
        :param _builtins.int d_port_start: The destination port starts, and the value range is 0~65535.
        :param _builtins.str forward_protocol: Protocol type, desirable values tcp, udp, all.
        :param _builtins.int priority: Policy priority, the lower the number, the higher the level, the higher the rule matches, taking a value of 1-1000.Note: This field may return null, indicating that a valid value could not be retrieved.
        :param _builtins.int s_port_end: The source port ends, and the acceptable value ranges from 0 to 65535.
        :param _builtins.int s_port_start: The source port starts, and the value range is 0~65535.
        """
        pulumi.set(__self__, "action", action)
...
class DdosPolicyV2BlackWhiteIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip: Ip of resource instance.
        :param _builtins.str ip_type: IP type, value [`black`(blacklist IP), `white` (whitelist IP)].
        """
        pulumi.set(__self__, "ip", ip)
...
class DdosPolicyV2DdosConnectLimit(dict):
    ...
    def __init__(__self__, *,
                 bad_conn_threshold: _builtins.int,
                 conn_timeout: _builtins.int,
                 dst_conn_limit: _builtins.int,
                 dst_new_limit: _builtins.int,
                 null_conn_enable: _builtins.int,
                 sd_conn_limit: _builtins.int,
                 sd_new_limit: _builtins.int,
                 syn_limit: _builtins.int,
                 syn_rate: _builtins.int):
        """
        :param _builtins.int bad_conn_threshold: Based on connection suppression trigger threshold, value range [0,4294967295].
        :param _builtins.int conn_timeout: Abnormal connection detection condition, connection timeout, value range [0,65535].
        :param _builtins.int dst_conn_limit: Concurrent connection control based on destination IP+ destination port.
        :param _builtins.int dst_new_limit: Limit on the number of news per second based on the destination IP.
        :param _builtins.int null_conn_enable: Abnormal connection detection conditions, empty connection guard switch, value range[0,1].
        :param _builtins.int sd_conn_limit: Concurrent connection control based on source IP + destination IP.
        :param _builtins.int sd_new_limit: The limit on the number of news per second based on source IP + destination IP.
        :param _builtins.int syn_limit: Anomaly connection detection condition, syn threshold, value range [0,100].
        :param _builtins.int syn_rate: Anomalous connection detection condition, percentage of syn ack, value range [0,100].
        """
        pulumi.set(__self__, "bad_conn_threshold", bad_conn_threshold)
        pulumi.set(__self__, "conn_timeout", conn_timeout)
    ...
    def dst_conn_limit(self) -> _builtins.int:
        """
    ...
    def dst_new_limit(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="nullConnEnable")
    def null_conn_enable(self) -> _builtins.int:
        """
    ...
    def sd_conn_limit(self) -> _builtins.int:
        """
    ...
    def sd_new_limit(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="synRate")
    def syn_rate(self) -> _builtins.int:
        """
...
class DdosPolicyV2DdosGeoIpBlockConfig(dict):
    ...
    def __init__(__self__, *,
                 action: _builtins.str,
                 area_lists: Sequence[_builtins.int],
                 region_type: _builtins.str):
        """
        :param _builtins.str action: Block action, take the value [`drop`, `trans`].
        :param Sequence[_builtins.int] area_lists: When the RegionType is customized, the AreaList must be filled in, and a maximum of 128 must be filled in.
        :param _builtins.str region_type: Zone type, value [oversea (overseas),china (domestic),customized (custom region)].
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "area_lists", area_lists)
        pulumi.set(__self__, "region_type", region_type)
    ...
    @_builtins.property
    @pulumi.getter(name="areaLists")
    def area_lists(self) -> Sequence[_builtins.int]:
        """
...
class DdosPolicyV2DdosSpeedLimitConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dst_port_list: _builtins.str,
                 mode: _builtins.int,
                 packet_rate: _builtins.int,
                 protocol_list: _builtins.str):
        """
        :param _builtins.int bandwidth: Bandwidth bps.
        :param _builtins.str dst_port_list: List of port ranges, up to 8, multiple; Separated, the range is represented with -; this port range must be filled in; fill in the style 1:0-65535, style 2:80; 443; 1000-2000.
        :param _builtins.int mode: Speed limit mode, take the value [1 (speed limit based on source IP),2 (speed limit based on destination port)].
        :param _builtins.int packet_rate: Packet rate pps.
        :param _builtins.str protocol_list: IP protocol numbers, take the value[ ALL (all protocols),TCP (tcp protocol),UDP (udp protocol),SMP (smp protocol),1; 2-100 (custom protocol number range, up to 8)].
        """
    ...
    def dst_port_list(self) -> _builtins.str:
        """
    ...
    def packet_rate(self) -> _builtins.int:
        """
        Packet rate pps.
        """
    ...
    def protocol_list(self) -> _builtins.str:
        """
...
class DdosPolicyV2PacketFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 d_port_start: _builtins.int,
                 depth: _builtins.int,
                 depth2: _builtins.int,
                 is_not: _builtins.int,
                 is_not2: _builtins.int,
                 match_begin: _builtins.str,
                 match_begin2: _builtins.str,
                 match_logic: _builtins.str,
                 match_type: _builtins.str,
                 match_type2: _builtins.str,
                 offset: _builtins.int,
                 offset2: _builtins.int,
                 ...
                 str2: _builtins.str):
        """
        :param _builtins.str action: Action, take the value [drop,transmit,drop_black (discard and black out),drop_rst (Interception),drop_black_rst (intercept and block),forward].
        :param _builtins.int d_port_end: The end destination port, take the value 1~65535, which must be greater than or equal to the starting destination port.
        :param _builtins.int d_port_start: From the destination port, take the value 0~65535.
        :param _builtins.int depth: Detection depth from the detection position, value [0,1500].
        :param _builtins.int depth2: Second detection depth starting from the second detection position, value [0,1500].
        :param _builtins.int is_not: Whether to include the detected value, take the value [0 (included),1 (not included)].
        :param _builtins.int is_not2: Whether the second detection contains the detected value, the value [0 (included),1 (not included)].
        :param _builtins.str match_begin: Detect position, take the value [begin_l3 (IP header),begin_l4 (TCP/UDP header),begin_l5 (T load), no_match (mismatch)].
        :param _builtins.str match_begin2: The second detection position. take the value [begin_l3 (IP header),begin_l4 (TCP/UDP header),begin_l5 (T load), no_match (mismatch)].
        :param _builtins.str match_logic: When there is a second detection condition, the and/or relationship with the first detection condition, takes the value [And (and relationship),none (fill in this value when there is no second detection condition)].
        :param _builtins.str match_type: Detection type, value [sunday (keyword),pcre (regular expression)].
        :param _builtins.str match_type2: The second type of detection, takes the value [sunday (keyword),pcre (regular expression)].
        :param _builtins.int offset: Offset from detection position, value range [0, Depth].
        :param _builtins.int offset2: Offset from the second detection position, value range [0,Depth2].
        :param _builtins.int pktlen_max: The maximum message length, taken from 1 to 1500, must be greater than or equal to the minimum message length.
        :param _builtins.int pktlen_min: Minimum message length, 1-1500.
        :param _builtins.str protocol: Protocol, value [tcp udp icmp all].
        :param _builtins.int s_port_end: End source port, take the value 1~65535, must be greater than or equal to the starting source port.
        :param _builtins.int s_port_start: Start the source port, take the value 0~65535.
        :param _builtins.str str: Detect values, key strings or regular expressions, take the value [When the detection type is sunday, please fill in the string or hexadecimal bytecode, for example 13233 corresponds to the hexadecimal bytecode of the string `123`;When the detection type is pcre, please fill in the regular expression string;].
    ...
    def is_not2(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="matchBegin")
    def match_begin(self) -> _builtins.str:
        """
    ...
    def match_begin2(self) -> _builtins.str:
        """
    ...
    def match_logic(self) -> _builtins.str:
        """
    ...
    def match_type2(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def offset2(self) -> _builtins.int:
        """
...
class DdosPolicyV2ProtocolBlockConfig(dict):
    ...
    def __init__(__self__, *,
                 drop_icmp: _builtins.int,
                 drop_other: _builtins.int,
                 drop_tcp: _builtins.int,
                 drop_udp: _builtins.int):
        """
        :param _builtins.int drop_icmp: ICMP block, value [0 (block off), 1 (block on)].
        :param _builtins.int drop_other: Other block, value [0 (block off), 1 (block on)].
        :param _builtins.int drop_tcp: TCP block, value [0 (block off), 1 (block on)].
        :param _builtins.int drop_udp: UDP block, value [0 (block off), 1 (block on)].
        """
        pulumi.set(__self__, "drop_icmp", drop_icmp)
        pulumi.set(__self__, "drop_other", drop_other)
        pulumi.set(__self__, "drop_tcp", drop_tcp)
    ...
    @_builtins.property
    @pulumi.getter(name="dropIcmp")
    def drop_icmp(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dropOther")
    def drop_other(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dropTcp")
    def drop_tcp(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dropUdp")
    def drop_udp(self) -> _builtins.int:
        """
...
class DdosPolicyV2WaterPrintConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int offset: Watermark offset, value range: [0-100].
        :param _builtins.int open_status: Whether it is enabled, value [0 (manual open), 1 (immediate operation)].
        :param _builtins.str verify: Watermark check mode, value [`checkall`(normal mode), `shortfpcheckall`(simplified mode)].
        """
    ...
    def open_status(self) -> _builtins.int:
        """
...
class DdosPolicyV2WaterPrintConfigListener(dict):
    ...
    def __init__(__self__, *,
                 ...
                 frontend_port_end: _builtins.int):
        """
        :param _builtins.str forward_protocol: Forwarding protocol, value [TCP, UDP].
        :param _builtins.int frontend_port: Lower limit of forwarding listening port. Values: [1-65535].
        :param _builtins.int frontend_port_end: Upper limit of forwarding listening port. Values: [1-65535].
        """
        pulumi.set(__self__, "forward_protocol", forward_protocol)
    ...
    def frontend_port_end(self) -> _builtins.int:
        """
...
class DdosPolicyWatermarkFilter(dict):
    ...
    def __init__(__self__, *,
                 auto_remove: Optional[_builtins.bool] = None,
                 offset: Optional[_builtins.int] = None,
                 open_switch: Optional[_builtins.bool] = None,
                 tcp_port_lists: Optional[Sequence[_builtins.str]] = None,
                 udp_port_lists: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool auto_remove: Indicate whether to auto-remove the watermark or not.
        :param _builtins.int offset: The offset of watermark. Valid value ranges: (0~1500).
        :param _builtins.bool open_switch: Indicate whether to open watermark or not. It muse be set `true` when any field of watermark was set.
        :param Sequence[_builtins.str] tcp_port_lists: Port range of TCP, the format is like `2000-3000`.
        :param Sequence[_builtins.str] udp_port_lists: Port range of TCP, the format is like `2000-3000`.
        """
    ...
    def auto_remove(self) -> Optional[_builtins.bool]:
        """
    ...
    def open_switch(self) -> Optional[_builtins.bool]:
        """
    ...
    def tcp_port_lists(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def udp_port_lists(self) -> Optional[Sequence[_builtins.str]]:
        """
        Port range of TCP, the format is like `2000-3000`.
        """
...
class DdosPolicyWatermarkKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 open_switch: Optional[_builtins.bool] = None):
        """
        :param _builtins.str content: Content of the watermark.
        :param _builtins.str create_time: Create time of the DDoS policy.
        :param _builtins.str id: Id of the watermark.
        :param _builtins.bool open_switch: Indicate whether to auto-remove the watermark or not.
        """
...
class L4RuleSourceList(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str source: Source IP or domain, valid format of ip is like `1.1.1.1` and valid format of host source is like `abc.com`.
        :param _builtins.int weight: Weight of the source, the valid value ranges from 0 to 100.
        """
...
class L4RuleV2Rules(dict):
    ...
    def __init__(__self__, *,
                 keep_enable: _builtins.bool,
                 keeptime: _builtins.int,
                 lb_type: _builtins.int,
                 protocol: _builtins.str,
                 region: _builtins.int,
                 remove_switch: _builtins.bool,
        ...
        """
        :param _builtins.bool keep_enable: session hold switch.
        :param _builtins.int keeptime: The keeptime of the layer 4 rule.
        :param _builtins.int lb_type: LB type of the rule, `1` for weight cycling and `2` for IP hash.
        :param _builtins.str protocol: Protocol of the rule.
        :param _builtins.int region: Corresponding regional information.
        :param _builtins.bool remove_switch: Remove the watermark state.
        :param _builtins.str rule_name: Name of the rule.
        :param Sequence['L4RuleV2RulesSourceListArgs'] source_lists: Source list of the rule.
        :param _builtins.int source_port: The source port of the layer 4 rule.
        :param _builtins.int source_type: Source type, `1` for source of host, `2` for source of IP.
        :param _builtins.int virtual_port: The virtual port of the layer 4 rule.
        """
    ...
    def keep_enable(self) -> _builtins.bool:
        """
        session hold switch.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def keeptime(self) -> _builtins.int:
        """
    ...
    def lb_type(self) -> _builtins.int:
        """
    ...
    def remove_switch(self) -> _builtins.bool:
        """
    ...
    def virtual_port(self) -> _builtins.int:
        """
...
class L4RuleV2RulesSourceList(dict):
    def __init__(__self__, *,
                 ...
                 weight: _builtins.int):
        """
        :param _builtins.str source: Source IP or domain.
        :param _builtins.int weight: Weight of the source.
        """
        pulumi.set(__self__, "source", source)
        pulumi.set(__self__, "weight", weight)
...
class L7RuleV2Rule(dict):
    ...
    def __init__(__self__, *,
                 domain: _builtins.str,
                 keep_enable: _builtins.int,
                 keeptime: _builtins.int,
                 lb_type: _builtins.int,
                 protocol: _builtins.str,
                 source_lists: Sequence['outputs.L7RuleV2RuleSourceList'],
                 source_type: _builtins.int,
                 cc_enable: Optional[_builtins.int] = None,
                 cert_type: Optional[_builtins.int] = None,
                 https_to_http_enable: Optional[_builtins.int] = None,
                 ssl_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str domain: Domain of the rule.
        :param _builtins.int keep_enable: session hold switch.
        :param _builtins.int keeptime: The keeptime of the layer 4 rule.
        :param _builtins.int lb_type: LB type of the rule, `1` for weight cycling and `2` for IP hash.
        :param _builtins.str protocol: Protocol of the rule.
        :param _builtins.int source_type: Source type, `1` for source of host, `2` for source of IP.
        :param _builtins.int cc_enable: HTTPS protocol CC protection status, value [0 (off), 1 (on)], defaule is 0.
        :param _builtins.int cert_type: The source of the certificate must be filled in when the forwarding protocol is https, the value [2 (Tencent Cloud Hosting Certificate)], and 0 when the forwarding protocol is http.
        :param _builtins.int https_to_http_enable: Whether to enable the Https protocol to use Http back-to-source, take the value [0 (off), 1 (on)], do not fill in the default is off, defaule is 0.
        :param _builtins.str ssl_id: When the certificate source is a Tencent Cloud managed certificate, this field must be filled in with the managed certificate ID.
        """
        pulumi.set(__self__, "domain", domain)
        pulumi.set(__self__, "keep_enable", keep_enable)
        pulumi.set(__self__, "keeptime", keeptime)
    ...
    @_builtins.property
    @pulumi.getter(name="keepEnable")
    def keep_enable(self) -> _builtins.int:
        """
        session hold switch.
        """
        return pulumi.get(self, "keep_enable")
    ...
    def cc_enable(self) -> Optional[_builtins.int]:
        """
    ...
    def cert_type(self) -> Optional[_builtins.int]:
        """
    ...
    def https_to_http_enable(self) -> Optional[_builtins.int]:
        """
    ...
    def ssl_id(self) -> Optional[_builtins.str]:
        """
...
class GetCcHttpPoliciesListResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Action mode.
        :param _builtins.str create_time: Create time of the CC self-define http policy.
        :param _builtins.int frequency: Max frequency per minute.
        :param Sequence[_builtins.str] ip_lists: IP of the CC self-define http policy.
        ...
        :param _builtins.str smode: Match mode.
        :param _builtins.bool switch: Indicate the CC self-define http policy takes effect or not.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "create_time", create_time)
...
class GetCcHttpPoliciesListRuleListResult(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str operator: Operator of the rule.
        :param _builtins.str skey: Key of the rule.
        :param _builtins.str value: Rule value.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "skey", skey)
        pulumi.set(__self__, "value", value)
...
class GetCcHttpsPoliciesListResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: Action mode.
        :param _builtins.str create_time: Create time of the CC self-define https policy.
        :param _builtins.str domain: Domain that the CC self-define https policy works for.
        :param Sequence[_builtins.str] ip_lists: Ip of the CC self-define https policy.
        :param _builtins.str name: Name of the CC https policy to be queried.
        :param _builtins.str policy_id: Id of the CC https policy to be queried.
        :param _builtins.str resource_id: Id of the resource that the CC https policy works for.
        :param _builtins.str resource_type: Type of the resource that the CC https policy works for, valid value is `bgpip`.
        :param _builtins.str rule_id: Rule id of the domain that the CC self-define https policy works for.
        :param Sequence['GetCcHttpsPoliciesListRuleListArgs'] rule_lists: Rule list of the CC self-define https policy.
        :param _builtins.bool switch: Indicate the CC self-define https policy takes effect or not.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "create_time", create_time)
        pulumi.set(__self__, "domain", domain)
...
class GetDdosPoliciesListResult(dict):
    def __init__(__self__, *,
                 ...
                 black_ips: Optional[Sequence[_builtins.str]] = None,
                 white_ips: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str create_time: Create time of the DDoS policy.
        :param Sequence['GetDdosPoliciesListDropOptionArgs'] drop_options: Option list of abnormal check of the DDoS policy.
        :param _builtins.str name: Name of the DDoS policy.
        ...
        :param _builtins.str scene_id: Id of policy case that the DDoS policy works for.
        ...
        :param Sequence[_builtins.str] black_ips: Black ip list.
        :param Sequence[_builtins.str] white_ips: White ip list.
        """
        pulumi.set(__self__, "create_time", create_time)
    ...
    def black_ips(self) -> Optional[Sequence[_builtins.str]]:
        """
        Black ip list.
        """
    ...
    def white_ips(self) -> Optional[Sequence[_builtins.str]]:
        """
        White ip list.
        """
...
class GetDdosPoliciesListDropOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 udp_mbps_limit: _builtins.int):
        """
        :param _builtins.int bad_conn_threshold: The number of new connections based on destination IP that trigger suppression of connections.
        :param _builtins.bool check_sync_conn: Indicate whether to check null connection or not.
        :param _builtins.int conn_timeout: Connection timeout of abnormal connection check.
        :param _builtins.int d_conn_limit: The limit of concurrent connections based on destination IP.
        :param _builtins.int d_new_limit: The limit of new connections based on destination IP.
        :param _builtins.bool drop_abroad: Indicate whether to drop abroad traffic or not.
        :param _builtins.bool drop_icmp: Indicate whether to drop ICMP protocol or not.
        :param _builtins.bool drop_other: Indicate whether to drop other protocols(exclude TCP/UDP/ICMP) or not.
        :param _builtins.bool drop_tcp: Indicate whether to drop TCP protocol or not.
        :param _builtins.bool drop_udp: Indicate to drop UDP protocol or not.
        :param _builtins.int icmp_mbps_limit: The limit of ICMP traffic rate.
        :param _builtins.bool null_conn_enable: Indicate to enable null connection or not.
        :param _builtins.int other_mbps_limit: The limit of other protocols(exclude TCP/UDP/ICMP) traffic rate.
        :param _builtins.int s_conn_limit: The limit of concurrent connections based on source IP.
        :param _builtins.int s_new_limit: The limit of new connections based on source IP.
        :param _builtins.int syn_limit: The limit of syn of abnormal connection check.
        :param _builtins.int syn_rate: The percentage of syn in ack of abnormal connection check.
        :param _builtins.int tcp_mbps_limit: The limit of TCP traffic.
        :param _builtins.int udp_mbps_limit: The limit of UDP traffic rate.
        """
        pulumi.set(__self__, "bad_conn_threshold", bad_conn_threshold)
        pulumi.set(__self__, "check_sync_conn", check_sync_conn)
        pulumi.set(__self__, "conn_timeout", conn_timeout)
...
class GetDdosPoliciesListPacketFilterResult(dict):
    def __init__(__self__, *,
                 action: _builtins.str,
                 d_end_port: _builtins.int,
                 d_start_port: _builtins.int,
                 depth: _builtins.int,
                 is_include: _builtins.bool,
                 match_begin: _builtins.str,
                 match_str: _builtins.str,
                 match_type: _builtins.str,
                 offset: _builtins.int,
                 pkt_length_max: _builtins.int,
                 pkt_length_min: _builtins.int,
                 protocol: _builtins.str,
                 s_end_port: _builtins.int,
                 s_start_port: _builtins.int):
        """
        :param _builtins.str action: Action of port to take.
        :param _builtins.int d_end_port: End port of the destination.
        :param _builtins.int d_start_port: Start port of the destination.
        :param _builtins.int depth: The depth of match.
        :param _builtins.bool is_include: Indicate whether to include the key word/regular expression or not.
        :param _builtins.str match_begin: Indicate whether to check load or not.
        :param _builtins.str match_str: The key word or regular expression.
        :param _builtins.str match_type: Match type.
        :param _builtins.int offset: The offset of watermark.
        :param _builtins.int pkt_length_max: The max length of the packet.
        :param _builtins.int pkt_length_min: The minimum length of the packet.
        :param _builtins.str protocol: Protocol.
        :param _builtins.int s_end_port: End port of the source.
        :param _builtins.int s_start_port: Start port of the source.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "d_end_port", d_end_port)
        pulumi.set(__self__, "d_start_port", d_start_port)
    ...
    @_builtins.property
    @pulumi.getter(name="dEndPort")
    def d_end_port(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dStartPort")
    def d_start_port(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="isInclude")
    def is_include(self) -> _builtins.bool:
        """
        Indicate whether to include the key word/regular expression or not.
        """
        return pulumi.get(self, "is_include")
    ...
    @_builtins.property
    @pulumi.getter(name="matchStr")
    def match_str(self) -> _builtins.str:
        """
        The key word or regular expression.
        """
        return pulumi.get(self, "match_str")
    ...
    @_builtins.property
    @pulumi.getter(name="pktLengthMax")
    def pkt_length_max(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="pktLengthMin")
    def pkt_length_min(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sEndPort")
    def s_end_port(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sStartPort")
    def s_start_port(self) -> _builtins.int:
        """
...
class GetDdosPoliciesListPortFilterResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.int kind: The type of forbidden port, and valid values are 0, 1, 2. 0 for destination port, 1 for source port and 2 for both destination and source posts.
        :param _builtins.str protocol: Protocol.
...
class GetDdosPoliciesListWatermarkFilterResult(dict):
    def __init__(__self__, *,
                 auto_remove: _builtins.bool,
                 offset: _builtins.int,
                 open_switch: _builtins.bool,
                 tcp_port_lists: Sequence[_builtins.str],
                 udp_port_lists: Sequence[_builtins.str]):
        """
        :param _builtins.bool auto_remove: Indicate whether to auto-remove the watermark or not.
        :param _builtins.int offset: The offset of watermark.
        :param _builtins.bool open_switch: Indicate whether to auto-remove the watermark or not.
        :param Sequence[_builtins.str] tcp_port_lists: Port range of TCP.
        :param Sequence[_builtins.str] udp_port_lists: Port range of TCP.
        """
        pulumi.set(__self__, "auto_remove", auto_remove)
        pulumi.set(__self__, "offset", offset)
        pulumi.set(__self__, "open_switch", open_switch)
    ...
    @_builtins.property
    @pulumi.getter(name="autoRemove")
    def auto_remove(self) -> _builtins.bool:
        """
        Indicate whether to auto-remove the watermark or not.
        """
        return pulumi.get(self, "auto_remove")
    ...
    @_builtins.property
    @pulumi.getter(name="openSwitch")
    def open_switch(self) -> _builtins.bool:
        """
        Indicate whether to auto-remove the watermark or not.
        """
        return pulumi.get(self, "open_switch")
    ...
    @_builtins.property
    @pulumi.getter(name="tcpPortLists")
    def tcp_port_lists(self) -> Sequence[_builtins.str]:
        """
        Port range of TCP.
        """
        return pulumi.get(self, "tcp_port_lists")
    ...
    @_builtins.property
    @pulumi.getter(name="udpPortLists")
    def udp_port_lists(self) -> Sequence[_builtins.str]:
        """
        Port range of TCP.
        """
        return pulumi.get(self, "udp_port_lists")
...
class GetDdosPolicyCasesListResult(dict):
    def __init__(__self__, *,
                 app_protocols: Sequence[_builtins.str],
                 app_type: _builtins.str,
                 create_time: _builtins.str,
                 has_abroad: _builtins.str,
                 has_initiate_tcp: _builtins.str,
                 has_initiate_udp: _builtins.str,
                 has_vpn: _builtins.str,
                 max_tcp_package_len: _builtins.str,
                 max_udp_package_len: _builtins.str,
                 min_tcp_package_len: _builtins.str,
                 min_udp_package_len: _builtins.str,
                 name: _builtins.str,
                 peer_tcp_port: _builtins.str,
                 peer_udp_port: _builtins.str,
                 platform_types: Sequence[_builtins.str],
                 resource_type: _builtins.str,
                 scene_id: _builtins.str,
                 tcp_end_port: _builtins.str,
                 tcp_footprint: _builtins.str,
                 tcp_start_port: _builtins.str,
                 udp_end_port: _builtins.str,
                 udp_footprint: _builtins.str,
                 udp_start_port: _builtins.str,
                 web_api_urls: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] app_protocols: App protocol set of the DDoS policy case.
        :param _builtins.str app_type: App type of the DDoS policy case.
        :param _builtins.str create_time: Create time of the DDoS policy case.
        :param _builtins.str has_abroad: Indicate whether the service involves overseas or not.
        :param _builtins.str has_initiate_tcp: Indicate whether the service actively initiates TCP requests or not.
        :param _builtins.str has_initiate_udp: Indicate whether the actively initiate UDP requests or not.
        :param _builtins.str has_vpn: Indicate whether the service involves VPN service or not.
        :param _builtins.str max_tcp_package_len: The max length of TCP message package.
        :param _builtins.str max_udp_package_len: The max length of UDP message package.
        :param _builtins.str min_tcp_package_len: The minimum length of TCP message package.
        :param _builtins.str min_udp_package_len: The minimum length of UDP message package.
        :param _builtins.str name: Name of the DDoS policy case.
        :param _builtins.str peer_tcp_port: The port that actively initiates TCP requests.
        :param _builtins.str peer_udp_port: The port that actively initiates UDP requests.
        :param Sequence[_builtins.str] platform_types: Platform set of the DDoS policy case.
        ...
        :param _builtins.str tcp_end_port: End port of the TCP service.
        :param _builtins.str tcp_footprint: The fixed signature of TCP protocol load.
        :param _builtins.str tcp_start_port: Start port of the TCP service.
        :param _builtins.str udp_end_port: End port of the UDP service.
        :param _builtins.str udp_footprint: The fixed signature of TCP protocol load.
        :param _builtins.str udp_start_port: Start port of the UDP service.
        :param Sequence[_builtins.str] web_api_urls: Web API url set.
        """
    ...
    def app_protocols(self) -> Sequence[_builtins.str]:
        """
    ...
    def has_abroad(self) -> _builtins.str:
        """
    ...
    def has_initiate_tcp(self) -> _builtins.str:
        """
    ...
    def has_initiate_udp(self) -> _builtins.str:
        """
    ...
    def has_vpn(self) -> _builtins.str:
        """
    ...
    def max_tcp_package_len(self) -> _builtins.str:
        """
    ...
    def max_udp_package_len(self) -> _builtins.str:
        """
    ...
    def min_tcp_package_len(self) -> _builtins.str:
        """
    ...
    def min_udp_package_len(self) -> _builtins.str:
        """
    ...
    def peer_tcp_port(self) -> _builtins.str:
        """
    ...
    def peer_udp_port(self) -> _builtins.str:
        """
    ...
    def platform_types(self) -> Sequence[_builtins.str]:
        """
    ...
    def tcp_end_port(self) -> _builtins.str:
        """
    ...
    def tcp_footprint(self) -> _builtins.str:
        """
    ...
    def tcp_start_port(self) -> _builtins.str:
        """
    ...
    def udp_end_port(self) -> _builtins.str:
        """
    ...
    def udp_footprint(self) -> _builtins.str:
        """
        The fixed signature of TCP protocol load.
        """
    ...
    def udp_start_port(self) -> _builtins.str:
        """
    ...
    def web_api_urls(self) -> Sequence[_builtins.str]:
        """
        Web API url set.
        """
...
class GetEipListResult(dict):
    def __init__(__self__, *,
                 ...
                 eip_address_status: _builtins.str,
                 eip_bound_rsc_eni: _builtins.str,
                 eip_bound_rsc_vip: _builtins.str,
                 eip_lists: Sequence[_builtins.str],
                 expired_time: _builtins.str,
                 modify_time: _builtins.str,
                 protection_status: _builtins.str,
                 region: _builtins.str,
                 eip_bound_rsc_ins: Optional[_builtins.str] = None,
                 instance_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str created_time: The created time of resource.
        :param _builtins.str eip_address_status: Eip PUBLIC IP status.
        :param _builtins.str eip_bound_rsc_eni: The ID of the bound ENI.
        :param _builtins.str eip_bound_rsc_vip: Bind the resource intranet IP.
        :param _builtins.str expired_time: The expired time of resource.
        :param _builtins.str modify_time: The modify time of resource.
        :param _builtins.str protection_status: The protection status of the asset instance.
        :param _builtins.str region: The region where the asset instance is located.
        :param _builtins.str eip_bound_rsc_ins: The ID of the resource instance for the binding.
        :param _builtins.str instance_id: ID of the resource instance.
        """
    ...
    def eip_address_status(self) -> _builtins.str:
        """
    ...
    def eip_bound_rsc_eni(self) -> _builtins.str:
        """
    ...
    def eip_bound_rsc_vip(self) -> _builtins.str:
        """
    ...
    def eip_bound_rsc_ins(self) -> Optional[_builtins.str]:
        """
...
class GetL4RulesListResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.int s_port: The source port of the layer 4 rule.
        :param _builtins.bool session_switch: Indicate that the session will keep or not.
        :param _builtins.int session_time: Session keep time, only valid when `session_switch` is true, the available value ranges from 1 to 300 and unit is second.
    ...
    def session_switch(self) -> _builtins.bool:
        """
    ...
    def session_time(self) -> _builtins.int:
        """
...
class GetL4RulesV2ListResult(dict):
    def __init__(__self__, *,
                 ...
                 virtual_port: _builtins.int):
        """
        :param _builtins.str id: Bind the resource ID information.
        :param _builtins.str ip: Ip of the resource.
        :param _builtins.bool keep_enable: session hold switch.
        :param _builtins.int keeptime: The keeptime of the layer 4 rule.
        :param _builtins.int lb_type: LB type of the rule, `1` for weight cycling and `2` for IP hash.
        :param _builtins.str modify_time: Rule modification time.
        :param _builtins.str protocol: Protocol of the rule.
        :param _builtins.int region: Corresponding regional information.
        :param _builtins.bool remove_switch: Remove the watermark state.
        :param _builtins.str rule_id: ID of the 4 layer rule.
        :param _builtins.str rule_name: Name of the rule.
        :param Sequence['GetL4RulesV2ListSourceListArgs'] source_lists: Source list of the rule.
        :param _builtins.int source_port: The source port of the layer 4 rule.
        :param _builtins.int source_type: Source type, `1` for source of host, `2` for source of IP.
        :param _builtins.int virtual_port: Virtual port of resource.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "ip", ip)
        pulumi.set(__self__, "keep_enable", keep_enable)
...
class GetL7RulesListResult(dict):
    def __init__(__self__, *,
                 domain: _builtins.str,
                 health_check_code: _builtins.int,
                 health_check_health_num: _builtins.int,
                 health_check_interval: _builtins.int,
                 ...
                 protocol: _builtins.str,
                 rule_id: _builtins.str,
                 source_lists: Sequence[_builtins.str],
                 source_type: _builtins.int,
        ...
        :param _builtins.int health_check_code: HTTP Status Code. `1` means the return value `1xx` is health. `2` means the return value `2xx` is health. `4` means the return value `3xx` is health. `8` means the return value `4xx` is health. `16` means the return value `5xx` is health. If you want multiple return codes to indicate health, need to add the corresponding values.
        :param _builtins.int health_check_health_num: Health threshold of health check.
        :param _builtins.int health_check_interval: Interval time of health check.
        :param _builtins.str health_check_method: Methods of health check.
        ...
        :param Sequence[_builtins.str] source_lists: Source list of the rule.
        :param _builtins.int source_type: Source type, 1 for source of host, 2 for source of ip.
        :param _builtins.str ssl_id: SSL id.
        :param _builtins.int status: Status of the rule. `0` for create/modify success, `2` for create/modify fail, `3` for delete success, `5` for waiting to be created/modified, `7` for waiting to be deleted and `8` for waiting to get SSL id.
        :param _builtins.bool switch: Indicate the rule will take effect or not.
        :param _builtins.int threshold: Threshold of the rule.
        """
        pulumi.set(__self__, "domain", domain)
    ...
    def health_check_code(self) -> _builtins.int:
        """
        HTTP Status Code. `1` means the return value `1xx` is health. `2` means the return value `2xx` is health. `4` means the return value `3xx` is health. `8` means the return value `4xx` is health. `16` means the return value `5xx` is health. If you want multiple return codes to indicate health, need to add the corresponding values.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceLists")
    def source_lists(self) -> Sequence[_builtins.str]:
        """
        Source list of the rule.
        """
        return pulumi.get(self, "source_lists")
...
class GetL7RulesV2ListResult(dict):
    def __init__(__self__, *,
                 cc_enable: _builtins.int,
                 cc_level: _builtins.str,
                 cc_status: _builtins.int,
                 cc_threshold: _builtins.int,
                 cert_type: _builtins.int,
                 domain: _builtins.str,
                 https_to_http_enable: _builtins.int,
                 id: _builtins.str,
                 ip: _builtins.str,
                 keep_enable: _builtins.int,
                 keep_time: _builtins.int,
                 lb_type: _builtins.int,
                 modify_time: _builtins.str,
                 protocol: _builtins.str,
                 region: _builtins.int,
                 ...
                 virtual_port: _builtins.int):
        """
        :param _builtins.int cc_enable: CC protection status of HTTPS protocol, the value is [0 (off), 1 (on)].
        :param _builtins.str cc_level: CC protection level of HTTPS protocol.
        :param _builtins.int cc_status: CC protection status, value [0(off), 1(on)].
        :param _builtins.int cc_threshold: CC protection threshold of HTTPS protocol.
        :param _builtins.int cert_type: The source of the certificate.
        :param _builtins.str domain: Domain of resource.
        :param _builtins.int https_to_http_enable: Whether to enable the Https protocol to use Http back-to-source, take the value [0 (off), 1 (on)], default is off.
        :param _builtins.str id: Id of the resource.
        :param _builtins.str ip: Ip of the resource.
        :param _builtins.int keep_enable: Session keep switch, value [0 (session keep closed), 1 (session keep open)].
        :param _builtins.int keep_time: Session hold time, in seconds.
        :param _builtins.int lb_type: Load balancing mode, the value is [1 (weighted round-robin)].
        :param _builtins.str modify_time: Modify time of resource.
        :param _builtins.str protocol: Protocol of resource, value range [`http`, `https`].
        :param _builtins.int region: The area code.
        :param _builtins.str rule_name: Rule description.
        :param Sequence['GetL7RulesV2ListSourceListArgs'] source_lists: Source list of the rule.
        :param _builtins.int source_type: Back-to-origin method, value [1 (domain name back-to-source), 2 (IP back-to-source)].
        :param _builtins.str ssl_id: SSL id of the resource.
        :param _builtins.int status: Rule status, value [0 (rule configuration is successful), 1 (rule configuration is in effect), 2 (rule configuration fails), 3 (rule deletion is in effect), 5 (rule deletion fails), 6 (rule is waiting to be configured), 7 (rule pending deletion), 8 (rule pending configuration certificate)].
        :param _builtins.int virtual_port: Virtual port of resource.
        """
        pulumi.set(__self__, "cc_enable", cc_enable)
    ...
    @_builtins.property
    @pulumi.getter(name="ccEnable")
    def cc_enable(self) -> _builtins.int:
        """
    ...
    def cc_level(self) -> _builtins.str:
        """
    ...
    def cc_threshold(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="certType")
    def cert_type(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="httpsToHttpEnable")
    def https_to_http_enable(self) -> _builtins.int:
        """
...
class GetL7RulesV2ListSourceListResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: _builtins.int):
        """
        :param _builtins.str source: Back-to-source IP or domain name.
        :param _builtins.int weight: Weight value, take value [0,100].
        """
        pulumi.set(__self__, "source", source)
        pulumi.set(__self__, "weight", weight)
