...
__all__ = ['DdosIpAttachmentV2', 'DdosIpAttachmentV2Args']

@pulumi.input_type
class DdosIpAttachmentV2Args:
    def __init__(__self__, *,
                 bgp_instance_id: pulumi.Input[_builtins.str],
                 bound_ip_lists: pulumi.Input[Optional[Sequence[pulumi.Input['DdosIpAttachmentV2BoundIpListArgs']]]] = None):
        """
        The set of arguments for constructing a DdosIpAttachmentV2 resource.

        :param pulumi.Input[_builtins.str] bgp_instance_id: Anti-DDoS instance ID.
    ...
    def bgp_instance_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def bgp_instance_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "bgp_instance_id", value)

    @_builtins.property
    @pulumi.getter(name="boundIpLists")
    def bound_ip_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosIpAttachmentV2BoundIpListArgs']]]]:
        """
    ...
    def bound_ip_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosIpAttachmentV2BoundIpListArgs']]]]):
...
class _DdosIpAttachmentV2State:
    def __init__(__self__, *,
                 bgp_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 bound_ip_lists: pulumi.Input[Optional[Sequence[pulumi.Input['DdosIpAttachmentV2BoundIpListArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="bgpInstanceId")
    def bgp_instance_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Anti-DDoS instance ID.
        """
        return pulumi.get(self, "bgp_instance_id")
    ...
    @bgp_instance_id.setter
    def bgp_instance_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "bgp_instance_id", value)
...
@pulumi.type_token("tencentcloud:Dayu/ddosIpAttachmentV2:DdosIpAttachmentV2")
class DdosIpAttachmentV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bgp_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 bound_ip_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosIpAttachmentV2BoundIpListArgs', 'DdosIpAttachmentV2BoundIpListArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        boundip = tencentcloud.dayu.DdosIpAttachmentV2("boundip",
            id="bgp-xxxxxx",
            bound_ip_lists=[{
                "ip": "1.1.1.1",
                "biz_type": "public",
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            bgp_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            bound_ip_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosIpAttachmentV2BoundIpListArgs', 'DdosIpAttachmentV2BoundIpListArgsDict']]]]] = None) -> 'DdosIpAttachmentV2':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="bgpInstanceId")
    def bgp_instance_id(self) -> pulumi.Output[_builtins.str]:
        """
        Anti-DDoS instance ID.
        """
        return pulumi.get(self, "bgp_instance_id")
