...
__all__ = ['DdosPolicy', 'DdosPolicyArgs']
...
class DdosPolicyArgs:
    def __init__(__self__, *,
                 ...
                 black_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 packet_filters: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPacketFilterArgs']]]] = None,
                 port_filters: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPortFilterArgs']]]] = None,
                 watermark_filters: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkFilterArgs']]]] = None,
                 white_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] resource_type: Type of the resource that the DDoS policy works for. Valid values: `bgpip`, `bgp`, `bgp-multip` and `net`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] black_ips: Black IP list.
        :param pulumi.Input[_builtins.str] name: Name of the DDoS policy. Length should between 1 and 32.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] white_ips: White IP list.
        """
    ...
    def black_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Black IP list.
        """
    ...
    @black_ips.setter
    def black_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def packet_filters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPacketFilterArgs']]]]:
        """
    ...
    def packet_filters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPacketFilterArgs']]]]):
        pulumi.set(self, "packet_filters", value)

    @_builtins.property
    @pulumi.getter(name="portFilters")
    def port_filters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPortFilterArgs']]]]:
        """
    ...
    @port_filters.setter
    def port_filters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPortFilterArgs']]]]):
        pulumi.set(self, "port_filters", value)

    @_builtins.property
    @pulumi.getter(name="watermarkFilters")
    def watermark_filters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkFilterArgs']]]]:
        """
    ...
    def watermark_filters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkFilterArgs']]]]):
        pulumi.set(self, "watermark_filters", value)

    @_builtins.property
    @pulumi.getter(name="whiteIps")
    def white_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        White IP list.
        """
    ...
    @white_ips.setter
    def white_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _DdosPolicyState:
    def __init__(__self__, *,
                 ...
                 drop_options: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyDropOptionArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 packet_filters: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyPacketFilterArgs']]]] = None,
                 ...
                 watermark_filters: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkFilterArgs']]]] = None,
                 watermark_keys: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkKeyArgs']]]] = None,
                 white_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: Name of the DDoS policy. Length should between 1 and 32.
        :param pulumi.Input[Sequence[pulumi.Input['DdosPolicyPacketFilterArgs']]] packet_filters: Message filter options list.
        :param pulumi.Input[_builtins.str] policy_id: Id of policy.
        :param pulumi.Input[Sequence[pulumi.Input['DdosPolicyPortFilterArgs']]] port_filters: Port limits of abnormal check of the DDos policy.
        :param pulumi.Input[_builtins.str] resource_type: Type of the resource that the DDoS policy works for. Valid values: `bgpip`, `bgp`, `bgp-multip` and `net`.
        :param pulumi.Input[_builtins.str] scene_id: Id of policy case that the DDoS policy works for.
        :param pulumi.Input[Sequence[pulumi.Input['DdosPolicyWatermarkFilterArgs']]] watermark_filters: Watermark policy options, and only support one watermark policy at most.
    ...
    @_builtins.property
    @pulumi.getter(name="dropOptions")
    def drop_options(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyDropOptionArgs']]]]:
        """
        Option list of abnormal check of the DDos policy, should set at least one policy.
        """
        return pulumi.get(self, "drop_options")
    ...
    @drop_options.setter
    def drop_options(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyDropOptionArgs']]]]):
        pulumi.set(self, "drop_options", value)
    ...
    def watermark_keys(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkKeyArgs']]]]:
        """
        Watermark content.
        """
    ...
    def watermark_keys(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DdosPolicyWatermarkKeyArgs']]]]):
...
@pulumi.type_token("tencentcloud:Dayu/ddosPolicy:DdosPolicy")
class DdosPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 black_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 drop_options: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyDropOptionArgs', 'DdosPolicyDropOptionArgsDict']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 packet_filters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyPacketFilterArgs', 'DdosPolicyPacketFilterArgsDict']]]]] = None,
                 port_filters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyPortFilterArgs', 'DdosPolicyPortFilterArgsDict']]]]] = None,
                 resource_type: pulumi.Input[Optional[_builtins.str]] = None,
                 watermark_filters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyWatermarkFilterArgs', 'DdosPolicyWatermarkFilterArgsDict']]]]] = None,
                 white_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        test_policy = tencentcloud.dayu.DdosPolicy("test_policy",
            resource_type="bgpip",
            name="tf_test_policy",
            black_ips=["1.1.1.1"],
            white_ips=["2.2.2.2"],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] black_ips: Black IP list.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyDropOptionArgs', 'DdosPolicyDropOptionArgsDict']]]] drop_options: Option list of abnormal check of the DDos policy, should set at least one policy.
        :param pulumi.Input[_builtins.str] name: Name of the DDoS policy. Length should between 1 and 32.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyPacketFilterArgs', 'DdosPolicyPacketFilterArgsDict']]]] packet_filters: Message filter options list.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyPortFilterArgs', 'DdosPolicyPortFilterArgsDict']]]] port_filters: Port limits of abnormal check of the DDos policy.
        :param pulumi.Input[_builtins.str] resource_type: Type of the resource that the DDoS policy works for. Valid values: `bgpip`, `bgp`, `bgp-multip` and `net`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyWatermarkFilterArgs', 'DdosPolicyWatermarkFilterArgsDict']]]] watermark_filters: Watermark policy options, and only support one watermark policy at most.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] white_ips: White IP list.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            scene_id: pulumi.Input[Optional[_builtins.str]] = None,
            watermark_filters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyWatermarkFilterArgs', 'DdosPolicyWatermarkFilterArgsDict']]]]] = None,
            watermark_keys: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DdosPolicyWatermarkKeyArgs', 'DdosPolicyWatermarkKeyArgsDict']]]]] = None,
            white_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'DdosPolicy':
        """
        ...
        :param pulumi.Input[_builtins.str] scene_id: Id of policy case that the DDoS policy works for.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyWatermarkFilterArgs', 'DdosPolicyWatermarkFilterArgsDict']]]] watermark_filters: Watermark policy options, and only support one watermark policy at most.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DdosPolicyWatermarkKeyArgs', 'DdosPolicyWatermarkKeyArgsDict']]]] watermark_keys: Watermark content.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] white_ips: White IP list.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="blackIps")
    def black_ips(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Black IP list.
        """
        return pulumi.get(self, "black_ips")
    ...
    @_builtins.property
    @pulumi.getter(name="whiteIps")
    def white_ips(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        White IP list.
        """
        return pulumi.get(self, "white_ips")
