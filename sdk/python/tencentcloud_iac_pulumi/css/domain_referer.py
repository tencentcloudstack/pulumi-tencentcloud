...
class _DomainRefererState:
    def __init__(__self__, *,
                 allow_empty: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="allowEmpty")
    def allow_empty(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Allow blank referers, 0: not allowed, 1: allowed.
        """
        return pulumi.get(self, "allow_empty")
    ...
    @allow_empty.setter
    def allow_empty(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "allow_empty", value)
...
class DomainReferer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enable: pulumi.Input[Optional[_builtins.int]] = None,
            rules: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.int]] = None) -> 'DomainReferer':
        """
