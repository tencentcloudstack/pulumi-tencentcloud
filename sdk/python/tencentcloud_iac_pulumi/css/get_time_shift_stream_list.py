...
class GetTimeShiftStreamListResult:
    ...
    def stream_lists(
        self,
    ) -> Sequence["outputs.GetTimeShiftStreamListStreamListResult"]:
        """
...
def get_time_shift_stream_list(
    ...
    time_shift_stream_list = tencentcloud.css.get_time_shift_stream_list(start_time=1698768000,
        end_time=1698820641,
        stream_name="live",
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getTimeShiftStreamList:getTimeShiftStreamList",
        __args__,
        opts=opts,
        typ=GetTimeShiftStreamListResult,
    ).value
...
def get_time_shift_stream_list_output(
...
) -> pulumi.Output[GetTimeShiftStreamListResult]:
    """
    Use this data source to query detailed information of css time_shift_stream_list
    ...
    return __ret__.apply(
        lambda __response__: GetTimeShiftStreamListResult(
            ...
            stream_lists=pulumi.get(__response__, "stream_lists"),
