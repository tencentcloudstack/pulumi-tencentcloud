...
def get_time_shift_stream_list(domain: Optional[_builtins.str] = None,
...
def get_time_shift_stream_list_output(domain: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTimeShiftStreamListResult]:
    """
    Use this data source to query detailed information of css time_shift_stream_list
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Css/getTimeShiftStreamList:getTimeShiftStreamList', __args__, opts=opts, typ=GetTimeShiftStreamListResult)
    return __ret__.apply(lambda __response__: GetTimeShiftStreamListResult(
