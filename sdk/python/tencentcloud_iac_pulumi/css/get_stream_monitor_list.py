...
class GetStreamMonitorListResult:
    ...
    def live_stream_monitors(
        self,
    ) -> Sequence["outputs.GetStreamMonitorListLiveStreamMonitorResult"]:
        """
...
def get_stream_monitor_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getStreamMonitorList:getStreamMonitorList",
        __args__,
        opts=opts,
        typ=GetStreamMonitorListResult,
    ).value
...
def get_stream_monitor_list_output(
    ...
    return __ret__.apply(
        lambda __response__: GetStreamMonitorListResult(
