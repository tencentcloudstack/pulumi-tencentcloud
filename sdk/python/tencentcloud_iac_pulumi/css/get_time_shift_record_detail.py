...
class GetTimeShiftRecordDetailResult:
    ...
    def domain_group(self) -> _builtins.str | None:
    ...
    def record_lists(
        self,
    ) -> Sequence["outputs.GetTimeShiftRecordDetailRecordListResult"]:
        """
    ...
    def trans_code_id(self) -> _builtins.int | None:
...
def get_time_shift_record_detail(
    app_name: _builtins.str | None = None,
    domain: _builtins.str | None = None,
    domain_group: _builtins.str | None = None,
    ...
    trans_code_id: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getTimeShiftRecordDetail:getTimeShiftRecordDetail",
        __args__,
        opts=opts,
        typ=GetTimeShiftRecordDetailResult,
    ).value
...
def get_time_shift_record_detail_output(
    app_name: pulumi.Input[_builtins.str | None] = None,
    domain: pulumi.Input[_builtins.str | None] = None,
    domain_group: pulumi.Input[_builtins.str | None] = None,
    ...
    trans_code_id: pulumi.Input[_builtins.int | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetTimeShiftRecordDetailResult]:
    """
    Use this data source to query detailed information of css time_shift_record_detail
    ...
    return __ret__.apply(
        lambda __response__: GetTimeShiftRecordDetailResult(
