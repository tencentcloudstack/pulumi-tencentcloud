...
__all__ = ["WatermarkRuleAttachment", "WatermarkRuleAttachmentArgs"]
...
class WatermarkRuleAttachmentArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] app_name: rule app name.
        :param pulumi.Input[_builtins.str] domain_name: rule domain name.
        :param pulumi.Input[_builtins.str] stream_name: rule stream name.
        :param pulumi.Input[_builtins.int] template_id: The template Id can be acquired by the Id of `Css.Watermark`.
        """
...
@pulumi.type_token("tencentcloud:Css/watermarkRuleAttachment:WatermarkRuleAttachment")
class WatermarkRuleAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.css.PullStreamTask("example",
        ...
        example_watermark = tencentcloud.css.Watermark("example",
            ...
            width=0,
            height=0)
        watermark_rule_attachment = tencentcloud.css.WatermarkRuleAttachment("watermark_rule_attachment",
            domain_name=example.domain_name,
            app_name=example.app_name,
            stream_name=example.stream_name,
            template_id=example_watermark.id.apply(lambda x: int(x)))
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            WatermarkRuleAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
