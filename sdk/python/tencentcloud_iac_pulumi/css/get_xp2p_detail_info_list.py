...
class GetXp2pDetailInfoListResult:
    ...
    def data_info_lists(
        self,
    ) -> Sequence["outputs.GetXp2pDetailInfoListDataInfoListResult"]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def dimensions(self) -> Sequence[_builtins.str] | None:
    ...
    def query_time(self) -> _builtins.str | None:
    ...
    def stream_names(self) -> Sequence[_builtins.str] | None:
...
def get_xp2p_detail_info_list(
    dimensions: Sequence[_builtins.str] | None = None,
    query_time: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    stream_names: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getXp2pDetailInfoList:getXp2pDetailInfoList",
        __args__,
        opts=opts,
        typ=GetXp2pDetailInfoListResult,
    ).value
...
def get_xp2p_detail_info_list_output(
    dimensions: pulumi.Input[Sequence[_builtins.str] | None] = None,
    query_time: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    stream_names: pulumi.Input[Sequence[_builtins.str] | None] = None,
    types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetXp2pDetailInfoListResult]:
    """
    Use this data source to query detailed information of css xp2p_detail_info_list
    ...
    return __ret__.apply(
        lambda __response__: GetXp2pDetailInfoListResult(
