...
__all__ = ["PullStreamTaskRestart", "PullStreamTaskRestartArgs"]
...
class PullStreamTaskRestartArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] operator: Task operator.
...
@pulumi.type_token("tencentcloud:Css/pullStreamTaskRestart:PullStreamTaskRestart")
class PullStreamTaskRestart(pulumi.CustomResource):
    ...
    def __init__(
        ...
        restart_push_task = tencentcloud.css.PullStreamTaskRestart("restart_push_task",
            task_id="3573",
            operator="tf-test")
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            PullStreamTaskRestartArgs, pulumi.ResourceOptions, *args, **kwargs
        )
