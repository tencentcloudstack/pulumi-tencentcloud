...
class GetDomainsResult:
    ...
    def domain_status(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "domain_status")

    @_builtins.property
    @pulumi.getter(name="domainType")
    def domain_type(self) -> Optional[_builtins.int]:
    ...
    def is_delay_live(self) -> Optional[_builtins.int]:
        """
    ...
    def play_type(self) -> Optional[_builtins.int]:
        """
...
def get_domains(domain_prefix: Optional[_builtins.str] = None,
                domain_status: Optional[_builtins.int] = None,
                domain_type: Optional[_builtins.int] = None,
                is_delay_live: Optional[_builtins.int] = None,
                play_type: Optional[_builtins.int] = None,
    ...
    :param _builtins.str domain_prefix: domain name prefix.
    :param _builtins.int domain_status: domain name status filter. 0-disable, 1-enable.
    :param _builtins.int domain_type: Domain name type filtering. 0-push, 1-play.
...
def get_domains_output(domain_prefix: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                       domain_status: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                       domain_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                       is_delay_live: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                       play_type: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Css/getDomains:getDomains', __args__, opts=opts, typ=GetDomainsResult)
    return __ret__.apply(lambda __response__: GetDomainsResult(
        ...
        is_delay_live=pulumi.get(__response__, 'is_delay_live'),
        play_type=pulumi.get(__response__, 'play_type'),
