...
class GetDomainsResult:
    ...
    def is_delay_live(self) -> _builtins.int | None:
        """
    ...
    def play_type(self) -> _builtins.int | None:
        """
...
def get_domains(
    domain_prefix: _builtins.str | None = None,
    domain_status: _builtins.int | None = None,
    domain_type: _builtins.int | None = None,
    is_delay_live: _builtins.int | None = None,
    play_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getDomains:getDomains",
        __args__,
        opts=opts,
        typ=GetDomainsResult,
    ).value
...
def get_domains_output(
    domain_prefix: pulumi.Input[_builtins.str | None] = None,
    domain_status: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetDomainsResult]:
    """
    Use this data source to query detailed information of css domains
    ...
    return __ret__.apply(
        lambda __response__: GetDomainsResult(
