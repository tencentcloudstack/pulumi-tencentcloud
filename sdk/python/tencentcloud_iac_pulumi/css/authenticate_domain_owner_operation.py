...
__all__ = ["AuthenticateDomainOwnerOperation", "AuthenticateDomainOwnerOperationArgs"]
...
class AuthenticateDomainOwnerOperationArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] domain_name: The domain name to verify.
...
class AuthenticateDomainOwnerOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            AuthenticateDomainOwnerOperationArgs,
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = AuthenticateDomainOwnerOperationArgs.__new__(
                AuthenticateDomainOwnerOperationArgs
            )
    ...
    def get(
        ...
        domain_name: pulumi.Input[_builtins.str | None] = None,
        verify_type: pulumi.Input[_builtins.str | None] = None,
    ) -> "AuthenticateDomainOwnerOperation":
        """
        ...
        __props__ = _AuthenticateDomainOwnerOperationState.__new__(
            _AuthenticateDomainOwnerOperationState
        )

        __props__.__dict__["domain_name"] = domain_name
        __props__.__dict__["verify_type"] = verify_type
        return AuthenticateDomainOwnerOperation(
    ...
    @_builtins.property
    @pulumi.getter(name="verifyType")
    def verify_type(self) -> pulumi.Output[_builtins.str | None]:
        """
        Authentication type. Possible values:`dnsCheck`: Immediately verify whether the resolution record of the configured dns is consistent with the content to be verified, and save the record if successful.`fileCheck`: Immediately verify whether the web file is consistent with the content to be verified, and save the record if successful.`dbCheck`: Check if authentication has been successful.
        """
        return pulumi.get(self, "verify_type")
