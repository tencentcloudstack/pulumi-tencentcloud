...
class GetMonitorReportResult:
    ...
    def diagnose_results(
        self,
    ) -> Sequence["outputs.GetMonitorReportDiagnoseResultResult"]:
        """
...
def get_monitor_report(
    monitor_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Css/getMonitorReport:getMonitorReport",
        __args__,
        opts=opts,
        typ=GetMonitorReportResult,
    ).value
...
def get_monitor_report_output(
...
) -> pulumi.Output[GetMonitorReportResult]:
    """
    Use this data source to query detailed information of css monitor_report
    ...
    return __ret__.apply(
        lambda __response__: GetMonitorReportResult(
