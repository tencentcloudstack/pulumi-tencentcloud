...
class GetDedicatedClusterHostsResult:
    ...
    def host_info_sets(
        self,
    ) -> Sequence["outputs.GetDedicatedClusterHostsHostInfoSetResult"]:
        """
...
def get_dedicated_cluster_hosts(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cdc/getDedicatedClusterHosts:getDedicatedClusterHosts",
        __args__,
        opts=opts,
        typ=GetDedicatedClusterHostsResult,
    ).value
...
def get_dedicated_cluster_hosts_output(
...
) -> pulumi.Output[GetDedicatedClusterHostsResult]:
    """
    Use this data source to query detailed information of CDC dedicated cluster hosts
    ...
    return __ret__.apply(
        lambda __response__: GetDedicatedClusterHostsResult(
