...
def get_dedicated_cluster_orders_output(action_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        dedicated_cluster_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
