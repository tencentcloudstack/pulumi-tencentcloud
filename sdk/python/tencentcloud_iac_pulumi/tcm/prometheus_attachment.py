...
__all__ = ['PrometheusAttachment', 'PrometheusAttachmentArgs']
...
class _PrometheusAttachmentState:
    def __init__(__self__, *,
                 ...
                 prometheus: pulumi.Input[Optional['PrometheusAttachmentPrometheusArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def prometheus(self) -> pulumi.Input[Optional['PrometheusAttachmentPrometheusArgs']]:
        """
        Prometheus configuration.
        """
        return pulumi.get(self, "prometheus")
    ...
    @prometheus.setter
    def prometheus(self, value: pulumi.Input[Optional['PrometheusAttachmentPrometheusArgs']]):
        pulumi.set(self, "prometheus", value)


@pulumi.type_token("tencentcloud:Tcm/prometheusAttachment:PrometheusAttachment")
class PrometheusAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 mesh_id: pulumi.Input[Optional[_builtins.str]] = None,
                 prometheus: pulumi.Input[Optional[Union['PrometheusAttachmentPrometheusArgs', 'PrometheusAttachmentPrometheusArgsDict']]] = None,
                 __props__=None):
        """
        ...
        **NOTE:** If you use the config attribute prometheus in tencentcloud_tcm_mesh, do not use Tcm.PrometheusAttachment
        ...
        prometheus_attachment = tencentcloud.tcm.PrometheusAttachment("prometheus_attachment",
        ...
        :param pulumi.Input[_builtins.str] mesh_id: Mesh ID.
        :param pulumi.Input[Union['PrometheusAttachmentPrometheusArgs', 'PrometheusAttachmentPrometheusArgsDict']] prometheus: Prometheus configuration.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            mesh_id: pulumi.Input[Optional[_builtins.str]] = None,
            prometheus: pulumi.Input[Optional[Union['PrometheusAttachmentPrometheusArgs', 'PrometheusAttachmentPrometheusArgsDict']]] = None) -> 'PrometheusAttachment':
        """
