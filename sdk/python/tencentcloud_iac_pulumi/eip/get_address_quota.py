...
def get_address_quota(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eip/getAddressQuota:getAddressQuota",
        __args__,
        opts=opts,
        typ=GetAddressQuotaResult,
    ).value
...
def get_address_quota_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAddressQuotaResult(
