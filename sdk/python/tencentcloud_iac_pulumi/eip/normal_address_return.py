...
__all__ = ['NormalAddressReturn', 'NormalAddressReturnArgs']

@pulumi.input_type
class NormalAddressReturnArgs:
    def __init__(__self__, *,
                 address_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
        The set of arguments for constructing a NormalAddressReturn resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] address_ips: The IP address of the EIP, example: 101.35.139.183.
        """
    ...
    def address_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @address_ips.setter
    def address_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
@pulumi.type_token("tencentcloud:Eip/normalAddressReturn:NormalAddressReturn")
class NormalAddressReturn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            address_ips: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'NormalAddressReturn':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="addressIps")
    def address_ips(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The IP address of the EIP, example: 101.35.139.183.
        """
        return pulumi.get(self, "address_ips")
