...
__all__ = ['CenterExternalSamlIdentityProvider', 'CenterExternalSamlIdentityProviderArgs']
...
class _CenterExternalSamlIdentityProviderState:
    def __init__(__self__, *,
                 acs_url: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def acs_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Acs url.
        """
    ...
    @acs_url.setter
    def acs_url(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class CenterExternalSamlIdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            x509_certificate: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'CenterExternalSamlIdentityProvider':
        """
