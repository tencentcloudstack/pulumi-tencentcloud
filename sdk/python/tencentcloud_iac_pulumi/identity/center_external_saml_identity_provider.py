...
__all__ = [
    "CenterExternalSamlIdentityProvider",
    "CenterExternalSamlIdentityProviderArgs",
]
...
class _CenterExternalSamlIdentityProviderState:
    def __init__(
        __self__,
        *,
        acs_url: pulumi.Input[_builtins.str | None] = None,
        certificate_ids: pulumi.Input[
    ...
    def acs_url(self) -> pulumi.Input[_builtins.str | None]:
        """
        Acs url.
        """
    ...
    @acs_url.setter
    def acs_url(self, value: pulumi.Input[_builtins.str | None]):
...
class CenterExternalSamlIdentityProvider(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.identity.CenterExternalSamlIdentityProvider("example",
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = CenterExternalSamlIdentityProviderArgs.__new__(
                CenterExternalSamlIdentityProviderArgs
            )
    ...
    def get(
        ...
        __props__ = _CenterExternalSamlIdentityProviderState.__new__(
            _CenterExternalSamlIdentityProviderState
        )
        ...
        __props__.__dict__["x509_certificate"] = x509_certificate
        __props__.__dict__["zone_id"] = zone_id
        return CenterExternalSamlIdentityProvider(
