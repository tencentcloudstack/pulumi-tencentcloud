...
__all__ = [
    ...
    "CenterRoleConfigurationPermissionCustomPoliciesAttachmentArgs",
]
...
class CenterRoleConfigurationPermissionCustomPoliciesAttachment(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = (
                CenterRoleConfigurationPermissionCustomPoliciesAttachmentArgs.__new__(
                    CenterRoleConfigurationPermissionCustomPoliciesAttachmentArgs
                )
            )
    ...
    def get(
        ...
        __props__ = (
            _CenterRoleConfigurationPermissionCustomPoliciesAttachmentState.__new__(
                _CenterRoleConfigurationPermissionCustomPoliciesAttachmentState
            )
        )
        ...
        __props__.__dict__["role_configuration_id"] = role_configuration_id
        __props__.__dict__["zone_id"] = zone_id
        return CenterRoleConfigurationPermissionCustomPoliciesAttachment(
    ...
    def policies(
        ...
        Sequence[
            "outputs.CenterRoleConfigurationPermissionCustomPoliciesAttachmentPolicy"
        ]
    ]:
        """
        Policies.
