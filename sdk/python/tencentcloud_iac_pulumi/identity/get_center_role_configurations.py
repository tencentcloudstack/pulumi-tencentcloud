...
def get_center_role_configurations_output(filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          filter_targets: pulumi.Input[Optional[Optional[Sequence[_builtins.int]]]] = None,
