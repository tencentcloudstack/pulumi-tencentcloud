...
class GetCenterUsersResult:
    ...
    def filter_groups(self) -> Sequence[_builtins.str] | None:
    ...
    def user_status(self) -> _builtins.str | None:
        return pulumi.get(self, "user_status")

    @_builtins.property
    @pulumi.getter(name="userType")
    def user_type(self) -> _builtins.str | None:
...
def get_center_users(
    ...
    filter_groups: Sequence[_builtins.str] | None = None,
    result_output_file: _builtins.str | None = None,
    sort_field: _builtins.str | None = None,
    sort_type: _builtins.str | None = None,
    user_status: _builtins.str | None = None,
    user_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Identity/getCenterUsers:getCenterUsers",
        __args__,
        opts=opts,
        typ=GetCenterUsersResult,
    ).value
...
def get_center_users_output(
    filter: pulumi.Input[_builtins.str | None] = None,
    filter_groups: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetCenterUsersResult]:
    """
    Use this data source to query detailed information of identity center users
    ...
    return __ret__.apply(
        lambda __response__: GetCenterUsersResult(
