...
def get_center_groups_output(filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             filter_users: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
