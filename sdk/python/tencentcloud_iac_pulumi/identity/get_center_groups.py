...
class GetCenterGroupsResult:
    ...
    def filter_users(self) -> Sequence[_builtins.str] | None:
...
def get_center_groups(
    ...
    filter_users: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Identity/getCenterGroups:getCenterGroups",
        __args__,
        opts=opts,
        typ=GetCenterGroupsResult,
    ).value
...
def get_center_groups_output(
    filter: pulumi.Input[_builtins.str | None] = None,
    filter_users: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetCenterGroupsResult]:
    """
    Use this data source to query detailed information of identity center groups
    ...
    return __ret__.apply(
        lambda __response__: GetCenterGroupsResult(
