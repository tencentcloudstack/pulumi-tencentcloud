...
__all__ = ["CenterRoleAssignment", "CenterRoleAssignmentArgs"]
...
class CenterRoleAssignmentArgs:
    def __init__(
        ...
        *,
        ...
        deprovision_strategy: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def deprovision_strategy(self) -> pulumi.Input[_builtins.str | None]:
        """
        When you remove the last authorization configured with a certain privilege on a group account target account, whether to cancel the privilege configuration deployment at the same time. Value: DeprovisionForLastRoleAssignmentOnAccount: Remove privileges to configure deployment. None (default): Configure deployment without delegating privileges.
        """
    ...
    def deprovision_strategy(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] principal_id: Identity ID for the CAM user synchronization. Valid values:
               When the PrincipalType value is Group, it is the CIC user group ID (g-********).
               When the PrincipalType value is User, it is the CIC user ID (u-********).
        :param pulumi.Input[_builtins.str] principal_name: Principal name.
        :param pulumi.Input[_builtins.str] principal_type: Identity type for the CAM user synchronization. Valid values:

               User: indicates that the identity for the CAM user synchronization is a CIC user.
               Group: indicates that the identity for the CAM user synchronization is a CIC user group.
        :param pulumi.Input[_builtins.str] role_configuration_id: Permission configuration ID.
        :param pulumi.Input[_builtins.str] role_configuration_name: Role configuration name.
...
@pulumi.type_token("tencentcloud:Identity/centerRoleAssignment:CenterRoleAssignment")
class CenterRoleAssignment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.identity.CenterRoleAssignment("example",
            zone_id="z-1os7c9znogct",
            principal_id="u-lyfm8b7qoi5l",
            principal_type="User",
            target_uin=int(100043911945),
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CenterRoleAssignmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="deprovisionStrategy")
    def deprovision_strategy(self) -> pulumi.Output[_builtins.str | None]:
        """
        When you remove the last authorization configured with a certain privilege on a group account target account, whether to cancel the privilege configuration deployment at the same time. Value: DeprovisionForLastRoleAssignmentOnAccount: Remove privileges to configure deployment. None (default): Configure deployment without delegating privileges.
        """
        return pulumi.get(self, "deprovision_strategy")
