...
class _SslState:
    def __init__(__self__, *,
                 ...
                 ssl_config: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sslConfig")
    def ssl_config(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The SSL configuration status of the instance: `enabled`,`disabled`.
        """
        return pulumi.get(self, "ssl_config")
    ...
    @ssl_config.setter
    def ssl_config(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "ssl_config", value)
...
class Ssl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            ssl_config: pulumi.Input[Optional[_builtins.str]] = None) -> 'Ssl':
        """
