...
__all__ = ["MaintenanceWindow", "MaintenanceWindowArgs"]
...
class MaintenanceWindowArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] end_time: The end time of the maintenance window, e.g. 19:00.
        :param pulumi.Input[_builtins.str] instance_id: The ID of instance.
        :param pulumi.Input[_builtins.str] start_time: Maintenance window start time, e.g. 17:00.
        """
...
@pulumi.type_token("tencentcloud:Redis/maintenanceWindow:MaintenanceWindow")
class MaintenanceWindow(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.redis.Instance("example",
            ...
            vpc_id=vpc.id,
            subnet_id=subnet.id)
        example_maintenance_window = tencentcloud.redis.MaintenanceWindow("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            MaintenanceWindowArgs, pulumi.ResourceOptions, *args, **kwargs
        )
