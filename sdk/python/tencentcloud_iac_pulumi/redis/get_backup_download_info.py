...
class GetBackupDownloadInfoResult:
    ...
    def __init__(
        ...
        id=None,
        instance_id=None,
        ip_comparison_symbol=None,
        limit_ips=None,
        limit_type=None,
        limit_vpcs=None,
        result_output_file=None,
        vpc_comparison_symbol=None,
    ):
    ...
    def ip_comparison_symbol(self) -> _builtins.str | None:
        return pulumi.get(self, "ip_comparison_symbol")

    @_builtins.property
    @pulumi.getter(name="limitIps")
    def limit_ips(self) -> Sequence[_builtins.str] | None:
        return pulumi.get(self, "limit_ips")

    @_builtins.property
    @pulumi.getter(name="limitType")
    def limit_type(self) -> _builtins.str | None:
    ...
    def limit_vpcs(
        self,
    ) -> Sequence["outputs.GetBackupDownloadInfoLimitVpcResult"] | None:
    ...
    def vpc_comparison_symbol(self) -> _builtins.str | None:
...
def get_backup_download_info(
    backup_id: _builtins.str | None = None,
    instance_id: _builtins.str | None = None,
    ip_comparison_symbol: _builtins.str | None = None,
    limit_ips: Sequence[_builtins.str] | None = None,
    limit_type: _builtins.str | None = None,
    limit_vpcs: (
        Sequence[
            Union[
    ...
    vpc_comparison_symbol: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Redis/getBackupDownloadInfo:getBackupDownloadInfo",
        __args__,
        opts=opts,
        typ=GetBackupDownloadInfoResult,
    ).value
...
def get_backup_download_info_output(
    backup_id: pulumi.Input[_builtins.str | None] = None,
    instance_id: pulumi.Input[_builtins.str | None] = None,
    ip_comparison_symbol: pulumi.Input[_builtins.str | None] = None,
    limit_ips: pulumi.Input[Sequence[_builtins.str] | None] = None,
    limit_type: pulumi.Input[_builtins.str | None] = None,
    limit_vpcs: pulumi.Input[
        Sequence[
            Union[
                "GetBackupDownloadInfoLimitVpcArgs",
                "GetBackupDownloadInfoLimitVpcArgsDict",
    ...
    vpc_comparison_symbol: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetBackupDownloadInfoResult]:
    """
    Use this data source to query detailed information of redis backup_download_info
    ...
    return __ret__.apply(
        lambda __response__: GetBackupDownloadInfoResult(
