...
class GetInstanceZoneInfoResult:
    ...
    def replica_groups(
        self,
    ) -> Sequence["outputs.GetInstanceZoneInfoReplicaGroupResult"]:
        """
...
def get_instance_zone_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Redis/getInstanceZoneInfo:getInstanceZoneInfo",
        __args__,
        opts=opts,
        typ=GetInstanceZoneInfoResult,
    ).value
...
def get_instance_zone_info_output(
...
) -> pulumi.Output[GetInstanceZoneInfoResult]:
    """
    Use this data source to query detailed information of redis instance_zone_info
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceZoneInfoResult(
