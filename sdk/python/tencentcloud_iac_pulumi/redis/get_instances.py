...
def get_instances(limit: Optional[_builtins.int] = None,
...
def get_instances_output(limit: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Redis/getInstances:getInstances', __args__, opts=opts, typ=GetInstancesResult)
