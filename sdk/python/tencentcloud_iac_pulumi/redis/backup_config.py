    ...
    def __init__(
        ...
        *,
        ...
        if backup_periods is not None:
            warnings.warn(
                """It has been deprecated from version 1.58.2. It makes no difference to online config at all""",
                DeprecationWarning,
            )
            pulumi.log.warn(
                """backup_periods is deprecated: It has been deprecated from version 1.58.2. It makes no difference to online config at all"""
            )
        if backup_periods is not None:
...
class _BackupConfigState:
    def __init__(
        ...
        *,
        ...
        redis_id: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="redisId")
    def redis_id(self) -> pulumi.Input[_builtins.str | None]:
        """
        ID of a redis instance to which the policy will be applied.
        """
        return pulumi.get(self, "redis_id")
    ...
    @redis_id.setter
    def redis_id(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "redis_id", value)
