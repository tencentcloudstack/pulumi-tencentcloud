...
__all__ = ["ClearInstanceOperation", "ClearInstanceOperationArgs"]
...
class ClearInstanceOperationArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] password: Redis instance password (password-free instances do not need to pass passwords, non-password-free instances must be transmitted).
        """
...
@pulumi.type_token("tencentcloud:Redis/clearInstanceOperation:ClearInstanceOperation")
class ClearInstanceOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.redis.Instance("example",
            ...
            vpc_id=vpc.id,
            subnet_id=subnet.id)
        example_clear_instance_operation = tencentcloud.redis.ClearInstanceOperation("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ClearInstanceOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
