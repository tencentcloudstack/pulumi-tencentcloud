...
def get_backup(begin_time: Optional[_builtins.str] = None,
...
def get_backup_output(begin_time: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Redis/getBackup:getBackup', __args__, opts=opts, typ=GetBackupResult)
