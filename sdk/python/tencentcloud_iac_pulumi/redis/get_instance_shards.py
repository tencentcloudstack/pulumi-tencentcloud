...
class GetInstanceShardsResult:
    ...
    def filter_slave(self) -> Optional[_builtins.bool]:
...
def get_instance_shards(filter_slave: Optional[_builtins.bool] = None,
...
def get_instance_shards_output(filter_slave: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Redis/getInstanceShards:getInstanceShards', __args__, opts=opts, typ=GetInstanceShardsResult)
