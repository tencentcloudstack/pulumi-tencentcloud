...
def get_subscribe(limit: Optional[_builtins.int] = None,
...
def get_subscribe_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                         ...
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSubscribeResult]:
    """
    Use this data source to query detailed information of tcmq subscribe
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Tcmq/getSubscribe:getSubscribe', __args__, opts=opts, typ=GetSubscribeResult)
    return __ret__.apply(lambda __response__: GetSubscribeResult(
