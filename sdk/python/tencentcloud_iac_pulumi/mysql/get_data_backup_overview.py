...
def get_data_backup_overview(product: Optional[_builtins.str] = None,
...
def get_data_backup_overview_output(product: Optional[pulumi.Input[_builtins.str]] = None,
                                    result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataBackupOverviewResult]:
    """
    Use this data source to query detailed information of mysql data_backup_overview
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mysql/getDataBackupOverview:getDataBackupOverview', __args__, opts=opts, typ=GetDataBackupOverviewResult)
    return __ret__.apply(lambda __response__: GetDataBackupOverviewResult(
        auto_backup_count=pulumi.get(__response__, 'auto_backup_count'),
        auto_backup_volume=pulumi.get(__response__, 'auto_backup_volume'),
        data_backup_archive_count=pulumi.get(__response__, 'data_backup_archive_count'),
        data_backup_archive_volume=pulumi.get(__response__, 'data_backup_archive_volume'),
        data_backup_count=pulumi.get(__response__, 'data_backup_count'),
        data_backup_standby_count=pulumi.get(__response__, 'data_backup_standby_count'),
        data_backup_standby_volume=pulumi.get(__response__, 'data_backup_standby_volume'),
