...
class GetDataBackupOverviewResult:
    ...
    def __init__(
        __self__,
        auto_backup_count=None,
        auto_backup_volume=None,
        data_backup_archive_count=None,
        data_backup_archive_volume=None,
        data_backup_count=None,
        data_backup_standby_count=None,
        data_backup_standby_volume=None,
        data_backup_volume=None,
        id=None,
        manual_backup_count=None,
        manual_backup_volume=None,
        product=None,
        remote_backup_count=None,
        remote_backup_volume=None,
        ...
        if data_backup_archive_volume and not isinstance(
            data_backup_archive_volume, int
        ):
            raise TypeError(
                "Expected argument 'data_backup_archive_volume' to be a int"
            )
        ...
        if data_backup_standby_volume and not isinstance(
            data_backup_standby_volume, int
        ):
            raise TypeError(
                "Expected argument 'data_backup_standby_volume' to be a int"
            )
    ...
    def data_backup_archive_count(self) -> _builtins.int:
        """
    ...
    def data_backup_archive_volume(self) -> _builtins.int:
        """
    ...
    def data_backup_standby_count(self) -> _builtins.int:
        """
    ...
    def data_backup_standby_volume(self) -> _builtins.int:
        """
    ...
    def remote_backup_count(self) -> _builtins.int:
        """
    ...
    def remote_backup_volume(self) -> _builtins.int:
        """
...
def get_data_backup_overview(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getDataBackupOverview:getDataBackupOverview",
        __args__,
        opts=opts,
        typ=GetDataBackupOverviewResult,
    ).value
...
def get_data_backup_overview_output(
...
) -> pulumi.Output[GetDataBackupOverviewResult]:
    """
    Use this data source to query detailed information of mysql data_backup_overview
    ...
    return __ret__.apply(
        lambda __response__: GetDataBackupOverviewResult(
            auto_backup_count=pulumi.get(__response__, "auto_backup_count"),
            auto_backup_volume=pulumi.get(__response__, "auto_backup_volume"),
            data_backup_archive_count=pulumi.get(
                __response__, "data_backup_archive_count"
            ),
            data_backup_archive_volume=pulumi.get(
                __response__, "data_backup_archive_volume"
            ),
            data_backup_count=pulumi.get(__response__, "data_backup_count"),
            data_backup_standby_count=pulumi.get(
                __response__, "data_backup_standby_count"
            ),
            data_backup_standby_volume=pulumi.get(
                __response__, "data_backup_standby_volume"
            ),
            data_backup_volume=pulumi.get(__response__, "data_backup_volume"),
            id=pulumi.get(__response__, "id"),
            manual_backup_count=pulumi.get(__response__, "manual_backup_count"),
            manual_backup_volume=pulumi.get(__response__, "manual_backup_volume"),
            product=pulumi.get(__response__, "product"),
            remote_backup_count=pulumi.get(__response__, "remote_backup_count"),
            remote_backup_volume=pulumi.get(__response__, "remote_backup_volume"),
