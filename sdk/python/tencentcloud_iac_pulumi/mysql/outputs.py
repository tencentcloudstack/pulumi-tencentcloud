...
class ProxyAddressConfigProxyAllocation(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProxyAddressConfigProxyAllocation. Access the value via the '{suggest}' property getter instead.")
    ...
    def __init__(__self__, *,
                 proxy_instances: Sequence['outputs.ProxyAddressConfigProxyAllocationProxyInstance'],
                 region: _builtins.str,
                 zone: _builtins.str):
        """
    ...
    def proxy_instances(self) -> Sequence['outputs.ProxyAddressConfigProxyAllocationProxyInstance']:
        """
        Proxy instance list.
        """
...
class ProxyAddressConfigProxyAllocationProxyInstance(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ProxyAddressConfigProxyAllocationProxyInstance. Access the value via the '{suggest}' property getter instead.")
