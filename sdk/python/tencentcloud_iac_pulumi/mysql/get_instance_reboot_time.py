...
class GetInstanceRebootTimeResult:
    ...
    def __init__(
        __self__, id=None, instance_ids=None, items=None, result_output_file=None
    ):
...
def get_instance_reboot_time(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getInstanceRebootTime:getInstanceRebootTime",
        __args__,
        opts=opts,
        typ=GetInstanceRebootTimeResult,
    ).value
...
def get_instance_reboot_time_output(
...
) -> pulumi.Output[GetInstanceRebootTimeResult]:
    """
    Use this data source to query detailed information of mysql instance_reboot_time
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceRebootTimeResult(
