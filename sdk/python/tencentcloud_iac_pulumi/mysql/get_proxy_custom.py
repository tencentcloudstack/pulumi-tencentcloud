...
def get_proxy_custom(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getProxyCustom:getProxyCustom",
        __args__,
        opts=opts,
        typ=GetProxyCustomResult,
    ).value
...
def get_proxy_custom_output(
...
) -> pulumi.Output[GetProxyCustomResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetProxyCustomResult(
