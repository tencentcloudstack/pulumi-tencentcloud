...
class GetBackupListResult:
    ...
    def max_number(self) -> _builtins.int | None:
...
def get_backup_list(
    max_number: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getBackupList:getBackupList",
        __args__,
        opts=opts,
        typ=GetBackupListResult,
    ).value
...
def get_backup_list_output(
    max_number: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetBackupListResult]:
    """
    Use this data source to query the list of backup databases.
    ...
    return __ret__.apply(
        lambda __response__: GetBackupListResult(
