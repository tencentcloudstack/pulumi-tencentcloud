...
class GetUserTaskResult:
    ...
    def async_request_id(self) -> Optional[_builtins.str]:
        """
    ...
    def start_time_begin(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "start_time_begin")

    @_builtins.property
    @pulumi.getter(name="startTimeEnd")
    def start_time_end(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "start_time_end")

    @_builtins.property
    @pulumi.getter(name="taskStatuses")
    def task_statuses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_user_task(async_request_id: Optional[_builtins.str] = None,
                  instance_id: Optional[_builtins.str] = None,
                  result_output_file: Optional[_builtins.str] = None,
                  start_time_begin: Optional[_builtins.str] = None,
                  start_time_end: Optional[_builtins.str] = None,
                  task_statuses: Optional[Sequence[_builtins.str]] = None,
    ...
    user_task = tencentcloud.Mysql.get_user_task(instance_id="cdb-fitq5t9h",
...
def get_user_task_output(async_request_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         ...
                         start_time_begin: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         start_time_end: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                         task_statuses: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         task_types: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUserTaskResult]:
    """
    Use this data source to query detailed information of mysql user_task
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mysql/getUserTask:getUserTask', __args__, opts=opts, typ=GetUserTaskResult)
    return __ret__.apply(lambda __response__: GetUserTaskResult(
        async_request_id=pulumi.get(__response__, 'async_request_id'),
        id=pulumi.get(__response__, 'id'),
        instance_id=pulumi.get(__response__, 'instance_id'),
        items=pulumi.get(__response__, 'items'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        start_time_begin=pulumi.get(__response__, 'start_time_begin'),
        start_time_end=pulumi.get(__response__, 'start_time_end'),
