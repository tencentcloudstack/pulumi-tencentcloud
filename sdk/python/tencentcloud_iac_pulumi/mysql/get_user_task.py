...
class GetUserTaskResult:
    ...
    def async_request_id(self) -> _builtins.str | None:
        """
...
def get_user_task(
    async_request_id: _builtins.str | None = None,
    instance_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    start_time_begin: _builtins.str | None = None,
    start_time_end: _builtins.str | None = None,
    task_statuses: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getUserTask:getUserTask",
        __args__,
        opts=opts,
        typ=GetUserTaskResult,
    ).value
...
def get_user_task_output(
    async_request_id: pulumi.Input[_builtins.str | None] = None,
    instance_id: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    start_time_begin: pulumi.Input[_builtins.str | None] = None,
    start_time_end: pulumi.Input[_builtins.str | None] = None,
    task_statuses: pulumi.Input[Sequence[_builtins.str] | None] = None,
    task_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetUserTaskResult]:
    """
    Use this data source to query detailed information of mysql user_task
    ...
    return __ret__.apply(
        lambda __response__: GetUserTaskResult(
