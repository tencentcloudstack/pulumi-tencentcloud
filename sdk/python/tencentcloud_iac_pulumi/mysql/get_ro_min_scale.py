...
class GetRoMinScaleResult:
    ...
    def master_instance_id(self) -> _builtins.str | None:
    ...
    def ro_instance_id(self) -> _builtins.str | None:
...
def get_ro_min_scale(
    master_instance_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    ro_instance_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getRoMinScale:getRoMinScale",
        __args__,
        opts=opts,
        typ=GetRoMinScaleResult,
    ).value
...
def get_ro_min_scale_output(
...
) -> pulumi.Output[GetRoMinScaleResult]:
    """
    Use this data source to query detailed information of mysql ro_min_scale
    ...
    return __ret__.apply(
        lambda __response__: GetRoMinScaleResult(
