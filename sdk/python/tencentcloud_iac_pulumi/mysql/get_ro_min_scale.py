...
class GetRoMinScaleResult:
    ...
    def ro_instance_id(self) -> Optional[_builtins.str]:
...
def get_ro_min_scale(master_instance_id: Optional[_builtins.str] = None,
                     result_output_file: Optional[_builtins.str] = None,
                     ro_instance_id: Optional[_builtins.str] = None,
...
def get_ro_min_scale_output(master_instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            ro_instance_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRoMinScaleResult]:
    """
    Use this data source to query detailed information of mysql ro_min_scale
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mysql/getRoMinScale:getRoMinScale', __args__, opts=opts, typ=GetRoMinScaleResult)
    return __ret__.apply(lambda __response__: GetRoMinScaleResult(
        ...
        ro_instance_id=pulumi.get(__response__, 'ro_instance_id'),
