...
class GetProjectSecurityGroupResult:
    ...
    def __init__(
        __self__, groups=None, id=None, project_id=None, result_output_file=None
    ):
...
def get_project_security_group(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getProjectSecurityGroup:getProjectSecurityGroup",
        __args__,
        opts=opts,
        typ=GetProjectSecurityGroupResult,
    ).value
...
def get_project_security_group_output(
...
) -> pulumi.Output[GetProjectSecurityGroupResult]:
    """
    Use this data source to query detailed information of mysql project_security_group
    ...
    return __ret__.apply(
        lambda __response__: GetProjectSecurityGroupResult(
