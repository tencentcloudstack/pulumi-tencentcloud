...
class DeployGroupArgs:
    def __init__(__self__, *,
                 ...
                 dev_classes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 limit_num: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def dev_classes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    @dev_classes.setter
    def dev_classes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "dev_classes", value)

    @_builtins.property
    @pulumi.getter(name="limitNum")
    def limit_num(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @limit_num.setter
    def limit_num(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class DeployGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: pulumi.Input[Optional[_builtins.str]] = None,
            dev_classes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            limit_num: pulumi.Input[Optional[_builtins.int]] = None) -> 'DeployGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="devClasses")
    def dev_classes(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The device class of deploy group. optional value is SH12+SH02, TS85, etc.
        """
        return pulumi.get(self, "dev_classes")
    ...
    @_builtins.property
    @pulumi.getter(name="limitNum")
    def limit_num(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The limit on the number of instances on the same physical machine in deploy group affinity policy 1.
        """
        return pulumi.get(self, "limit_num")
