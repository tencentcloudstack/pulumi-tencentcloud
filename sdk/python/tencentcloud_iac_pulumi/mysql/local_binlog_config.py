...
__all__ = ["LocalBinlogConfig", "LocalBinlogConfigArgs"]
...
class LocalBinlogConfigArgs:
    def __init__(
        ...
        *,
        ...
        max_usage: pulumi.Input[_builtins.int],
        save_hours: pulumi.Input[_builtins.int]
    ):
        """
        The set of arguments for constructing a LocalBinlogConfig resource.

        :param pulumi.Input[_builtins.str] instance_id: Instance ID in the format of cdb-c1nl9rpv. It is the same as the instance ID displayed in the TencentDB console.
        :param pulumi.Input[_builtins.int] max_usage: Space utilization of local binlog. Value range: [30,50].
        :param pulumi.Input[_builtins.int] save_hours: Retention period of local binlog. Valid range: 72-168 hours. When there is disaster recovery instance, the valid range will be 120-168 hours.
        """
    ...
    def max_usage(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @max_usage.setter
    def max_usage(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "max_usage", value)

    @_builtins.property
    @pulumi.getter(name="saveHours")
    def save_hours(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @save_hours.setter
    def save_hours(self, value: pulumi.Input[_builtins.int]):
...
class _LocalBinlogConfigState:
    def __init__(
        ...
        *,
        ...
        max_usage: pulumi.Input[_builtins.int | None] = None,
        save_hours: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="maxUsage")
    def max_usage(self) -> pulumi.Input[_builtins.int | None]:
        """
        Space utilization of local binlog. Value range: [30,50].
        """
        return pulumi.get(self, "max_usage")
    ...
    @max_usage.setter
    def max_usage(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "max_usage", value)

    @_builtins.property
    @pulumi.getter(name="saveHours")
    def save_hours(self) -> pulumi.Input[_builtins.int | None]:
        """
        Retention period of local binlog. Valid range: 72-168 hours. When there is disaster recovery instance, the valid range will be 120-168 hours.
        """
        return pulumi.get(self, "save_hours")
    ...
    @save_hours.setter
    def save_hours(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "save_hours", value)


@pulumi.type_token("tencentcloud:Mysql/localBinlogConfig:LocalBinlogConfig")
class LocalBinlogConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_local_binlog_config = tencentcloud.mysql.LocalBinlogConfig("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            LocalBinlogConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="maxUsage")
    def max_usage(self) -> pulumi.Output[_builtins.int]:
        """
        Space utilization of local binlog. Value range: [30,50].
        """
        return pulumi.get(self, "max_usage")
    ...
    @_builtins.property
    @pulumi.getter(name="saveHours")
    def save_hours(self) -> pulumi.Output[_builtins.int]:
        """
        Retention period of local binlog. Valid range: 72-168 hours. When there is disaster recovery instance, the valid range will be 120-168 hours.
        """
        return pulumi.get(self, "save_hours")
