...
class _LocalBinlogConfigState:
    def __init__(__self__, *,
                 ...
                 save_hours: Optional[pulumi.Input[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="saveHours")
    def save_hours(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        Retention period of local binlog. Valid range: 72-168 hours. When there is disaster recovery instance, the valid range will be 120-168 hours.
        """
        return pulumi.get(self, "save_hours")
    ...
    @save_hours.setter
    def save_hours(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "save_hours", value)
...
class LocalBinlogConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            max_usage: Optional[pulumi.Input[_builtins.int]] = None,
            save_hours: Optional[pulumi.Input[_builtins.int]] = None) -> 'LocalBinlogConfig':
        """
