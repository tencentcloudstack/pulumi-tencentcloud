...
class GetDatabasesResult:
    ...
    def database_regexp(self) -> _builtins.str | None:
...
def get_databases(
    database_regexp: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getDatabases:getDatabases",
        __args__,
        opts=opts,
        typ=GetDatabasesResult,
    ).value
...
def get_databases_output(
    database_regexp: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetDatabasesResult(
