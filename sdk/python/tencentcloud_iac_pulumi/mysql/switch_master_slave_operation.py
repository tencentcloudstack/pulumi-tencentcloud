...
__all__ = ["SwitchMasterSlaveOperation", "SwitchMasterSlaveOperationArgs"]
...
class SwitchMasterSlaveOperationArgs:
    def __init__(
        ...
        *,
        ...
        dst_slave: pulumi.Input[_builtins.str | None] = None,
        force_switch: pulumi.Input[_builtins.bool | None] = None,
        wait_switch: pulumi.Input[_builtins.bool | None] = None
    ):
        """
        ...
        :param pulumi.Input[_builtins.str] dst_slave: target instance. Possible values: `first` - first standby; `second` - second standby. The default value is `first`, and only multi-AZ instances support setting it to `second`.
        :param pulumi.Input[_builtins.bool] force_switch: Whether to force switch. Default is False. Note that if you set the mandatory switch to True, there is a risk of data loss on the instance, so use it with caution.
        :param pulumi.Input[_builtins.bool] wait_switch: Whether to switch within the time window. The default is False, i.e. do not switch within the time window. Note that if the ForceSwitch parameter is set to True, this parameter will not take effect.
        """
    ...
    def dst_slave(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @dst_slave.setter
    def dst_slave(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "dst_slave", value)

    @_builtins.property
    @pulumi.getter(name="forceSwitch")
    def force_switch(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    @force_switch.setter
    def force_switch(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "force_switch", value)

    @_builtins.property
    @pulumi.getter(name="waitSwitch")
    def wait_switch(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    @wait_switch.setter
    def wait_switch(self, value: pulumi.Input[_builtins.bool | None]):
...
class SwitchMasterSlaveOperation(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_switch_master_slave_operation = tencentcloud.mysql.SwitchMasterSlaveOperation("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SwitchMasterSlaveOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = SwitchMasterSlaveOperationArgs.__new__(
                SwitchMasterSlaveOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _SwitchMasterSlaveOperationState.__new__(
            _SwitchMasterSlaveOperationState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="dstSlave")
    def dst_slave(self) -> pulumi.Output[_builtins.str | None]:
        """
        target instance. Possible values: `first` - first standby; `second` - second standby. The default value is `first`, and only multi-AZ instances support setting it to `second`.
        """
        return pulumi.get(self, "dst_slave")
    ...
    @_builtins.property
    @pulumi.getter(name="forceSwitch")
    def force_switch(self) -> pulumi.Output[_builtins.bool | None]:
        """
        Whether to force switch. Default is False. Note that if you set the mandatory switch to True, there is a risk of data loss on the instance, so use it with caution.
        """
        return pulumi.get(self, "force_switch")
    ...
    @_builtins.property
    @pulumi.getter(name="waitSwitch")
    def wait_switch(self) -> pulumi.Output[_builtins.bool | None]:
        """
        Whether to switch within the time window. The default is False, i.e. do not switch within the time window. Note that if the ForceSwitch parameter is set to True, this parameter will not take effect.
        """
        return pulumi.get(self, "wait_switch")
