...
class ReadonlyInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ro_group_id: Read only group id. If rogroupId is empty, a new ro group is created by default. If it is not empty, the existing ro group is used.
