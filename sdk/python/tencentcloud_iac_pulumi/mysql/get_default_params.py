...
class GetDefaultParamsResult:
    ...
    def __init__(
        __self__, db_version=None, id=None, param_lists=None, result_output_file=None
    ):
...
def get_default_params(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getDefaultParams:getDefaultParams",
        __args__,
        opts=opts,
        typ=GetDefaultParamsResult,
    ).value
...
def get_default_params_output(
...
) -> pulumi.Output[GetDefaultParamsResult]:
    """
    Provide a datasource to query default mysql parameters.
    ...
    return __ret__.apply(
        lambda __response__: GetDefaultParamsResult(
