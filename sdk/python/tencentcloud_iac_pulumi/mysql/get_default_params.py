...
def get_default_params(db_version: Optional[_builtins.str] = None,
    ...
    mysql57 = tencentcloud.MysqlDefaultParams("mysql_57", db_version=5.7)
    ```
...
def get_default_params_output(db_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
