...
def get_instance_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getInstanceInfo:getInstanceInfo",
        __args__,
        opts=opts,
        typ=GetInstanceInfoResult,
    ).value
...
def get_instance_info_output(
...
) -> pulumi.Output[GetInstanceInfoResult]:
    """
    Use this data source to query detailed information of mysql instance_info
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceInfoResult(
