...
class PasswordComplexityArgs:
    def __init__(
        ...
        *,
        ...
        param_lists: pulumi.Input[
            Sequence[pulumi.Input["PasswordComplexityParamListArgs"]] | None
        ] = None
    ):
        """
    ...
    def param_lists(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["PasswordComplexityParamListArgs"]] | None]:
        """
...
class PasswordComplexity(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            PasswordComplexityArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def param_lists(
        self,
    ) -> pulumi.Output[Sequence["outputs.PasswordComplexityParamList"] | None]:
        """
        List of parameters to be modified. Every element is a combination of `Name` (parameter name) and `CurrentValue` (new value). Valid values for `Name` of version 8.0: `validate_password.policy`, `validate_password.length`, `validate_password.mixed_case_count`, `validate_password.number_count`, `validate_password.special_char_count`. Valid values for `Name` of version 5.6 and 5.7: `validate_password_policy`, `validate_password_length` `validate_password_mixed_case_count`, `validate_password_number_count`, `validate_password_special_char_count`.
        """
        return pulumi.get(self, "param_lists")
