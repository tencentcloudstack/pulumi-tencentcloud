...
class GetParameterListResult:
    ...
    def parameter_lists(
        self,
    ) -> Sequence["outputs.GetParameterListParameterListResult"]:
        """
...
def get_parameter_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getParameterList:getParameterList",
        __args__,
        opts=opts,
        typ=GetParameterListResult,
    ).value
...
def get_parameter_list_output(
...
) -> pulumi.Output[GetParameterListResult]:
    """
    Use this data source to get information about a parameter group of a database instance.
    ...
    return __ret__.apply(
        lambda __response__: GetParameterListResult(
