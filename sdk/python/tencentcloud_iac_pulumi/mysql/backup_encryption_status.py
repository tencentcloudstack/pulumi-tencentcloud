...
class _BackupEncryptionStatusState:
    def __init__(
        __self__,
        *,
        encryption_status: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="encryptionStatus")
    def encryption_status(self) -> pulumi.Input[_builtins.str | None]:
        """
        Whether physical backup encryption is enabled for the instance. Possible values are `on`, `off`.
        """
        return pulumi.get(self, "encryption_status")
...
class BackupEncryptionStatus(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BackupEncryptionStatusArgs, pulumi.ResourceOptions, *args, **kwargs
        )
