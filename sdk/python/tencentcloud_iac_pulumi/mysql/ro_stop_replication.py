...
__all__ = ["RoStopReplication", "RoStopReplicationArgs"]
...
@pulumi.type_token("tencentcloud:Mysql/roStopReplication:RoStopReplication")
class RoStopReplication(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_proxy = tencentcloud.mysql.Proxy("example",
            ...
            vip="10.0.0.120",
            vport=3306)
        example_ro_stop_replication = tencentcloud.mysql.RoStopReplication("example", instance_id=example_proxy.id)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RoStopReplicationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
