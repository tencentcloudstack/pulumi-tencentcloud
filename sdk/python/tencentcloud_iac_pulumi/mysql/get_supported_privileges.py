...
def get_supported_privileges(instance_id: Optional[_builtins.str] = None,
...
def get_supported_privileges_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                    result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSupportedPrivilegesResult]:
    """
    Use this data source to query detailed information of mysql supported_privileges
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mysql/getSupportedPrivileges:getSupportedPrivileges', __args__, opts=opts, typ=GetSupportedPrivilegesResult)
    return __ret__.apply(lambda __response__: GetSupportedPrivilegesResult(
        column_supported_privileges=pulumi.get(__response__, 'column_supported_privileges'),
        database_supported_privileges=pulumi.get(__response__, 'database_supported_privileges'),
        global_supported_privileges=pulumi.get(__response__, 'global_supported_privileges'),
        id=pulumi.get(__response__, 'id'),
        instance_id=pulumi.get(__response__, 'instance_id'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        table_supported_privileges=pulumi.get(__response__, 'table_supported_privileges')))
