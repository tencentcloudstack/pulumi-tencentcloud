...
class _TimeWindowState:
    def __init__(__self__, *,
                 ...
                 max_delay_time: Optional[pulumi.Input[_builtins.int]] = None,
                 time_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 weekdays: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="timeRanges")
    def time_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Time period available for maintenance after modification in the format of 10:00-12:00. Each period lasts from half an hour to three hours, with the start time and end time aligned by half-hour. Up to two time periods can be set. Start and end time range: [00:00, 24:00].
        """
        return pulumi.get(self, "time_ranges")
    ...
    @time_ranges.setter
    def time_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "time_ranges", value)
...
class TimeWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_delay_time: Optional[pulumi.Input[_builtins.int]] = None,
            time_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            weekdays: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'TimeWindow':
        """
