...
__all__ = ["TimeWindow", "TimeWindowArgs"]
...
class TimeWindowArgs:
    def __init__(
        ...
        *,
        ...
        time_ranges: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        max_delay_time: pulumi.Input[_builtins.int | None] = None,
        weekdays: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None
    ):
        """
        The set of arguments for constructing a TimeWindow resource.

        :param pulumi.Input[_builtins.str] instance_id: Instance ID in the format of cdb-c1nl9rpv or cdbro-c1nl9rpv. It is the same as the instance ID displayed on the TencentDB Console page.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] time_ranges: Time period available for maintenance after modification in the format of 10:00-12:00. Each period lasts from half an hour to three hours, with the start time and end time aligned by half-hour. Up to two time periods can be set. Start and end time range: [00:00, 24:00].
        :param pulumi.Input[_builtins.int] max_delay_time: Data delay threshold. It takes effect only for source instance and disaster recovery instance. Default value: 10.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] weekdays: Specifies for which day to modify the time period. Value range: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday. If it is not specified or is left blank, the time period will be modified for every day by default.
        """
    ...
    def time_ranges(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @time_ranges.setter
    def time_ranges(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "time_ranges", value)

    @_builtins.property
    @pulumi.getter(name="maxDelayTime")
    def max_delay_time(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def max_delay_time(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "max_delay_time", value)

    @_builtins.property
    @pulumi.getter
    def weekdays(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None]:
        """
...
class _TimeWindowState:
    def __init__(
        ...
        *,
        ...
        max_delay_time: pulumi.Input[_builtins.int | None] = None,
        time_ranges: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        weekdays: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None
    ):
        """
...
@pulumi.type_token("tencentcloud:Mysql/timeWindow:TimeWindow")
class TimeWindow(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_time_window = tencentcloud.mysql.TimeWindow("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TimeWindowArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Mysql/timeWindow:TimeWindow", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="maxDelayTime")
    def max_delay_time(self) -> pulumi.Output[_builtins.int | None]:
        """
        Data delay threshold. It takes effect only for source instance and disaster recovery instance. Default value: 10.
        """
        return pulumi.get(self, "max_delay_time")
    ...
    @_builtins.property
    @pulumi.getter(name="timeRanges")
    def time_ranges(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Time period available for maintenance after modification in the format of 10:00-12:00. Each period lasts from half an hour to three hours, with the start time and end time aligned by half-hour. Up to two time periods can be set. Start and end time range: [00:00, 24:00].
        """
        return pulumi.get(self, "time_ranges")
    ...
    @_builtins.property
    @pulumi.getter
    def weekdays(self) -> pulumi.Output[Sequence[_builtins.str] | None]:
        """
        Specifies for which day to modify the time period. Value range: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday. If it is not specified or is left blank, the time period will be modified for every day by default.
        """
        return pulumi.get(self, "weekdays")
