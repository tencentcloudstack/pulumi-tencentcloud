...
class GetBackupOverviewResult:
    ...
    def __init__(
        __self__,
        backup_archive_volume=None,
        backup_count=None,
        backup_standby_volume=None,
        backup_volume=None,
        billing_volume=None,
        free_volume=None,
        id=None,
...
def get_backup_overview(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getBackupOverview:getBackupOverview",
        __args__,
        opts=opts,
        typ=GetBackupOverviewResult,
    ).value
...
def get_backup_overview_output(
...
) -> pulumi.Output[GetBackupOverviewResult]:
    """
    Use this data source to query detailed information of mysql backup_overview
    ...
    return __ret__.apply(
        lambda __response__: GetBackupOverviewResult(
