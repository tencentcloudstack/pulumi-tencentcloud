...
class GetBackupOverviewResult:
    ...
    def backup_archive_volume(self) -> _builtins.int:
        """
    ...
    def backup_standby_volume(self) -> _builtins.int:
        """
    ...
    def billing_volume(self) -> _builtins.int:
        """
    ...
    def free_volume(self) -> _builtins.int:
        """
...
def get_backup_overview(product: Optional[_builtins.str] = None,
...
def get_backup_overview_output(product: Optional[pulumi.Input[_builtins.str]] = None,
                               result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetBackupOverviewResult]:
    """
    Use this data source to query detailed information of mysql backup_overview
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mysql/getBackupOverview:getBackupOverview', __args__, opts=opts, typ=GetBackupOverviewResult)
    return __ret__.apply(lambda __response__: GetBackupOverviewResult(
        backup_archive_volume=pulumi.get(__response__, 'backup_archive_volume'),
        backup_count=pulumi.get(__response__, 'backup_count'),
        backup_standby_volume=pulumi.get(__response__, 'backup_standby_volume'),
        backup_volume=pulumi.get(__response__, 'backup_volume'),
        billing_volume=pulumi.get(__response__, 'billing_volume'),
        free_volume=pulumi.get(__response__, 'free_volume'),
