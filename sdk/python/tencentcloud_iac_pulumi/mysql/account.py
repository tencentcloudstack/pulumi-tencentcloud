...
class AccountArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] mysql_id: Instance ID to which the account belongs.
        :param pulumi.Input[_builtins.str] password: Operation password.
        :param pulumi.Input[_builtins.str] description: Database description.
        :param pulumi.Input[_builtins.str] host: Account host, default is `%`.
        :param pulumi.Input[_builtins.int] max_user_connections: The maximum number of available connections for a new account, the default value is 10240, and the maximum value that can be set is 10240.
...
@pulumi.type_token("tencentcloud:Mysql/account:Account")
class Account(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Mysql/account:Account", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="maxUserConnections")
    def max_user_connections(self) -> pulumi.Output[_builtins.int]:
        """
        The maximum number of available connections for a new account, the default value is 10240, and the maximum value that can be set is 10240.
        """
        return pulumi.get(self, "max_user_connections")
