...
class GetDbFeaturesResult:
    ...
    def __init__(
        __self__,
        audit_need_upgrade=None,
        current_sub_version=None,
        encryption_need_upgrade=None,
        id=None,
        instance_id=None,
        is_remote_ro=None,
        is_support_audit=None,
        is_support_encryption=None,
        is_support_update_sub_version=None,
        master_region=None,
        result_output_file=None,
        target_sub_version=None,
    ):
        ...
        if is_support_update_sub_version and not isinstance(
            is_support_update_sub_version, bool
        ):
            raise TypeError(
                "Expected argument 'is_support_update_sub_version' to be a bool"
            )
        pulumi.set(
            __self__, "is_support_update_sub_version", is_support_update_sub_version
        )
...
def get_db_features(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mysql/getDbFeatures:getDbFeatures",
        __args__,
        opts=opts,
        typ=GetDbFeaturesResult,
    ).value
    ...
    return AwaitableGetDbFeaturesResult(
        ...
        is_support_update_sub_version=pulumi.get(
            __ret__, "is_support_update_sub_version"
        ),
...
def get_db_features_output(
...
) -> pulumi.Output[GetDbFeaturesResult]:
    """
    Use this data source to query detailed information of mysql db_features
    ...
    return __ret__.apply(
        lambda __response__: GetDbFeaturesResult(
            ...
            is_support_update_sub_version=pulumi.get(
                __response__, "is_support_update_sub_version"
            ),
