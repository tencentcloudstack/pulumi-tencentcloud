...
__all__ = ["IsolateInstance", "IsolateInstanceArgs"]
...
@pulumi.type_token("tencentcloud:Mysql/isolateInstance:IsolateInstance")
class IsolateInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_isolate_instance = tencentcloud.mysql.IsolateInstance("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            IsolateInstanceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
