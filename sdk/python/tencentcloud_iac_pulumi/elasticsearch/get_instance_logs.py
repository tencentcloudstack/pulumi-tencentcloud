...
class GetInstanceLogsResult:
    ...
    def log_type(self) -> Optional[_builtins.int]:
...
def get_instance_logs(end_time: Optional[_builtins.str] = None,
...
def get_instance_logs_output(end_time: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                             instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                             log_type: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstanceLogsResult]:
    """
    Use this data source to query detailed information of es elasticsearch_instance_logs
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Elasticsearch/getInstanceLogs:getInstanceLogs', __args__, opts=opts, typ=GetInstanceLogsResult)
    return __ret__.apply(lambda __response__: GetInstanceLogsResult(
