...
class _LogstashPipelineState:
    def __init__(__self__, *,
                 ...
                 op_type: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="opType")
    def op_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Operation type. 1: save only; 2: save and deploy.
        """
        return pulumi.get(self, "op_type")
    ...
    @op_type.setter
    def op_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "op_type", value)
...
class LogstashPipeline(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 op_type: pulumi.Input[Optional[_builtins.int]] = None,
                 pipeline: pulumi.Input[Optional[Union['LogstashPipelinePipelineArgs', 'LogstashPipelinePipelineArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            op_type: pulumi.Input[Optional[_builtins.int]] = None,
            pipeline: pulumi.Input[Optional[Union['LogstashPipelinePipelineArgs', 'LogstashPipelinePipelineArgsDict']]] = None) -> 'LogstashPipeline':
        """
