...
class DiagnoseArgs:
    def __init__(
        ...
        *,
        ...
        cron_time: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a Diagnose resource.

        :param pulumi.Input[_builtins.str] instance_id: Instance id.
        :param pulumi.Input[_builtins.str] cron_time: Intelligent operation and maintenance staff regularly patrol the inspection time every day, the time format is HH:00:00, such as 15:00:00.
        """
    ...
    def cron_time(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @cron_time.setter
    def cron_time(self, value: pulumi.Input[_builtins.str | None]):
...
class _DiagnoseState:
    def __init__(
        ...
        *,
        cron_time: pulumi.Input[_builtins.str | None] = None,
        diagnose_job_metas: pulumi.Input[
            Sequence[pulumi.Input["DiagnoseDiagnoseJobMetaArgs"]] | None
        ] = None,
        instance_id: pulumi.Input[_builtins.str | None] = None,
        max_count: pulumi.Input[_builtins.int | None] = None
    ):
        """
        ...
        :param pulumi.Input[_builtins.str] instance_id: Instance id.
        :param pulumi.Input[_builtins.int] max_count: The maximum number of manual triggers per day for intelligent operation and maintenance staff.
        """
        if cron_time is not None:
            pulumi.set(__self__, "cron_time", cron_time)
    ...
    def diagnose_job_metas(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["DiagnoseDiagnoseJobMetaArgs"]] | None]:
        """
    ...
    def max_count(self) -> pulumi.Input[_builtins.int | None]:
        """
...
@pulumi.type_token("tencentcloud:Elasticsearch/diagnose:Diagnose")
class Diagnose(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DiagnoseArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def get(
        ...
        diagnose_job_metas: pulumi.Input[
            Sequence[
                pulumi.Input[
                    Union[
                        "DiagnoseDiagnoseJobMetaArgs", "DiagnoseDiagnoseJobMetaArgsDict"
                    ]
                ]
            ]
            | None
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] cron_time: Intelligent operation and maintenance staff regularly patrol the inspection time every day, the time format is HH:00:00, such as 15:00:00.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DiagnoseDiagnoseJobMetaArgs', 'DiagnoseDiagnoseJobMetaArgsDict']]]] diagnose_job_metas: Diagnostic items and meta-information of intelligent operation and maintenance.
        :param pulumi.Input[_builtins.str] instance_id: Instance id.
        :param pulumi.Input[_builtins.int] max_count: The maximum number of manual triggers per day for intelligent operation and maintenance staff.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cronTime")
    def cron_time(self) -> pulumi.Output[_builtins.str | None]:
        """
        Intelligent operation and maintenance staff regularly patrol the inspection time every day, the time format is HH:00:00, such as 15:00:00.
        """
        return pulumi.get(self, "cron_time")
    ...
    def diagnose_job_metas(
        self,
    ) -> pulumi.Output[Sequence["outputs.DiagnoseDiagnoseJobMeta"]]:
        """
        Diagnostic items and meta-information of intelligent operation and maintenance.
        """
        return pulumi.get(self, "diagnose_job_metas")
