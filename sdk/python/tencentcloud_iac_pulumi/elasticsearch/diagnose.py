...
class DiagnoseArgs:
    def __init__(__self__, *,
                 ...
                 cron_time: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def cron_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @cron_time.setter
    def cron_time(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _DiagnoseState:
    def __init__(__self__, *,
                 cron_time: pulumi.Input[Optional[_builtins.str]] = None,
                 diagnose_job_metas: pulumi.Input[Optional[Sequence[pulumi.Input['DiagnoseDiagnoseJobMetaArgs']]]] = None,
    ...
    def diagnose_job_metas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DiagnoseDiagnoseJobMetaArgs']]]]:
        """
    ...
    def diagnose_job_metas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DiagnoseDiagnoseJobMetaArgs']]]]):
...
class Diagnose(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cron_time: pulumi.Input[Optional[_builtins.str]] = None,
            diagnose_job_metas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DiagnoseDiagnoseJobMetaArgs', 'DiagnoseDiagnoseJobMetaArgsDict']]]]] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            max_count: pulumi.Input[Optional[_builtins.int]] = None) -> 'Diagnose':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cronTime")
    def cron_time(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Intelligent operation and maintenance staff regularly patrol the inspection time every day, the time format is HH:00:00, such as 15:00:00.
        """
        return pulumi.get(self, "cron_time")
