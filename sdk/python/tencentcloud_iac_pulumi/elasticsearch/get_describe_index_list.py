...
def get_describe_index_list_output(index_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                   index_status_lists: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
