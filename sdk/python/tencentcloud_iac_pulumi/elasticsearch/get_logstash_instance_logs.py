...
def get_logstash_instance_logs(end_time: Optional[str] = None,
    ...
    :param str end_time: Log end time, in YYYY-MM-DD HH:MM:SS format, such as 2019-01-22 20:15:53.
    :param str instance_id: Instance id.
    :param int log_type: Log type. Default 1, Valid values:
           - 1: Main Log
           - 2: Slow log
           - 3: GC Log.
    :param int order_by_type: Time sort method. Default is 0. 0: descending; 1: ascending order.
    :param str result_output_file: Used to save results.
    :param str search_key: Search terms, support LUCENE syntax, such as level:WARN, ip:1.1.1.1, message:test-index, etc.
    :param str start_time: Log start time, in YYYY-MM-DD HH:MM:SS format, such as 2019-01-22 20:15:53.
    """
    __args__ = dict()
...
@_utilities.lift_output_func(get_logstash_instance_logs)
def get_logstash_instance_logs_output(end_time: Optional[pulumi.Input[Optional[str]]] = None,
                                      instance_id: Optional[pulumi.Input[str]] = None,
                                      log_type: Optional[pulumi.Input[int]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetLogstashInstanceLogsResult]:
    """
    Use this data source to query detailed information of elasticsearch logstash_instance_logs
