...
def get_reset_instance_blueprint_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetResetInstanceBlueprintFilterArgs', 'GetResetInstanceBlueprintFilterArgsDict']]]]] = None,
