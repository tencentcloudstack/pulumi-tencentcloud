...
__all__ = ["DiskAttachment", "DiskAttachmentArgs"]
...
@pulumi.type_token("tencentcloud:Lighthouse/diskAttachment:DiskAttachment")
class DiskAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        disk_attachment = tencentcloud.lighthouse.DiskAttachment("disk_attachment",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DiskAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
