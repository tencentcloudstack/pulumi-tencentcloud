...
__all__ = ['RenewDisk', 'RenewDiskArgs']
...
class RenewDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] disk_id: List of disk ID.
...
class _RenewDiskState:
    def __init__(__self__, *,
                 ...
                 renew_disk_charge_prepaid: pulumi.Input[Optional['RenewDiskRenewDiskChargePrepaidArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="renewDiskChargePrepaid")
    def renew_disk_charge_prepaid(self) -> pulumi.Input[Optional['RenewDiskRenewDiskChargePrepaidArgs']]:
        """
        Renew cloud hard disk subscription related parameter settings.
        """
        return pulumi.get(self, "renew_disk_charge_prepaid")
    ...
    @renew_disk_charge_prepaid.setter
    def renew_disk_charge_prepaid(self, value: pulumi.Input[Optional['RenewDiskRenewDiskChargePrepaidArgs']]):
        pulumi.set(self, "renew_disk_charge_prepaid", value)


@pulumi.type_token("tencentcloud:Lighthouse/renewDisk:RenewDisk")
class RenewDisk(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_voucher: pulumi.Input[Optional[_builtins.bool]] = None,
                 disk_id: pulumi.Input[Optional[_builtins.str]] = None,
                 renew_disk_charge_prepaid: pulumi.Input[Optional[Union['RenewDiskRenewDiskChargePrepaidArgs', 'RenewDiskRenewDiskChargePrepaidArgsDict']]] = None,
                 __props__=None):
        """
        ...
        renew_disk = tencentcloud.lighthouse.RenewDisk("renew_disk",
        ...
        :param pulumi.Input[_builtins.bool] auto_voucher: Whether to automatically use the voucher. Not used by default.
        :param pulumi.Input[_builtins.str] disk_id: List of disk ID.
        :param pulumi.Input[Union['RenewDiskRenewDiskChargePrepaidArgs', 'RenewDiskRenewDiskChargePrepaidArgsDict']] renew_disk_charge_prepaid: Renew cloud hard disk subscription related parameter settings.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            auto_voucher: pulumi.Input[Optional[_builtins.bool]] = None,
            disk_id: pulumi.Input[Optional[_builtins.str]] = None,
            renew_disk_charge_prepaid: pulumi.Input[Optional[Union['RenewDiskRenewDiskChargePrepaidArgs', 'RenewDiskRenewDiskChargePrepaidArgsDict']]] = None) -> 'RenewDisk':
        """
