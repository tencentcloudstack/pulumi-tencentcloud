...
class GetDisksResult:
    ...
    def disk_ids(self) -> Sequence[_builtins.str] | None:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetDisksFilterResult"] | None:
...
def get_disks(
    disk_ids: Sequence[_builtins.str] | None = None,
    filters: (
        Sequence[Union["GetDisksFilterArgs", "GetDisksFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Lighthouse/getDisks:getDisks",
        __args__,
        opts=opts,
        typ=GetDisksResult,
    ).value
...
def get_disks_output(
    disk_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetDisksResult(
