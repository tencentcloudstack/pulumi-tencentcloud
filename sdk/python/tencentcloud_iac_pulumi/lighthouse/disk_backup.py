...
class DiskBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] disk_id: Disk ID. Only data disks are supported to create disk backup.
        :param pulumi.Input[str] disk_backup_name: Disk backup name. The maximum length is 90 characters.
        """
