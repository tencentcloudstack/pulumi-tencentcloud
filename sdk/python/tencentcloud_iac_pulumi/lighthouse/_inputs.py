...
class FirewallRuleFirewallRuleArgsDict(TypedDict):
    ...
    """
    firewall_rule_description: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class FirewallRuleFirewallRuleArgs:
    def __init__(__self__, *,
                 ...
                 firewall_rule_description: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def firewall_rule_description(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Firewall rule description.
        """
    ...
    def firewall_rule_description(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class InstanceContainerArgsDict(TypedDict):
    ...
    Container name.
    """
    envs: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerEnvArgsDict']]]]]
    """
    List of environment variables.
    """
    publish_ports: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerPublishPortArgsDict']]]]]
    """
    List of mappings of container ports and host ports.
    """
    volumes: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerVolumeArgsDict']]]]]
    """
...
class InstanceContainerArgs:
    def __init__(__self__, *,
                 ...
                 envs: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerEnvArgs']]]] = None,
                 publish_ports: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerPublishPortArgs']]]] = None,
                 volumes: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerVolumeArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def envs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerEnvArgs']]]]:
        """
        List of environment variables.
        """
    ...
    @envs.setter
    def envs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerEnvArgs']]]]):
        pulumi.set(self, "envs", value)

    @_builtins.property
    @pulumi.getter(name="publishPorts")
    def publish_ports(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerPublishPortArgs']]]]:
        """
        List of mappings of container ports and host ports.
        """
    ...
    def publish_ports(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerPublishPortArgs']]]]):
        pulumi.set(self, "publish_ports", value)

    @_builtins.property
    @pulumi.getter
    def volumes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerVolumeArgs']]]]:
        """
        List of container mount volumes.
        """
    ...
    @volumes.setter
    def volumes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceContainerVolumeArgs']]]]):
...
class RenewDiskRenewDiskChargePrepaidArgsDict(TypedDict):
    cur_instance_deadline: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class RenewDiskRenewDiskChargePrepaidArgs:
    def __init__(__self__, *,
                 cur_instance_deadline: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def cur_instance_deadline(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Current instance expiration time. Such as 2018-01-01 00:00:00. Specifying this parameter can align the expiration time of the instance attached to the disk. One of this parameter and Period must be specified, and cannot be specified at the same time.
        """
    ...
    def cur_instance_deadline(self, value: pulumi.Input[Optional[_builtins.str]]):
