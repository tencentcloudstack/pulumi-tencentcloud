...
def get_instance_blueprint(instance_ids: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] instance_ids: Instance ID list, which currently can contain only one instance.
...
def get_instance_blueprint_output(instance_ids: Optional[pulumi.Input[Sequence[_builtins.str]]] = None,
                                  result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstanceBlueprintResult]:
    """
    Use this data source to query detailed information of lighthouse instance_blueprint
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Lighthouse/getInstanceBlueprint:getInstanceBlueprint', __args__, opts=opts, typ=GetInstanceBlueprintResult)
    return __ret__.apply(lambda __response__: GetInstanceBlueprintResult(
        blueprint_instance_sets=pulumi.get(__response__, 'blueprint_instance_sets'),
