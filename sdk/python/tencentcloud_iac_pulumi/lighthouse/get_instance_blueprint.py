...
class GetInstanceBlueprintResult:
    ...
    def blueprint_instance_sets(
        self,
    ) -> Sequence["outputs.GetInstanceBlueprintBlueprintInstanceSetResult"]:
        """
...
def get_instance_blueprint(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Lighthouse/getInstanceBlueprint:getInstanceBlueprint",
        __args__,
        opts=opts,
        typ=GetInstanceBlueprintResult,
    ).value
...
def get_instance_blueprint_output(
...
) -> pulumi.Output[GetInstanceBlueprintResult]:
    """
    Use this data source to query detailed information of lighthouse instance_blueprint
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceBlueprintResult(
