...
__all__ = ["StartInstance", "StartInstanceArgs"]
...
@pulumi.type_token("tencentcloud:Lighthouse/startInstance:StartInstance")
class StartInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        start_instance = tencentcloud.lighthouse.StartInstance("start_instance", instance_id="lhins-xxxxxx")
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            StartInstanceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
