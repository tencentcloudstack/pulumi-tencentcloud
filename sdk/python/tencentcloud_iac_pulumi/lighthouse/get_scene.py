...
def get_scene(limit: Optional[_builtins.int] = None,
...
def get_scene_output(limit: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Lighthouse/getScene:getScene', __args__, opts=opts, typ=GetSceneResult)
