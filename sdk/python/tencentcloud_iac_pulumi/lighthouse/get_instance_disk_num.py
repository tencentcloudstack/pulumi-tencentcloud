...
class GetInstanceDiskNumResult:
    ...
    def attach_detail_sets(
        self,
    ) -> Sequence["outputs.GetInstanceDiskNumAttachDetailSetResult"]:
        """
...
def get_instance_disk_num(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Lighthouse/getInstanceDiskNum:getInstanceDiskNum",
        __args__,
        opts=opts,
        typ=GetInstanceDiskNumResult,
    ).value
...
def get_instance_disk_num_output(
...
) -> pulumi.Output[GetInstanceDiskNumResult]:
    """
    Use this data source to query detailed information of lighthouse instance_disk_num
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceDiskNumResult(
