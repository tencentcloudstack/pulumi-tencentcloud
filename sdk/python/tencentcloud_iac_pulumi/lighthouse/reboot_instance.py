...
@pulumi.type_token("tencentcloud:Lighthouse/rebootInstance:RebootInstance")
class RebootInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        reboot_instance = tencentcloud.lighthouse.RebootInstance("reboot_instance", instance_id="lhins-xxx")
        ```
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Lighthouse/rebootInstance:RebootInstance",
            resource_name,
            __props__,
            opts,
        )
