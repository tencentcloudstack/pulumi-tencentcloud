...
def get_org_financial_by_product(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Organization/getOrgFinancialByProduct:getOrgFinancialByProduct",
        __args__,
        opts=opts,
        typ=GetOrgFinancialByProductResult,
    ).value
...
def get_org_financial_by_product_output(
...
) -> pulumi.Output[GetOrgFinancialByProductResult]:
    """
    Use this data source to query detailed information of organization org_financial_by_product
    ...
    return __ret__.apply(
        lambda __response__: GetOrgFinancialByProductResult(
