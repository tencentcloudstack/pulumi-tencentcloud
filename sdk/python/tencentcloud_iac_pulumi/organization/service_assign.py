...
__all__ = ['ServiceAssign', 'ServiceAssignArgs']

@pulumi.input_type
class ServiceAssignArgs:
    def __init__(__self__, *,
                 member_uins: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]],
                 service_id: pulumi.Input[_builtins.int],
                 management_scope: pulumi.Input[Optional[_builtins.int]] = None,
                 management_scope_node_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 management_scope_uins: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None):
        """
        The set of arguments for constructing a ServiceAssign resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] member_uins: Uin list of the delegated admins, Including up to 20 items.
        :param pulumi.Input[_builtins.int] service_id: Organization service ID.
        :param pulumi.Input[_builtins.int] management_scope: Management scope of the delegated admin. Valid values: 1 (all members), 2 (partial members). Default value: `1`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] management_scope_node_ids: ID list of the managed departments. This parameter is valid when `management_scope` is `2`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] management_scope_uins: Uin list of the managed members. This parameter is valid when `management_scope` is `2`.
        """
    ...
    def member_uins(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]:
        """
    ...
    @member_uins.setter
    def member_uins(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.int]]]):
    ...
    def management_scope(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def management_scope(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "management_scope", value)

    @_builtins.property
    @pulumi.getter(name="managementScopeNodeIds")
    def management_scope_node_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    def management_scope_node_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]):
        pulumi.set(self, "management_scope_node_ids", value)

    @_builtins.property
    @pulumi.getter(name="managementScopeUins")
    def management_scope_uins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    def management_scope_uins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]):
...
class _ServiceAssignState:
    def __init__(__self__, *,
                 ...
                 management_scope_node_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 management_scope_uins: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 member_uins: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="memberUins")
    def member_uins(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]:
        """
        Uin list of the delegated admins, Including up to 20 items.
        """
        return pulumi.get(self, "member_uins")
    ...
    @member_uins.setter
    def member_uins(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]):
        pulumi.set(self, "member_uins", value)
...
@pulumi.type_token("tencentcloud:Organization/serviceAssign:ServiceAssign")
class ServiceAssign(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            management_scope_uins: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
            member_uins: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
            service_id: pulumi.Input[Optional[_builtins.int]] = None) -> 'ServiceAssign':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="managementScope")
    def management_scope(self) -> pulumi.Output[_builtins.int]:
        """
        Management scope of the delegated admin. Valid values: 1 (all members), 2 (partial members). Default value: `1`.
        """
        return pulumi.get(self, "management_scope")
    ...
    @_builtins.property
    @pulumi.getter(name="managementScopeNodeIds")
    def management_scope_node_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.int]]]:
        """
        ID list of the managed departments. This parameter is valid when `management_scope` is `2`.
        """
        return pulumi.get(self, "management_scope_node_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="managementScopeUins")
    def management_scope_uins(self) -> pulumi.Output[Optional[Sequence[_builtins.int]]]:
        """
        Uin list of the managed members. This parameter is valid when `management_scope` is `2`.
        """
        return pulumi.get(self, "management_scope_uins")
    ...
    @_builtins.property
    @pulumi.getter(name="memberUins")
    def member_uins(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        Uin list of the delegated admins, Including up to 20 items.
        """
        return pulumi.get(self, "member_uins")
