...
class OrgIdentityIdentityPolicyArgsDict(TypedDict):
    policy_document: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Customize policy content and follow CAM policy syntax. Valid and required when PolicyType is the 1-custom policy.
    """
    policy_id: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    policy_type: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class OrgIdentityIdentityPolicyArgs:
    def __init__(__self__, *,
                 ...
                 policy_type: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def policy_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Policy type. Value 1-custom policy 2-preset policy; default value 2.
        """
    ...
    @policy_type.setter
    def policy_type(self, value: pulumi.Input[Optional[_builtins.int]]):
