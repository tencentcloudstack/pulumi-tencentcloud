...
__all__ = ["PolicySubAccountAttachment", "PolicySubAccountAttachmentArgs"]
...
class PolicySubAccountAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        policy_sub_account_attachment = tencentcloud.organization.PolicySubAccountAttachment("policy_sub_account_attachment",
            member_uin=int(100028582828),
            org_sub_account_uin=int(100028223737),
            policy_id=144256499)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            PolicySubAccountAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = PolicySubAccountAttachmentArgs.__new__(
                PolicySubAccountAttachmentArgs
            )
    ...
    def get(
        ...
        __props__ = _PolicySubAccountAttachmentState.__new__(
            _PolicySubAccountAttachmentState
        )
