...
__all__ = ["OrgIdentity", "OrgIdentityArgs"]
...
class OrgIdentityArgs:
    def __init__(
        __self__,
        *,
        identity_alias_name: pulumi.Input[_builtins.str],
        identity_policies: pulumi.Input[
            Sequence[pulumi.Input["OrgIdentityIdentityPolicyArgs"]]
        ],
        ...
        :param pulumi.Input[_builtins.str] identity_alias_name: Identity name.Supports English letters and numbers, the length cannot exceed 40 characters.
        :param pulumi.Input[Sequence[pulumi.Input['OrgIdentityIdentityPolicyArgs']]] identity_policies: Identity policy list.
        :param pulumi.Input[_builtins.str] description: Identity description.
        """
    ...
    def identity_alias_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def identity_alias_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def identity_policies(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["OrgIdentityIdentityPolicyArgs"]]]:
        """
    ...
    def identity_policies(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["OrgIdentityIdentityPolicyArgs"]]],
    ):
...
class _OrgIdentityState:
    def __init__(
        ...
        *,
        description: pulumi.Input[_builtins.str | None] = None,
        identity_alias_name: pulumi.Input[_builtins.str | None] = None,
        identity_policies: pulumi.Input[
            Sequence[pulumi.Input["OrgIdentityIdentityPolicyArgs"]] | None
        ] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="identityAliasName")
    def identity_alias_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        Identity name.Supports English letters and numbers, the length cannot exceed 40 characters.
        """
        return pulumi.get(self, "identity_alias_name")
    ...
    @identity_alias_name.setter
    def identity_alias_name(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "identity_alias_name", value)
    ...
    def identity_policies(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["OrgIdentityIdentityPolicyArgs"]] | None]:
        """
        Identity policy list.
        """
        return pulumi.get(self, "identity_policies")
...
@pulumi.type_token("tencentcloud:Organization/orgIdentity:OrgIdentity")
class OrgIdentity(pulumi.CustomResource):
    ...
    def __init__(
        ...
        org_identity = tencentcloud.organization.OrgIdentity("org_identity",
        ...
        :param pulumi.Input[_builtins.str] description: Identity description.
        :param pulumi.Input[_builtins.str] identity_alias_name: Identity name.Supports English letters and numbers, the length cannot exceed 40 characters.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OrgIdentityIdentityPolicyArgs', 'OrgIdentityIdentityPolicyArgsDict']]]] identity_policies: Identity policy list.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            OrgIdentityArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="identityAliasName")
    def identity_alias_name(self) -> pulumi.Output[_builtins.str]:
        """
        Identity name.Supports English letters and numbers, the length cannot exceed 40 characters.
        """
        return pulumi.get(self, "identity_alias_name")
    ...
    def identity_policies(
        self,
    ) -> pulumi.Output[Sequence["outputs.OrgIdentityIdentityPolicy"]]:
        """
        Identity policy list.
        """
        return pulumi.get(self, "identity_policies")
