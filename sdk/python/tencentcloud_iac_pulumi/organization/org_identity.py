...
class _OrgIdentityState:
    def __init__(__self__, *,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_alias_name: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_policies: pulumi.Input[Optional[Sequence[pulumi.Input['OrgIdentityIdentityPolicyArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="identityAliasName")
    def identity_alias_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Identity name.Supports English letters and numbers, the length cannot exceed 40 characters.
        """
        return pulumi.get(self, "identity_alias_name")
    ...
    @identity_alias_name.setter
    def identity_alias_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "identity_alias_name", value)

    @_builtins.property
    @pulumi.getter(name="identityPolicies")
    def identity_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OrgIdentityIdentityPolicyArgs']]]]:
        """
        Identity policy list.
        """
        return pulumi.get(self, "identity_policies")
    ...
    @identity_policies.setter
    def identity_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OrgIdentityIdentityPolicyArgs']]]]):
        pulumi.set(self, "identity_policies", value)
...
class OrgIdentity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_alias_name: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_policies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OrgIdentityIdentityPolicyArgs', 'OrgIdentityIdentityPolicyArgsDict']]]]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            description: pulumi.Input[Optional[_builtins.str]] = None,
            identity_alias_name: pulumi.Input[Optional[_builtins.str]] = None,
            identity_policies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OrgIdentityIdentityPolicyArgs', 'OrgIdentityIdentityPolicyArgsDict']]]]] = None) -> 'OrgIdentity':
        """
