...
def get_org_financial_by_month(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Organization/getOrgFinancialByMonth:getOrgFinancialByMonth",
        __args__,
        opts=opts,
        typ=GetOrgFinancialByMonthResult,
    ).value
...
def get_org_financial_by_month_output(
...
) -> pulumi.Output[GetOrgFinancialByMonthResult]:
    """
    Use this data source to query detailed information of organization org_financial_by_month
    ...
    return __ret__.apply(
        lambda __response__: GetOrgFinancialByMonthResult(
