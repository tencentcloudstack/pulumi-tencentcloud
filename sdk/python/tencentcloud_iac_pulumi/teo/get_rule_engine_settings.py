...
class AwaitableGetRuleEngineSettingsResult(GetRuleEngineSettingsResult):
    ...
    def __await__(self):
        ...
        return GetRuleEngineSettingsResult(
            actions=self.actions, id=self.id, result_output_file=self.result_output_file
        )


def get_rule_engine_settings(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Teo/getRuleEngineSettings:getRuleEngineSettings",
        __args__,
        opts=opts,
        typ=GetRuleEngineSettingsResult,
    ).value
...
def get_rule_engine_settings_output(
    ...
    return __ret__.apply(
        lambda __response__: GetRuleEngineSettingsResult(
