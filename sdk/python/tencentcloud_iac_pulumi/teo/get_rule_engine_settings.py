...
def get_rule_engine_settings(result_output_file: Optional[_builtins.str] = None,
...
def get_rule_engine_settings_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRuleEngineSettingsResult]:
    """
    Use this data source to query detailed information of teo ruleEngineSettings
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Teo/getRuleEngineSettings:getRuleEngineSettings', __args__, opts=opts, typ=GetRuleEngineSettingsResult)
    return __ret__.apply(lambda __response__: GetRuleEngineSettingsResult(
