...
__all__ = ["RealtimeLogDelivery", "RealtimeLogDeliveryArgs"]
...
class RealtimeLogDeliveryArgs:
    def __init__(
        ...
        *,
        ...
        entity_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        fields: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
        log_type: pulumi.Input[_builtins.str],
        sample: pulumi.Input[_builtins.int],
        task_name: pulumi.Input[_builtins.str],
        task_type: pulumi.Input[_builtins.str],
        zone_id: pulumi.Input[_builtins.str],
        cls: pulumi.Input[Optional["RealtimeLogDeliveryClsArgs"]] = None,
        custom_endpoint: pulumi.Input[
            Optional["RealtimeLogDeliveryCustomEndpointArgs"]
        ] = None,
        custom_fields: pulumi.Input[
            Sequence[pulumi.Input["RealtimeLogDeliveryCustomFieldArgs"]] | None
        ] = None,
        delivery_conditions: pulumi.Input[
            Sequence[pulumi.Input["RealtimeLogDeliveryDeliveryConditionArgs"]] | None
        ] = None,
        delivery_status: pulumi.Input[_builtins.str | None] = None,
        log_format: pulumi.Input[Optional["RealtimeLogDeliveryLogFormatArgs"]] = None,
        s3: pulumi.Input[Optional["RealtimeLogDeliveryS3Args"]] = None
    ):
        """
        The set of arguments for constructing a RealtimeLogDelivery resource.

        :param pulumi.Input[_builtins.str] area: Data delivery area, possible values are: `mainland`: within mainland China; `overseas`: worldwide (excluding mainland China).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] entity_lists: List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] fields: A list of preset fields for delivery.
        :param pulumi.Input[_builtins.str] log_type: Data delivery type, the values are: `domain`: site acceleration log; `application`: four-layer proxy log; `web-rateLiming`: rate limit and CC attack protection log; `web-attack`: managed rule log; `web-rule`: custom rule log; `web-bot`: Bot management log.
        :param pulumi.Input[_builtins.int] sample: The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        :param pulumi.Input[_builtins.str] task_name: The name of the real-time log delivery task. The format is a combination of numbers, English, -, and _. The maximum length is 200 characters.
        :param pulumi.Input[_builtins.str] task_type: The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push to a custom HTTP(S) address; `s3`: push to an AWS S3 compatible storage bucket address; `log_analysis`: push to EdgeOne log analysis.
        ...
        :param pulumi.Input[_builtins.str] delivery_status: The status of the real-time log delivery task. The values are: `enabled`: enabled; `disabled`: disabled. Leave it blank to keep the original configuration. Not required when creating.
    ...
    def entity_lists(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        """
    ...
    @entity_lists.setter
    def entity_lists(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @sample.setter
    def sample(self, value: pulumi.Input[_builtins.int]):
    ...
    def task_type(self) -> pulumi.Input[_builtins.str]:
        """
        The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push to a custom HTTP(S) address; `s3`: push to an AWS S3 compatible storage bucket address; `log_analysis`: push to EdgeOne log analysis.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def cls(self) -> pulumi.Input[Optional["RealtimeLogDeliveryClsArgs"]]:
        """
    ...
    @cls.setter
    def cls(self, value: pulumi.Input[Optional["RealtimeLogDeliveryClsArgs"]]):
    ...
    def custom_endpoint(
        self,
    ) -> pulumi.Input[Optional["RealtimeLogDeliveryCustomEndpointArgs"]]:
        """
    ...
    def custom_endpoint(
        self, value: pulumi.Input[Optional["RealtimeLogDeliveryCustomEndpointArgs"]]
    ):
    ...
    def delivery_status(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def delivery_status(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "delivery_status", value)

    @_builtins.property
    @pulumi.getter(name="logFormat")
    def log_format(self) -> pulumi.Input[Optional["RealtimeLogDeliveryLogFormatArgs"]]:
        """
    ...
    @log_format.setter
    def log_format(
        self, value: pulumi.Input[Optional["RealtimeLogDeliveryLogFormatArgs"]]
    ):
        pulumi.set(self, "log_format", value)

    @_builtins.property
    @pulumi.getter
    def s3(self) -> pulumi.Input[Optional["RealtimeLogDeliveryS3Args"]]:
        """
    ...
    @s3.setter
    def s3(self, value: pulumi.Input[Optional["RealtimeLogDeliveryS3Args"]]):
...
class _RealtimeLogDeliveryState:
    def __init__(
        ...
        *,
        ...
        delivery_status: pulumi.Input[_builtins.str | None] = None,
        entity_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        fields: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        log_format: pulumi.Input[Optional["RealtimeLogDeliveryLogFormatArgs"]] = None,
        log_type: pulumi.Input[_builtins.str | None] = None,
        s3: pulumi.Input[Optional["RealtimeLogDeliveryS3Args"]] = None,
        sample: pulumi.Input[_builtins.int | None] = None,
        ...
        :param pulumi.Input['RealtimeLogDeliveryS3Args'] s3: Configuration information of AWS S3 compatible storage bucket. This parameter is required when TaskType is s3.
        :param pulumi.Input[_builtins.int] sample: The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        :param pulumi.Input[_builtins.str] task_id: Real-time log delivery task ID.
        :param pulumi.Input[_builtins.str] task_name: The name of the real-time log delivery task. The format is a combination of numbers, English, -, and _. The maximum length is 200 characters.
        :param pulumi.Input[_builtins.str] task_type: The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push to a custom HTTP(S) address; `s3`: push to an AWS S3 compatible storage bucket address; `log_analysis`: push to EdgeOne log analysis.
        :param pulumi.Input[_builtins.str] zone_id: ID of the site.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> pulumi.Input[_builtins.int | None]:
        """
        The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        """
        return pulumi.get(self, "sample")
    ...
    @sample.setter
    def sample(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "sample", value)
...
@pulumi.type_token("tencentcloud:Teo/realtimeLogDelivery:RealtimeLogDelivery")
class RealtimeLogDelivery(pulumi.CustomResource):
    ...
    def __init__(
        ...
        area: pulumi.Input[_builtins.str | None] = None,
        cls: pulumi.Input[
            Union["RealtimeLogDeliveryClsArgs", "RealtimeLogDeliveryClsArgsDict"] | None
        ] = None,
        custom_endpoint: pulumi.Input[
            Union[
                "RealtimeLogDeliveryCustomEndpointArgs",
                "RealtimeLogDeliveryCustomEndpointArgsDict",
            ]
            | None
        ] = None,
        custom_fields: pulumi.Input[
            Sequence[
                pulumi.Input[
                    Union[
                        ...
                        "RealtimeLogDeliveryCustomFieldArgsDict",
                    ]
                ]
            ]
            | None
            ...
            Sequence[
                pulumi.Input[
                    Union[
                        ...
                        "RealtimeLogDeliveryDeliveryConditionArgsDict",
                    ]
                ]
            ]
            | None
        ...
        entity_lists: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        fields: pulumi.Input[Sequence[pulumi.Input[_builtins.str]] | None] = None,
        log_format: pulumi.Input[
            Union[
                "RealtimeLogDeliveryLogFormatArgs",
                "RealtimeLogDeliveryLogFormatArgsDict",
            ]
            | None
        ] = None,
        log_type: pulumi.Input[_builtins.str | None] = None,
        s3: pulumi.Input[
            Union["RealtimeLogDeliveryS3Args", "RealtimeLogDeliveryS3ArgsDict"] | None
        ] = None,
        sample: pulumi.Input[_builtins.int | None] = None,
        task_name: pulumi.Input[_builtins.str | None] = None,
        task_type: pulumi.Input[_builtins.str | None] = None,
        ...
        teo_realtime_log_delivery = tencentcloud.teo.RealtimeLogDelivery("teo_realtime_log_delivery",
            area="overseas",
        ...
        :param pulumi.Input[_builtins.str] area: Data delivery area, possible values are: `mainland`: within mainland China; `overseas`: worldwide (excluding mainland China).
        :param pulumi.Input[Union['RealtimeLogDeliveryClsArgs', 'RealtimeLogDeliveryClsArgsDict']] cls: CLS configuration information. This parameter is required when TaskType is cls.
        :param pulumi.Input[Union['RealtimeLogDeliveryCustomEndpointArgs', 'RealtimeLogDeliveryCustomEndpointArgsDict']] custom_endpoint: Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to custom_endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RealtimeLogDeliveryCustomFieldArgs', 'RealtimeLogDeliveryCustomFieldArgsDict']]]] custom_fields: The list of custom fields delivered supports extracting specified field values from HTTP request headers, response headers, and cookies. Custom field names cannot be repeated and cannot exceed 200 fields.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RealtimeLogDeliveryDeliveryConditionArgs', 'RealtimeLogDeliveryDeliveryConditionArgsDict']]]] delivery_conditions: The filter condition for log delivery. If it is not filled, all logs will be delivered.
        :param pulumi.Input[_builtins.str] delivery_status: The status of the real-time log delivery task. The values are: `enabled`: enabled; `disabled`: disabled. Leave it blank to keep the original configuration. Not required when creating.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] entity_lists: List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] fields: A list of preset fields for delivery.
        :param pulumi.Input[Union['RealtimeLogDeliveryLogFormatArgs', 'RealtimeLogDeliveryLogFormatArgsDict']] log_format: The output format of log delivery. If it is not filled, it means the default format. The default format logic is as follows: when TaskType is `custom_endpoint`, the default format is an array of multiple JSON objects, each JSON object is a log; when TaskType is `s3`, the default format is JSON Lines; in particular, when TaskType is `cls`, the value of LogFormat.FormatType can only be json, and other parameters in LogFormat will be ignored. It is recommended not to pass LogFormat.
        :param pulumi.Input[_builtins.str] log_type: Data delivery type, the values are: `domain`: site acceleration log; `application`: four-layer proxy log; `web-rateLiming`: rate limit and CC attack protection log; `web-attack`: managed rule log; `web-rule`: custom rule log; `web-bot`: Bot management log.
        :param pulumi.Input[Union['RealtimeLogDeliveryS3Args', 'RealtimeLogDeliveryS3ArgsDict']] s3: Configuration information of AWS S3 compatible storage bucket. This parameter is required when TaskType is s3.
        :param pulumi.Input[_builtins.int] sample: The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        :param pulumi.Input[_builtins.str] task_name: The name of the real-time log delivery task. The format is a combination of numbers, English, -, and _. The maximum length is 200 characters.
        :param pulumi.Input[_builtins.str] task_type: The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push to a custom HTTP(S) address; `s3`: push to an AWS S3 compatible storage bucket address; `log_analysis`: push to EdgeOne log analysis.
        :param pulumi.Input[_builtins.str] zone_id: ID of the site.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            RealtimeLogDeliveryArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def custom_endpoint(
        self,
    ) -> pulumi.Output["outputs.RealtimeLogDeliveryCustomEndpoint"]:
        """
        Customize the configuration information of the HTTP service. This parameter is required when TaskType is set to custom_endpoint.
        """
        return pulumi.get(self, "custom_endpoint")
    ...
    def custom_fields(
        self,
    ) -> pulumi.Output[Sequence["outputs.RealtimeLogDeliveryCustomField"]]:
        """
        The list of custom fields delivered supports extracting specified field values from HTTP request headers, response headers, and cookies. Custom field names cannot be repeated and cannot exceed 200 fields.
        """
        return pulumi.get(self, "custom_fields")
    ...
    def delivery_conditions(
        self,
    ) -> pulumi.Output[Sequence["outputs.RealtimeLogDeliveryDeliveryCondition"]]:
        """
        The filter condition for log delivery. If it is not filled, all logs will be delivered.
        """
        return pulumi.get(self, "delivery_conditions")
    ...
    @_builtins.property
    @pulumi.getter(name="entityLists")
    def entity_lists(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        """
        return pulumi.get(self, "entity_lists")
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> pulumi.Output[_builtins.int]:
        """
        The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        """
        return pulumi.get(self, "sample")
