...
class RealtimeLogDeliveryArgs:
    def __init__(__self__, *,
                 ...
                 custom_endpoint: pulumi.Input[Optional['RealtimeLogDeliveryCustomEndpointArgs']] = None,
                 custom_fields: pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryCustomFieldArgs']]]] = None,
                 delivery_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryDeliveryConditionArgs']]]] = None,
                 delivery_status: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def custom_endpoint(self) -> pulumi.Input[Optional['RealtimeLogDeliveryCustomEndpointArgs']]:
        """
    ...
    def custom_endpoint(self, value: pulumi.Input[Optional['RealtimeLogDeliveryCustomEndpointArgs']]):
        pulumi.set(self, "custom_endpoint", value)

    @_builtins.property
    @pulumi.getter(name="customFields")
    def custom_fields(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryCustomFieldArgs']]]]:
        """
    ...
    def custom_fields(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryCustomFieldArgs']]]]):
        pulumi.set(self, "custom_fields", value)

    @_builtins.property
    @pulumi.getter(name="deliveryConditions")
    def delivery_conditions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryDeliveryConditionArgs']]]]:
        """
    ...
    def delivery_conditions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryDeliveryConditionArgs']]]]):
        pulumi.set(self, "delivery_conditions", value)

    @_builtins.property
    @pulumi.getter(name="deliveryStatus")
    def delivery_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def delivery_status(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @log_format.setter
    def log_format(self, value: pulumi.Input[Optional['RealtimeLogDeliveryLogFormatArgs']]):
...
class _RealtimeLogDeliveryState:
    def __init__(__self__, *,
                 ...
                 delivery_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['RealtimeLogDeliveryDeliveryConditionArgs']]]] = None,
                 delivery_status: pulumi.Input[Optional[_builtins.str]] = None,
                 entity_lists: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 fields: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 log_format: pulumi.Input[Optional['RealtimeLogDeliveryLogFormatArgs']] = None,
                 log_type: pulumi.Input[Optional[_builtins.str]] = None,
                 s3: pulumi.Input[Optional['RealtimeLogDeliveryS3Args']] = None,
                 sample: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="entityLists")
    def entity_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        """
        return pulumi.get(self, "entity_lists")
    ...
    @entity_lists.setter
    def entity_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "entity_lists", value)
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        """
        return pulumi.get(self, "sample")
    ...
    @sample.setter
    def sample(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "sample", value)
...
class RealtimeLogDelivery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 area: pulumi.Input[Optional[_builtins.str]] = None,
                 cls: pulumi.Input[Optional[Union['RealtimeLogDeliveryClsArgs', 'RealtimeLogDeliveryClsArgsDict']]] = None,
                 custom_endpoint: pulumi.Input[Optional[Union['RealtimeLogDeliveryCustomEndpointArgs', 'RealtimeLogDeliveryCustomEndpointArgsDict']]] = None,
                 custom_fields: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RealtimeLogDeliveryCustomFieldArgs', 'RealtimeLogDeliveryCustomFieldArgsDict']]]]] = None,
                 delivery_conditions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['RealtimeLogDeliveryDeliveryConditionArgs', 'RealtimeLogDeliveryDeliveryConditionArgsDict']]]]] = None,
                 delivery_status: pulumi.Input[Optional[_builtins.str]] = None,
                 entity_lists: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 fields: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 log_format: pulumi.Input[Optional[Union['RealtimeLogDeliveryLogFormatArgs', 'RealtimeLogDeliveryLogFormatArgsDict']]] = None,
                 log_type: pulumi.Input[Optional[_builtins.str]] = None,
                 s3: pulumi.Input[Optional[Union['RealtimeLogDeliveryS3Args', 'RealtimeLogDeliveryS3ArgsDict']]] = None,
                 sample: pulumi.Input[Optional[_builtins.int]] = None,
                 task_name: pulumi.Input[Optional[_builtins.str]] = None,
                 task_type: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            task_name: pulumi.Input[Optional[_builtins.str]] = None,
            task_type: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RealtimeLogDelivery':
        """
