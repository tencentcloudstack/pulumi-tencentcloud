...
class RealtimeLogDeliveryArgs:
    def __init__(__self__, *,
                 ...
                 delivery_status: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] task_type: The real-time log delivery task type. The possible values are: `cls`: push to Tencent Cloud CLS; `custom_endpoint`: push to a custom HTTP(S) address; `s3`: push to an AWS S3 compatible storage bucket address.
    ...
    def delivery_status(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def delivery_status(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _RealtimeLogDeliveryState:
    def __init__(__self__, *,
                 ...
                 delivery_conditions: Optional[pulumi.Input[Sequence[pulumi.Input['RealtimeLogDeliveryDeliveryConditionArgs']]]] = None,
                 delivery_status: Optional[pulumi.Input[_builtins.str]] = None,
                 entity_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 log_format: Optional[pulumi.Input['RealtimeLogDeliveryLogFormatArgs']] = None,
                 log_type: Optional[pulumi.Input[_builtins.str]] = None,
                 s3: Optional[pulumi.Input['RealtimeLogDeliveryS3Args']] = None,
                 sample: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="entityLists")
    def entity_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        List of entities (seven-layer domain names or four-layer proxy instances) corresponding to real-time log delivery tasks. Example values are as follows: Seven-layer domain name: `domain.example.com`; four-layer proxy instance: sid-2s69eb5wcms7. For values, refer to: `https://cloud.tencent.com/document/api/1552/80690`, `https://cloud.tencent.com/document/api/1552/86336`.
        """
        return pulumi.get(self, "entity_lists")
    ...
    @entity_lists.setter
    def entity_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "entity_lists", value)
    ...
    @_builtins.property
    @pulumi.getter
    def sample(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        The sampling ratio is in thousandths, with a value range of 1-1000. For example, filling in 605 means the sampling ratio is 60.5%. Leaving it blank means the sampling ratio is 100%.
        """
        return pulumi.get(self, "sample")
    ...
    @sample.setter
    def sample(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "sample", value)
...
class RealtimeLogDelivery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 area: Optional[pulumi.Input[_builtins.str]] = None,
                 cls: Optional[pulumi.Input[Union['RealtimeLogDeliveryClsArgs', 'RealtimeLogDeliveryClsArgsDict']]] = None,
                 custom_endpoint: Optional[pulumi.Input[Union['RealtimeLogDeliveryCustomEndpointArgs', 'RealtimeLogDeliveryCustomEndpointArgsDict']]] = None,
                 custom_fields: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RealtimeLogDeliveryCustomFieldArgs', 'RealtimeLogDeliveryCustomFieldArgsDict']]]]] = None,
                 delivery_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RealtimeLogDeliveryDeliveryConditionArgs', 'RealtimeLogDeliveryDeliveryConditionArgsDict']]]]] = None,
                 delivery_status: Optional[pulumi.Input[_builtins.str]] = None,
                 entity_lists: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 fields: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 log_format: Optional[pulumi.Input[Union['RealtimeLogDeliveryLogFormatArgs', 'RealtimeLogDeliveryLogFormatArgsDict']]] = None,
                 log_type: Optional[pulumi.Input[_builtins.str]] = None,
                 s3: Optional[pulumi.Input[Union['RealtimeLogDeliveryS3Args', 'RealtimeLogDeliveryS3ArgsDict']]] = None,
                 sample: Optional[pulumi.Input[_builtins.int]] = None,
                 task_name: Optional[pulumi.Input[_builtins.str]] = None,
                 task_type: Optional[pulumi.Input[_builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            task_name: Optional[pulumi.Input[_builtins.str]] = None,
            task_type: Optional[pulumi.Input[_builtins.str]] = None,
            zone_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'RealtimeLogDelivery':
        """
