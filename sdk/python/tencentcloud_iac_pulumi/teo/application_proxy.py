...
class ApplicationProxyArgs:
    def __init__(__self__, *,
                 ...
                 session_persist_time: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def session_persist_time(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def session_persist_time(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class _ApplicationProxyState:
    def __init__(__self__, *,
                 accelerate_type: pulumi.Input[Optional[_builtins.int]] = None,
                 area: pulumi.Input[Optional[_builtins.str]] = None,
                 ban_status: pulumi.Input[Optional[_builtins.str]] = None,
                 host_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ipv6: pulumi.Input[Optional['ApplicationProxyIpv6Args']] = None,
                 plat_type: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_name: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_type: pulumi.Input[Optional[_builtins.str]] = None,
                 schedule_values: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 security_type: pulumi.Input[Optional[_builtins.int]] = None,
                 session_persist_time: pulumi.Input[Optional[_builtins.int]] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="accelerateType")
    def accelerate_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        - `0`: Disable acceleration.- `1`: Enable acceleration.
        """
        return pulumi.get(self, "accelerate_type")
    ...
    @accelerate_type.setter
    def accelerate_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "accelerate_type", value)
    ...
    def ban_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @ban_status.setter
    def ban_status(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter(name="platType")
    def plat_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Scheduling mode.- `ip`: Anycast IP.- `domain`: CNAME.
        """
        return pulumi.get(self, "plat_type")
    ...
    @plat_type.setter
    def plat_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "plat_type", value)
    ...
    def schedule_values(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def schedule_values(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "schedule_values", value)

    @_builtins.property
    @pulumi.getter(name="securityType")
    def security_type(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        - `0`: Disable security protection.- `1`: Enable security protection.
        """
        return pulumi.get(self, "security_type")
    ...
    @security_type.setter
    def security_type(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "security_type", value)
...
class ApplicationProxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 accelerate_type: pulumi.Input[Optional[_builtins.int]] = None,
                 ipv6: pulumi.Input[Optional[Union['ApplicationProxyIpv6Args', 'ApplicationProxyIpv6ArgsDict']]] = None,
                 plat_type: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_name: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_type: pulumi.Input[Optional[_builtins.str]] = None,
                 security_type: pulumi.Input[Optional[_builtins.int]] = None,
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ApplicationProxy':
        """
