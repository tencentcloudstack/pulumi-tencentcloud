...
class GetZoneAvailablePlansResult:
    ...
    def plan_info_lists(
        self,
    ) -> Sequence["outputs.GetZoneAvailablePlansPlanInfoListResult"]:
        """
...
def get_zone_available_plans(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Teo/getZoneAvailablePlans:getZoneAvailablePlans",
        __args__,
        opts=opts,
        typ=GetZoneAvailablePlansResult,
    ).value
...
def get_zone_available_plans_output(
    ...
    return __ret__.apply(
        lambda __response__: GetZoneAvailablePlansResult(
