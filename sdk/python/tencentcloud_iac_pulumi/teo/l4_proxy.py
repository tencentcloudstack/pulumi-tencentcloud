...
class L4ProxyArgs:
    def __init__(__self__, *,
                 ...
                 accelerate_mainland: pulumi.Input[Optional[_builtins.str]] = None,
                 area: pulumi.Input[Optional[_builtins.str]] = None,
                 ddos_protection_config: pulumi.Input[Optional['L4ProxyDdosProtectionConfigArgs']] = None,
        ...
        if ddos_protection_config is not None:
            warnings.warn("""It has been deprecated from version 1.82.90. Please do not use this field anymore.""", DeprecationWarning)
            pulumi.log.warn("""ddos_protection_config is deprecated: It has been deprecated from version 1.82.90. Please do not use this field anymore.""")
        if ddos_protection_config is not None:
    ...
    def accelerate_mainland(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def accelerate_mainland(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_utilities.deprecated("""It has been deprecated from version 1.82.90. Please do not use this field anymore.""")
    def ddos_protection_config(self) -> pulumi.Input[Optional['L4ProxyDdosProtectionConfigArgs']]:
        """
    ...
    def ddos_protection_config(self, value: pulumi.Input[Optional['L4ProxyDdosProtectionConfigArgs']]):
...
class L4Proxy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 accelerate_mainland: pulumi.Input[Optional[_builtins.str]] = None,
                 area: pulumi.Input[Optional[_builtins.str]] = None,
                 ddos_protection_config: pulumi.Input[Optional[Union['L4ProxyDdosProtectionConfigArgs', 'L4ProxyDdosProtectionConfigArgsDict']]] = None,
                 ipv6: pulumi.Input[Optional[_builtins.str]] = None,
                 proxy_name: pulumi.Input[Optional[_builtins.str]] = None,
                 static_ip: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            proxy_name: pulumi.Input[Optional[_builtins.str]] = None,
            static_ip: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'L4Proxy':
        """
    ...
    @pulumi.getter(name="ddosProtectionConfig")
    @_utilities.deprecated("""It has been deprecated from version 1.82.90. Please do not use this field anymore.""")
    def ddos_protection_config(self) -> pulumi.Output['outputs.L4ProxyDdosProtectionConfig']:
        """
        It has been deprecated from version 1.82.90. Please do not use this field anymore. Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For details, see [Exclusive DDoS Protection Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        """
        return pulumi.get(self, "ddos_protection_config")
