...
class L4ProxyArgs:
    def __init__(
        ...
        *,
        ...
        accelerate_mainland: pulumi.Input[_builtins.str | None] = None,
        area: pulumi.Input[_builtins.str | None] = None,
        ddos_protection_config: pulumi.Input[
            Optional["L4ProxyDdosProtectionConfigArgs"]
        ] = None,
        ipv6: pulumi.Input[_builtins.str | None] = None,
        static_ip: pulumi.Input[_builtins.str | None] = None
    ):
        """
        ...
        :param pulumi.Input['L4ProxyDdosProtectionConfigArgs'] ddos_protection_config: It has been deprecated from version 1.82.90. Please do not use this field anymore. Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For details, see [Exclusive DDoS Protection Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        ...
        if ddos_protection_config is not None:
            warnings.warn(
                """It has been deprecated from version 1.82.90. Please do not use this field anymore.""",
                DeprecationWarning,
            )
            pulumi.log.warn(
                """ddos_protection_config is deprecated: It has been deprecated from version 1.82.90. Please do not use this field anymore."""
            )
        if ddos_protection_config is not None:
    ...
    def accelerate_mainland(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def accelerate_mainland(self, value: pulumi.Input[_builtins.str | None]):
    ...
    def ddos_protection_config(
        self,
    ) -> pulumi.Input[Optional["L4ProxyDdosProtectionConfigArgs"]]:
        """
    ...
    def ddos_protection_config(
        self, value: pulumi.Input[Optional["L4ProxyDdosProtectionConfigArgs"]]
    ):
        pulumi.set(self, "ddos_protection_config", value)

    @_builtins.property
    @pulumi.getter
    def ipv6(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @ipv6.setter
    def ipv6(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "ipv6", value)

    @_builtins.property
    @pulumi.getter(name="staticIp")
    def static_ip(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @static_ip.setter
    def static_ip(self, value: pulumi.Input[_builtins.str | None]):
...
class _L4ProxyState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input['L4ProxyDdosProtectionConfigArgs'] ddos_protection_config: It has been deprecated from version 1.82.90. Please do not use this field anymore. Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For details, see [Exclusive DDoS Protection Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        :param pulumi.Input[_builtins.str] ipv6: Specifies whether to enable IPv6 access. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        :param pulumi.Input[_builtins.str] proxy_id: L4 proxy instance ID.
        :param pulumi.Input[_builtins.str] proxy_name: Layer 4 proxy instance name. You can enter 1-50 characters. Valid characters are a-z, 0-9, and hyphens (-). However, hyphens (-) cannot be used individually or consecutively and should not be placed at the beginning or end of the name. Modifications are not allowed after creation.
        :param pulumi.Input[_builtins.str] static_ip: Specifies whether to enable the fixed IP address. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        :param pulumi.Input[_builtins.str] zone_id: Site ID.
        """
...
class L4Proxy(pulumi.CustomResource):
    ...
    def __init__(
        ...
        ddos_protection_config: pulumi.Input[
            Union[
                "L4ProxyDdosProtectionConfigArgs", "L4ProxyDdosProtectionConfigArgsDict"
            ]
            | None
        ] = None,
        ipv6: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.str] accelerate_mainland: Specifies whether to enable network optimization in the Chinese mainland. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        :param pulumi.Input[_builtins.str] area: Acceleration zone of the Layer 4 proxy instance. `mainland`: Availability zone in the Chinese mainland; `overseas`: Global availability zone (excluding the Chinese mainland); `global`: Global availability zone.
        :param pulumi.Input[Union['L4ProxyDdosProtectionConfigArgs', 'L4ProxyDdosProtectionConfigArgsDict']] ddos_protection_config: It has been deprecated from version 1.82.90. Please do not use this field anymore. Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For details, see [Exclusive DDoS Protection Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        :param pulumi.Input[_builtins.str] ipv6: Specifies whether to enable IPv6 access. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        :param pulumi.Input[_builtins.str] proxy_name: Layer 4 proxy instance name. You can enter 1-50 characters. Valid characters are a-z, 0-9, and hyphens (-). However, hyphens (-) cannot be used individually or consecutively and should not be placed at the beginning or end of the name. Modifications are not allowed after creation.
        :param pulumi.Input[_builtins.str] static_ip: Specifies whether to enable the fixed IP address. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        :param pulumi.Input[_builtins.str] zone_id: Site ID.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            L4ProxyArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Teo/l4Proxy:L4Proxy", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="accelerateMainland")
    def accelerate_mainland(self) -> pulumi.Output[_builtins.str | None]:
        """
        Specifies whether to enable network optimization in the Chinese mainland. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        """
        return pulumi.get(self, "accelerate_mainland")
    ...
    def ddos_protection_config(
        self,
    ) -> pulumi.Output["outputs.L4ProxyDdosProtectionConfig"]:
        """
        It has been deprecated from version 1.82.90. Please do not use this field anymore. Layer 3/Layer 4 DDoS protection. The default protection option of the platform will be used if it is left empty. For details, see [Exclusive DDoS Protection Usage](https://intl.cloud.tencent.com/document/product/1552/95994?from_cn_redirect=1).
        """
        return pulumi.get(self, "ddos_protection_config")
    ...
    @_builtins.property
    @pulumi.getter
    def ipv6(self) -> pulumi.Output[_builtins.str | None]:
        """
        Specifies whether to enable IPv6 access. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        """
        return pulumi.get(self, "ipv6")
    ...
    @_builtins.property
    @pulumi.getter(name="staticIp")
    def static_ip(self) -> pulumi.Output[_builtins.str | None]:
        """
        Specifies whether to enable the fixed IP address. The default value off is used if left empty. This configuration can only be enabled in certain acceleration zones and security protection configurations. For details, see [Creating an L4 Proxy Instance](https://intl.cloud.tencent.com/document/product/1552/90025?from_cn_redirect=1). Valid values: `on`: Enable; `off`: Disable.
        """
        return pulumi.get(self, "static_ip")
