...
class SecurityPolicyArgs:
    def __init__(
        ...
        *,
        ...
        config: pulumi.Input["SecurityPolicyConfigArgs"] | None = None
    ):
        """
    ...
    @property
    @pulumi.getter
    def config(self) -> pulumi.Input["SecurityPolicyConfigArgs"] | None:
        """
    ...
    @config.setter
    def config(self, value: pulumi.Input["SecurityPolicyConfigArgs"] | None):
...
class SecurityPolicy(pulumi.CustomResource):
    ...
    def __init__(
        ...
        config: pulumi.Input[pulumi.InputType["SecurityPolicyConfigArgs"]] | None = None,
        entity: pulumi.Input[str] | None = None,
        zone_id: pulumi.Input[str] | None = None,
        __props__=None,
    ):
