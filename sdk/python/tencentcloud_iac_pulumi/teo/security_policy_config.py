...
__all__ = ["SecurityPolicyConfig", "SecurityPolicyConfigArgs"]
...
class SecurityPolicyConfigArgs:
    def __init__(
        ...
        *,
        ...
        security_config: pulumi.Input[
            Optional["SecurityPolicyConfigSecurityConfigArgs"]
        ] = None,
        security_policy: pulumi.Input[
            Optional["SecurityPolicyConfigSecurityPolicyArgs"]
        ] = None,
        ...
        :param pulumi.Input['SecurityPolicyConfigSecurityConfigArgs'] security_config: Security configuration. Classic web protection settings. Note: the DescribeSecurityPolicy API does not return SecurityConfig, so this field is write-only for state consistency. For each sub-configuration, if not specified, the existing API configuration is kept.
    ...
    def security_config(
        self,
    ) -> pulumi.Input[Optional["SecurityPolicyConfigSecurityConfigArgs"]]:
        """
    ...
    def security_config(
        self, value: pulumi.Input[Optional["SecurityPolicyConfigSecurityConfigArgs"]]
    ):
    ...
    def security_policy(
        self,
    ) -> pulumi.Input[Optional["SecurityPolicyConfigSecurityPolicyArgs"]]:
        """
    ...
    def security_policy(
        self, value: pulumi.Input[Optional["SecurityPolicyConfigSecurityPolicyArgs"]]
    ):
...
class SecurityPolicyConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        security_config: pulumi.Input[
            Union[
                "SecurityPolicyConfigSecurityConfigArgs",
                "SecurityPolicyConfigSecurityConfigArgsDict",
            ]
            | None
        ] = None,
        security_policy: pulumi.Input[
            Union[
                "SecurityPolicyConfigSecurityPolicyArgs",
                "SecurityPolicyConfigSecurityPolicyArgsDict",
            ]
            | None
        ] = None,
        template_id: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.str] entity: Security policy type. the following parameter values can be used: <li>ZoneDefaultPolicy: used to specify a site-level policy;</li> <li>Template: used to specify a policy Template. you need to simultaneously specify the TemplateId parameter;</li> <li>Host: used to specify a domain-level policy (note: when using a domain name to specify a dns service policy, only dns services or policy templates that have applied a domain-level policy are supported).</li>.
        :param pulumi.Input[_builtins.str] host: Specifies the specified domain. when the Entity parameter value is Host, use the domain-level policy specified by this parameter. for example: use www.example.com to configure the domain-level policy of the domain.
        :param pulumi.Input[Union['SecurityPolicyConfigSecurityConfigArgs', 'SecurityPolicyConfigSecurityConfigArgsDict']] security_config: Security configuration. Classic web protection settings. Note: the DescribeSecurityPolicy API does not return SecurityConfig, so this field is write-only for state consistency. For each sub-configuration, if not specified, the existing API configuration is kept.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SecurityPolicyConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter
    def entity(self) -> pulumi.Output[_builtins.str | None]:
        """
        Security policy type. the following parameter values can be used: <li>ZoneDefaultPolicy: used to specify a site-level policy;</li> <li>Template: used to specify a policy Template. you need to simultaneously specify the TemplateId parameter;</li> <li>Host: used to specify a domain-level policy (note: when using a domain name to specify a dns service policy, only dns services or policy templates that have applied a domain-level policy are supported).</li>.
        """
        return pulumi.get(self, "entity")
    ...
    def security_config(
        self,
    ) -> pulumi.Output["outputs.SecurityPolicyConfigSecurityConfig"]:
        """
        Security configuration. Classic web protection settings. Note: the DescribeSecurityPolicy API does not return SecurityConfig, so this field is write-only for state consistency. For each sub-configuration, if not specified, the existing API configuration is kept.
        """
        return pulumi.get(self, "security_config")
    ...
    def security_policy(
        self,
    ) -> pulumi.Output[Optional["outputs.SecurityPolicyConfigSecurityPolicy"]]:
        """
        Security policy configuration. it is recommended to use for custom policies and managed rule configurations of Web protection. it supports configuring security policies with expression grammar.
        """
        return pulumi.get(self, "security_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="templateId")
    def template_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        Specify the policy Template ID. use this parameter to specify the ID of the policy Template when the Entity parameter value is Template.
        """
        return pulumi.get(self, "template_id")
