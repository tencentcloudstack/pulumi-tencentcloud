...
class SecurityPolicyConfigArgs:
    def __init__(__self__, *,
                 ...
                 security_config: pulumi.Input[Optional['SecurityPolicyConfigSecurityConfigArgs']] = None,
                 security_policy: pulumi.Input[Optional['SecurityPolicyConfigSecurityPolicyArgs']] = None,
    ...
    def security_config(self) -> pulumi.Input[Optional['SecurityPolicyConfigSecurityConfigArgs']]:
        """
    ...
    def security_config(self, value: pulumi.Input[Optional['SecurityPolicyConfigSecurityConfigArgs']]):
        pulumi.set(self, "security_config", value)

    @_builtins.property
    @pulumi.getter(name="securityPolicy")
    def security_policy(self) -> pulumi.Input[Optional['SecurityPolicyConfigSecurityPolicyArgs']]:
        """
    ...
    def security_policy(self, value: pulumi.Input[Optional['SecurityPolicyConfigSecurityPolicyArgs']]):
...
class SecurityPolicyConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 entity: pulumi.Input[Optional[_builtins.str]] = None,
                 host: pulumi.Input[Optional[_builtins.str]] = None,
                 security_config: pulumi.Input[Optional[Union['SecurityPolicyConfigSecurityConfigArgs', 'SecurityPolicyConfigSecurityConfigArgsDict']]] = None,
                 security_policy: pulumi.Input[Optional[Union['SecurityPolicyConfigSecurityPolicyArgs', 'SecurityPolicyConfigSecurityPolicyArgsDict']]] = None,
                 template_id: pulumi.Input[Optional[_builtins.str]] = None,
                 zone_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            security_policy: pulumi.Input[Optional[Union['SecurityPolicyConfigSecurityPolicyArgs', 'SecurityPolicyConfigSecurityPolicyArgsDict']]] = None,
            template_id: pulumi.Input[Optional[_builtins.str]] = None,
            zone_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'SecurityPolicyConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="securityConfig")
    def security_config(self) -> pulumi.Output['outputs.SecurityPolicyConfigSecurityConfig']:
        """
        Security configuration. Classic web protection settings. Note: the DescribeSecurityPolicy API does not return SecurityConfig, so this field is write-only for state consistency. For each sub-configuration, if not specified, the existing API configuration is kept.
        """
        return pulumi.get(self, "security_config")
