...
class AwaitableGetSecurityPolicyRegionsResult(GetSecurityPolicyRegionsResult):
    ...
    def __await__(self):
        ...
        return GetSecurityPolicyRegionsResult(
            geo_ips=self.geo_ips, id=self.id, result_output_file=self.result_output_file
        )


def get_security_policy_regions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Teo/getSecurityPolicyRegions:getSecurityPolicyRegions",
        __args__,
        opts=opts,
        typ=GetSecurityPolicyRegionsResult,
    ).value
...
def get_security_policy_regions_output(
    result_output_file: pulumi.Input[str | None] | None = None,
    opts: pulumi.InvokeOptions | None = None,
) -> pulumi.Output[GetSecurityPolicyRegionsResult]:
    """
    Use this data source to access information about an existing resource.
    """
