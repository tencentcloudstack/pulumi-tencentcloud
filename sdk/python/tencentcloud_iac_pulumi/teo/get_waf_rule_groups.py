...
def get_waf_rule_groups(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Teo/getWafRuleGroups:getWafRuleGroups",
        __args__,
        opts=opts,
        typ=GetWafRuleGroupsResult,
    ).value
