...
__all__ = ["DnsRecord", "DnsRecordArgs"]
...
class DnsRecordArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] location: DNS record resolution route, not specified as default, indicates the default resolution route, which is effective for all regions.
...
class DnsRecord(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DnsRecordArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Teo/dnsRecord:DnsRecord", resource_name, __props__, opts
        )
