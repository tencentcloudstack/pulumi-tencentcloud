...
class DdosPolicyArgs:
    def __init__(
        ...
        *,
        ...
        ddos_rule: pulumi.Input["DdosPolicyDdosRuleArgs"] | None = None
    ):
        """
    ...
    def ddos_rule(self) -> pulumi.Input["DdosPolicyDdosRuleArgs"] | None:
        """
    ...
    @ddos_rule.setter
    def ddos_rule(self, value: pulumi.Input["DdosPolicyDdosRuleArgs"] | None):
...
class _DdosPolicyState:
    def __init__(
        ...
        *,
        ddos_rule: pulumi.Input["DdosPolicyDdosRuleArgs"] | None = None,
        policy_id: pulumi.Input[int] | None = None,
    ...
    @property
    @pulumi.getter(name="policyId")
    def policy_id(self) -> pulumi.Input[int] | None:
        """
        Policy ID.
        """
        return pulumi.get(self, "policy_id")
    ...
    @policy_id.setter
    def policy_id(self, value: pulumi.Input[int] | None):
        pulumi.set(self, "policy_id", value)
...
class DdosPolicy(pulumi.CustomResource):
    ...
    def __init__(
        ...
        ddos_rule: pulumi.Input[pulumi.InputType["DdosPolicyDdosRuleArgs"]] | None = None,
        policy_id: pulumi.Input[int] | None = None,
        zone_id: pulumi.Input[str] | None = None,
        __props__=None,
    ):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Teo/ddosPolicy:DdosPolicy", resource_name, __props__, opts
        )
