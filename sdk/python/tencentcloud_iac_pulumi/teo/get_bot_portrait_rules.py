...
def get_bot_portrait_rules(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Teo/getBotPortraitRules:getBotPortraitRules",
        __args__,
        opts=opts,
        typ=GetBotPortraitRulesResult,
    ).value
