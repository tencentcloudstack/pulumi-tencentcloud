...
__all__ = ["BlockIgnore", "BlockIgnoreArgs"]
...
class BlockIgnoreArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] direction: Rule direction, 0 outbound, 1 inbound, 3 intranet.
        :param pulumi.Input[_builtins.str] end_time: Rule end time, format: 2006-01-02 15:04:05, must be greater than the current time.
        :param pulumi.Input[_builtins.int] rule_type: Rule type, 1 block, 2 ignore, domain block is not supported.
        :param pulumi.Input[_builtins.str] comment: Remarks information, length cannot exceed 50.
        :param pulumi.Input[_builtins.str] domain: Rule domain name, one of IP and Domain is required.
        :param pulumi.Input[_builtins.str] ip: Rule IP address, one of IP and Domain is required.
        :param pulumi.Input[_builtins.str] start_time: Rule start time.
        """
...
class _BlockIgnoreState:
    ...
    @_builtins.property
    @pulumi.getter
    def direction(self) -> pulumi.Input[_builtins.str | None]:
        """
        Rule direction, 0 outbound, 1 inbound, 3 intranet.
        """
        return pulumi.get(self, "direction")
...
@pulumi.type_token("tencentcloud:Cfw/blockIgnore:BlockIgnore")
class BlockIgnore(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BlockIgnoreArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cfw/blockIgnore:BlockIgnore", resource_name, __props__, opts
        )
