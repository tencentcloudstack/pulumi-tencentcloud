...
__all__ = ["VpcInstance", "VpcInstanceArgs"]
...
class VpcInstanceArgs:
    def __init__(
        ...
        *,
        ...
        vpc_fw_instances: pulumi.Input[
            Sequence[pulumi.Input["VpcInstanceVpcFwInstanceArgs"]]
        ],
        ccn_id: pulumi.Input[_builtins.str | None] = None,
        fw_vpc_cidr: pulumi.Input[_builtins.str | None] = None,
        name: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a VpcInstance resource.

        :param pulumi.Input[_builtins.int] mode: Mode 0: private network mode; 1: CCN cloud networking mode.
        :param pulumi.Input[_builtins.int] switch_mode: Switch mode of firewall instance. 1: Single point intercommunication; 2: Multi-point communication; 4: Custom Routing.
        ...
        :param pulumi.Input[_builtins.str] ccn_id: Cloud networking id, suitable for cloud networking mode.
        :param pulumi.Input[_builtins.str] fw_vpc_cidr: auto Automatically select the firewall network segment; 10.10.10.0/24 The firewall network segment entered by the user.
        :param pulumi.Input[_builtins.str] name: VPC firewall (group) name.
        """
    ...
    def vpc_fw_instances(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["VpcInstanceVpcFwInstanceArgs"]]]:
        """
    ...
    def vpc_fw_instances(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["VpcInstanceVpcFwInstanceArgs"]]],
    ):
    ...
    def fw_vpc_cidr(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @fw_vpc_cidr.setter
    def fw_vpc_cidr(self, value: pulumi.Input[_builtins.str | None]):
...
class _VpcInstanceState:
    def __init__(
        ...
        *,
        ...
        vpc_fw_instances: pulumi.Input[
            Sequence[pulumi.Input["VpcInstanceVpcFwInstanceArgs"]] | None
        ] = None
    ):
        """
        ...
        :param pulumi.Input[_builtins.str] ccn_id: Cloud networking id, suitable for cloud networking mode.
        :param pulumi.Input[_builtins.str] fw_group_id: Firewall group ID.
        :param pulumi.Input[_builtins.str] fw_vpc_cidr: auto Automatically select the firewall network segment; 10.10.10.0/24 The firewall network segment entered by the user.
        :param pulumi.Input[_builtins.int] mode: Mode 0: private network mode; 1: CCN cloud networking mode.
        :param pulumi.Input[_builtins.str] name: VPC firewall (group) name.
        :param pulumi.Input[_builtins.int] switch_mode: Switch mode of firewall instance. 1: Single point intercommunication; 2: Multi-point communication; 4: Custom Routing.
    ...
    def vpc_fw_instances(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["VpcInstanceVpcFwInstanceArgs"]] | None]:
        """
        List of firewall instances under firewall (group).
        """
        return pulumi.get(self, "vpc_fw_instances")
...
@pulumi.type_token("tencentcloud:Cfw/vpcInstance:VpcInstance")
class VpcInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        :param pulumi.Input[_builtins.str] name: VPC firewall (group) name.
        :param pulumi.Input[_builtins.int] switch_mode: Switch mode of firewall instance. 1: Single point intercommunication; 2: Multi-point communication; 4: Custom Routing.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VpcInstanceVpcFwInstanceArgs', 'VpcInstanceVpcFwInstanceArgsDict']]]] vpc_fw_instances: List of firewall instances under firewall (group).
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            VpcInstanceArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__.__dict__["fw_group_id"] = None
        super().__init__(
            "tencentcloud:Cfw/vpcInstance:VpcInstance", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="ccnId")
    def ccn_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        Cloud networking id, suitable for cloud networking mode.
        """
        return pulumi.get(self, "ccn_id")
    ...
    @_builtins.property
    @pulumi.getter(name="fwGroupId")
    def fw_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        Firewall group ID.
        """
        return pulumi.get(self, "fw_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="fwVpcCidr")
    def fw_vpc_cidr(self) -> pulumi.Output[_builtins.str | None]:
        """
        auto Automatically select the firewall network segment; 10.10.10.0/24 The firewall network segment entered by the user.
        """
        return pulumi.get(self, "fw_vpc_cidr")
    ...
    def vpc_fw_instances(
        self,
    ) -> pulumi.Output[Sequence["outputs.VpcInstanceVpcFwInstance"]]:
        """
        List of firewall instances under firewall (group).
        """
        return pulumi.get(self, "vpc_fw_instances")
