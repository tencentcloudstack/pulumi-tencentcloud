...
__all__ = ["EdgeFirewallSwitch", "EdgeFirewallSwitchArgs"]
...
class EdgeFirewallSwitchArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] switch_mode: 0: bypass; 1: serial.
        :param pulumi.Input[_builtins.str] subnet_id: The first EIP switch in the vpc is turned on, and you need to specify a subnet to create a private connection. If `switch_mode` is 1 and `enable` is 1, this field is required.
        """
...
@pulumi.type_token("tencentcloud:Cfw/edgeFirewallSwitch:EdgeFirewallSwitch")
class EdgeFirewallSwitch(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_edge_firewall_switch = tencentcloud.cfw.EdgeFirewallSwitch("example",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            EdgeFirewallSwitchArgs, pulumi.ResourceOptions, *args, **kwargs
        )
