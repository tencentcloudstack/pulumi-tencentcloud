...
class GetDescribeHostUpdateRecordDetailResult:
    ...
    def record_detail_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostUpdateRecordDetailRecordDetailListResult"]:
        """
...
class AwaitableGetDescribeHostUpdateRecordDetailResult(
    GetDescribeHostUpdateRecordDetailResult
):
...
def get_describe_host_update_record_detail(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostUpdateRecordDetail:getDescribeHostUpdateRecordDetail",
        __args__,
        opts=opts,
        typ=GetDescribeHostUpdateRecordDetailResult,
    ).value
...
def get_describe_host_update_record_detail_output(
...
) -> pulumi.Output[GetDescribeHostUpdateRecordDetailResult]:
    """
    Use this data source to query detailed information of ssl describe_host_update_record_detail
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostUpdateRecordDetailResult(
