...
class GetDescribeHostTkeInstanceListResult:
    ...
    def filters(
        self,
    ) -> Sequence["outputs.GetDescribeHostTkeInstanceListFilterResult"] | None:
    ...
    def instance_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostTkeInstanceListInstanceListResult"]:
        """
...
class AwaitableGetDescribeHostTkeInstanceListResult(
    GetDescribeHostTkeInstanceListResult
):
...
def get_describe_host_tke_instance_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostTkeInstanceList:getDescribeHostTkeInstanceList",
        __args__,
        opts=opts,
        typ=GetDescribeHostTkeInstanceListResult,
    ).value
...
def get_describe_host_tke_instance_list_output(
...
) -> pulumi.Output[GetDescribeHostTkeInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_tke_instance_list
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostTkeInstanceListResult(
