...
def get_describe_host_ddos_instance_list(certificate_id: Optional[_builtins.str] = None,
                                         filters: Optional[Sequence[Union['GetDescribeHostDdosInstanceListFilterArgs', 'GetDescribeHostDdosInstanceListFilterArgsDict']]] = None,
...
def get_describe_host_ddos_instance_list_output(certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetDescribeHostDdosInstanceListFilterArgs', 'GetDescribeHostDdosInstanceListFilterArgsDict']]]]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDescribeHostDdosInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_ddos_instance_list
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ssl/getDescribeHostDdosInstanceList:getDescribeHostDdosInstanceList', __args__, opts=opts, typ=GetDescribeHostDdosInstanceListResult)
    return __ret__.apply(lambda __response__: GetDescribeHostDdosInstanceListResult(
