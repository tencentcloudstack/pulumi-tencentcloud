...
class GetDescribeManagerDetailResult:
    ...
    def contact_mail(self) -> _builtins.str:
        """
        Contact mailbox.
        """
...
def get_describe_manager_detail(manager_id: Optional[_builtins.int] = None,
    ...
    describe_manager_detail = tencentcloud.ssl.get_describe_manager_detail(manager_id=int(""))
    ```
...
def get_describe_manager_detail_output(manager_id: pulumi.Input[Optional[_builtins.int]] = None,
                                       result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDescribeManagerDetailResult]:
    """
    Use this data source to query detailed information of ssl describe_manager_detail
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ssl/getDescribeManagerDetail:getDescribeManagerDetail', __args__, opts=opts, typ=GetDescribeManagerDetailResult)
    return __ret__.apply(lambda __response__: GetDescribeManagerDetailResult(
        company_id=pulumi.get(__response__, 'company_id'),
        company_infos=pulumi.get(__response__, 'company_infos'),
        contact_first_name=pulumi.get(__response__, 'contact_first_name'),
        contact_last_name=pulumi.get(__response__, 'contact_last_name'),
        contact_mail=pulumi.get(__response__, 'contact_mail'),
        contact_phone=pulumi.get(__response__, 'contact_phone'),
        contact_position=pulumi.get(__response__, 'contact_position'),
        create_time=pulumi.get(__response__, 'create_time'),
        expire_time=pulumi.get(__response__, 'expire_time'),
        id=pulumi.get(__response__, 'id'),
        manager_department=pulumi.get(__response__, 'manager_department'),
        manager_first_name=pulumi.get(__response__, 'manager_first_name'),
        manager_id=pulumi.get(__response__, 'manager_id'),
        manager_last_name=pulumi.get(__response__, 'manager_last_name'),
        manager_mail=pulumi.get(__response__, 'manager_mail'),
        manager_phone=pulumi.get(__response__, 'manager_phone'),
        manager_position=pulumi.get(__response__, 'manager_position'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        status=pulumi.get(__response__, 'status'),
        verify_time=pulumi.get(__response__, 'verify_time')))
