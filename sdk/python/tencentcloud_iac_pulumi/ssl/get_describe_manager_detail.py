...
class GetDescribeManagerDetailResult:
    ...
    def company_infos(
        self,
    ) -> Sequence["outputs.GetDescribeManagerDetailCompanyInfoResult"]:
        """
...
def get_describe_manager_detail(
    manager_id: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeManagerDetail:getDescribeManagerDetail",
        __args__,
        opts=opts,
        typ=GetDescribeManagerDetailResult,
    ).value
...
def get_describe_manager_detail_output(
    manager_id: pulumi.Input[_builtins.int | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetDescribeManagerDetailResult]:
    """
    Use this data source to query detailed information of ssl describe_manager_detail
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeManagerDetailResult(
