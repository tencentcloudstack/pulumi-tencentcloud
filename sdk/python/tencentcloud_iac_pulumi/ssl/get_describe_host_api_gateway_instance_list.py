...
def get_describe_host_api_gateway_instance_list(certificate_id: Optional[_builtins.str] = None,
                                                filters: Optional[Sequence[Union['GetDescribeHostApiGatewayInstanceListFilterArgs', 'GetDescribeHostApiGatewayInstanceListFilterArgsDict']]] = None,
    ...
    :param Sequence[Union['GetDescribeHostApiGatewayInstanceListFilterArgs', 'GetDescribeHostApiGatewayInstanceListFilterArgsDict']] filters: List of filtering parameters; Filterkey: domainmatch.
...
def get_describe_host_api_gateway_instance_list_output(certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                       filters: Optional[pulumi.Input[Optional[Sequence[Union['GetDescribeHostApiGatewayInstanceListFilterArgs', 'GetDescribeHostApiGatewayInstanceListFilterArgsDict']]]]] = None,
                                                       ...
                                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDescribeHostApiGatewayInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_api_gateway_instance_list
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ssl/getDescribeHostApiGatewayInstanceList:getDescribeHostApiGatewayInstanceList', __args__, opts=opts, typ=GetDescribeHostApiGatewayInstanceListResult)
    return __ret__.apply(lambda __response__: GetDescribeHostApiGatewayInstanceListResult(
