...
class GetDescribeHostApiGatewayInstanceListResult:
    ...
    def filters(
        self,
    ) -> Sequence["outputs.GetDescribeHostApiGatewayInstanceListFilterResult"] | None:
    ...
    def instance_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostApiGatewayInstanceListInstanceListResult"]:
        """
...
class AwaitableGetDescribeHostApiGatewayInstanceListResult(
    GetDescribeHostApiGatewayInstanceListResult
):
...
def get_describe_host_api_gateway_instance_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostApiGatewayInstanceList:getDescribeHostApiGatewayInstanceList",
        __args__,
        opts=opts,
        typ=GetDescribeHostApiGatewayInstanceListResult,
    ).value
...
def get_describe_host_api_gateway_instance_list_output(
...
) -> pulumi.Output[GetDescribeHostApiGatewayInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_api_gateway_instance_list
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostApiGatewayInstanceListResult(
