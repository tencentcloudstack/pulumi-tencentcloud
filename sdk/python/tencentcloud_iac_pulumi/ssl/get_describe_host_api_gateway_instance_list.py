...
def get_describe_host_api_gateway_instance_list_output(certificate_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                       filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDescribeHostApiGatewayInstanceListFilterArgs', 'GetDescribeHostApiGatewayInstanceListFilterArgsDict']]]]] = None,
