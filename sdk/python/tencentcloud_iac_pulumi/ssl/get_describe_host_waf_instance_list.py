...
def get_describe_host_waf_instance_list(certificate_id: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDescribeHostWafInstanceListFilterArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetDescribeHostWafInstanceListFilterArgs']] filters: List of filtering parameters; Filterkey: domainmatch.
...
@_utilities.lift_output_func(get_describe_host_waf_instance_list)
def get_describe_host_waf_instance_list_output(certificate_id: Optional[pulumi.Input[str]] = None,
                                               filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetDescribeHostWafInstanceListFilterArgs']]]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDescribeHostWafInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_waf_instance_list
