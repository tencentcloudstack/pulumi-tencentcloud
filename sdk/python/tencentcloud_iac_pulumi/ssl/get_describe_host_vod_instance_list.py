...
def get_describe_host_vod_instance_list(certificate_id: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDescribeHostVodInstanceListFilterArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetDescribeHostVodInstanceListFilterArgs']] filters: List of filter parameters.
    ...
    :param str resource_type: Deploy resource type VOD.
...
@_utilities.lift_output_func(get_describe_host_vod_instance_list)
def get_describe_host_vod_instance_list_output(certificate_id: Optional[pulumi.Input[str]] = None,
                                               filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetDescribeHostVodInstanceListFilterArgs']]]]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDescribeHostVodInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_vod_instance_list
