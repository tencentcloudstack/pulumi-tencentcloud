...
__all__ = [
    "DeployCertificateInstanceOperation",
    "DeployCertificateInstanceOperationArgs",
]
...
class _DeployCertificateInstanceOperationState:
    def __init__(
        ...
        *,
        ...
        instance_id_lists: pulumi.Input[
...
class DeployCertificateInstanceOperation(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = DeployCertificateInstanceOperationArgs.__new__(
                DeployCertificateInstanceOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _DeployCertificateInstanceOperationState.__new__(
            _DeployCertificateInstanceOperationState
        )
        ...
        __props__.__dict__["resource_type"] = resource_type
        __props__.__dict__["status"] = status
        return DeployCertificateInstanceOperation(
