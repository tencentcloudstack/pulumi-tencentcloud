...
__all__ = [
    ...
    "CheckCertificateDomainVerificationOperationArgs",
]
...
class _CheckCertificateDomainVerificationOperationState:
    def __init__(
        ...
        *,
        ...
        verification_results: pulumi.Input[
            Sequence[
                pulumi.Input[
...
class CheckCertificateDomainVerificationOperation(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = CheckCertificateDomainVerificationOperationArgs.__new__(
                CheckCertificateDomainVerificationOperationArgs
            )
    ...
    def get(
        ...
        __props__ = _CheckCertificateDomainVerificationOperationState.__new__(
            _CheckCertificateDomainVerificationOperationState
        )

        __props__.__dict__["certificate_id"] = certificate_id
        __props__.__dict__["verification_results"] = verification_results
        return CheckCertificateDomainVerificationOperation(
    ...
    def verification_results(
        ...
        Sequence[
            "outputs.CheckCertificateDomainVerificationOperationVerificationResult"
        ]
    ]:
        """
        Domain name verification results.
