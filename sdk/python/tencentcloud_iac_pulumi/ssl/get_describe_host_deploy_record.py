...
class GetDescribeHostDeployRecordResult:
    ...
    def deploy_record_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostDeployRecordDeployRecordListResult"]:
        """
...
def get_describe_host_deploy_record(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostDeployRecord:getDescribeHostDeployRecord",
        __args__,
        opts=opts,
        typ=GetDescribeHostDeployRecordResult,
    ).value
...
def get_describe_host_deploy_record_output(
...
) -> pulumi.Output[GetDescribeHostDeployRecordResult]:
    """
    Use this data source to query detailed information of ssl describe_host_deploy_record
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostDeployRecordResult(
