...
@pulumi.type_token("tencentcloud:Ssl/checkCertificateChainOperation:CheckCertificateChainOperation")
class CheckCertificateChainOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            certificate_chain: pulumi.Input[Optional[_builtins.str]] = None) -> 'CheckCertificateChainOperation':
        """
