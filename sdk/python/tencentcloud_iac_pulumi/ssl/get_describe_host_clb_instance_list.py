...
class GetDescribeHostClbInstanceListResult:
    ...
    def __init__(
        __self__,
        async_cache=None,
        async_cache_time=None,
        async_offset=None,
        async_total_num=None,
        certificate_id=None,
        filters=None,
        id=None,
        instance_lists=None,
    ...
    def async_cache(self) -> _builtins.int | None:
    ...
    def filters(
        self,
    ) -> Sequence["outputs.GetDescribeHostClbInstanceListFilterResult"] | None:
    ...
    def instance_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostClbInstanceListInstanceListResult"]:
        """
...
class AwaitableGetDescribeHostClbInstanceListResult(
    GetDescribeHostClbInstanceListResult
):
...
def get_describe_host_clb_instance_list(
    async_cache: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostClbInstanceList:getDescribeHostClbInstanceList",
        __args__,
        opts=opts,
        typ=GetDescribeHostClbInstanceListResult,
    ).value
...
def get_describe_host_clb_instance_list_output(
    async_cache: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetDescribeHostClbInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_clb_instance_list
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostClbInstanceListResult(
