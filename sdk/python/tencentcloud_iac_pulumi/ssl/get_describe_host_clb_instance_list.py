...
def get_describe_host_clb_instance_list(async_cache: Optional[int] = None,
                                        certificate_id: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDescribeHostClbInstanceListFilterArgs']]] = None,
    ...
    :param int async_cache: Whether to cache asynchronous.
    :param str certificate_id: Certificate ID to be deployed.
    :param Sequence[pulumi.InputType['GetDescribeHostClbInstanceListFilterArgs']] filters: List of filtering parameters; Filterkey: domainmatch.
...
@_utilities.lift_output_func(get_describe_host_clb_instance_list)
def get_describe_host_clb_instance_list_output(async_cache: Optional[pulumi.Input[Optional[int]]] = None,
                                               certificate_id: Optional[pulumi.Input[str]] = None,
                                               filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetDescribeHostClbInstanceListFilterArgs']]]]] = None,
                                               is_cache: Optional[pulumi.Input[Optional[int]]] = None,
                                               old_certificate_id: Optional[pulumi.Input[Optional[str]]] = None,
                                               result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDescribeHostClbInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_clb_instance_list
