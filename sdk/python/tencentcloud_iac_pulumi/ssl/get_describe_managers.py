...
class GetDescribeManagersResult:
    ...
    def manager_mail(self) -> _builtins.str | None:
        """
        Manager mailbox.
        """
    ...
    def manager_name(self) -> _builtins.str | None:
...
def get_describe_managers(
    company_id: _builtins.int | None = None,
    manager_mail: _builtins.str | None = None,
    manager_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeManagers:getDescribeManagers",
        __args__,
        opts=opts,
        typ=GetDescribeManagersResult,
    ).value
...
def get_describe_managers_output(
    company_id: pulumi.Input[_builtins.int | None] = None,
    manager_mail: pulumi.Input[_builtins.str | None] = None,
    manager_name: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetDescribeManagersResult]:
    """
    Use this data source to query detailed information of ssl describe_managers
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeManagersResult(
