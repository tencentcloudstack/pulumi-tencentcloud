...
def get_describe_host_cos_instance_list(certificate_id: Optional[str] = None,
                                        filters: Optional[Sequence[pulumi.InputType['GetDescribeHostCosInstanceListFilterArgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetDescribeHostCosInstanceListFilterArgs']] filters: List of filter parameters.
    :param int is_cache: Whether to query the cache, 1: Yes; 0: No, the default is the query cache, the cache is half an hour.
    :param str resource_type: Deploy resource type cos.
...
@_utilities.lift_output_func(get_describe_host_cos_instance_list)
def get_describe_host_cos_instance_list_output(certificate_id: Optional[pulumi.Input[str]] = None,
                                               filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetDescribeHostCosInstanceListFilterArgs']]]]] = None,
                                               is_cache: Optional[pulumi.Input[Optional[int]]] = None,
                                               resource_type: Optional[pulumi.Input[str]] = None,
                                               result_output_file: Optional[pulumi.Input[Optional[str]]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDescribeHostCosInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_cos_instance_list
