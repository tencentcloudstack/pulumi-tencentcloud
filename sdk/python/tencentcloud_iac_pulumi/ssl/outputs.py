...
class CheckCertificateDomainVerificationOperationVerificationResult(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param int ca_check: CA inspection results.
        :param Sequence[str] check_values: Detected values.
        :param str domain: Domain name.
        :param bool frequently: Whether frequent requests.
        :param bool issued: Whether issued.
        :param int local_check: Local inspection results.
        :param str local_check_fail_reason: Check the reason for the failure.
        :param str verify_type: Domain Verify Type.
        """
