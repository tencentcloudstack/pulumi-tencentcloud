...
class GetDescribeHostDeployRecordDetailResult:
    ...
    def __init__(
        __self__,
        deploy_record_detail_lists=None,
        deploy_record_id=None,
        failed_total_count=None,
        id=None,
        result_output_file=None,
        running_total_count=None,
        success_total_count=None,
    ):
        if deploy_record_detail_lists and not isinstance(
            deploy_record_detail_lists, list
        ):
            raise TypeError(
                "Expected argument 'deploy_record_detail_lists' to be a list"
            )
    ...
    def deploy_record_detail_lists(
        self,
    ) -> Sequence[
        "outputs.GetDescribeHostDeployRecordDetailDeployRecordDetailListResult"
    ]:
        """
...
class AwaitableGetDescribeHostDeployRecordDetailResult(
    GetDescribeHostDeployRecordDetailResult
):
...
def get_describe_host_deploy_record_detail(
    deploy_record_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostDeployRecordDetail:getDescribeHostDeployRecordDetail",
        __args__,
        opts=opts,
        typ=GetDescribeHostDeployRecordDetailResult,
    ).value
...
def get_describe_host_deploy_record_detail_output(
    deploy_record_id: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetDescribeHostDeployRecordDetailResult]:
    """
    Use this data source to query detailed information of ssl describe_host_deploy_record_detail
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostDeployRecordDetailResult(
            deploy_record_detail_lists=pulumi.get(
                __response__, "deploy_record_detail_lists"
            ),
