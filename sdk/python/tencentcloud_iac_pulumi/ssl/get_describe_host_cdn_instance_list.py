...
def get_describe_host_cdn_instance_list_output(async_cache: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                               certificate_id: pulumi.Input[Optional[_builtins.str]] = None,
                                               filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDescribeHostCdnInstanceListFilterArgs', 'GetDescribeHostCdnInstanceListFilterArgsDict']]]]] = None,
