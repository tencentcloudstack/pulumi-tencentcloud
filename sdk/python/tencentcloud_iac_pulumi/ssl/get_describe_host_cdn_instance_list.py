...
class GetDescribeHostCdnInstanceListResult:
    ...
    def filters(
        self,
    ) -> Sequence["outputs.GetDescribeHostCdnInstanceListFilterResult"] | None:
    ...
    def instance_lists(
        self,
    ) -> Sequence["outputs.GetDescribeHostCdnInstanceListInstanceListResult"]:
        """
...
class AwaitableGetDescribeHostCdnInstanceListResult(
    GetDescribeHostCdnInstanceListResult
):
...
def get_describe_host_cdn_instance_list(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ssl/getDescribeHostCdnInstanceList:getDescribeHostCdnInstanceList",
        __args__,
        opts=opts,
        typ=GetDescribeHostCdnInstanceListResult,
    ).value
...
def get_describe_host_cdn_instance_list_output(
...
) -> pulumi.Output[GetDescribeHostCdnInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_cdn_instance_list
    ...
    return __ret__.apply(
        lambda __response__: GetDescribeHostCdnInstanceListResult(
