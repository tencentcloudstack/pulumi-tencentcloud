...
def get_describe_host_cdn_instance_list(async_cache: Optional[_builtins.int] = None,
                                        certificate_id: Optional[_builtins.str] = None,
                                        filters: Optional[Sequence[Union['GetDescribeHostCdnInstanceListFilterArgs', 'GetDescribeHostCdnInstanceListFilterArgsDict']]] = None,
    ...
    :param _builtins.int async_cache: Whether.
    :param _builtins.str certificate_id: Certificate ID to be deployed.
    :param Sequence[Union['GetDescribeHostCdnInstanceListFilterArgs', 'GetDescribeHostCdnInstanceListFilterArgsDict']] filters: List of filtering parameters; Filterkey: domainmatch.
...
def get_describe_host_cdn_instance_list_output(async_cache: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                               certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
                                               filters: Optional[pulumi.Input[Optional[Sequence[Union['GetDescribeHostCdnInstanceListFilterArgs', 'GetDescribeHostCdnInstanceListFilterArgsDict']]]]] = None,
                                               ...
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDescribeHostCdnInstanceListResult]:
    """
    Use this data source to query detailed information of ssl describe_host_cdn_instance_list
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Ssl/getDescribeHostCdnInstanceList:getDescribeHostCdnInstanceList', __args__, opts=opts, typ=GetDescribeHostCdnInstanceListResult)
    return __ret__.apply(lambda __response__: GetDescribeHostCdnInstanceListResult(
