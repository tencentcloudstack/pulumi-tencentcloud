...
__all__ = ["StreamLiveInput", "StreamLiveInputArgs"]
...
class StreamLiveInputArgs:
    def __init__(
        ...
        *,
        ...
        input_settings: pulumi.Input[
            Sequence[pulumi.Input["StreamLiveInputInputSettingArgs"]] | None
        ] = None,
    ...
    def input_settings(
        self,
    ) -> pulumi.Input[Sequence[pulumi.Input["StreamLiveInputInputSettingArgs"]] | None]:
        """
...
class StreamLiveInput(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            StreamLiveInputArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def input_settings(
        self,
    ) -> pulumi.Output[Sequence["outputs.StreamLiveInputInputSetting"]]:
        """
        Input settings. For the type `RTMP_PUSH`, `RTMP_PULL`, `HLS_PULL`, or `MP4_PULL`, 1 or 2 inputs of the corresponding type can be configured.
        """
        return pulumi.get(self, "input_settings")
