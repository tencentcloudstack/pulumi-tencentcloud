...
class StreamLiveInputInputSettingArgsDict(TypedDict):
    ...
    """
    input_address: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class StreamLiveInputInputSettingArgs:
    def __init__(__self__, *,
                 ...
                 input_address: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def input_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        RTP/UDP input address, which does not need to be entered for the input parameter.Note: this field may return null, indicating that no valid values can be obtained.
        """
    ...
    def input_address(self, value: pulumi.Input[Optional[_builtins.str]]):
