...
__all__ = ["SnapshotSharePermission", "SnapshotSharePermissionArgs"]
...
class SnapshotSharePermissionArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] account_ids: List of account IDs with which a snapshot is shared. For the format of array-type parameters, see[API Introduction](https://cloud.tencent.com/document/api/213/568). You can find the account ID in[Account Information](https://console.cloud.tencent.com/developer).
        :param pulumi.Input[_builtins.str] snapshot_id: The ID of the snapshot to be queried. You can obtain this by using [DescribeSnapshots](https://cloud.tencent.com/document/api/362/15647).
        """
...
@pulumi.type_token("tencentcloud:Cbs/snapshotSharePermission:SnapshotSharePermission")
class SnapshotSharePermission(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.cbs.SnapshotSharePermission("example",
            account_ids=[
                "10002320****",
                "10002277****",
            ],
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SnapshotSharePermissionArgs, pulumi.ResourceOptions, *args, **kwargs
        )
