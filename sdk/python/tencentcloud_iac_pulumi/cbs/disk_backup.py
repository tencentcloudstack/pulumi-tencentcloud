...
__all__ = ["DiskBackup", "DiskBackupArgs"]
...
class DiskBackupArgs:
    def __init__(
        ...
        *,
        ...
        disk_backup_name: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a DiskBackup resource.

        :param pulumi.Input[_builtins.str] disk_id: ID of the original cloud disk of the backup point, which can be queried through the DescribeDisks API.
        :param pulumi.Input[_builtins.str] disk_backup_name: Backup point name.
        """
    ...
    def disk_backup_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        Backup point name.
        """
    ...
    def disk_backup_name(self, value: pulumi.Input[_builtins.str | None]):
...
@pulumi.type_token("tencentcloud:Cbs/diskBackup:DiskBackup")
class DiskBackup(pulumi.CustomResource):
    ...
    def __init__(
        ...
        > **NOTE:** The parameter `disk_backup_quota` in the resource `Cbs.Storage` must be greater than 1.
        ...
        example_disk_backup = tencentcloud.cbs.DiskBackup("example",
            disk_id=example.id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            DiskBackupArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cbs/diskBackup:DiskBackup", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="diskBackupName")
    def disk_backup_name(self) -> pulumi.Output[_builtins.str | None]:
        """
        Backup point name.
        """
        return pulumi.get(self, "disk_backup_name")
