...
def get_storages_set(availability_zone: Optional[_builtins.str] = None,
...
def get_storages_set_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetStoragesSetResult]:
    """
    Use this data source to query detailed information of CBS storages in parallel.
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cbs/getStoragesSet:getStoragesSet', __args__, opts=opts, typ=GetStoragesSetResult)
    return __ret__.apply(lambda __response__: GetStoragesSetResult(
