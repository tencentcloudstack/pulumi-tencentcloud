...
def get_storages_set(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cbs/getStoragesSet:getStoragesSet",
        __args__,
        opts=opts,
        typ=GetStoragesSetResult,
    ).value
...
def get_storages_set_output(
...
) -> pulumi.Output[GetStoragesSetResult]:
    """
    Use this data source to query detailed information of CBS storages in parallel.
    ...
    return __ret__.apply(
        lambda __response__: GetStoragesSetResult(
