...
def get_snapshots_output(availability_zone: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cbs/getSnapshots:getSnapshots', __args__, opts=opts, typ=GetSnapshotsResult)
