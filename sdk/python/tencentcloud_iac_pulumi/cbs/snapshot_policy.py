...
class SnapshotPolicyArgs:
    def __init__(
        ...
        *,
        ...
        retention_days: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def retention_days(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def retention_days(self, value: pulumi.Input[_builtins.int | None]):
...
class _SnapshotPolicyState:
    def __init__(
        __self__,
        *,
        repeat_hours: pulumi.Input[Sequence[pulumi.Input[_builtins.int]] | None] = None,
        repeat_weekdays: pulumi.Input[
...
class SnapshotPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="retentionDays")
    def retention_days(self) -> pulumi.Output[_builtins.int | None]:
        """
        Retention days of the snapshot, and the default value is 7.
        """
        return pulumi.get(self, "retention_days")
