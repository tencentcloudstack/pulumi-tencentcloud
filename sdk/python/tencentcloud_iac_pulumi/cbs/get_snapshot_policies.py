...
def get_snapshot_policies_output(result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                 snapshot_policy_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
