...
class GetSnapshotPoliciesResult:
    ...
    def snapshot_policy_lists(
        self,
    ) -> Sequence["outputs.GetSnapshotPoliciesSnapshotPolicyListResult"]:
        """
    ...
    def snapshot_policy_name(self) -> _builtins.str | None:
        """
...
def get_snapshot_policies(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cbs/getSnapshotPolicies:getSnapshotPolicies",
        __args__,
        opts=opts,
        typ=GetSnapshotPoliciesResult,
    ).value
...
def get_snapshot_policies_output(
...
) -> pulumi.Output[GetSnapshotPoliciesResult]:
    """
    Use this data source to query detailed information of CBS snapshot policies.
    ...
    return __ret__.apply(
        lambda __response__: GetSnapshotPoliciesResult(
