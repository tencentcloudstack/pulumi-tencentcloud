...
class GetStoragesResult:
    ...
    def charge_types(self) -> Sequence[_builtins.str] | None:
        """
    ...
    def instance_ips(self) -> Sequence[_builtins.str] | None:
        return pulumi.get(self, "instance_ips")

    @_builtins.property
    @pulumi.getter(name="instanceNames")
    def instance_names(self) -> Sequence[_builtins.str] | None:
        return pulumi.get(self, "instance_names")

    @_builtins.property
    @pulumi.getter
    def portable(self) -> _builtins.bool | None:
    ...
    def storage_lists(self) -> Sequence["outputs.GetStoragesStorageListResult"]:
        """
    ...
    def storage_name(self) -> _builtins.str | None:
        """
        Name of CBS.
        """
    ...
    def storage_states(self) -> Sequence[_builtins.str] | None:
    ...
    def storage_usage(self) -> _builtins.str | None:
        """
        Types of CBS.
        """
...
def get_storages(
    ...
    charge_types: Sequence[_builtins.str] | None = None,
    dedicated_cluster_id: _builtins.str | None = None,
    instance_ips: Sequence[_builtins.str] | None = None,
    instance_names: Sequence[_builtins.str] | None = None,
    portable: _builtins.bool | None = None,
    project_id: _builtins.int | None = None,
    result_output_file: _builtins.str | None = None,
    storage_id: _builtins.str | None = None,
    storage_name: _builtins.str | None = None,
    storage_states: Sequence[_builtins.str] | None = None,
    storage_type: _builtins.str | None = None,
    storage_usage: _builtins.str | None = None,
    ...
    example = tencentcloud.cbs.get_storages(storage_id="disk-6goq404g",
    ...
    example = tencentcloud.cbs.get_storages(charge_types=[
            "POSTPAID_BY_HOUR",
            "PREPAID",
            "CDCPAID",
    ...
    :param Sequence[_builtins.str] charge_types: List filter by disk charge type (`POSTPAID_BY_HOUR` | `PREPAID` | `CDCPAID` | `DEDICATED_CLUSTER_PAID`).
    :param _builtins.str dedicated_cluster_id: Exclusive cluster id.
    :param Sequence[_builtins.str] instance_ips: List filter by attached instance public or private IPs.
    :param Sequence[_builtins.str] instance_names: List filter by attached instance name.
    :param _builtins.bool portable: Filter by whether the disk is portable (Boolean `true` or `false`).
    ...
    :param Sequence[_builtins.str] storage_states: List filter by disk state (`UNATTACHED` | `ATTACHING` | `ATTACHED` | `DETACHING` | `EXPANDING` | `ROLLBACKING` | `TORECYCLE`).
    ...
    :param Sequence[_builtins.str] tag_keys: List filter by tag keys.
    :param Sequence[_builtins.str] tag_values: List filter by tag values.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cbs/getStorages:getStorages",
        __args__,
        opts=opts,
        typ=GetStoragesResult,
    ).value
...
def get_storages_output(
    availability_zone: pulumi.Input[_builtins.str | None] = None,
    charge_types: pulumi.Input[Sequence[_builtins.str] | None] = None,
    dedicated_cluster_id: pulumi.Input[_builtins.str | None] = None,
    instance_ips: pulumi.Input[Sequence[_builtins.str] | None] = None,
    instance_names: pulumi.Input[Sequence[_builtins.str] | None] = None,
    portable: pulumi.Input[_builtins.bool | None] = None,
    ...
    storage_states: pulumi.Input[Sequence[_builtins.str] | None] = None,
    storage_type: pulumi.Input[_builtins.str | None] = None,
    storage_usage: pulumi.Input[_builtins.str | None] = None,
    tag_keys: pulumi.Input[Sequence[_builtins.str] | None] = None,
    tag_values: pulumi.Input[Sequence[_builtins.str] | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetStoragesResult]:
    """
    Use this data source to query detailed information of CBS storages.
    ...
    return __ret__.apply(
        lambda __response__: GetStoragesResult(
            availability_zone=pulumi.get(__response__, "availability_zone"),
            charge_types=pulumi.get(__response__, "charge_types"),
            dedicated_cluster_id=pulumi.get(__response__, "dedicated_cluster_id"),
            id=pulumi.get(__response__, "id"),
            instance_ips=pulumi.get(__response__, "instance_ips"),
            ...
            storage_lists=pulumi.get(__response__, "storage_lists"),
            storage_name=pulumi.get(__response__, "storage_name"),
            storage_states=pulumi.get(__response__, "storage_states"),
