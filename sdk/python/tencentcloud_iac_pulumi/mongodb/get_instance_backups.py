...
class GetInstanceBackupsResult:
    ...
    def backup_method(self) -> _builtins.int | None:
        """
        Backup method.
        """
...
def get_instance_backups(
    backup_method: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mongodb/getInstanceBackups:getInstanceBackups",
        __args__,
        opts=opts,
        typ=GetInstanceBackupsResult,
    ).value
...
def get_instance_backups_output(
...
) -> pulumi.Output[GetInstanceBackupsResult]:
    """
    Use this data source to query detailed information of mongodb instance_backups
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceBackupsResult(
