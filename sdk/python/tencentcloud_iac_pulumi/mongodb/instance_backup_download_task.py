...
class _InstanceBackupDownloadTaskState:
    def __init__(__self__, *,
                 ...
                 backup_sets: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceBackupDownloadTaskBackupSetArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="backupSets")
    def backup_sets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceBackupDownloadTaskBackupSetArgs']]]]:
        """
        Specifies the node names of replica sets to download or a list of shard names for sharded clusters.For example, the replica set cmgo-p8vnipr5, example (fixed value): BackupSets.0=cmgo-p8vnipr5_0, the full amount of data can be downloaded.For example, the sharded cluster cmgo-p8vnipr5, for example: BackupSets.0=cmgo-p8vnipr5_0&amp;amp;BackupSets.1=cmgo-p8vnipr5_1, that is, to download the data of shard 0 and 1. If the sharded cluster needs to be downloaded in full, please pass in the example. Full slice name.
        """
        return pulumi.get(self, "backup_sets")
    ...
    @backup_sets.setter
    def backup_sets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceBackupDownloadTaskBackupSetArgs']]]]):
        pulumi.set(self, "backup_sets", value)
...
@pulumi.type_token("tencentcloud:Mongodb/instanceBackupDownloadTask:InstanceBackupDownloadTask")
class InstanceBackupDownloadTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 backup_name: pulumi.Input[Optional[_builtins.str]] = None,
                 backup_sets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceBackupDownloadTaskBackupSetArgs', 'InstanceBackupDownloadTaskBackupSetArgsDict']]]]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            backup_name: pulumi.Input[Optional[_builtins.str]] = None,
            backup_sets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceBackupDownloadTaskBackupSetArgs', 'InstanceBackupDownloadTaskBackupSetArgsDict']]]]] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'InstanceBackupDownloadTask':
        """
