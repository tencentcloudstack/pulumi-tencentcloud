...
class GetZoneConfigResult:
    ...
    def __init__(
        __self__, available_zone=None, id=None, lists=None, result_output_file=None
    ):
    ...
    def available_zone(self) -> _builtins.str | None:
        """
...
def get_zone_config(
    available_zone: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mongodb/getZoneConfig:getZoneConfig",
        __args__,
        opts=opts,
