...
__all__ = ['InstanceTransparentDataEncryption', 'InstanceTransparentDataEncryptionArgs']
...
class InstanceTransparentDataEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_id: Instance ID, for example: cmgo-p8vn ***. Currently supported general versions include: 4.4 and 5.0, but the cloud disk version is not currently supported.
        :param pulumi.Input[_builtins.str] kms_region: The region where the Key Management Service (KMS) serves, such as ap-shanghai.
...
class _InstanceTransparentDataEncryptionState:
    def __init__(__self__, *,
                 ...
                 key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 key_info_lists: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceTransparentDataEncryptionKeyInfoListArgs']]]] = None,
                 kms_region: pulumi.Input[Optional[_builtins.str]] = None,
                 transparent_data_encryption_status: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] kms_region: The region where the Key Management Service (KMS) serves, such as ap-shanghai.
        :param pulumi.Input[_builtins.str] transparent_data_encryption_status: Represents whether transparent encryption is turned on. Valid values:
               - close: Not opened;
    ...
    def key_info_lists(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceTransparentDataEncryptionKeyInfoListArgs']]]]:
        """
        List of bound keys.
        """
    ...
    def key_info_lists(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceTransparentDataEncryptionKeyInfoListArgs']]]]):
    ...
    def transparent_data_encryption_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def transparent_data_encryption_status(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "transparent_data_encryption_status", value)


@pulumi.type_token("tencentcloud:Mongodb/instanceTransparentDataEncryption:InstanceTransparentDataEncryption")
class InstanceTransparentDataEncryption(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            key_id: pulumi.Input[Optional[_builtins.str]] = None,
            key_info_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceTransparentDataEncryptionKeyInfoListArgs', 'InstanceTransparentDataEncryptionKeyInfoListArgsDict']]]]] = None,
            kms_region: pulumi.Input[Optional[_builtins.str]] = None,
            transparent_data_encryption_status: pulumi.Input[Optional[_builtins.str]] = None) -> 'InstanceTransparentDataEncryption':
        """
        ...
        :param pulumi.Input[_builtins.str] instance_id: Instance ID, for example: cmgo-p8vn ***. Currently supported general versions include: 4.4 and 5.0, but the cloud disk version is not currently supported.
        :param pulumi.Input[_builtins.str] key_id: Key ID. If this parameter is not set and the specific key ID is not specified, Tencent Cloud will automatically generate the key and this key will be beyond the control of Terraform.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceTransparentDataEncryptionKeyInfoListArgs', 'InstanceTransparentDataEncryptionKeyInfoListArgsDict']]]] key_info_lists: List of bound keys.
        :param pulumi.Input[_builtins.str] kms_region: The region where the Key Management Service (KMS) serves, such as ap-shanghai.
        :param pulumi.Input[_builtins.str] transparent_data_encryption_status: Represents whether transparent encryption is turned on. Valid values:
               - close: Not opened;
               - open: It has been opened.
    ...
    @_builtins.property
    @pulumi.getter(name="transparentDataEncryptionStatus")
    def transparent_data_encryption_status(self) -> pulumi.Output[_builtins.str]:
        """
        Represents whether transparent encryption is turned on. Valid values:
        - close: Not opened;
        - open: It has been opened.
