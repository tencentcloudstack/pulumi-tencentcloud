...
def get_instance_connections(instance_id: Optional[_builtins.str] = None,
...
def get_instance_connections_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                                    result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstanceConnectionsResult]:
    """
    Use this data source to query detailed information of mongodb instance_connections
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mongodb/getInstanceConnections:getInstanceConnections', __args__, opts=opts, typ=GetInstanceConnectionsResult)
    return __ret__.apply(lambda __response__: GetInstanceConnectionsResult(
