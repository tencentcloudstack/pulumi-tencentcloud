...
class GetInstanceConnectionsResult:
    ...
    def __init__(
        __self__, clients=None, id=None, instance_id=None, result_output_file=None
    ):
...
def get_instance_connections(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mongodb/getInstanceConnections:getInstanceConnections",
        __args__,
        opts=opts,
        typ=GetInstanceConnectionsResult,
    ).value
...
def get_instance_connections_output(
...
) -> pulumi.Output[GetInstanceConnectionsResult]:
    """
    Use this data source to query detailed information of mongodb instance_connections
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceConnectionsResult(
