...
class GetInstanceParamsResult:
    ...
    def __init__(
        __self__,
        id=None,
        instance_enum_params=None,
        instance_id=None,
        instance_integer_params=None,
        instance_multi_params=None,
        instance_text_params=None,
    ...
    def instance_enum_params(
        self,
    ) -> Sequence["outputs.GetInstanceParamsInstanceEnumParamResult"]:
        """
        Enum parameter.
        """
    ...
    def instance_integer_params(
        self,
    ) -> Sequence["outputs.GetInstanceParamsInstanceIntegerParamResult"]:
        """
        Integer parameter.
        """
    ...
    def instance_multi_params(
        self,
    ) -> Sequence["outputs.GetInstanceParamsInstanceMultiParamResult"]:
        """
        multi parameter.
        """
    ...
    def instance_text_params(
        self,
    ) -> Sequence["outputs.GetInstanceParamsInstanceTextParamResult"]:
        """
        text parameter.
        """
...
def get_instance_params(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mongodb/getInstanceParams:getInstanceParams",
        __args__,
        opts=opts,
        typ=GetInstanceParamsResult,
    ).value
...
def get_instance_params_output(
...
) -> pulumi.Output[GetInstanceParamsResult]:
    """
    Use this data source to query detailed information of mongodb instance_params
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceParamsResult(
