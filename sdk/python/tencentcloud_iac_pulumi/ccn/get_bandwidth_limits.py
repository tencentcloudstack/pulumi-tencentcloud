...
def get_bandwidth_limits(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ccn/getBandwidthLimits:getBandwidthLimits",
        __args__,
        opts=opts,
        typ=GetBandwidthLimitsResult,
    ).value
...
def get_bandwidth_limits_output(
...
) -> pulumi.Output[GetBandwidthLimitsResult]:
    """
    Use this data source to query detailed information of CCN bandwidth limits.
    ...
    return __ret__.apply(
        lambda __response__: GetBandwidthLimitsResult(
