...
def get_cross_border_region_bandwidth_limits_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetCrossBorderRegionBandwidthLimitsFilterArgs', 'GetCrossBorderRegionBandwidthLimitsFilterArgsDict']]]]] = None,
