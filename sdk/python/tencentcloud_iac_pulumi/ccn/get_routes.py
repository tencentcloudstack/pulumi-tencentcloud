...
def get_routes_output(ccn_id: pulumi.Input[Optional[_builtins.str]] = None,
                      filters: pulumi.Input[Optional[Optional[Sequence[Union['GetRoutesFilterArgs', 'GetRoutesFilterArgsDict']]]]] = None,
