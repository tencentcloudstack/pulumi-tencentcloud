...
class GetRoutesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetRoutesFilterResult"] | None:
...
def get_routes(
    ...
    filters: (
        Sequence[Union["GetRoutesFilterArgs", "GetRoutesFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Ccn/getRoutes:getRoutes", __args__, opts=opts, typ=GetRoutesResult
    ).value
...
def get_routes_output(
    ...
    return __ret__.apply(
        lambda __response__: GetRoutesResult(
