...
def get_route_table_input_policies_output(ccn_id: pulumi.Input[Optional[_builtins.str]] = None,
                                          policy_version: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
