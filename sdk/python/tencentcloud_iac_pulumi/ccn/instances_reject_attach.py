...
__all__ = ['InstancesRejectAttach', 'InstancesRejectAttachArgs']
...
class _InstancesRejectAttachState:
    def __init__(__self__, *,
                 ...
                 instances: pulumi.Input[Optional[Sequence[pulumi.Input['InstancesRejectAttachInstanceArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def instances(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstancesRejectAttachInstanceArgs']]]]:
        """
        Reject List Of Attachment Instances.
        """
        return pulumi.get(self, "instances")
    ...
    @instances.setter
    def instances(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstancesRejectAttachInstanceArgs']]]]):
        pulumi.set(self, "instances", value)


@pulumi.type_token("tencentcloud:Ccn/instancesRejectAttach:InstancesRejectAttach")
class InstancesRejectAttach(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ccn_id: pulumi.Input[Optional[_builtins.str]] = None,
                 instances: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstancesRejectAttachInstanceArgs', 'InstancesRejectAttachInstanceArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        ccn_instances_reject_attach = tencentcloud.ccn.InstancesRejectAttach("ccn_instances_reject_attach",
            ccn_id="ccn-39lqkygf",
            instances=[{
        ...
        :param pulumi.Input[_builtins.str] ccn_id: CCN Instance ID.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstancesRejectAttachInstanceArgs', 'InstancesRejectAttachInstanceArgsDict']]]] instances: Reject List Of Attachment Instances.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            ccn_id: pulumi.Input[Optional[_builtins.str]] = None,
            instances: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstancesRejectAttachInstanceArgs', 'InstancesRejectAttachInstanceArgsDict']]]]] = None) -> 'InstancesRejectAttach':
        """
