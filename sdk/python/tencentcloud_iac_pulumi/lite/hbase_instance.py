...
class HbaseInstanceArgs:
    def __init__(
        ...
        *,
        ...
        tags: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceTagArgs"]]] | None = None
    ):
        """
...
class _HbaseInstanceState:
    def __init__(
        __self__,
        *,
        disk_size: pulumi.Input[int] | None = None,
        disk_type: pulumi.Input[str] | None = None,
        instance_name: pulumi.Input[str] | None = None,
        node_type: pulumi.Input[str] | None = None,
        pay_mode: pulumi.Input[int] | None = None,
        tags: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceTagArgs"]]] | None = None,
        zone_settings: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]]] | None = None
    ):
        """
    ...
    @property
    @pulumi.getter(name="diskSize")
    def disk_size(self) -> pulumi.Input[int] | None:
        """
        Instance single-node disk capacity, in GB. The single-node disk capacity must be greater than or equal to 100 and less than or equal to 10000, with an adjustment step size of 20.
        """
        return pulumi.get(self, "disk_size")
    ...
    @disk_size.setter
    def disk_size(self, value: pulumi.Input[int] | None):
        pulumi.set(self, "disk_size", value)

    @property
    @pulumi.getter(name="diskType")
    def disk_type(self) -> pulumi.Input[str] | None:
        """
        Instance disk type, fill in CLOUD_HSSD to indicate performance cloud storage.
        """
        return pulumi.get(self, "disk_type")
    ...
    @disk_type.setter
    def disk_type(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "disk_type", value)

    @property
    @pulumi.getter(name="instanceName")
    def instance_name(self) -> pulumi.Input[str] | None:
        """
        Instance name. Length limit is 6-36 characters. Only Chinese characters, letters, numbers, -, and _ are allowed.
        """
        return pulumi.get(self, "instance_name")
    ...
    @instance_name.setter
    def instance_name(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "instance_name", value)

    @property
    @pulumi.getter(name="nodeType")
    def node_type(self) -> pulumi.Input[str] | None:
        """
        Instance node type, can be filled in as 4C16G, 8C32G, 16C64G, 32C128G, case insensitive.
        """
        return pulumi.get(self, "node_type")
    ...
    @node_type.setter
    def node_type(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "node_type", value)

    @property
    @pulumi.getter(name="payMode")
    def pay_mode(self) -> pulumi.Input[int] | None:
        """
        Instance pay mode. Value range: 0: indicates post pay mode, that is, pay-as-you-go.
        """
        return pulumi.get(self, "pay_mode")
    ...
    @pay_mode.setter
    def pay_mode(self, value: pulumi.Input[int] | None):
        pulumi.set(self, "pay_mode", value)
    ...
    def zone_settings(
        self,
        value: pulumi.Input[Sequence[pulumi.Input["HbaseInstanceZoneSettingArgs"]]] | None,
    ):
        pulumi.set(self, "zone_settings", value)
...
class HbaseInstance(pulumi.CustomResource):
    ...
    def __init__(
        ...
        node_type: pulumi.Input[str] | None = None,
        pay_mode: pulumi.Input[int] | None = None,
        tags: pulumi.Input[Sequence[pulumi.Input[pulumi.InputType["HbaseInstanceTagArgs"]]]] | None = None,
        zone_settings: pulumi.Input[Sequence[pulumi.Input[pulumi.InputType["HbaseInstanceZoneSettingArgs"]]]] | None = None,
        __props__=None,
    ):
        """
