...
def get_hbase_instances(
    ...
    filters: Sequence[pulumi.InputType["GetHbaseInstancesFilterArgs"]] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Lite/getHbaseInstances:getHbaseInstances",
        __args__,
        opts=opts,
...
def get_hbase_instances_output(
    asc: pulumi.Input[int | None] | None = None,
    display_strategy: pulumi.Input[str] | None = None,
    filters: pulumi.Input[Sequence[pulumi.InputType["GetHbaseInstancesFilterArgs"]] | None] | None = None,
    order_field: pulumi.Input[str | None] | None = None,
