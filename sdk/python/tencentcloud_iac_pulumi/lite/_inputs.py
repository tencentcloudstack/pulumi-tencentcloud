...
class HbaseInstanceTagArgs:
    def __init__(
        __self__,
        *,
        tag_key: pulumi.Input[str] | None = None,
        tag_value: pulumi.Input[str] | None = None
    ):
        """
    ...
    def tag_key(self) -> pulumi.Input[str] | None:
        """
        Tag key.
        """
    ...
    @tag_key.setter
    def tag_key(self, value: pulumi.Input[str] | None):
        pulumi.set(self, "tag_key", value)

    @property
    @pulumi.getter(name="tagValue")
    def tag_value(self) -> pulumi.Input[str] | None:
        """
        Tag value.
        """
    ...
    @tag_value.setter
    def tag_value(self, value: pulumi.Input[str] | None):
...
class HbaseInstanceZoneSettingVpcSettingsArgs:
    def __init__(__self__, *, subnet_id: pulumi.Input[str], vpc_id: pulumi.Input[str]):
        """
