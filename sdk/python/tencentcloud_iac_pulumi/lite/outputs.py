...
class HbaseInstanceTag(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in HbaseInstanceTag. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        __self__, *, tag_key: str | None = None, tag_value: str | None = None
    ):
        """
...
class HbaseInstanceZoneSetting(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in HbaseInstanceZoneSetting. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        ...
        *,
        node_num: int,
        vpc_settings: "HbaseInstanceZoneSettingVpcSettings",
        zone: str,
    ):
        """
    ...
    def vpc_settings(self) -> "HbaseInstanceZoneSettingVpcSettings":
        """
...
class HbaseInstanceZoneSettingVpcSettings(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in HbaseInstanceZoneSettingVpcSettings. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(__self__, *, subnet_id: str, vpc_id: str):
        """
...
class GetHbaseInstancesFilterResult(dict):
    def __init__(__self__, *, name: str, values: Sequence[str]):
        """
...
class GetHbaseInstancesInstanceListResult(dict):
    def __init__(
        ...
        *,
        ...
        status_desc: str,
        subnet_id: int,
        tags: Sequence["GetHbaseInstancesInstanceListTagResult"],
        vpc_id: int,
        zone: str,
        zone_id: int,
        zone_settings: Sequence[
            "GetHbaseInstancesInstanceListZoneSettingResult"
        ],
    ):
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence["GetHbaseInstancesInstanceListTagResult"]:
        """
        List of tags.
        """
    ...
    def zone_settings(
        self,
    ) -> Sequence["GetHbaseInstancesInstanceListZoneSettingResult"]:
        """
...
class GetHbaseInstancesInstanceListZoneSettingResult(dict):
    ...
    def vpc_settings(
        self,
    ) -> Sequence["GetHbaseInstancesInstanceListZoneSettingVpcSettingResult"]:
        """
        Private network related information configuration. This parameter can be used to specify the ID of the private network, subnet ID, and other information.
        """
        return pulumi.get(self, "vpc_settings")
