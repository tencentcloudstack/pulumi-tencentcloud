...
def get_clusters(
    ...
    foo = tencentcloud.Eks.get_clusters(cluster_id="cls-xxxxxxxx")
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eks/getClusters:getClusters",
        __args__,
        opts=opts,
...
def get_clusters_output(
    cluster_id: pulumi.Input[str | None] | None = None,
    cluster_name: pulumi.Input[str | None] | None = None,
