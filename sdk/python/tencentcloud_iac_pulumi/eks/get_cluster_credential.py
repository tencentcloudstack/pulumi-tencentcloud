...
def get_cluster_credential(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eks/getClusterCredential:getClusterCredential",
        __args__,
        opts=opts,
        typ=GetClusterCredentialResult,
    ).value
