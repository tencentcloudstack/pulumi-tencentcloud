...
def get_public_key(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kms/getPublicKey:getPublicKey",
        __args__,
        opts=opts,
        typ=GetPublicKeyResult,
    ).value
...
def get_public_key_output(
...
) -> pulumi.Output[GetPublicKeyResult]:
    """
    Use this data source to query detailed information of kms public_key
    ...
    return __ret__.apply(
        lambda __response__: GetPublicKeyResult(
