...
def get_get_parameters_for_import(
    key_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    wrapping_algorithm: _builtins.str | None = None,
    wrapping_key_spec: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kms/getGetParametersForImport:getGetParametersForImport",
        __args__,
        opts=opts,
        typ=GetGetParametersForImportResult,
    ).value
...
def get_get_parameters_for_import_output(
    ...
    wrapping_key_spec: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetGetParametersForImportResult]:
    """
    Use this data source to query detailed information of kms get_parameters_for_import
    ...
    return __ret__.apply(
        lambda __response__: GetGetParametersForImportResult(
