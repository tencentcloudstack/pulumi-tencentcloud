...
def get_list_algorithms(result_output_file: Optional[_builtins.str] = None,
...
def get_list_algorithms_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetListAlgorithmsResult]:
    """
    Use this data source to query detailed information of kms list_algorithms
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Kms/getListAlgorithms:getListAlgorithms', __args__, opts=opts, typ=GetListAlgorithmsResult)
    return __ret__.apply(lambda __response__: GetListAlgorithmsResult(
        asymmetric_algorithms=pulumi.get(__response__, 'asymmetric_algorithms'),
        asymmetric_sign_verify_algorithms=pulumi.get(__response__, 'asymmetric_sign_verify_algorithms'),
