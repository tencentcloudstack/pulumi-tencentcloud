...
class GetListAlgorithmsResult:
    ...
    def __init__(
        __self__,
        asymmetric_algorithms=None,
        asymmetric_sign_verify_algorithms=None,
        id=None,
        result_output_file=None,
        symmetric_algorithms=None,
    ):
        ...
        if asymmetric_sign_verify_algorithms and not isinstance(
            asymmetric_sign_verify_algorithms, list
        ):
            raise TypeError(
                "Expected argument 'asymmetric_sign_verify_algorithms' to be a list"
            )
        pulumi.set(
            __self__,
    ...
    def asymmetric_algorithms(
        self,
    ) -> Sequence["outputs.GetListAlgorithmsAsymmetricAlgorithmResult"]:
        """
    ...
    def asymmetric_sign_verify_algorithms(
        self,
    ) -> Sequence["outputs.GetListAlgorithmsAsymmetricSignVerifyAlgorithmResult"]:
        """
    ...
    def symmetric_algorithms(
        self,
    ) -> Sequence["outputs.GetListAlgorithmsSymmetricAlgorithmResult"]:
        """
...
def get_list_algorithms(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kms/getListAlgorithms:getListAlgorithms",
        __args__,
        opts=opts,
        typ=GetListAlgorithmsResult,
    ).value

    return AwaitableGetListAlgorithmsResult(
        asymmetric_algorithms=pulumi.get(__ret__, "asymmetric_algorithms"),
        asymmetric_sign_verify_algorithms=pulumi.get(
            __ret__, "asymmetric_sign_verify_algorithms"
        ),
...
def get_list_algorithms_output(
    ...
    return __ret__.apply(
        lambda __response__: GetListAlgorithmsResult(
            asymmetric_algorithms=pulumi.get(__response__, "asymmetric_algorithms"),
            asymmetric_sign_verify_algorithms=pulumi.get(
                __response__, "asymmetric_sign_verify_algorithms"
            ),
            id=pulumi.get(__response__, "id"),
            result_output_file=pulumi.get(__response__, "result_output_file"),
            symmetric_algorithms=pulumi.get(__response__, "symmetric_algorithms"),
        )
    )
