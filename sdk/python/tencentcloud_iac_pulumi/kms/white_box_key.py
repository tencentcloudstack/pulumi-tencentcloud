...
__all__ = ["WhiteBoxKey", "WhiteBoxKeyArgs"]
...
class WhiteBoxKey(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            WhiteBoxKeyArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Kms/whiteBoxKey:WhiteBoxKey", resource_name, __props__, opts
        )
