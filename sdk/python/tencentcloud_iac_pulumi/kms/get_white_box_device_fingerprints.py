...
def get_white_box_device_fingerprints(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Kms/getWhiteBoxDeviceFingerprints:getWhiteBoxDeviceFingerprints",
        __args__,
        opts=opts,
        typ=GetWhiteBoxDeviceFingerprintsResult,
    ).value
...
def get_white_box_device_fingerprints_output(
...
) -> pulumi.Output[GetWhiteBoxDeviceFingerprintsResult]:
    """
    Use this data source to query detailed information of kms white_box_device_fingerprints
    ...
    return __ret__.apply(
        lambda __response__: GetWhiteBoxDeviceFingerprintsResult(
