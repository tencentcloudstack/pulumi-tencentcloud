...
class GetInstancesResult:
    ...
    def reserved_instance_id(self) -> _builtins.str | None:
        """
    ...
    def reserved_instance_lists(
        self,
    ) -> Sequence["outputs.GetInstancesReservedInstanceListResult"]:
        """
...
def get_instances(
    ...
    reserved_instance_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Reserved/getInstances:getInstances",
        __args__,
        opts=opts,
...
def get_instances_output(
    ...
    reserved_instance_id: pulumi.Input[_builtins.str | None] = None,
