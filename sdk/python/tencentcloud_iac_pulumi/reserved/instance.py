...
class InstanceArgs:
    def __init__(
        ...
        *,
        ...
        reserved_instance_name: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    def reserved_instance_name(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def reserved_instance_name(self, value: pulumi.Input[_builtins.str | None]):
...
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Reserved/instance:Instance", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="reservedInstanceName")
    def reserved_instance_name(self) -> pulumi.Output[_builtins.str | None]:
        """
        Reserved Instance display name.
        - If you do not specify an instance display name, 'Unnamed' is displayed by default.
        - Up to 60 characters (including pattern strings) are supported.
