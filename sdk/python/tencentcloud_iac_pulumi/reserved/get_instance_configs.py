...
class GetInstanceConfigsResult:
    ...
    def product_description(self) -> Optional[_builtins.str]:
...
def get_instance_configs(availability_zone: Optional[_builtins.str] = None,
...
def get_instance_configs_output(availability_zone: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                ...
                                offering_type: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                product_description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetInstanceConfigsResult]:
    """
    Use this data source to query reserved instances configuration.
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Reserved/getInstanceConfigs:getInstanceConfigs', __args__, opts=opts, typ=GetInstanceConfigsResult)
    return __ret__.apply(lambda __response__: GetInstanceConfigsResult(
