...
class GetInstanceConfigsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def duration(self) -> _builtins.int | None:
        """
    ...
    def offering_type(self) -> _builtins.str | None:
        """
    ...
    def product_description(self) -> _builtins.str | None:
...
def get_instance_configs(
    ...
    duration: _builtins.int | None = None,
    instance_type: _builtins.str | None = None,
    offering_type: _builtins.str | None = None,
    product_description: _builtins.str | None = None,
    ...
    :param _builtins.str product_description: Filter by the Platform Description (that is, operating system) for Reserved Instance billing. Shaped like: linux.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Reserved/getInstanceConfigs:getInstanceConfigs",
        __args__,
        opts=opts,
        typ=GetInstanceConfigsResult,
    ).value
...
def get_instance_configs_output(
    ...
    offering_type: pulumi.Input[_builtins.str | None] = None,
    product_description: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetInstanceConfigsResult]:
    """
    Use this data source to query reserved instances configuration.
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceConfigsResult(
