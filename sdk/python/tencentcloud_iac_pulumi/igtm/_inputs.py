...
class AddressPoolAddressSetArgsDict(TypedDict):
    ...
    """
    address_id: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    Address ID.
    """
    created_on: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Creation time.
    """
    location: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Address name.
    """
    ...
    """
    updated_on: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    Modification time.
    """
...
class AddressPoolAddressSetArgs:
    def __init__(
        ...
        *,
        addr: pulumi.Input[_builtins.str],
        is_enable: pulumi.Input[_builtins.str],
        address_id: pulumi.Input[_builtins.int | None] = None,
    ...
    def address_id(self) -> pulumi.Input[_builtins.int | None]:
        """
        Address ID.
        """
    ...
    @address_id.setter
    def address_id(self, value: pulumi.Input[_builtins.int | None]):
...
class StrategyFallbackAddressPoolSetArgsDict(TypedDict):
    address_pools: pulumi.Input[
        Sequence[pulumi.Input["StrategyFallbackAddressPoolSetAddressPoolArgsDict"]]
    ]
    """
    Address pool IDs and weights in the set, array.
    """
    main_address_pool_id: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    Address pool set ID.
    """
    min_survive_num: NotRequired[pulumi.Input[_builtins.int | None]]
    """
    Switch threshold, cannot exceed the total number of addresses in the main set.
    """
    traffic_strategy: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class StrategyFallbackAddressPoolSetArgs:
    def __init__(
        ...
        *,
        address_pools: pulumi.Input[
            Sequence[pulumi.Input["StrategyFallbackAddressPoolSetAddressPoolArgs"]]
        ],
        main_address_pool_id: pulumi.Input[_builtins.int | None] = None,
        min_survive_num: pulumi.Input[_builtins.int | None] = None,
    ...
    def main_address_pool_id(self) -> pulumi.Input[_builtins.int | None]:
        """
        Address pool set ID.
        """
    ...
    def main_address_pool_id(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "main_address_pool_id", value)

    @_builtins.property
    @pulumi.getter(name="minSurviveNum")
    def min_survive_num(self) -> pulumi.Input[_builtins.int | None]:
        """
        Switch threshold, cannot exceed the total number of addresses in the main set.
        """
    ...
    def min_survive_num(self, value: pulumi.Input[_builtins.int | None]):
...
class StrategyMainAddressPoolSetArgsDict(TypedDict):
    address_pools: pulumi.Input[
        Sequence[pulumi.Input["StrategyMainAddressPoolSetAddressPoolArgsDict"]]
    ]
    """
    Address pool IDs and weights in the set, array.
    """
...
class StrategyMainAddressPoolSetArgs:
    def __init__(
        ...
        *,
        address_pools: pulumi.Input[
            Sequence[pulumi.Input["StrategyMainAddressPoolSetAddressPoolArgs"]]
        ],
        main_address_pool_id: pulumi.Input[_builtins.int | None] = None,
        min_survive_num: pulumi.Input[_builtins.int | None] = None,
        traffic_strategy: pulumi.Input[_builtins.str | None] = None
...
class GetAddressPoolListFilterArgs:
    def __init__(
        ...
        *,
        name: _builtins.str,
        values: Sequence[_builtins.str],
        fuzzy: _builtins.bool | None = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def fuzzy(self) -> _builtins.bool | None:
        """
        Whether to enable fuzzy query, only supports filter field name as domain.
        When fuzzy query is enabled, maximum Value length is 1, otherwise maximum Value length is 5. (Reserved field, currently not used).
        """
    ...
    @fuzzy.setter
    def fuzzy(self, value: _builtins.bool | None):
