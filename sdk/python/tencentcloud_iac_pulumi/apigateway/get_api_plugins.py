...
class GetApiPluginsResult:
    ...
    def environment_name(self) -> _builtins.str | None:
...
def get_api_plugins(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getApiPlugins:getApiPlugins",
        __args__,
        opts=opts,
        typ=GetApiPluginsResult,
    ).value
...
def get_api_plugins_output(
...
) -> pulumi.Output[GetApiPluginsResult]:
    """
    Use this data source to query detailed information of apiGateway api_plugins
    ...
    return __ret__.apply(
        lambda __response__: GetApiPluginsResult(
