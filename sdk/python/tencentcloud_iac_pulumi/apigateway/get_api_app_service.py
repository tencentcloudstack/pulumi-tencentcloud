...
class GetApiAppServiceResult:
    ...
    def __init__(
        __self__,
        api_id_status_sets=None,
        api_region=None,
        api_total_count=None,
        available_environments=None,
        created_time=None,
        id=None,
        inner_http_port=None,
        inner_https_port=None,
        internal_sub_domain=None,
        ip_version=None,
        modified_time=None,
        net_types=None,
        outer_sub_domain=None,
        protocol=None,
        ...
        service_name=None,
        set_id=None,
        usage_plan_lists=None,
        usage_plan_total_count=None,
        user_type=None,
    ):
    ...
    def api_id_status_sets(
        self,
    ) -> Sequence["outputs.GetApiAppServiceApiIdStatusSetResult"]:
        """
    ...
    def api_total_count(self) -> _builtins.int:
        """
    ...
    def available_environments(self) -> Sequence[_builtins.str]:
        """
    ...
    def usage_plan_lists(
        self,
    ) -> Sequence["outputs.GetApiAppServiceUsagePlanListResult"]:
        """
    ...
    def usage_plan_total_count(self) -> _builtins.int:
        """
...
def get_api_app_service(
    api_region: _builtins.str | None = None,
    ...
    example = tencentcloud.apigateway.get_api_app_service_output(service_id=example_api.service_id,
        api_region="ap-guangzhou")
    ```


    :param _builtins.str api_region: Territory to which the service belongs.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getApiAppService:getApiAppService",
        __args__,
        opts=opts,
        typ=GetApiAppServiceResult,
    ).value
...
def get_api_app_service_output(
    api_region: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetApiAppServiceResult]:
    """
    Use this data source to query detailed information of apigateway api_app_services
    ...
    return __ret__.apply(
        lambda __response__: GetApiAppServiceResult(
            api_id_status_sets=pulumi.get(__response__, "api_id_status_sets"),
            api_region=pulumi.get(__response__, "api_region"),
            api_total_count=pulumi.get(__response__, "api_total_count"),
            available_environments=pulumi.get(__response__, "available_environments"),
            created_time=pulumi.get(__response__, "created_time"),
            id=pulumi.get(__response__, "id"),
            inner_http_port=pulumi.get(__response__, "inner_http_port"),
            inner_https_port=pulumi.get(__response__, "inner_https_port"),
            internal_sub_domain=pulumi.get(__response__, "internal_sub_domain"),
            ip_version=pulumi.get(__response__, "ip_version"),
            modified_time=pulumi.get(__response__, "modified_time"),
            net_types=pulumi.get(__response__, "net_types"),
            outer_sub_domain=pulumi.get(__response__, "outer_sub_domain"),
            protocol=pulumi.get(__response__, "protocol"),
            result_output_file=pulumi.get(__response__, "result_output_file"),
            service_desc=pulumi.get(__response__, "service_desc"),
            service_id=pulumi.get(__response__, "service_id"),
            service_name=pulumi.get(__response__, "service_name"),
            set_id=pulumi.get(__response__, "set_id"),
            usage_plan_lists=pulumi.get(__response__, "usage_plan_lists"),
            usage_plan_total_count=pulumi.get(__response__, "usage_plan_total_count"),
