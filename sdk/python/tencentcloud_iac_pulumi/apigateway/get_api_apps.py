...
class GetApiAppsResult:
    ...
    def api_app_id(self) -> _builtins.str | None:
        """
        ApiApp ID.
        """
    ...
    def api_app_name(self) -> _builtins.str | None:
        """
        ApiApp Name.
        """
...
def get_api_apps(
    api_app_id: _builtins.str | None = None,
    api_app_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getApiApps:getApiApps",
        __args__,
        opts=opts,
        typ=GetApiAppsResult,
    ).value
...
def get_api_apps_output(
...
) -> pulumi.Output[GetApiAppsResult]:
    """
    Use this data source to query list information of api_gateway api_app
    ...
    return __ret__.apply(
        lambda __response__: GetApiAppsResult(
