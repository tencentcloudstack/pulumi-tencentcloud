...
class GetUpstreamsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetUpstreamsFilterResult"] | None:
...
def get_upstreams(
    filters: (
        Sequence[Union["GetUpstreamsFilterArgs", "GetUpstreamsFilterArgsDict"]] | None
    ) = None,
    result_output_file: _builtins.str | None = None,
    upstream_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getUpstreams:getUpstreams",
        __args__,
        opts=opts,
        typ=GetUpstreamsResult,
    ).value
...
def get_upstreams_output(
    ...
    return __ret__.apply(
        lambda __response__: GetUpstreamsResult(
