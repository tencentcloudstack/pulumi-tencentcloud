...
def get_plugins(
    environment_name: _builtins.str | None = None,
    plugin_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getPlugins:getPlugins",
        __args__,
        opts=opts,
        typ=GetPluginsResult,
    ).value
...
def get_plugins_output(
    environment_name: pulumi.Input[_builtins.str | None] = None,
    plugin_id: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetPluginsResult]:
    """
    Use this data source to query detailed information of apigateway plugin
    ...
    return __ret__.apply(
        lambda __response__: GetPluginsResult(
