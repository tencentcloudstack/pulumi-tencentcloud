...
class GetUsagePlansResult:
    ...
    def usage_plan_id(self) -> _builtins.str | None:
        """
    ...
    def usage_plan_name(self) -> _builtins.str | None:
        """
...
def get_usage_plans(
    ...
    usage_plan_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getUsagePlans:getUsagePlans",
        __args__,
        opts=opts,
        typ=GetUsagePlansResult,
    ).value
...
def get_usage_plans_output(
...
) -> pulumi.Output[GetUsagePlansResult]:
    """
    Use this data source to query API gateway usage plans.
    ...
    return __ret__.apply(
        lambda __response__: GetUsagePlansResult(
