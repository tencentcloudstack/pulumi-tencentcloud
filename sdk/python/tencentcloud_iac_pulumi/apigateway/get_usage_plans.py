...
def get_usage_plans(result_output_file: Optional[_builtins.str] = None,
...
def get_usage_plans_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           usage_plan_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           usage_plan_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:ApiGateway/getUsagePlans:getUsagePlans', __args__, opts=opts, typ=GetUsagePlansResult)
