...
class GetApiKeysResult:
    ...
    def api_key_id(self) -> _builtins.str | None:
        """
        API key ID.
        """
...
def get_api_keys(
    api_key_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getApiKeys:getApiKeys",
        __args__,
        opts=opts,
        typ=GetApiKeysResult,
    ).value
...
def get_api_keys_output(
    api_key_id: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetApiKeysResult(
