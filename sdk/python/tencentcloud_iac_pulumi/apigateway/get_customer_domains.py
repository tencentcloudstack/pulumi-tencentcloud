...
def get_customer_domains(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getCustomerDomains:getCustomerDomains",
        __args__,
        opts=opts,
        typ=GetCustomerDomainsResult,
    ).value
...
def get_customer_domains_output(
...
) -> pulumi.Output[GetCustomerDomainsResult]:
    """
    Use this data source to query API gateway domain list.
    ...
    return __ret__.apply(
        lambda __response__: GetCustomerDomainsResult(
