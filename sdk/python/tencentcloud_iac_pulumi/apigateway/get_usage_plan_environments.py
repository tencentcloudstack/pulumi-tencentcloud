...
class GetUsagePlanEnvironmentsResult:
    ...
    def bind_type(self) -> _builtins.str | None:
...
def get_usage_plan_environments(
    bind_type: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    usage_plan_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:ApiGateway/getUsagePlanEnvironments:getUsagePlanEnvironments",
        __args__,
        opts=opts,
        typ=GetUsagePlanEnvironmentsResult,
    ).value
...
def get_usage_plan_environments_output(
...
) -> pulumi.Output[GetUsagePlanEnvironmentsResult]:
    """
    Used to query the environment list bound by the plan.
    ...
    return __ret__.apply(
        lambda __response__: GetUsagePlanEnvironmentsResult(
