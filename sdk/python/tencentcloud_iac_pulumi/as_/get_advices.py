...
class GetAdvicesResult:
    ...
    def auto_scaling_advice_sets(
        self,
    ) -> Sequence["outputs.GetAdvicesAutoScalingAdviceSetResult"]:
        """
...
def get_advices(
    ...
    advices = tencentcloud.as_.get_advices(auto_scaling_group_ids=["asc-lo0b94oy"])
    ```
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:As/getAdvices:getAdvices",
        __args__,
        opts=opts,
        typ=GetAdvicesResult,
    ).value
...
def get_advices_output(
...
) -> pulumi.Output[GetAdvicesResult]:
    """
    Use this data source to query detailed information of as advices
    ...
    return __ret__.apply(
        lambda __response__: GetAdvicesResult(
            auto_scaling_advice_sets=pulumi.get(
                __response__, "auto_scaling_advice_sets"
            ),
