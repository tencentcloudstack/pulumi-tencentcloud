...
def get_limits(result_output_file: Optional[_builtins.str] = None,
...
def get_limits_output(result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:As/getLimits:getLimits', __args__, opts=opts, typ=GetLimitsResult)
    return __ret__.apply(lambda __response__: GetLimitsResult(
        id=pulumi.get(__response__, 'id'),
        max_number_of_auto_scaling_groups=pulumi.get(__response__, 'max_number_of_auto_scaling_groups'),
        max_number_of_launch_configurations=pulumi.get(__response__, 'max_number_of_launch_configurations'),
        number_of_auto_scaling_groups=pulumi.get(__response__, 'number_of_auto_scaling_groups'),
        number_of_launch_configurations=pulumi.get(__response__, 'number_of_launch_configurations'),
