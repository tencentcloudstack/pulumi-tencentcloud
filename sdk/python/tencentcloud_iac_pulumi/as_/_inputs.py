...
class StartInstanceRefreshRefreshSettingsArgsDict(TypedDict):
    ...
    """
    check_instance_target_health: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    check_instance_target_health_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class StartInstanceRefreshRefreshSettingsArgs:
    def __init__(__self__, *,
                 ...
                 check_instance_target_health: pulumi.Input[Optional[_builtins.bool]] = None,
                 check_instance_target_health_timeout: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def check_instance_target_health(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Backend service health check status for instances, defaults to FALSE. This setting takes effect only for scaling groups bound with application load balancers. When enabled, if an instance fails the check after being refreshed, its load balancer port weight remains 0 and is marked as a refresh failure. Valid values: <br><li>TRUE: Enable the check.</li> <li>FALSE: Do not enable the check.
        """
    ...
    def check_instance_target_health(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "check_instance_target_health", value)

    @_builtins.property
    @pulumi.getter(name="checkInstanceTargetHealthTimeout")
    def check_instance_target_health_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The timeout period for backend service health status checks, in seconds. The valid range is [60, 7200], with a default value of 1800 seconds. This takes effect only when the CheckInstanceTargetHealth parameter is enabled. If the instance health check times out, it will be marked as a refresh failure.
        """
    ...
    def check_instance_target_health_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgsDict(TypedDict):
    ...
    """
    batch_pause: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    fail_process: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgs:
    def __init__(__self__, *,
                 batch_number: pulumi.Input[_builtins.int],
                 batch_pause: pulumi.Input[Optional[_builtins.str]] = None,
                 fail_process: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def batch_pause(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Pause policy between batches. Default value: Automatic. Valid values: <br><li>FIRST_BATCH_PAUSE: Pause after the first batch update completes.</li> <li>BATCH_INTERVAL_PAUSE: Pause between each batch update.</li> <li>AUTOMATIC: No pauses.
        """
    ...
    @batch_pause.setter
    def batch_pause(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "batch_pause", value)

    @_builtins.property
    @pulumi.getter(name="failProcess")
    def fail_process(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Failure Handling Policy. The default value is `AUTO_PAUSE`. The values are as follows, `AUTO_PAUSE`: Pause after refresh fails; `AUTO_ROLLBACK`: Roll back after refresh fails; `AUTO_CANCEL`: Cancel after refresh fails.
        """
    ...
    @fail_process.setter
    def fail_process(self, value: pulumi.Input[Optional[_builtins.str]]):
