...
class LifecycleHookLifecycleCommandArgsDict(TypedDict):
    ...
    """
    parameters: NotRequired[pulumi.Input[_builtins.str | None]]
    """
...
class LoadBalancerForwardLoadBalancerArgsDict(TypedDict):
    ...
    """
    target_attributes: pulumi.Input[
        Sequence[pulumi.Input["LoadBalancerForwardLoadBalancerTargetAttributeArgsDict"]]
    ]
    """
...
class LoadBalancerForwardLoadBalancerArgs:
    def __init__(
        ...
        *,
        ...
        load_balancer_id: pulumi.Input[_builtins.str],
        target_attributes: pulumi.Input[
            Sequence[pulumi.Input["LoadBalancerForwardLoadBalancerTargetAttributeArgs"]]
        ],
...
class ScalingGroupForwardBalancerIdArgsDict(TypedDict):
    ...
    """
    target_attributes: pulumi.Input[
        Sequence[pulumi.Input["ScalingGroupForwardBalancerIdTargetAttributeArgsDict"]]
    ]
    """
...
class ScalingGroupForwardBalancerIdArgs:
    def __init__(
        ...
        *,
        ...
        load_balancer_id: pulumi.Input[_builtins.str],
        target_attributes: pulumi.Input[
            Sequence[pulumi.Input["ScalingGroupForwardBalancerIdTargetAttributeArgs"]]
        ],
...
class StartInstanceRefreshRefreshSettingsArgsDict(TypedDict):
    rolling_update_settings: pulumi.Input[
        "StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgsDict"
    ]
    """
    ...
    """
    check_instance_target_health: NotRequired[pulumi.Input[_builtins.bool | None]]
    """
    ...
    """
    check_instance_target_health_timeout: NotRequired[
...
class StartInstanceRefreshRefreshSettingsArgs:
    def __init__(
        ...
        *,
        ...
        check_instance_target_health: pulumi.Input[_builtins.bool | None] = None,
        check_instance_target_health_timeout: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def rolling_update_settings(
        self,
    ) -> pulumi.Input["StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgs"]:
        """
        Rolling update settings parameters. RefreshMode is the rolling update. This parameter must be filled in.Note: This field may return null, indicating that no valid value can be obtained.
        """
    ...
    def check_instance_target_health(self) -> pulumi.Input[_builtins.bool | None]:
        """
        Backend service health check status for instances, defaults to FALSE. This setting takes effect only for scaling groups bound with application load balancers. When enabled, if an instance fails the check after being refreshed, its load balancer port weight remains 0 and is marked as a refresh failure. Valid values: <br><li>TRUE: Enable the check.</li> <li>FALSE: Do not enable the check.
        """
    ...
    def check_instance_target_health(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "check_instance_target_health", value)

    @_builtins.property
    @pulumi.getter(name="checkInstanceTargetHealthTimeout")
    def check_instance_target_health_timeout(
        self,
    ) -> pulumi.Input[_builtins.int | None]:
        """
        The timeout period for backend service health status checks, in seconds. The valid range is [60, 7200], with a default value of 1800 seconds. This takes effect only when the CheckInstanceTargetHealth parameter is enabled. If the instance health check times out, it will be marked as a refresh failure.
...
class StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgsDict(TypedDict):
    ...
    """
    batch_pause: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    fail_process: NotRequired[pulumi.Input[_builtins.str | None]]
    """
    ...
    """
    max_surge: NotRequired[pulumi.Input[_builtins.int | None]]
    """
...
class StartInstanceRefreshRefreshSettingsRollingUpdateSettingsArgs:
    def __init__(
        ...
        *,
        batch_number: pulumi.Input[_builtins.int],
        batch_pause: pulumi.Input[_builtins.str | None] = None,
        fail_process: pulumi.Input[_builtins.str | None] = None,
        max_surge: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    def batch_pause(self) -> pulumi.Input[_builtins.str | None]:
        """
        Pause policy between batches. Default value: Automatic. Valid values: <br><li>FIRST_BATCH_PAUSE: Pause after the first batch update completes.</li> <li>BATCH_INTERVAL_PAUSE: Pause between each batch update.</li> <li>AUTOMATIC: No pauses.
        """
    ...
    @batch_pause.setter
    def batch_pause(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "batch_pause", value)

    @_builtins.property
    @pulumi.getter(name="failProcess")
    def fail_process(self) -> pulumi.Input[_builtins.str | None]:
        """
        Failure Handling Policy. The default value is `AUTO_PAUSE`. The values are as follows, `AUTO_PAUSE`: Pause after refresh fails; `AUTO_ROLLBACK`: Roll back after refresh fails; `AUTO_CANCEL`: Cancel after refresh fails.
        """
    ...
    @fail_process.setter
    def fail_process(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "fail_process", value)

    @_builtins.property
    @pulumi.getter(name="maxSurge")
    def max_surge(self) -> pulumi.Input[_builtins.int | None]:
        """
        Maximum Extra Quantity. After setting this parameter, a batch of pay-as-you-go extra instances will be created according to the launch configuration before the rolling update starts, and the extra instances will be destroyed after the rolling update is completed.
        """
    ...
    @max_surge.setter
    def max_surge(self, value: pulumi.Input[_builtins.int | None]):
