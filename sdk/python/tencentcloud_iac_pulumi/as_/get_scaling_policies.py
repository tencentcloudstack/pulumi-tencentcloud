...
class GetScalingPoliciesResult:
    ...
    def scaling_policy_id(self) -> _builtins.str | None:
        return pulumi.get(self, "scaling_policy_id")

    @_builtins.property
    @pulumi.getter(name="scalingPolicyLists")
    def scaling_policy_lists(
        self,
    ) -> Sequence["outputs.GetScalingPoliciesScalingPolicyListResult"]:
        """
...
def get_scaling_policies(
    ...
    scaling_policy_id: _builtins.str | None = None,
    ...
    as_scaling_policies = tencentcloud.as_.get_scaling_policies(scaling_policy_id="asg-mvyghxu7",
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:As/getScalingPolicies:getScalingPolicies",
        __args__,
        opts=opts,
        typ=GetScalingPoliciesResult,
    ).value
...
def get_scaling_policies_output(
    ...
    scaling_policy_id: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetScalingPoliciesResult]:
    """
    Use this data source to query detailed information of scaling policy.
    ...
    return __ret__.apply(
        lambda __response__: GetScalingPoliciesResult(
