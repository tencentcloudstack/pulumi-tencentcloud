...
class ScheduleArgs:
    def __init__(__self__, *,
                 ...
                 disable_update_desired_capacity: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        if disable_update_desired_capacity is not None:
            pulumi.set(__self__, "disable_update_desired_capacity", disable_update_desired_capacity)
    ...
    def disable_update_desired_capacity(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def disable_update_desired_capacity(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _ScheduleState:
    def __init__(__self__, *,
                 ...
                 schedule_action_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="scheduleActionName")
    def schedule_action_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of this scaling action.
        """
        return pulumi.get(self, "schedule_action_name")
    ...
    @schedule_action_name.setter
    def schedule_action_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "schedule_action_name", value)
...
class Schedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["disable_update_desired_capacity"] = disable_update_desired_capacity
    ...
    def get(resource_name: str,
            ...
            scaling_group_id: pulumi.Input[Optional[_builtins.str]] = None,
            schedule_action_name: pulumi.Input[Optional[_builtins.str]] = None,
            start_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'Schedule':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def recurrence(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The time when recurring future actions will start. Start time is specified by the user following the Unix cron syntax format. And this argument should be set with end_time together.
        """
        return pulumi.get(self, "recurrence")
