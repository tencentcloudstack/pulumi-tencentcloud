...
class _NotificationState:
    def __init__(
        __self__,
        *,
        notification_types: pulumi.Input[
...
class Notification(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            NotificationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            if notification_user_group_ids is None and not opts.urn:
                raise TypeError(
                    "Missing required property 'notification_user_group_ids'"
                )
        ...
        super().__init__(
            "tencentcloud:As/notification:Notification", resource_name, __props__, opts
        )
