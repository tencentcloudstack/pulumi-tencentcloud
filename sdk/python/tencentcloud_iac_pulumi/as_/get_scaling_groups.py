...
class GetScalingGroupsResult:
    ...
    def scaling_group_id(self) -> _builtins.str | None:
        """
    ...
    def scaling_group_lists(
        self,
    ) -> Sequence["outputs.GetScalingGroupsScalingGroupListResult"]:
        """
    ...
    def scaling_group_name(self) -> _builtins.str | None:
        """
...
def get_scaling_groups(
    ...
    scaling_group_id: _builtins.str | None = None,
    scaling_group_name: _builtins.str | None = None,
    ...
    as_scaling_groups = tencentcloud.as_.get_scaling_groups(scaling_group_name="myasgroup",
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:As/getScalingGroups:getScalingGroups",
        __args__,
        opts=opts,
        typ=GetScalingGroupsResult,
    ).value
...
def get_scaling_groups_output(
...
) -> pulumi.Output[GetScalingGroupsResult]:
    """
    Use this data source to query the detail information of an existing autoscaling group.
    ...
    return __ret__.apply(
        lambda __response__: GetScalingGroupsResult(
