...
def get_scaling_configs_output(configuration_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                               configuration_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
