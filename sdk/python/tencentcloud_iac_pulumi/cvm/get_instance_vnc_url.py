...
def get_instance_vnc_url(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cvm/getInstanceVncUrl:getInstanceVncUrl",
        __args__,
        opts=opts,
        typ=GetInstanceVncUrlResult,
    ).value
...
def get_instance_vnc_url_output(
...
) -> pulumi.Output[GetInstanceVncUrlResult]:
    """
    Use this data source to query detailed information of cvm instance_vnc_url
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceVncUrlResult(
