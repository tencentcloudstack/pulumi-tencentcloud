...
def get_instances_modification_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetInstancesModificationFilterArgs', 'GetInstancesModificationFilterArgsDict']]]]] = None,
