...
@pulumi.type_token("tencentcloud:Cvm/securityGroupAttachment:SecurityGroupAttachment")
class SecurityGroupAttachment(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example_security_group_attachment = tencentcloud.cvm.SecurityGroupAttachment("example",
