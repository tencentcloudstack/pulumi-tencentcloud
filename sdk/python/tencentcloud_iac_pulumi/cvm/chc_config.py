...
__all__ = ['ChcConfig', 'ChcConfigArgs']

@pulumi.input_type
class ChcConfigArgs:
    def __init__(__self__, *,
                 chc_id: pulumi.Input[_builtins.str],
                 bmc_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 bmc_user: pulumi.Input[Optional[_builtins.str]] = None,
                 bmc_virtual_private_cloud: pulumi.Input[Optional['ChcConfigBmcVirtualPrivateCloudArgs']] = None,
                 deploy_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 deploy_virtual_private_cloud: pulumi.Input[Optional['ChcConfigDeployVirtualPrivateCloudArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] chc_id: CHC host ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] bmc_security_group_ids: Out-of-band network security group list.
        :param pulumi.Input[_builtins.str] bmc_user: Valid characters: Letters, numbers, hyphens and underscores. Only set when update password.
        :param pulumi.Input['ChcConfigBmcVirtualPrivateCloudArgs'] bmc_virtual_private_cloud: Out-of-band network information.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] deploy_security_group_ids: Deployment network security group list.
        :param pulumi.Input['ChcConfigDeployVirtualPrivateCloudArgs'] deploy_virtual_private_cloud: Deployment network information.
        :param pulumi.Input[_builtins.str] device_type: Server type.
        :param pulumi.Input[_builtins.str] instance_name: CHC host name.
        :param pulumi.Input[_builtins.str] password: The password can contain 8 to 16 characters, including letters, numbers and special symbols (()`~!@#$%^&amp;amp;*-+=_|{}).
        """
    ...
    def chc_id(self) -> pulumi.Input[_builtins.str]:
        """
        CHC host ID.
        """
    ...
    @chc_id.setter
    def chc_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "chc_id", value)

    @_builtins.property
    @pulumi.getter(name="bmcSecurityGroupIds")
    def bmc_security_group_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def bmc_security_group_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "bmc_security_group_ids", value)

    @_builtins.property
    @pulumi.getter(name="bmcUser")
    def bmc_user(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @bmc_user.setter
    def bmc_user(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "bmc_user", value)

    @_builtins.property
    @pulumi.getter(name="bmcVirtualPrivateCloud")
    def bmc_virtual_private_cloud(self) -> pulumi.Input[Optional['ChcConfigBmcVirtualPrivateCloudArgs']]:
        """
    ...
    def bmc_virtual_private_cloud(self, value: pulumi.Input[Optional['ChcConfigBmcVirtualPrivateCloudArgs']]):
        pulumi.set(self, "bmc_virtual_private_cloud", value)

    @_builtins.property
    @pulumi.getter(name="deploySecurityGroupIds")
    def deploy_security_group_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def deploy_security_group_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "deploy_security_group_ids", value)

    @_builtins.property
    @pulumi.getter(name="deployVirtualPrivateCloud")
    def deploy_virtual_private_cloud(self) -> pulumi.Input[Optional['ChcConfigDeployVirtualPrivateCloudArgs']]:
        """
    ...
    def deploy_virtual_private_cloud(self, value: pulumi.Input[Optional['ChcConfigDeployVirtualPrivateCloudArgs']]):
...
class _ChcConfigState:
    def __init__(__self__, *,
                 ...
                 bmc_user: pulumi.Input[Optional[_builtins.str]] = None,
                 bmc_virtual_private_cloud: pulumi.Input[Optional['ChcConfigBmcVirtualPrivateCloudArgs']] = None,
                 chc_id: pulumi.Input[Optional[_builtins.str]] = None,
                 deploy_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 deploy_virtual_private_cloud: pulumi.Input[Optional['ChcConfigDeployVirtualPrivateCloudArgs']] = None,
                 device_type: pulumi.Input[Optional[_builtins.str]] = None,
                 instance_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="chcId")
    def chc_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        CHC host ID.
        """
        return pulumi.get(self, "chc_id")
    ...
    @chc_id.setter
    def chc_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "chc_id", value)
...
@pulumi.type_token("tencentcloud:Cvm/chcConfig:ChcConfig")
class ChcConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bmc_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 bmc_user: pulumi.Input[Optional[_builtins.str]] = None,
                 bmc_virtual_private_cloud: pulumi.Input[Optional[Union['ChcConfigBmcVirtualPrivateCloudArgs', 'ChcConfigBmcVirtualPrivateCloudArgsDict']]] = None,
                 chc_id: pulumi.Input[Optional[_builtins.str]] = None,
                 deploy_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 deploy_virtual_private_cloud: pulumi.Input[Optional[Union['ChcConfigDeployVirtualPrivateCloudArgs', 'ChcConfigDeployVirtualPrivateCloudArgsDict']]] = None,
                 device_type: pulumi.Input[Optional[_builtins.str]] = None,
                 instance_name: pulumi.Input[Optional[_builtins.str]] = None,
                 password: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        chc_config = tencentcloud.cvm.ChcConfig("chc_config",
            chc_id="chc-xxxxxx",
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] bmc_security_group_ids: Out-of-band network security group list.
        :param pulumi.Input[_builtins.str] bmc_user: Valid characters: Letters, numbers, hyphens and underscores. Only set when update password.
        :param pulumi.Input[Union['ChcConfigBmcVirtualPrivateCloudArgs', 'ChcConfigBmcVirtualPrivateCloudArgsDict']] bmc_virtual_private_cloud: Out-of-band network information.
        :param pulumi.Input[_builtins.str] chc_id: CHC host ID.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] deploy_security_group_ids: Deployment network security group list.
        :param pulumi.Input[Union['ChcConfigDeployVirtualPrivateCloudArgs', 'ChcConfigDeployVirtualPrivateCloudArgsDict']] deploy_virtual_private_cloud: Deployment network information.
        :param pulumi.Input[_builtins.str] device_type: Server type.
        :param pulumi.Input[_builtins.str] instance_name: CHC host name.
        :param pulumi.Input[_builtins.str] password: The password can contain 8 to 16 characters, including letters, numbers and special symbols (()`~!@#$%^&amp;amp;*-+=_|{}).
        """
    ...
    def get(resource_name: str,
            ...
            device_type: pulumi.Input[Optional[_builtins.str]] = None,
            instance_name: pulumi.Input[Optional[_builtins.str]] = None,
            password: pulumi.Input[Optional[_builtins.str]] = None) -> 'ChcConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="bmcSecurityGroupIds")
    def bmc_security_group_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Out-of-band network security group list.
        """
        return pulumi.get(self, "bmc_security_group_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="bmcUser")
    def bmc_user(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Valid characters: Letters, numbers, hyphens and underscores. Only set when update password.
        """
        return pulumi.get(self, "bmc_user")
    ...
    @_builtins.property
    @pulumi.getter(name="chcId")
    def chc_id(self) -> pulumi.Output[_builtins.str]:
        """
        CHC host ID.
        """
        return pulumi.get(self, "chc_id")
    ...
    @_builtins.property
    @pulumi.getter(name="deploySecurityGroupIds")
    def deploy_security_group_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Deployment network security group list.
        """
        return pulumi.get(self, "deploy_security_group_ids")
