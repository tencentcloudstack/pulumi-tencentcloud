...
__all__ = ['ModifyInstanceDiskType', 'ModifyInstanceDiskTypeArgs']

@pulumi.input_type
class ModifyInstanceDiskTypeArgs:
    def __init__(__self__, *,
                 instance_id: pulumi.Input[_builtins.str],
                 data_disks: pulumi.Input[Optional[Sequence[pulumi.Input['ModifyInstanceDiskTypeDataDiskArgs']]]] = None,
                 system_disk: pulumi.Input[Optional['ModifyInstanceDiskTypeSystemDiskArgs']] = None):
        """
        The set of arguments for constructing a ModifyInstanceDiskType resource.

        :param pulumi.Input[_builtins.str] instance_id: Instance ID. To obtain the instance IDs, you can call DescribeInstances and look for InstanceId in the response.
        :param pulumi.Input[Sequence[pulumi.Input['ModifyInstanceDiskTypeDataDiskArgs']]] data_disks: For instance data disk configuration information, you only need to specify the media type of the target cloud disk to be converted, and specify the value of DiskType. Currently, only one data disk conversion is supported. The CdcId parameter is only supported for instances of the CDHPAID type.
        :param pulumi.Input['ModifyInstanceDiskTypeSystemDiskArgs'] system_disk: For instance system disk configuration information, you only need to specify the nature type of the target cloud disk to be converted, and specify the value of DiskType. Only CDHPAID type instances are supported to specify Cd.
        """
    ...
    def data_disks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ModifyInstanceDiskTypeDataDiskArgs']]]]:
        """
    ...
    @data_disks.setter
    def data_disks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ModifyInstanceDiskTypeDataDiskArgs']]]]):
        pulumi.set(self, "data_disks", value)

    @_builtins.property
    @pulumi.getter(name="systemDisk")
    def system_disk(self) -> pulumi.Input[Optional['ModifyInstanceDiskTypeSystemDiskArgs']]:
        """
    ...
    @system_disk.setter
    def system_disk(self, value: pulumi.Input[Optional['ModifyInstanceDiskTypeSystemDiskArgs']]):
...
@pulumi.type_token("tencentcloud:Cvm/modifyInstanceDiskType:ModifyInstanceDiskType")
class ModifyInstanceDiskType(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 data_disks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ModifyInstanceDiskTypeDataDiskArgs', 'ModifyInstanceDiskTypeDataDiskArgsDict']]]]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 system_disk: pulumi.Input[Optional[Union['ModifyInstanceDiskTypeSystemDiskArgs', 'ModifyInstanceDiskTypeSystemDiskArgsDict']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ModifyInstanceDiskTypeDataDiskArgs', 'ModifyInstanceDiskTypeDataDiskArgsDict']]]] data_disks: For instance data disk configuration information, you only need to specify the media type of the target cloud disk to be converted, and specify the value of DiskType. Currently, only one data disk conversion is supported. The CdcId parameter is only supported for instances of the CDHPAID type.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID. To obtain the instance IDs, you can call DescribeInstances and look for InstanceId in the response.
        :param pulumi.Input[Union['ModifyInstanceDiskTypeSystemDiskArgs', 'ModifyInstanceDiskTypeSystemDiskArgsDict']] system_disk: For instance system disk configuration information, you only need to specify the nature type of the target cloud disk to be converted, and specify the value of DiskType. Only CDHPAID type instances are supported to specify Cd.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            data_disks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ModifyInstanceDiskTypeDataDiskArgs', 'ModifyInstanceDiskTypeDataDiskArgsDict']]]]] = None,
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            system_disk: pulumi.Input[Optional[Union['ModifyInstanceDiskTypeSystemDiskArgs', 'ModifyInstanceDiskTypeSystemDiskArgsDict']]] = None) -> 'ModifyInstanceDiskType':
        """
