...
class _LaunchTemplateDefaultVersionState:
    ...
    @_builtins.property
    @pulumi.getter(name="defaultVersion")
    def default_version(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of the version that you want to set as the default version.
        """
        return pulumi.get(self, "default_version")
    ...
    @default_version.setter
    def default_version(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "default_version", value)
...
@pulumi.type_token("tencentcloud:Cvm/launchTemplateDefaultVersion:LaunchTemplateDefaultVersion")
class LaunchTemplateDefaultVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            default_version: pulumi.Input[Optional[_builtins.int]] = None,
            launch_template_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'LaunchTemplateDefaultVersion':
        """
