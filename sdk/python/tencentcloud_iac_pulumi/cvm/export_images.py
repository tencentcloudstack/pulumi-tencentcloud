...
__all__ = ["ExportImages", "ExportImagesArgs"]
...
class ExportImagesArgs:
    def __init__(
        ...
        *,
        ...
        export_format: pulumi.Input[_builtins.str | None] = None,
        only_export_root_disk: pulumi.Input[_builtins.bool | None] = None,
        ...
        :param pulumi.Input[_builtins.str] file_name_prefix: Prefix of exported file.
        :param pulumi.Input[_builtins.str] image_id: Image ID.
        :param pulumi.Input[_builtins.bool] dry_run: Check whether the image can be exported.
        :param pulumi.Input[_builtins.str] export_format: Format of the exported image file. Valid values: RAW, QCOW2, VHD and VMDK. Default value: RAW.
        :param pulumi.Input[_builtins.bool] only_export_root_disk: Whether to export only the system disk.
        :param pulumi.Input[_builtins.str] role_name: Role name (Default: CVM_QcsRole). Before exporting the images, make sure the role exists, and it has write permission to COS.
        """
    ...
    def export_format(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    def export_format(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "export_format", value)

    @_builtins.property
    @pulumi.getter(name="onlyExportRootDisk")
    def only_export_root_disk(self) -> pulumi.Input[_builtins.bool | None]:
        """
    ...
    def only_export_root_disk(self, value: pulumi.Input[_builtins.bool | None]):
...
class _ExportImagesState:
    def __init__(
        ...
        *,
        ...
        dry_run: pulumi.Input[_builtins.bool | None] = None,
        export_format: pulumi.Input[_builtins.str | None] = None,
        file_name_prefix: pulumi.Input[_builtins.str | None] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="fileNamePrefix")
    def file_name_prefix(self) -> pulumi.Input[_builtins.str | None]:
        """
        Prefix of exported file.
        """
        return pulumi.get(self, "file_name_prefix")
    ...
    @file_name_prefix.setter
    def file_name_prefix(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "file_name_prefix", value)
...
@pulumi.type_token("tencentcloud:Cvm/exportImages:ExportImages")
class ExportImages(pulumi.CustomResource):
    ...
    def __init__(
        ...
        export_images = tencentcloud.cvm.ExportImages("export_images",
            bucket_name="xxxxxx",
            image_id="img-xxxxxx",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ExportImagesArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cvm/exportImages:ExportImages", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="exportFormat")
    def export_format(self) -> pulumi.Output[_builtins.str | None]:
        """
        Format of the exported image file. Valid values: RAW, QCOW2, VHD and VMDK. Default value: RAW.
        """
        return pulumi.get(self, "export_format")
    ...
    @_builtins.property
    @pulumi.getter(name="fileNamePrefix")
    def file_name_prefix(self) -> pulumi.Output[_builtins.str]:
        """
        Prefix of exported file.
        """
        return pulumi.get(self, "file_name_prefix")
    ...
    @_builtins.property
    @pulumi.getter(name="onlyExportRootDisk")
    def only_export_root_disk(self) -> pulumi.Output[_builtins.bool | None]:
        """
        Whether to export only the system disk.
        """
        return pulumi.get(self, "only_export_root_disk")
    ...
    @_builtins.property
    @pulumi.getter(name="roleName")
    def role_name(self) -> pulumi.Output[_builtins.str | None]:
        """
        Role name (Default: CVM_QcsRole). Before exporting the images, make sure the role exists, and it has write permission to COS.
        """
        return pulumi.get(self, "role_name")
