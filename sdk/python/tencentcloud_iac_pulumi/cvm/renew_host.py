...
class _RenewHostState:
    def __init__(__self__, *,
                 host_charge_prepaid: pulumi.Input[Optional['RenewHostHostChargePrepaidArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="hostChargePrepaid")
    def host_charge_prepaid(self) -> pulumi.Input[Optional['RenewHostHostChargePrepaidArgs']]:
        """
        Prepaid mode, that is, yearly and monthly subscription related parameter settings. Through this parameter, you can specify attributes such as the purchase duration of the Subscription instance and whether to set automatic renewal. If the payment mode of the specified instance is prepaid, this parameter must be passed.
        """
        return pulumi.get(self, "host_charge_prepaid")
    ...
    @host_charge_prepaid.setter
    def host_charge_prepaid(self, value: pulumi.Input[Optional['RenewHostHostChargePrepaidArgs']]):
        pulumi.set(self, "host_charge_prepaid", value)
...
class RenewHost(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 host_charge_prepaid: pulumi.Input[Optional[Union['RenewHostHostChargePrepaidArgs', 'RenewHostHostChargePrepaidArgsDict']]] = None,
                 host_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            host_charge_prepaid: pulumi.Input[Optional[Union['RenewHostHostChargePrepaidArgs', 'RenewHostHostChargePrepaidArgsDict']]] = None,
            host_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RenewHost':
        """
