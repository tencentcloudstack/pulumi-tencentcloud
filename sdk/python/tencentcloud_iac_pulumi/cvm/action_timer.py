...
__all__ = ["ActionTimer", "ActionTimerArgs"]
...
class _ActionTimerState:
    def __init__(
        __self__,
        *,
        action_timer: pulumi.Input[Optional["ActionTimerActionTimerArgs"]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="actionTimer")
    def action_timer(self) -> pulumi.Input[Optional["ActionTimerActionTimerArgs"]]:
        """
        Scheduled tasks. This parameter can be used to specify scheduled tasks for instances, and currently only supports scheduled destruction.
        """
        return pulumi.get(self, "action_timer")
    ...
    @action_timer.setter
    def action_timer(self, value: pulumi.Input[Optional["ActionTimerActionTimerArgs"]]):
        pulumi.set(self, "action_timer", value)
...
@pulumi.type_token("tencentcloud:Cvm/actionTimer:ActionTimer")
class ActionTimer(pulumi.CustomResource):
    ...
    def __init__(
        ...
        action_timer: pulumi.Input[
            Union["ActionTimerActionTimerArgs", "ActionTimerActionTimerArgsDict"] | None
        ] = None,
        instance_id: pulumi.Input[_builtins.str | None] = None,
        __props__=None,
    ):
        ...
        example_action_timer = tencentcloud.cvm.ActionTimer("example",
        ...
        :param pulumi.Input[Union['ActionTimerActionTimerArgs', 'ActionTimerActionTimerArgsDict']] action_timer: Scheduled tasks. This parameter can be used to specify scheduled tasks for instances, and currently only supports scheduled destruction.
        :param pulumi.Input[_builtins.str] instance_id: Instance ID.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ActionTimerArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cvm/actionTimer:ActionTimer", resource_name, __props__, opts
        )
