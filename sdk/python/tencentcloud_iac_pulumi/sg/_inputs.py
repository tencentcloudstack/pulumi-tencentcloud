...
class RuleDataArgsDict(TypedDict):
    ...
    """
    order_index: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Rule priority.
    """
...
class RuleDataArgs:
    def __init__(__self__, *,
                 ...
                 source_content: pulumi.Input[_builtins.str],
                 source_type: pulumi.Input[_builtins.str],
                 order_index: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def order_index(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Rule priority.
        """
    ...
    @order_index.setter
    def order_index(self, value: pulumi.Input[Optional[_builtins.str]]):
