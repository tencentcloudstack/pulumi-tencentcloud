...
class GetListAttachedUserPolicyResult:
    ...
    def policy_lists(
        self,
    ) -> Sequence["outputs.GetListAttachedUserPolicyPolicyListResult"]:
    ...
    def strategy_type(self) -> _builtins.int | None:
...
def get_list_attached_user_policy(
    attach_type: _builtins.int | None = None,
    keyword: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    strategy_type: _builtins.int | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cam/getListAttachedUserPolicy:getListAttachedUserPolicy",
        __args__,
        opts=opts,
        typ=GetListAttachedUserPolicyResult,
    ).value
...
def get_list_attached_user_policy_output(
    attach_type: pulumi.Input[_builtins.int | None] = None,
...
) -> pulumi.Output[GetListAttachedUserPolicyResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    return __ret__.apply(
        lambda __response__: GetListAttachedUserPolicyResult(
