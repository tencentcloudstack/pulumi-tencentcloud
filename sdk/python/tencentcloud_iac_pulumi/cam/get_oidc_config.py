...
def get_oidc_config(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cam/getOidcConfig:getOidcConfig",
        __args__,
        opts=opts,
        typ=GetOidcConfigResult,
    ).value
...
def get_oidc_config_output(
...
) -> pulumi.Output[GetOidcConfigResult]:
    """
    Use this data source to query detailed information of cam oidc_config
    ...
    return __ret__.apply(
        lambda __response__: GetOidcConfigResult(
