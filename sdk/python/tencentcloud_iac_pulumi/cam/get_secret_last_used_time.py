...
def get_secret_last_used_time_output(result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                     secret_id_lists: pulumi.Input[Optional[Sequence[_builtins.str]]] = None,
