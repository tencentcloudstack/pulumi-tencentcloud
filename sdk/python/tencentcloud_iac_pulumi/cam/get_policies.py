...
class GetPoliciesResult:
    ...
    """
    def __init__(__self__, create_mode=None, description=None, id=None, key_word=None, name=None, policy_id=None, policy_lists=None, result_output_file=None, scope=None, type=None):
...
def get_policies_output(create_mode: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
