...
__all__ = ["SetPolicyVersionConfig", "SetPolicyVersionConfigArgs"]
...
class SetPolicyVersionConfigArgs:
    def __init__(
        ...
        *,
        ...
        version_id: pulumi.Input[_builtins.int]
    ):
        """
        ...
        :param pulumi.Input[_builtins.int] version_id: The policy version number, which can be obtained from ListPolicyVersions.
        """
    ...
    def version_id(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @version_id.setter
    def version_id(self, value: pulumi.Input[_builtins.int]):
...
@pulumi.type_token("tencentcloud:Cam/setPolicyVersionConfig:SetPolicyVersionConfig")
class SetPolicyVersionConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        example = tencentcloud.cam.SetPolicyVersionConfig("example",
            policy_id=234290251,
            version_id=3)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            SetPolicyVersionConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
