...
__all__ = ["PolicyByName", "PolicyByNameArgs"]
...
@pulumi.type_token("tencentcloud:Cam/policyByName:PolicyByName")
class PolicyByName(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            PolicyByNameArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Cam/policyByName:PolicyByName", resource_name, __props__, opts
        )
