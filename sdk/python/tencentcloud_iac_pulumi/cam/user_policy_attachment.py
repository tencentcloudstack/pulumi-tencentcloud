...
class UserPolicyAttachmentArgs:
    ...
    @_utilities.deprecated("""It has been deprecated from version 1.59.5. Use `user_name` instead.""")
...
class UserPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_type: pulumi.Input[Optional[_builtins.str]] = None,
            user_id: pulumi.Input[Optional[_builtins.str]] = None,
            user_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'UserPolicyAttachment':
        """
