...
def get_sub_accounts(filter_sub_account_uins: Optional[Sequence[_builtins.int]] = None,
    ...
    example = tencentcloud.cam.get_sub_accounts(filter_sub_account_uins=[int(100037718139)])
    ```
...
def get_sub_accounts_output(filter_sub_account_uins: pulumi.Input[Optional[Sequence[_builtins.int]]] = None,
