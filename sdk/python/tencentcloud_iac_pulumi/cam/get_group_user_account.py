...
class GetGroupUserAccountResult:
    ...
    def sub_uin(self) -> Optional[_builtins.int]:
...
def get_group_user_account(result_output_file: Optional[_builtins.str] = None,
                           rp: Optional[_builtins.int] = None,
                           sub_uin: Optional[_builtins.int] = None,
    ...
    group_user_account = tencentcloud.cam.get_group_user_account(sub_uin=int(100033690181))
    ```


    :param _builtins.str result_output_file: Used to save results.
    :param _builtins.int rp: Number per page. The default is 20.
    :param _builtins.int sub_uin: Sub-user uin.
    :param _builtins.int uid: Sub-user uid.
    """
    __args__ = {}
...
def get_group_user_account_output(result_output_file: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                  rp: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                  sub_uin: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                  uid: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetGroupUserAccountResult]:
    """
    Use this data source to query detailed information of cam group_user_account
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cam/getGroupUserAccount:getGroupUserAccount', __args__, opts=opts, typ=GetGroupUserAccountResult)
    return __ret__.apply(lambda __response__: GetGroupUserAccountResult(
        group_infos=pulumi.get(__response__, 'group_infos'),
        id=pulumi.get(__response__, 'id'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        rp=pulumi.get(__response__, 'rp'),
        sub_uin=pulumi.get(__response__, 'sub_uin'),
