...
def get_group_user_account_output(result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  rp: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                  sub_uin: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
