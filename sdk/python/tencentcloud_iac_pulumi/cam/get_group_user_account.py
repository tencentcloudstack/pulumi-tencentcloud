...
class GetGroupUserAccountResult:
    ...
    def sub_uin(self) -> _builtins.int | None:
...
def get_group_user_account(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cam/getGroupUserAccount:getGroupUserAccount",
        __args__,
        opts=opts,
        typ=GetGroupUserAccountResult,
    ).value
...
def get_group_user_account_output(
    ...
    return __ret__.apply(
        lambda __response__: GetGroupUserAccountResult(
