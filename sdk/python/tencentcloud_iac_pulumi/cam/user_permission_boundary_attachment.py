...
@pulumi.type_token("tencentcloud:Cam/userPermissionBoundaryAttachment:UserPermissionBoundaryAttachment")
class UserPermissionBoundaryAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            policy_id: pulumi.Input[Optional[_builtins.int]] = None,
            target_uin: pulumi.Input[Optional[_builtins.int]] = None) -> 'UserPermissionBoundaryAttachment':
        """
