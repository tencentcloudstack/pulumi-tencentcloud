...
def get_saml_providers(description: Optional[_builtins.str] = None,
...
def get_saml_providers_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSamlProvidersResult]:
    """
    Use this data source to query detailed information of CAM SAML providers
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Cam/getSamlProviders:getSamlProviders', __args__, opts=opts, typ=GetSamlProvidersResult)
    return __ret__.apply(lambda __response__: GetSamlProvidersResult(
