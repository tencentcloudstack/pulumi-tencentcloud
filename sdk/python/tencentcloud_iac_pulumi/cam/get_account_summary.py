...
def get_account_summary(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Cam/getAccountSummary:getAccountSummary",
        __args__,
        opts=opts,
        typ=GetAccountSummaryResult,
    ).value
...
def get_account_summary_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAccountSummaryResult(
