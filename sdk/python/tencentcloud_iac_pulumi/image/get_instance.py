...
class GetInstanceResult:
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetInstanceFilterResult"] | None:
...
def get_instance(
    filters: (
        Sequence[Union["GetInstanceFilterArgs", "GetInstanceFilterArgsDict"]] | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Image/getInstance:getInstance",
        __args__,
        opts=opts,
