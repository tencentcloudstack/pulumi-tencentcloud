...
class _BucketPicStyleState:
    def __init__(__self__, *,
                 ...
                 style_body: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="styleBody")
    def style_body(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        style details, example: mageMogr2/grayscale/1.
        """
        return pulumi.get(self, "style_body")
    ...
    @style_body.setter
    def style_body(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "style_body", value)
...
class BucketPicStyle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            bucket: Optional[pulumi.Input[_builtins.str]] = None,
            style_body: Optional[pulumi.Input[_builtins.str]] = None,
            style_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'BucketPicStyle':
        """
