...
__all__ = ["BucketPicStyle", "BucketPicStyleArgs"]
...
class BucketPicStyleArgs:
    def __init__(
        ...
        *,
        ...
        style_body: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] style_body: style details, example: mageMogr2/grayscale/1.
        :param pulumi.Input[_builtins.str] style_name: style name, style names are case-sensitive, and a combination of uppercase and lowercase letters, numbers, and `$ + _ ( )` is supported.
        """
    ...
    def style_body(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @style_body.setter
    def style_body(self, value: pulumi.Input[_builtins.str]):
...
class _BucketPicStyleState:
    def __init__(
        ...
        *,
        ...
        style_body: pulumi.Input[_builtins.str | None] = None,
        style_name: pulumi.Input[_builtins.str | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="styleBody")
    def style_body(self) -> pulumi.Input[_builtins.str | None]:
        """
        style details, example: mageMogr2/grayscale/1.
        """
        return pulumi.get(self, "style_body")
    ...
    @style_body.setter
    def style_body(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "style_body", value)

    @_builtins.property
    @pulumi.getter(name="styleName")
    def style_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        style name, style names are case-sensitive, and a combination of uppercase and lowercase letters, numbers, and `$ + _ ( )` is supported.
        """
        return pulumi.get(self, "style_name")
    ...
    @style_name.setter
    def style_name(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "style_name", value)


@pulumi.type_token("tencentcloud:Ci/bucketPicStyle:BucketPicStyle")
class BucketPicStyle(pulumi.CustomResource):
    ...
    def __init__(
        ...
        bucket_pic_style = tencentcloud.ci.BucketPicStyle("bucket_pic_style",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            BucketPicStyleArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="styleBody")
    def style_body(self) -> pulumi.Output[_builtins.str]:
        """
        style details, example: mageMogr2/grayscale/1.
        """
        return pulumi.get(self, "style_body")
