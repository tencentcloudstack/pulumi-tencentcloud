...
class MediaAnimationTemplateContainer(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str format: Package format.
        """
...
class MediaAnimationTemplateTimeInterval(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str duration: duration, [0 video duration], in seconds, Support float format, the execution accuracy is accurate to milliseconds.
        :param _builtins.str start: Starting time, [0 video duration], in seconds, Support float format, the execution accuracy is accurate to milliseconds.
        """
...
class MediaAnimationTemplateVideo(dict):
    ...
    def __init__(__self__, *,
                 codec: _builtins.str,
                 animate_frames_per_second: Optional[_builtins.str] = None,
                 animate_only_keep_key_frame: Optional[_builtins.str] = None,
                 animate_time_interval_of_frame: Optional[_builtins.str] = None,
                 fps: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 quality: Optional[_builtins.str] = None,
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str codec: Codec format `gif`, `webp`.
        :param _builtins.str animate_frames_per_second: Animation per second frame number, Priority: AnimateFramesPerSecond &gt; AnimateOnlyKeepKeyFrame &gt; AnimateTimeIntervalOfFrame.
        :param _builtins.str animate_only_keep_key_frame: GIFs are kept only Keyframe, Priority: AnimateFramesPerSecond &gt; AnimateOnlyKeepKeyFrame &gt; AnimateTimeIntervalOfFrame.
        :param _builtins.str animate_time_interval_of_frame: Animation frame extraction every time, (0, video duration], Animation frame extraction time interval, If TimeInterval.Duration is set, it is less than this value.
        :param _builtins.str fps: Frame rate, value range: (0, 60], Unit: fps.
        :param _builtins.str height: High, value range: [128, 4096], Unit: px, If only Height is set, Width is calculated according to the original ratio of the video, must be even.
        :param _builtins.str quality: Set relative quality, [1, 100), webp image quality setting takes effect, gif has no quality parameter.
        :param _builtins.str width: width, value range: [128, 4096], Unit: px, If only Width is set, Height is calculated according to the original ratio of the video, must be even.
        """
    ...
    def animate_frames_per_second(self) -> Optional[_builtins.str]:
        """
    ...
    def animate_only_keep_key_frame(self) -> Optional[_builtins.str]:
        """
    ...
    def animate_time_interval_of_frame(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def fps(self) -> Optional[_builtins.str]:
        """
...
class MediaConcatTemplateConcatTemplateAudio(dict):
    def __init__(__self__, *,
                 codec: _builtins.str,
                 bitrate: Optional[_builtins.str] = None,
                 channels: Optional[_builtins.str] = None,
                 samplerate: Optional[_builtins.str] = None):
        """
        :param _builtins.str codec: Codec format, value aac, mp3.
        :param _builtins.str bitrate: Original audio bit rate, unit: Kbps, Value range: [8, 1000].
        :param _builtins.str channels: number of channels- When Codec is set to aac, support 1, 2, 4, 5, 6, 8- When Codec is set to mp3, support 1, 2.
        :param _builtins.str samplerate: Sampling Rate- Unit: Hz- Optional 11025, 22050, 32000, 44100, 48000, 96000- Different packages, mp3 supports different sampling rates, as shown in the table below.
        """
        pulumi.set(__self__, "codec", codec)
    ...
    @_builtins.property
    @pulumi.getter
    def bitrate(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def samplerate(self) -> Optional[_builtins.str]:
        """
...
class MediaConcatTemplateConcatTemplateAudioMix(dict):
    ...
    def __init__(__self__, *,
                 audio_source: _builtins.str,
                 effect_config: Optional['outputs.MediaConcatTemplateConcatTemplateAudioMixEffectConfig'] = None,
                 mix_mode: Optional[_builtins.str] = None,
                 replace: Optional[_builtins.str] = None):
        """
        :param _builtins.str audio_source: The media address of the audio track that needs to be mixed.
        :param 'MediaConcatTemplateConcatTemplateAudioMixEffectConfigArgs' effect_config: Mix Fade Configuration.
        :param _builtins.str mix_mode: Mixing mode Repeat: background sound loop, Once: The background sound is played once.
        :param _builtins.str replace: Whether to replace the original audio of the Input media file with the mixed audio track media.
        """
    ...
    def audio_source(self) -> _builtins.str:
        """
    ...
    def mix_mode(self) -> Optional[_builtins.str]:
        """
...
class MediaConcatTemplateConcatTemplateAudioMixEffectConfig(dict):
    ...
    def __init__(__self__, *,
                 bgm_fade_time: Optional[_builtins.str] = None,
                 enable_bgm_fade: Optional[_builtins.str] = None,
                 enable_end_fadeout: Optional[_builtins.str] = None,
                 enable_start_fadein: Optional[_builtins.str] = None,
                 end_fadeout_time: Optional[_builtins.str] = None,
                 start_fadein_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str bgm_fade_time: bgm transition fade-in duration, support floating point numbers.
        :param _builtins.str enable_bgm_fade: Enable bgm conversion fade in.
        :param _builtins.str enable_end_fadeout: enable fade out.
        :param _builtins.str enable_start_fadein: enable fade in.
        :param _builtins.str end_fadeout_time: fade out time, greater than 0, support floating point numbers.
        :param _builtins.str start_fadein_time: Fade in duration, greater than 0, support floating point numbers.
        """
    ...
    def bgm_fade_time(self) -> Optional[_builtins.str]:
        """
    ...
    def enable_bgm_fade(self) -> Optional[_builtins.str]:
        """
    ...
    def enable_end_fadeout(self) -> Optional[_builtins.str]:
        """
        enable fade out.
        """
    ...
    def enable_start_fadein(self) -> Optional[_builtins.str]:
        """
        enable fade in.
        """
    ...
    def end_fadeout_time(self) -> Optional[_builtins.str]:
        """
    ...
    def start_fadein_time(self) -> Optional[_builtins.str]:
        """
...
class MediaConcatTemplateConcatTemplateConcatFragment(dict):
    def __init__(__self__, *,
                 ...
                 url: _builtins.str):
        """
        :param _builtins.str mode: node type, `start`, `end`.
        :param _builtins.str url: Splicing object address.
        """
...
class MediaConcatTemplateConcatTemplateContainer(dict):
    def __init__(__self__, *,
                 format: _builtins.str):
        """
        :param _builtins.str format: Container format: mp4, flv, hls, ts, mp3, aac.
        """
        pulumi.set(__self__, "format", format)
...
class MediaConcatTemplateConcatTemplateVideo(dict):
    def __init__(__self__, *,
                 codec: _builtins.str,
                 bitrate: Optional[_builtins.str] = None,
                 crf: Optional[_builtins.str] = None,
                 fps: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 remove: Optional[_builtins.str] = None,
                 rotate: Optional[_builtins.str] = None,
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str codec: Codec format `H.264`.
        :param _builtins.str bitrate: Original audio bit rate, unit: Kbps, Value range: [8, 1000].
        :param _builtins.str crf: Bit rate-quality control factor, value range: (0, 51], If Crf is set, the setting of Bitrate will be invalid, When Bitrate is empty, the default is 25.
        :param _builtins.str fps: Frame rate, value range: (0, 60], Unit: fps.
        :param _builtins.str height: High, value range: [128, 4096], Unit: px, If only Height is set, Width is calculated according to the original ratio of the video, must be even.
        :param _builtins.str remove: Whether to delete the source audio stream, the value is true, false.
        :param _builtins.str rotate: Rotation angle, Value range: [0, 360), Unit: degree.
        :param _builtins.str width: width, value range: [128, 4096], Unit: px, If only Width is set, Height is calculated according to the original ratio of the video, must be even.
        """
        pulumi.set(__self__, "codec", codec)
        if bitrate is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def crf(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def remove(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rotate(self) -> Optional[_builtins.str]:
        """
...
class MediaPicProcessTemplatePicProcess(dict):
    ...
    def __init__(__self__, *,
                 process_rule: _builtins.str,
                 is_pic_info: Optional[_builtins.str] = None):
        """
        :param _builtins.str process_rule: Image processing rules, 1: basic image processing, please refer to the basic image processing document, 2: image compression, please refer to the image compression document, 3: blind watermark, please refer to the blind watermark document.
        :param _builtins.str is_pic_info: Whether to return the original image information.
        """
    ...
    def process_rule(self) -> _builtins.str:
        """
    ...
    def is_pic_info(self) -> Optional[_builtins.str]:
        """
...
class MediaSmartCoverTemplateSmartCover(dict):
    ...
    def __init__(__self__, *,
                 ...
                 delete_duplicates: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str format: Image Format, value jpg, png, webp.
        :param _builtins.str count: Number of screenshots, [1,10].
        :param _builtins.str delete_duplicates: cover deduplication, true/false.
        :param _builtins.str height: Height, value range: [128, 4096], unit: px, if only Height is set, Width is calculated according to the original video ratio.
        :param _builtins.str width: Width, value range: [128, 4096], unit: px, if only Width is set, Height is calculated according to the original ratio of the video.
        """
        pulumi.set(__self__, "format", format)
    ...
    def delete_duplicates(self) -> Optional[_builtins.str]:
        """
...
class MediaSnapshotTemplateSnapshot(dict):
    ...
    def __init__(__self__, *,
                 count: _builtins.str,
                 black_level: Optional[_builtins.str] = None,
                 ci_param: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 is_check_black: Optional[_builtins.str] = None,
                 is_check_count: Optional[_builtins.str] = None,
                 mode: Optional[_builtins.str] = None,
                 pixel_black_threshold: Optional[_builtins.str] = None,
                 snapshot_out_mode: Optional[_builtins.str] = None,
                 ...
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str count: Number of screenshots, range (0 10000].
        :param _builtins.str black_level: Screenshot black screen detection parameters, Valid when IsCheckBlack=true, Value reference range [30, 100], indicating the proportion of black pixels, the smaller the value, the smaller the proportion of black pixels, Start&gt;0, the parameter setting is invalid, no filter black screen, Start =0 parameter is valid, the start time of the frame capture is the first frame non-black screen start.
        :param _builtins.str ci_param: Screenshot image processing parameters, for example: imageMogr2/format/png.
        :param _builtins.str height: high, value range: [128, 4096], Unit: px, If only Height is set, Width is calculated according to the original ratio of the video.
        :param _builtins.str is_check_black: Whether to enable black screen detection true/false.
        :param _builtins.str is_check_count: Whether to check the number of screenshots forcibly, when using custom interval mode to take screenshots, the video time is not long enough to capture Count screenshots, you can switch to average screenshot mode to capture Count screenshots.
        :param _builtins.str mode: Screenshot mode, value range: {Interval, Average, KeyFrame}- Interval means interval mode Average means average mode- KeyFrame represents the key frame mode- Interval mode: Start, TimeInterval, The Count parameter takes effect. When Count is set and TimeInterval is not set, Indicates to capture all frames, a total of Count pictures- Average mode: Start, the Count parameter takes effect. express.
        :param _builtins.str pixel_black_threshold: Screenshot black screen detection parameters, Valid when IsCheckBlack=true, The threshold for judging whether a pixel is a black point, value range: [0, 255].
        :param _builtins.str snapshot_out_mode: Screenshot output mode parameters, Value range: {OnlySnapshot, OnlySprite, SnapshotAndSprite}, OnlySnapshot means output only screenshot mode OnlySprite means only output sprite mode SnapshotAndSprite means output screenshot and sprite mode.
        :param 'MediaSnapshotTemplateSnapshotSpriteSnapshotConfigArgs' sprite_snapshot_config: Screenshot output configuration.
        :param _builtins.str start: Starting time, [0 video duration] in seconds, Support float format, the execution accuracy is accurate to milliseconds.
        :param _builtins.str time_interval: Screenshot time interval, (0 3600], in seconds, Support float format, the execution accuracy is accurate to milliseconds.
        :param _builtins.str width: wide, value range: [128, 4096], Unit: px, If only Width is set, Height is calculated according to the original ratio of the video.
        """
        pulumi.set(__self__, "count", count)
    ...
    def black_level(self) -> Optional[_builtins.str]:
        """
    ...
    def ci_param(self) -> Optional[_builtins.str]:
        """
    ...
    def is_check_black(self) -> Optional[_builtins.str]:
        """
    ...
    def is_check_count(self) -> Optional[_builtins.str]:
        """
    ...
    def pixel_black_threshold(self) -> Optional[_builtins.str]:
        """
    ...
    def snapshot_out_mode(self) -> Optional[_builtins.str]:
        """
...
class MediaSnapshotTemplateSnapshotSpriteSnapshotConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lines: _builtins.str,
                 cell_height: Optional[_builtins.str] = None,
                 cell_width: Optional[_builtins.str] = None,
                 margin: Optional[_builtins.str] = None,
                 padding: Optional[_builtins.str] = None):
        """
        :param _builtins.str color: See `https://www.ffmpeg.org/ffmpeg-utils.html#color-syntax` for details on supported colors.
        :param _builtins.str columns: Number of screenshot columns, value range: [1, 10000].
        :param _builtins.str lines: Number of screenshot lines, value range: [1, 10000].
        :param _builtins.str cell_height: Single image height Value range: [8, 4096], Unit: px.
        :param _builtins.str cell_width: Single image width Value range: [8, 4096], Unit: px.
        :param _builtins.str margin: screenshot margin size, Value range: [8, 4096], Unit: px.
        :param _builtins.str padding: screenshot padding size, Value range: [8, 4096], Unit: px.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def columns(self) -> _builtins.str:
        """
    ...
    def cell_height(self) -> Optional[_builtins.str]:
        """
    ...
    def cell_width(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def margin(self) -> Optional[_builtins.str]:
        """
...
class MediaSpeechRecognitionTemplateSpeechRecognition(dict):
    ...
    def __init__(__self__, *,
                 channel_num: _builtins.str,
                 engine_model_type: _builtins.str,
                 convert_num_mode: Optional[_builtins.str] = None,
                 filter_dirty: Optional[_builtins.str] = None,
                 filter_modal: Optional[_builtins.str] = None,
                 filter_punc: Optional[_builtins.str] = None,
                 output_file_type: Optional[_builtins.str] = None,
                 res_text_format: Optional[_builtins.str] = None,
                 speaker_diarization: Optional[_builtins.str] = None,
                 speaker_number: Optional[_builtins.str] = None):
        """
        :param _builtins.str channel_num: Number of voice channels: 1 means mono. EngineModelType supports only mono for non-telephone scenarios, and 2 means dual channels (only 8k_zh engine model supports dual channels, which should correspond to both sides of the call).
        :param _builtins.str engine_model_type: Engine model type, divided into phone scene and non-phone scene, phone scene: 8k_zh: phone 8k Chinese Mandarin general (can be used for dual-channel audio), 8k_zh_s: phone 8k Chinese Mandarin speaker separation (only for monophonic audio), 8k_en: Telephone 8k English; non-telephone scene: 16k_zh: 16k Mandarin Chinese, 16k_zh_video: 16k audio and video field, 16k_en: 16k English, 16k_ca: 16k Cantonese, 16k_ja: 16k Japanese, 16k_zh_edu: Chinese education, 16k_en_edu: English education, 16k_zh_medical: medical, 16k_th: Thai, 16k_zh_dialect: multi-dialect, supports 23 dialects.
        :param _builtins.str convert_num_mode: Whether to perform intelligent conversion of Arabic numerals (currently supports Mandarin Chinese engine): 0 means no conversion, directly output Chinese numbers, 1 means intelligently convert to Arabic numerals according to the scene, 3 means enable math-related digital conversion, the default value is 0.
        :param _builtins.str filter_dirty: Whether to filter dirty words (currently supports Mandarin Chinese engine): 0 means not to filter dirty words, 1 means to filter dirty words, 2 means to replace dirty words with *, the default value is 0.
        :param _builtins.str filter_modal: Whether to pass modal particles (currently supports Mandarin Chinese engine): 0 means not to filter modal particles, 1 means partial filtering, 2 means strict filtering, and the default value is 0.
        :param _builtins.str filter_punc: Whether to filter punctuation (currently supports Mandarin Chinese engine): 0 means no filtering, 1 means filtering end-of-sentence punctuation, 2 means filtering all punctuation, the default value is 0.
        :param _builtins.str output_file_type: Output file type, optional txt, srt. The default is txt.
        :param _builtins.str res_text_format: Recognition result return form: 0 means the recognition result text (including segmented time stamps), 1 is the detailed recognition result at the word level granularity, without punctuation, and includes the speech rate value (a list of word time stamps, generally used to generate subtitle scenes), 2 Detailed recognition results at word-level granularity (including punctuation and speech rate values)..
        :param _builtins.str speaker_diarization: Whether to enable speaker separation: 0 means not enabled, 1 means enabled (only supports 8k_zh, 16k_zh, 16k_zh_video, monophonic audio), the default value is 0, Note: 8K telephony scenarios suggest using dual-channel to distinguish between the two parties, set ChannelNum=2 is enough, no need to enable speaker separation.
        :param _builtins.str speaker_number: The number of speakers to be separated (need to be used in conjunction with enabling speaker separation), value range: 0-10, 0 means automatic separation (currently only supports <= 6 people), 1-10 represents the number of specified speakers to be separated. The default value is 0.
        """
    ...
    def channel_num(self) -> _builtins.str:
        """
    ...
    def engine_model_type(self) -> _builtins.str:
        """
        Engine model type, divided into phone scene and non-phone scene, phone scene: 8k_zh: phone 8k Chinese Mandarin general (can be used for dual-channel audio), 8k_zh_s: phone 8k Chinese Mandarin speaker separation (only for monophonic audio), 8k_en: Telephone 8k English; non-telephone scene: 16k_zh: 16k Mandarin Chinese, 16k_zh_video: 16k audio and video field, 16k_en: 16k English, 16k_ca: 16k Cantonese, 16k_ja: 16k Japanese, 16k_zh_edu: Chinese education, 16k_en_edu: English education, 16k_zh_medical: medical, 16k_th: Thai, 16k_zh_dialect: multi-dialect, supports 23 dialects.
        """
    ...
    def convert_num_mode(self) -> Optional[_builtins.str]:
        """
    ...
    def filter_dirty(self) -> Optional[_builtins.str]:
        """
    ...
    def filter_modal(self) -> Optional[_builtins.str]:
        """
    ...
    def filter_punc(self) -> Optional[_builtins.str]:
        """
    ...
    def output_file_type(self) -> Optional[_builtins.str]:
        """
    ...
    def res_text_format(self) -> Optional[_builtins.str]:
        """
    ...
    def speaker_diarization(self) -> Optional[_builtins.str]:
        """
    ...
    def speaker_number(self) -> Optional[_builtins.str]:
        """
...
class MediaTranscodeProTemplateAudio(dict):
    def __init__(__self__, *,
                 ...
                 remove: Optional[_builtins.str] = None):
        """
        :param _builtins.str codec: Codec format, value aac, mp3, flac, amr, Vorbis, opus, pcm_s16le.
        :param _builtins.str remove: Whether to delete the source audio stream, the value is true, false.
        """
        pulumi.set(__self__, "codec", codec)
        if remove is not None:
...
class MediaTranscodeProTemplateContainerClipConfig(dict):
    def __init__(__self__, *,
                 duration: Optional[_builtins.str] = None):
        """
        :param _builtins.str duration: Fragmentation duration, default 5s.
        """
        if duration is not None:
            pulumi.set(__self__, "duration", duration)
...
class MediaTranscodeProTemplateTransConfig(dict):
    ...
    def __init__(__self__, *,
                 adj_dar_method: Optional[_builtins.str] = None,
                 audio_bitrate_adj_method: Optional[_builtins.str] = None,
                 delete_metadata: Optional[_builtins.str] = None,
                 is_check_audio_bitrate: Optional[_builtins.str] = None,
                 is_check_reso: Optional[_builtins.str] = None,
                 is_check_video_bitrate: Optional[_builtins.str] = None,
                 is_hdr2_sdr: Optional[_builtins.str] = None,
                 reso_adj_method: Optional[_builtins.str] = None,
                 video_bitrate_adj_method: Optional[_builtins.str] = None):
        """
        :param _builtins.str adj_dar_method: Resolution adjustment method, value scale, crop, pad, none, When the aspect ratio of the output video is different from the original video, adjust the resolution accordingly according to this parameter.
        :param _builtins.str audio_bitrate_adj_method: Audio bit rate adjustment mode, value 0, 1; when the output audio bit rate is greater than the original audio bit rate, 0 means use the original audio bit rate; 1 means return transcoding failed, Take effect when IsCheckAudioBitrate is true.
        :param _builtins.str delete_metadata: Whether to delete the MetaData information in the file, true, false, When false, keep source file information.
        :param _builtins.str is_check_audio_bitrate: Whether to check the audio code rate, true, false, When false, transcode according to configuration parameters.
        :param _builtins.str is_check_reso: Whether to check the resolution, when it is false, transcode according to the configuration parameters.
        :param _builtins.str is_check_video_bitrate: Whether to check the video code rate, when it is false, transcode according to the configuration parameters.
        :param _builtins.str is_hdr2_sdr: Whether to enable HDR to SDR true, false.
        :param _builtins.str reso_adj_method: Resolution adjustment mode, value 0, 1; 0 means use the original video resolution; 1 means return transcoding failed, Take effect when IsCheckReso is true.
        :param _builtins.str video_bitrate_adj_method: Video bit rate adjustment method, value 0, 1; when the output video bit rate is greater than the original video bit rate, 0 means use the original video bit rate; 1 means return transcoding failed, Take effect when IsCheckVideoBitrate is true.
        """
    ...
    def adj_dar_method(self) -> Optional[_builtins.str]:
        """
    ...
    def audio_bitrate_adj_method(self) -> Optional[_builtins.str]:
        """
    ...
    def delete_metadata(self) -> Optional[_builtins.str]:
        """
    ...
    def is_check_audio_bitrate(self) -> Optional[_builtins.str]:
        """
    ...
    def is_check_reso(self) -> Optional[_builtins.str]:
        """
    ...
    def is_check_video_bitrate(self) -> Optional[_builtins.str]:
        """
    ...
    def is_hdr2_sdr(self) -> Optional[_builtins.str]:
        """
    ...
    def reso_adj_method(self) -> Optional[_builtins.str]:
        """
    ...
    def video_bitrate_adj_method(self) -> Optional[_builtins.str]:
        """
...
class MediaTranscodeProTemplateVideo(dict):
    def __init__(__self__, *,
                 ...
                 fps: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 interlaced: Optional[_builtins.str] = None,
                 profile: Optional[_builtins.str] = None,
                 rotate: Optional[_builtins.str] = None,
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str bitrate: Bit rate of video output file, value range: [10, 50000], unit: Kbps, auto means adaptive bit rate.
        :param _builtins.str codec: Codec format, default value: `H.264`, when format is WebM, it is VP8, value range: `H.264`, `H.265`, `VP8`, `VP9`, `AV1`.
        :param _builtins.str fps: Frame rate, value range: (0, 60], Unit: fps.
        :param _builtins.str height: High, value range: [128, 4096], Unit: px, If only Height is set, Width is calculated according to the original ratio of the video, must be even.
        :param _builtins.str interlaced: field pattern.
        :param _builtins.str profile: encoding level, Support baseline, main, high, auto- When Pixfmt is auto, this parameter can only be set to auto, when it is set to other options, the parameter value will be set to auto- baseline: suitable for mobile devices- main: suitable for standard resolution devices- high: suitable for high-resolution devices- Only H.264 supports this parameter.
        :param _builtins.str rotate: Rotation angle, Value range: [0, 360), Unit: degree.
        :param _builtins.str width: width, value range: [128, 4096], Unit: px, If only Width is set, Height is calculated according to the original ratio of the video, must be even.
        """
        if bitrate is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def interlaced(self) -> Optional[_builtins.str]:
        """
        field pattern.
        """
...
class MediaTranscodeTemplateAudio(dict):
    ...
    def __init__(__self__, *,
                 ...
                 channels: Optional[_builtins.str] = None,
                 codec: Optional[_builtins.str] = None,
                 keep_two_tracks: Optional[_builtins.str] = None,
                 remove: Optional[_builtins.str] = None,
                 sample_format: Optional[_builtins.str] = None,
                 samplerate: Optional[_builtins.str] = None,
                 switch_track: Optional[_builtins.str] = None):
        """
        :param _builtins.str bitrate: Original audio bit rate, unit: Kbps, Value range: [8, 1000].
        :param _builtins.str channels: number of channels- When Codec is set to aac/flac, support 1, 2, 4, 5, 6, 8- When Codec is set to mp3/opus, support 1, 2- When Codec is set to Vorbis, only 2 is supported- When Codec is set to amr, only 1 is supported- When Codec is set to pcm_s16le, only 1 and 2 are supported- When the encapsulation format is dash, 8 is not supported.
        :param _builtins.str codec: Codec format, value aac, mp3, flac, amr, Vorbis, opus, pcm_s16le.
        :param _builtins.str keep_two_tracks: Keep dual audio tracks, the value is true, false. This parameter is invalid when Video.Codec is H.265.
        :param _builtins.str remove: Whether to delete the source audio stream, the value is true, false.
        :param _builtins.str sample_format: Sampling bit width- When Codec is set to aac, support fltp- When Codec is set to mp3, fltp, s16p, s32p are supported- When Codec is set to flac, s16, s32, s16p, s32p are supported- When Codec is set to amr, support s16, s16p- When Codec is set to opus, support s16- When Codec is set to pcm_s16le, support s16- When Codec is set to Vorbis, support fltp- This parameter is invalid when Video.Codec is H.265.
        :param _builtins.str samplerate: Sampling Rate- Unit: Hz- Optional 8000, 11025, 12000, 16000, 22050, 24000, 32000, 44100, 48000, 88200, 96000- Different packages, mp3 supports different sampling rates, as shown in the table below- When Codec is set to amr, only 8000 is supported- When Codec is set to opus, it supports 8000, 16000, 24000, 48000.
        :param _builtins.str switch_track: Convert track, the value is true, false. This parameter is invalid when Video.Codec is H.265.
        """
        if bitrate is not None:
            pulumi.set(__self__, "bitrate", bitrate)
        if channels is not None:
    ...
    def keep_two_tracks(self) -> Optional[_builtins.str]:
        """
    ...
    def sample_format(self) -> Optional[_builtins.str]:
        """
    ...
    def switch_track(self) -> Optional[_builtins.str]:
        """
...
class MediaTranscodeTemplateTransConfigHlsEncrypt(dict):
    ...
    def __init__(__self__, *,
                 is_hls_encrypt: Optional[_builtins.str] = None,
                 uri_key: Optional[_builtins.str] = None):
        """
        :param _builtins.str is_hls_encrypt: Whether to enable HLS encryption, support encryption when Container.Format is hls.
        :param _builtins.str uri_key: HLS encrypted key, this parameter is only meaningful when IsHlsEncrypt is true.
        """
    ...
    def is_hls_encrypt(self) -> Optional[_builtins.str]:
        """
...
class MediaTranscodeTemplateVideo(dict):
    ...
    def __init__(__self__, *,
                 bitrate: Optional[_builtins.str] = None,
                 bufsize: Optional[_builtins.str] = None,
                 codec: Optional[_builtins.str] = None,
                 crf: Optional[_builtins.str] = None,
                 fps: Optional[_builtins.str] = None,
                 gop: Optional[_builtins.str] = None,
                 height: Optional[_builtins.str] = None,
                 long_short_mode: Optional[_builtins.str] = None,
                 maxrate: Optional[_builtins.str] = None,
                 pixfmt: Optional[_builtins.str] = None,
        ...
        """
        :param _builtins.str bitrate: Bit rate of video output file, value range: [10, 50000], unit: Kbps, auto means adaptive bit rate.
        :param _builtins.str bufsize: buffer size, Value range: [1000, 128000], Unit: Kb, This parameter is not supported when Codec is VP8/VP9.
        :param _builtins.str codec: Codec format, default value: `H.264`, when format is WebM, it is VP8, value range: `H.264`, `H.265`, `VP8`, `VP9`, `AV1`.
        :param _builtins.str crf: Bit rate-quality control factor, value range: (0, 51], If Crf is set, the setting of Bitrate will be invalid, When Bitrate is empty, the default is 25.
        :param _builtins.str fps: Frame rate, value range: (0, 60], Unit: fps.
        :param _builtins.str gop: The maximum number of frames between key frames, value range: [1, 100000].
        :param _builtins.str height: High, value range: [128, 4096], Unit: px, If only Height is set, Width is calculated according to the original ratio of the video, must be even.
        :param _builtins.str long_short_mode: Adaptive length,true, false, This parameter is not supported when Codec is VP8/VP9/AV1.
        :param _builtins.str maxrate: Peak video bit rate, Value range: [10, 50000], Unit: Kbps, This parameter is not supported when Codec is VP8/VP9.
        :param _builtins.str pixfmt: video color format, H.264 support: yuv420p, yuv422p, yuv444p, yuvj420p, yuvj422p, yuvj444p, auto, H.265 support: yuv420p, yuv420p10le, auto, This parameter is not supported when Codec is VP8/VP9/AV1.
        :param _builtins.str preset: Video Algorithm Presets- H.264 supports this parameter, the values are veryfast, fast, medium, slow, slower- VP8 supports this parameter, the value is good, realtime- AV1 supports this parameter, the value is 5 (recommended value), 4- H.265 and VP9 do not support this parameter.
        :param _builtins.str profile: encoding level, Support baseline, main, high, auto- When Pixfmt is auto, this parameter can only be set to auto, when it is set to other options, the parameter value will be set to auto- baseline: suitable for mobile devices- main: suitable for standard resolution devices- high: suitable for high-resolution devices- Only H.264 supports this parameter.
        :param _builtins.str remove: Whether to delete the video stream, true, false.
        :param _builtins.str rotate: Rotation angle, Value range: [0, 360), Unit: degree.
        :param _builtins.str width: width, value range: [128, 4096], Unit: px, If only Width is set, Height is calculated according to the original ratio of the video, must be even.
        """
        if bitrate is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def bufsize(self) -> Optional[_builtins.str]:
        """
    ...
    def long_short_mode(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def maxrate(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def pixfmt(self) -> Optional[_builtins.str]:
        """
...
class MediaVideoMontageTemplateContainer(dict):
    def __init__(__self__, *,
                 format: _builtins.str):
        """
        :param _builtins.str format: Container format: mp4, flv, hls, ts, mkv.
        """
        pulumi.set(__self__, "format", format)
...
class MediaVideoProcessTemplateColorEnhance(dict):
    def __init__(__self__, *,
                 ...
                 correction: Optional[_builtins.str] = None,
                 enable: Optional[_builtins.str] = None,
                 saturation: Optional[_builtins.str] = None):
        """
        :param _builtins.str contrast: Contrast, value range: [0, 100], empty string (indicates automatic analysis).
        :param _builtins.str correction: colorcorrection, value range: [0, 100], empty string (indicating automatic analysis).
        :param _builtins.str enable: Whether color enhancement is turned on.
        :param _builtins.str saturation: Saturation, value range: [0, 100], empty string (indicating automatic analysis).
        """
    ...
    @_builtins.property
    @pulumi.getter
    def correction(self) -> Optional[_builtins.str]:
        """
...
class MediaVideoProcessTemplateMsSharpen(dict):
    ...
    def __init__(__self__, *,
                 enable: Optional[_builtins.str] = None,
                 sharpen_level: Optional[_builtins.str] = None):
        """
        :param _builtins.str enable: Whether detail enhancement is enabled.
        :param _builtins.str sharpen_level: Enhancement level, value range: [0, 10], empty string (indicates automatic analysis).
        """
        if enable is not None:
            pulumi.set(__self__, "enable", enable)
    ...
    def sharpen_level(self) -> Optional[_builtins.str]:
        """
...
class MediaVoiceSeparateTemplateAudioConfig(dict):
    def __init__(__self__, *,
                 ...
                 samplerate: Optional[_builtins.str] = None):
        """
        :param _builtins.str codec: Codec format, value aac, mp3, flac, amr.
        :param _builtins.str bitrate: Original audio bit rate, unit: Kbps, Value range: [8, 1000].
        :param _builtins.str channels: number of channels- When Codec is set to aac/flac, support 1, 2, 4, 5, 6, 8- When Codec is set to mp3, support 1, 2- When Codec is set to amr, only 1 is supported.
        :param _builtins.str samplerate: Sampling Rate- 1: Unit: Hz- 2: Optional 8000, 11025, 22050, 32000, 44100, 48000, 96000- 3: When Codec is set to aac/flac, 8000 is not supported- 4: When Codec is set to mp3, 8000 and 96000 are not supported- 5: When Codec is set to amr, only 8000 is supported.
        """
        pulumi.set(__self__, "codec", codec)
        if bitrate is not None:
            pulumi.set(__self__, "bitrate", bitrate)
...
class MediaWatermarkTemplateWatermark(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str dx: Horizontal offset, 1: In the picture watermark, if Background is true, when locMode is Relativity, it is %, value range: [-300 0]; when locMode is Absolute, it is px, value range: [-4096 0] ], 2: In the picture watermark, if Background is false, when locMode is Relativity, it is %, value range: [0 100]; when locMode is Absolute, it is px, value range: [0 4096], 3: In text watermark, when locMode is Relativity, it is %, value range: [0 100]; when locMode is Absolute, it is px, value range: [0 4096], 4: When Pos is Top, Bottom and Center, the parameter is invalid.
        :param _builtins.str dy: Vertical offset, 1: In the picture watermark, if Background is true, when locMode is Relativity, it is %, value range: [-300 0]; when locMode is Absolute, it is px, value range: [-4096 0] ],2: In the picture watermark, if Background is false, when locMode is Relativity, it is %, value range: [0 100]; when locMode is Absolute, it is px, value range: [0 4096],3: In text watermark, when locMode is Relativity, it is %, value range: [0 100]; when locMode is Absolute, it is px, value range: [0 4096], 4: When Pos is Left, Right and Center, the parameter is invalid.
        :param _builtins.str loc_mode: Offset method, Relativity: proportional, Absolute: fixed position.
        :param _builtins.str pos: Reference position, TopRight, TopLeft, BottomRight, BottomLeft, Left, Right, Top, Bottom, Center.
        :param _builtins.str type: Watermark type, Text: text watermark, Image: image watermark.
        :param _builtins.str end_time: Watermark end time, 1: [0 video duration], 2: unit is second, 3: support float format, execution accuracy is accurate to milliseconds.
        :param 'MediaWatermarkTemplateWatermarkImageArgs' image: Image watermark node.
        :param _builtins.str start_time: Watermark start time, 1: [0 video duration], 2: unit is second, 3: support float format, execution accuracy is accurate to milliseconds.
    ...
    def loc_mode(self) -> _builtins.str:
        """
...
class MediaWatermarkTemplateWatermarkImage(dict):
    def __init__(__self__, *,
                 ...
                 mode: _builtins.str,
                 transparency: _builtins.str,
                 url: _builtins.str,
                 height: Optional[_builtins.str] = None,
                 width: Optional[_builtins.str] = None):
        """
        :param _builtins.str background: Whether the background image.
        :param _builtins.str mode: Size mode, Original: original size, Proportion: proportional, Fixed: fixed size.
        :param _builtins.str transparency: Transparency, value range: [1 100], unit %.
        :param _builtins.str url: Address of watermark map (pass in after Urlencode is required).
        :param _builtins.str height: High, 1: When the Mode is Original, it does not support setting the width of the watermark image, 2: When the Mode is Proportion, the unit is %, the value range of the background image: [100 300]; the value range of the foreground image: [1 100], relative to Video width, up to 4096px, 3: When Mode is Fixed, the unit is px, value range: [8, 4096], 4: If only Width is set, Height is calculated according to the proportion of the watermark image.
    ...
    @_builtins.property
    @pulumi.getter
    def background(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def transparency(self) -> _builtins.str:
        """
...
class MediaWatermarkTemplateWatermarkText(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transparency: _builtins.str):
        """
        :param _builtins.str font_color: Font color, format: 0xRRGGBB.
        :param _builtins.str font_size: Font size, value range: [5 100], unit px.
        :param _builtins.str font_type: font type.
        :param _builtins.str text: Watermark content, the length does not exceed 64 characters, only supports Chinese, English, numbers, _, - and *.
        :param _builtins.str transparency: Transparency, value range: [1 100], unit %.
        """
