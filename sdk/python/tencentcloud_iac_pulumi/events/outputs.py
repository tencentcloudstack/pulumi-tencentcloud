...
class AuditTrackFilters(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in AuditTrackFilters. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        ...
        *,
        resource_fields: (
            Sequence["outputs.AuditTrackFiltersResourceField"] | None
        ) = None,
    ):
        """
...
class AuditTrackFiltersResourceField(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in AuditTrackFiltersResourceField. Access the value via the '{suggest}' property getter instead."
            )
...
class AuditTrackStorage(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(
                f"Key '{key}' not found in AuditTrackStorage. Access the value via the '{suggest}' property getter instead."
            )
    ...
    def __init__(
        ...
        *,
        ...
        :param _builtins.str storage_type: Storage type (Valid values: cos, cls, ckafka).
