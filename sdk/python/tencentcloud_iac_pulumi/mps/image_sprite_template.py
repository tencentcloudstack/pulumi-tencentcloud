...
class ImageSpriteTemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.int] column_count: The number of columns in the small image in the sprite.
        :param pulumi.Input[_builtins.int] row_count: The number of rows in the small image in the sprite.
        :param pulumi.Input[_builtins.int] sample_interval: Sampling interval.When SampleType is Percent, specify the percentage of the sampling interval.When SampleType is Time, specify the sampling interval time in seconds.
        :param pulumi.Input[_builtins.str] sample_type: Sampling type, optional value:Percent/Time.
        ...
        :param pulumi.Input[_builtins.str] format: Image format, the value can be jpg, png, webp. Default is jpg.
        :param pulumi.Input[_builtins.int] height: The maximum value of the height (or short side) of the small image in the sprite image, value range: 0 and [128, 4096], unit: px.When Width and Height are both 0, the resolution is the same.When Width is 0 and Height is not 0, Width is scaled proportionally.When Width is not 0 and Height is 0, Height is scaled proportionally.When both Width and Height are not 0, the resolution is specified by the user.Default value: 0.
        :param pulumi.Input[_builtins.str] name: Image sprite template name, length limit: 64 characters.
        ...
        :param pulumi.Input[_builtins.int] width: The maximum value of the width (or long side) of the small image in the sprite image, value range: 0 and [128, 4096], unit: px.When Width and Height are both 0, the resolution is the same.When Width is 0 and Height is not 0, Width is scaled proportionally.When Width is not 0 and Height is 0, Height is scaled proportionally.When both Width and Height are not 0, the resolution is specified by the user.Default value: 0.
        """
...
@pulumi.type_token("tencentcloud:Mps/imageSpriteTemplate:ImageSpriteTemplate")
class ImageSpriteTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        image_sprite_template = tencentcloud.mps.ImageSpriteTemplate("image_sprite_template",
            column_count=10,
            fill_type="stretch",
            format="jpg",
            height=143,
