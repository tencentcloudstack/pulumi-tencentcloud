...
class GetSchedulesResult:
    ...
    def schedule_ids(self) -> Sequence[_builtins.int] | None:
        return pulumi.get(self, "schedule_ids")

    @_builtins.property
    @pulumi.getter(name="scheduleInfoSets")
    def schedule_info_sets(
        self,
    ) -> Sequence["outputs.GetSchedulesScheduleInfoSetResult"]:
        """
    ...
    def trigger_type(self) -> _builtins.str | None:
...
def get_schedules(
    ...
    schedule_ids: Sequence[_builtins.int] | None = None,
    status: _builtins.str | None = None,
    trigger_type: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Mps/getSchedules:getSchedules",
        __args__,
        opts=opts,
        typ=GetSchedulesResult,
    ).value
...
def get_schedules_output(
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    schedule_ids: pulumi.Input[Sequence[_builtins.int] | None] = None,
...
) -> pulumi.Output[GetSchedulesResult]:
    """
    Use this data source to query detailed information of mps schedules
    ...
    return __ret__.apply(
        lambda __response__: GetSchedulesResult(
