...
__all__ = ["EnableWorkflowConfig", "EnableWorkflowConfigArgs"]
...
class _EnableWorkflowConfigState:
    def __init__(
        ...
        *,
        ...
        workflow_id: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="workflowId")
    def workflow_id(self) -> pulumi.Input[_builtins.int | None]:
        """
        Workflow ID.
        """
        return pulumi.get(self, "workflow_id")
    ...
    @workflow_id.setter
    def workflow_id(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "workflow_id", value)
...
class EnableWorkflowConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        config = tencentcloud.mps.EnableWorkflowConfig("config",
            workflow_id=example.id.apply(lambda x: int(x)),
            enabled=True)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            EnableWorkflowConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
