...
__all__ = ["WordSample", "WordSampleArgs"]
...
class _WordSampleState:
    ...
    @_builtins.property
    @pulumi.getter
    def keyword(self) -> pulumi.Input[_builtins.str | None]:
        """
        Keyword. Length limit: 20 characters.
        """
        return pulumi.get(self, "keyword")
    ...
    @keyword.setter
    def keyword(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "keyword", value)
...
class WordSample(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            WordSampleArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Mps/wordSample:WordSample", resource_name, __props__, opts
        )
