...
class AdaptiveDynamicStreamingTemplateArgs:
    def __init__(
        ...
        *,
        ...
        disable_higher_video_bitrate: pulumi.Input[_builtins.int | None] = None,
        disable_higher_video_resolution: pulumi.Input[_builtins.int | None] = None,
        name: pulumi.Input[_builtins.str | None] = None,
        pure_audio: pulumi.Input[_builtins.int | None] = None,
    ...
    def disable_higher_video_bitrate(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def disable_higher_video_bitrate(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "disable_higher_video_bitrate", value)

    @_builtins.property
    @pulumi.getter(name="disableHigherVideoResolution")
    def disable_higher_video_resolution(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def pure_audio(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    @pure_audio.setter
    def pure_audio(self, value: pulumi.Input[_builtins.int | None]):
...
class AdaptiveDynamicStreamingTemplate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="disableHigherVideoBitrate")
    def disable_higher_video_bitrate(self) -> pulumi.Output[_builtins.int | None]:
        """
        Whether to prohibit video from low bit rate to high bit rate, value range:0: no.1: yes.Default value: 0.
        """
        return pulumi.get(self, "disable_higher_video_bitrate")
    ...
    @_builtins.property
    @pulumi.getter(name="disableHigherVideoResolution")
    def disable_higher_video_resolution(self) -> pulumi.Output[_builtins.int | None]:
        """
        Whether to prohibit the conversion of video resolution to high resolution, value range:0: no.1: yes.Default value: 0.
        """
        return pulumi.get(self, "disable_higher_video_resolution")
