...
def get_parse_live_stream_process_notification(content: Optional[_builtins.str] = None,
    ...
    :param _builtins.str content: Live stream event notification obtained from CMQ.
...
def get_parse_live_stream_process_notification_output(content: Optional[pulumi.Input[_builtins.str]] = None,
                                                      result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetParseLiveStreamProcessNotificationResult]:
    """
    Use this data source to query detailed information of mps parse_live_stream_process_notification
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Mps/getParseLiveStreamProcessNotification:getParseLiveStreamProcessNotification', __args__, opts=opts, typ=GetParseLiveStreamProcessNotificationResult)
    return __ret__.apply(lambda __response__: GetParseLiveStreamProcessNotificationResult(
