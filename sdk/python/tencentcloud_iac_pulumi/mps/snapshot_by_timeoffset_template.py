...
class SnapshotByTimeoffsetTemplateArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] name: Snapshot by timeoffset template name, length limit: 64 characters.
...
class SnapshotByTimeoffsetTemplate(pulumi.CustomResource):
    ...
    def __init__(
        ...
        snapshot_by_timeoffset_template = tencentcloud.mps.SnapshotByTimeoffsetTemplate("snapshot_by_timeoffset_template",
            fill_type="stretch",
            format="jpg",
            height=128,
            name="terraform-test",
