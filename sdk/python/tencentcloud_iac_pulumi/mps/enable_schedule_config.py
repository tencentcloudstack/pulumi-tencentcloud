...
__all__ = ["EnableScheduleConfig", "EnableScheduleConfigArgs"]
...
class EnableScheduleConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        config = tencentcloud.mps.EnableScheduleConfig("config",
            schedule_id=example.id.apply(lambda x: int(x)),
            enabled=True)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            EnableScheduleConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
