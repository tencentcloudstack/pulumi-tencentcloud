...
__all__ = ["ManageTaskOperation", "ManageTaskOperationArgs"]
...
class ManageTaskOperationArgs:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] operation_type: Operation type. Valid values:`Abort`: task termination. Notice: If the task type is live stream processing (LiveStreamProcessTask), tasks whose task status is `WAITING` or `PROCESSING` can be terminated.For other task types, only tasks whose task status is `WAITING` can be terminated.
        :param pulumi.Input[_builtins.str] task_id: Video processing task ID.
        """
...
@pulumi.type_token("tencentcloud:Mps/manageTaskOperation:ManageTaskOperation")
class ManageTaskOperation(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ManageTaskOperationArgs, pulumi.ResourceOptions, *args, **kwargs
        )
