...
class WorkflowArgs:
    def __init__(__self__, *,
                 ...
                 ai_content_review_task: pulumi.Input[Optional['WorkflowAiContentReviewTaskArgs']] = None,
                 ai_recognition_task: pulumi.Input[Optional['WorkflowAiRecognitionTaskArgs']] = None,
                 media_process_task: pulumi.Input[Optional['WorkflowMediaProcessTaskArgs']] = None,
                 output_dir: pulumi.Input[Optional[_builtins.str]] = None,
                 output_storage: pulumi.Input[Optional['WorkflowOutputStorageArgs']] = None,
                 task_notify_config: pulumi.Input[Optional['WorkflowTaskNotifyConfigArgs']] = None,
                 task_priority: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def ai_analysis_task(self, value: pulumi.Input[Optional['WorkflowAiAnalysisTaskArgs']]):
        pulumi.set(self, "ai_analysis_task", value)

    @_builtins.property
    @pulumi.getter(name="aiContentReviewTask")
    def ai_content_review_task(self) -> pulumi.Input[Optional['WorkflowAiContentReviewTaskArgs']]:
        """
    ...
    def ai_content_review_task(self, value: pulumi.Input[Optional['WorkflowAiContentReviewTaskArgs']]):
        pulumi.set(self, "ai_content_review_task", value)

    @_builtins.property
    @pulumi.getter(name="aiRecognitionTask")
    def ai_recognition_task(self) -> pulumi.Input[Optional['WorkflowAiRecognitionTaskArgs']]:
        """
    ...
    def ai_recognition_task(self, value: pulumi.Input[Optional['WorkflowAiRecognitionTaskArgs']]):
        pulumi.set(self, "ai_recognition_task", value)

    @_builtins.property
    @pulumi.getter(name="mediaProcessTask")
    def media_process_task(self) -> pulumi.Input[Optional['WorkflowMediaProcessTaskArgs']]:
        """
    ...
    def media_process_task(self, value: pulumi.Input[Optional['WorkflowMediaProcessTaskArgs']]):
    ...
    def output_storage(self, value: pulumi.Input[Optional['WorkflowOutputStorageArgs']]):
        pulumi.set(self, "output_storage", value)

    @_builtins.property
    @pulumi.getter(name="taskNotifyConfig")
    def task_notify_config(self) -> pulumi.Input[Optional['WorkflowTaskNotifyConfigArgs']]:
        """
    ...
    def task_notify_config(self, value: pulumi.Input[Optional['WorkflowTaskNotifyConfigArgs']]):
        pulumi.set(self, "task_notify_config", value)

    @_builtins.property
    @pulumi.getter(name="taskPriority")
    def task_priority(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def task_priority(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class Workflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 ai_analysis_task: pulumi.Input[Optional[Union['WorkflowAiAnalysisTaskArgs', 'WorkflowAiAnalysisTaskArgsDict']]] = None,
                 ai_content_review_task: pulumi.Input[Optional[Union['WorkflowAiContentReviewTaskArgs', 'WorkflowAiContentReviewTaskArgsDict']]] = None,
                 ai_recognition_task: pulumi.Input[Optional[Union['WorkflowAiRecognitionTaskArgs', 'WorkflowAiRecognitionTaskArgsDict']]] = None,
                 media_process_task: pulumi.Input[Optional[Union['WorkflowMediaProcessTaskArgs', 'WorkflowMediaProcessTaskArgsDict']]] = None,
                 output_dir: pulumi.Input[Optional[_builtins.str]] = None,
                 output_storage: pulumi.Input[Optional[Union['WorkflowOutputStorageArgs', 'WorkflowOutputStorageArgsDict']]] = None,
                 task_notify_config: pulumi.Input[Optional[Union['WorkflowTaskNotifyConfigArgs', 'WorkflowTaskNotifyConfigArgsDict']]] = None,
                 task_priority: pulumi.Input[Optional[_builtins.int]] = None,
                 trigger: pulumi.Input[Optional[Union['WorkflowTriggerArgs', 'WorkflowTriggerArgsDict']]] = None,
                 workflow_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            task_priority: pulumi.Input[Optional[_builtins.int]] = None,
            trigger: pulumi.Input[Optional[Union['WorkflowTriggerArgs', 'WorkflowTriggerArgsDict']]] = None,
            workflow_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'Workflow':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="taskPriority")
    def task_priority(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The priority of the workflow, the larger the value, the higher the priority, the value range is -10 to 10, and blank means 0.
        """
        return pulumi.get(self, "task_priority")
