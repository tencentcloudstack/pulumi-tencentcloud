...
class GetTargetGroupsResult:
    ...
    def target_group_name(self) -> _builtins.str | None:
        """
        Target group VPC ID.
        """
...
def get_target_groups(
    ...
    target_group_name: _builtins.str | None = None,
    ...
    rule_basic = tencentcloud.clb.ListenerRule("rule_basic",
        clb_id=clb_basic.id,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getTargetGroups:getTargetGroups",
        __args__,
        opts=opts,
        typ=GetTargetGroupsResult,
    ).value
...
def get_target_groups_output(
...
) -> pulumi.Output[GetTargetGroupsResult]:
    """
    Use this data source to query target group information.
    ...
    return __ret__.apply(
        lambda __response__: GetTargetGroupsResult(
