...
def get_listener_rules(clb_id: Optional[_builtins.str] = None,
...
def get_listener_rules_output(clb_id: Optional[pulumi.Input[_builtins.str]] = None,
                              ...
                              scheduler: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getListenerRules:getListenerRules', __args__, opts=opts, typ=GetListenerRulesResult)
