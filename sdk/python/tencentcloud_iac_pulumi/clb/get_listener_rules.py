...
class GetListenerRulesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def scheduler(self) -> _builtins.str | None:
        """
...
def get_listener_rules(
    ...
    scheduler: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getListenerRules:getListenerRules",
        __args__,
        opts=opts,
        typ=GetListenerRulesResult,
    ).value
...
def get_listener_rules_output(
...
) -> pulumi.Output[GetListenerRulesResult]:
    """
    Use this data source to query detailed information of CLB listener rule
    ...
    return __ret__.apply(
        lambda __response__: GetListenerRulesResult(
