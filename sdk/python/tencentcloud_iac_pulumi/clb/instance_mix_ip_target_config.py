...
__all__ = ["InstanceMixIpTargetConfig", "InstanceMixIpTargetConfigArgs"]
...
class InstanceMixIpTargetConfigArgs:
    def __init__(
        ...
        *,
        ...
        mix_ip_target: pulumi.Input[_builtins.bool]
    ):
        """
        The set of arguments for constructing a InstanceMixIpTargetConfig resource.

        :param pulumi.Input[_builtins.str] load_balancer_id: ID of CLB instances to be queried.
        :param pulumi.Input[_builtins.bool] mix_ip_target: False: closed True:open.
        """
    ...
    def mix_ip_target(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def mix_ip_target(self, value: pulumi.Input[_builtins.bool]):
...
class _InstanceMixIpTargetConfigState:
    def __init__(
        ...
        *,
        ...
        mix_ip_target: pulumi.Input[_builtins.bool | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mixIpTarget")
    def mix_ip_target(self) -> pulumi.Input[_builtins.bool | None]:
        """
        False: closed True:open.
        """
        return pulumi.get(self, "mix_ip_target")
    ...
    @mix_ip_target.setter
    def mix_ip_target(self, value: pulumi.Input[_builtins.bool | None]):
        pulumi.set(self, "mix_ip_target", value)
...
class InstanceMixIpTargetConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        instance_mix_ip_target_config = tencentcloud.clb.InstanceMixIpTargetConfig("instance_mix_ip_target_config",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            InstanceMixIpTargetConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = InstanceMixIpTargetConfigArgs.__new__(
                InstanceMixIpTargetConfigArgs
            )
    ...
    def get(
        ...
        __props__ = _InstanceMixIpTargetConfigState.__new__(
            _InstanceMixIpTargetConfigState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="mixIpTarget")
    def mix_ip_target(self) -> pulumi.Output[_builtins.bool]:
        """
        False: closed True:open.
        """
        return pulumi.get(self, "mix_ip_target")
