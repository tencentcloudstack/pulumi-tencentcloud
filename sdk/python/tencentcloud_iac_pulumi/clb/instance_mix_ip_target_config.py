...
class _InstanceMixIpTargetConfigState:
    def __init__(__self__, *,
                 ...
                 mix_ip_target: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="mixIpTarget")
    def mix_ip_target(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        False: closed True:open.
        """
        return pulumi.get(self, "mix_ip_target")
    ...
    @mix_ip_target.setter
    def mix_ip_target(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "mix_ip_target", value)


@pulumi.type_token("tencentcloud:Clb/instanceMixIpTargetConfig:InstanceMixIpTargetConfig")
class InstanceMixIpTargetConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            load_balancer_id: pulumi.Input[Optional[_builtins.str]] = None,
            mix_ip_target: pulumi.Input[Optional[_builtins.bool]] = None) -> 'InstanceMixIpTargetConfig':
        """
