...
__all__ = ["TargetGroupAttachment", "TargetGroupAttachmentArgs"]
...
class TargetGroupAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            TargetGroupAttachmentArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    @_builtins.property
    @pulumi.getter(name="listenerId")
    def listener_id(self) -> pulumi.Output[_builtins.str | None]:
        """
        ID of the CLB listener.
        """
        return pulumi.get(self, "listener_id")
