...
def get_target_group_list(filters: Optional[Sequence[Union['GetTargetGroupListFilterArgs', 'GetTargetGroupListFilterArgsDict']]] = None,
    ...
    target_group_list = tencentcloud.Clb.get_target_group_list(filters=[{
    ...
    :param Sequence[Union['GetTargetGroupListFilterArgs', 'GetTargetGroupListFilterArgsDict']] filters: Filter array, which is exclusive of TargetGroupIds. Valid values: TargetGroupVpcId and TargetGroupName. Target group ID will be used first.
    :param _builtins.str result_output_file: Used to save results.
    :param Sequence[_builtins.str] target_group_ids: Target group ID array.
    """
    __args__ = dict()
...
def get_target_group_list_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetTargetGroupListFilterArgs', 'GetTargetGroupListFilterArgsDict']]]]] = None,
                                 result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 target_group_ids: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTargetGroupListResult]:
    """
    Use this data source to query detailed information of clb target_group_list
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getTargetGroupList:getTargetGroupList', __args__, opts=opts, typ=GetTargetGroupListResult)
    return __ret__.apply(lambda __response__: GetTargetGroupListResult(
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        target_group_ids=pulumi.get(__response__, 'target_group_ids'),
        target_group_sets=pulumi.get(__response__, 'target_group_sets')))
