...
@pulumi.input_type
class LogSetArgs:
    def __init__(__self__, *, period: pulumi.Input[_builtins.int | None] = None):
        """
        The set of arguments for constructing a LogSet resource.

        :param pulumi.Input[_builtins.int] period: Logset retention period in days. Maximun value is `90`.
        """
...
class _LogSetState:
    def __init__(
        ...
        *,
        ...
        topic_count: pulumi.Input[_builtins.str | None] = None
    ):
        """
        Input properties used for looking up and filtering LogSet resources.

        :param pulumi.Input[_builtins.str] create_time: Logset creation time.
        :param pulumi.Input[_builtins.str] name: Logset name, which unique and fixed `clb_logset` among all CLS logsets.
        :param pulumi.Input[_builtins.int] period: Logset retention period in days. Maximun value is `90`.
        :param pulumi.Input[_builtins.str] topic_count: Number of log topics in logset.
        """
    ...
    def topic_count(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @topic_count.setter
    def topic_count(self, value: pulumi.Input[_builtins.str | None]):
        pulumi.set(self, "topic_count", value)


@pulumi.type_token("tencentcloud:Clb/logSet:LogSet")
class LogSet(pulumi.CustomResource):
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Clb/logSet:LogSet", resource_name, __props__, opts
        )
    ...
    @_builtins.property
    @pulumi.getter(name="topicCount")
    def topic_count(self) -> pulumi.Output[_builtins.str]:
        """
        Number of log topics in logset.
        """
        return pulumi.get(self, "topic_count")
