...
def get_idle_instances(load_balancer_region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str load_balancer_region: CLB instance region.
...
def get_idle_instances_output(load_balancer_region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIdleInstancesResult]:
    """
    Use this data source to query detailed information of clb idle_loadbalancers
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getIdleInstances:getIdleInstances', __args__, opts=opts, typ=GetIdleInstancesResult)
    return __ret__.apply(lambda __response__: GetIdleInstancesResult(
        id=pulumi.get(__response__, 'id'),
        idle_load_balancers=pulumi.get(__response__, 'idle_load_balancers'),
