...
class GetIdleInstancesResult:
    ...
    def idle_load_balancers(
        self,
    ) -> Sequence["outputs.GetIdleInstancesIdleLoadBalancerResult"]:
        """
...
def get_idle_instances(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getIdleInstances:getIdleInstances",
        __args__,
        opts=opts,
        typ=GetIdleInstancesResult,
    ).value
...
def get_idle_instances_output(
...
) -> pulumi.Output[GetIdleInstancesResult]:
    """
    Use this data source to query detailed information of clb idle_loadbalancers
    ...
    return __ret__.apply(
        lambda __response__: GetIdleInstancesResult(
