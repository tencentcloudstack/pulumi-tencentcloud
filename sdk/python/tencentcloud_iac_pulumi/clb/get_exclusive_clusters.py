...
class GetExclusiveClustersResult:
    ...
    def __init__(
        __self__, cluster_sets=None, filters=None, id=None, result_output_file=None
    ):
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Sequence["outputs.GetExclusiveClustersFilterResult"] | None:
...
def get_exclusive_clusters(
    filters: (
        Sequence[
            Union[
                "GetExclusiveClustersFilterArgs", "GetExclusiveClustersFilterArgsDict"
            ]
        ]
        | None
    ) = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getExclusiveClusters:getExclusiveClusters",
        __args__,
        opts=opts,
        typ=GetExclusiveClustersResult,
    ).value
...
def get_exclusive_clusters_output(
...
) -> pulumi.Output[GetExclusiveClustersResult]:
    """
    Use this data source to query detailed information of clb exclusive_clusters
    ...
    return __ret__.apply(
        lambda __response__: GetExclusiveClustersResult(
