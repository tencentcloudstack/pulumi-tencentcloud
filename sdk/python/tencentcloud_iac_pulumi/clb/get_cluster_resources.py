...
def get_cluster_resources_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetClusterResourcesFilterArgs', 'GetClusterResourcesFilterArgsDict']]]]] = None,
