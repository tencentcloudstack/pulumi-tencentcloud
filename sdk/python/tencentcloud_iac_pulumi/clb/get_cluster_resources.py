...
def get_cluster_resources(filters: Optional[Sequence[Union['GetClusterResourcesFilterArgs', 'GetClusterResourcesFilterArgsDict']]] = None,
    ...
    cluster_resources = tencentcloud.Clb.get_cluster_resources(filters=[{
        "name": "idle",
        "values": ["True"],
    }])
    ```
...
def get_cluster_resources_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetClusterResourcesFilterArgs', 'GetClusterResourcesFilterArgsDict']]]]] = None,
                                 result_output_file: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClusterResourcesResult]:
    """
    Use this data source to query detailed information of clb cluster_resources
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getClusterResources:getClusterResources', __args__, opts=opts, typ=GetClusterResourcesResult)
    return __ret__.apply(lambda __response__: GetClusterResourcesResult(
        cluster_resource_sets=pulumi.get(__response__, 'cluster_resource_sets'),
