...
class GetInstanceTrafficResult:
    ...
    def __init__(
        __self__,
        id=None,
        load_balancer_region=None,
        load_balancer_traffics=None,
    ...
    def load_balancer_region(self) -> _builtins.str | None:
        return pulumi.get(self, "load_balancer_region")

    @_builtins.property
    @pulumi.getter(name="loadBalancerTraffics")
    def load_balancer_traffics(
        self,
    ) -> Sequence["outputs.GetInstanceTrafficLoadBalancerTrafficResult"]:
        """
...
def get_instance_traffic(
    load_balancer_region: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getInstanceTraffic:getInstanceTraffic",
        __args__,
        opts=opts,
        typ=GetInstanceTrafficResult,
    ).value
...
def get_instance_traffic_output(
    load_balancer_region: pulumi.Input[_builtins.str | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetInstanceTrafficResult]:
    """
    Use this data source to query detailed information of clb instance_traffic
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceTrafficResult(
