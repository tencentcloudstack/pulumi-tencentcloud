...
def get_instance_detail(fields: Optional[Sequence[_builtins.str]] = None,
                        filters: Optional[Sequence[Union['GetInstanceDetailFilterArgs', 'GetInstanceDetailFilterArgsDict']]] = None,
...
def get_instance_detail_output(fields: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                               filters: Optional[pulumi.Input[Optional[Sequence[Union['GetInstanceDetailFilterArgs', 'GetInstanceDetailFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getInstanceDetail:getInstanceDetail', __args__, opts=opts, typ=GetInstanceDetailResult)
    return __ret__.apply(lambda __response__: GetInstanceDetailResult(
        fields=pulumi.get(__response__, 'fields'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        load_balancer_detail_sets=pulumi.get(__response__, 'load_balancer_detail_sets'),
