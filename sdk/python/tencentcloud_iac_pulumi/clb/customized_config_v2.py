...
class _CustomizedConfigV2State:
    def __init__(__self__, *,
                 config_content: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="configContent")
    def config_content(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Content of Customized Config.
        """
        return pulumi.get(self, "config_content")
    ...
    @config_content.setter
    def config_content(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "config_content", value)
...
class CustomizedConfigV2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            config_type: pulumi.Input[Optional[_builtins.str]] = None,
            create_time: pulumi.Input[Optional[_builtins.str]] = None,
            update_time: pulumi.Input[Optional[_builtins.str]] = None) -> 'CustomizedConfigV2':
        """
