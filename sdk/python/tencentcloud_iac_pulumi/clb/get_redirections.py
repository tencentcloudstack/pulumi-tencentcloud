...
class GetRedirectionsResult:
    ...
    def target_listener_id(self) -> Optional[_builtins.str]:
        """
    ...
    def target_rule_id(self) -> Optional[_builtins.str]:
        """
...
def get_redirections(clb_id: Optional[_builtins.str] = None,
                     result_output_file: Optional[_builtins.str] = None,
                     source_listener_id: Optional[_builtins.str] = None,
                     source_rule_id: Optional[_builtins.str] = None,
                     target_listener_id: Optional[_builtins.str] = None,
                     target_rule_id: Optional[_builtins.str] = None,
...
def get_redirections_output(clb_id: Optional[pulumi.Input[_builtins.str]] = None,
                            ...
                            target_listener_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            target_rule_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRedirectionsResult]:
    """
    Use this data source to query detailed information of CLB redirections
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getRedirections:getRedirections', __args__, opts=opts, typ=GetRedirectionsResult)
    return __ret__.apply(lambda __response__: GetRedirectionsResult(
        clb_id=pulumi.get(__response__, 'clb_id'),
        id=pulumi.get(__response__, 'id'),
        redirection_lists=pulumi.get(__response__, 'redirection_lists'),
        result_output_file=pulumi.get(__response__, 'result_output_file'),
        source_listener_id=pulumi.get(__response__, 'source_listener_id'),
        source_rule_id=pulumi.get(__response__, 'source_rule_id'),
        target_listener_id=pulumi.get(__response__, 'target_listener_id'),
        target_rule_id=pulumi.get(__response__, 'target_rule_id')))
