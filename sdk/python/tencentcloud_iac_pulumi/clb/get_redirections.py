...
class GetRedirectionsResult:
    ...
    def redirection_lists(
        self,
    ) -> Sequence["outputs.GetRedirectionsRedirectionListResult"]:
        """
    ...
    def target_listener_id(self) -> _builtins.str | None:
        """
    ...
    def target_rule_id(self) -> _builtins.str | None:
        """
...
def get_redirections(
    clb_id: _builtins.str | None = None,
    result_output_file: _builtins.str | None = None,
    source_listener_id: _builtins.str | None = None,
    source_rule_id: _builtins.str | None = None,
    target_listener_id: _builtins.str | None = None,
    target_rule_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getRedirections:getRedirections",
        __args__,
        opts=opts,
        typ=GetRedirectionsResult,
    ).value
...
def get_redirections_output(
...
) -> pulumi.Output[GetRedirectionsResult]:
    """
    Use this data source to query detailed information of CLB redirections
    ...
    return __ret__.apply(
        lambda __response__: GetRedirectionsResult(
