...
def get_attachments(clb_id: Optional[_builtins.str] = None,
...
def get_attachments_output(clb_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Clb/getAttachments:getAttachments', __args__, opts=opts, typ=GetAttachmentsResult)
