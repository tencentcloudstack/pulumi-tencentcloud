...
class GetAttachmentsResult:
    ...
    def attachment_lists(
        self,
    ) -> Sequence["outputs.GetAttachmentsAttachmentListResult"]:
        """
...
def get_attachments(
    ...
    clblab = tencentcloud.clb.get_attachments(listener_id="lbl-hh141sn9",
        clb_id="lb-k2zjp9lv",
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getAttachments:getAttachments",
        __args__,
        opts=opts,
        typ=GetAttachmentsResult,
    ).value
...
def get_attachments_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAttachmentsResult(
            attachment_lists=pulumi.get(__response__, "attachment_lists"),
