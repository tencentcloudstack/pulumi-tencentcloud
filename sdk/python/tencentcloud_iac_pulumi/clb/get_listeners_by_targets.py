...
def get_listeners_by_targets_output(backends: pulumi.Input[Optional[Sequence[Union['GetListenersByTargetsBackendArgs', 'GetListenersByTargetsBackendArgsDict']]]] = None,
