...
def get_listeners(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getListeners:getListeners",
        __args__,
        opts=opts,
        typ=GetListenersResult,
    ).value
...
def get_listeners_output(
...
) -> pulumi.Output[GetListenersResult]:
    """
    Use this data source to query detailed information of CLB listener
    ...
    return __ret__.apply(
        lambda __response__: GetListenersResult(
