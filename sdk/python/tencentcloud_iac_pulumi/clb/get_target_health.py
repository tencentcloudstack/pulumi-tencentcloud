...
def get_target_health(
    load_balancer_ids: Sequence[_builtins.str] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Clb/getTargetHealth:getTargetHealth",
        __args__,
        opts=opts,
        typ=GetTargetHealthResult,
    ).value
...
def get_target_health_output(
    load_balancer_ids: pulumi.Input[Sequence[_builtins.str] | None] = None,
    result_output_file: pulumi.Input[_builtins.str | None] = None,
    opts: pulumi.InvokeOptions | pulumi.InvokeOutputOptions | None = None,
) -> pulumi.Output[GetTargetHealthResult]:
    """
    Use this data source to query detailed information of clb target_health
    ...
    return __ret__.apply(
        lambda __response__: GetTargetHealthResult(
