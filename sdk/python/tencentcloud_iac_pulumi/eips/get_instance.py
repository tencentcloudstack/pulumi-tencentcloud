...
class GetInstanceResult:
    ...
    def eip_id(self) -> _builtins.str | None:
        """
        ID of the EIP.
        """
    ...
    def eip_name(self) -> _builtins.str | None:
        """
        Name of the EIP.
        """
...
def get_instance(
    eip_id: _builtins.str | None = None,
    eip_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Eips/getInstance:getInstance",
        __args__,
        opts=opts,
...
def get_instance_output(
    ...
    eip_name: pulumi.Input[_builtins.str | None] = None,
