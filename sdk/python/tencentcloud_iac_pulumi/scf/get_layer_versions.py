...
class GetLayerVersionsResult:
    ...
    def compatible_runtimes(self) -> Sequence[_builtins.str] | None:
...
def get_layer_versions(
    compatible_runtimes: Sequence[_builtins.str] | None = None,
    layer_name: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getLayerVersions:getLayerVersions",
        __args__,
        opts=opts,
        typ=GetLayerVersionsResult,
    ).value
...
def get_layer_versions_output(
    compatible_runtimes: pulumi.Input[Sequence[_builtins.str] | None] = None,
...
) -> pulumi.Output[GetLayerVersionsResult]:
    """
    Use this data source to query detailed information of scf layer_versions
    ...
    return __ret__.apply(
        lambda __response__: GetLayerVersionsResult(
