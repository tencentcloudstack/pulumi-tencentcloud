...
class GetFunctionAliasesResult:
    ...
    def function_version(self) -> _builtins.str | None:
        """
...
def get_function_aliases(
    ...
    function_version: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getFunctionAliases:getFunctionAliases",
        __args__,
        opts=opts,
        typ=GetFunctionAliasesResult,
    ).value
...
def get_function_aliases_output(
...
) -> pulumi.Output[GetFunctionAliasesResult]:
    """
    Use this data source to query detailed information of scf function_aliases
    ...
    return __ret__.apply(
        lambda __response__: GetFunctionAliasesResult(
