...
def get_function_aliases_output(function_name: pulumi.Input[Optional[_builtins.str]] = None,
                                function_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
