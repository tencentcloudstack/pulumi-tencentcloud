...
__all__ = ["ReservedConcurrencyConfig", "ReservedConcurrencyConfigArgs"]
...
class ReservedConcurrencyConfigArgs:
    def __init__(
        ...
        *,
        ...
        reserved_concurrency_mem: pulumi.Input[_builtins.int],
        namespace: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a ReservedConcurrencyConfig resource.

        :param pulumi.Input[_builtins.str] function_name: Specifies the function of which you want to configure the reserved quota.
        :param pulumi.Input[_builtins.int] reserved_concurrency_mem: Reserved memory quota of the function. Note: the upper limit for the total reserved quota of the function is the user's total concurrency memory minus 12800.
    ...
    def reserved_concurrency_mem(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def reserved_concurrency_mem(self, value: pulumi.Input[_builtins.int]):
...
class _ReservedConcurrencyConfigState:
    def __init__(
        ...
        *,
        ...
        namespace: pulumi.Input[_builtins.str | None] = None,
        reserved_concurrency_mem: pulumi.Input[_builtins.int | None] = None
    ):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="reservedConcurrencyMem")
    def reserved_concurrency_mem(self) -> pulumi.Input[_builtins.int | None]:
        """
        Reserved memory quota of the function. Note: the upper limit for the total reserved quota of the function is the user's total concurrency memory minus 12800.
        """
        return pulumi.get(self, "reserved_concurrency_mem")
    ...
    @reserved_concurrency_mem.setter
    def reserved_concurrency_mem(self, value: pulumi.Input[_builtins.int | None]):
        pulumi.set(self, "reserved_concurrency_mem", value)
...
class ReservedConcurrencyConfig(pulumi.CustomResource):
    ...
    def __init__(
        ...
        reserved_concurrency_config = tencentcloud.scf.ReservedConcurrencyConfig("reserved_concurrency_config",
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ReservedConcurrencyConfigArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        if opts.id is None:
            ...
            __props__ = ReservedConcurrencyConfigArgs.__new__(
                ReservedConcurrencyConfigArgs
            )
    ...
    def get(
        ...
        __props__ = _ReservedConcurrencyConfigState.__new__(
            _ReservedConcurrencyConfigState
        )
    ...
    @_builtins.property
    @pulumi.getter(name="reservedConcurrencyMem")
    def reserved_concurrency_mem(self) -> pulumi.Output[_builtins.int]:
        """
        Reserved memory quota of the function. Note: the upper limit for the total reserved quota of the function is the user's total concurrency memory minus 12800.
        """
        return pulumi.get(self, "reserved_concurrency_mem")
