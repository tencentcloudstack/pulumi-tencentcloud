...
class GetAsyncEventManagementResult:
    ...
    def invoke_types(self) -> Optional[Sequence[_builtins.str]]:
        """
        Invocation type.
        """
...
def get_async_event_management(function_name: Optional[_builtins.str] = None,
                               invoke_request_id: Optional[_builtins.str] = None,
                               invoke_types: Optional[Sequence[_builtins.str]] = None,
...
def get_async_event_management_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
                                      invoke_request_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      invoke_types: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAsyncEventManagementResult]:
    """
    Use this data source to query detailed information of scf async_event_management
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Scf/getAsyncEventManagement:getAsyncEventManagement', __args__, opts=opts, typ=GetAsyncEventManagementResult)
    return __ret__.apply(lambda __response__: GetAsyncEventManagementResult(
