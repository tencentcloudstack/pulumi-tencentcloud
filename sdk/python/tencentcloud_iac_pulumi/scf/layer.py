...
class LayerArgs:
    def __init__(
        ...
        *,
        ...
        license_info: pulumi.Input[_builtins.str | None] = None
    ):
        """
        The set of arguments for constructing a Layer resource.

        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] compatible_runtimes: The compatible runtimes of layer.
        ...
        :param pulumi.Input[_builtins.str] description: The description of layer.
        :param pulumi.Input[_builtins.str] license_info: The license info of layer.
        """
    ...
    def license_info(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @license_info.setter
    def license_info(self, value: pulumi.Input[_builtins.str | None]):
...
class _LayerState:
    def __init__(
        __self__,
        *,
        code_sha256: pulumi.Input[_builtins.str | None] = None,
        compatible_runtimes: pulumi.Input[
            Sequence[pulumi.Input[_builtins.str]] | None
        ] = None,
        content: pulumi.Input[Optional["LayerContentArgs"]] = None,
        create_time: pulumi.Input[_builtins.str | None] = None,
        description: pulumi.Input[_builtins.str | None] = None,
        layer_name: pulumi.Input[_builtins.str | None] = None,
        layer_version: pulumi.Input[_builtins.int | None] = None,
        license_info: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[_builtins.str] code_sha256: The code type of layer.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] compatible_runtimes: The compatible runtimes of layer.
        :param pulumi.Input['LayerContentArgs'] content: The source code of layer.
        :param pulumi.Input[_builtins.str] create_time: The create time of layer.
        :param pulumi.Input[_builtins.str] description: The description of layer.
        :param pulumi.Input[_builtins.str] layer_name: The name of layer.
        :param pulumi.Input[_builtins.int] layer_version: The version of layer.
        :param pulumi.Input[_builtins.str] license_info: The license info of layer.
        :param pulumi.Input[_builtins.str] location: The download location url of layer.
        :param pulumi.Input[_builtins.str] status: The current status of layer.
        """
    ...
    def code_sha256(self) -> pulumi.Input[_builtins.str | None]:
        """
    ...
    @code_sha256.setter
    def code_sha256(self, value: pulumi.Input[_builtins.str | None]):
    ...
    @_builtins.property
    @pulumi.getter
    def content(self) -> pulumi.Input[Optional["LayerContentArgs"]]:
        """
        The source code of layer.
        """
        return pulumi.get(self, "content")
    ...
    @content.setter
    def content(self, value: pulumi.Input[Optional["LayerContentArgs"]]):
        pulumi.set(self, "content", value)
    ...
    @_builtins.property
    @pulumi.getter(name="layerName")
    def layer_name(self) -> pulumi.Input[_builtins.str | None]:
        """
        The name of layer.
        """
        return pulumi.get(self, "layer_name")
    ...
    def layer_version(self) -> pulumi.Input[_builtins.int | None]:
        """
    ...
    def layer_version(self, value: pulumi.Input[_builtins.int | None]):
...
@pulumi.type_token("tencentcloud:Scf/layer:Layer")
class Layer(pulumi.CustomResource):
    ...
    def __init__(
        ...
        content: pulumi.Input[
            Union["LayerContentArgs", "LayerContentArgsDict"] | None
        ] = None,
        description: pulumi.Input[_builtins.str | None] = None,
        layer_name: pulumi.Input[_builtins.str | None] = None,
        license_info: pulumi.Input[_builtins.str | None] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] compatible_runtimes: The compatible runtimes of layer.
        :param pulumi.Input[Union['LayerContentArgs', 'LayerContentArgsDict']] content: The source code of layer.
        :param pulumi.Input[_builtins.str] description: The description of layer.
        :param pulumi.Input[_builtins.str] layer_name: The name of layer.
        :param pulumi.Input[_builtins.str] license_info: The license info of layer.
        """
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            LayerArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__("tencentcloud:Scf/layer:Layer", resource_name, __props__, opts)
    ...
    @_builtins.property
    @pulumi.getter(name="layerVersion")
    def layer_version(self) -> pulumi.Output[_builtins.int]:
        """
        The version of layer.
        """
        return pulumi.get(self, "layer_version")
    ...
    @_builtins.property
    @pulumi.getter(name="licenseInfo")
    def license_info(self) -> pulumi.Output[_builtins.str | None]:
        """
        The license info of layer.
        """
        return pulumi.get(self, "license_info")
