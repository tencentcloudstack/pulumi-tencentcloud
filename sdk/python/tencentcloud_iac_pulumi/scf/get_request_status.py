...
def get_request_status(
    ...
    function_request_id: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getRequestStatus:getRequestStatus",
        __args__,
        opts=opts,
        typ=GetRequestStatusResult,
    ).value
...
def get_request_status_output(
...
) -> pulumi.Output[GetRequestStatusResult]:
    """
    Use this data source to query detailed information of scf request_status
    ...
    return __ret__.apply(
        lambda __response__: GetRequestStatusResult(
