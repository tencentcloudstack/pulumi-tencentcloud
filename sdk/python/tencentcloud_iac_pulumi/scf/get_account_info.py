...
def get_account_info(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getAccountInfo:getAccountInfo",
        __args__,
        opts=opts,
        typ=GetAccountInfoResult,
    ).value
...
def get_account_info_output(
    ...
    return __ret__.apply(
        lambda __response__: GetAccountInfoResult(
