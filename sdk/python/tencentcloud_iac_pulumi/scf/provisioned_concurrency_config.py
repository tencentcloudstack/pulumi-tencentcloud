...
class ProvisionedConcurrencyConfigArgs:
    def __init__(__self__, *,
                 ...
                 tracking_target: pulumi.Input[Optional[_builtins.float]] = None,
                 trigger_actions: pulumi.Input[Optional[Sequence[pulumi.Input['ProvisionedConcurrencyConfigTriggerActionArgs']]]] = None):
        """
    ...
    def tracking_target(self) -> pulumi.Input[Optional[_builtins.float]]:
        """
    ...
    def tracking_target(self, value: pulumi.Input[Optional[_builtins.float]]):
        pulumi.set(self, "tracking_target", value)

    @_builtins.property
    @pulumi.getter(name="triggerActions")
    def trigger_actions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ProvisionedConcurrencyConfigTriggerActionArgs']]]]:
        """
    ...
    def trigger_actions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ProvisionedConcurrencyConfigTriggerActionArgs']]]]):
...
class _ProvisionedConcurrencyConfigState:
    def __init__(__self__, *,
                 ...
                 tracking_target: pulumi.Input[Optional[_builtins.float]] = None,
                 trigger_actions: pulumi.Input[Optional[Sequence[pulumi.Input['ProvisionedConcurrencyConfigTriggerActionArgs']]]] = None,
                 version_provisioned_concurrency_num: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="versionProvisionedConcurrencyNum")
    def version_provisioned_concurrency_num(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Provisioned concurrency amount. Note: there is an upper limit for the sum of provisioned concurrency amounts of all versions, which currently is the function&amp;#39;s maximum concurrency quota minus 100.
        """
        return pulumi.get(self, "version_provisioned_concurrency_num")
    ...
    @version_provisioned_concurrency_num.setter
    def version_provisioned_concurrency_num(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "version_provisioned_concurrency_num", value)


@pulumi.type_token("tencentcloud:Scf/provisionedConcurrencyConfig:ProvisionedConcurrencyConfig")
class ProvisionedConcurrencyConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 qualifier: pulumi.Input[Optional[_builtins.str]] = None,
                 tracking_target: pulumi.Input[Optional[_builtins.float]] = None,
                 trigger_actions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ProvisionedConcurrencyConfigTriggerActionArgs', 'ProvisionedConcurrencyConfigTriggerActionArgsDict']]]]] = None,
                 version_provisioned_concurrency_num: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            tracking_target: pulumi.Input[Optional[_builtins.float]] = None,
            trigger_actions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ProvisionedConcurrencyConfigTriggerActionArgs', 'ProvisionedConcurrencyConfigTriggerActionArgsDict']]]]] = None,
            version_provisioned_concurrency_num: pulumi.Input[Optional[_builtins.int]] = None) -> 'ProvisionedConcurrencyConfig':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="minCapacity")
    def min_capacity(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The minimum number of instances. It can not be smaller than 1.
        """
        return pulumi.get(self, "min_capacity")
    ...
    @_builtins.property
    @pulumi.getter(name="provisionedType")
    def provisioned_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the provisioned concurrency type. Default: Static provisioned concurrency. ConcurrencyUtilizationTracking: Scales the concurrency automatically according to the concurrency utilization. If ConcurrencyUtilizationTracking is passed in, TrackingTarget, MinCapacity and MaxCapacity are required, and VersionProvisionedConcurrencyNum must be 0.
        """
        return pulumi.get(self, "provisioned_type")
    ...
    @_builtins.property
    @pulumi.getter(name="trackingTarget")
    def tracking_target(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The target concurrency utilization. Range: (0,1) (two decimal places).
        """
        return pulumi.get(self, "tracking_target")
