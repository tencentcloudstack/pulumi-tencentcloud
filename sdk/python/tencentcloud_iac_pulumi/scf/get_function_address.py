...
def get_function_address(function_name: Optional[_builtins.str] = None,
...
def get_function_address_output(function_name: Optional[pulumi.Input[_builtins.str]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetFunctionAddressResult]:
    """
    Use this data source to query detailed information of scf function_address
    ...
    __ret__ = pulumi.runtime.invoke_output('tencentcloud:Scf/getFunctionAddress:getFunctionAddress', __args__, opts=opts, typ=GetFunctionAddressResult)
    return __ret__.apply(lambda __response__: GetFunctionAddressResult(
