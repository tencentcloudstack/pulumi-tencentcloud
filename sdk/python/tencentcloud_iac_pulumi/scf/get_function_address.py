...
def get_function_address(
    ...
    :param _builtins.str qualifier: Function version.
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getFunctionAddress:getFunctionAddress",
        __args__,
        opts=opts,
        typ=GetFunctionAddressResult,
    ).value
...
def get_function_address_output(
...
) -> pulumi.Output[GetFunctionAddressResult]:
    """
    Use this data source to query detailed information of scf function_address
    ...
    return __ret__.apply(
        lambda __response__: GetFunctionAddressResult(
