...
class GetLayersResult:
    ...
    def compatible_runtime(self) -> _builtins.str | None:
...
def get_layers(
    compatible_runtime: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Scf/getLayers:getLayers", __args__, opts=opts, typ=GetLayersResult
    ).value
...
def get_layers_output(
    compatible_runtime: pulumi.Input[_builtins.str | None] = None,
    ...
    return __ret__.apply(
        lambda __response__: GetLayersResult(
