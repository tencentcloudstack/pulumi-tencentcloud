...
__all__ = ["ModifyAccessPeriod", "ModifyAccessPeriodArgs"]


@pulumi.input_type
class ModifyAccessPeriodArgs:
    def __init__(__self__, *, period: pulumi.Input[int], topic_id: pulumi.Input[str]):
        """
...
class _ModifyAccessPeriodState:
    def __init__(
        __self__,
        *,
        period: pulumi.Input[int] | None = None,
    ...
    @property
    @pulumi.getter
    def period(self) -> pulumi.Input[int] | None:
        """
        Access log retention period, range is [1, 180].
        """
        return pulumi.get(self, "period")
    ...
    @period.setter
    def period(self, value: pulumi.Input[int] | None):
        pulumi.set(self, "period", value)
...
class ModifyAccessPeriod(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            ModifyAccessPeriodArgs, pulumi.ResourceOptions, *args, **kwargs
        )
