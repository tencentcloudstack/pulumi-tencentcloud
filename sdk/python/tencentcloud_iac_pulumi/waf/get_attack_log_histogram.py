...
def get_attack_log_histogram(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getAttackLogHistogram:getAttackLogHistogram",
        __args__,
        opts=opts,
        typ=GetAttackLogHistogramResult,
    ).value
...
def get_attack_log_histogram_output(
...
) -> pulumi.Output[GetAttackLogHistogramResult]:
    """
    Use this data source to query detailed information of waf attack_log_histogram
    ...
    return __ret__.apply(
        lambda __response__: GetAttackLogHistogramResult(
