...
class ClbInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] goods_category: Billing order parameters. support: premium_clb, enterprise_clb, ultimate_clb.
...
class ClbInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_span: Optional[pulumi.Input[int]] = None,
            time_unit: Optional[pulumi.Input[str]] = None,
            valid_time: Optional[pulumi.Input[str]] = None) -> 'ClbInstance':
        """
