...
class GetAttackLogListResult:
    ...
    @_builtins.property
    @pulumi.getter
    def page(self) -> _builtins.int | None:
        return pulumi.get(self, "page")

    @_builtins.property
    @pulumi.getter(name="queryCount")
    def query_count(self) -> _builtins.int | None:
...
def get_attack_log_list(
    domain: _builtins.str | None = None,
    end_time: _builtins.str | None = None,
    page: _builtins.int | None = None,
    query_count: _builtins.int | None = None,
    query_string: _builtins.str | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getAttackLogList:getAttackLogList",
        __args__,
        opts=opts,
        typ=GetAttackLogListResult,
    ).value
...
def get_attack_log_list_output(
    domain: pulumi.Input[_builtins.str | None] = None,
    end_time: pulumi.Input[_builtins.str | None] = None,
    page: pulumi.Input[_builtins.int | None] = None,
    query_count: pulumi.Input[_builtins.int | None] = None,
    query_string: pulumi.Input[_builtins.str | None] = None,
...
) -> pulumi.Output[GetAttackLogListResult]:
    """
    Use this data source to query detailed information of waf attack_log_list
    ...
    return __ret__.apply(
        lambda __response__: GetAttackLogListResult(
