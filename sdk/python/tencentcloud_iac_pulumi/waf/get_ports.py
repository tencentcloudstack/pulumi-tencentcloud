...
def get_ports(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getPorts:getPorts", __args__, opts=opts, typ=GetPortsResult
    ).value
...
def get_ports_output(
    ...
    return __ret__.apply(
        lambda __response__: GetPortsResult(
