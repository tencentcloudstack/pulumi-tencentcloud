...
class GetAttackOverviewResult:
    ...
    def __init__(
        ...
        access_count=None,
        acl_count=None,
        api_assets_count=None,
        api_risk_event_count=None,
        appid=None,
        attack_count=None,
        bot_count=None,
        cc_count=None,
...
def get_attack_overview(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getAttackOverview:getAttackOverview",
        __args__,
        opts=opts,
        typ=GetAttackOverviewResult,
    ).value
...
def get_attack_overview_output(
...
) -> pulumi.Output[GetAttackOverviewResult]:
    """
    Use this data source to query detailed information of waf attack_overview
    ...
    return __ret__.apply(
        lambda __response__: GetAttackOverviewResult(
