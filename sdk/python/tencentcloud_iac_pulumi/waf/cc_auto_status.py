...
__all__ = ["CcAutoStatus", "CcAutoStatusArgs"]
...
class _CcAutoStatusState:
    def __init__(
        ...
        *,
        ...
        :param pulumi.Input[_builtins.str] domain: Domain.
        :param pulumi.Input[_builtins.str] edition: Waf edition. clb-waf means clb-waf, sparta-waf means saas-waf.
        :param pulumi.Input[_builtins.int] status: cc auto status, 1(open), 0(close).
        """
...
@pulumi.type_token("tencentcloud:Waf/ccAutoStatus:CcAutoStatus")
class CcAutoStatus(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(
            CcAutoStatusArgs, pulumi.ResourceOptions, *args, **kwargs
        )
    ...
    def _internal_init(
        ...
        super().__init__(
            "tencentcloud:Waf/ccAutoStatus:CcAutoStatus", resource_name, __props__, opts
        )
