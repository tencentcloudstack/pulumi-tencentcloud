...
def get_user_domains(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getUserDomains:getUserDomains",
        __args__,
        opts=opts,
        typ=GetUserDomainsResult,
    ).value
...
def get_user_domains_output(
    ...
    return __ret__.apply(
        lambda __response__: GetUserDomainsResult(
