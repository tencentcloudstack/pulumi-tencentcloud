...
class GetWafInfosResult:
    ...
    def __init__(
        __self__, host_lists=None, id=None, params=None, result_output_file=None
    ):
...
def get_waf_infos(
    params: Sequence[pulumi.InputType["GetWafInfosParamArgs"]] | None = None,
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getWafInfos:getWafInfos",
        __args__,
        opts=opts,
        typ=GetWafInfosResult,
    ).value
...
def get_waf_infos_output(
    params: pulumi.Input[Sequence[pulumi.InputType["GetWafInfosParamArgs"]]] | None = None,
    result_output_file: pulumi.Input[str | None] | None = None,
    opts: pulumi.InvokeOptions | None = None,
) -> pulumi.Output[GetWafInfosResult]:
    """
    Use this data source to access information about an existing resource.
    """
