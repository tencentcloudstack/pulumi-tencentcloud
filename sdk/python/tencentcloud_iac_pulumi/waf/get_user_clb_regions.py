...
class GetUserClbRegionsResult:
    ...
    def __init__(
        __self__, datas=None, id=None, result_output_file=None, rich_datas=None
    ):
...
def get_user_clb_regions(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getUserClbRegions:getUserClbRegions",
        __args__,
        opts=opts,
        typ=GetUserClbRegionsResult,
    ).value
...
def get_user_clb_regions_output(
    ...
    return __ret__.apply(
        lambda __response__: GetUserClbRegionsResult(
