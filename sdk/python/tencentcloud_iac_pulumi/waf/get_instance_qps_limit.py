...
def get_instance_qps_limit(
    ...
    __ret__ = pulumi.runtime.invoke(
        "tencentcloud:Waf/getInstanceQpsLimit:getInstanceQpsLimit",
        __args__,
        opts=opts,
        typ=GetInstanceQpsLimitResult,
    ).value
...
def get_instance_qps_limit_output(
...
) -> pulumi.Output[GetInstanceQpsLimitResult]:
    """
    Use this data source to query detailed information of waf instance_qps_limit
    ...
    return __ret__.apply(
        lambda __response__: GetInstanceQpsLimitResult(
