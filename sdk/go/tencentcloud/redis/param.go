...
type Param struct {
	...
	InstanceParams pulumi.StringMapOutput `pulumi:"instanceParams"`
}
...
type paramState struct {
	...
	// A list of parameters modified by the instance.
	InstanceParams map[string]string `pulumi:"instanceParams"`
}
...
type ParamState struct {
	...
	// A list of parameters modified by the instance.
	InstanceParams pulumi.StringMapInput
}
...
// A list of parameters modified by the instance.
func (o ParamOutput) InstanceParams() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Param) pulumi.StringMapOutput { return v.InstanceParams }).(pulumi.StringMapOutput)
}
