...
func GetInstanceShardsOutput(ctx *pulumi.Context, args GetInstanceShardsOutputArgs, opts ...pulumi.InvokeOption) GetInstanceShardsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Redis/getInstanceShards:getInstanceShards", args, GetInstanceShardsResultOutput{}, options).(GetInstanceShardsResultOutput)
}
