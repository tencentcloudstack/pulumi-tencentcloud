...
//
// > **NOTE:** If resource `Clb.SecurityGroupAttachment` is used to manage the security group of clb instance, the `securityGroups` field cannot be explicitly used in resource `Clb.Instance`
//
// ## Example Usage
//
// ```go
