...
//				return err
//			}
//			_, err = cam.NewMfaFlag(ctx, "example", &cam.MfaFlagArgs{
...
type MfaFlag struct {
	...
	// Action flag setting.
	ActionFlag MfaFlagActionFlagOutput `pulumi:"actionFlag"`
	// Login flag setting.
	LoginFlag MfaFlagLoginFlagOutput `pulumi:"loginFlag"`
	// Operate uin.
...
// Action flag setting.
func (o MfaFlagOutput) ActionFlag() MfaFlagActionFlagOutput {
	return o.ApplyT(func(v *MfaFlag) MfaFlagActionFlagOutput { return v.ActionFlag }).(MfaFlagActionFlagOutput)
}

// Login flag setting.
func (o MfaFlagOutput) LoginFlag() MfaFlagLoginFlagOutput {
	return o.ApplyT(func(v *MfaFlag) MfaFlagLoginFlagOutput { return v.LoginFlag }).(MfaFlagLoginFlagOutput)
}
