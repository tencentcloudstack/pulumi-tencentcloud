...
//			_, err := cam.NewUserPermissionBoundaryAttachment(ctx, "example", &cam.UserPermissionBoundaryAttachmentArgs{
//				TargetUin: pulumi.Int(100037718101),
//				PolicyId:  pulumi.Int(234290251),
//			})
//			if err != nil {
//				return err
//			}
