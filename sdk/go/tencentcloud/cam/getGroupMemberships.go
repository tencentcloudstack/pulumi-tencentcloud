...
func GetGroupMembershipsOutput(ctx *pulumi.Context, args GetGroupMembershipsOutputArgs, opts ...pulumi.InvokeOption) GetGroupMembershipsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Cam/getGroupMemberships:getGroupMemberships", args, GetGroupMembershipsResultOutput{}, options).(GetGroupMembershipsResultOutput)
}
