...
//			_, err := organization.NewOrgMember(ctx, "example", &organization.OrgMemberArgs{
//				Name:   pulumi.String("tf-example-dev"),
//				NodeId: pulumi.Int(2013128),
...
// Whether to force delete the member account when deleting the organization member. It is only applicable to member accounts of the creation type, not to member accounts of the invitation type. Default is false.
func (o OrgMemberOutput) ForceDeleteAccount() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *OrgMember) pulumi.BoolPtrOutput { return v.ForceDeleteAccount }).(pulumi.BoolPtrOutput)
}
...
// Tag description list.
func (o OrgMemberOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *OrgMember) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
