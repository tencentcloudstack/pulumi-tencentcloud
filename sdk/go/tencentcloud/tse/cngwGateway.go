...
//				return err
//			}
//			_, err = tse.NewCngwGateway(ctx, "cngw_gateway", &tse.CngwGatewayArgs{
...
// Tag description list.
func (o CngwGatewayOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *CngwGateway) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
