...
//				return err
//			}
//			_, err = tse.NewCngwService(ctx, "cngw_service", &tse.CngwServiceArgs{
...
//
// Deprecated: Deprecate ineffective tags
func (o CngwServiceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *CngwService) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
