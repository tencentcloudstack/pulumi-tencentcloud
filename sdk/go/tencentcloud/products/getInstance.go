...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/tencentcloudstack/pulumi-tencentcloud/sdk/go/tencentcloud/products"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := products.GetInstance(ctx, &products.GetInstanceArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetInstance(ctx *pulumi.Context, args *GetInstanceArgs, opts ...pulumi.InvokeOption) (*GetInstanceResult, error) {
	...
	err := ctx.Invoke("tencentcloud:Products/getInstance:getInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetInstanceResult struct {
	...
	Id string `pulumi:"id"`
	// Product list.
	ProductLists     []GetInstanceProductList `pulumi:"productLists"`
	ResultOutputFile *string                  `pulumi:"resultOutputFile"`
}
...
func GetInstanceOutput(ctx *pulumi.Context, args GetInstanceOutputArgs, opts ...pulumi.InvokeOption) GetInstanceResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Products/getInstance:getInstance", args, GetInstanceResultOutput{}, options).(GetInstanceResultOutput)
}
...
// Product list.
func (o GetInstanceResultOutput) ProductLists() GetInstanceProductListArrayOutput {
	return o.ApplyT(func(v GetInstanceResult) []GetInstanceProductList { return v.ProductLists }).(GetInstanceProductListArrayOutput)
}
