...
//			foo, err := key.NewPair(ctx, "foo", &key.PairArgs{
...
// Content of private key in a key pair. Tencent Cloud do not keep private keys. Please keep it properly.
func (o PairOutput) PrivateKey() pulumi.StringOutput {
	return o.ApplyT(func(v *Pair) pulumi.StringOutput { return v.PrivateKey }).(pulumi.StringOutput)
}
...
// Tags of the key pair.
func (o PairOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Pair) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
