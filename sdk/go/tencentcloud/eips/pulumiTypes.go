...
// The tags of EIP.
func (o GetInstanceEipListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetInstanceEipList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
