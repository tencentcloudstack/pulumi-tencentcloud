...
// Tag description list.
func (o GrafanaInstanceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *GrafanaInstance) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
