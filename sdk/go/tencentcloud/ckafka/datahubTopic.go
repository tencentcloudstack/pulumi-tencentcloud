...
//				return err
//			}
//			_, err = ckafka.NewDatahubTopic(ctx, "datahub_topic", &ckafka.DatahubTopicArgs{
//				Name:         pulumi.String(invokeFormat.Result),
//				PartitionNum: pulumi.Int(20),
//				RetentionMs:  pulumi.Int(60000),
//				Note:         pulumi.String("for test"),
...
// Tags of dataHub topic.
func (o DatahubTopicOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *DatahubTopic) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
