...
//			prepaidInstance, err := dcdb.NewDbInstance(ctx, "prepaid_instance", &dcdb.DbInstanceArgs{
...
//				return err
//			}
//			hourdbInstance, err := dcdb.NewHourdbInstance(ctx, "hourdb_instance", &dcdb.HourdbInstanceArgs{
