...
func GetProjectSecurityGroupsOutput(ctx *pulumi.Context, args GetProjectSecurityGroupsOutputArgs, opts ...pulumi.InvokeOption) GetProjectSecurityGroupsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Dcdb/getProjectSecurityGroups:getProjectSecurityGroups", args, GetProjectSecurityGroupsResultOutput{}, options).(GetProjectSecurityGroupsResultOutput)
}
