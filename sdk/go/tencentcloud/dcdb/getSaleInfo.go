...
//			_, err := dcdb.GetSaleInfo(ctx, &dcdb.GetSaleInfoArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetSaleInfoOutput(ctx *pulumi.Context, args GetSaleInfoOutputArgs, opts ...pulumi.InvokeOption) GetSaleInfoResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSaleInfoResultOutput, error) {
			...
			return ctx.InvokeOutput("tencentcloud:Dcdb/getSaleInfo:getSaleInfo", args, GetSaleInfoResultOutput{}, options).(GetSaleInfoResultOutput), nil
