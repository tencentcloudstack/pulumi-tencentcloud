...
// 		_, err := Mysql.NewInstanceEncryptionOperation(ctx, "instanceEncryptionOperation", &Mysql.InstanceEncryptionOperationArgs{
// 			InstanceId: pulumi.Any(tencentcloud_mysql_instance.This.Id),
