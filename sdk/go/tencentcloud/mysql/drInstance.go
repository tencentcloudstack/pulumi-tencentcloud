...
//			_, err := mysql.NewDrInstance(ctx, "example", &mysql.DrInstanceArgs{
...
// Instance tags.
func (o DrInstanceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *DrInstance) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
