...
type ReadonlyInstance struct {
	...
	ClusterTopology ReadonlyInstanceClusterTopologyOutput `pulumi:"clusterTopology"`
	// CPU cores.
...
type readonlyInstanceState struct {
	...
	// Cluster Edition node topology configuration. Note: If you purchased a cluster edition instance, this parameter is required. You need to set the RW and RO node topology of the cluster edition instance. The RO node range is 1-5. Please set at least 1 RO node.
	ClusterTopology *ReadonlyInstanceClusterTopology `pulumi:"clusterTopology"`
	// CPU cores.
	Cpu *int `pulumi:"cpu"`
	// Specify device type, available values:
	// - `UNIVERSAL` (default): universal instance,
...
type ReadonlyInstanceState struct {
	...
	// Cluster Edition node topology configuration. Note: If you purchased a cluster edition instance, this parameter is required. You need to set the RW and RO node topology of the cluster edition instance. The RO node range is 1-5. Please set at least 1 RO node.
	ClusterTopology ReadonlyInstanceClusterTopologyPtrInput
	// CPU cores.
...
// Cluster Edition node topology configuration. Note: If you purchased a cluster edition instance, this parameter is required. You need to set the RW and RO node topology of the cluster edition instance. The RO node range is 1-5. Please set at least 1 RO node.
func (o ReadonlyInstanceOutput) ClusterTopology() ReadonlyInstanceClusterTopologyOutput {
	return o.ApplyT(func(v *ReadonlyInstance) ReadonlyInstanceClusterTopologyOutput { return v.ClusterTopology }).(ReadonlyInstanceClusterTopologyOutput)
}
