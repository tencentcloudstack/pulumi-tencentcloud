...
type GetTypesArgs struct {
	...
	// Cbs filter.
	CbsFilter *GetTypesCbsFilter `pulumi:"cbsFilter"`
...
type GetTypesOutputArgs struct {
	...
	// Cbs filter.
	CbsFilter GetTypesCbsFilterPtrInput `pulumi:"cbsFilter"`
	// The number of CPU cores of the instance.
...
func (o GetTypesResultOutput) CbsFilter() GetTypesCbsFilterPtrOutput {
	return o.ApplyT(func(v GetTypesResult) *GetTypesCbsFilter { return v.CbsFilter }).(GetTypesCbsFilterPtrOutput)
}
