...
type ExtraTemplateAddressesExtra struct {
	// IP address.
...
// ExtraTemplateAddressesExtraInput is an input type that accepts ExtraTemplateAddressesExtraArgs and ExtraTemplateAddressesExtraOutput values.
// You can construct a concrete instance of `ExtraTemplateAddressesExtraInput` via:
//
//	ExtraTemplateAddressesExtraArgs{...}
type ExtraTemplateAddressesExtraInput interface {
	pulumi.Input

	ToExtraTemplateAddressesExtraOutput() ExtraTemplateAddressesExtraOutput
	ToExtraTemplateAddressesExtraOutputWithContext(context.Context) ExtraTemplateAddressesExtraOutput
}

type ExtraTemplateAddressesExtraArgs struct {
	// IP address.
...
func (ExtraTemplateAddressesExtraArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ExtraTemplateAddressesExtra)(nil)).Elem()
}

func (i ExtraTemplateAddressesExtraArgs) ToExtraTemplateAddressesExtraOutput() ExtraTemplateAddressesExtraOutput {
	return i.ToExtraTemplateAddressesExtraOutputWithContext(context.Background())
}

func (i ExtraTemplateAddressesExtraArgs) ToExtraTemplateAddressesExtraOutputWithContext(ctx context.Context) ExtraTemplateAddressesExtraOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExtraTemplateAddressesExtraOutput)
}

// ExtraTemplateAddressesExtraArrayInput is an input type that accepts ExtraTemplateAddressesExtraArray and ExtraTemplateAddressesExtraArrayOutput values.
// You can construct a concrete instance of `ExtraTemplateAddressesExtraArrayInput` via:
//
//	ExtraTemplateAddressesExtraArray{ ExtraTemplateAddressesExtraArgs{...} }
type ExtraTemplateAddressesExtraArrayInput interface {
	pulumi.Input

	ToExtraTemplateAddressesExtraArrayOutput() ExtraTemplateAddressesExtraArrayOutput
	ToExtraTemplateAddressesExtraArrayOutputWithContext(context.Context) ExtraTemplateAddressesExtraArrayOutput
}

type ExtraTemplateAddressesExtraArray []ExtraTemplateAddressesExtraInput

func (ExtraTemplateAddressesExtraArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ExtraTemplateAddressesExtra)(nil)).Elem()
}

func (i ExtraTemplateAddressesExtraArray) ToExtraTemplateAddressesExtraArrayOutput() ExtraTemplateAddressesExtraArrayOutput {
	return i.ToExtraTemplateAddressesExtraArrayOutputWithContext(context.Background())
}

func (i ExtraTemplateAddressesExtraArray) ToExtraTemplateAddressesExtraArrayOutputWithContext(ctx context.Context) ExtraTemplateAddressesExtraArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ExtraTemplateAddressesExtraArrayOutput)
}

type ExtraTemplateAddressesExtraOutput struct{ *pulumi.OutputState }

func (ExtraTemplateAddressesExtraOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ExtraTemplateAddressesExtra)(nil)).Elem()
}

func (o ExtraTemplateAddressesExtraOutput) ToExtraTemplateAddressesExtraOutput() ExtraTemplateAddressesExtraOutput {
	return o
}

func (o ExtraTemplateAddressesExtraOutput) ToExtraTemplateAddressesExtraOutputWithContext(ctx context.Context) ExtraTemplateAddressesExtraOutput {
	return o
}

// IP address.
func (o ExtraTemplateAddressesExtraOutput) Address() pulumi.StringOutput {
	return o.ApplyT(func(v ExtraTemplateAddressesExtra) string { return v.Address }).(pulumi.StringOutput)
}

// Remarks.
func (o ExtraTemplateAddressesExtraOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExtraTemplateAddressesExtra) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// Update Time.
func (o ExtraTemplateAddressesExtraOutput) UpdatedTime() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ExtraTemplateAddressesExtra) *string { return v.UpdatedTime }).(pulumi.StringPtrOutput)
}

type ExtraTemplateAddressesExtraArrayOutput struct{ *pulumi.OutputState }

func (ExtraTemplateAddressesExtraArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ExtraTemplateAddressesExtra)(nil)).Elem()
}

func (o ExtraTemplateAddressesExtraArrayOutput) ToExtraTemplateAddressesExtraArrayOutput() ExtraTemplateAddressesExtraArrayOutput {
	return o
}

func (o ExtraTemplateAddressesExtraArrayOutput) ToExtraTemplateAddressesExtraArrayOutputWithContext(ctx context.Context) ExtraTemplateAddressesExtraArrayOutput {
	return o
}

func (o ExtraTemplateAddressesExtraArrayOutput) Index(i pulumi.IntInput) ExtraTemplateAddressesExtraOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ExtraTemplateAddressesExtra {
		return vs[0].([]ExtraTemplateAddressesExtra)[vs[1].(int)]
	}).(ExtraTemplateAddressesExtraOutput)
}
...
func init() {
	pulumi.RegisterInputType(reflect.TypeOf((*ExtraTemplateAddressesExtraInput)(nil)).Elem(), ExtraTemplateAddressesExtraArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ExtraTemplateAddressesExtraArrayInput)(nil)).Elem(), ExtraTemplateAddressesExtraArray{})
	...
	pulumi.RegisterOutputType(ExtraTemplateAddressesExtraOutput{})
	pulumi.RegisterOutputType(ExtraTemplateAddressesExtraArrayOutput{})
