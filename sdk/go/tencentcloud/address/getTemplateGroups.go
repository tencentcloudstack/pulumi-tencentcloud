...
func GetTemplateGroupsOutput(ctx *pulumi.Context, args GetTemplateGroupsOutputArgs, opts ...pulumi.InvokeOption) GetTemplateGroupsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Address/getTemplateGroups:getTemplateGroups", args, GetTemplateGroupsResultOutput{}, options).(GetTemplateGroupsResultOutput)
}
