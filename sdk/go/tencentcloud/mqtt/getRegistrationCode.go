...
func GetRegistrationCodeOutput(ctx *pulumi.Context, args GetRegistrationCodeOutputArgs, opts ...pulumi.InvokeOption) GetRegistrationCodeResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Mqtt/getRegistrationCode:getRegistrationCode", args, GetRegistrationCodeResultOutput{}, options).(GetRegistrationCodeResultOutput)
}
