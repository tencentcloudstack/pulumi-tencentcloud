...
//			_, err := tag.NewInstance(ctx, "example", &tag.InstanceArgs{
...
func NewInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tencentcloud:Tag/instance:Instance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInstance(ctx *pulumi.Context,
	...
	var resource Instance
	err := ctx.ReadResource("tencentcloud:Tag/instance:Instance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o InstanceOutput) TagKey() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.TagKey }).(pulumi.StringOutput)
}

// Tag value.
func (o InstanceOutput) TagValue() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.TagValue }).(pulumi.StringOutput)
}
