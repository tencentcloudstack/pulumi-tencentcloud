...
//			_, err := postgresql.NewBackupDownloadRestrictionConfig(ctx, "backup_download_restriction_config", &postgresql.BackupDownloadRestrictionConfigArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := vpc.NewInstance(ctx, "pg_vpc", &vpc.InstanceArgs{
