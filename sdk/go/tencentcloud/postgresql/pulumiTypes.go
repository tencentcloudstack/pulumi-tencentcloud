...
type InstanceBackupPlan struct {
	...
	MonthlyBackupPeriods []string `pulumi:"monthlyBackupPeriods"`
	// Specify days of the retention.
	MonthlyBackupRetentionPeriod *int `pulumi:"monthlyBackupRetentionPeriod"`
	// Monthly plan id.
	MonthlyPlanId *string `pulumi:"monthlyPlanId"`
}
...
type InstanceBackupPlanArgs struct {
	...
	// If it is in monthly dimension, the format is numeric characters, such as ["1","2"].
	MonthlyBackupPeriods pulumi.StringArrayInput `pulumi:"monthlyBackupPeriods"`
	// Specify days of the retention.
	MonthlyBackupRetentionPeriod pulumi.IntPtrInput `pulumi:"monthlyBackupRetentionPeriod"`
	// Monthly plan id.
	MonthlyPlanId pulumi.StringPtrInput `pulumi:"monthlyPlanId"`
}
...
// If it is in monthly dimension, the format is numeric characters, such as ["1","2"].
func (o InstanceBackupPlanOutput) MonthlyBackupPeriods() pulumi.StringArrayOutput {
	return o.ApplyT(func(v InstanceBackupPlan) []string { return v.MonthlyBackupPeriods }).(pulumi.StringArrayOutput)
}

// Specify days of the retention.
func (o InstanceBackupPlanOutput) MonthlyBackupRetentionPeriod() pulumi.IntPtrOutput {
	return o.ApplyT(func(v InstanceBackupPlan) *int { return v.MonthlyBackupRetentionPeriod }).(pulumi.IntPtrOutput)
}

// Monthly plan id.
func (o InstanceBackupPlanOutput) MonthlyPlanId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InstanceBackupPlan) *string { return v.MonthlyPlanId }).(pulumi.StringPtrOutput)
}
...
// If it is in monthly dimension, the format is numeric characters, such as ["1","2"].
func (o InstanceBackupPlanPtrOutput) MonthlyBackupPeriods() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InstanceBackupPlan) []string {
		if v == nil {
			return nil
		}
		return v.MonthlyBackupPeriods
	}).(pulumi.StringArrayOutput)
}

// Specify days of the retention.
func (o InstanceBackupPlanPtrOutput) MonthlyBackupRetentionPeriod() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *InstanceBackupPlan) *int {
		if v == nil {
			return nil
		}
		return v.MonthlyBackupRetentionPeriod
	}).(pulumi.IntPtrOutput)
}

// Monthly plan id.
func (o InstanceBackupPlanPtrOutput) MonthlyPlanId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *InstanceBackupPlan) *string {
		if v == nil {
			return nil
		}
		return v.MonthlyPlanId
	}).(pulumi.StringPtrOutput)
}
...
type ParametersParamList struct {
...
// ParametersParamListInput is an input type that accepts ParametersParamListArgs and ParametersParamListOutput values.
// You can construct a concrete instance of `ParametersParamListInput` via:
//
//	ParametersParamListArgs{...}
type ParametersParamListInput interface {
	pulumi.Input

	ToParametersParamListOutput() ParametersParamListOutput
	ToParametersParamListOutputWithContext(context.Context) ParametersParamListOutput
}

type ParametersParamListArgs struct {
	// The default value of the parameter. Returned as a string.
	...
	Name pulumi.StringInput `pulumi:"name"`
	// Parameter Chinese Description.
	ParamDescriptionCh pulumi.StringPtrInput `pulumi:"paramDescriptionCh"`
	// Parameter English Description.
	ParamDescriptionEn pulumi.StringPtrInput `pulumi:"paramDescriptionEn"`
}

func (ParametersParamListArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ParametersParamList)(nil)).Elem()
}

func (i ParametersParamListArgs) ToParametersParamListOutput() ParametersParamListOutput {
	return i.ToParametersParamListOutputWithContext(context.Background())
}

func (i ParametersParamListArgs) ToParametersParamListOutputWithContext(ctx context.Context) ParametersParamListOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ParametersParamListOutput)
}

// ParametersParamListArrayInput is an input type that accepts ParametersParamListArray and ParametersParamListArrayOutput values.
// You can construct a concrete instance of `ParametersParamListArrayInput` via:
//
//	ParametersParamListArray{ ParametersParamListArgs{...} }
type ParametersParamListArrayInput interface {
	pulumi.Input

	ToParametersParamListArrayOutput() ParametersParamListArrayOutput
	ToParametersParamListArrayOutputWithContext(context.Context) ParametersParamListArrayOutput
}

type ParametersParamListArray []ParametersParamListInput

func (ParametersParamListArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ParametersParamList)(nil)).Elem()
}

func (i ParametersParamListArray) ToParametersParamListArrayOutput() ParametersParamListArrayOutput {
	return i.ToParametersParamListArrayOutputWithContext(context.Background())
}

func (i ParametersParamListArray) ToParametersParamListArrayOutputWithContext(ctx context.Context) ParametersParamListArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ParametersParamListArrayOutput)
}

type ParametersParamListOutput struct{ *pulumi.OutputState }

func (ParametersParamListOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ParametersParamList)(nil)).Elem()
}

func (o ParametersParamListOutput) ToParametersParamListOutput() ParametersParamListOutput {
	return o
}

func (o ParametersParamListOutput) ToParametersParamListOutputWithContext(ctx context.Context) ParametersParamListOutput {
	return o
}

// The default value of the parameter. Returned as a string.
func (o ParametersParamListOutput) DefaultValue() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ParametersParamList) *string { return v.DefaultValue }).(pulumi.StringPtrOutput)
}

// The new value to which the parameter will be modified. When this parameter is used as an input parameter, its value must be a string, such as `0.1` (decimal), `1000` (integer), and `replica` (enum).
func (o ParametersParamListOutput) ExpectedValue() pulumi.StringOutput {
	return o.ApplyT(func(v ParametersParamList) string { return v.ExpectedValue }).(pulumi.StringOutput)
}

// Parameter name.
func (o ParametersParamListOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v ParametersParamList) string { return v.Name }).(pulumi.StringOutput)
}

// Parameter Chinese Description.
func (o ParametersParamListOutput) ParamDescriptionCh() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ParametersParamList) *string { return v.ParamDescriptionCh }).(pulumi.StringPtrOutput)
}

// Parameter English Description.
func (o ParametersParamListOutput) ParamDescriptionEn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ParametersParamList) *string { return v.ParamDescriptionEn }).(pulumi.StringPtrOutput)
}

type ParametersParamListArrayOutput struct{ *pulumi.OutputState }

func (ParametersParamListArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]ParametersParamList)(nil)).Elem()
}

func (o ParametersParamListArrayOutput) ToParametersParamListArrayOutput() ParametersParamListArrayOutput {
	return o
}

func (o ParametersParamListArrayOutput) ToParametersParamListArrayOutputWithContext(ctx context.Context) ParametersParamListArrayOutput {
	return o
}

func (o ParametersParamListArrayOutput) Index(i pulumi.IntInput) ParametersParamListOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) ParametersParamList {
		return vs[0].([]ParametersParamList)[vs[1].(int)]
	}).(ParametersParamListOutput)
}
...
type GetDbVersionsVersionSet struct {
...
// GetDbVersionsVersionSetInput is an input type that accepts GetDbVersionsVersionSetArgs and GetDbVersionsVersionSetOutput values.
// You can construct a concrete instance of `GetDbVersionsVersionSetInput` via:
//
//	GetDbVersionsVersionSetArgs{...}
type GetDbVersionsVersionSetInput interface {
	pulumi.Input

	ToGetDbVersionsVersionSetOutput() GetDbVersionsVersionSetOutput
	ToGetDbVersionsVersionSetOutputWithContext(context.Context) GetDbVersionsVersionSetOutput
}

type GetDbVersionsVersionSetArgs struct {
	// List of versions to which this database version (`DBKernelVersion`) can be upgraded, including minor and major version numbers available for upgrade (complete kernel version format example: v15.1_v1.6).
	AvailableUpgradeTargets pulumi.StringArrayInput `pulumi:"availableUpgradeTargets"`
	// Database engines. Valid values:
	// 1. `postgresql` (TencentDB for PostgreSQL)
...
func (GetDbVersionsVersionSetArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetDbVersionsVersionSet)(nil)).Elem()
}

func (i GetDbVersionsVersionSetArgs) ToGetDbVersionsVersionSetOutput() GetDbVersionsVersionSetOutput {
	return i.ToGetDbVersionsVersionSetOutputWithContext(context.Background())
}

func (i GetDbVersionsVersionSetArgs) ToGetDbVersionsVersionSetOutputWithContext(ctx context.Context) GetDbVersionsVersionSetOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetDbVersionsVersionSetOutput)
}

// GetDbVersionsVersionSetArrayInput is an input type that accepts GetDbVersionsVersionSetArray and GetDbVersionsVersionSetArrayOutput values.
// You can construct a concrete instance of `GetDbVersionsVersionSetArrayInput` via:
//
//	GetDbVersionsVersionSetArray{ GetDbVersionsVersionSetArgs{...} }
type GetDbVersionsVersionSetArrayInput interface {
	pulumi.Input

	ToGetDbVersionsVersionSetArrayOutput() GetDbVersionsVersionSetArrayOutput
	ToGetDbVersionsVersionSetArrayOutputWithContext(context.Context) GetDbVersionsVersionSetArrayOutput
}

type GetDbVersionsVersionSetArray []GetDbVersionsVersionSetInput

func (GetDbVersionsVersionSetArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetDbVersionsVersionSet)(nil)).Elem()
}

func (i GetDbVersionsVersionSetArray) ToGetDbVersionsVersionSetArrayOutput() GetDbVersionsVersionSetArrayOutput {
	return i.ToGetDbVersionsVersionSetArrayOutputWithContext(context.Background())
}

func (i GetDbVersionsVersionSetArray) ToGetDbVersionsVersionSetArrayOutputWithContext(ctx context.Context) GetDbVersionsVersionSetArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetDbVersionsVersionSetArrayOutput)
}

type GetDbVersionsVersionSetOutput struct{ *pulumi.OutputState }

func (GetDbVersionsVersionSetOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetDbVersionsVersionSet)(nil)).Elem()
}

func (o GetDbVersionsVersionSetOutput) ToGetDbVersionsVersionSetOutput() GetDbVersionsVersionSetOutput {
	return o
}

func (o GetDbVersionsVersionSetOutput) ToGetDbVersionsVersionSetOutputWithContext(ctx context.Context) GetDbVersionsVersionSetOutput {
	return o
}

// List of versions to which this database version (`DBKernelVersion`) can be upgraded, including minor and major version numbers available for upgrade (complete kernel version format example: v15.1_v1.6).
func (o GetDbVersionsVersionSetOutput) AvailableUpgradeTargets() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) []string { return v.AvailableUpgradeTargets }).(pulumi.StringArrayOutput)
}

// Database engines. Valid values:
// 1. `postgresql` (TencentDB for PostgreSQL)
// 2. `mssqlCompatible` (MSSQL compatible-TencentDB for PostgreSQL).
func (o GetDbVersionsVersionSetOutput) DbEngine() pulumi.StringOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) string { return v.DbEngine }).(pulumi.StringOutput)
}

// PostgreSQL kernel version number.
func (o GetDbVersionsVersionSetOutput) DbKernelVersion() pulumi.StringOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) string { return v.DbKernelVersion }).(pulumi.StringOutput)
}

// PostgreSQL major version number.
func (o GetDbVersionsVersionSetOutput) DbMajorVersion() pulumi.StringOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) string { return v.DbMajorVersion }).(pulumi.StringOutput)
}

// Version of the postgresql database engine.
func (o GetDbVersionsVersionSetOutput) DbVersion() pulumi.StringOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) string { return v.DbVersion }).(pulumi.StringOutput)
}

// Database version status. Valid values:
// `AVAILABLE`.
// `DEPRECATED`.
func (o GetDbVersionsVersionSetOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) string { return v.Status }).(pulumi.StringOutput)
}

// List of features supported by the database kernel, such as:
// TDE: Supports data encryption.
func (o GetDbVersionsVersionSetOutput) SupportedFeatureNames() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetDbVersionsVersionSet) []string { return v.SupportedFeatureNames }).(pulumi.StringArrayOutput)
}

type GetDbVersionsVersionSetArrayOutput struct{ *pulumi.OutputState }

func (GetDbVersionsVersionSetArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetDbVersionsVersionSet)(nil)).Elem()
}

func (o GetDbVersionsVersionSetArrayOutput) ToGetDbVersionsVersionSetArrayOutput() GetDbVersionsVersionSetArrayOutput {
	return o
}

func (o GetDbVersionsVersionSetArrayOutput) ToGetDbVersionsVersionSetArrayOutputWithContext(ctx context.Context) GetDbVersionsVersionSetArrayOutput {
	return o
}

func (o GetDbVersionsVersionSetArrayOutput) Index(i pulumi.IntInput) GetDbVersionsVersionSetOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetDbVersionsVersionSet {
		return vs[0].([]GetDbVersionsVersionSet)[vs[1].(int)]
	}).(GetDbVersionsVersionSetOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ParametersParamListArrayInput)(nil)).Elem(), ParametersParamListArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetDbVersionsVersionSetArrayInput)(nil)).Elem(), GetDbVersionsVersionSetArray{})
	...
	pulumi.RegisterOutputType(ParametersParamListArrayOutput{})
	...
	pulumi.RegisterOutputType(GetDbVersionsVersionSetArrayOutput{})
