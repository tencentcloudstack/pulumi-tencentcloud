...
//			exampleReadonlyGroup, err := postgresql.NewReadonlyGroup(ctx, "example", &postgresql.ReadonlyGroupArgs{
...
//			}
//			// create postgresql readonly instance
//			_, err = postgresql.NewReadonlyInstance(ctx, "example", &postgresql.ReadonlyInstanceArgs{
