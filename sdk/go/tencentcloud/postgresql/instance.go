...
//
// > **Note:** If you need to upgrade the database version, Please use data source `Postgresql.getDbVersions` to obtain the valid version value for `dbKernelVersion`, `dbMajorVersion` and `engineVersion`. And when modifying, `dbKernelVersion`, `dbMajorVersion` and `engineVersion` must be set.
//
...
type Instance struct {
	...
	KmsClusterId pulumi.StringOutput `pulumi:"kmsClusterId"`
...
func NewInstance(ctx *pulumi.Context,
	...
	if args.RootPassword != nil {
		args.RootPassword = pulumi.ToSecret(args.RootPassword).(pulumi.StringInput)
	}
...
type instanceState struct {
	...
	// Specify the cluster served by KMS. If KMSClusterId is blank, use the KMS of the default cluster. If you choose to specify a KMS cluster, you need to pass in KMSClusterId.
	KmsClusterId *string `pulumi:"kmsClusterId"`
	// KeyId of the custom key.
...
type InstanceState struct {
	...
	// Specify the cluster served by KMS. If KMSClusterId is blank, use the KMS of the default cluster. If you choose to specify a KMS cluster, you need to pass in KMSClusterId.
	KmsClusterId pulumi.StringPtrInput
	// KeyId of the custom key.
...
// Specify the cluster served by KMS. If KMSClusterId is blank, use the KMS of the default cluster. If you choose to specify a KMS cluster, you need to pass in KMSClusterId.
func (o InstanceOutput) KmsClusterId() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.KmsClusterId }).(pulumi.StringOutput)
}
