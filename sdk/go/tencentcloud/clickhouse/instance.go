...
type Instance struct {
	...
	// access address info.
	AccessInfo pulumi.StringOutput `pulumi:"accessInfo"`
	...
	CkDefaultUserPwd pulumi.StringPtrOutput `pulumi:"ckDefaultUserPwd"`
	// CLS log set id.
	...
	// Secondary zone info.
	SecondaryZoneInfos InstanceSecondaryZoneInfoArrayOutput `pulumi:"secondaryZoneInfos"`
	// Subnet.
...
func NewInstance(ctx *pulumi.Context,
	...
	if args.CkDefaultUserPwd != nil {
		args.CkDefaultUserPwd = pulumi.ToSecret(args.CkDefaultUserPwd).(pulumi.StringPtrInput)
	}
...
type instanceState struct {
	...
	// The password for the default account to log in to the instance. 8-16 characters, including at least three of the following: uppercase letters, lowercase letters, numbers, and special characters `!@#%^*`. The first character cannot be a special character.
	CkDefaultUserPwd *string `pulumi:"ckDefaultUserPwd"`
	// CLS log set id.
	...
	// Secondary zone info.
	SecondaryZoneInfos []InstanceSecondaryZoneInfo `pulumi:"secondaryZoneInfos"`
	// Subnet.
...
type InstanceState struct {
	// access address info.
	AccessInfo pulumi.StringPtrInput
	// Billing type: `PREPAID` prepaid, `POSTPAID_BY_HOUR` postpaid.
	ChargeType pulumi.StringPtrInput
	// The password for the default account to log in to the instance. 8-16 characters, including at least three of the following: uppercase letters, lowercase letters, numbers, and special characters `!@#%^*`. The first character cannot be a special character.
	CkDefaultUserPwd pulumi.StringPtrInput
	// CLS log set id.
	...
	// Secondary zone info.
	SecondaryZoneInfos InstanceSecondaryZoneInfoArrayInput
	// Subnet.
...
// access address info.
func (o InstanceOutput) AccessInfo() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.AccessInfo }).(pulumi.StringOutput)
}
...
// The password for the default account to log in to the instance. 8-16 characters, including at least three of the following: uppercase letters, lowercase letters, numbers, and special characters `!@#%^*`. The first character cannot be a special character.
func (o InstanceOutput) CkDefaultUserPwd() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringPtrOutput { return v.CkDefaultUserPwd }).(pulumi.StringPtrOutput)
}
...
// Secondary zone info.
func (o InstanceOutput) SecondaryZoneInfos() InstanceSecondaryZoneInfoArrayOutput {
	return o.ApplyT(func(v *Instance) InstanceSecondaryZoneInfoArrayOutput { return v.SecondaryZoneInfos }).(InstanceSecondaryZoneInfoArrayOutput)
}
