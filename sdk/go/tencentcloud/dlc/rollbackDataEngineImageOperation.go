...
//			example, err := dlc.GetCheckDataEngineImageCanBeRollback(ctx, &dlc.GetCheckDataEngineImageCanBeRollbackArgs{
//				DataEngineId: "DataEngine-cgkvbas6",
//			}, nil)
//			if err != nil {
//				return err
//			}
//			_, err = dlc.NewRollbackDataEngineImageOperation(ctx, "example", &dlc.RollbackDataEngineImageOperationArgs{
