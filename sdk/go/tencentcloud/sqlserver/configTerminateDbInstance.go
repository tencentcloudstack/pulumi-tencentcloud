...
// 		_, err := Sqlserver.NewConfigTerminateDbInstance(ctx, "configTerminateDbInstance", &Sqlserver.ConfigTerminateDbInstanceArgs{
// 			InstanceId: pulumi.String("mssql-4tgeyeeh"),
// 		})
// 		if err != nil {
// 			return err
// 		}
