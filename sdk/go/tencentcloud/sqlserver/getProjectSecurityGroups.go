...
func GetProjectSecurityGroupsOutput(ctx *pulumi.Context, args GetProjectSecurityGroupsOutputArgs, opts ...pulumi.InvokeOption) GetProjectSecurityGroupsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Sqlserver/getProjectSecurityGroups:getProjectSecurityGroups", args, GetProjectSecurityGroupsResultOutput{}, options).(GetProjectSecurityGroupsResultOutput)
}
