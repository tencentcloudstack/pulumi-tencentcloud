...
// Internet address domain name.
func (o InstanceOutput) DnsPodDomain() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.DnsPodDomain }).(pulumi.StringOutput)
}
...
// External port number.
func (o InstanceOutput) TgwWanVport() pulumi.IntOutput {
	return o.ApplyT(func(v *Instance) pulumi.IntOutput { return v.TgwWanVport }).(pulumi.IntOutput)
}
