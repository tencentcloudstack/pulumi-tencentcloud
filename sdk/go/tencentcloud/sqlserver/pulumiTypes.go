...
type WanIpConfigRoGroup struct {
...
// WanIpConfigRoGroupInput is an input type that accepts WanIpConfigRoGroupArgs and WanIpConfigRoGroupOutput values.
// You can construct a concrete instance of `WanIpConfigRoGroupInput` via:
//
//	WanIpConfigRoGroupArgs{...}
type WanIpConfigRoGroupInput interface {
	pulumi.Input

	ToWanIpConfigRoGroupOutput() WanIpConfigRoGroupOutput
	ToWanIpConfigRoGroupOutputWithContext(context.Context) WanIpConfigRoGroupOutput
}

type WanIpConfigRoGroupArgs struct {
	// Internet address domain name.
	DnsPodDomain pulumi.StringPtrInput `pulumi:"dnsPodDomain"`
	// External port number.
	TgwWanVport pulumi.IntPtrInput `pulumi:"tgwWanVport"`
}

func (WanIpConfigRoGroupArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*WanIpConfigRoGroup)(nil)).Elem()
}

func (i WanIpConfigRoGroupArgs) ToWanIpConfigRoGroupOutput() WanIpConfigRoGroupOutput {
	return i.ToWanIpConfigRoGroupOutputWithContext(context.Background())
}

func (i WanIpConfigRoGroupArgs) ToWanIpConfigRoGroupOutputWithContext(ctx context.Context) WanIpConfigRoGroupOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WanIpConfigRoGroupOutput)
}

// WanIpConfigRoGroupArrayInput is an input type that accepts WanIpConfigRoGroupArray and WanIpConfigRoGroupArrayOutput values.
// You can construct a concrete instance of `WanIpConfigRoGroupArrayInput` via:
//
//	WanIpConfigRoGroupArray{ WanIpConfigRoGroupArgs{...} }
type WanIpConfigRoGroupArrayInput interface {
	pulumi.Input

	ToWanIpConfigRoGroupArrayOutput() WanIpConfigRoGroupArrayOutput
	ToWanIpConfigRoGroupArrayOutputWithContext(context.Context) WanIpConfigRoGroupArrayOutput
}

type WanIpConfigRoGroupArray []WanIpConfigRoGroupInput

func (WanIpConfigRoGroupArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]WanIpConfigRoGroup)(nil)).Elem()
}

func (i WanIpConfigRoGroupArray) ToWanIpConfigRoGroupArrayOutput() WanIpConfigRoGroupArrayOutput {
	return i.ToWanIpConfigRoGroupArrayOutputWithContext(context.Background())
}

func (i WanIpConfigRoGroupArray) ToWanIpConfigRoGroupArrayOutputWithContext(ctx context.Context) WanIpConfigRoGroupArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(WanIpConfigRoGroupArrayOutput)
}

type WanIpConfigRoGroupOutput struct{ *pulumi.OutputState }

func (WanIpConfigRoGroupOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*WanIpConfigRoGroup)(nil)).Elem()
}

func (o WanIpConfigRoGroupOutput) ToWanIpConfigRoGroupOutput() WanIpConfigRoGroupOutput {
	return o
}

func (o WanIpConfigRoGroupOutput) ToWanIpConfigRoGroupOutputWithContext(ctx context.Context) WanIpConfigRoGroupOutput {
	return o
}

// Internet address domain name.
func (o WanIpConfigRoGroupOutput) DnsPodDomain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v WanIpConfigRoGroup) *string { return v.DnsPodDomain }).(pulumi.StringPtrOutput)
}

// External port number.
func (o WanIpConfigRoGroupOutput) TgwWanVport() pulumi.IntPtrOutput {
	return o.ApplyT(func(v WanIpConfigRoGroup) *int { return v.TgwWanVport }).(pulumi.IntPtrOutput)
}

type WanIpConfigRoGroupArrayOutput struct{ *pulumi.OutputState }

func (WanIpConfigRoGroupArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]WanIpConfigRoGroup)(nil)).Elem()
}

func (o WanIpConfigRoGroupArrayOutput) ToWanIpConfigRoGroupArrayOutput() WanIpConfigRoGroupArrayOutput {
	return o
}

func (o WanIpConfigRoGroupArrayOutput) ToWanIpConfigRoGroupArrayOutputWithContext(ctx context.Context) WanIpConfigRoGroupArrayOutput {
	return o
}

func (o WanIpConfigRoGroupArrayOutput) Index(i pulumi.IntInput) WanIpConfigRoGroupOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) WanIpConfigRoGroup {
		return vs[0].([]WanIpConfigRoGroup)[vs[1].(int)]
	}).(WanIpConfigRoGroupOutput)
}
...
// Tags of the SQL Server basic instance.
func (o GetBasicInstancesInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetBasicInstancesInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*WanIpConfigRoGroupInput)(nil)).Elem(), WanIpConfigRoGroupArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*WanIpConfigRoGroupArrayInput)(nil)).Elem(), WanIpConfigRoGroupArray{})
	...
	pulumi.RegisterOutputType(WanIpConfigRoGroupOutput{})
	pulumi.RegisterOutputType(WanIpConfigRoGroupArrayOutput{})
