...
//				InstanceId: exampleDb.ID().ToIDOutput().ToStringOutput(),
...
func GetBackupByFlowIdOutput(ctx *pulumi.Context, args GetBackupByFlowIdOutputArgs, opts ...pulumi.InvokeOption) GetBackupByFlowIdResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Sqlserver/getBackupByFlowId:getBackupByFlowId", args, GetBackupByFlowIdResultOutput{}, options).(GetBackupByFlowIdResultOutput)
}
