...
func GetBackupByFlowIdOutput(ctx *pulumi.Context, args GetBackupByFlowIdOutputArgs, opts ...pulumi.InvokeOption) GetBackupByFlowIdResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetBackupByFlowIdResultOutput, error) {
			args := v.(GetBackupByFlowIdArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("tencentcloud:Sqlserver/getBackupByFlowId:getBackupByFlowId", args, GetBackupByFlowIdResultOutput{}, options).(GetBackupByFlowIdResultOutput), nil
