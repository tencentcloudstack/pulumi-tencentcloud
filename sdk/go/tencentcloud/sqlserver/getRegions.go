...
//			_, err := sqlserver.GetRegions(ctx, &sqlserver.GetRegionsArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetRegionsOutput(ctx *pulumi.Context, args GetRegionsOutputArgs, opts ...pulumi.InvokeOption) GetRegionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetRegionsResultOutput, error) {
			...
			return ctx.InvokeOutput("tencentcloud:Sqlserver/getRegions:getRegions", args, GetRegionsResultOutput{}, options).(GetRegionsResultOutput), nil
