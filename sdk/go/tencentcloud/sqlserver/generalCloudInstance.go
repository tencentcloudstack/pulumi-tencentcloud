...
type GeneralCloudInstance struct {
	...
	DiskEncryptFlag pulumi.IntPtrOutput `pulumi:"diskEncryptFlag"`
	...
	DrZones pulumi.StringArrayOutput `pulumi:"drZones"`
	...
	MultiNodes pulumi.BoolOutput `pulumi:"multiNodes"`
...
type generalCloudInstanceState struct {
	...
	// Whether it is a multi-node architecture instance, the default value is false. When MultiNodes = true, the parameter MultiZones must be true.
	MultiNodes *bool `pulumi:"multiNodes"`
	// Whether to deploy across availability zones, the default value is false.
...
type GeneralCloudInstanceState struct {
	...
	// The standby node availability area is empty by default. When MultiNodes = true, the primary node and standby node availability areas cannot all be the same. The minimum number of standby availability areas set is 2, and the maximum number is no more than 5.
	DrZones pulumi.StringArrayInput
	// It has been deprecated from version 1.81.2. Upgrade the high-availability architecture of sqlserver, upgrade from mirror disaster recovery to always on cluster disaster recovery, only support 2017 and above and support always on high-availability instances, do not support downgrading to mirror disaster recovery, CLUSTER-upgrade to always on capacity Disaster, if not filled, the high-availability architecture will not be modified.
	//
	// Deprecated: It has been deprecated from version 1.81.2.
	...
	// Whether it is a multi-node architecture instance, the default value is false. When MultiNodes = true, the parameter MultiZones must be true.
	MultiNodes pulumi.BoolPtrInput
	// Whether to deploy across availability zones, the default value is false.
...
// Disk encryption identification, 0-not encrypted, 1-encrypted.
func (o GeneralCloudInstanceOutput) DiskEncryptFlag() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.IntPtrOutput { return v.DiskEncryptFlag }).(pulumi.IntPtrOutput)
}

// Internet address domain name.
func (o GeneralCloudInstanceOutput) DnsPodDomain() pulumi.StringOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.StringOutput { return v.DnsPodDomain }).(pulumi.StringOutput)
}

// The standby node availability area is empty by default. When MultiNodes = true, the primary node and standby node availability areas cannot all be the same. The minimum number of standby availability areas set is 2, and the maximum number is no more than 5.
func (o GeneralCloudInstanceOutput) DrZones() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.StringArrayOutput { return v.DrZones }).(pulumi.StringArrayOutput)
}
...
// Whether it is a multi-node architecture instance, the default value is false. When MultiNodes = true, the parameter MultiZones must be true.
func (o GeneralCloudInstanceOutput) MultiNodes() pulumi.BoolOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.BoolOutput { return v.MultiNodes }).(pulumi.BoolOutput)
}

// Whether to deploy across availability zones, the default value is false.
func (o GeneralCloudInstanceOutput) MultiZones() pulumi.BoolOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.BoolOutput { return v.MultiZones }).(pulumi.BoolOutput)
}
...
// External port number.
func (o GeneralCloudInstanceOutput) TgwWanVport() pulumi.IntOutput {
	return o.ApplyT(func(v *GeneralCloudInstance) pulumi.IntOutput { return v.TgwWanVport }).(pulumi.IntOutput)
}
