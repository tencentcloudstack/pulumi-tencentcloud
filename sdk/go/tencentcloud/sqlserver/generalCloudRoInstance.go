...
//				return err
//			}
//			example, err := sqlserver.NewGeneralCloudInstance(ctx, "example", &sqlserver.GeneralCloudInstanceArgs{
...
// Tag description list.
func (o GeneralCloudRoInstanceOutput) ResourceTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *GeneralCloudRoInstance) pulumi.StringMapOutput { return v.ResourceTags }).(pulumi.StringMapOutput)
}
