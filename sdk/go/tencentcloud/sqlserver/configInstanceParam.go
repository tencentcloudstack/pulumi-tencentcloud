...
// 		_, err := Sqlserver.NewConfigInstanceParam(ctx, "configInstanceParam", &Sqlserver.ConfigInstanceParamArgs{
// 			InstanceId: pulumi.Any(tencentcloud_sqlserver_instance.Test.Id),
