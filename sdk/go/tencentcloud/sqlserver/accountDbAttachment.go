...
//				return err
//			}
//			exampleAccount, err := sqlserver.NewAccount(ctx, "example", &sqlserver.AccountArgs{
//				InstanceId: example.ID(),
...
//				return err
//			}
//			_, err = sqlserver.NewAccountDbAttachment(ctx, "example", &sqlserver.AccountDbAttachmentArgs{
//				InstanceId:  example.ID(),
