...
//				return err
//			}
//			exampleConfigTerminateDbInstance, err := sqlserver.NewConfigTerminateDbInstance(ctx, "example", &sqlserver.ConfigTerminateDbInstanceArgs{
//				InstanceId: example.ID().ToIDOutput().ToStringOutput(),
//			})
//			if err != nil {
//				return err
//			}
//			_, err = sqlserver.NewRenewPostpaidDbInstance(ctx, "example", &sqlserver.RenewPostpaidDbInstanceArgs{
//				InstanceId: exampleConfigTerminateDbInstance.ID().ToIDOutput().ToStringOutput(),
//			})
//			if err != nil {
//				return err
//			}
