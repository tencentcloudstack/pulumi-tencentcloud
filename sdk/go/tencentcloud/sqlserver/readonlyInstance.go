...
//				return err
//			}
//			example, err := sqlserver.NewInstance(ctx, "example", &sqlserver.InstanceArgs{
...
//				return err
//			}
//			_, err = sqlserver.NewReadonlyInstance(ctx, "example", &sqlserver.ReadonlyInstanceArgs{
...
// Internet address domain name.
func (o ReadonlyInstanceOutput) DnsPodDomain() pulumi.StringOutput {
	return o.ApplyT(func(v *ReadonlyInstance) pulumi.StringOutput { return v.DnsPodDomain }).(pulumi.StringOutput)
}
...
// Instance type.
func (o ReadonlyInstanceOutput) HaType() pulumi.StringOutput {
	return o.ApplyT(func(v *ReadonlyInstance) pulumi.StringOutput { return v.HaType }).(pulumi.StringOutput)
}
...
// External port number.
func (o ReadonlyInstanceOutput) TgwWanVport() pulumi.IntOutput {
	return o.ApplyT(func(v *ReadonlyInstance) pulumi.IntOutput { return v.TgwWanVport }).(pulumi.IntOutput)
}

// System time zone, default: `China Standard Time`.
func (o ReadonlyInstanceOutput) TimeZone() pulumi.StringOutput {
	return o.ApplyT(func(v *ReadonlyInstance) pulumi.StringOutput { return v.TimeZone }).(pulumi.StringOutput)
}
