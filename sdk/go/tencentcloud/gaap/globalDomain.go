...
//			_, err := gaap.NewGlobalDomain(ctx, "global_domain", &gaap.GlobalDomainArgs{
...
// Instance tags.
func (o GlobalDomainOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *GlobalDomain) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
