...
//			foo, err := gaap.NewProxy(ctx, "foo", &gaap.ProxyArgs{
...
type DomainErrorPage struct {
	...
	SetHeaders pulumi.StringMapOutput `pulumi:"setHeaders"`
}
...
type DomainErrorPageState struct {
	...
	// Response headers to be set.
	SetHeaders pulumi.StringMapInput
}
...
// Response headers to be set.
func (o DomainErrorPageOutput) SetHeaders() pulumi.StringMapOutput {
	return o.ApplyT(func(v *DomainErrorPage) pulumi.StringMapOutput { return v.SetHeaders }).(pulumi.StringMapOutput)
}
