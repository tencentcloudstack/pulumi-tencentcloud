...
//			_, err := cbs.GetSnapshots(ctx, &cbs.GetSnapshotsArgs{}, nil)
//			if err != nil {
//				return err
//			}
//			return nil
...
func GetSnapshotsOutput(ctx *pulumi.Context, args GetSnapshotsOutputArgs, opts ...pulumi.InvokeOption) GetSnapshotsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSnapshotsResultOutput, error) {
			...
			return ctx.InvokeOutput("tencentcloud:Cbs/getSnapshots:getSnapshots", args, GetSnapshotsResultOutput{}, options).(GetSnapshotsResultOutput), nil
...
// ID of the project within the snapshot.
func (o GetSnapshotsResultOutput) ProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSnapshotsResult) *string { return v.ProjectId }).(pulumi.StringPtrOutput)
}
