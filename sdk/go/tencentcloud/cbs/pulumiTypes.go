...
// Kms key ID.
func (o GetStoragesSetStorageListOutput) KmsKeyId() pulumi.StringOutput {
	return o.ApplyT(func(v GetStoragesSetStorageList) string { return v.KmsKeyId }).(pulumi.StringOutput)
}
...
// The available tags within this CBS.
func (o GetStoragesSetStorageListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetStoragesSetStorageList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
// Kms key ID.
func (o GetStoragesStorageListOutput) KmsKeyId() pulumi.StringOutput {
	return o.ApplyT(func(v GetStoragesStorageList) string { return v.KmsKeyId }).(pulumi.StringOutput)
}
...
// The available tags within this CBS.
func (o GetStoragesStorageListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetStoragesStorageList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
