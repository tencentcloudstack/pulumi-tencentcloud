...
// Tags of secret.
func (o ProductSecretOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ProductSecret) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
