...
//				return err
//			}
//			_, err = ssm.NewSshKeyPairSecret(ctx, "example", &ssm.SshKeyPairSecretArgs{
...
// Tags of secret.
func (o SshKeyPairSecretOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *SshKeyPairSecret) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
