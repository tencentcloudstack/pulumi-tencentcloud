...
// Tags of the scaling group.
func (o GetScalingGroupsResultOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetScalingGroupsResult) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
