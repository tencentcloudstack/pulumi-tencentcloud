...
//				return err
//			}
//			exampleLifecycleHook, err := as.NewLifecycleHook(ctx, "example", &as.LifecycleHookArgs{
...
//				return err
//			}
//			_, err = as.NewCompleteLifecycle(ctx, "complete_lifecycle", &as.CompleteLifecycleArgs{
//				LifecycleHookId:       exampleLifecycleHook.ID().ToIDOutput().ToStringOutput(),
