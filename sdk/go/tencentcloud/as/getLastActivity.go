...
type GetLastActivityArgs struct {
	...
	ExcludeCancelledActivity *bool `pulumi:"excludeCancelledActivity"`
...
type GetLastActivityOutputArgs struct {
	...
	// Exclude cancellation type activities when querying. The default value is false, indicating that cancellation type activities are not excluded.
	ExcludeCancelledActivity pulumi.BoolPtrInput `pulumi:"excludeCancelledActivity"`
	// Used to save results.
...
func (o GetLastActivityResultOutput) ExcludeCancelledActivity() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetLastActivityResult) *bool { return v.ExcludeCancelledActivity }).(pulumi.BoolPtrOutput)
}
