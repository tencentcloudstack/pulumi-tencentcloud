...
// DomainRuleCacheInput is an input type that accepts DomainRuleCacheArgs and DomainRuleCacheOutput values.
// You can construct a concrete instance of `DomainRuleCacheInput` via:
//
//	DomainRuleCacheArgs{...}
type DomainRuleCacheInput interface {
	pulumi.Input

	ToDomainRuleCacheOutput() DomainRuleCacheOutput
	ToDomainRuleCacheOutputWithContext(context.Context) DomainRuleCacheOutput
}

type DomainRuleCacheArgs struct {
	// Cache expiration time setting, the unit is second, the maximum can be set to 365 days.
...
func (DomainRuleCacheArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*DomainRuleCache)(nil)).Elem()
}

func (i DomainRuleCacheArgs) ToDomainRuleCacheOutput() DomainRuleCacheOutput {
	return i.ToDomainRuleCacheOutputWithContext(context.Background())
}

func (i DomainRuleCacheArgs) ToDomainRuleCacheOutputWithContext(ctx context.Context) DomainRuleCacheOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DomainRuleCacheOutput)
}

// DomainRuleCacheArrayInput is an input type that accepts DomainRuleCacheArray and DomainRuleCacheArrayOutput values.
// You can construct a concrete instance of `DomainRuleCacheArrayInput` via:
//
//	DomainRuleCacheArray{ DomainRuleCacheArgs{...} }
type DomainRuleCacheArrayInput interface {
	pulumi.Input

	ToDomainRuleCacheArrayOutput() DomainRuleCacheArrayOutput
	ToDomainRuleCacheArrayOutputWithContext(context.Context) DomainRuleCacheArrayOutput
}

type DomainRuleCacheArray []DomainRuleCacheInput

func (DomainRuleCacheArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DomainRuleCache)(nil)).Elem()
}

func (i DomainRuleCacheArray) ToDomainRuleCacheArrayOutput() DomainRuleCacheArrayOutput {
	return i.ToDomainRuleCacheArrayOutputWithContext(context.Background())
}

func (i DomainRuleCacheArray) ToDomainRuleCacheArrayOutputWithContext(ctx context.Context) DomainRuleCacheArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DomainRuleCacheArrayOutput)
}

type DomainRuleCacheOutput struct{ *pulumi.OutputState }

func (DomainRuleCacheOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*DomainRuleCache)(nil)).Elem()
}

func (o DomainRuleCacheOutput) ToDomainRuleCacheOutput() DomainRuleCacheOutput {
	return o
}

func (o DomainRuleCacheOutput) ToDomainRuleCacheOutputWithContext(ctx context.Context) DomainRuleCacheOutput {
	return o
}

// Cache expiration time setting, the unit is second, the maximum can be set to 365 days.
func (o DomainRuleCacheOutput) CacheTime() pulumi.IntOutput {
	return o.ApplyT(func(v DomainRuleCache) int { return v.CacheTime }).(pulumi.IntOutput)
}

// Advanced cache expiration configuration. When it is turned on, it will compare the max-age value returned by the origin site with the cache expiration time set in CacheRules, and take the minimum value to cache at the node. Valid values are `on` and `off`. Default value is `off`.
func (o DomainRuleCacheOutput) CompareMaxAge() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.CompareMaxAge }).(pulumi.StringPtrOutput)
}

// Follow the source station configuration switch. Valid values are `on` and `off`.
func (o DomainRuleCacheOutput) FollowOriginSwitch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.FollowOriginSwitch }).(pulumi.StringPtrOutput)
}

// Specify whether to enable heuristic cache, only available while `followOriginSwitch` enabled, values: `on`, `off` (Default).
func (o DomainRuleCacheOutput) HeuristicCacheSwitch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.HeuristicCacheSwitch }).(pulumi.StringPtrOutput)
}

// Specify heuristic cache time in second, only available while `followOriginSwitch` and `heuristicCacheSwitch` enabled.
func (o DomainRuleCacheOutput) HeuristicCacheTime() pulumi.IntPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *int { return v.HeuristicCacheTime }).(pulumi.IntPtrOutput)
}

// Force caching. After opening, the no-store and no-cache resources returned by the origin site will also be cached in accordance with the CacheRules rules. Valid values are `on` and `off`. Default value is `off`.
func (o DomainRuleCacheOutput) IgnoreCacheControl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.IgnoreCacheControl }).(pulumi.StringPtrOutput)
}

// Ignore the Set-Cookie header of the origin site. Valid values are `on` and `off`. Default value is `off`. This parameter is for white-list customer.
func (o DomainRuleCacheOutput) IgnoreSetCookie() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.IgnoreSetCookie }).(pulumi.StringPtrOutput)
}

// Cache configuration switch. Valid values are `on` and `off`.
func (o DomainRuleCacheOutput) NoCacheSwitch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.NoCacheSwitch }).(pulumi.StringPtrOutput)
}

// Always check back to origin. Valid values are `on` and `off`. Default value is `off`.
func (o DomainRuleCacheOutput) ReValidate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.ReValidate }).(pulumi.StringPtrOutput)
}

// Matching content under the corresponding type of CacheType: `all`: fill *, `file`: fill in the suffix name, such as jpg, txt, `directory`: fill in the path, such as /xxx/test, `path`: fill in the absolute path, such as /xxx/test.html, `index`: fill /.
func (o DomainRuleCacheOutput) RulePaths() pulumi.StringArrayOutput {
	return o.ApplyT(func(v DomainRuleCache) []string { return v.RulePaths }).(pulumi.StringArrayOutput)
}

// Rule type. The following types are supported: `all`: all documents take effect, `file`: the specified file suffix takes effect, `directory`: the specified path takes effect, `path`: specify the absolute path to take effect, `index`: home page.
func (o DomainRuleCacheOutput) RuleType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.RuleType }).(pulumi.StringPtrOutput)
}

// Cache configuration switch. Valid values are `on` and `off`.
func (o DomainRuleCacheOutput) Switch() pulumi.StringPtrOutput {
	return o.ApplyT(func(v DomainRuleCache) *string { return v.Switch }).(pulumi.StringPtrOutput)
}

type DomainRuleCacheArrayOutput struct{ *pulumi.OutputState }

func (DomainRuleCacheArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]DomainRuleCache)(nil)).Elem()
}

func (o DomainRuleCacheArrayOutput) ToDomainRuleCacheArrayOutput() DomainRuleCacheArrayOutput {
	return o
}

func (o DomainRuleCacheArrayOutput) ToDomainRuleCacheArrayOutputWithContext(ctx context.Context) DomainRuleCacheArrayOutput {
	return o
}

func (o DomainRuleCacheArrayOutput) Index(i pulumi.IntInput) DomainRuleCacheOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) DomainRuleCache {
		return vs[0].([]DomainRuleCache)[vs[1].(int)]
	}).(DomainRuleCacheOutput)
}
...
type GetDomainsDomainList struct {
	...
	RuleCaches []GetDomainsDomainListRuleCache `pulumi:"ruleCaches"`
...
type GetDomainsDomainListArgs struct {
	...
	// Advanced path cache configuration.
	RuleCaches GetDomainsDomainListRuleCacheArrayInput `pulumi:"ruleCaches"`
	// Service type of acceleration domain name. The available value include `web`, `download` and `media`.
...
// Advanced path cache configuration.
func (o GetDomainsDomainListOutput) RuleCaches() GetDomainsDomainListRuleCacheArrayOutput {
	return o.ApplyT(func(v GetDomainsDomainList) []GetDomainsDomainListRuleCache { return v.RuleCaches }).(GetDomainsDomainListRuleCacheArrayOutput)
}
...
// Tags of cdn domain.
func (o GetDomainsDomainListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetDomainsDomainList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
type GetDomainsDomainListRuleCache struct {
...
// GetDomainsDomainListRuleCacheInput is an input type that accepts GetDomainsDomainListRuleCacheArgs and GetDomainsDomainListRuleCacheOutput values.
// You can construct a concrete instance of `GetDomainsDomainListRuleCacheInput` via:
//
//	GetDomainsDomainListRuleCacheArgs{...}
type GetDomainsDomainListRuleCacheInput interface {
	pulumi.Input

	ToGetDomainsDomainListRuleCacheOutput() GetDomainsDomainListRuleCacheOutput
	ToGetDomainsDomainListRuleCacheOutputWithContext(context.Context) GetDomainsDomainListRuleCacheOutput
}

type GetDomainsDomainListRuleCacheArgs struct {
	// Cache expiration time setting, the unit is second.
	CacheTime pulumi.IntInput `pulumi:"cacheTime"`
	// Advanced cache expiration configuration.
	CompareMaxAge pulumi.StringPtrInput `pulumi:"compareMaxAge"`
...
func (GetDomainsDomainListRuleCacheArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetDomainsDomainListRuleCache)(nil)).Elem()
}

func (i GetDomainsDomainListRuleCacheArgs) ToGetDomainsDomainListRuleCacheOutput() GetDomainsDomainListRuleCacheOutput {
	return i.ToGetDomainsDomainListRuleCacheOutputWithContext(context.Background())
}

func (i GetDomainsDomainListRuleCacheArgs) ToGetDomainsDomainListRuleCacheOutputWithContext(ctx context.Context) GetDomainsDomainListRuleCacheOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetDomainsDomainListRuleCacheOutput)
}

// GetDomainsDomainListRuleCacheArrayInput is an input type that accepts GetDomainsDomainListRuleCacheArray and GetDomainsDomainListRuleCacheArrayOutput values.
// You can construct a concrete instance of `GetDomainsDomainListRuleCacheArrayInput` via:
//
//	GetDomainsDomainListRuleCacheArray{ GetDomainsDomainListRuleCacheArgs{...} }
type GetDomainsDomainListRuleCacheArrayInput interface {
	pulumi.Input

	ToGetDomainsDomainListRuleCacheArrayOutput() GetDomainsDomainListRuleCacheArrayOutput
	ToGetDomainsDomainListRuleCacheArrayOutputWithContext(context.Context) GetDomainsDomainListRuleCacheArrayOutput
}

type GetDomainsDomainListRuleCacheArray []GetDomainsDomainListRuleCacheInput

func (GetDomainsDomainListRuleCacheArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetDomainsDomainListRuleCache)(nil)).Elem()
}

func (i GetDomainsDomainListRuleCacheArray) ToGetDomainsDomainListRuleCacheArrayOutput() GetDomainsDomainListRuleCacheArrayOutput {
	return i.ToGetDomainsDomainListRuleCacheArrayOutputWithContext(context.Background())
}

func (i GetDomainsDomainListRuleCacheArray) ToGetDomainsDomainListRuleCacheArrayOutputWithContext(ctx context.Context) GetDomainsDomainListRuleCacheArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetDomainsDomainListRuleCacheArrayOutput)
}

type GetDomainsDomainListRuleCacheOutput struct{ *pulumi.OutputState }

func (GetDomainsDomainListRuleCacheOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetDomainsDomainListRuleCache)(nil)).Elem()
}

func (o GetDomainsDomainListRuleCacheOutput) ToGetDomainsDomainListRuleCacheOutput() GetDomainsDomainListRuleCacheOutput {
	return o
}

func (o GetDomainsDomainListRuleCacheOutput) ToGetDomainsDomainListRuleCacheOutputWithContext(ctx context.Context) GetDomainsDomainListRuleCacheOutput {
	return o
}

// Cache expiration time setting, the unit is second.
func (o GetDomainsDomainListRuleCacheOutput) CacheTime() pulumi.IntOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) int { return v.CacheTime }).(pulumi.IntOutput)
}

// Advanced cache expiration configuration.
func (o GetDomainsDomainListRuleCacheOutput) CompareMaxAge() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) *string { return v.CompareMaxAge }).(pulumi.StringPtrOutput)
}

// Follow the source station configuration switch.
func (o GetDomainsDomainListRuleCacheOutput) FollowOriginSwitch() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.FollowOriginSwitch }).(pulumi.StringOutput)
}

// Force caching. After opening, the no-store and no-cache resources returned by the origin site will also be cached in accordance with the CacheRules rules.
func (o GetDomainsDomainListRuleCacheOutput) IgnoreCacheControl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) *string { return v.IgnoreCacheControl }).(pulumi.StringPtrOutput)
}

// Ignore the Set-Cookie header of the origin site.
func (o GetDomainsDomainListRuleCacheOutput) IgnoreSetCookie() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.IgnoreSetCookie }).(pulumi.StringOutput)
}

// Cache configuration switch.
func (o GetDomainsDomainListRuleCacheOutput) NoCacheSwitch() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.NoCacheSwitch }).(pulumi.StringOutput)
}

// Always check back to origin.
func (o GetDomainsDomainListRuleCacheOutput) ReValidate() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.ReValidate }).(pulumi.StringOutput)
}

// Rule paths.
func (o GetDomainsDomainListRuleCacheOutput) RulePaths() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) []string { return v.RulePaths }).(pulumi.StringArrayOutput)
}

// Rule type.
func (o GetDomainsDomainListRuleCacheOutput) RuleType() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.RuleType }).(pulumi.StringOutput)
}

// Cache configuration switch.
func (o GetDomainsDomainListRuleCacheOutput) Switch() pulumi.StringOutput {
	return o.ApplyT(func(v GetDomainsDomainListRuleCache) string { return v.Switch }).(pulumi.StringOutput)
}

type GetDomainsDomainListRuleCacheArrayOutput struct{ *pulumi.OutputState }

func (GetDomainsDomainListRuleCacheArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetDomainsDomainListRuleCache)(nil)).Elem()
}

func (o GetDomainsDomainListRuleCacheArrayOutput) ToGetDomainsDomainListRuleCacheArrayOutput() GetDomainsDomainListRuleCacheArrayOutput {
	return o
}

func (o GetDomainsDomainListRuleCacheArrayOutput) ToGetDomainsDomainListRuleCacheArrayOutputWithContext(ctx context.Context) GetDomainsDomainListRuleCacheArrayOutput {
	return o
}

func (o GetDomainsDomainListRuleCacheArrayOutput) Index(i pulumi.IntInput) GetDomainsDomainListRuleCacheOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetDomainsDomainListRuleCache {
		return vs[0].([]GetDomainsDomainListRuleCache)[vs[1].(int)]
	}).(GetDomainsDomainListRuleCacheOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*DomainRuleCacheInput)(nil)).Elem(), DomainRuleCacheArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*DomainRuleCacheArrayInput)(nil)).Elem(), DomainRuleCacheArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetDomainsDomainListRuleCacheInput)(nil)).Elem(), GetDomainsDomainListRuleCacheArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetDomainsDomainListRuleCacheArrayInput)(nil)).Elem(), GetDomainsDomainListRuleCacheArray{})
	...
	pulumi.RegisterOutputType(DomainRuleCacheOutput{})
	pulumi.RegisterOutputType(DomainRuleCacheArrayOutput{})
	...
	pulumi.RegisterOutputType(GetDomainsDomainListRuleCacheOutput{})
	pulumi.RegisterOutputType(GetDomainsDomainListRuleCacheArrayOutput{})
}
