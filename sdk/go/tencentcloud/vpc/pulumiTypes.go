...
type Ipv6CidrBlockIpv6CidrBlockSet struct {
...
// Ipv6CidrBlockIpv6CidrBlockSetInput is an input type that accepts Ipv6CidrBlockIpv6CidrBlockSetArgs and Ipv6CidrBlockIpv6CidrBlockSetOutput values.
// You can construct a concrete instance of `Ipv6CidrBlockIpv6CidrBlockSetInput` via:
//
//	Ipv6CidrBlockIpv6CidrBlockSetArgs{...}
type Ipv6CidrBlockIpv6CidrBlockSetInput interface {
	pulumi.Input

	ToIpv6CidrBlockIpv6CidrBlockSetOutput() Ipv6CidrBlockIpv6CidrBlockSetOutput
	ToIpv6CidrBlockIpv6CidrBlockSetOutputWithContext(context.Context) Ipv6CidrBlockIpv6CidrBlockSetOutput
}

type Ipv6CidrBlockIpv6CidrBlockSetArgs struct {
	// Apply for the type of IPv6 Cidr, GUA (Global Unicast Address), ULA (Unique Local Address).
...
func (Ipv6CidrBlockIpv6CidrBlockSetArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*Ipv6CidrBlockIpv6CidrBlockSet)(nil)).Elem()
}

func (i Ipv6CidrBlockIpv6CidrBlockSetArgs) ToIpv6CidrBlockIpv6CidrBlockSetOutput() Ipv6CidrBlockIpv6CidrBlockSetOutput {
	return i.ToIpv6CidrBlockIpv6CidrBlockSetOutputWithContext(context.Background())
}

func (i Ipv6CidrBlockIpv6CidrBlockSetArgs) ToIpv6CidrBlockIpv6CidrBlockSetOutputWithContext(ctx context.Context) Ipv6CidrBlockIpv6CidrBlockSetOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Ipv6CidrBlockIpv6CidrBlockSetOutput)
}

// Ipv6CidrBlockIpv6CidrBlockSetArrayInput is an input type that accepts Ipv6CidrBlockIpv6CidrBlockSetArray and Ipv6CidrBlockIpv6CidrBlockSetArrayOutput values.
// You can construct a concrete instance of `Ipv6CidrBlockIpv6CidrBlockSetArrayInput` via:
//
//	Ipv6CidrBlockIpv6CidrBlockSetArray{ Ipv6CidrBlockIpv6CidrBlockSetArgs{...} }
type Ipv6CidrBlockIpv6CidrBlockSetArrayInput interface {
	pulumi.Input

	ToIpv6CidrBlockIpv6CidrBlockSetArrayOutput() Ipv6CidrBlockIpv6CidrBlockSetArrayOutput
	ToIpv6CidrBlockIpv6CidrBlockSetArrayOutputWithContext(context.Context) Ipv6CidrBlockIpv6CidrBlockSetArrayOutput
}

type Ipv6CidrBlockIpv6CidrBlockSetArray []Ipv6CidrBlockIpv6CidrBlockSetInput

func (Ipv6CidrBlockIpv6CidrBlockSetArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]Ipv6CidrBlockIpv6CidrBlockSet)(nil)).Elem()
}

func (i Ipv6CidrBlockIpv6CidrBlockSetArray) ToIpv6CidrBlockIpv6CidrBlockSetArrayOutput() Ipv6CidrBlockIpv6CidrBlockSetArrayOutput {
	return i.ToIpv6CidrBlockIpv6CidrBlockSetArrayOutputWithContext(context.Background())
}

func (i Ipv6CidrBlockIpv6CidrBlockSetArray) ToIpv6CidrBlockIpv6CidrBlockSetArrayOutputWithContext(ctx context.Context) Ipv6CidrBlockIpv6CidrBlockSetArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(Ipv6CidrBlockIpv6CidrBlockSetArrayOutput)
}

type Ipv6CidrBlockIpv6CidrBlockSetOutput struct{ *pulumi.OutputState }

func (Ipv6CidrBlockIpv6CidrBlockSetOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*Ipv6CidrBlockIpv6CidrBlockSet)(nil)).Elem()
}

func (o Ipv6CidrBlockIpv6CidrBlockSetOutput) ToIpv6CidrBlockIpv6CidrBlockSetOutput() Ipv6CidrBlockIpv6CidrBlockSetOutput {
	return o
}

func (o Ipv6CidrBlockIpv6CidrBlockSetOutput) ToIpv6CidrBlockIpv6CidrBlockSetOutputWithContext(ctx context.Context) Ipv6CidrBlockIpv6CidrBlockSetOutput {
	return o
}

// Apply for the type of IPv6 Cidr, GUA (Global Unicast Address), ULA (Unique Local Address).
func (o Ipv6CidrBlockIpv6CidrBlockSetOutput) AddressType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Ipv6CidrBlockIpv6CidrBlockSet) *string { return v.AddressType }).(pulumi.StringPtrOutput)
}

// Ipv6 cidr block.
func (o Ipv6CidrBlockIpv6CidrBlockSetOutput) Ipv6CidrBlock() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Ipv6CidrBlockIpv6CidrBlockSet) *string { return v.Ipv6CidrBlock }).(pulumi.StringPtrOutput)
}

// Range of network operator types: 'BGP' - default, 'CMCC' - China Mobile, 'CTCC' - China Telecom, 'CUCC' - China Joint Debugging.
func (o Ipv6CidrBlockIpv6CidrBlockSetOutput) IspType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v Ipv6CidrBlockIpv6CidrBlockSet) *string { return v.IspType }).(pulumi.StringPtrOutput)
}

type Ipv6CidrBlockIpv6CidrBlockSetArrayOutput struct{ *pulumi.OutputState }

func (Ipv6CidrBlockIpv6CidrBlockSetArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]Ipv6CidrBlockIpv6CidrBlockSet)(nil)).Elem()
}

func (o Ipv6CidrBlockIpv6CidrBlockSetArrayOutput) ToIpv6CidrBlockIpv6CidrBlockSetArrayOutput() Ipv6CidrBlockIpv6CidrBlockSetArrayOutput {
	return o
}

func (o Ipv6CidrBlockIpv6CidrBlockSetArrayOutput) ToIpv6CidrBlockIpv6CidrBlockSetArrayOutputWithContext(ctx context.Context) Ipv6CidrBlockIpv6CidrBlockSetArrayOutput {
	return o
}

func (o Ipv6CidrBlockIpv6CidrBlockSetArrayOutput) Index(i pulumi.IntInput) Ipv6CidrBlockIpv6CidrBlockSetOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) Ipv6CidrBlockIpv6CidrBlockSet {
		return vs[0].([]Ipv6CidrBlockIpv6CidrBlockSet)[vs[1].(int)]
	}).(Ipv6CidrBlockIpv6CidrBlockSetOutput)
}
...
// PrivateNatGatewayTranslationNatRuleTranslationNatRuleInput is an input type that accepts PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs and PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput values.
// You can construct a concrete instance of `PrivateNatGatewayTranslationNatRuleTranslationNatRuleInput` via:
//
//	PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs{...}
type PrivateNatGatewayTranslationNatRuleTranslationNatRuleInput interface {
	pulumi.Input

	ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput
	ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutputWithContext(context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput
}

type PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs struct {
	// Translation rule description.
	Description pulumi.StringInput `pulumi:"description"`
	// Source IP, valid when translation rule type is network layer.
	OriginalIp pulumi.StringPtrInput `pulumi:"originalIp"`
	// Translation rule target, optional values "LOCAL","PEER".
	TranslationDirection pulumi.StringInput `pulumi:"translationDirection"`
	// Translation IP, when translation rule type is transport layer, it is an IP pool.
	TranslationIp pulumi.StringInput `pulumi:"translationIp"`
	// Translation rule type, optional values "NETWORK_LAYER","TRANSPORT_LAYER".
	TranslationType pulumi.StringInput `pulumi:"translationType"`
}

func (PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateNatGatewayTranslationNatRuleTranslationNatRule)(nil)).Elem()
}

func (i PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput {
	return i.ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutputWithContext(context.Background())
}

func (i PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutputWithContext(ctx context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput)
}

// PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayInput is an input type that accepts PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray and PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput values.
// You can construct a concrete instance of `PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayInput` via:
//
//	PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray{ PrivateNatGatewayTranslationNatRuleTranslationNatRuleArgs{...} }
type PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayInput interface {
	pulumi.Input

	ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput
	ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutputWithContext(context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput
}

type PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray []PrivateNatGatewayTranslationNatRuleTranslationNatRuleInput

func (PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]PrivateNatGatewayTranslationNatRuleTranslationNatRule)(nil)).Elem()
}

func (i PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput {
	return i.ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutputWithContext(context.Background())
}

func (i PrivateNatGatewayTranslationNatRuleTranslationNatRuleArray) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutputWithContext(ctx context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput)
}

type PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput struct{ *pulumi.OutputState }

func (PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*PrivateNatGatewayTranslationNatRuleTranslationNatRule)(nil)).Elem()
}

func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput {
	return o
}

func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleOutputWithContext(ctx context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput {
	return o
}

// Translation rule description.
func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v PrivateNatGatewayTranslationNatRuleTranslationNatRule) string { return v.Description }).(pulumi.StringOutput)
}

// Source IP, valid when translation rule type is network layer.
func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) OriginalIp() pulumi.StringPtrOutput {
	return o.ApplyT(func(v PrivateNatGatewayTranslationNatRuleTranslationNatRule) *string { return v.OriginalIp }).(pulumi.StringPtrOutput)
}

// Translation rule target, optional values "LOCAL","PEER".
func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) TranslationDirection() pulumi.StringOutput {
	return o.ApplyT(func(v PrivateNatGatewayTranslationNatRuleTranslationNatRule) string { return v.TranslationDirection }).(pulumi.StringOutput)
}

// Translation IP, when translation rule type is transport layer, it is an IP pool.
func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) TranslationIp() pulumi.StringOutput {
	return o.ApplyT(func(v PrivateNatGatewayTranslationNatRuleTranslationNatRule) string { return v.TranslationIp }).(pulumi.StringOutput)
}

// Translation rule type, optional values "NETWORK_LAYER","TRANSPORT_LAYER".
func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput) TranslationType() pulumi.StringOutput {
	return o.ApplyT(func(v PrivateNatGatewayTranslationNatRuleTranslationNatRule) string { return v.TranslationType }).(pulumi.StringOutput)
}

type PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput struct{ *pulumi.OutputState }

func (PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]PrivateNatGatewayTranslationNatRuleTranslationNatRule)(nil)).Elem()
}

func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput() PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput {
	return o
}

func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput) ToPrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutputWithContext(ctx context.Context) PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput {
	return o
}

func (o PrivateNatGatewayTranslationNatRuleTranslationNatRuleArrayOutput) Index(i pulumi.IntInput) PrivateNatGatewayTranslationNatRuleTranslationNatRuleOutput {
...
// Tags of the subnet.
func (o GetAclsAclListSubnetOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetAclsAclListSubnet) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
type GetInstancesInstanceList struct {
	...
	CommonAssistantCidrs []string `pulumi:"commonAssistantCidrs"`
	// container assistant CIDR block.
	ContainerAssistantCidrs []string `pulumi:"containerAssistantCidrs"`
...
type GetInstancesInstanceListArgs struct {
	...
	CidrBlock pulumi.StringInput `pulumi:"cidrBlock"`
	// common assistant CIDR block.
	CommonAssistantCidrs pulumi.StringArrayInput `pulumi:"commonAssistantCidrs"`
	// container assistant CIDR block.
	ContainerAssistantCidrs pulumi.StringArrayInput `pulumi:"containerAssistantCidrs"`
	// Creation time of VPC.
	CreateTime pulumi.StringInput `pulumi:"createTime"`
	// A list of DNS servers which can be used within the VPC.
...
// common assistant CIDR block.
func (o GetInstancesInstanceListOutput) CommonAssistantCidrs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetInstancesInstanceList) []string { return v.CommonAssistantCidrs }).(pulumi.StringArrayOutput)
}

// container assistant CIDR block.
func (o GetInstancesInstanceListOutput) ContainerAssistantCidrs() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetInstancesInstanceList) []string { return v.ContainerAssistantCidrs }).(pulumi.StringArrayOutput)
}
...
// Tags of the VPC to be queried.
func (o GetInstancesInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetInstancesInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
// Tags of the routing table to be queried.
func (o GetRouteTablesInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetRouteTablesInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
// Tags of the subnet to be queried.
func (o GetSubnetsInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetSubnetsInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*Ipv6CidrBlockIpv6CidrBlockSetInput)(nil)).Elem(), Ipv6CidrBlockIpv6CidrBlockSetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*Ipv6CidrBlockIpv6CidrBlockSetArrayInput)(nil)).Elem(), Ipv6CidrBlockIpv6CidrBlockSetArray{})
	...
	pulumi.RegisterOutputType(Ipv6CidrBlockIpv6CidrBlockSetOutput{})
	pulumi.RegisterOutputType(Ipv6CidrBlockIpv6CidrBlockSetArrayOutput{})
