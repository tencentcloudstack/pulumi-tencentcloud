...
//			_, err := vpc.NewResumeSnapshotInstance(ctx, "resume_snapshot_instance", &vpc.ResumeSnapshotInstanceArgs{
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			example, err := vpc.GetSnapshotFiles(ctx, &vpc.GetSnapshotFilesArgs{
...
//				return err
//			}
//			exampleBucket, err := cos.NewBucket(ctx, "example", &cos.BucketArgs{
