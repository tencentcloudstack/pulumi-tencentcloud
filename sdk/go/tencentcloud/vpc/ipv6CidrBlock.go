...
type Ipv6CidrBlock struct {
	...
	// Ipv6 cidr block set.
	Ipv6CidrBlockSets Ipv6CidrBlockIpv6CidrBlockSetArrayOutput `pulumi:"ipv6CidrBlockSets"`
...
type ipv6CidrBlockState struct {
	...
	// Ipv6 cidr block set.
	Ipv6CidrBlockSets []Ipv6CidrBlockIpv6CidrBlockSet `pulumi:"ipv6CidrBlockSets"`
	// `VPC` instance `ID`, in the form of `vpc-f49l6u0z`.
...
type Ipv6CidrBlockState struct {
	...
	// Ipv6 cidr block set.
	Ipv6CidrBlockSets Ipv6CidrBlockIpv6CidrBlockSetArrayInput
	// `VPC` instance `ID`, in the form of `vpc-f49l6u0z`.
...
// Apply for the type of IPv6 Cidr, GUA (Global Unicast Address), ULA (Unique Local Address).
func (o Ipv6CidrBlockOutput) AddressType() pulumi.StringOutput {
	return o.ApplyT(func(v *Ipv6CidrBlock) pulumi.StringOutput { return v.AddressType }).(pulumi.StringOutput)
}
...
// Ipv6 cidr block set.
func (o Ipv6CidrBlockOutput) Ipv6CidrBlockSets() Ipv6CidrBlockIpv6CidrBlockSetArrayOutput {
	return o.ApplyT(func(v *Ipv6CidrBlock) Ipv6CidrBlockIpv6CidrBlockSetArrayOutput { return v.Ipv6CidrBlockSets }).(Ipv6CidrBlockIpv6CidrBlockSetArrayOutput)
}
