...
// Resource types, including `Address`, `LoadBalance`.
func (o BandwidthPackageAttachmentOutput) ResourceType() pulumi.StringOutput {
	return o.ApplyT(func(v *BandwidthPackageAttachment) pulumi.StringOutput { return v.ResourceType }).(pulumi.StringOutput)
}
