...
//			_, err := vpc.NewEndPoint(ctx, "example", &vpc.EndPointArgs{
...
type EndPoint struct {
	...
	// VIP of endpoint ip.
	EndPointVip pulumi.StringOutput `pulumi:"endPointVip"`
...
// VIP of endpoint ip.
func (o EndPointOutput) EndPointVip() pulumi.StringOutput {
	return o.ApplyT(func(v *EndPoint) pulumi.StringOutput { return v.EndPointVip }).(pulumi.StringOutput)
}
