...
//			_, err := bh.NewDevice(ctx, "example", &bh.DeviceArgs{
//				DeviceSet: &bh.DeviceDeviceSetArgs{
...
type Device struct {
	...
	DeviceSet DeviceDeviceSetOutput `pulumi:"deviceSet"`
}
...
func NewDevice(ctx *pulumi.Context,
	...
	if args.DeviceSet == nil {
		return nil, errors.New("invalid value for required argument 'DeviceSet'")
	}
	opts = internal.PkgResourceDefaultOpts(opts)
	var resource Device
	err := ctx.RegisterResource("tencentcloud:Bh/device:Device", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDevice(ctx *pulumi.Context,
	...
	var resource Device
	err := ctx.ReadResource("tencentcloud:Bh/device:Device", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type deviceState struct {
	...
	// Asset parameter list.
	DeviceSet *DeviceDeviceSet `pulumi:"deviceSet"`
}
...
type DeviceState struct {
	...
	// Asset parameter list.
	DeviceSet DeviceDeviceSetPtrInput
}
...
type DeviceArgs struct {
	...
	AccountId pulumi.IntPtrInput
	// Asset parameter list.
	DeviceSet DeviceDeviceSetInput
}
...
// Cloud account ID to which the asset belongs.
func (o DeviceOutput) AccountId() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Device) pulumi.IntPtrOutput { return v.AccountId }).(pulumi.IntPtrOutput)
}

// ID of the device.
func (o DeviceOutput) DeviceId() pulumi.IntOutput {
	return o.ApplyT(func(v *Device) pulumi.IntOutput { return v.DeviceId }).(pulumi.IntOutput)
}

// Asset parameter list.
func (o DeviceOutput) DeviceSet() DeviceDeviceSetOutput {
	return o.ApplyT(func(v *Device) DeviceDeviceSetOutput { return v.DeviceSet }).(DeviceDeviceSetOutput)
}
