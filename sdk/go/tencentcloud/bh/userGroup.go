...
//			_, err := bh.NewUserGroup(ctx, "example", &bh.UserGroupArgs{
...
func NewUserGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("tencentcloud:Bh/userGroup:UserGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserGroup(ctx *pulumi.Context,
	...
	var resource UserGroup
	err := ctx.ReadResource("tencentcloud:Bh/userGroup:UserGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Department ID to which the user group belongs, e.g.: 1.2.3.
func (o UserGroupOutput) DepartmentId() pulumi.StringOutput {
	return o.ApplyT(func(v *UserGroup) pulumi.StringOutput { return v.DepartmentId }).(pulumi.StringOutput)
}
...
// User group ID.
func (o UserGroupOutput) UserGroupId() pulumi.IntOutput {
	return o.ApplyT(func(v *UserGroup) pulumi.IntOutput { return v.UserGroupId }).(pulumi.IntOutput)
}
