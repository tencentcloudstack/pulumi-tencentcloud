...
func Instances(ctx *pulumi.Context, args *InstancesArgs, opts ...pulumi.InvokeOption) (*InstancesResult, error) {
	...
	err := ctx.Invoke("tencentcloud:Ccn/instances:Instances", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func (o InstancesResultOutput) CcnId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v InstancesResult) *string { return v.CcnId }).(pulumi.StringPtrOutput)
}
