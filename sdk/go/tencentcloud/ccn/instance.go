...
type Instance struct {
	...
	RouteEcmpFlag pulumi.BoolOutput `pulumi:"routeEcmpFlag"`
	// Whether to enable the routing overlap function. `true`: enabled, `false`: disabled. Default is true, cannot set to false.
	RouteOverlapFlag pulumi.BoolOutput `pulumi:"routeOverlapFlag"`
...
// Whether to enable the equivalent routing function. `true`: enabled, `false`: disabled. Default is false.
func (o InstanceOutput) RouteEcmpFlag() pulumi.BoolOutput {
	return o.ApplyT(func(v *Instance) pulumi.BoolOutput { return v.RouteEcmpFlag }).(pulumi.BoolOutput)
}

// Whether to enable the routing overlap function. `true`: enabled, `false`: disabled. Default is true, cannot set to false.
func (o InstanceOutput) RouteOverlapFlag() pulumi.BoolOutput {
	return o.ApplyT(func(v *Instance) pulumi.BoolOutput { return v.RouteOverlapFlag }).(pulumi.BoolOutput)
}
