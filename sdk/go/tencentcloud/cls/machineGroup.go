...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := cls.NewMachineGroup(ctx, "group_ostype", &cls.MachineGroupArgs{
//				GroupName:      pulumi.String("group"),
//				ServiceLogging: pulumi.Bool(true),
//				Ostype:         pulumi.Int(1),
//				Tags: pulumi.StringMap{
...
type MachineGroup struct {
	...
	MetaTags pulumi.StringMapOutput `pulumi:"metaTags"`
	// Operating system type. Valid values: 0 (Linux), 1 (Windows).
	Ostype pulumi.IntOutput `pulumi:"ostype"`
...
type machineGroupState struct {
	...
	// Machine group metadata information list, stored as key-value pairs.
	MetaTags map[string]string `pulumi:"metaTags"`
	// Operating system type. Valid values: 0 (Linux), 1 (Windows).
...
type MachineGroupState struct {
	...
	// Machine group metadata information list, stored as key-value pairs.
	MetaTags pulumi.StringMapInput
	// Operating system type. Valid values: 0 (Linux), 1 (Windows).
	Ostype pulumi.IntPtrInput
	// Whether to enable the service log to record the logs generated by the LogListener service itself. After it is enabled, the internal logset clsServiceLogging and the loglistener_status, loglistener_alarm, and loglistenerBusiness log topics will be created, which will not incur fees.
...
// Machine group metadata information list, stored as key-value pairs.
func (o MachineGroupOutput) MetaTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MachineGroup) pulumi.StringMapOutput { return v.MetaTags }).(pulumi.StringMapOutput)
}

// Operating system type. Valid values: 0 (Linux), 1 (Windows).
func (o MachineGroupOutput) Ostype() pulumi.IntOutput {
	return o.ApplyT(func(v *MachineGroup) pulumi.IntOutput { return v.Ostype }).(pulumi.IntOutput)
}
...
// Tag description list. Up to 10 tag key-value pairs are supported and must be unique.
func (o MachineGroupOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *MachineGroup) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
