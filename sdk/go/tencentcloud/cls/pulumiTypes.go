...
// GetTopicsFilterInput is an input type that accepts GetTopicsFilterArgs and GetTopicsFilterOutput values.
// You can construct a concrete instance of `GetTopicsFilterInput` via:
//
//	GetTopicsFilterArgs{...}
type GetTopicsFilterInput interface {
	pulumi.Input

	ToGetTopicsFilterOutput() GetTopicsFilterOutput
	ToGetTopicsFilterOutputWithContext(context.Context) GetTopicsFilterOutput
}

type GetTopicsFilterArgs struct {
	// Field to be filtered.
	Key pulumi.StringInput `pulumi:"key"`
	// Value to be filtered.
	Values pulumi.StringArrayInput `pulumi:"values"`
...
func (GetTopicsFilterArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetTopicsFilter)(nil)).Elem()
}

func (i GetTopicsFilterArgs) ToGetTopicsFilterOutput() GetTopicsFilterOutput {
	return i.ToGetTopicsFilterOutputWithContext(context.Background())
}

func (i GetTopicsFilterArgs) ToGetTopicsFilterOutputWithContext(ctx context.Context) GetTopicsFilterOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetTopicsFilterOutput)
}

// GetTopicsFilterArrayInput is an input type that accepts GetTopicsFilterArray and GetTopicsFilterArrayOutput values.
// You can construct a concrete instance of `GetTopicsFilterArrayInput` via:
//
//	GetTopicsFilterArray{ GetTopicsFilterArgs{...} }
type GetTopicsFilterArrayInput interface {
	pulumi.Input

	ToGetTopicsFilterArrayOutput() GetTopicsFilterArrayOutput
	ToGetTopicsFilterArrayOutputWithContext(context.Context) GetTopicsFilterArrayOutput
}

type GetTopicsFilterArray []GetTopicsFilterInput

func (GetTopicsFilterArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetTopicsFilter)(nil)).Elem()
}

func (i GetTopicsFilterArray) ToGetTopicsFilterArrayOutput() GetTopicsFilterArrayOutput {
	return i.ToGetTopicsFilterArrayOutputWithContext(context.Background())
}

func (i GetTopicsFilterArray) ToGetTopicsFilterArrayOutputWithContext(ctx context.Context) GetTopicsFilterArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetTopicsFilterArrayOutput)
}

type GetTopicsFilterOutput struct{ *pulumi.OutputState }

func (GetTopicsFilterOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetTopicsFilter)(nil)).Elem()
}

func (o GetTopicsFilterOutput) ToGetTopicsFilterOutput() GetTopicsFilterOutput {
	return o
}

func (o GetTopicsFilterOutput) ToGetTopicsFilterOutputWithContext(ctx context.Context) GetTopicsFilterOutput {
	return o
}

// Field to be filtered.
func (o GetTopicsFilterOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsFilter) string { return v.Key }).(pulumi.StringOutput)
}

// Value to be filtered.
func (o GetTopicsFilterOutput) Values() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetTopicsFilter) []string { return v.Values }).(pulumi.StringArrayOutput)
}

type GetTopicsFilterArrayOutput struct{ *pulumi.OutputState }

func (GetTopicsFilterArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetTopicsFilter)(nil)).Elem()
}

func (o GetTopicsFilterArrayOutput) ToGetTopicsFilterArrayOutput() GetTopicsFilterArrayOutput {
	return o
}

func (o GetTopicsFilterArrayOutput) ToGetTopicsFilterArrayOutputWithContext(ctx context.Context) GetTopicsFilterArrayOutput {
	return o
}

func (o GetTopicsFilterArrayOutput) Index(i pulumi.IntInput) GetTopicsFilterOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetTopicsFilter {
		return vs[0].([]GetTopicsFilter)[vs[1].(int)]
	}).(GetTopicsFilterOutput)
}
...
type GetTopicsTopic struct {
	...
	// Note: This field may return null, indicating that no valid values can be obtained.
	SubAssumerName string `pulumi:"subAssumerName"`
...
type GetTopicsTopicArgs struct {
	...
	// - 0 (default): Log topic.
	// - 1: Metric topic.
	BizType pulumi.IntInput `pulumi:"bizType"`
	// Creation time.
	CreateTime pulumi.StringInput `pulumi:"createTime"`
	// Topic description
	// Note: This field may return null, indicating that no valid values can be obtained.
	Describes pulumi.StringInput `pulumi:"describes"`
	// Enable log sinking, with the lifecycle of standard storage, where hotPeriod < Period.For standard storage, hotPeriod is used, and for infrequent access storage, it is Period-hotPeriod. (The topic type must be a log topic)HotPeriod=0 indicates that log sinking is not enabled.
	// Note: This field may return null, indicating that no valid values can be obtained.
	HotPeriod pulumi.IntInput `pulumi:"hotPeriod"`
	// Whether the topic has indexing enabled (the topic type must be log topic).
	Index pulumi.BoolInput `pulumi:"index"`
	// Free authentication switch. false: disabled; true: enabled.After enabling, anonymous access to the log topic will be supported for specified operations. For details, please refer to Log Topic (https://intl.cloud.tencent.com/document/product/614/41035?from_cn_redirect=1).Note: This field may return null, indicating that no valid values can be obtained.
	IsWebTracking pulumi.BoolInput `pulumi:"isWebTracking"`
	// Logset ID.
	LogsetId pulumi.StringInput `pulumi:"logsetId"`
	// Maximum number of partitions to split into for this topic if automatic split is enabled
	// Note: this field may return `null`, indicating that no valid values can be obtained.
	MaxSplitPartitions pulumi.IntInput `pulumi:"maxSplitPartitions"`
	// Number of topic partitions.
	...
	// Cloud product sub-identifier. If the log topic is created by another cloud product, this field returns the name of the cloud product and its log type, such as `TKE-Audit` or `TKE-Event`. Some products only return the cloud product identifier (`AssumerName`), without this field.
	// Note: This field may return null, indicating that no valid values can be obtained.
	SubAssumerName pulumi.StringInput `pulumi:"subAssumerName"`
	// Tag information bound to the topicNote: This field may return null, indicating that no valid values can be obtained.
...
// Cloud product identifier. When the topic is created by other cloud products, this field displays the name of the cloud product, such as CDN, TKE.Note: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) AssumerName() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.AssumerName }).(pulumi.StringOutput)
}

// Whether automatic split is enabled for this topic
// Note: this field may return `null`, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) AutoSplit() pulumi.BoolOutput {
	return o.ApplyT(func(v GetTopicsTopic) bool { return v.AutoSplit }).(pulumi.BoolOutput)
}

// Topic type
// - 0 (default): Log topic.
// - 1: Metric topic.
func (o GetTopicsTopicOutput) BizType() pulumi.IntOutput {
	return o.ApplyT(func(v GetTopicsTopic) int { return v.BizType }).(pulumi.IntOutput)
}
...
// Topic description
// Note: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) Describes() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.Describes }).(pulumi.StringOutput)
}

// Enable log sinking, with the lifecycle of standard storage, where hotPeriod < Period.For standard storage, hotPeriod is used, and for infrequent access storage, it is Period-hotPeriod. (The topic type must be a log topic)HotPeriod=0 indicates that log sinking is not enabled.
// Note: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) HotPeriod() pulumi.IntOutput {
	return o.ApplyT(func(v GetTopicsTopic) int { return v.HotPeriod }).(pulumi.IntOutput)
}

// Whether the topic has indexing enabled (the topic type must be log topic).
func (o GetTopicsTopicOutput) Index() pulumi.BoolOutput {
	return o.ApplyT(func(v GetTopicsTopic) bool { return v.Index }).(pulumi.BoolOutput)
}

// Free authentication switch. false: disabled; true: enabled.After enabling, anonymous access to the log topic will be supported for specified operations. For details, please refer to Log Topic (https://intl.cloud.tencent.com/document/product/614/41035?from_cn_redirect=1).Note: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) IsWebTracking() pulumi.BoolOutput {
	return o.ApplyT(func(v GetTopicsTopic) bool { return v.IsWebTracking }).(pulumi.BoolOutput)
}

// Logset ID.
func (o GetTopicsTopicOutput) LogsetId() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.LogsetId }).(pulumi.StringOutput)
}

// Maximum number of partitions to split into for this topic if automatic split is enabled
// Note: this field may return `null`, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) MaxSplitPartitions() pulumi.IntOutput {
	return o.ApplyT(func(v GetTopicsTopic) int { return v.MaxSplitPartitions }).(pulumi.IntOutput)
}

// Number of topic partitions.
func (o GetTopicsTopicOutput) PartitionCount() pulumi.IntOutput {
	return o.ApplyT(func(v GetTopicsTopic) int { return v.PartitionCount }).(pulumi.IntOutput)
}

// Lifecycle in days. Value range: 1-3600 (3640 indicates permanent retention)
// Note: This field may return `null`, indicating that no valid value was found.
func (o GetTopicsTopicOutput) Period() pulumi.IntOutput {
	return o.ApplyT(func(v GetTopicsTopic) int { return v.Period }).(pulumi.IntOutput)
}

// Whether the topic has log collection enabled. true: collection enabled; false: collection disabled.Log collection is enabled by default when creating a log topic, and this field can be modified by calling ModifyTopic through the SDK.The console currently does not support modifying this parameter.
func (o GetTopicsTopicOutput) Status() pulumi.BoolOutput {
	return o.ApplyT(func(v GetTopicsTopic) bool { return v.Status }).(pulumi.BoolOutput)
}

// Storage type of the topicNote: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) StorageType() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.StorageType }).(pulumi.StringOutput)
}

// Cloud product sub-identifier. If the log topic is created by another cloud product, this field returns the name of the cloud product and its log type, such as `TKE-Audit` or `TKE-Event`. Some products only return the cloud product identifier (`AssumerName`), without this field.
// Note: This field may return null, indicating that no valid values can be obtained.
func (o GetTopicsTopicOutput) SubAssumerName() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.SubAssumerName }).(pulumi.StringOutput)
}
...
// Topic ID.
func (o GetTopicsTopicOutput) TopicId() pulumi.StringOutput {
	return o.ApplyT(func(v GetTopicsTopic) string { return v.TopicId }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetTopicsFilterArrayInput)(nil)).Elem(), GetTopicsFilterArray{})
	...
	pulumi.RegisterOutputType(GetTopicsFilterArrayOutput{})
