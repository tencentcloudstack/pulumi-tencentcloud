...
func GetDedicatedClustersOutput(ctx *pulumi.Context, args GetDedicatedClustersOutputArgs, opts ...pulumi.InvokeOption) GetDedicatedClustersResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Cdc/getDedicatedClusters:getDedicatedClusters", args, GetDedicatedClustersResultOutput{}, options).(GetDedicatedClustersResultOutput)
}
