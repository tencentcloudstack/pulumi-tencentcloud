...
// Tags of the instance.
func (o GetInstanceInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetInstanceInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
...
// Tags of the instance.
func (o GetSetInstanceListOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetSetInstanceList) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
