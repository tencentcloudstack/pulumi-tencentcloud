...
//			exampleInstance, err := tcr.NewInstance(ctx, "example", &tcr.InstanceArgs{
...
//				return err
//			}
//			example := tcr.GetNamespacesOutput(ctx, tcr.GetNamespacesOutputArgs{
...
// Tag description list.
func (o WebhookTriggerOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *WebhookTrigger) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
