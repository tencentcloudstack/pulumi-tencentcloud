...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := tcr.NewImmutableTagRule(ctx, "example_rule_A", &tcr.ImmutableTagRuleArgs{
//				RegistryId:    pulumi.Any(exampleTencentcloudTcrInstance.Id),
...
//				return err
//			}
//			_, err = tcr.NewImmutableTagRule(ctx, "example_rule_B", &tcr.ImmutableTagRuleArgs{
//				RegistryId:    pulumi.Any(exampleTencentcloudTcrInstance.Id),
//				NamespaceName: pulumi.Any(example.Name),
//				Rule: &tcr.ImmutableTagRuleRuleArgs{
//					RepositoryPattern:    pulumi.String("**"),
...
// Tag description list.
func (o ImmutableTagRuleOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ImmutableTagRule) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
