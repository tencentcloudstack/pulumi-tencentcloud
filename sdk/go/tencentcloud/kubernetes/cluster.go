...
//				defaultInstanceType = param
//			}
//			_, err := kubernetes.NewCluster(ctx, "test_node_pool_global_config", &kubernetes.ClusterArgs{
...
//				defaultInstanceType = param
//			}
//			_, err := kubernetes.NewCluster(ctx, "managed_cluster", &kubernetes.ClusterArgs{
//				VpcId:                pulumi.String(vpc),
//				ClusterMaxPodNum:     pulumi.Int(32),
//				ClusterName:          pulumi.String("test"),
//				ClusterDesc:          pulumi.String("test cluster desc"),
...
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := kubernetes.NewCluster(ctx, "cdc_cluster", &kubernetes.ClusterArgs{
...
//							},
//							MasterConfig: &kubernetes.ClusterExistInstanceInstancesParaMasterConfigArgs{
//								MountTarget:     pulumi.String("/var/data"),
//								DockerGraphPath: pulumi.String("/var/lib/containerd"),
//								Unschedulable:   pulumi.Int(0),
//								Labels: kubernetes.ClusterExistInstanceInstancesParaMasterConfigLabelArray{
//									&kubernetes.ClusterExistInstanceInstancesParaMasterConfigLabelArgs{
//										Name:  pulumi.String("key"),
//										Value: pulumi.String("value"),
//									},
//								},
//								DataDisk: &kubernetes.ClusterExistInstanceInstancesParaMasterConfigDataDiskArgs{
//									FileSystem:         pulumi.String("ext4"),
//									AutoFormatAndMount: pulumi.Bool(true),
//									MountTarget:        pulumi.String("/var/data"),
//									DiskPartition:      pulumi.String("/dev/vdb"),
//								},
//								ExtraArgs: &kubernetes.ClusterExistInstanceInstancesParaMasterConfigExtraArgsArgs{
//									Kubelets: pulumi.StringArray{
//										pulumi.String("root-dir=/root"),
//									},
//								},
//								Taints: kubernetes.ClusterExistInstanceInstancesParaMasterConfigTaintArray{
//									&kubernetes.ClusterExistInstanceInstancesParaMasterConfigTaintArgs{
...
type Cluster struct {
	...
	ClusterInternetDomain pulumi.StringOutput `pulumi:"clusterInternetDomain"`
	...
	ClusterIntranetDomain pulumi.StringOutput `pulumi:"clusterIntranetDomain"`
	...
	DataPlaneV2 pulumi.BoolOutput `pulumi:"dataPlaneV2"`
	...
	DisableAddons pulumi.StringArrayOutput `pulumi:"disableAddons"`
	...
	IsDualStack pulumi.BoolOutput `pulumi:"isDualStack"`
...
type clusterState struct {
	...
	// Whether to enable DataPlaneV2 (replace kube-proxy with cilium). `dataPlaneV2` and `clusterIpvs` should not be set at the same time.
	DataPlaneV2 *bool `pulumi:"dataPlaneV2"`
	// Indicates whether cluster deletion protection is enabled. Default is false.
	DeletionProtection *bool `pulumi:"deletionProtection"`
	// To prevent the installation of a specific Addon component, enter the corresponding AddonName.
	DisableAddons []string `pulumi:"disableAddons"`
	// Docker graph path. Default is `/var/lib/docker`.
	...
	// In the VPC-CNI mode of the cluster, the dual stack cluster status defaults to false, indicating a non dual stack cluster.
	IsDualStack *bool `pulumi:"isDualStack"`
	// Indicates whether non-static ip mode is enabled. Default is false.
...
type ClusterState struct {
	...
	// Whether to enable DataPlaneV2 (replace kube-proxy with cilium). `dataPlaneV2` and `clusterIpvs` should not be set at the same time.
	DataPlaneV2 pulumi.BoolPtrInput
	// Indicates whether cluster deletion protection is enabled. Default is false.
	DeletionProtection pulumi.BoolPtrInput
	// To prevent the installation of a specific Addon component, enter the corresponding AddonName.
	DisableAddons pulumi.StringArrayInput
	// Docker graph path. Default is `/var/lib/docker`.
	...
	// In the VPC-CNI mode of the cluster, the dual stack cluster status defaults to false, indicating a non dual stack cluster.
	IsDualStack pulumi.BoolPtrInput
	// Indicates whether non-static ip mode is enabled. Default is false.
...
// Domain name for cluster Kube-apiserver internet access. Be careful if you modify value of this parameter, the clusterExternalEndpoint value may be changed automatically too.
func (o ClusterOutput) ClusterInternetDomain() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.ClusterInternetDomain }).(pulumi.StringOutput)
}
...
// Domain name for cluster Kube-apiserver intranet access. Be careful if you modify value of this parameter, the pgwEndpoint value may be changed automatically too.
func (o ClusterOutput) ClusterIntranetDomain() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.ClusterIntranetDomain }).(pulumi.StringOutput)
}
...
// Runtime type of the cluster, the available values include: 'docker' and 'containerd'.The Kubernetes v1.24 has removed dockershim, so please use containerd in v1.24 or higher. The default value is `docker` for versions below v1.24 and `containerd` for versions above v1.24.
func (o ClusterOutput) ContainerRuntime() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.ContainerRuntime }).(pulumi.StringOutput)
}

// Whether to enable DataPlaneV2 (replace kube-proxy with cilium). `dataPlaneV2` and `clusterIpvs` should not be set at the same time.
func (o ClusterOutput) DataPlaneV2() pulumi.BoolOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolOutput { return v.DataPlaneV2 }).(pulumi.BoolOutput)
}
...
// To prevent the installation of a specific Addon component, enter the corresponding AddonName.
func (o ClusterOutput) DisableAddons() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringArrayOutput { return v.DisableAddons }).(pulumi.StringArrayOutput)
}
...
// In the VPC-CNI mode of the cluster, the dual stack cluster status defaults to false, indicating a non dual stack cluster.
func (o ClusterOutput) IsDualStack() pulumi.BoolOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolOutput { return v.IsDualStack }).(pulumi.BoolOutput)
}
