...
// labels of serverless node.
func (o ServerlessNodePoolOutput) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ServerlessNodePool) pulumi.StringMapOutput { return v.Labels }).(pulumi.StringMapOutput)
}
