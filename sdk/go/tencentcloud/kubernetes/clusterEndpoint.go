...
// The Intranet address used for access.
func (o ClusterEndpointOutput) KubeConfig() pulumi.StringOutput {
	return o.ApplyT(func(v *ClusterEndpoint) pulumi.StringOutput { return v.KubeConfig }).(pulumi.StringOutput)
}

// Kubernetes config of private network.
func (o ClusterEndpointOutput) KubeConfigIntranet() pulumi.StringOutput {
	return o.ApplyT(func(v *ClusterEndpoint) pulumi.StringOutput { return v.KubeConfigIntranet }).(pulumi.StringOutput)
}
