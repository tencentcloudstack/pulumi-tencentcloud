...
// Labels of tke attachment exits CVM.
func (o ClusterAttachmentOutput) Labels() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ClusterAttachment) pulumi.StringMapOutput { return v.Labels }).(pulumi.StringMapOutput)
}
