...
type GetIpStrategiesListAttachList struct {
	...
	OauthConfig map[string]string `pulumi:"oauthConfig"`
	// API path.
	Path string `pulumi:"path"`
	// API protocol.
	Protocol string `pulumi:"protocol"`
...
type GetIpStrategiesListAttachListArgs struct {
	...
	ModifyTime pulumi.StringInput `pulumi:"modifyTime"`
	// OAUTH configuration information. It takes effect when authType is `OAUTH`.
	OauthConfig pulumi.StringMapInput `pulumi:"oauthConfig"`
	// API path.
	Path pulumi.StringInput `pulumi:"path"`
	// API protocol.
	Protocol pulumi.StringInput `pulumi:"protocol"`
...
// OAUTH configuration information. It takes effect when authType is `OAUTH`.
func (o GetIpStrategiesListAttachListOutput) OauthConfig() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetIpStrategiesListAttachList) map[string]string { return v.OauthConfig }).(pulumi.StringMapOutput)
}
