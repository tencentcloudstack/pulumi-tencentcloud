...
type RabbitmqVipInstanceVpc struct {
	...
	VpcDataStreamEndpointStatus *string `pulumi:"vpcDataStreamEndpointStatus"`
	// VPC Endpoint.
...
// RabbitmqVipInstanceVpcInput is an input type that accepts RabbitmqVipInstanceVpcArgs and RabbitmqVipInstanceVpcOutput values.
// You can construct a concrete instance of `RabbitmqVipInstanceVpcInput` via:
//
//	RabbitmqVipInstanceVpcArgs{...}
type RabbitmqVipInstanceVpcInput interface {
	pulumi.Input

	ToRabbitmqVipInstanceVpcOutput() RabbitmqVipInstanceVpcOutput
	ToRabbitmqVipInstanceVpcOutputWithContext(context.Context) RabbitmqVipInstanceVpcOutput
}

type RabbitmqVipInstanceVpcArgs struct {
	// Private network SubnetId.
	SubnetId pulumi.StringPtrInput `pulumi:"subnetId"`
	// Status Of Vpc Endpoint.
	VpcDataStreamEndpointStatus pulumi.StringPtrInput `pulumi:"vpcDataStreamEndpointStatus"`
	// VPC Endpoint.
	VpcEndpoint pulumi.StringPtrInput `pulumi:"vpcEndpoint"`
	// Private network VpcId.
	VpcId pulumi.StringPtrInput `pulumi:"vpcId"`
}

func (RabbitmqVipInstanceVpcArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*RabbitmqVipInstanceVpc)(nil)).Elem()
}

func (i RabbitmqVipInstanceVpcArgs) ToRabbitmqVipInstanceVpcOutput() RabbitmqVipInstanceVpcOutput {
	return i.ToRabbitmqVipInstanceVpcOutputWithContext(context.Background())
}

func (i RabbitmqVipInstanceVpcArgs) ToRabbitmqVipInstanceVpcOutputWithContext(ctx context.Context) RabbitmqVipInstanceVpcOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RabbitmqVipInstanceVpcOutput)
}

// RabbitmqVipInstanceVpcArrayInput is an input type that accepts RabbitmqVipInstanceVpcArray and RabbitmqVipInstanceVpcArrayOutput values.
// You can construct a concrete instance of `RabbitmqVipInstanceVpcArrayInput` via:
//
//	RabbitmqVipInstanceVpcArray{ RabbitmqVipInstanceVpcArgs{...} }
type RabbitmqVipInstanceVpcArrayInput interface {
	pulumi.Input

	ToRabbitmqVipInstanceVpcArrayOutput() RabbitmqVipInstanceVpcArrayOutput
	ToRabbitmqVipInstanceVpcArrayOutputWithContext(context.Context) RabbitmqVipInstanceVpcArrayOutput
}

type RabbitmqVipInstanceVpcArray []RabbitmqVipInstanceVpcInput

func (RabbitmqVipInstanceVpcArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]RabbitmqVipInstanceVpc)(nil)).Elem()
}

func (i RabbitmqVipInstanceVpcArray) ToRabbitmqVipInstanceVpcArrayOutput() RabbitmqVipInstanceVpcArrayOutput {
	return i.ToRabbitmqVipInstanceVpcArrayOutputWithContext(context.Background())
}

func (i RabbitmqVipInstanceVpcArray) ToRabbitmqVipInstanceVpcArrayOutputWithContext(ctx context.Context) RabbitmqVipInstanceVpcArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(RabbitmqVipInstanceVpcArrayOutput)
}

type RabbitmqVipInstanceVpcOutput struct{ *pulumi.OutputState }

func (RabbitmqVipInstanceVpcOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*RabbitmqVipInstanceVpc)(nil)).Elem()
}

func (o RabbitmqVipInstanceVpcOutput) ToRabbitmqVipInstanceVpcOutput() RabbitmqVipInstanceVpcOutput {
	return o
}

func (o RabbitmqVipInstanceVpcOutput) ToRabbitmqVipInstanceVpcOutputWithContext(ctx context.Context) RabbitmqVipInstanceVpcOutput {
	return o
}

// Private network SubnetId.
func (o RabbitmqVipInstanceVpcOutput) SubnetId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RabbitmqVipInstanceVpc) *string { return v.SubnetId }).(pulumi.StringPtrOutput)
}

// Status Of Vpc Endpoint.
func (o RabbitmqVipInstanceVpcOutput) VpcDataStreamEndpointStatus() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RabbitmqVipInstanceVpc) *string { return v.VpcDataStreamEndpointStatus }).(pulumi.StringPtrOutput)
}

// VPC Endpoint.
func (o RabbitmqVipInstanceVpcOutput) VpcEndpoint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RabbitmqVipInstanceVpc) *string { return v.VpcEndpoint }).(pulumi.StringPtrOutput)
}

// Private network VpcId.
func (o RabbitmqVipInstanceVpcOutput) VpcId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v RabbitmqVipInstanceVpc) *string { return v.VpcId }).(pulumi.StringPtrOutput)
}

type RabbitmqVipInstanceVpcArrayOutput struct{ *pulumi.OutputState }

func (RabbitmqVipInstanceVpcArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]RabbitmqVipInstanceVpc)(nil)).Elem()
}

func (o RabbitmqVipInstanceVpcArrayOutput) ToRabbitmqVipInstanceVpcArrayOutput() RabbitmqVipInstanceVpcArrayOutput {
	return o
}

func (o RabbitmqVipInstanceVpcArrayOutput) ToRabbitmqVipInstanceVpcArrayOutputWithContext(ctx context.Context) RabbitmqVipInstanceVpcArrayOutput {
	return o
}

func (o RabbitmqVipInstanceVpcArrayOutput) Index(i pulumi.IntInput) RabbitmqVipInstanceVpcOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) RabbitmqVipInstanceVpc {
		return vs[0].([]RabbitmqVipInstanceVpc)[vs[1].(int)]
	}).(RabbitmqVipInstanceVpcOutput)
}
