...
//			_, err := tdmq.NewProfessionalCluster(ctx, "professional_cluster", &tdmq.ProfessionalClusterArgs{
...
// Tag description list.
func (o ProfessionalClusterOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ProfessionalCluster) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
