...
//			example, err := tdmq.NewRocketmqCluster(ctx, "example", &tdmq.RocketmqClusterArgs{
...
//				return err
//			}
//			exampleRocketmqRole, err := tdmq.NewRocketmqRole(ctx, "example", &tdmq.RocketmqRoleArgs{
...
//				return err
//			}
//			_, err = tdmq.NewRocketmqEnvironmentRole(ctx, "example", &tdmq.RocketmqEnvironmentRoleArgs{
