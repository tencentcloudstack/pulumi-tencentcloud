...
type SyncConfigOptions struct {
	...
	RateLimitOption *SyncConfigOptionsRateLimitOption `pulumi:"rateLimitOption"`
}
...
type SyncConfigOptionsArgs struct {
	...
	// Task speed limit information
	// Note: This field may return null, indicating that no valid values can be obtained.
	RateLimitOption SyncConfigOptionsRateLimitOptionPtrInput `pulumi:"rateLimitOption"`
}
...
// Task speed limit information
// Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsOutput) RateLimitOption() SyncConfigOptionsRateLimitOptionPtrOutput {
	return o.ApplyT(func(v SyncConfigOptions) *SyncConfigOptionsRateLimitOption { return v.RateLimitOption }).(SyncConfigOptionsRateLimitOptionPtrOutput)
}
...
// Task speed limit information
// Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsPtrOutput) RateLimitOption() SyncConfigOptionsRateLimitOptionPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptions) *SyncConfigOptionsRateLimitOption {
		if v == nil {
			return nil
		}
		return v.RateLimitOption
	}).(SyncConfigOptionsRateLimitOptionPtrOutput)
}
...
type SyncConfigOptionsRateLimitOption struct {
	...
	CurrentDumpRps int `pulumi:"currentDumpRps"`
	...
	CurrentDumpThread int `pulumi:"currentDumpThread"`
	...
	CurrentLoadRps int `pulumi:"currentLoadRps"`
	...
	CurrentLoadThread int `pulumi:"currentLoadThread"`
	...
	CurrentSinkerThread int `pulumi:"currentSinkerThread"`
	...
	DefaultDumpRps int `pulumi:"defaultDumpRps"`
	...
	DefaultDumpThread int `pulumi:"defaultDumpThread"`
	...
	DefaultLoadRps int `pulumi:"defaultLoadRps"`
	...
	HasUserSetRateLimit string `pulumi:"hasUserSetRateLimit"`
}

// SyncConfigOptionsRateLimitOptionInput is an input type that accepts SyncConfigOptionsRateLimitOptionArgs and SyncConfigOptionsRateLimitOptionOutput values.
// You can construct a concrete instance of `SyncConfigOptionsRateLimitOptionInput` via:
//
//	SyncConfigOptionsRateLimitOptionArgs{...}
type SyncConfigOptionsRateLimitOptionInput interface {
	pulumi.Input

	ToSyncConfigOptionsRateLimitOptionOutput() SyncConfigOptionsRateLimitOptionOutput
	ToSyncConfigOptionsRateLimitOptionOutputWithContext(context.Context) SyncConfigOptionsRateLimitOptionOutput
}

type SyncConfigOptionsRateLimitOptionArgs struct {
	// The full export Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
	CurrentDumpRps pulumi.IntInput `pulumi:"currentDumpRps"`
	// The number of full export threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
	CurrentDumpThread pulumi.IntInput `pulumi:"currentDumpThread"`
	// The full import Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
	CurrentLoadRps pulumi.IntInput `pulumi:"currentLoadRps"`
	// The number of full import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
	CurrentLoadThread pulumi.IntInput `pulumi:"currentLoadThread"`
	// The number of incremental import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 128.Note: This field may return null, indicating that no valid values can be obtained.
	CurrentSinkerThread pulumi.IntInput `pulumi:"currentSinkerThread"`
	// The default full export Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
	DefaultDumpRps pulumi.IntInput `pulumi:"defaultDumpRps"`
	// The default number of full export threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
	DefaultDumpThread pulumi.IntInput `pulumi:"defaultDumpThread"`
	// The default full import Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
	DefaultLoadRps pulumi.IntInput `pulumi:"defaultLoadRps"`
	// The default number of full import threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
	DefaultLoadThread pulumi.IntInput `pulumi:"defaultLoadThread"`
	// The default number of incremental import threads. This field is only meaningful in the output parameter.
	// Note: This field may return null, indicating that no valid values can be obtained.
	DefaultSinkerThread pulumi.IntInput `pulumi:"defaultSinkerThread"`
	// enum:"no"/"yes", no: the user has not set a speed limit; yes: a speed limit has been set. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
	HasUserSetRateLimit pulumi.StringInput `pulumi:"hasUserSetRateLimit"`
}

func (SyncConfigOptionsRateLimitOptionArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SyncConfigOptionsRateLimitOption)(nil)).Elem()
}

func (i SyncConfigOptionsRateLimitOptionArgs) ToSyncConfigOptionsRateLimitOptionOutput() SyncConfigOptionsRateLimitOptionOutput {
	return i.ToSyncConfigOptionsRateLimitOptionOutputWithContext(context.Background())
}

func (i SyncConfigOptionsRateLimitOptionArgs) ToSyncConfigOptionsRateLimitOptionOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SyncConfigOptionsRateLimitOptionOutput)
}

func (i SyncConfigOptionsRateLimitOptionArgs) ToSyncConfigOptionsRateLimitOptionPtrOutput() SyncConfigOptionsRateLimitOptionPtrOutput {
	return i.ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(context.Background())
}

func (i SyncConfigOptionsRateLimitOptionArgs) ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SyncConfigOptionsRateLimitOptionOutput).ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(ctx)
}

// SyncConfigOptionsRateLimitOptionPtrInput is an input type that accepts SyncConfigOptionsRateLimitOptionArgs, SyncConfigOptionsRateLimitOptionPtr and SyncConfigOptionsRateLimitOptionPtrOutput values.
// You can construct a concrete instance of `SyncConfigOptionsRateLimitOptionPtrInput` via:
//
//	        SyncConfigOptionsRateLimitOptionArgs{...}
//
//	or:
//
//	        nil
type SyncConfigOptionsRateLimitOptionPtrInput interface {
	pulumi.Input

	ToSyncConfigOptionsRateLimitOptionPtrOutput() SyncConfigOptionsRateLimitOptionPtrOutput
	ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(context.Context) SyncConfigOptionsRateLimitOptionPtrOutput
}

type syncConfigOptionsRateLimitOptionPtrType SyncConfigOptionsRateLimitOptionArgs

func SyncConfigOptionsRateLimitOptionPtr(v *SyncConfigOptionsRateLimitOptionArgs) SyncConfigOptionsRateLimitOptionPtrInput {
	return (*syncConfigOptionsRateLimitOptionPtrType)(v)
}

func (*syncConfigOptionsRateLimitOptionPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SyncConfigOptionsRateLimitOption)(nil)).Elem()
}

func (i *syncConfigOptionsRateLimitOptionPtrType) ToSyncConfigOptionsRateLimitOptionPtrOutput() SyncConfigOptionsRateLimitOptionPtrOutput {
	return i.ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(context.Background())
}

func (i *syncConfigOptionsRateLimitOptionPtrType) ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SyncConfigOptionsRateLimitOptionPtrOutput)
}

type SyncConfigOptionsRateLimitOptionOutput struct{ *pulumi.OutputState }

func (SyncConfigOptionsRateLimitOptionOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SyncConfigOptionsRateLimitOption)(nil)).Elem()
}

func (o SyncConfigOptionsRateLimitOptionOutput) ToSyncConfigOptionsRateLimitOptionOutput() SyncConfigOptionsRateLimitOptionOutput {
	return o
}

func (o SyncConfigOptionsRateLimitOptionOutput) ToSyncConfigOptionsRateLimitOptionOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionOutput {
	return o
}

func (o SyncConfigOptionsRateLimitOptionOutput) ToSyncConfigOptionsRateLimitOptionPtrOutput() SyncConfigOptionsRateLimitOptionPtrOutput {
	return o.ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(context.Background())
}

func (o SyncConfigOptionsRateLimitOptionOutput) ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SyncConfigOptionsRateLimitOption) *SyncConfigOptionsRateLimitOption {
		return &v
	}).(SyncConfigOptionsRateLimitOptionPtrOutput)
}

// The full export Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) CurrentDumpRps() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.CurrentDumpRps }).(pulumi.IntOutput)
}

// The number of full export threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) CurrentDumpThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.CurrentDumpThread }).(pulumi.IntOutput)
}

// The full import Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) CurrentLoadRps() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.CurrentLoadRps }).(pulumi.IntOutput)
}

// The number of full import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) CurrentLoadThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.CurrentLoadThread }).(pulumi.IntOutput)
}

// The number of incremental import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 128.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) CurrentSinkerThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.CurrentSinkerThread }).(pulumi.IntOutput)
}

// The default full export Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) DefaultDumpRps() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.DefaultDumpRps }).(pulumi.IntOutput)
}

// The default number of full export threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) DefaultDumpThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.DefaultDumpThread }).(pulumi.IntOutput)
}

// The default full import Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) DefaultLoadRps() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.DefaultLoadRps }).(pulumi.IntOutput)
}

// The default number of full import threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) DefaultLoadThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.DefaultLoadThread }).(pulumi.IntOutput)
}

// The default number of incremental import threads. This field is only meaningful in the output parameter.
// Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) DefaultSinkerThread() pulumi.IntOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) int { return v.DefaultSinkerThread }).(pulumi.IntOutput)
}

// enum:"no"/"yes", no: the user has not set a speed limit; yes: a speed limit has been set. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionOutput) HasUserSetRateLimit() pulumi.StringOutput {
	return o.ApplyT(func(v SyncConfigOptionsRateLimitOption) string { return v.HasUserSetRateLimit }).(pulumi.StringOutput)
}

type SyncConfigOptionsRateLimitOptionPtrOutput struct{ *pulumi.OutputState }

func (SyncConfigOptionsRateLimitOptionPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SyncConfigOptionsRateLimitOption)(nil)).Elem()
}

func (o SyncConfigOptionsRateLimitOptionPtrOutput) ToSyncConfigOptionsRateLimitOptionPtrOutput() SyncConfigOptionsRateLimitOptionPtrOutput {
	return o
}

func (o SyncConfigOptionsRateLimitOptionPtrOutput) ToSyncConfigOptionsRateLimitOptionPtrOutputWithContext(ctx context.Context) SyncConfigOptionsRateLimitOptionPtrOutput {
	return o
}

func (o SyncConfigOptionsRateLimitOptionPtrOutput) Elem() SyncConfigOptionsRateLimitOptionOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) SyncConfigOptionsRateLimitOption {
		if v != nil {
			return *v
		}
		var ret SyncConfigOptionsRateLimitOption
		return ret
	}).(SyncConfigOptionsRateLimitOptionOutput)
}

// The full export Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) CurrentDumpRps() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.CurrentDumpRps
	}).(pulumi.IntPtrOutput)
}

// The number of full export threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) CurrentDumpThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.CurrentDumpThread
	}).(pulumi.IntPtrOutput)
}

// The full import Rps currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 50,000,000.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) CurrentLoadRps() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.CurrentLoadRps
	}).(pulumi.IntPtrOutput)
}

// The number of full import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 16.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) CurrentLoadThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.CurrentLoadThread
	}).(pulumi.IntPtrOutput)
}

// The number of incremental import threads currently in effect. The value of this field can be adjusted when configuring the task. Note: If it is not set or set to 0, it means the current value is maintained. The maximum value is 128.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) CurrentSinkerThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.CurrentSinkerThread
	}).(pulumi.IntPtrOutput)
}

// The default full export Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) DefaultDumpRps() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.DefaultDumpRps
	}).(pulumi.IntPtrOutput)
}

// The default number of full export threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) DefaultDumpThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.DefaultDumpThread
	}).(pulumi.IntPtrOutput)
}

// The default full import Rps. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) DefaultLoadRps() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.DefaultLoadRps
	}).(pulumi.IntPtrOutput)
}

// The default number of full import threads. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) DefaultLoadThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.DefaultLoadThread
	}).(pulumi.IntPtrOutput)
}

// The default number of incremental import threads. This field is only meaningful in the output parameter.
// Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) DefaultSinkerThread() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *int {
		if v == nil {
			return nil
		}
		return &v.DefaultSinkerThread
	}).(pulumi.IntPtrOutput)
}

// enum:"no"/"yes", no: the user has not set a speed limit; yes: a speed limit has been set. This field is only meaningful in the output parameter.Note: This field may return null, indicating that no valid values can be obtained.
func (o SyncConfigOptionsRateLimitOptionPtrOutput) HasUserSetRateLimit() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SyncConfigOptionsRateLimitOption) *string {
		if v == nil {
			return nil
		}
		return &v.HasUserSetRateLimit
	}).(pulumi.StringPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SyncConfigOptionsRateLimitOptionInput)(nil)).Elem(), SyncConfigOptionsRateLimitOptionArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SyncConfigOptionsRateLimitOptionPtrInput)(nil)).Elem(), SyncConfigOptionsRateLimitOptionArgs{})
	...
	pulumi.RegisterOutputType(SyncConfigOptionsRateLimitOptionOutput{})
	pulumi.RegisterOutputType(SyncConfigOptionsRateLimitOptionPtrOutput{})
