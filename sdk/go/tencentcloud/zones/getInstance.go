...
//
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//	"github.com/tencentcloudstack/pulumi-tencentcloud/sdk/go/tencentcloud/zones"
//
// )
//
//	func main() {
//		pulumi.Run(func(ctx *pulumi.Context) error {
//			_, err := zones.GetInstance(ctx, &zones.GetInstanceArgs{
//				Product: "cvm",
//			}, nil)
//			if err != nil {
//				return err
...
func GetInstance(ctx *pulumi.Context, args *GetInstanceArgs, opts ...pulumi.InvokeOption) (*GetInstanceResult, error) {
	...
	err := ctx.Invoke("tencentcloud:Zones/getInstance:getInstance", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetInstanceResult struct {
	...
	Scene            *int    `pulumi:"scene"`
	// Zone list.
	ZoneLists []GetInstanceZoneList `pulumi:"zoneLists"`
}
...
func GetInstanceOutput(ctx *pulumi.Context, args GetInstanceOutputArgs, opts ...pulumi.InvokeOption) GetInstanceResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Zones/getInstance:getInstance", args, GetInstanceResultOutput{}, options).(GetInstanceResultOutput)
}
...
// Zone list.
func (o GetInstanceResultOutput) ZoneLists() GetInstanceZoneListArrayOutput {
	return o.ApplyT(func(v GetInstanceResult) []GetInstanceZoneList { return v.ZoneLists }).(GetInstanceZoneListArrayOutput)
}
