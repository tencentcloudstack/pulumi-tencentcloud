...
//			_, err := eip.NewAssociation(ctx, "example", &eip.AssociationArgs{
...
// ID of the dedicated cluster.
func (o AssociationOutput) CdcId() pulumi.StringOutput {
	return o.ApplyT(func(v *Association) pulumi.StringOutput { return v.CdcId }).(pulumi.StringOutput)
}
