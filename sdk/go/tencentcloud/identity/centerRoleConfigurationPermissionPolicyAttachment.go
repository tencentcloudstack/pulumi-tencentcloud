...
//			_, err := identity.NewCenterRoleConfigurationPermissionPolicyAttachment(ctx, "identity_center_role_configuration_permission_policy_attachment", &identity.CenterRoleConfigurationPermissionPolicyAttachmentArgs{
