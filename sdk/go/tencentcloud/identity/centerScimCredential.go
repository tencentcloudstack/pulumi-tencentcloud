...
//			_, err := identity.NewCenterScimCredential(ctx, "identity_center_scim_credential", &identity.CenterScimCredentialArgs{
...
func (o CenterScimCredentialOutput) CredentialSecret() pulumi.StringOutput {
	return o.ApplyT(func(v *CenterScimCredential) pulumi.StringOutput { return v.CredentialSecret }).(pulumi.StringOutput)
}
