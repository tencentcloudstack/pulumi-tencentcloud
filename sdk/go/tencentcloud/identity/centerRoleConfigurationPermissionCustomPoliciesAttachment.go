...
//			_, err := identity.NewCenterRoleConfigurationPermissionCustomPoliciesAttachment(ctx, "identity_center_role_configuration_permission_custom_policies_attachment", &identity.CenterRoleConfigurationPermissionCustomPoliciesAttachmentArgs{
