...
type GetRecordListInstanceList struct {
...
// GetRecordListInstanceListInput is an input type that accepts GetRecordListInstanceListArgs and GetRecordListInstanceListOutput values.
// You can construct a concrete instance of `GetRecordListInstanceListInput` via:
//
//	GetRecordListInstanceListArgs{...}
type GetRecordListInstanceListInput interface {
	pulumi.Input

	ToGetRecordListInstanceListOutput() GetRecordListInstanceListOutput
	ToGetRecordListInstanceListOutputWithContext(context.Context) GetRecordListInstanceListOutput
}

type GetRecordListInstanceListArgs struct {
	// Whether it is the default NS record.
	...
	// Retrieve resolution records for certain line IDs. You can view the allowed line information for the current domain through the DescribeRecordLineList interface.
	RecordLine pulumi.StringInput `pulumi:"recordLine"`
	// Retrieve certain types of resolution records, such as A, CNAME, NS, AAAA, explicit URL, implicit URL, CAA, SPF, etc.
...
func (GetRecordListInstanceListArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetRecordListInstanceList)(nil)).Elem()
}

func (i GetRecordListInstanceListArgs) ToGetRecordListInstanceListOutput() GetRecordListInstanceListOutput {
	return i.ToGetRecordListInstanceListOutputWithContext(context.Background())
}

func (i GetRecordListInstanceListArgs) ToGetRecordListInstanceListOutputWithContext(ctx context.Context) GetRecordListInstanceListOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetRecordListInstanceListOutput)
}

// GetRecordListInstanceListArrayInput is an input type that accepts GetRecordListInstanceListArray and GetRecordListInstanceListArrayOutput values.
// You can construct a concrete instance of `GetRecordListInstanceListArrayInput` via:
//
//	GetRecordListInstanceListArray{ GetRecordListInstanceListArgs{...} }
type GetRecordListInstanceListArrayInput interface {
	pulumi.Input

	ToGetRecordListInstanceListArrayOutput() GetRecordListInstanceListArrayOutput
	ToGetRecordListInstanceListArrayOutputWithContext(context.Context) GetRecordListInstanceListArrayOutput
}

type GetRecordListInstanceListArray []GetRecordListInstanceListInput

func (GetRecordListInstanceListArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetRecordListInstanceList)(nil)).Elem()
}

func (i GetRecordListInstanceListArray) ToGetRecordListInstanceListArrayOutput() GetRecordListInstanceListArrayOutput {
	return i.ToGetRecordListInstanceListArrayOutputWithContext(context.Background())
}

func (i GetRecordListInstanceListArray) ToGetRecordListInstanceListArrayOutputWithContext(ctx context.Context) GetRecordListInstanceListArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetRecordListInstanceListArrayOutput)
}

type GetRecordListInstanceListOutput struct{ *pulumi.OutputState }

func (GetRecordListInstanceListOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetRecordListInstanceList)(nil)).Elem()
}

func (o GetRecordListInstanceListOutput) ToGetRecordListInstanceListOutput() GetRecordListInstanceListOutput {
	return o
}

func (o GetRecordListInstanceListOutput) ToGetRecordListInstanceListOutputWithContext(ctx context.Context) GetRecordListInstanceListOutput {
	return o
}

// Whether it is the default NS record.
func (o GetRecordListInstanceListOutput) DefaultNs() pulumi.BoolOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) bool { return v.DefaultNs }).(pulumi.BoolOutput)
}

// The domain to which the resolution record belongs.
func (o GetRecordListInstanceListOutput) Domain() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.Domain }).(pulumi.StringOutput)
}

// ID.
func (o GetRecordListInstanceListOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.Id }).(pulumi.StringOutput)
}

// Line ID.
func (o GetRecordListInstanceListOutput) LineId() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.LineId }).(pulumi.StringOutput)
}

// Record monitoring status, normal: OK, alarm: WARN, downtime: DOWN, empty if monitoring is not set or paused.
func (o GetRecordListInstanceListOutput) MonitorStatus() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.MonitorStatus }).(pulumi.StringOutput)
}

// MX value, only available for MX records Note: This field may return null, indicating that no valid value can be obtained.
func (o GetRecordListInstanceListOutput) Mx() pulumi.IntOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) int { return v.Mx }).(pulumi.IntOutput)
}

// Record ID.
func (o GetRecordListInstanceListOutput) RecordId() pulumi.IntOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) int { return v.RecordId }).(pulumi.IntOutput)
}

// Retrieve resolution records for certain line IDs. You can view the allowed line information for the current domain through the DescribeRecordLineList interface.
func (o GetRecordListInstanceListOutput) RecordLine() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.RecordLine }).(pulumi.StringOutput)
}

// Retrieve certain types of resolution records, such as A, CNAME, NS, AAAA, explicit URL, implicit URL, CAA, SPF, etc.
func (o GetRecordListInstanceListOutput) RecordType() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.RecordType }).(pulumi.StringOutput)
}

// Get the resolution record based on the resolution record remark.
func (o GetRecordListInstanceListOutput) Remark() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.Remark }).(pulumi.StringOutput)
}

// Record status, enabled: ENABLE, paused: DISABLE.
func (o GetRecordListInstanceListOutput) Status() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.Status }).(pulumi.StringOutput)
}

// Retrieve resolution records based on the host header of the resolution record. Fuzzy matching is used by default. You can set the IsExactSubdomain parameter to true for precise searching.
func (o GetRecordListInstanceListOutput) SubDomain() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.SubDomain }).(pulumi.StringOutput)
}

// Record cache time.
func (o GetRecordListInstanceListOutput) Ttl() pulumi.IntOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) int { return v.Ttl }).(pulumi.IntOutput)
}

// Update time.
func (o GetRecordListInstanceListOutput) UpdatedOn() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.UpdatedOn }).(pulumi.StringOutput)
}

// Record value.
func (o GetRecordListInstanceListOutput) Value() pulumi.StringOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) string { return v.Value }).(pulumi.StringOutput)
}

// Record weight, used for load balancing records. Note: This field may return null, indicating that no valid value can be obtained.
func (o GetRecordListInstanceListOutput) Weight() pulumi.IntOutput {
	return o.ApplyT(func(v GetRecordListInstanceList) int { return v.Weight }).(pulumi.IntOutput)
}

type GetRecordListInstanceListArrayOutput struct{ *pulumi.OutputState }

func (GetRecordListInstanceListArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetRecordListInstanceList)(nil)).Elem()
}

func (o GetRecordListInstanceListArrayOutput) ToGetRecordListInstanceListArrayOutput() GetRecordListInstanceListArrayOutput {
	return o
}

func (o GetRecordListInstanceListArrayOutput) ToGetRecordListInstanceListArrayOutputWithContext(ctx context.Context) GetRecordListInstanceListArrayOutput {
	return o
}

func (o GetRecordListInstanceListArrayOutput) Index(i pulumi.IntInput) GetRecordListInstanceListOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetRecordListInstanceList {
		return vs[0].([]GetRecordListInstanceList)[vs[1].(int)]
	}).(GetRecordListInstanceListOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetRecordListInstanceListInput)(nil)).Elem(), GetRecordListInstanceListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetRecordListInstanceListArrayInput)(nil)).Elem(), GetRecordListInstanceListArray{})
	...
	pulumi.RegisterOutputType(GetRecordListInstanceListOutput{})
	pulumi.RegisterOutputType(GetRecordListInstanceListArrayOutput{})
