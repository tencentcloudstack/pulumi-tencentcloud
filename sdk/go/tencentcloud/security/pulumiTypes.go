...
// Tags of the security group to be queried. Conflict with `securityGroupId`.
func (o GetGroupsSecurityGroupOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetGroupsSecurityGroup) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
