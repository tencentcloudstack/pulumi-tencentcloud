...
//			example, err := css.NewPullStreamTask(ctx, "example", &css.PullStreamTaskArgs{
...
//				return err
//			}
//			exampleWatermark, err := css.NewWatermark(ctx, "example", &css.WatermarkArgs{
...
//				return err
//			}
//			_, err = css.NewWatermarkRuleAttachment(ctx, "watermark_rule_attachment", &css.WatermarkRuleAttachmentArgs{
