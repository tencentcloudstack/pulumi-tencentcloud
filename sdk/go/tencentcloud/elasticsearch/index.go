...
func NewIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.RegisterResource("tencentcloud:Elasticsearch/index:Index", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIndex(ctx *pulumi.Context,
	...
	var resource Index
	err := ctx.ReadResource("tencentcloud:Elasticsearch/index:Index", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (o IndexOutput) IndexMetaJson() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Index) pulumi.StringPtrOutput { return v.IndexMetaJson }).(pulumi.StringPtrOutput)
}
...
func (o IndexOutput) IndexType() pulumi.StringOutput {
	return o.ApplyT(func(v *Index) pulumi.StringOutput { return v.IndexType }).(pulumi.StringOutput)
}

// es instance id.
func (o IndexOutput) InstanceId() pulumi.StringOutput {
	return o.ApplyT(func(v *Index) pulumi.StringOutput { return v.InstanceId }).(pulumi.StringOutput)
}
