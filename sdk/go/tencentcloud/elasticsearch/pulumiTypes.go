...
type InstanceEsPublicAcl struct {
	// Access Whitelist.
	WhiteIpLists []string `pulumi:"whiteIpLists"`
}

// InstanceEsPublicAclInput is an input type that accepts InstanceEsPublicAclArgs and InstanceEsPublicAclOutput values.
// You can construct a concrete instance of `InstanceEsPublicAclInput` via:
//
//	InstanceEsPublicAclArgs{...}
type InstanceEsPublicAclInput interface {
	pulumi.Input

	ToInstanceEsPublicAclOutput() InstanceEsPublicAclOutput
	ToInstanceEsPublicAclOutputWithContext(context.Context) InstanceEsPublicAclOutput
}

type InstanceEsPublicAclArgs struct {
	// Access Whitelist.
	WhiteIpLists pulumi.StringArrayInput `pulumi:"whiteIpLists"`
}

func (InstanceEsPublicAclArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceEsPublicAcl)(nil)).Elem()
}

func (i InstanceEsPublicAclArgs) ToInstanceEsPublicAclOutput() InstanceEsPublicAclOutput {
	return i.ToInstanceEsPublicAclOutputWithContext(context.Background())
}

func (i InstanceEsPublicAclArgs) ToInstanceEsPublicAclOutputWithContext(ctx context.Context) InstanceEsPublicAclOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceEsPublicAclOutput)
}

func (i InstanceEsPublicAclArgs) ToInstanceEsPublicAclPtrOutput() InstanceEsPublicAclPtrOutput {
	return i.ToInstanceEsPublicAclPtrOutputWithContext(context.Background())
}

func (i InstanceEsPublicAclArgs) ToInstanceEsPublicAclPtrOutputWithContext(ctx context.Context) InstanceEsPublicAclPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceEsPublicAclOutput).ToInstanceEsPublicAclPtrOutputWithContext(ctx)
}

// InstanceEsPublicAclPtrInput is an input type that accepts InstanceEsPublicAclArgs, InstanceEsPublicAclPtr and InstanceEsPublicAclPtrOutput values.
// You can construct a concrete instance of `InstanceEsPublicAclPtrInput` via:
//
//	        InstanceEsPublicAclArgs{...}
//
//	or:
//
//	        nil
type InstanceEsPublicAclPtrInput interface {
	pulumi.Input

	ToInstanceEsPublicAclPtrOutput() InstanceEsPublicAclPtrOutput
	ToInstanceEsPublicAclPtrOutputWithContext(context.Context) InstanceEsPublicAclPtrOutput
}

type instanceEsPublicAclPtrType InstanceEsPublicAclArgs

func InstanceEsPublicAclPtr(v *InstanceEsPublicAclArgs) InstanceEsPublicAclPtrInput {
	return (*instanceEsPublicAclPtrType)(v)
}

func (*instanceEsPublicAclPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**InstanceEsPublicAcl)(nil)).Elem()
}

func (i *instanceEsPublicAclPtrType) ToInstanceEsPublicAclPtrOutput() InstanceEsPublicAclPtrOutput {
	return i.ToInstanceEsPublicAclPtrOutputWithContext(context.Background())
}

func (i *instanceEsPublicAclPtrType) ToInstanceEsPublicAclPtrOutputWithContext(ctx context.Context) InstanceEsPublicAclPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceEsPublicAclPtrOutput)
}

type InstanceEsPublicAclOutput struct{ *pulumi.OutputState }

func (InstanceEsPublicAclOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceEsPublicAcl)(nil)).Elem()
}

func (o InstanceEsPublicAclOutput) ToInstanceEsPublicAclOutput() InstanceEsPublicAclOutput {
	return o
}

func (o InstanceEsPublicAclOutput) ToInstanceEsPublicAclOutputWithContext(ctx context.Context) InstanceEsPublicAclOutput {
	return o
}

func (o InstanceEsPublicAclOutput) ToInstanceEsPublicAclPtrOutput() InstanceEsPublicAclPtrOutput {
	return o.ToInstanceEsPublicAclPtrOutputWithContext(context.Background())
}

func (o InstanceEsPublicAclOutput) ToInstanceEsPublicAclPtrOutputWithContext(ctx context.Context) InstanceEsPublicAclPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v InstanceEsPublicAcl) *InstanceEsPublicAcl {
		return &v
	}).(InstanceEsPublicAclPtrOutput)
}

// Access Whitelist.
func (o InstanceEsPublicAclOutput) WhiteIpLists() pulumi.StringArrayOutput {
	return o.ApplyT(func(v InstanceEsPublicAcl) []string { return v.WhiteIpLists }).(pulumi.StringArrayOutput)
}

type InstanceEsPublicAclPtrOutput struct{ *pulumi.OutputState }

func (InstanceEsPublicAclPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**InstanceEsPublicAcl)(nil)).Elem()
}

func (o InstanceEsPublicAclPtrOutput) ToInstanceEsPublicAclPtrOutput() InstanceEsPublicAclPtrOutput {
	return o
}

func (o InstanceEsPublicAclPtrOutput) ToInstanceEsPublicAclPtrOutputWithContext(ctx context.Context) InstanceEsPublicAclPtrOutput {
	return o
}

func (o InstanceEsPublicAclPtrOutput) Elem() InstanceEsPublicAclOutput {
	return o.ApplyT(func(v *InstanceEsPublicAcl) InstanceEsPublicAcl {
		if v != nil {
			return *v
		}
		var ret InstanceEsPublicAcl
		return ret
	}).(InstanceEsPublicAclOutput)
}

// Access Whitelist.
func (o InstanceEsPublicAclPtrOutput) WhiteIpLists() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InstanceEsPublicAcl) []string {
		if v == nil {
			return nil
		}
		return v.WhiteIpLists
	}).(pulumi.StringArrayOutput)
}
...
type LogstashMultiZoneInfo struct {
	// Availability zone.
	AvailabilityZone string `pulumi:"availabilityZone"`
...
// LogstashMultiZoneInfoInput is an input type that accepts LogstashMultiZoneInfoArgs and LogstashMultiZoneInfoOutput values.
// You can construct a concrete instance of `LogstashMultiZoneInfoInput` via:
//
//	LogstashMultiZoneInfoArgs{...}
type LogstashMultiZoneInfoInput interface {
	pulumi.Input

	ToLogstashMultiZoneInfoOutput() LogstashMultiZoneInfoOutput
	ToLogstashMultiZoneInfoOutputWithContext(context.Context) LogstashMultiZoneInfoOutput
}

type LogstashMultiZoneInfoArgs struct {
	// Availability zone.
	AvailabilityZone pulumi.StringInput `pulumi:"availabilityZone"`
	// Whether it is a hidden availability zone.
...
func (LogstashMultiZoneInfoArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*LogstashMultiZoneInfo)(nil)).Elem()
}

func (i LogstashMultiZoneInfoArgs) ToLogstashMultiZoneInfoOutput() LogstashMultiZoneInfoOutput {
	return i.ToLogstashMultiZoneInfoOutputWithContext(context.Background())
}

func (i LogstashMultiZoneInfoArgs) ToLogstashMultiZoneInfoOutputWithContext(ctx context.Context) LogstashMultiZoneInfoOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogstashMultiZoneInfoOutput)
}

// LogstashMultiZoneInfoArrayInput is an input type that accepts LogstashMultiZoneInfoArray and LogstashMultiZoneInfoArrayOutput values.
// You can construct a concrete instance of `LogstashMultiZoneInfoArrayInput` via:
//
//	LogstashMultiZoneInfoArray{ LogstashMultiZoneInfoArgs{...} }
type LogstashMultiZoneInfoArrayInput interface {
	pulumi.Input

	ToLogstashMultiZoneInfoArrayOutput() LogstashMultiZoneInfoArrayOutput
	ToLogstashMultiZoneInfoArrayOutputWithContext(context.Context) LogstashMultiZoneInfoArrayOutput
}

type LogstashMultiZoneInfoArray []LogstashMultiZoneInfoInput

func (LogstashMultiZoneInfoArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]LogstashMultiZoneInfo)(nil)).Elem()
}

func (i LogstashMultiZoneInfoArray) ToLogstashMultiZoneInfoArrayOutput() LogstashMultiZoneInfoArrayOutput {
	return i.ToLogstashMultiZoneInfoArrayOutputWithContext(context.Background())
}

func (i LogstashMultiZoneInfoArray) ToLogstashMultiZoneInfoArrayOutputWithContext(ctx context.Context) LogstashMultiZoneInfoArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(LogstashMultiZoneInfoArrayOutput)
}

type LogstashMultiZoneInfoOutput struct{ *pulumi.OutputState }

func (LogstashMultiZoneInfoOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*LogstashMultiZoneInfo)(nil)).Elem()
}

func (o LogstashMultiZoneInfoOutput) ToLogstashMultiZoneInfoOutput() LogstashMultiZoneInfoOutput {
	return o
}

func (o LogstashMultiZoneInfoOutput) ToLogstashMultiZoneInfoOutputWithContext(ctx context.Context) LogstashMultiZoneInfoOutput {
	return o
}

// Availability zone.
func (o LogstashMultiZoneInfoOutput) AvailabilityZone() pulumi.StringOutput {
	return o.ApplyT(func(v LogstashMultiZoneInfo) string { return v.AvailabilityZone }).(pulumi.StringOutput)
}

// Whether it is a hidden availability zone.
func (o LogstashMultiZoneInfoOutput) Hidden() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LogstashMultiZoneInfo) *bool { return v.Hidden }).(pulumi.BoolPtrOutput)
}

// Subnet id.
func (o LogstashMultiZoneInfoOutput) SubnetId() pulumi.StringOutput {
	return o.ApplyT(func(v LogstashMultiZoneInfo) string { return v.SubnetId }).(pulumi.StringOutput)
}

type LogstashMultiZoneInfoArrayOutput struct{ *pulumi.OutputState }

func (LogstashMultiZoneInfoArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]LogstashMultiZoneInfo)(nil)).Elem()
}

func (o LogstashMultiZoneInfoArrayOutput) ToLogstashMultiZoneInfoArrayOutput() LogstashMultiZoneInfoArrayOutput {
	return o
}

func (o LogstashMultiZoneInfoArrayOutput) ToLogstashMultiZoneInfoArrayOutputWithContext(ctx context.Context) LogstashMultiZoneInfoArrayOutput {
	return o
}

func (o LogstashMultiZoneInfoArrayOutput) Index(i pulumi.IntInput) LogstashMultiZoneInfoOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) LogstashMultiZoneInfo {
		return vs[0].([]LogstashMultiZoneInfo)[vs[1].(int)]
	}).(LogstashMultiZoneInfoOutput)
}
...
type GetInstancesInstanceList struct {
	...
	ElasticsearchPublicUrl string `pulumi:"elasticsearchPublicUrl"`
	// Elasticsearch VIP.
...
type GetInstancesInstanceListArgs struct {
	...
	// Elasticsearch public url.
	ElasticsearchPublicUrl pulumi.StringInput `pulumi:"elasticsearchPublicUrl"`
	// Elasticsearch VIP.
...
// Elasticsearch public url.
func (o GetInstancesInstanceListOutput) ElasticsearchPublicUrl() pulumi.StringOutput {
	return o.ApplyT(func(v GetInstancesInstanceList) string { return v.ElasticsearchPublicUrl }).(pulumi.StringOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceEsPublicAclInput)(nil)).Elem(), InstanceEsPublicAclArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceEsPublicAclPtrInput)(nil)).Elem(), InstanceEsPublicAclArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*LogstashMultiZoneInfoInput)(nil)).Elem(), LogstashMultiZoneInfoArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*LogstashMultiZoneInfoArrayInput)(nil)).Elem(), LogstashMultiZoneInfoArray{})
	...
	pulumi.RegisterOutputType(InstanceEsPublicAclOutput{})
	pulumi.RegisterOutputType(InstanceEsPublicAclPtrOutput{})
	...
	pulumi.RegisterOutputType(LogstashMultiZoneInfoOutput{})
	pulumi.RegisterOutputType(LogstashMultiZoneInfoArrayOutput{})
