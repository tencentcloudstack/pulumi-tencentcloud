...
//				return err
//			}
//			_, err = elasticsearch.NewInstance(ctx, "example_multi_zone", &elasticsearch.InstanceArgs{
//				InstanceName:      pulumi.String("tf_example_es"),
...
type Instance struct {
	...
	CosBackup InstanceCosBackupOutput `pulumi:"cosBackup"`
	...
	EsPublicAcl InstanceEsPublicAclOutput `pulumi:"esPublicAcl"`
	// Es public network address.
	EsPublicUrl pulumi.StringOutput `pulumi:"esPublicUrl"`
	...
	KibanaPrivateAccess pulumi.StringOutput `pulumi:"kibanaPrivateAccess"`
	// Kibana private URL.
	KibanaPrivateUrl pulumi.StringOutput `pulumi:"kibanaPrivateUrl"`
...
type instanceState struct {
	...
	// Public network access control list.
	EsPublicAcl *InstanceEsPublicAcl `pulumi:"esPublicAcl"`
	// Es public network address.
	EsPublicUrl *string `pulumi:"esPublicUrl"`
	// Name of the instance, which can contain 1 to 50 English letters, Chinese characters, digits, dashes(-), or underscores(_).
	InstanceName *string `pulumi:"instanceName"`
	// Kibana private network access status. Valid values are `OPEN` and `CLOSE`.
	KibanaPrivateAccess *string `pulumi:"kibanaPrivateAccess"`
	// Kibana private URL.
	KibanaPrivateUrl *string `pulumi:"kibanaPrivateUrl"`
	// Kibana public network access status. Valid values are `OPEN` and `CLOSE`.
...
type InstanceState struct {
	...
	// Public network access control list.
	EsPublicAcl InstanceEsPublicAclPtrInput
	// Es public network address.
	EsPublicUrl pulumi.StringPtrInput
	// Name of the instance, which can contain 1 to 50 English letters, Chinese characters, digits, dashes(-), or underscores(_).
	InstanceName pulumi.StringPtrInput
	// Kibana private network access status. Valid values are `OPEN` and `CLOSE`.
	KibanaPrivateAccess pulumi.StringPtrInput
	// Kibana private URL.
	KibanaPrivateUrl pulumi.StringPtrInput
	// Kibana public network access status. Valid values are `OPEN` and `CLOSE`.
...
// COS automatic backup information.
func (o InstanceOutput) CosBackup() InstanceCosBackupOutput {
	return o.ApplyT(func(v *Instance) InstanceCosBackupOutput { return v.CosBackup }).(InstanceCosBackupOutput)
}
...
// Public network access control list.
func (o InstanceOutput) EsPublicAcl() InstanceEsPublicAclOutput {
	return o.ApplyT(func(v *Instance) InstanceEsPublicAclOutput { return v.EsPublicAcl }).(InstanceEsPublicAclOutput)
}

// Es public network address.
func (o InstanceOutput) EsPublicUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.EsPublicUrl }).(pulumi.StringOutput)
}
...
// Kibana private network access status. Valid values are `OPEN` and `CLOSE`.
func (o InstanceOutput) KibanaPrivateAccess() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.KibanaPrivateAccess }).(pulumi.StringOutput)
}

// Kibana private URL.
func (o InstanceOutput) KibanaPrivateUrl() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.KibanaPrivateUrl }).(pulumi.StringOutput)
}
...
// ES cluster public network access status. Valid values are `OPEN` and `CLOSE`. Cannot be changed at the same time as `esAcl`.
func (o InstanceOutput) PublicAccess() pulumi.StringOutput {
	return o.ApplyT(func(v *Instance) pulumi.StringOutput { return v.PublicAccess }).(pulumi.StringOutput)
}
