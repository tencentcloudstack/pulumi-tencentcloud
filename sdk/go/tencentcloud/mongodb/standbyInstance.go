...
//				return err
//			}
//			_, err = mongodb.NewStandbyInstance(ctx, "mongodb", &mongodb.StandbyInstanceArgs{
...
//   - 1: Perform reconfiguration tasks within the maintenance time window.
//     Note: Adjusting the number of nodes and slices does not support changes within the maintenance window.
func (o StandbyInstanceOutput) InMaintenance() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *StandbyInstance) pulumi.IntPtrOutput { return v.InMaintenance }).(pulumi.IntPtrOutput)
}
...
// The tags of the Mongodb. Key name `project` is system reserved and can't be used.
func (o StandbyInstanceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *StandbyInstance) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
