...
type InstanceParamsInstanceParam struct {
...
// InstanceParamsInstanceParamInput is an input type that accepts InstanceParamsInstanceParamArgs and InstanceParamsInstanceParamOutput values.
// You can construct a concrete instance of `InstanceParamsInstanceParamInput` via:
//
//	InstanceParamsInstanceParamArgs{...}
type InstanceParamsInstanceParamInput interface {
	pulumi.Input

	ToInstanceParamsInstanceParamOutput() InstanceParamsInstanceParamOutput
	ToInstanceParamsInstanceParamOutputWithContext(context.Context) InstanceParamsInstanceParamOutput
}

type InstanceParamsInstanceParamArgs struct {
	// Parameter names that need to be modified.
...
func (InstanceParamsInstanceParamArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceParamsInstanceParam)(nil)).Elem()
}

func (i InstanceParamsInstanceParamArgs) ToInstanceParamsInstanceParamOutput() InstanceParamsInstanceParamOutput {
	return i.ToInstanceParamsInstanceParamOutputWithContext(context.Background())
}

func (i InstanceParamsInstanceParamArgs) ToInstanceParamsInstanceParamOutputWithContext(ctx context.Context) InstanceParamsInstanceParamOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceParamsInstanceParamOutput)
}

// InstanceParamsInstanceParamArrayInput is an input type that accepts InstanceParamsInstanceParamArray and InstanceParamsInstanceParamArrayOutput values.
// You can construct a concrete instance of `InstanceParamsInstanceParamArrayInput` via:
//
//	InstanceParamsInstanceParamArray{ InstanceParamsInstanceParamArgs{...} }
type InstanceParamsInstanceParamArrayInput interface {
	pulumi.Input

	ToInstanceParamsInstanceParamArrayOutput() InstanceParamsInstanceParamArrayOutput
	ToInstanceParamsInstanceParamArrayOutputWithContext(context.Context) InstanceParamsInstanceParamArrayOutput
}

type InstanceParamsInstanceParamArray []InstanceParamsInstanceParamInput

func (InstanceParamsInstanceParamArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]InstanceParamsInstanceParam)(nil)).Elem()
}

func (i InstanceParamsInstanceParamArray) ToInstanceParamsInstanceParamArrayOutput() InstanceParamsInstanceParamArrayOutput {
	return i.ToInstanceParamsInstanceParamArrayOutputWithContext(context.Background())
}

func (i InstanceParamsInstanceParamArray) ToInstanceParamsInstanceParamArrayOutputWithContext(ctx context.Context) InstanceParamsInstanceParamArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(InstanceParamsInstanceParamArrayOutput)
}

type InstanceParamsInstanceParamOutput struct{ *pulumi.OutputState }

func (InstanceParamsInstanceParamOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*InstanceParamsInstanceParam)(nil)).Elem()
}

func (o InstanceParamsInstanceParamOutput) ToInstanceParamsInstanceParamOutput() InstanceParamsInstanceParamOutput {
	return o
}

func (o InstanceParamsInstanceParamOutput) ToInstanceParamsInstanceParamOutputWithContext(ctx context.Context) InstanceParamsInstanceParamOutput {
	return o
}

// Parameter names that need to be modified.
func (o InstanceParamsInstanceParamOutput) Key() pulumi.StringOutput {
	return o.ApplyT(func(v InstanceParamsInstanceParam) string { return v.Key }).(pulumi.StringOutput)
}

// The value corresponding to the parameter name to be modified.
func (o InstanceParamsInstanceParamOutput) Value() pulumi.StringOutput {
	return o.ApplyT(func(v InstanceParamsInstanceParam) string { return v.Value }).(pulumi.StringOutput)
}

type InstanceParamsInstanceParamArrayOutput struct{ *pulumi.OutputState }

func (InstanceParamsInstanceParamArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]InstanceParamsInstanceParam)(nil)).Elem()
}

func (o InstanceParamsInstanceParamArrayOutput) ToInstanceParamsInstanceParamArrayOutput() InstanceParamsInstanceParamArrayOutput {
	return o
}

func (o InstanceParamsInstanceParamArrayOutput) ToInstanceParamsInstanceParamArrayOutputWithContext(ctx context.Context) InstanceParamsInstanceParamArrayOutput {
	return o
}

func (o InstanceParamsInstanceParamArrayOutput) Index(i pulumi.IntInput) InstanceParamsInstanceParamOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) InstanceParamsInstanceParam {
		return vs[0].([]InstanceParamsInstanceParam)[vs[1].(int)]
	}).(InstanceParamsInstanceParamOutput)
}
...
type GetInstanceUrlsUrl struct {
...
// GetInstanceUrlsUrlInput is an input type that accepts GetInstanceUrlsUrlArgs and GetInstanceUrlsUrlOutput values.
// You can construct a concrete instance of `GetInstanceUrlsUrlInput` via:
//
//	GetInstanceUrlsUrlArgs{...}
type GetInstanceUrlsUrlInput interface {
	pulumi.Input

	ToGetInstanceUrlsUrlOutput() GetInstanceUrlsUrlOutput
	ToGetInstanceUrlsUrlOutputWithContext(context.Context) GetInstanceUrlsUrlOutput
}

type GetInstanceUrlsUrlArgs struct {
	// Example connection string access address in the form of an instance URI.
	...
	// 	- MONGOS_READ_PRIMARY_AND_SECONDARY: refers to the connection between the master node and slave node of Mongos through this URI;
	// 	- MONGOS_READ_SECONDARY_AND_READONLY: refers to the connection between Mongos slave node and read-only node through this URI.
	UrlType pulumi.StringInput `pulumi:"urlType"`
}

func (GetInstanceUrlsUrlArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetInstanceUrlsUrl)(nil)).Elem()
}

func (i GetInstanceUrlsUrlArgs) ToGetInstanceUrlsUrlOutput() GetInstanceUrlsUrlOutput {
	return i.ToGetInstanceUrlsUrlOutputWithContext(context.Background())
}

func (i GetInstanceUrlsUrlArgs) ToGetInstanceUrlsUrlOutputWithContext(ctx context.Context) GetInstanceUrlsUrlOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetInstanceUrlsUrlOutput)
}

// GetInstanceUrlsUrlArrayInput is an input type that accepts GetInstanceUrlsUrlArray and GetInstanceUrlsUrlArrayOutput values.
// You can construct a concrete instance of `GetInstanceUrlsUrlArrayInput` via:
//
//	GetInstanceUrlsUrlArray{ GetInstanceUrlsUrlArgs{...} }
type GetInstanceUrlsUrlArrayInput interface {
	pulumi.Input

	ToGetInstanceUrlsUrlArrayOutput() GetInstanceUrlsUrlArrayOutput
	ToGetInstanceUrlsUrlArrayOutputWithContext(context.Context) GetInstanceUrlsUrlArrayOutput
}

type GetInstanceUrlsUrlArray []GetInstanceUrlsUrlInput

func (GetInstanceUrlsUrlArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetInstanceUrlsUrl)(nil)).Elem()
}

func (i GetInstanceUrlsUrlArray) ToGetInstanceUrlsUrlArrayOutput() GetInstanceUrlsUrlArrayOutput {
	return i.ToGetInstanceUrlsUrlArrayOutputWithContext(context.Background())
}

func (i GetInstanceUrlsUrlArray) ToGetInstanceUrlsUrlArrayOutputWithContext(ctx context.Context) GetInstanceUrlsUrlArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetInstanceUrlsUrlArrayOutput)
}

type GetInstanceUrlsUrlOutput struct{ *pulumi.OutputState }

func (GetInstanceUrlsUrlOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetInstanceUrlsUrl)(nil)).Elem()
}

func (o GetInstanceUrlsUrlOutput) ToGetInstanceUrlsUrlOutput() GetInstanceUrlsUrlOutput {
	return o
}

func (o GetInstanceUrlsUrlOutput) ToGetInstanceUrlsUrlOutputWithContext(ctx context.Context) GetInstanceUrlsUrlOutput {
	return o
}

// Example connection string access address in the form of an instance URI.
func (o GetInstanceUrlsUrlOutput) Address() pulumi.StringOutput {
	return o.ApplyT(func(v GetInstanceUrlsUrl) string { return v.Address }).(pulumi.StringOutput)
}
...
//   - MONGOS_READ_PRIMARY_AND_SECONDARY: refers to the connection between the master node and slave node of Mongos through this URI;
//   - MONGOS_READ_SECONDARY_AND_READONLY: refers to the connection between Mongos slave node and read-only node through this URI.
func (o GetInstanceUrlsUrlOutput) UrlType() pulumi.StringOutput {
	return o.ApplyT(func(v GetInstanceUrlsUrl) string { return v.UrlType }).(pulumi.StringOutput)
}

type GetInstanceUrlsUrlArrayOutput struct{ *pulumi.OutputState }

func (GetInstanceUrlsUrlArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetInstanceUrlsUrl)(nil)).Elem()
}

func (o GetInstanceUrlsUrlArrayOutput) ToGetInstanceUrlsUrlArrayOutput() GetInstanceUrlsUrlArrayOutput {
	return o
}

func (o GetInstanceUrlsUrlArrayOutput) ToGetInstanceUrlsUrlArrayOutputWithContext(ctx context.Context) GetInstanceUrlsUrlArrayOutput {
	return o
}

func (o GetInstanceUrlsUrlArrayOutput) Index(i pulumi.IntInput) GetInstanceUrlsUrlOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetInstanceUrlsUrl {
		return vs[0].([]GetInstanceUrlsUrl)[vs[1].(int)]
	}).(GetInstanceUrlsUrlOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceParamsInstanceParamInput)(nil)).Elem(), InstanceParamsInstanceParamArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*InstanceParamsInstanceParamArrayInput)(nil)).Elem(), InstanceParamsInstanceParamArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetInstanceUrlsUrlInput)(nil)).Elem(), GetInstanceUrlsUrlArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetInstanceUrlsUrlArrayInput)(nil)).Elem(), GetInstanceUrlsUrlArray{})
	...
	pulumi.RegisterOutputType(InstanceParamsInstanceParamOutput{})
	pulumi.RegisterOutputType(InstanceParamsInstanceParamArrayOutput{})
	...
	pulumi.RegisterOutputType(GetInstanceUrlsUrlOutput{})
	pulumi.RegisterOutputType(GetInstanceUrlsUrlArrayOutput{})
