...
// Environment variable of the SCF function.
func (o GetFunctionsFunctionOutput) Environment() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetFunctionsFunction) map[string]string { return v.Environment }).(pulumi.StringMapOutput)
}
...
// Tags of the SCF function to be queried, can use up to 10 tags.
func (o GetFunctionsFunctionOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetFunctionsFunction) map[string]string { return v.Tags }).(pulumi.StringMapOutput)
}
