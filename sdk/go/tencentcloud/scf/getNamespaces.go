...
//			fooNamespace, err := scf.NewNamespace(ctx, "foo", &scf.NamespaceArgs{
...
//				Namespace: fooNamespace.ID().ToIDOutput().ToStringOutput(),
//			}, nil)
//			return nil
//		})
//	}
...
func GetNamespacesOutput(ctx *pulumi.Context, args GetNamespacesOutputArgs, opts ...pulumi.InvokeOption) GetNamespacesResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Scf/getNamespaces:getNamespaces", args, GetNamespacesResultOutput{}, options).(GetNamespacesResultOutput)
}
