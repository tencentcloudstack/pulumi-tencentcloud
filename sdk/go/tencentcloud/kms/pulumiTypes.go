...
type GetKeysKeyListArgs struct {
	...
	Description pulumi.StringInput `pulumi:"description"`
	// The HSM cluster ID corresponding to KMS Advanced Edition (only valid for KMS Exclusive/Managed Edition service instances).
	HsmClusterId pulumi.StringInput `pulumi:"hsmClusterId"`
	// ID of CMK.
	KeyId pulumi.StringInput `pulumi:"keyId"`
	// Specify whether to enable key rotation.
	KeyRotationEnabled pulumi.BoolInput `pulumi:"keyRotationEnabled"`
...
// The HSM cluster ID corresponding to KMS Advanced Edition (only valid for KMS Exclusive/Managed Edition service instances).
func (o GetKeysKeyListOutput) HsmClusterId() pulumi.StringOutput {
	return o.ApplyT(func(v GetKeysKeyList) string { return v.HsmClusterId }).(pulumi.StringOutput)
}
...
type GetServiceStatusExclusiveHsmList struct {
	// Exclusive cluster ID.
	HsmClusterId string `pulumi:"hsmClusterId"`
	// Exclusive cluster name.
	HsmClusterName string `pulumi:"hsmClusterName"`
}

// GetServiceStatusExclusiveHsmListInput is an input type that accepts GetServiceStatusExclusiveHsmListArgs and GetServiceStatusExclusiveHsmListOutput values.
// You can construct a concrete instance of `GetServiceStatusExclusiveHsmListInput` via:
//
//	GetServiceStatusExclusiveHsmListArgs{...}
type GetServiceStatusExclusiveHsmListInput interface {
	pulumi.Input

	ToGetServiceStatusExclusiveHsmListOutput() GetServiceStatusExclusiveHsmListOutput
	ToGetServiceStatusExclusiveHsmListOutputWithContext(context.Context) GetServiceStatusExclusiveHsmListOutput
}

type GetServiceStatusExclusiveHsmListArgs struct {
	// Exclusive cluster ID.
	HsmClusterId pulumi.StringInput `pulumi:"hsmClusterId"`
	// Exclusive cluster name.
	HsmClusterName pulumi.StringInput `pulumi:"hsmClusterName"`
}

func (GetServiceStatusExclusiveHsmListArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetServiceStatusExclusiveHsmList)(nil)).Elem()
}

func (i GetServiceStatusExclusiveHsmListArgs) ToGetServiceStatusExclusiveHsmListOutput() GetServiceStatusExclusiveHsmListOutput {
	return i.ToGetServiceStatusExclusiveHsmListOutputWithContext(context.Background())
}

func (i GetServiceStatusExclusiveHsmListArgs) ToGetServiceStatusExclusiveHsmListOutputWithContext(ctx context.Context) GetServiceStatusExclusiveHsmListOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetServiceStatusExclusiveHsmListOutput)
}

// GetServiceStatusExclusiveHsmListArrayInput is an input type that accepts GetServiceStatusExclusiveHsmListArray and GetServiceStatusExclusiveHsmListArrayOutput values.
// You can construct a concrete instance of `GetServiceStatusExclusiveHsmListArrayInput` via:
//
//	GetServiceStatusExclusiveHsmListArray{ GetServiceStatusExclusiveHsmListArgs{...} }
type GetServiceStatusExclusiveHsmListArrayInput interface {
	pulumi.Input

	ToGetServiceStatusExclusiveHsmListArrayOutput() GetServiceStatusExclusiveHsmListArrayOutput
	ToGetServiceStatusExclusiveHsmListArrayOutputWithContext(context.Context) GetServiceStatusExclusiveHsmListArrayOutput
}

type GetServiceStatusExclusiveHsmListArray []GetServiceStatusExclusiveHsmListInput

func (GetServiceStatusExclusiveHsmListArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetServiceStatusExclusiveHsmList)(nil)).Elem()
}

func (i GetServiceStatusExclusiveHsmListArray) ToGetServiceStatusExclusiveHsmListArrayOutput() GetServiceStatusExclusiveHsmListArrayOutput {
	return i.ToGetServiceStatusExclusiveHsmListArrayOutputWithContext(context.Background())
}

func (i GetServiceStatusExclusiveHsmListArray) ToGetServiceStatusExclusiveHsmListArrayOutputWithContext(ctx context.Context) GetServiceStatusExclusiveHsmListArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetServiceStatusExclusiveHsmListArrayOutput)
}

type GetServiceStatusExclusiveHsmListOutput struct{ *pulumi.OutputState }

func (GetServiceStatusExclusiveHsmListOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetServiceStatusExclusiveHsmList)(nil)).Elem()
}

func (o GetServiceStatusExclusiveHsmListOutput) ToGetServiceStatusExclusiveHsmListOutput() GetServiceStatusExclusiveHsmListOutput {
	return o
}

func (o GetServiceStatusExclusiveHsmListOutput) ToGetServiceStatusExclusiveHsmListOutputWithContext(ctx context.Context) GetServiceStatusExclusiveHsmListOutput {
	return o
}

// Exclusive cluster ID.
func (o GetServiceStatusExclusiveHsmListOutput) HsmClusterId() pulumi.StringOutput {
	return o.ApplyT(func(v GetServiceStatusExclusiveHsmList) string { return v.HsmClusterId }).(pulumi.StringOutput)
}

// Exclusive cluster name.
func (o GetServiceStatusExclusiveHsmListOutput) HsmClusterName() pulumi.StringOutput {
	return o.ApplyT(func(v GetServiceStatusExclusiveHsmList) string { return v.HsmClusterName }).(pulumi.StringOutput)
}

type GetServiceStatusExclusiveHsmListArrayOutput struct{ *pulumi.OutputState }

func (GetServiceStatusExclusiveHsmListArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetServiceStatusExclusiveHsmList)(nil)).Elem()
}

func (o GetServiceStatusExclusiveHsmListArrayOutput) ToGetServiceStatusExclusiveHsmListArrayOutput() GetServiceStatusExclusiveHsmListArrayOutput {
	return o
}

func (o GetServiceStatusExclusiveHsmListArrayOutput) ToGetServiceStatusExclusiveHsmListArrayOutputWithContext(ctx context.Context) GetServiceStatusExclusiveHsmListArrayOutput {
	return o
}

func (o GetServiceStatusExclusiveHsmListArrayOutput) Index(i pulumi.IntInput) GetServiceStatusExclusiveHsmListOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetServiceStatusExclusiveHsmList {
		return vs[0].([]GetServiceStatusExclusiveHsmList)[vs[1].(int)]
	}).(GetServiceStatusExclusiveHsmListOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetServiceStatusExclusiveHsmListInput)(nil)).Elem(), GetServiceStatusExclusiveHsmListArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetServiceStatusExclusiveHsmListArrayInput)(nil)).Elem(), GetServiceStatusExclusiveHsmListArray{})
	...
	pulumi.RegisterOutputType(GetServiceStatusExclusiveHsmListOutput{})
	pulumi.RegisterOutputType(GetServiceStatusExclusiveHsmListArrayOutput{})
