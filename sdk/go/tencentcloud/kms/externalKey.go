...
// The HSM cluster ID corresponding to KMS Advanced Edition (only valid for KMS Exclusive/Managed Edition service instances).
func (o ExternalKeyOutput) HsmClusterId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ExternalKey) pulumi.StringPtrOutput { return v.HsmClusterId }).(pulumi.StringPtrOutput)
}
