...
type Vip struct {
	...
	CheckAssociate pulumi.BoolOutput `pulumi:"checkAssociate"`
...
type vipState struct {
	...
	// Whether to enable verification of the submachine or network card range during HAVIP drift. Not enabled by default.
	CheckAssociate *bool `pulumi:"checkAssociate"`
	// Create time of the HA VIP.
...
type VipState struct {
	...
	// Whether to enable verification of the submachine or network card range during HAVIP drift. Not enabled by default.
	CheckAssociate pulumi.BoolPtrInput
	// Create time of the HA VIP.
...
// Whether to enable verification of the submachine or network card range during HAVIP drift. Not enabled by default.
func (o VipOutput) CheckAssociate() pulumi.BoolOutput {
	return o.ApplyT(func(v *Vip) pulumi.BoolOutput { return v.CheckAssociate }).(pulumi.BoolOutput)
}
