...
func GetInstanceNodeInfoOutput(ctx *pulumi.Context, args GetInstanceNodeInfoOutputArgs, opts ...pulumi.InvokeOption) GetInstanceNodeInfoResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Mariadb/getInstanceNodeInfo:getInstanceNodeInfo", args, GetInstanceNodeInfoResultOutput{}, options).(GetInstanceNodeInfoResultOutput)
}
