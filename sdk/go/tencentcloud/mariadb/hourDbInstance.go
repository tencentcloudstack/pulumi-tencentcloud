...
// Tag description list.
func (o HourDbInstanceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *HourDbInstance) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
