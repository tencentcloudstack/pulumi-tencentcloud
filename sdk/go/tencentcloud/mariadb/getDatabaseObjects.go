...
func GetDatabaseObjectsOutput(ctx *pulumi.Context, args GetDatabaseObjectsOutputArgs, opts ...pulumi.InvokeOption) GetDatabaseObjectsResultOutput {
	...
	return ctx.InvokeOutput("tencentcloud:Mariadb/getDatabaseObjects:getDatabaseObjects", args, GetDatabaseObjectsResultOutput{}, options).(GetDatabaseObjectsResultOutput)
}
