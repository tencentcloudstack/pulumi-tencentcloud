...
func GetProjectSecurityGroups(ctx *pulumi.Context, args *GetProjectSecurityGroupsArgs, opts ...pulumi.InvokeOption) (*GetProjectSecurityGroupsResult, error) {
	...
	err := ctx.Invoke("tencentcloud:Mariadb/getProjectSecurityGroups:getProjectSecurityGroups", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetProjectSecurityGroupsOutput(ctx *pulumi.Context, args GetProjectSecurityGroupsOutputArgs, opts ...pulumi.InvokeOption) GetProjectSecurityGroupsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetProjectSecurityGroupsResultOutput, error) {
			...
			return ctx.InvokeOutput("tencentcloud:Mariadb/getProjectSecurityGroups:getProjectSecurityGroups", args, GetProjectSecurityGroupsResultOutput{}, options).(GetProjectSecurityGroupsResultOutput), nil
