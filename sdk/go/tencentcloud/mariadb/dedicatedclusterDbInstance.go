...
//			_, err := mariadb.NewDedicatedclusterDbInstance(ctx, "dedicatedcluster_db_instance", &mariadb.DedicatedclusterDbInstanceArgs{
...
// Tag description list.
func (o DedicatedclusterDbInstanceOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *DedicatedclusterDbInstance) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
