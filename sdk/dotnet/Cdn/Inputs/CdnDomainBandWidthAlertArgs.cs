...
namespace Pulumi.Tencentcloud.Cdn.Inputs
{
    ...
    public sealed class CdnDomainBandWidthAlertArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("statisticItem")]
        public Input<Inputs.CdnDomainBandWidthAlertStatisticItemArgs>? StatisticItem { get; set; }

        [Input("switch", required: true)]
        public Input<string> Switch { get; set; } = null!;

        public CdnDomainBandWidthAlertArgs()
        {
        }
    }
}
