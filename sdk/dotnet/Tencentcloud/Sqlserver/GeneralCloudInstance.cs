...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Sqlserver
{
    ...
    public partial class GeneralCloudInstance : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("drZones")]
        public Output<ImmutableArray<string>> DrZones { get; private set; } = null!;
        ...
        /// </summary>
        [Output("multiNodes")]
        public Output<bool> MultiNodes { get; private set; } = null!;
    ...
    public sealed class GeneralCloudInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("drZones")]
        private InputList<string>? _drZones;

        /// <summary>
        /// The standby node availability area is empty by default. When MultiNodes = true, the primary node and standby node availability areas cannot all be the same. The minimum number of standby availability areas set is 2, and the maximum number is no more than 5.
        /// </summary>
        public InputList<string> DrZones
        {
            get => _drZones ?? (_drZones = new InputList<string>());
            set => _drZones = value;
        }
        ...
        /// </summary>
        [Input("multiNodes")]
        public Input<bool>? MultiNodes { get; set; }
