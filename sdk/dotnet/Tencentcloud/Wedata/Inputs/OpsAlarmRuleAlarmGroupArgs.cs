...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Wedata.Inputs
{
    ...
    public sealed class OpsAlarmRuleAlarmGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.OpsAlarmRuleAlarmGroupNotificationFatigueArgs>? NotificationFatigue { get; set; }

        [Input("webHooks")]
        private InputList<Inputs.OpsAlarmRuleAlarmGroupWebHookArgs>? _webHooks;

        /// <summary>
        /// List of webhook addresses for the alarm group.
        /// </summary>
        public InputList<Inputs.OpsAlarmRuleAlarmGroupWebHookArgs> WebHooks
        {
            get => _webHooks ?? (_webHooks = new InputList<Inputs.OpsAlarmRuleAlarmGroupWebHookArgs>());
            set => _webHooks = value;
        }

        public OpsAlarmRuleAlarmGroupArgs()
        {
        }
        public static new OpsAlarmRuleAlarmGroupArgs Empty => new OpsAlarmRuleAlarmGroupArgs();
    }
}
