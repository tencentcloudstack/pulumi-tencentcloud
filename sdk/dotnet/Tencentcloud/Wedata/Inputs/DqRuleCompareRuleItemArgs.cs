...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Wedata.Inputs
{
    ...
    public sealed class DqRuleCompareRuleItemArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("valueLists")]
        private InputList<Inputs.DqRuleCompareRuleItemValueListArgs>? _valueLists;

        /// <summary>
        /// Compare the threshold listNote: This field may return null, indicating that a valid value cannot be obtained.
        /// </summary>
        public InputList<Inputs.DqRuleCompareRuleItemValueListArgs> ValueLists
        {
            get => _valueLists ?? (_valueLists = new InputList<Inputs.DqRuleCompareRuleItemValueListArgs>());
