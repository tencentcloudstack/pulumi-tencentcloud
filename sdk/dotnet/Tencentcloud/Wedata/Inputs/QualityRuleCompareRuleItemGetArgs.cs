...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Wedata.Inputs
{
    ...
    public sealed class QualityRuleCompareRuleItemGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("valueLists")]
        private InputList<Inputs.QualityRuleCompareRuleItemValueListGetArgs>? _valueLists;

        /// <summary>
        /// Comparison threshold list (required).
        /// </summary>
        public InputList<Inputs.QualityRuleCompareRuleItemValueListGetArgs> ValueLists
        {
            get => _valueLists ?? (_valueLists = new InputList<Inputs.QualityRuleCompareRuleItemValueListGetArgs>());
            set => _valueLists = value;
        }

        public QualityRuleCompareRuleItemGetArgs()
        {
        }
        public static new QualityRuleCompareRuleItemGetArgs Empty => new QualityRuleCompareRuleItemGetArgs();
    }
}
