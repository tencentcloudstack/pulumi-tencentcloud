...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Wedata.Inputs
{
    ...
    public sealed class QualityRuleGroupRuleGroupExecStrategyBoListGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("groupConfig")]
        public Input<Inputs.QualityRuleGroupRuleGroupExecStrategyBoListGroupConfigGetArgs>? GroupConfig { get; set; }
        ...
        [Input("tasks")]
        private InputList<Inputs.QualityRuleGroupRuleGroupExecStrategyBoListTaskGetArgs>? _tasks;

        /// <summary>
        /// Associated production scheduling task list, required when MonitorType=2.
        /// </summary>
        public InputList<Inputs.QualityRuleGroupRuleGroupExecStrategyBoListTaskGetArgs> Tasks
        {
            get => _tasks ?? (_tasks = new InputList<Inputs.QualityRuleGroupRuleGroupExecStrategyBoListTaskGetArgs>());
            set => _tasks = value;
        }
        ...
        public QualityRuleGroupRuleGroupExecStrategyBoListGetArgs()
        {
        }
        public static new QualityRuleGroupRuleGroupExecStrategyBoListGetArgs Empty => new QualityRuleGroupRuleGroupExecStrategyBoListGetArgs();
    }
}
