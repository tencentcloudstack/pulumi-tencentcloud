...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Postgresql
{
    ...
    /// {
    ///     var backupDownloadRestrictionConfig = new Tencentcloud.Postgresql.BackupDownloadRestrictionConfig("backup_download_restriction_config", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var pgVpc = new Tencentcloud.Vpc.Instance("pg_vpc", new()
    ///     {
    ///         Name = instanceName,
    ///         CidrBlock = vpcCidr,
    ///     });
