...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Emr
{
    ...
    ///     });
    /// 
    ///     var emrVpc = new Tencentcloud.Vpc.Instance("emr_vpc", new()
    ///     {
    ///         Name = "emr-vpc",
    ///         CidrBlock = "10.0.0.0/16",
    ///     });
    /// 
    ///     var emrSubnet = new Tencentcloud.Subnet.Instance("emr_subnet", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var emrSg = new Tencentcloud.Security.Group("emr_sg", new()
    ///     {
    ///         Name = "emr-sg",
    ///         Description = "emr sg",
    ///         ProjectId = 0,
    ///     });
    /// 
    ///     var emrCluster = new Tencentcloud.Emr.Cluster("emr_cluster", new()
    ///     {
    ///         ProductId = 38,
    ///         VpcSettings = 
    ///         {
    ...
    public partial class Cluster : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableDictionary<string, string>?> LoginSettings { get; private set; } = null!;
        ...
        /// </summary>
        [Output("multiZoneSettings")]
        public Output<ImmutableArray<Outputs.ClusterMultiZoneSetting>> MultiZoneSettings { get; private set; } = null!;
        ...
        /// </summary>
        [Output("placement")]
        public Output<ImmutableDictionary<string, string>> Placement { get; private set; } = null!;
        ...
        /// </summary>
        [Output("vpcSettings")]
        public Output<ImmutableDictionary<string, string>> VpcSettings { get; private set; } = null!;
    ...
    public sealed class ClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("loginSettings")]
        private InputMap<string>? _loginSettings;

        /// <summary>
        /// Instance login settings. There are two optional fields:- password: Instance login password: 8-16 characters, including uppercase letters, lowercase letters, numbers and special characters. Special symbols only support! @% ^ *. The first bit of the password cannot be a special character;- public_key_id: Public key id. After the key is associated, the instance can be accessed through the corresponding private key.
        /// </summary>
        public InputMap<string> LoginSettings
        {
            get => _loginSettings ?? (_loginSettings = new InputMap<string>());
            set
            {
        ...
        [Input("multiZoneSettings")]
        private InputList<Inputs.ClusterMultiZoneSettingArgs>? _multiZoneSettings;

        /// <summary>
        /// The specification of node resources is as follows: fill in a few available areas. In order, the first one is the main available area, the second one is the backup available area, and the third one is the arbitration available area.
        /// </summary>
        public InputList<Inputs.ClusterMultiZoneSettingArgs> MultiZoneSettings
        {
            get => _multiZoneSettings ?? (_multiZoneSettings = new InputList<Inputs.ClusterMultiZoneSettingArgs>());
            set => _multiZoneSettings = value;
        }
        ...
        [Input("placement")]
        private InputMap<string>? _placement;

        /// <summary>
        /// It will be deprecated in later versions. Use `PlacementInfo` instead. The location of the instance.
        /// </summary>
        [Obsolete(@"It will be deprecated in later versions. Use `PlacementInfo` instead.")]
        public InputMap<string> Placement
        {
            get => _placement ?? (_placement = new InputMap<string>());
    ...
    public sealed class ClusterState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("multiZoneSettings")]
        private InputList<Inputs.ClusterMultiZoneSettingGetArgs>? _multiZoneSettings;

        /// <summary>
        /// The specification of node resources is as follows: fill in a few available areas. In order, the first one is the main available area, the second one is the backup available area, and the third one is the arbitration available area.
        /// </summary>
        public InputList<Inputs.ClusterMultiZoneSettingGetArgs> MultiZoneSettings
        {
            get => _multiZoneSettings ?? (_multiZoneSettings = new InputList<Inputs.ClusterMultiZoneSettingGetArgs>());
            set => _multiZoneSettings = value;
        }
