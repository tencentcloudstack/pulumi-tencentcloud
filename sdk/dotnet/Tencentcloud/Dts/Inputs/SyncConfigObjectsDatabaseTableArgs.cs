...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Dts.Inputs
{
    ...
    public sealed class SyncConfigObjectsDatabaseTableArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("columns")]
        private InputList<Inputs.SyncConfigObjectsDatabaseTableColumnArgs>? _columns;
        ...
        /// </summary>
        public InputList<Inputs.SyncConfigObjectsDatabaseTableColumnArgs> Columns
        {
            get => _columns ?? (_columns = new InputList<Inputs.SyncConfigObjectsDatabaseTableColumnArgs>());
            set => _columns = value;
        }
