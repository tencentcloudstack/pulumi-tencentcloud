...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mps.Inputs
{
    ...
    public sealed class WithdrawsWatermarkOperationInputInfoArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The information of the COS object to process. This parameter is valid and required when `Type` is `COS`.
        /// </summary>
        [Input("cosInputInfo")]
        public Input<Inputs.WithdrawsWatermarkOperationInputInfoCosInputInfoArgs>? CosInputInfo { get; set; }
        ...
        /// </summary>
        [Input("s3InputInfo")]
        public Input<Inputs.WithdrawsWatermarkOperationInputInfoS3InputInfoArgs>? S3InputInfo { get; set; }
        ...
        /// </summary>
        [Input("urlInputInfo")]
        public Input<Inputs.WithdrawsWatermarkOperationInputInfoUrlInputInfoArgs>? UrlInputInfo { get; set; }

        public WithdrawsWatermarkOperationInputInfoArgs()
        {
        }
        public static new WithdrawsWatermarkOperationInputInfoArgs Empty => new WithdrawsWatermarkOperationInputInfoArgs();
    }
}
