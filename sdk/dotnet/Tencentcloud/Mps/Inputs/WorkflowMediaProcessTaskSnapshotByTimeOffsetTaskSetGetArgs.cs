...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mps.Inputs
{
    ...
    public sealed class WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetObjectNumberFormatGetArgs>? ObjectNumberFormat { get; set; }
        ...
        /// </summary>
        [Input("outputStorage")]
        public Input<Inputs.WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetOutputStorageGetArgs>? OutputStorage { get; set; }
        ...
        [Input("watermarkSets")]
        private InputList<Inputs.WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetWatermarkSetGetArgs>? _watermarkSets;

        /// <summary>
        /// Watermark list, support multiple pictures or text watermarks, up to 10.
        /// </summary>
        public InputList<Inputs.WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetWatermarkSetGetArgs> WatermarkSets
        {
            get => _watermarkSets ?? (_watermarkSets = new InputList<Inputs.WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetWatermarkSetGetArgs>());
            set => _watermarkSets = value;
        }

        public WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetGetArgs()
        {
        }
        public static new WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetGetArgs Empty => new WorkflowMediaProcessTaskSnapshotByTimeOffsetTaskSetGetArgs();
    }
}
