...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mps.Inputs
{
    ...
    public sealed class InputInputGroupSrtSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.InputInputGroupSrtSettingsSourceAddressArgs>? _sourceAddresses;

        /// <summary>
        /// SRT peer address, required when Mode is CALLER, and only 1 set can be filled in.
        /// </summary>
        public InputList<Inputs.InputInputGroupSrtSettingsSourceAddressArgs> SourceAddresses
        {
            get => _sourceAddresses ?? (_sourceAddresses = new InputList<Inputs.InputInputGroupSrtSettingsSourceAddressArgs>());
