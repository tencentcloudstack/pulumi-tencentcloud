...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mps.Outputs
{
    ...
    [OutputType]
    public sealed class WithdrawsWatermarkOperationInputInfo
    {
        /// <summary>
        /// The information of the COS object to process. This parameter is valid and required when `Type` is `COS`.
        /// </summary>
        public readonly Outputs.WithdrawsWatermarkOperationInputInfoCosInputInfo? CosInputInfo;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.WithdrawsWatermarkOperationInputInfoS3InputInfo? S3InputInfo;
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.WithdrawsWatermarkOperationInputInfoUrlInputInfo? UrlInputInfo;

        [OutputConstructor]
        private WithdrawsWatermarkOperationInputInfo(
            Outputs.WithdrawsWatermarkOperationInputInfoCosInputInfo? cosInputInfo,

            Outputs.WithdrawsWatermarkOperationInputInfoS3InputInfo? s3InputInfo,

            string type,

            Outputs.WithdrawsWatermarkOperationInputInfoUrlInputInfo? urlInputInfo)
        {
