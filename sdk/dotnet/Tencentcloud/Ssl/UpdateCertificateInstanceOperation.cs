...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Ssl
{
    ...
    /// {
    ///     var updateCertificateInstance = new Tencentcloud.Ssl.UpdateCertificateInstanceOperation("update_certificate_instance", new()
    ///     {
    ...
    ///         CertificatePublicKey = Std.File.Invoke(new()
    ///         {
    ///             Input = "xxx.crt",
