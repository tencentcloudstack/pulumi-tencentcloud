...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cfw
{
    ...
    ///     });
    /// 
    ///     var exampleVpcFirewallSwitch = new Tencentcloud.Cfw.VpcFirewallSwitch("example", new()
    ///     {
    ///         VpcInsId = example.Apply(getVpcFwSwitchesResult =&gt; getVpcFwSwitchesResult.Id),
    ///         SwitchId = example.Apply(getVpcFwSwitchesResult =&gt; getVpcFwSwitchesResult.SwitchLists[0]?.SwitchId),
    ///         Enable = 0,
    ///     });
    /// 
    /// });
