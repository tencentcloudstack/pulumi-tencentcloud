...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cfw
{
    ...
    /// 
    ///     var exampleEdgeFirewallSwitch = new Tencentcloud.Cfw.EdgeFirewallSwitch("example", new()
    ///     {
    ///         PublicIp = example.Apply(getEdgeFwSwitchesResult =&gt; getEdgeFwSwitchesResult.Datas[0]?.PublicIp),
    ///         SwitchMode = 1,
    ///         Enable = 0,
    ///     });
    /// 
