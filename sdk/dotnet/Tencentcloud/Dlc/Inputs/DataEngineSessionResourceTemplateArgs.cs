...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Dlc.Inputs
{
    ...
    public sealed class DataEngineSessionResourceTemplateArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.DataEngineSessionResourceTemplateRunningTimeParameterArgs>? _runningTimeParameters;

        /// <summary>
        /// The running time parameters of the session resource configuration template for a Spark job cluster.
        /// </summary>
        public InputList<Inputs.DataEngineSessionResourceTemplateRunningTimeParameterArgs> RunningTimeParameters
        {
            get => _runningTimeParameters ?? (_runningTimeParameters = new InputList<Inputs.DataEngineSessionResourceTemplateRunningTimeParameterArgs>());
