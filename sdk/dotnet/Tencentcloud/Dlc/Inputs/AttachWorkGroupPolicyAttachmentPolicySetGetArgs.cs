...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Dlc.Inputs
{
    ...
    public sealed class AttachWorkGroupPolicyAttachmentPolicySetGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("isAdminPolicy")]
        public Input<bool>? IsAdminPolicy { get; set; }
        ...
        public AttachWorkGroupPolicyAttachmentPolicySetGetArgs()
        {
        }
        public static new AttachWorkGroupPolicyAttachmentPolicySetGetArgs Empty => new AttachWorkGroupPolicyAttachmentPolicySetGetArgs();
    }
}
