...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Gaap.Outputs
{
    ...
    [OutputType]
    public sealed class GetDestRegionsDestRegionSetSupportFeatureResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDestRegionsDestRegionSetSupportFeatureResult(ImmutableArray<string> networkTypes)
        {
