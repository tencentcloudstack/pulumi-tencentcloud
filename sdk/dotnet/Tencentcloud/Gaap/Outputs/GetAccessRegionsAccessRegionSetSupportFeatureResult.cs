...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Gaap.Outputs
{
    ...
    [OutputType]
    public sealed class GetAccessRegionsAccessRegionSetSupportFeatureResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAccessRegionsAccessRegionSetSupportFeatureResult(ImmutableArray<string> networkTypes)
        {
