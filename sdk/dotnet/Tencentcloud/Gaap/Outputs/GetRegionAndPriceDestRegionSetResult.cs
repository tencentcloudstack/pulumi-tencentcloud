...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Gaap.Outputs
{
    ...
    [OutputType]
    public sealed class GetRegionAndPriceDestRegionSetResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetRegionAndPriceDestRegionSetSupportFeatureResult> SupportFeatures;

        [OutputConstructor]
        private GetRegionAndPriceDestRegionSetResult(
            int featureBitmap,
            ...
            ImmutableArray<Outputs.GetRegionAndPriceDestRegionSetSupportFeatureResult> supportFeatures)
        {
