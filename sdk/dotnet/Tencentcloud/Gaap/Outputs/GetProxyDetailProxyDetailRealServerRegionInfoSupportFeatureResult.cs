...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Gaap.Outputs
{
    ...
    [OutputType]
    public sealed class GetProxyDetailProxyDetailRealServerRegionInfoSupportFeatureResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetProxyDetailProxyDetailRealServerRegionInfoSupportFeatureResult(ImmutableArray<string> networkTypes)
        {
