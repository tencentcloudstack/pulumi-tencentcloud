...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Tcm
{
    ...
    /// {
    ///     var accessLogConfig = new Tencentcloud.Tcm.AccessLogConfig("access_log_config", new()
    ///     {
    ///         Address = "10.0.0.1",
    ///         Enable = true,
    ///         EnableServer = true,
    ...
    ///     });
    /// 
    ///     var deleteLogConfig = new Tencentcloud.Tcm.AccessLogConfig("delete_log_config", new()
    ///     {
    ///         EnableServer = false,
    ///         EnableStdout = false,
