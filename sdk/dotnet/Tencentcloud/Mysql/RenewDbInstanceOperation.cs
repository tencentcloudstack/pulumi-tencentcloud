...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mysql
{
    ...
    ///     });
    /// 
    ///     var example = Tencentcloud.Mysql.GetRollbackRangeTime.Invoke(new()
    ///     {
    ///         InstanceIds = new[]
    ///         {
    ///             exampleInstance.Id,
    ...
    ///     });
    /// 
    ///     var exampleRenewDbInstanceOperation = new Tencentcloud.Mysql.RenewDbInstanceOperation("example", new()
    ///     {
