...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Mysql
{
    ...
    ///     });
    /// 
    ///     var exampleRollback = new Tencentcloud.Mysql.Rollback("example", new()
    ///     {
    ///         InstanceId = exampleInstance.Id,
    ///         Strategy = "full",
    ///         RollbackTime = example.Apply(getRollbackRangeTimeResult =&gt; getRollbackRangeTimeResult.Item[0].Times[0].Start),
    ///         Databases = new[]
    ///         {
