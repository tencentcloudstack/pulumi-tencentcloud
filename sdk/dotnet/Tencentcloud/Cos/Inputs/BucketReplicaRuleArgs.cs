...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cos.Inputs
{
    ...
    public sealed class BucketReplicaRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BucketReplicaRuleDeleteMarkerReplicationArgs>? DeleteMarkerReplication { get; set; }
        ...
        /// </summary>
        [Input("filter")]
        public Input<Inputs.BucketReplicaRuleFilterArgs>? Filter { get; set; }
        ...
        public Input<Inputs.BucketReplicaRuleSourceSelectionCriteriaArgs>? SourceSelectionCriteria { get; set; }
