...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cos.Inputs
{
    ...
    public sealed class BatchOperationGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BatchOperationCosInitiateRestoreObjectGetArgs>? CosInitiateRestoreObject { get; set; }

        /// <summary>
        /// Specifies the specific parameters for the batch copy operation on the objects in the list.
        /// </summary>
        [Input("cosPutObjectCopy")]
        public Input<Inputs.BatchOperationCosPutObjectCopyGetArgs>? CosPutObjectCopy { get; set; }
