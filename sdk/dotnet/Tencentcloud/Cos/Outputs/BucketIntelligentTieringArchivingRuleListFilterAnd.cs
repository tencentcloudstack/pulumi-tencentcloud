...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cos.Outputs
{
    ...
    [OutputType]
    public sealed class BucketIntelligentTieringArchivingRuleListFilterAnd
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.BucketIntelligentTieringArchivingRuleListFilterAndTag> Tags;

        [OutputConstructor]
        private BucketIntelligentTieringArchivingRuleListFilterAnd(
            string? prefix,

            ImmutableArray<Outputs.BucketIntelligentTieringArchivingRuleListFilterAndTag> tags)
        {
            Prefix = prefix;
            Tags = tags;
        }
