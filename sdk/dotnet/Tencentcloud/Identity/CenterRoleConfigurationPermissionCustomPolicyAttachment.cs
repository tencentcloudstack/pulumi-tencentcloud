...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Identity
{
    ...
    /// {
    ///     var identityCenterRoleConfigurationPermissionCustomPolicyAttachment = new Tencentcloud.Identity.CenterRoleConfigurationPermissionCustomPolicyAttachment("identity_center_role_configuration_permission_custom_policy_attachment", new()
    ///     {
    ///         ZoneId = "z-xxxxxx",
