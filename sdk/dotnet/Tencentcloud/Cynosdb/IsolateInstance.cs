...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cynosdb
{
    ...
    public partial class IsolateInstance : Pulumi.CustomResource
    {
        ...
        public IsolateInstance(string name, IsolateInstanceArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Cynosdb/isolateInstance:IsolateInstance", name, args ?? new IsolateInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private IsolateInstance(string name, Input<string> id, IsolateInstanceState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Cynosdb/isolateInstance:IsolateInstance", name, state, MakeResourceOptions(options, id))
        {
        }
