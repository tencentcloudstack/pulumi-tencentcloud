...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Clickhouse
{
    ...
    /// {
    ///     var accountPermissionAllDatabase = new Tencentcloud.Clickhouse.AccountPermission("account_permission_all_database", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var accountPermissionNotAllDatabase = new Tencentcloud.Clickhouse.AccountPermission("account_permission_not_all_database", new()
    ///     {
    ///         InstanceId = "cdwch-xxxxxx",
    ///         Cluster = "default_cluster",
    ///         UserName = "user2",
