...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Dcdb
{
    ...
    /// 
    ///     var prepaidInstance = new Tencentcloud.Dcdb.DbInstance("prepaid_instance", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var hourdbInstance = new Tencentcloud.Dcdb.HourdbInstance("hourdb_instance", new()
    ///     {
    ...
    ///     var configHourdb = new Tencentcloud.Dcdb.EncryptAttributesConfig("config_hourdb", new()
    ///     {
    ...
    ///     var configPrepaid = new Tencentcloud.Dcdb.EncryptAttributesConfig("config_prepaid", new()
    ///     {
