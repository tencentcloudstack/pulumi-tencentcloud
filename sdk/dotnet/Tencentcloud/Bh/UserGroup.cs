...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Bh
{
    ...
    /// {
    ///     var example = new Tencentcloud.Bh.UserGroup("example", new()
    ///     {
    ///         Name = "tf-example",
    ///     });
    /// 
    ...
    /// ```
    /// </summary>
    [TencentcloudResourceType("tencentcloud:Bh/userGroup:UserGroup")]
    public partial class UserGroup : global::Pulumi.CustomResource
    {
        ...
        public UserGroup(string name, UserGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Bh/userGroup:UserGroup", name, args ?? new UserGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UserGroup(string name, Input<string> id, UserGroupState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Bh/userGroup:UserGroup", name, state, MakeResourceOptions(options, id))
        {
        }
