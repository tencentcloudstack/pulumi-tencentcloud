...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Tdmq
{
    ...
    ///     });
    /// 
    ///     var exampleNamespace = new Tencentcloud.Tdmq.Namespace("example", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var exampleTopic = new Tencentcloud.Tdmq.Topic("example", new()
    ///     {
    ///         ClusterId = example.Id,
    ...
    ///     });
    /// 
    ///     var exampleSubscription = new Tencentcloud.Tdmq.Subscription("example", new()
    ///     {
    ///         ClusterId = example.Id,
