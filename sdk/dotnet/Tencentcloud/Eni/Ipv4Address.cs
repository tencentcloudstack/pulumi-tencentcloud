...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Eni
{
    ...
    ///     });
    /// 
    ///     var exampleIpv4Address = new Tencentcloud.Eni.Ipv4Address("example", new()
    ///     {
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var example = new Tencentcloud.Eni.Ipv4Address("example", new()
    ///     {
    ///         NetworkInterfaceId = exampleTencentcloudEni.Id,
    ///         PrivateIpAddresses = new[]
    ///         {
    ///             new Tencentcloud.Eni.Inputs.Ipv4AddressPrivateIpAddressArgs
    ///             {
