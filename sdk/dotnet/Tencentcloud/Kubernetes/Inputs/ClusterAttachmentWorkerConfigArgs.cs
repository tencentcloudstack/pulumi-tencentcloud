...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Kubernetes.Inputs
{
    ...
    public sealed class ClusterAttachmentWorkerConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("dataDisks")]
        ...
        [Input("taints")]
        private InputList<Inputs.ClusterAttachmentWorkerConfigTaintArgs>? _taints;

        /// <summary>
        /// Node taint.
        /// </summary>
        public InputList<Inputs.ClusterAttachmentWorkerConfigTaintArgs> Taints
        {
            get => _taints ?? (_taints = new InputList<Inputs.ClusterAttachmentWorkerConfigTaintArgs>());
            set => _taints = value;
        }
        ...
        public static new ClusterAttachmentWorkerConfigArgs Empty => new ClusterAttachmentWorkerConfigArgs();
    }
}
