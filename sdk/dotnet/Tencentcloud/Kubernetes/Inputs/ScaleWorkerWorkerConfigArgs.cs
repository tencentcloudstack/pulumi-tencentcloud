...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Kubernetes.Inputs
{
    ...
    public sealed class ScaleWorkerWorkerConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _dataDisks ?? (_dataDisks = new InputList<Inputs.ScaleWorkerWorkerConfigDataDiskArgs>());
        ...
        [Input("tags")]
        private InputList<Inputs.ScaleWorkerWorkerConfigTagArgs>? _tags;

        /// <summary>
        /// Tag pairs.
        /// </summary>
        public InputList<Inputs.ScaleWorkerWorkerConfigTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.ScaleWorkerWorkerConfigTagArgs>());
            set => _tags = value;
        }
        ...
        public ScaleWorkerWorkerConfigArgs()
        {
        }
        public static new ScaleWorkerWorkerConfigArgs Empty => new ScaleWorkerWorkerConfigArgs();
    }
}
