...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Kubernetes
{
    ...
    /// {
    ///     var example = new Tencentcloud.Kubernetes.ClusterMasterAttachment("example", new()
    ///     {
    ...
    ///             "sg-hjs685q9",
    ///         },
    ///         MasterConfig = new Tencentcloud.Kubernetes.Inputs.ClusterMasterAttachmentMasterConfigArgs
    ///         {
    ...
    ///             Labels = new[]
    ///             {
    ///                 new Tencentcloud.Kubernetes.Inputs.ClusterMasterAttachmentMasterConfigLabelArgs
    ///                 {
    ///                     Name = "key",
    ///                     Value = "value",
    ///                 },
    ///             },
    ///             DataDisk = new Tencentcloud.Kubernetes.Inputs.ClusterMasterAttachmentMasterConfigDataDiskArgs
    ///             {
    ///                 FileSystem = "ext4",
    ...
    ///             },
    ///             ExtraArgs = new Tencentcloud.Kubernetes.Inputs.ClusterMasterAttachmentMasterConfigExtraArgsArgs
    ///             {
    ///                 Kubelets = new[]
    ///                 {
    ///                     "root-dir=/root",
    ...
    ///             Taints = new[]
    ///             {
    ///                 new Tencentcloud.Kubernetes.Inputs.ClusterMasterAttachmentMasterConfigTaintArgs
    ///                 {
    ///                     Key = "key",
    ///                     Value = "value",
    ///                     Effect = "NoSchedule",
