...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Inputs
{
    ...
    public sealed class SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupActionArgs> Action { get; set; } = null!;
        ...
        [Input("metaDatas")]
        private InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupMetaDataArgs>? _metaDatas;

        /// <summary>
        /// Managed rule group information, for output only.
        /// </summary>
        public InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupMetaDataArgs> MetaDatas
        {
            get => _metaDatas ?? (_metaDatas = new InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupMetaDataArgs>());
            set => _metaDatas = value;
        }

        [Input("ruleActions")]
        private InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupRuleActionArgs>? _ruleActions;
        ...
        /// </summary>
        public InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupRuleActionArgs> RuleActions
        {
            get => _ruleActions ?? (_ruleActions = new InputList<Inputs.SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupRuleActionArgs>());
        ...
        public SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupArgs()
        {
        }
        public static new SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupArgs Empty => new SecurityPolicyConfigSecurityPolicyManagedRulesManagedRuleGroupArgs();
    }
}
