...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Inputs
{
    ...
    public sealed class LoadBalancerHealthCheckerGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("headers")]
        private InputList<Inputs.LoadBalancerHealthCheckerHeaderGetArgs>? _headers;

        /// <summary>
        /// Custom HTTP request headers (up to 10), valid when `Type` is `HTTP` or `HTTPS`.
        /// </summary>
        public InputList<Inputs.LoadBalancerHealthCheckerHeaderGetArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.LoadBalancerHealthCheckerHeaderGetArgs>());
            set => _headers = value;
        }
        ...
        public LoadBalancerHealthCheckerGetArgs()
        {
        }
        public static new LoadBalancerHealthCheckerGetArgs Empty => new LoadBalancerHealthCheckerGetArgs();
    }
}
