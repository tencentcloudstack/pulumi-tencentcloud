...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Inputs
{
    ...
    public sealed class WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("baseAction")]
        public Input<Inputs.WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupBaseActionArgs>? BaseAction { get; set; }

        [Input("botManagementActionOverrides")]
        private InputList<Inputs.WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupBotManagementActionOverrideArgs>? _botManagementActionOverrides;
        ...
        /// </summary>
        public InputList<Inputs.WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupBotManagementActionOverrideArgs> BotManagementActionOverrides
        {
            get => _botManagementActionOverrides ?? (_botManagementActionOverrides = new InputList<Inputs.WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupBotManagementActionOverrideArgs>());
            set => _botManagementActionOverrides = value;
        }

        public WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupArgs()
        {
        }
        public static new WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupArgs Empty => new WebSecurityTemplateSecurityPolicyBotManagementBasicBotSettingsIpReputationIpReputationGroupArgs();
    }
}
