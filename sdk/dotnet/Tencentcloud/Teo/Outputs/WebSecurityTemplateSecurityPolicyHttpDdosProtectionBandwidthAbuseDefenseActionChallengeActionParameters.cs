...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyHttpDdosProtectionBandwidthAbuseDefenseActionChallengeActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyHttpDdosProtectionBandwidthAbuseDefenseActionChallengeActionParameters(
            string? attesterId,
