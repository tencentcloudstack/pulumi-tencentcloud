...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranchSubRuleBranchSubRuleBranchActionAccessUrlRedirectParametersQueryString
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleRuleBranchSubRuleBranchSubRuleBranchActionAccessUrlRedirectParametersQueryString(string? action)
        {
            Action = action;
        }
    }
