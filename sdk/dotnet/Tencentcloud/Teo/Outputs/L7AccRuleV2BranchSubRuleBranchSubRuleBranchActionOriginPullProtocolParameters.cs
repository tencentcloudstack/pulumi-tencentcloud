...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2BranchSubRuleBranchSubRuleBranchActionOriginPullProtocolParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleV2BranchSubRuleBranchSubRuleBranchActionOriginPullProtocolParameters(string? protocol)
        {
            Protocol = protocol;
        }
    }
