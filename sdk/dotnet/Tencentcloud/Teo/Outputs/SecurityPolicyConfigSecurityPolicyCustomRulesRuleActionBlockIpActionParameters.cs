...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class SecurityPolicyConfigSecurityPolicyCustomRulesRuleActionBlockIpActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SecurityPolicyConfigSecurityPolicyCustomRulesRuleActionBlockIpActionParameters(string duration)
        {
            Duration = duration;
        }
    }
