...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2Branch
    {
        /// <summary>
        /// Sub-Rule branch. this list currently supports filling in only one rule; multiple entries are invalid.
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleV2BranchAction> Actions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleV2BranchSubRule> SubRules;

        [OutputConstructor]
        private L7AccRuleV2Branch(
            ImmutableArray<Outputs.L7AccRuleV2BranchAction> actions,

            string? condition,

            ImmutableArray<Outputs.L7AccRuleV2BranchSubRule> subRules)
        {
            Actions = actions;
            Condition = condition;
            SubRules = subRules;
