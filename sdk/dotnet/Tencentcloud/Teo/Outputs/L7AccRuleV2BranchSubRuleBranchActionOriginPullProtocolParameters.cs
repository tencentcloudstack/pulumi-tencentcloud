...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2BranchSubRuleBranchActionOriginPullProtocolParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleV2BranchSubRuleBranchActionOriginPullProtocolParameters(string? protocol)
        {
            Protocol = protocol;
        }
    }
