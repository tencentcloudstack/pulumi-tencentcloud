...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2BranchSubRuleBranchActionAccessUrlRedirectParametersQueryString
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleV2BranchSubRuleBranchActionAccessUrlRedirectParametersQueryString(string? action)
        {
            Action = action;
        }
    }
