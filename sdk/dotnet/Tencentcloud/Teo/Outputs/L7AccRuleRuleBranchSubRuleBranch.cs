...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranchSubRuleBranch
    {
        /// <summary>
        /// Sub-Rule branch. this list currently supports filling in only one rule; multiple entries are invalid.
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleRuleBranchSubRuleBranchAction> Actions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleRuleBranchSubRuleBranchSubRule> SubRules;

        [OutputConstructor]
        private L7AccRuleRuleBranchSubRuleBranch(
            ImmutableArray<Outputs.L7AccRuleRuleBranchSubRuleBranchAction> actions,

            string? condition,

            ImmutableArray<Outputs.L7AccRuleRuleBranchSubRuleBranchSubRule> subRules)
        {
            Actions = actions;
            Condition = condition;
            SubRules = subRules;
