...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class SecurityPolicyConfigSecurityPolicyRateLimitingRulesRuleActionBlockIpActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private SecurityPolicyConfigSecurityPolicyRateLimitingRulesRuleActionBlockIpActionParameters(string duration)
        {
            Duration = duration;
        }
    }
