...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranchSubRuleBranchSubRuleBranchSubRuleBranchActionOriginPullProtocolParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleRuleBranchSubRuleBranchSubRuleBranchSubRuleBranchActionOriginPullProtocolParameters(string? protocol)
        {
            Protocol = protocol;
        }
    }
