...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyBotManagementClientAttestationRulesRuleInvalidAttestationActionChallengeActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyBotManagementClientAttestationRulesRuleInvalidAttestationActionChallengeActionParameters(
            string? attesterId,
