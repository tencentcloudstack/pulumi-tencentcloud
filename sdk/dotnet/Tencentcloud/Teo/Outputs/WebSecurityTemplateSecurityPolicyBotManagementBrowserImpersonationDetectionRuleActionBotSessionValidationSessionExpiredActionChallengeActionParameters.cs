...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionExpiredActionChallengeActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionExpiredActionChallengeActionParameters(
            string? attesterId,
