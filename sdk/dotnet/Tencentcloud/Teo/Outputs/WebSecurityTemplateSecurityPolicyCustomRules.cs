...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyCustomRules
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.WebSecurityTemplateSecurityPolicyCustomRulesRule> Rules;

        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyCustomRules(ImmutableArray<Outputs.WebSecurityTemplateSecurityPolicyCustomRulesRule> rules)
        {
            Rules = rules;
        }
    }
