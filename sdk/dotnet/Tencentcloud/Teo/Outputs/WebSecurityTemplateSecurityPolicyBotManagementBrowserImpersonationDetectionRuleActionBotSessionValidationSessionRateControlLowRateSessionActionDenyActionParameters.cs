...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionRateControlLowRateSessionActionDenyActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionRateControlLowRateSessionActionDenyActionParameters(
            string? blockIp,
