...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2BranchSubRuleBranchSubRuleBranchActionAccessUrlRedirectParametersQueryString
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleV2BranchSubRuleBranchSubRuleBranchActionAccessUrlRedirectParametersQueryString(string? action)
        {
            Action = action;
        }
    }
