...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionExpiredActionDenyActionParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebSecurityTemplateSecurityPolicyBotManagementBrowserImpersonationDetectionRuleActionBotSessionValidationSessionExpiredActionDenyActionParameters(
            string? blockIp,
