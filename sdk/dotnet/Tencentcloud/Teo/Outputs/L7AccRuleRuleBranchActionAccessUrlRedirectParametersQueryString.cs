...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranchActionAccessUrlRedirectParametersQueryString
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleRuleBranchActionAccessUrlRedirectParametersQueryString(string? action)
        {
            Action = action;
        }
    }
