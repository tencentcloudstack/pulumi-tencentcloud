...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranch
    {
        /// <summary>
        /// Sub-Rule branch. this list currently supports filling in only one rule; multiple entries are invalid.
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleRuleBranchAction> Actions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleRuleBranchSubRule> SubRules;

        [OutputConstructor]
        private L7AccRuleRuleBranch(
            ImmutableArray<Outputs.L7AccRuleRuleBranchAction> actions,

            string? condition,

            ImmutableArray<Outputs.L7AccRuleRuleBranchSubRule> subRules)
        {
            Actions = actions;
            Condition = condition;
            SubRules = subRules;
