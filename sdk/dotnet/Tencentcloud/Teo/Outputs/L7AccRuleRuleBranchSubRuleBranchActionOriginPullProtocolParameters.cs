...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleRuleBranchSubRuleBranchActionOriginPullProtocolParameters
    {
        /// <summary>
        ...
        [OutputConstructor]
        private L7AccRuleRuleBranchSubRuleBranchActionOriginPullProtocolParameters(string? protocol)
        {
            Protocol = protocol;
        }
    }
