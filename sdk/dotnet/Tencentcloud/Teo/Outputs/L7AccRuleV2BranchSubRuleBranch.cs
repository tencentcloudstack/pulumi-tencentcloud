...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Teo.Outputs
{
    ...
    [OutputType]
    public sealed class L7AccRuleV2BranchSubRuleBranch
    {
        /// <summary>
        /// Sub-Rule branch. this list currently supports filling in only one rule; multiple entries are invalid.
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleV2BranchSubRuleBranchAction> Actions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.L7AccRuleV2BranchSubRuleBranchSubRule> SubRules;

        [OutputConstructor]
        private L7AccRuleV2BranchSubRuleBranch(
            ImmutableArray<Outputs.L7AccRuleV2BranchSubRuleBranchAction> actions,

            string? condition,

            ImmutableArray<Outputs.L7AccRuleV2BranchSubRuleBranchSubRule> subRules)
        {
            Actions = actions;
            Condition = condition;
            SubRules = subRules;
