...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cwp
{
    ...
    ///     });
    /// 
    ///     var exampleLicenseOrder = new Tencentcloud.Cwp.LicenseOrder("example", new()
    ///     {
    ///         Alias = "tf_example",
    ///         LicenseType = 0,
    ///         LicenseNum = 1,
    ...
    ///     });
    /// 
    ///     var exampleLicenseBindAttachment = new Tencentcloud.Cwp.LicenseBindAttachment("example", new()
    ///     {
    ///         ResourceId = exampleLicenseOrder.ResourceId,
    ///         LicenseId = exampleLicenseOrder.LicenseId,
    ///         LicenseType = 0,
    ///         Quuid = example.Apply(getMachinesSimpleResult =&gt; getMachinesSimpleResult.Machines[0]?.Quuid),
    ///     });
    /// 
    /// });
    /// ```
