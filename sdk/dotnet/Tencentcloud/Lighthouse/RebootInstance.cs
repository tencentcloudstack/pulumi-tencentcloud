...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Lighthouse
{
    ...
    /// {
    ///     var rebootInstance = new Tencentcloud.Lighthouse.RebootInstance("reboot_instance", new()
    ///     {
    ...
    public partial class RebootInstance : global::Pulumi.CustomResource
    {
        ...
        public RebootInstance(string name, RebootInstanceArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Lighthouse/rebootInstance:RebootInstance", name, args ?? new RebootInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RebootInstance(string name, Input<string> id, RebootInstanceState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Lighthouse/rebootInstance:RebootInstance", name, state, MakeResourceOptions(options, id))
        {
        }
