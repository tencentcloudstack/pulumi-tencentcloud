...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Clb
{
    ...
    public partial class TargetGroupInstanceAttachment : global::Pulumi.CustomResource
    {
        ...
        public TargetGroupInstanceAttachment(string name, TargetGroupInstanceAttachmentArgs args, CustomResourceOptions? options = null)
            : base("tencentcloud:Clb/targetGroupInstanceAttachment:TargetGroupInstanceAttachment", name, args ?? new TargetGroupInstanceAttachmentArgs(), MakeResourceOptions(options, ""))
        {
        }

        private TargetGroupInstanceAttachment(string name, Input<string> id, TargetGroupInstanceAttachmentState? state = null, CustomResourceOptions? options = null)
            : base("tencentcloud:Clb/targetGroupInstanceAttachment:TargetGroupInstanceAttachment", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static TargetGroupInstanceAttachment Get(string name, Input<string> id, TargetGroupInstanceAttachmentState? state = null, CustomResourceOptions? options = null)
        {
            return new TargetGroupInstanceAttachment(name, id, state, options);
        }
    }
