...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls
{
    ...
    /// return await Deployment.RunAsync(() =&gt; 
    /// {
    ///     var groupOstype = new Tencentcloud.Cls.MachineGroup("group_ostype", new()
    ///     {
    ///         GroupName = "group",
    ///         ServiceLogging = true,
    ///         Ostype = 1,
    ...
    public partial class MachineGroup : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("metaTags")]
        public Output<ImmutableDictionary<string, string>> MetaTags { get; private set; } = null!;

        /// <summary>
        /// Operating system type. Valid values: 0 (Linux), 1 (Windows).
        /// </summary>
        [Output("ostype")]
        public Output<int> Ostype { get; private set; } = null!;
    ...
    public sealed class MachineGroupArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("metaTags")]
        private InputMap<string>? _metaTags;

        /// <summary>
        /// Machine group metadata information list, stored as key-value pairs.
        /// </summary>
        public InputMap<string> MetaTags
        {
            get => _metaTags ?? (_metaTags = new InputMap<string>());
            set => _metaTags = value;
        }
        ...
        /// </summary>
        [Input("ostype")]
        public Input<int>? Ostype { get; set; }
