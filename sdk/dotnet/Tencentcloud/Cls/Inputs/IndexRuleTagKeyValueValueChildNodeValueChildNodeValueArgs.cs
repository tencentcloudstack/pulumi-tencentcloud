...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleTagKeyValueValueChildNodeValueChildNodeValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeValueChildNodeArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeValueChildNodeArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeValueChildNodeArgs>());
        ...
        public IndexRuleTagKeyValueValueChildNodeValueChildNodeValueArgs()
        {
        }
        public static new IndexRuleTagKeyValueValueChildNodeValueChildNodeValueArgs Empty => new IndexRuleTagKeyValueValueChildNodeValueChildNodeValueArgs();
    }
}
