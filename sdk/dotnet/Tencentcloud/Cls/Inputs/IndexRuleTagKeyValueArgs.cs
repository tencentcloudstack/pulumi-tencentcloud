...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleTagKeyValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("value")]
        public Input<Inputs.IndexRuleTagKeyValueValueArgs>? Value { get; set; }

        public IndexRuleTagKeyValueArgs()
        {
        }
        public static new IndexRuleTagKeyValueArgs Empty => new IndexRuleTagKeyValueArgs();
    }
}
