...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleTagKeyValueValueGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleTagKeyValueValueChildNodeGetArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleTagKeyValueValueChildNodeGetArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleTagKeyValueValueChildNodeGetArgs>());
        ...
        public static new IndexRuleTagKeyValueValueGetArgs Empty => new IndexRuleTagKeyValueValueGetArgs();
    }
}
