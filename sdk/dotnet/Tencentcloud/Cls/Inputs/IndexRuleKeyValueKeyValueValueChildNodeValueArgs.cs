...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleKeyValueKeyValueValueChildNodeValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeArgs>());
        ...
        public IndexRuleKeyValueKeyValueValueChildNodeValueArgs()
        {
        }
        public static new IndexRuleKeyValueKeyValueValueChildNodeValueArgs Empty => new IndexRuleKeyValueKeyValueValueChildNodeValueArgs();
    }
}
