...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleKeyValueKeyValueValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeArgs>());
        ...
        public IndexRuleKeyValueKeyValueValueArgs()
        {
        }
        public static new IndexRuleKeyValueKeyValueValueArgs Empty => new IndexRuleKeyValueKeyValueValueArgs();
    }
}
