...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleTagKeyValueValueChildNodeValueArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleTagKeyValueValueChildNodeValueChildNodeArgs>());
        ...
        public IndexRuleTagKeyValueValueChildNodeValueArgs()
        {
        }
        public static new IndexRuleTagKeyValueValueChildNodeValueArgs Empty => new IndexRuleTagKeyValueValueChildNodeValueArgs();
    }
}
