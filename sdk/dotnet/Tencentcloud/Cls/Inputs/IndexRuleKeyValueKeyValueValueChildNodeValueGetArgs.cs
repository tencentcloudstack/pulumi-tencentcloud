...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleKeyValueKeyValueValueChildNodeValueGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Field alias.
        /// </summary>
        ...
        [Input("childNodes")]
        private InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeGetArgs>? _childNodes;

        /// <summary>
        /// Json child node list (recursive, up to 5 levels). Note: only json type fields can configure this parameter.
        /// </summary>
        public InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeGetArgs> ChildNodes
        {
            get => _childNodes ?? (_childNodes = new InputList<Inputs.IndexRuleKeyValueKeyValueValueChildNodeValueChildNodeGetArgs>());
        ...
        public IndexRuleKeyValueKeyValueValueChildNodeValueGetArgs()
        {
        }
        public static new IndexRuleKeyValueKeyValueValueChildNodeValueGetArgs Empty => new IndexRuleKeyValueKeyValueValueChildNodeValueGetArgs();
    }
}
