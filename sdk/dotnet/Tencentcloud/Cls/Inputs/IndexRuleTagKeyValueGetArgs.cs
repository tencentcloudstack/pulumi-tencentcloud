...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Cls.Inputs
{
    ...
    public sealed class IndexRuleTagKeyValueGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("value")]
        public Input<Inputs.IndexRuleTagKeyValueValueGetArgs>? Value { get; set; }

        public IndexRuleTagKeyValueGetArgs()
        {
        }
        public static new IndexRuleTagKeyValueGetArgs Empty => new IndexRuleTagKeyValueGetArgs();
    }
}
