...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Ckafka
{
    ...
    /// 
    ///     // create ckafka
    ///     var example = new Tencentcloud.Ckafka.Instance("example", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var gz7 = Tencentcloud.Availability.GetZonesByProduct.Invoke(new()
    ///     {
    ///         Name = "ap-guangzhou-7",
    ///         Product = "ckafka",
    ///     });
    ...
    ///     {
    ///         InstanceName = "tf-example",
    ///         ZoneId = gz6.Apply(getZonesByProductResult =&gt; getZonesByProductResult.Zones[0]?.Id),
    ///         MultiZoneFlag = true,
    ///         ZoneIds = new[]
    ///         {
    ///             gz6.Apply(getZonesByProductResult =&gt; getZonesByProductResult.Zones[0]?.Id),
    ///             gz7.Apply(getZonesByProductResult =&gt; getZonesByProductResult.Zones[0]?.Id),
    ///         },
    ///         RenewFlag = 0,
    ///         VpcId = vpc.Id,
    ///         SubnetId = subnet.Id,
    ...
    public partial class Instance : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("elasticBandwidthSwitch")]
        public Output<int?> ElasticBandwidthSwitch { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tagSet")]
        public Output<ImmutableDictionary<string, string>> TagSet { get; private set; } = null!;
    ...
    public sealed class InstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Elastic bandwidth switch 0 not turned on 1 turned on (0 default). This takes effect only when the instance is created.
        /// </summary>
        [Input("elasticBandwidthSwitch")]
        public Input<int>? ElasticBandwidthSwitch { get; set; }
        ...
        [Input("tagSet")]
        private InputMap<string>? _tagSet;

        /// <summary>
        /// Tag set of instance.
        /// </summary>
        public InputMap<string> TagSet
        {
            get => _tagSet ?? (_tagSet = new InputMap<string>());
            set => _tagSet = value;
        }
        ...
        /// It has been deprecated from version 1.78.5, because it do not support change. Use `TagSet` instead. Tags of instance. Partition size, the professional version does not need tag.
        /// </summary>
        [Obsolete(@"It has been deprecated from version 1.78.5, because it do not support change. Use `TagSet` instead.")]
