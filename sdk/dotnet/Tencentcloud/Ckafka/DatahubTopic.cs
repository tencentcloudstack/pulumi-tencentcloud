...
namespace TencentCloudIAC.PulumiPackage.Tencentcloud.Ckafka
{
    ...
    /// {
    ///     var user = Tencentcloud.User.GetInfo.Invoke();
    /// 
    ///     var datahubTopic = new Tencentcloud.Ckafka.DatahubTopic("datahub_topic", new()
    ///     {
    ...
    ///             Args = new[]
    ///             {
    ///                 user.Apply(getInfoResult =&gt; getInfoResult.AppId),
    ///             },
