...
namespace Pulumi.Tencentcloud.Address
{
    public static class TemplateGroups
    {
        public static Task<TemplateGroupsResult> InvokeAsync(TemplateGroupsArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<TemplateGroupsResult>("tencentcloud:Address/templateGroups:TemplateGroups", args ?? new TemplateGroupsArgs(), options.WithDefaults());

        public static Output<TemplateGroupsResult> Invoke(TemplateGroupsInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<TemplateGroupsResult>("tencentcloud:Address/templateGroups:TemplateGroups", args ?? new TemplateGroupsInvokeArgs(), options.WithDefaults());
    }
