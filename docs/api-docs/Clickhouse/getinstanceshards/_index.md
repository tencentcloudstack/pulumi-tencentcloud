...
title_tag: "tencentcloud.Clickhouse.getInstanceShards"
meta_desc: "Documentation for the tencentcloud.Clickhouse.getInstanceShards function with examples, input properties, output properties, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Clickhouse.inputs.GetInstanceShardsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceShards = ClickhouseFunctions.getInstanceShards(GetInstanceShardsArgs.builder()
            .instanceId("cdwch-datuhk3z")
            .build());
...
><span class="k">def </span>get_instance_shards<span class="p">(</span><span class="nx">instance_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_instance_shards_output<span class="p">(</span><span class="nx">instance_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Clickhouse/getInstanceShards:getInstanceShards
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceid_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instanceshardslist_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceshardslist_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Shards<wbr>List</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
    <dd><p>Instance shard information.</p>
</dd><dt class="property-"
            title="">
        <span id="resultoutputfile_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resultoutputfile_csharp" style="color: inherit; text-decoration: inherit;">Result<wbr>Output<wbr>File</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceid_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instanceshardslist_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceshardslist_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Shards<wbr>List</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceid_java" style="color: inherit; text-decoration: inherit;">instance<wbr>Id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instanceshardslist_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceshardslist_java" style="color: inherit; text-decoration: inherit;">instance<wbr>Shards<wbr>List</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceid_nodejs" style="color: inherit; text-decoration: inherit;">instance<wbr>Id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instanceshardslist_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceshardslist_nodejs" style="color: inherit; text-decoration: inherit;">instance<wbr>Shards<wbr>List</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">string</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instance_id_python" style="color: inherit; text-decoration: inherit;">instance_<wbr>id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instance_shards_list_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instance_shards_list_python" style="color: inherit; text-decoration: inherit;">instance_<wbr>shards_<wbr>list</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">str</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceid_yaml" style="color: inherit; text-decoration: inherit;">instance<wbr>Id</a>
    ...
    <dd></dd><dt class="property-"
            title="">
        <span id="instanceshardslist_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instanceshardslist_yaml" style="color: inherit; text-decoration: inherit;">instance<wbr>Shards<wbr>List</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">String</span>
    </dt>
