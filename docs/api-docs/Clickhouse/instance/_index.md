...
const cdwchInstance = new tencentcloud.clickhouse.Instance("cdwchInstance", {
...
import com.pulumi.tencentcloud.Clickhouse.Instance;
import com.pulumi.tencentcloud.Clickhouse.InstanceArgs;
import com.pulumi.tencentcloud.Clickhouse.inputs.InstanceCommonSpecArgs;
import com.pulumi.tencentcloud.Clickhouse.inputs.InstanceDataSpecArgs;
...
const cdwchInstancePrepaid = new tencentcloud.clickhouse.Instance("cdwchInstancePrepaid", {
    chargeType: "PREPAID",
    commonSpec: {
        count: 3,
        diskSize: 300,
