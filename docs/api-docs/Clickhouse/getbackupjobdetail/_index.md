...
import com.pulumi.tencentcloud.Clickhouse.inputs.GetBackupJobDetailArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var backupJobDetail = ClickhouseFunctions.getBackupJobDetail(GetBackupJobDetailArgs.builder()
            .backUpJobId(1234)
            .instanceId("cdwch-xxxxxx")
            .build());
