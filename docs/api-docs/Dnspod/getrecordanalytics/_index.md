...
import com.pulumi.tencentcloud.Dnspod.inputs.GetRecordAnalyticsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var recordAnalytics = DnspodFunctions.getRecordAnalytics(GetRecordAnalyticsArgs.builder()
            .dnsFormat("HOUR")
            .domain("iac-tf.cloud")
            .endDate("2023-11-07")
            .startDate("2023-09-07")
