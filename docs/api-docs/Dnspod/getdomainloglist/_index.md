...
import com.pulumi.tencentcloud.Dnspod.inputs.GetDomainLogListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var domainLogList = DnspodFunctions.getDomainLogList(GetDomainLogListArgs.builder()
            .domain("iac-tf.cloud")
            .domainId(123)
            .build());
