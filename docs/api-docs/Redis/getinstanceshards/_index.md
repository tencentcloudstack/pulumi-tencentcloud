...
import com.pulumi.tencentcloud.Redis.inputs.GetInstanceShardsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceShards = RedisFunctions.getInstanceShards(GetInstanceShardsArgs.builder()
            .filterSlave(false)
            .instanceId("crs-c1nl9rpv")
            .build());
