...
import com.pulumi.tencentcloud.Css.inputs.GetPullStreamTaskStatusArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var pullStreamTaskStatus = CssFunctions.getPullStreamTaskStatus(GetPullStreamTaskStatusArgs.builder()
            .taskId("63229997")
            .build());
