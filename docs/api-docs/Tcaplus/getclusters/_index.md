...
import com.pulumi.tencentcloud.Tcaplus.inputs.GetClustersArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var name = TcaplusFunctions.getClusters(GetClustersArgs.builder()
            .clusterName("cluster")
            .build());

        final var id = TcaplusFunctions.getClusters(GetClustersArgs.builder()
            .clusterId(tencentcloud_tcaplus_cluster.test().id())
            .build());

        final var idname = TcaplusFunctions.getClusters(GetClustersArgs.builder()
            .clusterId(tencentcloud_tcaplus_cluster.test().id())
            .clusterName("cluster")
            .build());
