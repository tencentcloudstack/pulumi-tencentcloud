...
public class App {
    ...
    public static void stack(Context ctx) {
        final var gatewayNodes = Output.of(TseFunctions.getGatewayNodes(GetGatewayNodesArgs.builder()
            .gatewayId("gateway-ddbb709b")
            .groupId("group-013c0d8e")
            .build()));
...
const gatewayNodes = pulumi.output(tencentcloud.Tse.getGatewayNodes({
    gatewayId: "gateway-ddbb709b",
    groupId: "group-013c0d8e",
}));
```
