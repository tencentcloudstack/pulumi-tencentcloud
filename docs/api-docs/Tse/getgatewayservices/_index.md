...
import com.pulumi.tencentcloud.Tse.inputs.GetGatewayServicesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var gatewayServices = TseFunctions.getGatewayServices(GetGatewayServicesArgs.builder()
