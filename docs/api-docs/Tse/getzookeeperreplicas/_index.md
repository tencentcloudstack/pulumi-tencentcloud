...
---
title: "getZookeeperReplicas"
title_tag: "tencentcloud.Tse.getZookeeperReplicas"
meta_desc: "Documentation for the tencentcloud.Tse.getZookeeperReplicas function with examples, input properties, output properties, and supporting types."
layout: api
...
zookeeper_replicas = tencentcloud.Tse.get_zookeeper_replicas(instance_id="ins-7eb7eea7")
```
```csharp
...
import com.pulumi.tencentcloud.Tse.inputs.GetZookeeperReplicasArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var zookeeperReplicas = TseFunctions.getZookeeperReplicas(GetZookeeperReplicasArgs.builder()
            .instanceId("ins-7eb7eea7")
            .build());
...
variables:
  zookeeperReplicas:
    fn::invoke:
      Function: tencentcloud:Tse:getZookeeperReplicas
      Arguments:
        instanceId: ins-7eb7eea7
```
...
## Using getZookeeperReplicas {#using}
...
><span class="k">function </span>getZookeeperReplicas<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetZookeeperReplicasArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>></span
><span class="k">
function </span>getZookeeperReplicasOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetZookeeperReplicasOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_zookeeper_replicas<span class="p">(</span><span class="nx">instance_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">result_output_file</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetZookeeperReplicasResult</span
><span class="k">
def </span>get_zookeeper_replicas_output<span class="p">(</span><span class="nx">instance_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                           <span class="nx">result_output_file</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetZookeeperReplicasResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetZookeeperReplicas<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetZookeeperReplicasArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>, error)</span
><span class="k">
func </span>GetZookeeperReplicasOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetZookeeperReplicasOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetZookeeperReplicasResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetZookeeperReplicas` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetZookeeperReplicas </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetZookeeperReplicasArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetZookeeperReplicasInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetZookeeperReplicasResult</a></span>> </span>getZookeeperReplicas<span class="p">(</span><span class="nx">GetZookeeperReplicasArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Tse/getZookeeperReplicas:getZookeeperReplicas
...
## getZookeeperReplicas Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicas_csharp" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzookeeperreplicasreplica">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Tse.<wbr>Outputs.<wbr>Get<wbr>Zookeeper<wbr>Replicas<wbr>Replica&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicas_go" style="color: inherit; text-decoration: inherit;">Replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzookeeperreplicasreplica">[]Get<wbr>Zookeeper<wbr>Replicas<wbr>Replica</a></span>
    </dt>
    <dd><p>Engine instance replica information.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicas_java" style="color: inherit; text-decoration: inherit;">replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzookeeperreplicasreplica">List&lt;Get<wbr>Zookeeper<wbr>Replicas<wbr>Replica&gt;</a></span>
    </dt>
    <dd><p>Engine instance replica information.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#replicas_yaml" style="color: inherit; text-decoration: inherit;">replicas</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getzookeeperreplicasreplica">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>Engine instance replica information.</p>
</dd><dt class="property-"
            title="">
...
<h4 id="getzookeeperreplicasreplica">Get<wbr>Zookeeper<wbr>Replicas<wbr>Replica</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#aliasname_csharp" style="color: inherit; text-decoration: inherit;">Alias<wbr>Name</a>
    ...
    <dd><p>aliasNote: This field may return null, indicating that a valid value is not available.</p>
