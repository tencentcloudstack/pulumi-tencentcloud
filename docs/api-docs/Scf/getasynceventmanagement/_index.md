...
import com.pulumi.tencentcloud.Scf.inputs.GetAsyncEventManagementArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var asyncEventManagement = ScfFunctions.getAsyncEventManagement(GetAsyncEventManagementArgs.builder()
            .functionName("keep-1676351130")
            .namespace("default")
            .order("ASC")
            .orderby("StartTime")
