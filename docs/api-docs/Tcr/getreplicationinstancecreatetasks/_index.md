...
import com.pulumi.tencentcloud.Tcr.inputs.GetReplicationInstanceCreateTasksArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var createTasks = TcrFunctions.getReplicationInstanceCreateTasks(GetReplicationInstanceCreateTasksArgs.builder()
            .replicationRegistryId(local.dst_registry_id())
            .replicationRegionId(local.dst_region_id())
            .build());
