...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var nsId = exampleNamespaces.apply(getNamespacesResult -> getNamespacesResult).apply(exampleNamespaces -> exampleNamespaces.apply(getNamespacesResult -> getNamespacesResult.namespaceLists()[0].id()));
