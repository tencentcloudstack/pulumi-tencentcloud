...
import com.pulumi.tencentcloud.Tcr.inputs.GetReplicationInstanceSyncStatusArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var syncStatus = TcrFunctions.getReplicationInstanceSyncStatus(GetReplicationInstanceSyncStatusArgs.builder()
            .registryId(local.src_registry_id())
            .replicationRegistryId(local.dst_registry_id())
            .replicationRegionId(local.dst_region_id())
            .showReplicationLog(false)
