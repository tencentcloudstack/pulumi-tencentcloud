...
import com.pulumi.tencentcloud.Monitor.inputs.GetPolicyGroupsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var groups = MonitorFunctions.getPolicyGroups(GetPolicyGroupsArgs.builder()
            .policyViewNames(            
                "REDIS-CLUSTER",
                "cvm_device")
            .build());

        final var name = MonitorFunctions.getPolicyGroups(GetPolicyGroupsArgs.builder()
            .name("test")
            .build());
