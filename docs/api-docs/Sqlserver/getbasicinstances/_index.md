...
---
title: "getBasicInstances"
title_tag: "tencentcloud.Sqlserver.getBasicInstances"
meta_desc: "Documentation for the tencentcloud.Sqlserver.getBasicInstances function with examples, input properties, output properties, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Sqlserver.inputs.GetBasicInstancesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleId = SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .id("mssql-3l3fgqn7")
            .build());
...
variables:
  exampleId:
    fn::invoke:
      Function: tencentcloud:Sqlserver:getBasicInstances
      Arguments:
        id: mssql-3l3fgqn7
```
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleProject = SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .projectId(0)
            .build());
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleVpc = SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .subnetId("subnet-nf9n81ps")
            .vpcId("vpc-409mvdvv")
            .build());
...
><span class="k">function </span>getBasicInstances<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetBasicInstancesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>></span
><span class="k">
function </span>getBasicInstancesOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetBasicInstancesOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_basic_instances<span class="p">(</span><span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                        ...
                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetBasicInstancesResult</span
><span class="k">
def </span>get_basic_instances_output<span class="p">(</span><span class="nx">id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                        ...
                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetBasicInstancesResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetBasicInstances<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetBasicInstancesArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>, error)</span
><span class="k">
func </span>GetBasicInstancesOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetBasicInstancesOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetBasicInstancesResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetBasicInstances` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetBasicInstances </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetBasicInstancesArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetBasicInstancesInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetBasicInstancesResult</a></span>> </span>getBasicInstances<span class="p">(</span><span class="nx">GetBasicInstancesArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Sqlserver/getBasicInstances:getBasicInstances
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd><p>ID of the SQL Server basic instance to be query.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Name of the SQL Server basic instance to be query.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
    ...
    <dd><p>Project ID of the SQL Server basic instance to be query.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#subnetid_csharp" style="color: inherit; text-decoration: inherit;">Subnet<wbr>Id</a>
    ...
    <dd><p>Subnet ID of the SQL Server basic instance to be query.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#vpcid_csharp" style="color: inherit; text-decoration: inherit;">Vpc<wbr>Id</a>
    ...
    <dd><p>Vpc ID of the SQL Server basic instance to be query.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
## getBasicInstances Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getbasicinstancesinstancelist">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Sqlserver.<wbr>Outputs.<wbr>Get<wbr>Basic<wbr>Instances<wbr>Instance<wbr>List&gt;</a></span>
    </dt>
    <dd><p>A list of SQL Server basic instances. Each element contains the following attributes.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd><p>ID of the SQL Server basic instance.</p>
</dd><dt class="property-"
            title="">
        <span id="name_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getbasicinstancesinstancelist">[]Get<wbr>Basic<wbr>Instances<wbr>Instance<wbr>List</a></span>
    </dt>
    <dd><p>A list of SQL Server basic instances. Each element contains the following attributes.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_java" style="color: inherit; text-decoration: inherit;">instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getbasicinstancesinstancelist">List&lt;Get<wbr>Basic<wbr>Instances<wbr>Instance<wbr>List&gt;</a></span>
    </dt>
    <dd><p>A list of SQL Server basic instances. Each element contains the following attributes.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_yaml" style="color: inherit; text-decoration: inherit;">instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getbasicinstancesinstancelist">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>A list of SQL Server basic instances. Each element contains the following attributes.</p>
</dd><dt class="property-"
            title="">
...
<h4 id="getbasicinstancesinstancelist">Get<wbr>Basic<wbr>Instances<wbr>Instance<wbr>List</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#status_csharp" style="color: inherit; text-decoration: inherit;">Status</a>
    ...
    <dd><p>Status of the SQL Server basic instance. <code>1</code> for applying, <code>2</code> for running, <code>3</code> for running with limit, <code>4</code> for isolated, <code>5</code> for recycling, <code>6</code> for recycled, <code>7</code> for running with task, <code>8</code> for off-line, <code>9</code> for expanding, <code>10</code> for migrating, <code>11</code> for readonly, <code>12</code> for rebooting.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#tags_csharp" style="color: inherit; text-decoration: inherit;">Tags</a>
    ...
    <dd><p>Tags of the SQL Server basic instance.</p>
</dd><dt class="property-required"
            title="Required">
