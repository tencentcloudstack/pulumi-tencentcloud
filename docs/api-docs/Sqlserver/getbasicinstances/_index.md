...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleId = Output.of(SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .id("mssql-3l3fgqn7")
            .build()));
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleProject = Output.of(SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .projectId(0)
            .build()));
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleVpc = Output.of(SqlserverFunctions.getBasicInstances(GetBasicInstancesArgs.builder()
            .subnetId("subnet-nf9n81ps")
            .vpcId("vpc-409mvdvv")
            .build()));
