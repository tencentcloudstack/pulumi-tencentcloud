...
import com.pulumi.tencentcloud.Sqlserver.inputs.GetInstancesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleId = SqlserverFunctions.getInstances(GetInstancesArgs.builder()
            .id("mssql-3l3fgqn7")
            .build());
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleProject = SqlserverFunctions.getInstances(GetInstancesArgs.builder()
            .projectId(0)
            .build());
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleVpc = SqlserverFunctions.getInstances(GetInstancesArgs.builder()
            .subnetId("subnet-nf9n81ps")
            .vpcId("vpc-409mvdvv")
            .build());
