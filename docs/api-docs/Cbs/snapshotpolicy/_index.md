...
title_tag: "tencentcloud.Cbs.SnapshotPolicy"
meta_desc: "Documentation for the tencentcloud.Cbs.SnapshotPolicy resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Cbs.SnapshotPolicy;
import com.pulumi.tencentcloud.Cbs.SnapshotPolicyArgs;
...
resources:
  snapshotPolicy:
    type: tencentcloud:Cbs:SnapshotPolicy
    properties:
      repeatHours:
        - 1
      repeatWeekdays:
...
<span class="k">def </span><span class="nx">SnapshotPolicy</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
                   ...
                   <span class="nx">repeat_hours</span><span class="p">:</span> <span class="nx">Optional[Sequence[int]]</span> = None<span class="p">,</span>
                   <span class="nx">repeat_weekdays</span><span class="p">:</span> <span class="nx">Optional[Sequence[int]]</span> = None<span class="p">,</span>
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Cbs:SnapshotPolicy</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repeathours_csharp" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Hours</a>
    ...
    <dd><p>Trigger times of periodic snapshot. Valid value ranges: (0~23). The 0 means 00:00, and so on.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#repeatweekdays_csharp" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Weekdays</a>
    ...
    <dd><p>Periodic snapshot is enabled. Valid values: [0, 1, 2, 3, 4, 5, 6]. 0 means Sunday, 1-6 means Monday to Saturday.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#snapshotpolicyname_csharp" style="color: inherit; text-decoration: inherit;">Snapshot<wbr>Policy<wbr>Name</a>
    ...
    <dd><p>Name of snapshot policy. The maximum length can not exceed 60 bytes.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#retentiondays_csharp" style="color: inherit; text-decoration: inherit;">Retention<wbr>Days</a>
    ...
    <dd><p>Retention days of the snapshot, and the default value is 7.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeathours_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeathours_csharp" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;int&gt;</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeatweekdays_csharp" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;int&gt;</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeathours_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeathours_go" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]int</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeatweekdays_go" style="color: inherit; text-decoration: inherit;">Repeat<wbr>Weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">[]int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeathours_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeathours_java" style="color: inherit; text-decoration: inherit;">repeat<wbr>Hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Integer&gt;</span>
    </dt>
    <dd><p>Trigger times of periodic snapshot. Valid value ranges: (0~23). The 0 means 00:00, and so on.</p>
            ...
            title="Optional">
        <span id="state_repeatweekdays_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeatweekdays_java" style="color: inherit; text-decoration: inherit;">repeat<wbr>Weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Integer&gt;</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeathours_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeathours_nodejs" style="color: inherit; text-decoration: inherit;">repeat<wbr>Hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number[]</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeatweekdays_nodejs" style="color: inherit; text-decoration: inherit;">repeat<wbr>Weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">number[]</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeat_hours_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeat_hours_python" style="color: inherit; text-decoration: inherit;">repeat_<wbr>hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[int]</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeat_weekdays_python" style="color: inherit; text-decoration: inherit;">repeat_<wbr>weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Sequence[int]</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-optional"
            title="Optional">
        <span id="state_repeathours_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeathours_yaml" style="color: inherit; text-decoration: inherit;">repeat<wbr>Hours</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Number&gt;</span>
    </dt>
    <dd><p>Trigger times of periodic snapshot. Valid value ranges: (0~23). The 0 means 00:00, and so on.</p>
            ...
            title="Optional">
        <span id="state_repeatweekdays_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_repeatweekdays_yaml" style="color: inherit; text-decoration: inherit;">repeat<wbr>Weekdays</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">List&lt;Number&gt;</span>
    </dt>
