...
import com.pulumi.tencentcloud.Vpc.inputs.GetSgSnapshotFileContentArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var sgSnapshotFileContent = VpcFunctions.getSgSnapshotFileContent(GetSgSnapshotFileContentArgs.builder()
            .securityGroupId("sg-ntrgm89v")
            .snapshotFileId("ssfile-017gepjxpr")
            .snapshotPolicyId("sspolicy-ebjofe71")
            .build());
