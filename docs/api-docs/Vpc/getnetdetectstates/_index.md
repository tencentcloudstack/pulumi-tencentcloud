...
import com.pulumi.tencentcloud.Vpc.inputs.GetNetDetectStatesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var netDetectStates = VpcFunctions.getNetDetectStates(GetNetDetectStatesArgs.builder()
            .netDetectIds("netd-12345678")
            .build());
