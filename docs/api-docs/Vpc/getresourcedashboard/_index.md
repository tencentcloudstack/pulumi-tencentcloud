...
import com.pulumi.tencentcloud.Vpc.inputs.GetResourceDashboardArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var resourceDashboard = VpcFunctions.getResourceDashboard(GetResourceDashboardArgs.builder()
            .vpcIds("vpc-4owdpnwr")
            .build());
