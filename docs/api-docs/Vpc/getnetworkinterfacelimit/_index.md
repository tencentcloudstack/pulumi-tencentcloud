...
import com.pulumi.tencentcloud.Vpc.inputs.GetNetworkInterfaceLimitArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var networkInterfaceLimit = VpcFunctions.getNetworkInterfaceLimit(GetNetworkInterfaceLimitArgs.builder()
            .instanceId("ins-cr2rfq78")
            .build());
