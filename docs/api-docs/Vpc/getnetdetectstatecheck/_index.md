...
import com.pulumi.tencentcloud.Vpc.inputs.GetNetDetectStateCheckArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var netDetectStateCheck = VpcFunctions.getNetDetectStateCheck(GetNetDetectStateCheckArgs.builder()
            .detectDestinationIps(            
                "10.0.0.3",
                "10.0.0.2")
            .netDetectId("netd-12345678")
