...
import com.pulumi.tencentcloud.Vpc.inputs.GetGatewayFlowMonitorDetailArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var gatewayFlowMonitorDetail = VpcFunctions.getGatewayFlowMonitorDetail(GetGatewayFlowMonitorDetailArgs.builder()
            .orderDirection("DESC")
            .orderField("OutTraffic")
            .timePoint("2023-06-02 12:15:20")
            .vpnId("vpngw-gt8bianl")
