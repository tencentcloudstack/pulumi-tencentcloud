...
import com.pulumi.tencentcloud.Emr.inputs.GetAutoScaleRecordsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var autoScaleRecords = EmrFunctions.getAutoScaleRecords(GetAutoScaleRecordsArgs.builder()
