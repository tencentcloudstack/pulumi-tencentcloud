...
class MyStack : Stack
{
    public MyStack()
    {
        var topSpaceTableTimeSeries = Output.Create(Tencentcloud.Dbbrain.GetTopSpaceTableTimeSeries.InvokeAsync(new Tencentcloud.Dbbrain.GetTopSpaceTableTimeSeriesArgs
        {
            EndDate = "%s",
            InstanceId = "%s",
            Product = "mysql",
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var topSpaceTableTimeSeries = Output.of(DbbrainFunctions.getTopSpaceTableTimeSeries(GetTopSpaceTableTimeSeriesArgs.builder()
            .endDate("%s")
            .instanceId("%s")
            .product("mysql")
            .sortBy("DataLength")
