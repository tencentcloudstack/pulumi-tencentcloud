...
import com.pulumi.tencentcloud.Dbbrain.inputs.GetTopSpaceSchemasArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var topSpaceSchemas = DbbrainFunctions.getTopSpaceSchemas(GetTopSpaceSchemasArgs.builder()
            .instanceId("%s")
            .product("mysql")
            .sortBy("DataLength")
            .build());
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#topspaceschemas_go" style="color: inherit; text-decoration: inherit;">Top<wbr>Space<wbr>Schemas</a>
</span>
        <span class="property-indicator"></span>
