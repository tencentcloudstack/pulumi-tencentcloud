...
import com.pulumi.tencentcloud.Dbbrain.inputs.GetSlowLogUserHostStatsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var test = DbbrainFunctions.getSlowLogUserHostStats(GetSlowLogUserHostStatsArgs.builder()
            .endTime("%s")
            .instanceId("%s")
            .product("mysql")
            .startTime("%s")
