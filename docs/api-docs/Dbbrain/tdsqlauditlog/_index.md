...
const myLog = new tencentcloud.dbbrain.TdsqlAuditLog("myLog", {
    endTime: "%s",
    filter: {
        hosts: [
            "%%",
...
import com.pulumi.tencentcloud.Dbbrain.TdsqlAuditLog;
import com.pulumi.tencentcloud.Dbbrain.TdsqlAuditLogArgs;
import com.pulumi.tencentcloud.Dbbrain.inputs.TdsqlAuditLogFilterArgs;
