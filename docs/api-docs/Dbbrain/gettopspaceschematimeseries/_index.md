...
import com.pulumi.tencentcloud.Dbbrain.inputs.GetTopSpaceSchemaTimeSeriesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var topSpaceSchemaTimeSeries = DbbrainFunctions.getTopSpaceSchemaTimeSeries(GetTopSpaceSchemaTimeSeriesArgs.builder()
            .endDate("%s")
            .instanceId("%s")
            .product("mysql")
            .sortBy("DataLength")
