...
import com.pulumi.tencentcloud.Clb.inputs.GetListenersByTargetsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var listenersByTargets = ClbFunctions.getListenersByTargets(GetListenersByTargetsArgs.builder()
