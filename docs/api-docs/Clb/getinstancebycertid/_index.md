...
import com.pulumi.tencentcloud.Clb.inputs.GetInstanceByCertIdArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceByCertId = ClbFunctions.getInstanceByCertId(GetInstanceByCertIdArgs.builder()
            .certIds("3a6B5y8v")
            .build());
