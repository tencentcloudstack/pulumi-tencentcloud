...
import com.pulumi.tencentcloud.Clb.inputs.GetTargetGroupListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var targetGroupList = ClbFunctions.getTargetGroupList(GetTargetGroupListArgs.builder()
