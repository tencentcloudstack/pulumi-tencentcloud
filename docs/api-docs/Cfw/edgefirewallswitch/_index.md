...
import com.pulumi.tencentcloud.Cfw.inputs.GetEdgeFwSwitchesArgs;
import com.pulumi.tencentcloud.Cfw.EdgeFirewallSwitch;
import com.pulumi.tencentcloud.Cfw.EdgeFirewallSwitchArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleEdgeFwSwitches = CfwFunctions.getEdgeFwSwitches();

        var exampleEdgeFirewallSwitch = new EdgeFirewallSwitch("exampleEdgeFirewallSwitch", EdgeFirewallSwitchArgs.builder()        
            .publicIp(exampleEdgeFwSwitches.applyValue(getEdgeFwSwitchesResult -> getEdgeFwSwitchesResult.datas()[0].publicIp()))
            .switchMode(1)
            .enable(0)
            .build());
