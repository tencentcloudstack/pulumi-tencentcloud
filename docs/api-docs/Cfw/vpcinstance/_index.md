...
import com.pulumi.tencentcloud.Cfw.VpcInstance;
import com.pulumi.tencentcloud.Cfw.VpcInstanceArgs;
import com.pulumi.tencentcloud.Cfw.inputs.VpcInstanceVpcFwInstanceArgs;
import com.pulumi.tencentcloud.Cfw.inputs.VpcInstanceVpcFwInstanceFwDeployArgs;
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#fwinsid_csharp" style="color: inherit; text-decoration: inherit;">Fw<wbr>Ins<wbr>Id</a>
    ...
    <dd><p>Firewall instance ID (passed in editing scenario).</p>
</dd><dt class="property-optional"
            title="Optional">
