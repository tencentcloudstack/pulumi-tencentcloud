...
import com.pulumi.tencentcloud.Cfw.VpcFirewallSwitch;
import com.pulumi.tencentcloud.Cfw.VpcFirewallSwitchArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var exampleVpcFwSwitches = CfwFunctions.getVpcFwSwitches(GetVpcFwSwitchesArgs.builder()
            .vpcInsId("cfwg-c8c2de41")
            .build());

        var exampleVpcFirewallSwitch = new VpcFirewallSwitch("exampleVpcFirewallSwitch", VpcFirewallSwitchArgs.builder()        
            .vpcInsId(exampleVpcFwSwitches.applyValue(getVpcFwSwitchesResult -> getVpcFwSwitchesResult.id()))
            .switchId(exampleVpcFwSwitches.applyValue(getVpcFwSwitchesResult -> getVpcFwSwitchesResult.switchLists()[0].switchId()))
            .enable(0)
            .build());
