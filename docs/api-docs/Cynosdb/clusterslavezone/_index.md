...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var exclusive = Output.of(SecurityFunctions.getGroups(GetGroupsArgs.builder()
            .name("test_preset_sg")
            .build()));

        final var sgId2 = exclusive.apply(getGroupsResult -> getGroupsResult.securityGroups()[0].securityGroupId());
...
configuration:
  fixedTags:
    type: object({fixed_resource = string})
    default:
      fixed_resource: do_not_remove
  availabilityZone:
    type: string
