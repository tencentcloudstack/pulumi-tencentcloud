...
import com.pulumi.tencentcloud.Cynosdb.inputs.GetResourcePackageSaleSpecsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var resourcePackageSaleSpecs = CynosdbFunctions.getResourcePackageSaleSpecs(GetResourcePackageSaleSpecsArgs.builder()
            .instanceType("cynosdb-serverless")
            .packageRegion("china")
            .packageType("CCU")
            .build());
