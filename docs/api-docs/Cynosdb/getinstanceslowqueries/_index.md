...
import com.pulumi.tencentcloud.Cynosdb.inputs.GetInstanceSlowQueriesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var instanceSlowQueries = CynosdbFunctions.getInstanceSlowQueries(GetInstanceSlowQueriesArgs.builder()
            .instanceId(cynosdbClusterId)
            .startTime("2023-06-20 23:19:03")
            .endTime("2023-06-30 23:19:03")
            .username("keep_dts")
