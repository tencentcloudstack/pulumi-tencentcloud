...
{
    var zone = Tencentcloud.Cynosdb.GetZone.Invoke(new()
    {
        IncludeVirtualZones = true,
        ShowPermission = true,
    });
...
import com.pulumi.tencentcloud.Cynosdb.inputs.GetZoneArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var zone = CynosdbFunctions.getZone(GetZoneArgs.builder()
            .includeVirtualZones(true)
            .showPermission(true)
            .build());
