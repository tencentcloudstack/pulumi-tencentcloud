...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var gz3 = Output.of(VpcFunctions.getSubnets(GetSubnetsArgs.builder()
            .availabilityZone(var_.default_az())
            .isDefault(true)
            .build()));

        final var vpcId = gz3.apply(getSubnetsResult -> getSubnetsResult.instanceLists()[0].vpcId());

        final var subnetId = gz3.apply(getSubnetsResult -> getSubnetsResult.instanceLists()[0].subnetId());
