...
import com.pulumi.tencentcloud.Cynosdb.inputs.GetRollbackTimeRangeArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var rollbackTimeRange = CynosdbFunctions.getRollbackTimeRange(GetRollbackTimeRangeArgs.builder()
            .clusterId("cynosdbmysql-bws8h88b")
            .build());
