...
title_tag: "tencentcloud.Mariadb.getInstanceNodeInfo"
meta_desc: "Documentation for the tencentcloud.Mariadb.getInstanceNodeInfo function with examples, input properties, output properties, and supporting types."
layout: api
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Mariadb/getInstanceNodeInfo:getInstanceNodeInfo
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodesinfos_csharp" style="color: inherit; text-decoration: inherit;">Nodes<wbr>Infos</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getinstancenodeinfonodesinfo">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Mariadb.<wbr>Outputs.<wbr>Get<wbr>Instance<wbr>Node<wbr>Info<wbr>Nodes<wbr>Info&gt;</a></span>
    </dt>
    <dd></dd><dt class="property-"
            title="">
        <span id="resultoutputfile_csharp">
