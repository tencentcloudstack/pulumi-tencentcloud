...
public class App {
    ...
    public static void stack(Context ctx) {
        final var projectSecurityGroups = Output.of(MariadbFunctions.getProjectSecurityGroups(GetProjectSecurityGroupsArgs.builder()
            .product("mariadb")
            .projectId(0)
            .build()));
...
const projectSecurityGroups = pulumi.output(tencentcloud.Mariadb.getProjectSecurityGroups({
    product: "mariadb",
    projectId: 0,
}));
```
