---
title: "getPrice"
title_tag: "tencentcloud.Mariadb.getPrice"
meta_desc: "Documentation for the tencentcloud.Mariadb.getPrice function with examples, input properties, output properties, and supporting types."
layout: api
...
class MyStack : Stack
{
    public MyStack()
    {
        var price = Output.Create(Tencentcloud.Mariadb.GetPrice.InvokeAsync(new Tencentcloud.Mariadb.GetPriceArgs
        {
            BuyCount = 1,
            Memory = 2,
            NodeCount = 2,
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var price = Output.of(MariadbFunctions.getPrice(GetPriceArgs.builder()
            .buyCount(1)
            .memory(2)
            .nodeCount(2)
            .paymode("prepaid")
...
variables:
  price:
    Fn::Invoke:
      Function: tencentcloud:Mariadb:getPrice
      Arguments:
        buyCount: 1
        memory: 2
        nodeCount: 2
...
><span class="k">def </span>get_price<span class="p">(</span><span class="nx">amount_unit</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
              <span class="nx">buy_count</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
...
def </span>get_price_output<span class="p">(</span><span class="nx">amount_unit</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
              <span class="nx">buy_count</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[int]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Mariadb/getPrice:getPrice
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buycount_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buycount_csharp" style="color: inherit; text-decoration: inherit;">Buy<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
    <dd><p>The quantity you want to purchase is queried by default for the price of purchasing 1 instance.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#nodecount_csharp" style="color: inherit; text-decoration: inherit;">Node<wbr>Count</a>
    ...
    <dd><p>Number of instance nodes, which can be obtained by querying the instance specification through the <code>DescribeDBInstanceSpecs</code> API.</p>
</dd><dt class="property-required"
            title="Required">
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buycount_go">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buycount_go" style="color: inherit; text-decoration: inherit;">Buy<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buycount_java">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buycount_java" style="color: inherit; text-decoration: inherit;">buy<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buycount_nodejs">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buycount_nodejs" style="color: inherit; text-decoration: inherit;">buy<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buy_count_python">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buy_count_python" style="color: inherit; text-decoration: inherit;">buy_<wbr>count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
...
<dl class="resources-properties"><dt class="property-required"
            title="Required">
        <span id="buycount_yaml">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#buycount_yaml" style="color: inherit; text-decoration: inherit;">buy<wbr>Count</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">Number</span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#id_csharp" style="color: inherit; text-decoration: inherit;">Id</a>
    ...
    <dd><p>The provider-assigned unique ID for this managed resource.</p>
            ...
            title="">
        <span id="mariadbprice_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#mariadbprice_csharp" style="color: inherit; text-decoration: inherit;">Mariadb<wbr>Price</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type">int</span>
    </dt>
