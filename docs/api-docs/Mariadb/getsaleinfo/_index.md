...
const saleInfo = tencentcloud.Mariadb.getSaleInfo({});
```
```python
import pulumi
...
import com.pulumi.tencentcloud.Mariadb.inputs.GetSaleInfoArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var saleInfo = MariadbFunctions.getSaleInfo();
