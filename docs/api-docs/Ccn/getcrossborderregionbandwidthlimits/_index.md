...
import com.pulumi.tencentcloud.Ccn.inputs.GetCrossBorderRegionBandwidthLimitsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var ccnRegionBandwidthLimits = CcnFunctions.getCrossBorderRegionBandwidthLimits(GetCrossBorderRegionBandwidthLimitsArgs.builder()
            .filters(            
