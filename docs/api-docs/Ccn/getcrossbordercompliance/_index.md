...
import com.pulumi.tencentcloud.Ccn.inputs.GetCrossBorderComplianceArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var crossBorderCompliance = CcnFunctions.getCrossBorderCompliance(GetCrossBorderComplianceArgs.builder()
            .complianceId(10002)
            .email("test@tencent.com")
            .serviceEndDate("2021-07-29")
            .serviceProvider("UNICOM")
