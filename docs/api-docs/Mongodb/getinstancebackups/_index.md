...
import com.pulumi.tencentcloud.Mongodb.inputs.GetInstanceBackupsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceBackups = MongodbFunctions.getInstanceBackups(GetInstanceBackupsArgs.builder()
            .backupMethod(0)
            .instanceId("cmgo-9d0p6umb")
            .build());
