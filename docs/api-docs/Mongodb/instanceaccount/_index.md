...
const instanceAccount = new tencentcloud.mongodb.InstanceAccount("instanceAccount", {
    authRoles: [{
        mask: 0,
        namespace: "*",
    }],
...
import com.pulumi.tencentcloud.Mongodb.InstanceAccount;
import com.pulumi.tencentcloud.Mongodb.InstanceAccountArgs;
import com.pulumi.tencentcloud.Mongodb.inputs.InstanceAccountAuthRoleArgs;
