...
import com.pulumi.tencentcloud.Gaap.inputs.GetCheckProxyCreateArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var checkProxyCreate = GaapFunctions.getCheckProxyCreate(GetCheckProxyCreateArgs.builder()
