...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostWafInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostWafInstanceList = SslFunctions.getDescribeHostWafInstanceList(GetDescribeHostWafInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .resourceType("waf")
            .build());
...
<h4 id="getdescribehostwafinstancelistinstancelist">Get<wbr>Describe<wbr>Host<wbr>Waf<wbr>Instance<wbr>List<wbr>Instance<wbr>List</h4>
