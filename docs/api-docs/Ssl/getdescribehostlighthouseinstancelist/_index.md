...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostLighthouseInstanceList = Output.of(SslFunctions.getDescribeHostLighthouseInstanceList(GetDescribeHostLighthouseInstanceListArgs.builder()
            .certificateId("8tvMCvGF")
            .resourceType("lighthouse")
            .build()));
