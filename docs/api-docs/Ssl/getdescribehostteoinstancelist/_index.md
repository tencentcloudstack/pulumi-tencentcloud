...
---
title: "getDescribeHostTeoInstanceList"
title_tag: "tencentcloud.Ssl.getDescribeHostTeoInstanceList"
meta_desc: "Documentation for the tencentcloud.Ssl.getDescribeHostTeoInstanceList function with examples, input properties, output properties, and supporting types."
layout: api
...
describe_host_teo_instance_list = tencentcloud.Ssl.get_describe_host_teo_instance_list(certificate_id="8u8DII0l",
    resource_type="teo")
```
```csharp
...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostTeoInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostTeoInstanceList = SslFunctions.getDescribeHostTeoInstanceList(GetDescribeHostTeoInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .resourceType("teo")
            .build());
...
variables:
  describeHostTeoInstanceList:
    fn::invoke:
      Function: tencentcloud:Ssl:getDescribeHostTeoInstanceList
      Arguments:
        certificateId: 8u8DII0l
        resourceType: teo
```
...
## Using getDescribeHostTeoInstanceList {#using}
...
><span class="k">function </span>getDescribeHostTeoInstanceList<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetDescribeHostTeoInstanceListArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>></span
><span class="k">
function </span>getDescribeHostTeoInstanceListOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetDescribeHostTeoInstanceListOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_describe_host_teo_instance_list<span class="p">(</span><span class="nx">certificate_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                        <span class="nx">filters</span><span class="p">:</span> <span class="nx">Optional[Sequence[_ssl.GetDescribeHostTeoInstanceListFilter]]</span> = None<span class="p">,</span>
                                        ...
                                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetDescribeHostTeoInstanceListResult</span
><span class="k">
def </span>get_describe_host_teo_instance_list_output<span class="p">(</span><span class="nx">certificate_id</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                        <span class="nx">filters</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_ssl.GetDescribeHostTeoInstanceListFilterArgs]]]]</span> = None<span class="p">,</span>
                                        ...
                                        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetDescribeHostTeoInstanceListResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetDescribeHostTeoInstanceList<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetDescribeHostTeoInstanceListArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>, error)</span
><span class="k">
func </span>GetDescribeHostTeoInstanceListOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetDescribeHostTeoInstanceListOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetDescribeHostTeoInstanceListResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetDescribeHostTeoInstanceList` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetDescribeHostTeoInstanceList </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetDescribeHostTeoInstanceListArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetDescribeHostTeoInstanceListInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetDescribeHostTeoInstanceListResult</a></span>> </span>getDescribeHostTeoInstanceList<span class="p">(</span><span class="nx">GetDescribeHostTeoInstanceListArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Ssl/getDescribeHostTeoInstanceList:getDescribeHostTeoInstanceList
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_csharp" style="color: inherit; text-decoration: inherit;">Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistfilter">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Ssl.<wbr>Inputs.<wbr>Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Filter&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_go" style="color: inherit; text-decoration: inherit;">Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistfilter">[]Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Filter</a></span>
    </dt>
    <dd><p>List of filtering parameters; Filterkey: domainmatch.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_java" style="color: inherit; text-decoration: inherit;">filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistfilter">List&lt;Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Filter&gt;</a></span>
    </dt>
    <dd><p>List of filtering parameters; Filterkey: domainmatch.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_yaml" style="color: inherit; text-decoration: inherit;">filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistfilter">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>List of filtering parameters; Filterkey: domainmatch.</p>
</dd><dt class="property-optional"
            title="Optional">
...
## getDescribeHostTeoInstanceList Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_csharp" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistinstancelist">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Ssl.<wbr>Outputs.<wbr>Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Instance<wbr>List&gt;</a></span>
    </dt>
    <dd><p>Teo instance listNote: This field may return NULL, indicating that the valid value cannot be obtained.</p>
</dd><dt class="property-"
            title="">
        <span id="resourcetype_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resourcetype_csharp" style="color: inherit; text-decoration: inherit;">Resource<wbr>Type</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_csharp" style="color: inherit; text-decoration: inherit;">Filters</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistfilter">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Ssl.<wbr>Outputs.<wbr>Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Filter&gt;</a></span>
    </dt>
    <dd></dd><dt class="property-"
            title="">
        <span id="iscache_csharp">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_go" style="color: inherit; text-decoration: inherit;">Instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistinstancelist">[]Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Instance<wbr>List</a></span>
    </dt>
    <dd><p>Teo instance listNote: This field may return NULL, indicating that the valid value cannot be obtained.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_java" style="color: inherit; text-decoration: inherit;">instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistinstancelist">List&lt;Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Instance<wbr>List&gt;</a></span>
    </dt>
    <dd><p>Teo instance listNote: This field may return NULL, indicating that the valid value cannot be obtained.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#instancelists_yaml" style="color: inherit; text-decoration: inherit;">instance<wbr>Lists</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getdescribehostteoinstancelistinstancelist">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>Teo instance listNote: This field may return NULL, indicating that the valid value cannot be obtained.</p>
</dd><dt class="property-"
            title="">
...
<h4 id="getdescribehostteoinstancelistfilter">Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Filter</h4>
...
<h4 id="getdescribehostteoinstancelistinstancelist">Get<wbr>Describe<wbr>Host<wbr>Teo<wbr>Instance<wbr>List<wbr>Instance<wbr>List</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#zoneid_csharp" style="color: inherit; text-decoration: inherit;">Zone<wbr>Id</a>
    ...
    <dd><p>Regional IDNote: This field may return NULL, indicating that the valid value cannot be obtained.</p>
</dd></dl>
</pulumi-choosable>
</div>
