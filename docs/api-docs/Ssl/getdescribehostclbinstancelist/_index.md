...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostClbInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostClbInstanceList = SslFunctions.getDescribeHostClbInstanceList(GetDescribeHostClbInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .build());
