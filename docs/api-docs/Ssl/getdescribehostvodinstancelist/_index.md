...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostVodInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostVodInstanceList = SslFunctions.getDescribeHostVodInstanceList(GetDescribeHostVodInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .resourceType("vod")
            .build());
