...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostCosInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostCosInstanceList = SslFunctions.getDescribeHostCosInstanceList(GetDescribeHostCosInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .resourceType("cos")
            .build());
