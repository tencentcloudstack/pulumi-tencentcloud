...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeManagerDetailArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeManagerDetail = SslFunctions.getDescribeManagerDetail(GetDescribeManagerDetailArgs.builder()
            .managerId("")
            .build());
