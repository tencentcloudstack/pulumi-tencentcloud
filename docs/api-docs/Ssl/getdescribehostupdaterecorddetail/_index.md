...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostUpdateRecordDetailArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostUpdateRecordDetail = SslFunctions.getDescribeHostUpdateRecordDetail(GetDescribeHostUpdateRecordDetailArgs.builder()
            .deployRecordId("35364")
            .build());
