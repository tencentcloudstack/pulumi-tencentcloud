...
class MyStack : Stack
{
    public MyStack()
    {
        var describeHostTkeInstanceList = Output.Create(Tencentcloud.Ssl.GetDescribeHostTkeInstanceList.InvokeAsync(new Tencentcloud.Ssl.GetDescribeHostTkeInstanceListArgs
        {
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostTkeInstanceList = Output.of(SslFunctions.getDescribeHostTkeInstanceList(GetDescribeHostTkeInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .build()));
