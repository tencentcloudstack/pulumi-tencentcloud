...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeHostCdnInstanceListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostCdnInstanceList = SslFunctions.getDescribeHostCdnInstanceList(GetDescribeHostCdnInstanceListArgs.builder()
            .certificateId("8u8DII0l")
            .resourceType("cdn")
            .build());
