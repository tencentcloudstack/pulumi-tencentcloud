...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeCompaniesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeCompanies = SslFunctions.getDescribeCompanies(GetDescribeCompaniesArgs.builder()
            .companyId(122)
            .build());
