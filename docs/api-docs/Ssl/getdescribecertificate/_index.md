...
import com.pulumi.tencentcloud.Ssl.inputs.GetDescribeCertificateArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeCertificate = SslFunctions.getDescribeCertificate(GetDescribeCertificateArgs.builder()
            .certificateId("8cj4g8h8")
            .build());
