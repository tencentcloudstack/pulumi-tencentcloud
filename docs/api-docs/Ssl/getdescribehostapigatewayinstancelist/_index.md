...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeHostApiGatewayInstanceList = Output.of(SslFunctions.getDescribeHostApiGatewayInstanceList(GetDescribeHostApiGatewayInstanceListArgs.builder()
            .certificateId("9Bpk7XOu")
            .resourceType("apiGateway")
            .build()));
