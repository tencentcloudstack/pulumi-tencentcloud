...
import com.pulumi.tencentcloud.Postgresql.inputs.GetParameterTemplatesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var parameterTemplates = PostgresqlFunctions.getParameterTemplates(GetParameterTemplatesArgs.builder()
            .filters(            
