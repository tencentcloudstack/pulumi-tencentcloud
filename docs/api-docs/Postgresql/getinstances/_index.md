...
import com.pulumi.tencentcloud.Postgresql.inputs.GetInstancesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var name = PostgresqlFunctions.getInstances(GetInstancesArgs.builder()
            .name("test")
            .build());

        final var project = PostgresqlFunctions.getInstances(GetInstancesArgs.builder()
            .projectId(0)
            .build());

        final var id = PostgresqlFunctions.getInstances(GetInstancesArgs.builder()
            .id("postgres-h9t4fde1")
            .build());
