...
import com.pulumi.tencentcloud.Postgresql.inputs.GetDbInstanceClassesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var dbInstanceClasses = PostgresqlFunctions.getDbInstanceClasses(GetDbInstanceClassesArgs.builder()
            .dbEngine("postgresql")
            .dbMajorVersion("13")
            .zone("ap-guangzhou-7")
            .build());
