...
title_tag: "tencentcloud.Postgresql.RenewDbInstanceOperation"
meta_desc: "Documentation for the tencentcloud.Postgresql.RenewDbInstanceOperation resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Postgresql.RenewDbInstanceOperation;
import com.pulumi.tencentcloud.Postgresql.RenewDbInstanceOperationArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var renewDbInstanceOperation = new RenewDbInstanceOperation("renewDbInstanceOperation", RenewDbInstanceOperationArgs.builder()        
            .dbInstanceId(tencentcloud_postgresql_instance.oper_test_PREPAID().id())
            .period(1)
            .autoVoucher(0)
            .build());
...
resources:
  renewDbInstanceOperation:
    type: tencentcloud:Postgresql:RenewDbInstanceOperation
    properties:
      dbInstanceId: ${tencentcloud_postgresql_instance.oper_test_PREPAID.id}
      period: 1
      autoVoucher: 0
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Postgresql:RenewDbInstanceOperation</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#dbinstanceid_csharp" style="color: inherit; text-decoration: inherit;">Db<wbr>Instance<wbr>Id</a>
    ...
    <dd><p>Instance ID in the format of postgres-6fego161.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#period_csharp" style="color: inherit; text-decoration: inherit;">Period</a>
    ...
    <dd><p>Renewal duration in months.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#autovoucher_csharp" style="color: inherit; text-decoration: inherit;">Auto<wbr>Voucher</a>
    ...
    <dd><p>Whether to automatically use vouchers. 1:yes, 0:no. Default value:0.</p>
</dd><dt class="property-optional property-replacement"
            title="Optional">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#voucherids_csharp" style="color: inherit; text-decoration: inherit;">Voucher<wbr>Ids</a>
    ...
    <dd><p>Voucher ID list (only one voucher can be specified currently).</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">db_instance_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">period</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">,</span>
        <span class="nx">voucher_ids</span><span class="p">:</span> <span class="nx">Optional[Sequence[str]]</span> = None<span class="p">) -&gt;</span> RenewDbInstanceOperation</code></pre></div>
</pulumi-choosable>
</div>
