...
import com.pulumi.tencentcloud.Cam.inputs.GetGroupsArgs;
import com.pulumi.tencentcloud.Cam.User;
import com.pulumi.tencentcloud.Cam.UserArgs;
import com.pulumi.tencentcloud.Cam.GroupMembership;
import com.pulumi.tencentcloud.Cam.GroupMembershipArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var groups = CamFunctions.getGroups(GetGroupsArgs.builder()
            .name(camGroupBasic)
            .build());
        ...
        var groupMembershipBasic = new GroupMembership("groupMembershipBasic", GroupMembershipArgs.builder()        
            .groupId(groups.applyValue(getGroupsResult -> getGroupsResult.groupLists()[0].groupId()))
            .userNames(foo.id())
            .build());
