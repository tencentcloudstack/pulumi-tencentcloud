...
import com.pulumi.tencentcloud.Cam.GroupPolicyAttachment;
import com.pulumi.tencentcloud.Cam.GroupPolicyAttachmentArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        var groupPolicyAttachmentBasic = new GroupPolicyAttachment("groupPolicyAttachmentBasic", GroupPolicyAttachmentArgs.builder()        
            ...
            .policyId(policy.applyValue(getPoliciesResult -> getPoliciesResult.policyLists()[0].policyId()))
            .build());
