...
import com.pulumi.tencentcloud.Cam.MfaFlag;
import com.pulumi.tencentcloud.Cam.MfaFlagArgs;
import com.pulumi.tencentcloud.Cam.inputs.MfaFlagLoginFlagArgs;
import com.pulumi.tencentcloud.Cam.inputs.MfaFlagActionFlagArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        var mfaFlag = new MfaFlag("mfaFlag", MfaFlagArgs.builder()        
            .opUin(info.applyValue(getInfoResult -> getInfoResult.uin()))
