...
import com.pulumi.tencentcloud.Cam.inputs.GetPolicyGrantingServiceAccessArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var policyGrantingServiceAccess = CamFunctions.getPolicyGrantingServiceAccess(GetPolicyGrantingServiceAccessArgs.builder()
            .roleId(4611686018436804608)
            .serviceType("cam")
            .build());
