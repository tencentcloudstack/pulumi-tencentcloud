...
import com.pulumi.tencentcloud.Cam.Role;
import com.pulumi.tencentcloud.Cam.RoleArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var myUin = info.applyValue(getInfoResult -> getInfoResult.ownerUin());
