...
import com.pulumi.tencentcloud.ApiGateway.inputs.GetBindApiAppsStatusArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var example = ApiGatewayFunctions.getBindApiAppsStatus(GetBindApiAppsStatusArgs.builder()
            .apiIds(            
                "api-0cvmf4x4",
                "api-jvqlzolk")
