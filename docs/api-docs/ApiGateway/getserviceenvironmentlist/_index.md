...
import com.pulumi.tencentcloud.ApiGateway.inputs.GetServiceEnvironmentListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var example = ApiGatewayFunctions.getServiceEnvironmentList(GetServiceEnvironmentListArgs.builder()
            .serviceId("service-nxz6yync")
            .build());
