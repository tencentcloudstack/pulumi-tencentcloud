...
import com.pulumi.tencentcloud.Kubernetes.inputs.GetClusterAuthenticationOptionsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var clusterAuthenticationOptions = KubernetesFunctions.getClusterAuthenticationOptions(GetClusterAuthenticationOptionsArgs.builder()
            .clusterId("cls-kzilgv5m")
            .build());
