...
import com.pulumi.tencentcloud.Kubernetes.AddonAttachment;
import com.pulumi.tencentcloud.Kubernetes.AddonAttachmentArgs;
...
import com.pulumi.tencentcloud.Tcr.inputs.GetInstancesArgs;
import com.pulumi.tencentcloud.Kubernetes.AddonAttachment;
import com.pulumi.tencentcloud.Kubernetes.AddonAttachmentArgs;
import java.util.List;
import java.util.ArrayList;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var endPoint = myIns.applyValue(getInstancesResult -> getInstancesResult).applyValue(myIns -> myIns.applyValue(getInstancesResult -> getInstancesResult.instanceLists()[0].internalEndPoint()));
