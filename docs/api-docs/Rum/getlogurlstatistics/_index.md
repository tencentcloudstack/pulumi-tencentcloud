...
import com.pulumi.tencentcloud.Rum.inputs.GetLogUrlStatisticsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var logUrlStatistics = RumFunctions.getLogUrlStatistics(GetLogUrlStatisticsArgs.builder()
            .endTime(1625454840)
            .projectId(1)
            .startTime(1625444040)
            .type("analysis")
