---
title: "getLogUrlStatistics"
title_tag: "tencentcloud.Rum.getLogUrlStatistics"
meta_desc: "Documentation for the tencentcloud.Rum.getLogUrlStatistics function with examples, input properties, output properties, and supporting types."
layout: api
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var logUrlStatistics = Output.of(RumFunctions.getLogUrlStatistics(GetLogUrlStatisticsArgs.builder()
            .endTime(1625454840)
            .projectId(1)
            .startTime(1625444040)
            .type("analysis")
...
const logUrlStatistics = pulumi.output(tencentcloud.Rum.getLogUrlStatistics({
    endTime: 1625454840,
    projectId: 1,
    startTime: 1625444040,
    type: "analysis",
...
variables:
  logUrlStatistics:
    Fn::Invoke:
      Function: tencentcloud:Rum:getLogUrlStatistics
      Arguments:
...
## Using getLogUrlStatistics {#using}
...
><span class="k">function </span>getLogUrlStatistics<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetLogUrlStatisticsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>></span
><span class="k">
function </span>getLogUrlStatisticsOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetLogUrlStatisticsOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_log_url_statistics<span class="p">(</span><span class="nx">area</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                           ...
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetLogUrlStatisticsResult</span
><span class="k">
def </span>get_log_url_statistics_output<span class="p">(</span><span class="nx">area</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                           ...
                           <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetLogUrlStatisticsResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetLogUrlStatistics<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetLogUrlStatisticsArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>, error)</span
><span class="k">
func </span>GetLogUrlStatisticsOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetLogUrlStatisticsOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetLogUrlStatisticsResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetLogUrlStatistics` in the Go SDK.
...
<div>
<pulumi-choosable type="language" values="csharp">
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetLogUrlStatistics </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetLogUrlStatisticsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetLogUrlStatisticsInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div>
<pulumi-choosable type="language" values="java">
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetLogUrlStatisticsResult</a></span>> </span>getLogUrlStatistics<span class="p">(</span><span class="nx">GetLogUrlStatisticsArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Rum/getLogUrlStatistics:getLogUrlStatistics
...
## getLogUrlStatistics Result {#result}
