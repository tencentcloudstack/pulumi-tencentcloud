...
const staticResource = tencentcloud.Rum.getStaticResource({
    endTime: 1625454840,
    projectId: 1,
...
import com.pulumi.tencentcloud.Rum.inputs.GetStaticResourceArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var staticResource = RumFunctions.getStaticResource(GetStaticResourceArgs.builder()
            .endTime(1625454840)
            .projectId(1)
            .startTime(1625444040)
            .type("top")
