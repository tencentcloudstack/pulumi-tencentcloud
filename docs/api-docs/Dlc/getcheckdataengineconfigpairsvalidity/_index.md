...
import com.pulumi.tencentcloud.Dlc.inputs.GetCheckDataEngineConfigPairsValidityArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var checkDataEngineConfigPairsValidity = DlcFunctions.getCheckDataEngineConfigPairsValidity(GetCheckDataEngineConfigPairsValidityArgs.builder()
            .childImageVersionId("d3ftghd4-9a7e-4f64-a3f4-f38507c69742")
            .build());
