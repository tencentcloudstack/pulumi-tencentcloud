...
public class App {
    ...
    public static void stack(Context ctx) {
        final var securityGroups = Output.of(DcdbFunctions.getSecurityGroups(GetSecurityGroupsArgs.builder()
            .instanceId("your_instance_id")
            .build()));
...
const securityGroups = pulumi.output(tencentcloud.Dcdb.getSecurityGroups({
    instanceId: "your_instance_id",
}));
```
