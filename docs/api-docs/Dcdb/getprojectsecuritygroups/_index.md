...
import com.pulumi.tencentcloud.Dcdb.inputs.GetProjectSecurityGroupsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var projectSecurityGroups = DcdbFunctions.getProjectSecurityGroups(GetProjectSecurityGroupsArgs.builder()
            .product("dcdb")
            .projectId(0)
            .build());
