...
title_tag: "tencentcloud.Dcdb.getProjectSecurityGroups"
meta_desc: "Documentation for the tencentcloud.Dcdb.getProjectSecurityGroups function with examples, input properties, output properties, and supporting types."
layout: api
...
class MyStack : Stack
{
    public MyStack()
    {
        var projectSecurityGroups = Output.Create(Tencentcloud.Dcdb.GetProjectSecurityGroups.InvokeAsync(new Tencentcloud.Dcdb.GetProjectSecurityGroupsArgs
        {
            Product = "dcdb",
            ProjectId = 0,
        }));
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var projectSecurityGroups = Output.of(DcdbFunctions.getProjectSecurityGroups(GetProjectSecurityGroupsArgs.builder()
            .product("dcdb")
            .projectId(0)
            .build()));
...
variables:
  projectSecurityGroups:
    Fn::Invoke:
      Function: tencentcloud:Dcdb:getProjectSecurityGroups
      Arguments:
        product: dcdb
        projectId: 0
```
...
><span class="k">def </span>get_project_security_groups<span class="p">(</span><span class="nx">product</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_project_security_groups_output<span class="p">(</span><span class="nx">product</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Dcdb/getProjectSecurityGroups:getProjectSecurityGroups
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#product_csharp" style="color: inherit; text-decoration: inherit;">Product</a>
    ...
    <dd><p>Database engine name. Valid value: <code>dcdb</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#groups_csharp" style="color: inherit; text-decoration: inherit;">Groups</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectsecuritygroupsgroup">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Dcdb.<wbr>Outputs.<wbr>Get<wbr>Project<wbr>Security<wbr>Groups<wbr>Group&gt;</a></span>
    </dt>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#createtime_csharp" style="color: inherit; text-decoration: inherit;">Create<wbr>Time</a>
    ...
    <dd><p>Creation time in the format of yyyy-mm-dd hh:mm:ss.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#inbounds_csharp" style="color: inherit; text-decoration: inherit;">Inbounds</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectsecuritygroupsgroupinbound">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Dcdb.<wbr>Inputs.<wbr>Get<wbr>Project<wbr>Security<wbr>Groups<wbr>Group<wbr>Inbound&gt;</a></span>
    </dt>
    <dd><p>Inbound rule.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#outbounds_csharp" style="color: inherit; text-decoration: inherit;">Outbounds</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getprojectsecuritygroupsgroupoutbound">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Dcdb.<wbr>Inputs.<wbr>Get<wbr>Project<wbr>Security<wbr>Groups<wbr>Group<wbr>Outbound&gt;</a></span>
    </dt>
    <dd><p>Outbound rule.</p>
</dd><dt class="property-required"
            title="Required">
        <span id="projectid_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#projectid_csharp" style="color: inherit; text-decoration: inherit;">Project<wbr>Id</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#action_csharp" style="color: inherit; text-decoration: inherit;">Action</a>
    ...
    <dd><p>Policy, which can be <code>ACCEPT</code> or <code>DROP</code>.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#cidrip_csharp" style="color: inherit; text-decoration: inherit;">Cidr<wbr>Ip</a>
    ...
    <dd><p>Source IP or source IP range, such as 192.168.0.0/16.</p>
</dd><dt class="property-required"
            title="Required">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#ipprotocol_csharp" style="color: inherit; text-decoration: inherit;">Ip<wbr>Protocol</a>
    ...
    <dd><p>Network protocol. UDP and TCP are supported.</p>
</dd><dt class="property-required"
            title="Required">
