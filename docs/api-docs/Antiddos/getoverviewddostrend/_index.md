...
import com.pulumi.tencentcloud.Antiddos.inputs.GetOverviewDdosTrendArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var overviewDdosTrend = AntiddosFunctions.getOverviewDdosTrend(GetOverviewDdosTrendArgs.builder()
            .business("bgpip")
            .endTime("2023-11-21 14:16:23")
            .metricName("bps")
            .period(300)
