...
import com.pulumi.tencentcloud.Mysql.inputs.GetInstanceParamRecordArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceParamRecord = MysqlFunctions.getInstanceParamRecord(GetInstanceParamRecordArgs.builder()
            .instanceId("")
            .build());
