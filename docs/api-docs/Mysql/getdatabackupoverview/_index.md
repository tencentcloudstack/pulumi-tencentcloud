...
import com.pulumi.tencentcloud.Mysql.inputs.GetDataBackupOverviewArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var dataBackupOverview = MysqlFunctions.getDataBackupOverview(GetDataBackupOverviewArgs.builder()
            .product("mysql")
            .build());
