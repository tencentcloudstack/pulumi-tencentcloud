...
{
    var mysql = Tencentcloud.Mysql.GetZoneConfig.Invoke(new()
    {
        Region = "ap-guangzhou",
        ResultOutputFile = "mytestpath",
    });
...
import com.pulumi.tencentcloud.Mysql.inputs.GetZoneConfigArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var mysql = MysqlFunctions.getZoneConfig(GetZoneConfigArgs.builder()
            .region("ap-guangzhou")
            .resultOutputFile("mytestpath")
            .build());
