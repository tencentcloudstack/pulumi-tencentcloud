...
public class App {
    ...
    public static void stack(Context ctx) {
        final var parseLiveStreamProcessNotification = Output.of(MpsFunctions.getParseLiveStreamProcessNotification(GetParseLiveStreamProcessNotificationArgs.builder()
            .content("your_content")
            .build()));
