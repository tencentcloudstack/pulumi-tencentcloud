...
title_tag: "tencentcloud.Mps.SnapshotByTimeoffsetTemplate"
meta_desc: "Documentation for the tencentcloud.Mps.SnapshotByTimeoffsetTemplate resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Mps.SnapshotByTimeoffsetTemplate;
import com.pulumi.tencentcloud.Mps.SnapshotByTimeoffsetTemplateArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var snapshotByTimeoffsetTemplate = new SnapshotByTimeoffsetTemplate("snapshotByTimeoffsetTemplate", SnapshotByTimeoffsetTemplateArgs.builder()        
            .fillType("stretch")
            .format("jpg")
            .height(128)
            .resolutionAdaptive("open")
...
resources:
  snapshotByTimeoffsetTemplate:
    type: tencentcloud:Mps:SnapshotByTimeoffsetTemplate
    properties:
      fillType: stretch
      format: jpg
      height: 128
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Mps:SnapshotByTimeoffsetTemplate</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Snapshot by timeoffset template name, length limit: 64 characters.</p>
</dd><dt class="property-optional"
            title="Optional">
