...
import com.pulumi.tencentcloud.Cvm.inputs.GetChcHostsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var chcHosts = CvmFunctions.getChcHosts(GetChcHostsArgs.builder()
            .chcIds("chc-xxxxxx")
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#filters_csharp" style="color: inherit; text-decoration: inherit;">Filters</a>
    ...
    <dd><p><code>zone</code> Filter by the availability zone, such as ap-guangzhou-1. Valid values: See <a href="https://www.tencentcloud.com/document/product/213/6091?from_cn_redirect=1">Regions and Availability Zones</a>.</p>
<ul>
