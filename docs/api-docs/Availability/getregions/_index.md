---
title: "getRegions"
title_tag: "tencentcloud.Availability.getRegions"
meta_desc: "Documentation for the tencentcloud.Availability.getRegions function with examples, input properties, output properties, and supporting types."
layout: api
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var myFavouriteRegion = Output.of(AvailabilityFunctions.getRegions(GetRegionsArgs.builder()
            .name("ap-guangzhou")
            .build()));
...
const myFavouriteRegion = pulumi.output(tencentcloud.Availability.getRegions({
    name: "ap-guangzhou",
}));
```
...
variables:
  myFavouriteRegion:
    Fn::Invoke:
      Function: tencentcloud:Availability:getRegions
      Arguments:
        name: ap-guangzhou
```
...
><span class="k">def </span>get_regions<span class="p">(</span><span class="nx">include_unavailable</span><span class="p">:</span> <span class="nx">Optional[bool]</span> = None<span class="p">,</span>
...
><span class="k">
def </span>get_regions_output<span class="p">(</span><span class="nx">include_unavailable</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[bool]]</span> = None<span class="p">,</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Availability/getRegions:getRegions
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#includeunavailable_csharp" style="color: inherit; text-decoration: inherit;">Include<wbr>Unavailable</a>
    ...
    <dd><p>A bool variable indicates that the query will include <code>UNAVAILABLE</code> regions.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>When specified, only the region with the exactly name match will be returned. <code>default</code> value means it consistent with the provider region.</p>
</dd><dt class="property-optional"
            title="Optional">
...
<dl class="resources-properties"><dt class="property-"
            title="">
        <span id="availabilityregions_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#availabilityregions_csharp" style="color: inherit; text-decoration: inherit;">Availability<wbr>Regions</a>
</span>
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregionsregion">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Availability.<wbr>Outputs.<wbr>Get<wbr>Regions<wbr>Region&gt;</a></span>
    </dt>
    <dd><p>A list of regions will be exported and its every element contains the following attributes:</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>The name of the region, like <code>ap-guangzhou</code>.</p>
</dd><dt class="property-"
            title="">
        <span id="resultoutputfile_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#resultoutputfile_csharp" style="color: inherit; text-decoration: inherit;">Result<wbr>Output<wbr>File</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#regions_yaml" style="color: inherit; text-decoration: inherit;">regions</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getregionsregion">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>A list of regions will be exported and its every element contains the following attributes:</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#description_csharp" style="color: inherit; text-decoration: inherit;">Description</a>
    ...
    <dd><p>The description of the region, like <code>Guangzhou Region</code>.</p>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#state_csharp" style="color: inherit; text-decoration: inherit;">State</a>
    ...
    <dd><p>The state of the region, indicate availability using <code>AVAILABLE</code> and <code>UNAVAILABLE</code> values.</p>
</dd></dl>
</pulumi-choosable>
</div>
