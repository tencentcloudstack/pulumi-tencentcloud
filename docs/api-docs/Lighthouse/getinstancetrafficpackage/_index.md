...
import com.pulumi.tencentcloud.Lighthouse.inputs.GetInstanceTrafficPackageArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceTrafficPackage = LighthouseFunctions.getInstanceTrafficPackage();
