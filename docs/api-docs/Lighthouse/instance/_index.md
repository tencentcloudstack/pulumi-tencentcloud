...
<p class="property-message">Deprecated:<p>It has been deprecated from version v1.81.8. Use <code>tencentcloud_lighthouse_key_pair_attachment</code> manage key pair.</p>
