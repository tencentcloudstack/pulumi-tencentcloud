...
---
title: "getMicroserviceApiVersion"
title_tag: "tencentcloud.Tsf.getMicroserviceApiVersion"
meta_desc: "Documentation for the tencentcloud.Tsf.getMicroserviceApiVersion function with examples, input properties, output properties, and supporting types."
layout: api
...
import com.pulumi.tencentcloud.Tsf.inputs.GetMicroserviceApiVersionArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var microserviceApiVersion = TsfFunctions.getMicroserviceApiVersion(GetMicroserviceApiVersionArgs.builder()
            .method("get")
            .microserviceId("ms-yq3jo6jd")
            .path("")
            .build());
...
variables:
  microserviceApiVersion:
    fn::invoke:
      Function: tencentcloud:Tsf:getMicroserviceApiVersion
      Arguments:
        method: get
        microserviceId: ms-yq3jo6jd
        path:
...
## Using getMicroserviceApiVersion {#using}
...
><span class="k">function </span>getMicroserviceApiVersion<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetMicroserviceApiVersionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Promise&lt;<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>></span
><span class="k">
function </span>getMicroserviceApiVersionOutput<span class="p">(</span><span class="nx">args</span><span class="p">:</span> <span class="nx">GetMicroserviceApiVersionOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p">?:</span> <span class="nx"><a href="/docs/reference/pkg/nodejs/pulumi/pulumi/#InvokeOptions">InvokeOptions</a></span><span class="p">): Output&lt;<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>></span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">def </span>get_microservice_api_version<span class="p">(</span><span class="nx">method</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>GetMicroserviceApiVersionResult</span
><span class="k">
def </span>get_microservice_api_version_output<span class="p">(</span><span class="nx">method</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[str]]</span> = None<span class="p">,</span>
                                 ...
                                 <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.InvokeOptions">Optional[InvokeOptions]</a></span> = None<span class="p">) -&gt;</span> <span>Output[GetMicroserviceApiVersionResult]</span
></code></pre></div>
</pulumi-choosable>
</div>
...
><span class="k">func </span>GetMicroserviceApiVersion<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetMicroserviceApiVersionArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) (*<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>, error)</span
><span class="k">
func </span>GetMicroserviceApiVersionOutput<span class="p">(</span><span class="nx">ctx</span><span class="p"> *</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#Context">Context</a></span><span class="p">,</span> <span class="nx">args</span><span class="p"> *</span><span class="nx">GetMicroserviceApiVersionOutputArgs</span><span class="p">,</span> <span class="nx">opts</span><span class="p"> ...</span><span class="nx"><a href="https://pkg.go.dev/github.com/pulumi/pulumi/sdk/v3/go/pulumi?tab=doc#InvokeOption">InvokeOption</a></span><span class="p">) GetMicroserviceApiVersionResultOutput</span
></code></pre></div>

&gt; Note: This function is named `GetMicroserviceApiVersion` in the Go SDK.
...
<div class="highlight"><pre class="chroma"><code class="language-csharp" data-lang="csharp"><span class="k">public static class </span><span class="nx">GetMicroserviceApiVersion </span><span class="p">
{</span><span class="k">
    public static </span>Task&lt;<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>> <span class="p">InvokeAsync(</span><span class="nx">GetMicroserviceApiVersionArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="k">
    public static </span>Output&lt;<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>> <span class="p">Invoke(</span><span class="nx">GetMicroserviceApiVersionInvokeArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx"><a href="/docs/reference/pkg/dotnet/Pulumi/Pulumi.InvokeOptions.html">InvokeOptions</a></span><span class="p">? </span><span class="nx">opts = null<span class="p">)</span><span class="p">
}</span></code></pre></div>
</pulumi-choosable>
</div>
...
<div class="highlight"><pre class="chroma"><code class="language-java" data-lang="java"><span class="k">public static CompletableFuture&lt;<span class="nx"><a href="#result">GetMicroserviceApiVersionResult</a></span>> </span>getMicroserviceApiVersion<span class="p">(</span><span class="nx">GetMicroserviceApiVersionArgs</span><span class="p"> </span><span class="nx">args<span class="p">,</span> <span class="nx">InvokeOptions</span><span class="p"> </span><span class="nx">options<span class="p">)</span>
...
<span class="k">&nbsp;&nbsp;function:</span> tencentcloud:Tsf/getMicroserviceApiVersion:getMicroserviceApiVersion
...
## getMicroserviceApiVersion Result {#result}
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#results_csharp" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmicroserviceapiversionresult">List&lt;Tencent<wbr>Cloud<wbr>IAC.<wbr>Pulumi<wbr>Package.<wbr>Tencentcloud.<wbr>Tsf.<wbr>Outputs.<wbr>Get<wbr>Microservice<wbr>Api<wbr>Version<wbr>Result&gt;</a></span>
    </dt>
    <dd><p>api version list.</p>
</dd><dt class="property-"
            title="">
        <span id="method_csharp">
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#method_csharp" style="color: inherit; text-decoration: inherit;">Method</a>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#results_go" style="color: inherit; text-decoration: inherit;">Results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmicroserviceapiversionresult">[]Get<wbr>Microservice<wbr>Api<wbr>Version<wbr>Result</a></span>
    </dt>
    <dd><p>api version list.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#results_java" style="color: inherit; text-decoration: inherit;">results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmicroserviceapiversionresult">List&lt;Get<wbr>Microservice<wbr>Api<wbr>Version<wbr>Result&gt;</a></span>
    </dt>
    <dd><p>api version list.</p>
</dd><dt class="property-"
            title="">
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#results_yaml" style="color: inherit; text-decoration: inherit;">results</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#getmicroserviceapiversionresult">List&lt;Property Map&gt;</a></span>
    </dt>
    <dd><p>api version list.</p>
</dd><dt class="property-"
            title="">
...
<h4 id="getmicroserviceapiversionresult">Get<wbr>Microservice<wbr>Api<wbr>Version<wbr>Result</h4>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#pkgversion_csharp" style="color: inherit; text-decoration: inherit;">Pkg<wbr>Version</a>
    ...
    <dd><p>application pkg version.</p>
</dd></dl>
</pulumi-choosable>
</div>
