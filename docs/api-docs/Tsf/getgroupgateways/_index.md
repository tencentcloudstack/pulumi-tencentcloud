...
import com.pulumi.tencentcloud.Tsf.inputs.GetGroupGatewaysArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var groupGateways = TsfFunctions.getGroupGateways(GetGroupGatewaysArgs.builder()
            .gatewayDeployGroupId("group-aeoej4qy")
            .searchWord("test")
            .build());
...
<h4 id="getgroupgatewaysresultcontent">Get<wbr>Group<wbr>Gateways<wbr>Result<wbr>Content</h4>
