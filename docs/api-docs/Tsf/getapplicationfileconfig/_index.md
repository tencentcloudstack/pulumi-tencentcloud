...
import com.pulumi.tencentcloud.Tsf.inputs.GetApplicationFileConfigArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var applicationFileConfig = TsfFunctions.getApplicationFileConfig(GetApplicationFileConfigArgs.builder()
            .applicationId("application-2vzk6n3v")
            .configId("dcfg-f-4y4ekzqv")
            .configName("file-log1")
            .configVersion("1.2")
