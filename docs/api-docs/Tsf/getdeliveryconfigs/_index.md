...
import com.pulumi.tencentcloud.Tsf.inputs.GetDeliveryConfigsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var deliveryConfigs = TsfFunctions.getDeliveryConfigs(GetDeliveryConfigsArgs.builder()
            .searchWord("test")
            .build());
