...
public class App {
    ...
    public static void stack(Context ctx) {
        final var usableUnitNamespaces = Output.of(TsfFunctions.getUsableUnitNamespaces(GetUsableUnitNamespacesArgs.builder()
            .searchWord("")
            .build()));
...
const usableUnitNamespaces = pulumi.output(tencentcloud.Tsf.getUsableUnitNamespaces({
    searchWord: "",
}));
```
