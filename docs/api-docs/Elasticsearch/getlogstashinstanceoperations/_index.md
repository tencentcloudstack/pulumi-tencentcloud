...
import com.pulumi.tencentcloud.Elasticsearch.inputs.GetLogstashInstanceOperationsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var logstashInstanceOperations = ElasticsearchFunctions.getLogstashInstanceOperations(GetLogstashInstanceOperationsArgs.builder()
            .endTime("2023-10-31 10:12:45")
            .instanceId("ls-xxxxxx")
            .startTime("2018-01-01 00:00:00")
            .build());
