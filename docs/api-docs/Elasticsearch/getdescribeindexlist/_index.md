...
import com.pulumi.tencentcloud.Elasticsearch.inputs.GetDescribeIndexListArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var describeIndexList = ElasticsearchFunctions.getDescribeIndexList(GetDescribeIndexListArgs.builder()
            .indexType("normal")
            .instanceId("es-nni6pm4s")
            .build());
