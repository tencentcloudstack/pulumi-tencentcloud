...
import com.pulumi.tencentcloud.Elasticsearch.inputs.GetInstanceLogsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var elasticsearchInstanceLogs = ElasticsearchFunctions.getInstanceLogs(GetInstanceLogsArgs.builder()
            .instanceId("es-xxxxxx")
            .build());
