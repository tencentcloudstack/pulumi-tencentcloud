...
---
title: "SecurityGroup"
title_tag: "tencentcloud.Elasticsearch.SecurityGroup"
meta_desc: "Documentation for the tencentcloud.Elasticsearch.SecurityGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
security_group = tencentcloud.elasticsearch.SecurityGroup("securityGroup",
...
import com.pulumi.tencentcloud.Elasticsearch.SecurityGroup;
import com.pulumi.tencentcloud.Elasticsearch.SecurityGroupArgs;
...
resources:
  securityGroup:
    type: tencentcloud:Elasticsearch:SecurityGroup
    properties:
      instanceId: es-5wn36he6
      securityGroupIds:
        - sg-mayqdlt1
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Elasticsearch:SecurityGroup</span><span class="p"></span>
