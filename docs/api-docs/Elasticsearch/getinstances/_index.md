...
const foo = tencentcloud.Elasticsearch.getInstances({
...
import com.pulumi.tencentcloud.Elasticsearch.inputs.GetInstancesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var foo = ElasticsearchFunctions.getInstances(GetInstancesArgs.builder()
            .instanceId("es-17634f05")
            .build());
