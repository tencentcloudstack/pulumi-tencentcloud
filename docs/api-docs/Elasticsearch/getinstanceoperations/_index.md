...
import com.pulumi.tencentcloud.Elasticsearch.inputs.GetInstanceOperationsArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var instanceOperations = ElasticsearchFunctions.getInstanceOperations(GetInstanceOperationsArgs.builder()
            .endTime("2023-10-31 10:12:45")
            .instanceId("es-xxxxxx")
            .startTime("2018-01-01 00:00:00")
            .build());
