...
---
title: "TemplateGroup"
title_tag: "tencentcloud.Address.TemplateGroup"
meta_desc: "Documentation for the tencentcloud.Address.TemplateGroup resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
const foo = new tencentcloud.address.TemplateGroup("foo", {templateIds: [
    "ipl-axaf24151",
    "ipl-axaf24152",
]});
```
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Address:TemplateGroup</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#name_csharp" style="color: inherit; text-decoration: inherit;">Name</a>
    ...
    <dd><p>Name of the address template group.</p>
</dd></dl>
</pulumi-choosable>
</div>
