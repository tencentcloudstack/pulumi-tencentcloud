...
---
title: "RenewInstance"
title_tag: "tencentcloud.Ckafka.RenewInstance"
meta_desc: "Documentation for the tencentcloud.Ckafka.RenewInstance resource with examples, input properties, output properties, lookup functions, and supporting types."
layout: api
...
const renewCkafkaInstance = new tencentcloud.ckafka.RenewInstance("renewCkafkaInstance", {
...
renew_ckafka_instance = tencentcloud.ckafka.RenewInstance("renewCkafkaInstance",
...
import com.pulumi.tencentcloud.Ckafka.RenewInstance;
import com.pulumi.tencentcloud.Ckafka.RenewInstanceArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        var renewCkafkaInstance = new RenewInstance("renewCkafkaInstance", RenewInstanceArgs.builder()        
            .instanceId("InstanceId")
            .timeSpan(1)
            .build());
...
resources:
  renewCkafkaInstance:
    type: tencentcloud:Ckafka:RenewInstance
    properties:
      instanceId: InstanceId
      timeSpan: 1
```
...
<div class="highlight"><pre class="chroma"><code class="language-yaml" data-lang="yaml">type: <span class="nx">tencentcloud:Ckafka:RenewInstance</span><span class="p"></span>
...
<a data-swiftype-name="resource-property" data-swiftype-type="text" href="#timespan_csharp" style="color: inherit; text-decoration: inherit;">Time<wbr>Span</a>
    ...
    <dd><p>Renewal duration, the default is 1, and the unit is month.</p>
</dd></dl>
</pulumi-choosable>
</div>
...
<span class="k">def </span><span class="nf">get</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
        ...
        <span class="nx">opts</span><span class="p">:</span> <span class="nx"><a href="/docs/reference/pkg/python/pulumi/#pulumi.ResourceOptions">Optional[ResourceOptions]</a></span> = None<span class="p">,</span>
        <span class="nx">instance_id</span><span class="p">:</span> <span class="nx">Optional[str]</span> = None<span class="p">,</span>
        <span class="nx">time_span</span><span class="p">:</span> <span class="nx">Optional[int]</span> = None<span class="p">) -&gt;</span> RenewInstance</code></pre></div>
</pulumi-choosable>
</div>
