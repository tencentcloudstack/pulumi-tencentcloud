...
public class App {
    ...
    public static void stack(Context ctx) {
        final var example = Output.of(WedataFunctions.getDataSourceWithoutInfo(GetDataSourceWithoutInfoArgs.builder()
...
&gt; Note: This function is named `GetDataSourceWithoutInfo` in the Go SDK.
...
## getDataSourceWithoutInfo Result {#result}
...
<h4 id="getdatasourcewithoutinfofilter">Get<wbr>Data<wbr>Source<wbr>Without<wbr>Info<wbr>Filter</h4>
...
<h4 id="getdatasourcewithoutinfoorderfield">Get<wbr>Data<wbr>Source<wbr>Without<wbr>Info<wbr>Order<wbr>Field</h4>
