...
public class App {
    ...
    public static void stack(Context ctx) {
        final var nameSelect = Output.of(DcxFunctions.getInstances(GetInstancesArgs.builder()
            .name("main")
            .build()));

        final var id = Output.of(DcxFunctions.getInstances(GetInstancesArgs.builder()
            .dcxId("dcx-3ikuw30k")
            .build()));
