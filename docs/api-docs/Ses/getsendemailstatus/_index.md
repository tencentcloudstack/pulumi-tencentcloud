...
import com.pulumi.tencentcloud.Ses.inputs.GetSendEmailStatusArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        final var sendEmailStatus = SesFunctions.getSendEmailStatus(GetSendEmailStatusArgs.builder()
            .messageId("qcloudses-30-4123414323-date-20210101094334-syNARhMTbKI1")
            .requestDate("2020-09-22")
            .toEmailAddress("example@cloud.com")
            .build());
