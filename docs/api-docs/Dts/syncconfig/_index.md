...
return await Deployment.RunAsync(() => 
{
    ...
    var syncConfig = new Tencentcloud.Dts.SyncConfig("syncConfig", new()
    {
        JobId = syncJob.JobId,
        SrcAccessType = "cdb",
        DstAccessType = "cdb",
...
import com.pulumi.tencentcloud.Dts.SyncConfig;
import com.pulumi.tencentcloud.Dts.SyncConfigArgs;
import com.pulumi.tencentcloud.Dts.inputs.SyncConfigObjectsArgs;
import com.pulumi.tencentcloud.Dts.inputs.SyncConfigSrcInfoArgs;
import com.pulumi.tencentcloud.Dts.inputs.SyncConfigDstInfoArgs;
...
import com.pulumi.tencentcloud.Ccn.inputs.GetInstancesArgs;
...
public class App {
    ...
    public static void stack(Context ctx) {
        ...
        final var srcMysql = MysqlFunctions.getInstance(GetInstanceArgs.builder()
            .instanceName("your_user_name_mysql_src")
            .build());

        final var srcIp = srcMysql.applyValue(getInstanceResult -> getInstanceResult.instanceLists()[0].intranetIp());

        final var srcPort = srcMysql.applyValue(getInstanceResult -> getInstanceResult.instanceLists()[0].intranetPort());

        final var ccns = CcnFunctions.getInstances(GetInstancesArgs.builder()
            .name("keep-ccn-dts-sh")
            .build());

        final var ccnId = ccns.applyValue(getInstancesResult -> getInstancesResult.instanceLists()[0].ccnId());

        final var dstMysql = MysqlFunctions.getInstance(GetInstanceArgs.builder()
            .instanceName("your_user_name_mysql_src")
            .build());

        final var dstMysqlId = dstMysql.applyValue(getInstanceResult -> getInstanceResult.instanceLists()[0].mysqlId());
        ...
        var syncConfig = new SyncConfig("syncConfig", SyncConfigArgs.builder()        
            .jobId(syncJobs.applyValue(getSyncJobsResult -> getSyncJobsResult.lists()[0].jobId()))
            .srcAccessType("ccn")
            .dstAccessType("cdb")
            .jobMode("liteMode")
            .runMode("Immediate")
